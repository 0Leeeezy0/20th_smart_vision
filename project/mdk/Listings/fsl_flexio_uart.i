# 1 "../../libraries/sdk/drives/fsl_flexio_uart.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/sdk/drives/fsl_flexio_uart.c" 2
...
# 10 "../../libraries/sdk/drives/fsl_flexio_uart.c" 2
# 21 "../../libraries/sdk/drives/fsl_flexio_uart.c"
...
# 39 "../../libraries/sdk/drives/fsl_flexio_uart.c"
static size_t FLEXIO_UART_TransferGetRxRingBufferLength(flexio_uart_handle_t *handle);
# 48 "../../libraries/sdk/drives/fsl_flexio_uart.c"
static _Bool FLEXIO_UART_TransferIsRxRingBufferFull(flexio_uart_handle_t *handle);
...
# 124 "../../libraries/sdk/drives/fsl_flexio_uart.c"
status_t FLEXIO_UART_Init(FLEXIO_UART_Type *base, const flexio_uart_config_t *userConfig, uint32_t srcClock_Hz)
{
    (((base != 0) && (userConfig != 0)) ? (void)0 : __aeabi_assert("(base != NULL) && (userConfig != NULL)", "../../libraries/sdk/drives/fsl_flexio_uart.c", 126),
# 126 "../../libraries/sdk/drives/fsl_flexio_uart.c"
#pragma clang diagnostic push
# 126 "../../libraries/sdk/drives/fsl_flexio_uart.c"
#pragma clang diagnostic ignored "-Wassume"
# 126 "../../libraries/sdk/drives/fsl_flexio_uart.c"
    (__builtin_assume)(((base != 0) && (userConfig != 0))?1:0)
# 126 "../../libraries/sdk/drives/fsl_flexio_uart.c"
#pragma clang diagnostic pop
# 126 "../../libraries/sdk/drives/fsl_flexio_uart.c"
    );
    ...
    ctrlReg |= ((((uint32_t)(((uint32_t)(userConfig->enableInDebug)) << (30U))) & (0x40000000U)) | (((uint32_t)(((uint32_t)(userConfig->enableFastAccess)) << (2U))) & (0x4U)) |
                (((uint32_t)(((uint32_t)(userConfig->enableUart)) << (0U))) & (0x1U)));
    ...
    timerConfig.triggerSelect = ((uint32_t)(base->RxPinIndex) << 1U);
...
# 260 "../../libraries/sdk/drives/fsl_flexio_uart.c"
void FLEXIO_UART_Deinit(FLEXIO_UART_Type *base)
{
...
# 290 "../../libraries/sdk/drives/fsl_flexio_uart.c"
void FLEXIO_UART_GetDefaultConfig(flexio_uart_config_t *userConfig)
{
    ((userConfig != 0) ? (void)0 : __aeabi_assert("userConfig != NULL", "../../libraries/sdk/drives/fsl_flexio_uart.c", 292),
# 292 "../../libraries/sdk/drives/fsl_flexio_uart.c"
#pragma clang diagnostic push
# 292 "../../libraries/sdk/drives/fsl_flexio_uart.c"
#pragma clang diagnostic ignored "-Wassume"
# 292 "../../libraries/sdk/drives/fsl_flexio_uart.c"
...
# 315 "../../libraries/sdk/drives/fsl_flexio_uart.c"
void FLEXIO_UART_EnableInterrupts(FLEXIO_UART_Type *base, uint32_t mask)
{
...
# 335 "../../libraries/sdk/drives/fsl_flexio_uart.c"
void FLEXIO_UART_DisableInterrupts(FLEXIO_UART_Type *base, uint32_t mask)
{
    if ((mask & (uint32_t)kFLEXIO_UART_TxDataRegEmptyInterruptEnable) != 0U)
    {
...
# 354 "../../libraries/sdk/drives/fsl_flexio_uart.c"
uint32_t FLEXIO_UART_GetStatusFlags(FLEXIO_UART_Type *base)
{
    uint32_t status = 0U;
    status =
...
# 379 "../../libraries/sdk/drives/fsl_flexio_uart.c"
void FLEXIO_UART_ClearStatusFlags(FLEXIO_UART_Type *base, uint32_t mask)
{
...
# 406 "../../libraries/sdk/drives/fsl_flexio_uart.c"
status_t FLEXIO_UART_WriteBlocking(FLEXIO_UART_Type *base, const uint8_t *txData, size_t txSize)
{
    ((txData != 0) ? (void)0 : __aeabi_assert("txData != NULL", "../../libraries/sdk/drives/fsl_flexio_uart.c", 408),
# 408 "../../libraries/sdk/drives/fsl_flexio_uart.c"
#pragma clang diagnostic push
# 408 "../../libraries/sdk/drives/fsl_flexio_uart.c"
#pragma clang diagnostic ignored "-Wassume"
# 408 "../../libraries/sdk/drives/fsl_flexio_uart.c"
...
# 408 "../../libraries/sdk/drives/fsl_flexio_uart.c"
    ...
    ((txSize != 0U) ? (void)0 : __aeabi_assert("txSize != 0U", "../../libraries/sdk/drives/fsl_flexio_uart.c", 409),
# 409 "../../libraries/sdk/drives/fsl_flexio_uart.c"
#pragma clang diagnostic push
# 409 "../../libraries/sdk/drives/fsl_flexio_uart.c"
#pragma clang diagnostic ignored "-Wassume"
# 409 "../../libraries/sdk/drives/fsl_flexio_uart.c"
...
# 449 "../../libraries/sdk/drives/fsl_flexio_uart.c"
status_t FLEXIO_UART_ReadBlocking(FLEXIO_UART_Type *base, uint8_t *rxData, size_t rxSize)
{
    ((rxData != 0) ? (void)0 : __aeabi_assert("rxData != NULL", "../../libraries/sdk/drives/fsl_flexio_uart.c", 451),
# 451 "../../libraries/sdk/drives/fsl_flexio_uart.c"
#pragma clang diagnostic push
# 451 "../../libraries/sdk/drives/fsl_flexio_uart.c"
#pragma clang diagnostic ignored "-Wassume"
# 451 "../../libraries/sdk/drives/fsl_flexio_uart.c"
...
# 451 "../../libraries/sdk/drives/fsl_flexio_uart.c"
    ...
    ((rxSize != 0U) ? (void)0 : __aeabi_assert("rxSize != 0U", "../../libraries/sdk/drives/fsl_flexio_uart.c", 452),
# 452 "../../libraries/sdk/drives/fsl_flexio_uart.c"
#pragma clang diagnostic push
# 452 "../../libraries/sdk/drives/fsl_flexio_uart.c"
#pragma clang diagnostic ignored "-Wassume"
# 452 "../../libraries/sdk/drives/fsl_flexio_uart.c"
...
# 501 "../../libraries/sdk/drives/fsl_flexio_uart.c"
status_t FLEXIO_UART_TransferCreateHandle(FLEXIO_UART_Type *base,
                                          flexio_uart_handle_t *handle,
                                          flexio_uart_transfer_callback_t callback,
                                          void *userData)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_flexio_uart.c", 506),
# 506 "../../libraries/sdk/drives/fsl_flexio_uart.c"
#pragma clang diagnostic push
# 506 "../../libraries/sdk/drives/fsl_flexio_uart.c"
#pragma clang diagnostic ignored "-Wassume"
# 506 "../../libraries/sdk/drives/fsl_flexio_uart.c"
...
# 506 "../../libraries/sdk/drives/fsl_flexio_uart.c"
    ...
    __NVIC_ClearPendingIRQ(flexio_irqs[FLEXIO_UART_GetInstance(base)]);
...
# 547 "../../libraries/sdk/drives/fsl_flexio_uart.c"
void FLEXIO_UART_TransferStartRingBuffer(FLEXIO_UART_Type *base,
                                         flexio_uart_handle_t *handle,
                                         uint8_t *ringBuffer,
                                         size_t ringBufferSize)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_flexio_uart.c", 552),
# 552 "../../libraries/sdk/drives/fsl_flexio_uart.c"
#pragma clang diagnostic push
# 552 "../../libraries/sdk/drives/fsl_flexio_uart.c"
#pragma clang diagnostic ignored "-Wassume"
# 552 "../../libraries/sdk/drives/fsl_flexio_uart.c"
...
# 575 "../../libraries/sdk/drives/fsl_flexio_uart.c"
void FLEXIO_UART_TransferStopRingBuffer(FLEXIO_UART_Type *base, flexio_uart_handle_t *handle)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_flexio_uart.c", 577),
# 577 "../../libraries/sdk/drives/fsl_flexio_uart.c"
#pragma clang diagnostic push
# 577 "../../libraries/sdk/drives/fsl_flexio_uart.c"
#pragma clang diagnostic ignored "-Wassume"
# 577 "../../libraries/sdk/drives/fsl_flexio_uart.c"
...
# 607 "../../libraries/sdk/drives/fsl_flexio_uart.c"
status_t FLEXIO_UART_TransferSendNonBlocking(FLEXIO_UART_Type *base,
                                             flexio_uart_handle_t *handle,
                                             flexio_uart_transfer_t *xfer)
{
    ...
    if ((0U == xfer->dataSize) || (0 == xfer->txData))
    {
...
# 649 "../../libraries/sdk/drives/fsl_flexio_uart.c"
void FLEXIO_UART_TransferAbortSend(FLEXIO_UART_Type *base, flexio_uart_handle_t *handle)
{
...
# 669 "../../libraries/sdk/drives/fsl_flexio_uart.c"
status_t FLEXIO_UART_TransferGetSendCount(FLEXIO_UART_Type *base, flexio_uart_handle_t *handle, size_t *count)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_flexio_uart.c", 671),
# 671 "../../libraries/sdk/drives/fsl_flexio_uart.c"
#pragma clang diagnostic push
# 671 "../../libraries/sdk/drives/fsl_flexio_uart.c"
#pragma clang diagnostic ignored "-Wassume"
# 671 "../../libraries/sdk/drives/fsl_flexio_uart.c"
...
# 671 "../../libraries/sdk/drives/fsl_flexio_uart.c"
    ...
    ((count != 0) ? (void)0 : __aeabi_assert("count != NULL", "../../libraries/sdk/drives/fsl_flexio_uart.c", 672),
# 672 "../../libraries/sdk/drives/fsl_flexio_uart.c"
#pragma clang diagnostic push
# 672 "../../libraries/sdk/drives/fsl_flexio_uart.c"
#pragma clang diagnostic ignored "-Wassume"
# 672 "../../libraries/sdk/drives/fsl_flexio_uart.c"
...
# 709 "../../libraries/sdk/drives/fsl_flexio_uart.c"
status_t FLEXIO_UART_TransferReceiveNonBlocking(FLEXIO_UART_Type *base,
                                                flexio_uart_handle_t *handle,
                                                flexio_uart_transfer_t *xfer,
                                                size_t *receivedBytes)
{
    ...
    if ((0U == xfer->dataSize) || (0 == xfer->rxData))
    {
        return kStatus_InvalidArgument;
    }
# 739 "../../libraries/sdk/drives/fsl_flexio_uart.c"
...
# 834 "../../libraries/sdk/drives/fsl_flexio_uart.c"
void FLEXIO_UART_TransferAbortReceive(FLEXIO_UART_Type *base, flexio_uart_handle_t *handle)
{
...
# 858 "../../libraries/sdk/drives/fsl_flexio_uart.c"
status_t FLEXIO_UART_TransferGetReceiveCount(FLEXIO_UART_Type *base, flexio_uart_handle_t *handle, size_t *count)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_flexio_uart.c", 860),
# 860 "../../libraries/sdk/drives/fsl_flexio_uart.c"
#pragma clang diagnostic push
# 860 "../../libraries/sdk/drives/fsl_flexio_uart.c"
#pragma clang diagnostic ignored "-Wassume"
# 860 "../../libraries/sdk/drives/fsl_flexio_uart.c"
...
# 860 "../../libraries/sdk/drives/fsl_flexio_uart.c"
    ...
    ((count != 0) ? (void)0 : __aeabi_assert("count != NULL", "../../libraries/sdk/drives/fsl_flexio_uart.c", 861),
# 861 "../../libraries/sdk/drives/fsl_flexio_uart.c"
#pragma clang diagnostic push
# 861 "../../libraries/sdk/drives/fsl_flexio_uart.c"
#pragma clang diagnostic ignored "-Wassume"
# 861 "../../libraries/sdk/drives/fsl_flexio_uart.c"
...
# 881 "../../libraries/sdk/drives/fsl_flexio_uart.c"
void FLEXIO_UART_TransferHandleIRQ(void *uartType, void *uartHandle)
{
    uint8_t count = 1;
