# 1 "../../libraries/zf_device/zf_device_wireless_uart.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/zf_device/zf_device_wireless_uart.c" 2
# 48 "../../libraries/zf_device/zf_device_wireless_uart.c"
...
# 49 "../../libraries/zf_device/zf_device_wireless_uart.c" 2
...
# 50 "../../libraries/zf_device/zf_device_wireless_uart.c" 2
...
# 51 "../../libraries/zf_device/zf_device_wireless_uart.c" 2
...
# 52 "../../libraries/zf_device/zf_device_wireless_uart.c" 2
...
# 53 "../../libraries/zf_device/zf_device_wireless_uart.c" 2
...
# 54 "../../libraries/zf_device/zf_device_wireless_uart.c" 2
...
# 55 "../../libraries/zf_device/zf_device_wireless_uart.c" 2
...
# 57 "../../libraries/zf_device/zf_device_wireless_uart.c" 2

static fifo_struct wireless_uart_fifo;
static uint8 wireless_uart_buffer[(64 )];

static uint8 wireless_uart_data = 0;
# 74 "../../libraries/zf_device/zf_device_wireless_uart.c"
uint32 wireless_uart_send_byte (const uint8 data)
{
    uint16 time_count = (100);
    while(time_count)
    {
...
# 98 "../../libraries/zf_device/zf_device_wireless_uart.c"
uint32 wireless_uart_send_buffer (const uint8 *buff, uint32 len)
{
    (debug_assert_handler((0 != buff), "../../libraries/zf_device/zf_device_wireless_uart.c", 100));
    uint16 time_count = 0;
    while(0 != len)
    {
        if(!gpio_get_level((D26)))
...
# 139 "../../libraries/zf_device/zf_device_wireless_uart.c"
uint32 wireless_uart_send_string (const char *str)
{
    (debug_assert_handler((0 != str), "../../libraries/zf_device/zf_device_wireless_uart.c", 141));
    uint16 time_count = 0;
...
# 182 "../../libraries/zf_device/zf_device_wireless_uart.c"
void wireless_uart_send_image (const uint8 *image_addr, uint32 image_size)
{
    (debug_assert_handler((0 != image_addr), "../../libraries/zf_device/zf_device_wireless_uart.c", 184));
...
# 198 "../../libraries/zf_device/zf_device_wireless_uart.c"
uint32 wireless_uart_read_buffer (uint8 *buff, uint32 len)
{
    (debug_assert_handler((0 != buff), "../../libraries/zf_device/zf_device_wireless_uart.c", 200));
    uint32 data_len = len;
    fifo_read_buffer(&wireless_uart_fifo, buff, &data_len, FIFO_READ_AND_CLEAN);
    return data_len;
}
# 215 "../../libraries/zf_device/zf_device_wireless_uart.c"
void wireless_uart_callback (void)
{
    uart_query_byte((UART_8), &wireless_uart_data);
    fifo_write_buffer(&wireless_uart_fifo, &wireless_uart_data, 1);
# 227 "../../libraries/zf_device/zf_device_wireless_uart.c"
}
# 236 "../../libraries/zf_device/zf_device_wireless_uart.c"
uint8 wireless_uart_init (void)
{
    uint8 return_state = 0;
    set_wireless_type(WIRELESS_UART, wireless_uart_callback);

    fifo_init(&wireless_uart_fifo, FIFO_DATA_8BIT, wireless_uart_buffer, (64 ));
    gpio_init((D26), GPI, GPIO_HIGH, GPI_PULL_UP);


    uart_init ((UART_8), (115200), (UART8_TX_D16), (UART8_RX_D17));
    uart_rx_interrupt((UART_8), 1);
# 295 "../../libraries/zf_device/zf_device_wireless_uart.c"
    return return_state;
}
