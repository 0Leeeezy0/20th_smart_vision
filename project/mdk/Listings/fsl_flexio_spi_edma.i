# 1 "../../libraries/sdk/drives/fsl_flexio_spi_edma.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/sdk/drives/fsl_flexio_spi_edma.c" 2
...
# 1 "../../libraries/sdk/drives/fsl_flexio_spi_edma.h" 1
# 11 "../../libraries/sdk/drives/fsl_flexio_spi_edma.h"
...
# 12 "../../libraries/sdk/drives/fsl_flexio_spi_edma.h" 2
...
# 13 "../../libraries/sdk/drives/fsl_flexio_spi_edma.h" 2
# 30 "../../libraries/sdk/drives/fsl_flexio_spi_edma.h"
...
# 89 "../../libraries/sdk/drives/fsl_flexio_spi_edma.h"
status_t FLEXIO_SPI_MasterTransferCreateHandleEDMA(FLEXIO_SPI_Type *base,
                                                   ...
                                                   edma_handle_t *txHandle,
                                                   edma_handle_t *rxHandle);
# 110 "../../libraries/sdk/drives/fsl_flexio_spi_edma.h"
...
# 129 "../../libraries/sdk/drives/fsl_flexio_spi_edma.h"
status_t FLEXIO_SPI_MasterTransferGetCountEDMA(FLEXIO_SPI_Type *base,
                                               flexio_spi_master_edma_handle_t *handle,
                                               size_t *count);
# 145 "../../libraries/sdk/drives/fsl_flexio_spi_edma.h"
...
# 169 "../../libraries/sdk/drives/fsl_flexio_spi_edma.h"
...
# 191 "../../libraries/sdk/drives/fsl_flexio_spi_edma.h"
...
# 10 "../../libraries/sdk/drives/fsl_flexio_spi_edma.c" 2
# 21 "../../libraries/sdk/drives/fsl_flexio_spi_edma.c"
typedef struct _flexio_spi_master_edma_private_handle
{
    FLEXIO_SPI_Type *base;
    flexio_spi_master_edma_handle_t *handle;
} flexio_spi_master_edma_private_handle_t;
# 37 "../../libraries/sdk/drives/fsl_flexio_spi_edma.c"
static void FLEXIO_SPI_TxEDMACallback(edma_handle_t *handle, void *param, _Bool transferDone, uint32_t tcds);
...
static void FLEXIO_SPI_RxEDMACallback(edma_handle_t *handle, void *param, _Bool transferDone, uint32_t tcds);
# 56 "../../libraries/sdk/drives/fsl_flexio_spi_edma.c"
...
static const uint32_t s_dummyData = (0xFFFFFFFFU);





static flexio_spi_master_edma_private_handle_t s_edmaPrivateHandle[2];
...
static void FLEXIO_SPI_TxEDMACallback(edma_handle_t *handle, void *param, _Bool transferDone, uint32_t tcds)
{
    ...
    if (transferDone)
    {
        FLEXIO_SPI_EnableDMA(spiPrivateHandle->base, (uint32_t)kFLEXIO_SPI_TxDmaEnable, 0);


        spiPrivateHandle->handle->txInProgress = 0;


        if ((spiPrivateHandle->handle->txInProgress == 0) && (spiPrivateHandle->handle->rxInProgress == 0))
        {
            if (spiPrivateHandle->handle->callback != 0)
            {
...
static void FLEXIO_SPI_RxEDMACallback(edma_handle_t *handle, void *param, _Bool transferDone, uint32_t tcds)
{
    ...
    if (transferDone)
    {
        ...
        FLEXIO_SPI_EnableDMA(spiPrivateHandle->base, (uint32_t)kFLEXIO_SPI_RxDmaEnable, 0);


        spiPrivateHandle->handle->rxInProgress = 0;
                                      ...
                                      flexio_spi_transfer_t *xfer)
{
    ...
    switch (dataFormat)
    {
        ...
        default:
            bytesPerFrame = 1U;
            direction = kFLEXIO_SPI_MsbFirst;
            ((1) ? (void)0 : __aeabi_assert("true", "../../libraries/sdk/drives/fsl_flexio_spi_edma.c", 166),
# 166 "../../libraries/sdk/drives/fsl_flexio_spi_edma.c"
#pragma clang diagnostic push
# 166 "../../libraries/sdk/drives/fsl_flexio_spi_edma.c"
#pragma clang diagnostic ignored "-Wassume"
# 166 "../../libraries/sdk/drives/fsl_flexio_spi_edma.c"
...
# 166 "../../libraries/sdk/drives/fsl_flexio_spi_edma.c"
    ...
    if (xfer->rxData != 0)
    {
        ...
        handle->rxInProgress = 1;
        FLEXIO_SPI_EnableDMA(base, (uint32_t)kFLEXIO_SPI_RxDmaEnable, 1);
    ...
    if (handle->txHandle != 0)
    {
        handle->txInProgress = 1;
        FLEXIO_SPI_EnableDMA(base, (uint32_t)kFLEXIO_SPI_TxDmaEnable, 1);
        EDMA_StartTransfer(handle->txHandle);
    }

    return kStatus_Success;
}
# 290 "../../libraries/sdk/drives/fsl_flexio_spi_edma.c"
status_t FLEXIO_SPI_MasterTransferCreateHandleEDMA(FLEXIO_SPI_Type *base,
                                                   flexio_spi_master_edma_handle_t *handle,
                                                   flexio_spi_master_edma_transfer_callback_t callback,
                                                   void *userData,
                                                   ...
                                                   edma_handle_t *rxHandle)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_flexio_spi_edma.c", 297),
# 297 "../../libraries/sdk/drives/fsl_flexio_spi_edma.c"
#pragma clang diagnostic push
# 297 "../../libraries/sdk/drives/fsl_flexio_spi_edma.c"
#pragma clang diagnostic ignored "-Wassume"
# 297 "../../libraries/sdk/drives/fsl_flexio_spi_edma.c"
...
# 297 "../../libraries/sdk/drives/fsl_flexio_spi_edma.c"
    ...
    handle->txInProgress = 0;
    handle->rxInProgress = 0;
...
# 356 "../../libraries/sdk/drives/fsl_flexio_spi_edma.c"
status_t FLEXIO_SPI_MasterTransferEDMA(FLEXIO_SPI_Type *base,
                                       flexio_spi_master_edma_handle_t *handle,
                                       flexio_spi_transfer_t *xfer)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_flexio_spi_edma.c", 360),
# 360 "../../libraries/sdk/drives/fsl_flexio_spi_edma.c"
#pragma clang diagnostic push
# 360 "../../libraries/sdk/drives/fsl_flexio_spi_edma.c"
#pragma clang diagnostic ignored "-Wassume"
# 360 "../../libraries/sdk/drives/fsl_flexio_spi_edma.c"
...
# 360 "../../libraries/sdk/drives/fsl_flexio_spi_edma.c"
    ...
    ((xfer != 0) ? (void)0 : __aeabi_assert("xfer != NULL", "../../libraries/sdk/drives/fsl_flexio_spi_edma.c", 361),
# 361 "../../libraries/sdk/drives/fsl_flexio_spi_edma.c"
#pragma clang diagnostic push
# 361 "../../libraries/sdk/drives/fsl_flexio_spi_edma.c"
#pragma clang diagnostic ignored "-Wassume"
# 361 "../../libraries/sdk/drives/fsl_flexio_spi_edma.c"
...
# 361 "../../libraries/sdk/drives/fsl_flexio_spi_edma.c"
    ...
    if (((xfer->txData == 0) && (xfer->rxData == 0)) || (xfer->dataSize == 0U))
    {
        return kStatus_InvalidArgument;
    }
...
# 432 "../../libraries/sdk/drives/fsl_flexio_spi_edma.c"
status_t FLEXIO_SPI_MasterTransferGetCountEDMA(FLEXIO_SPI_Type *base,
                                               flexio_spi_master_edma_handle_t *handle,
                                               size_t *count)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_flexio_spi_edma.c", 436),
# 436 "../../libraries/sdk/drives/fsl_flexio_spi_edma.c"
#pragma clang diagnostic push
# 436 "../../libraries/sdk/drives/fsl_flexio_spi_edma.c"
#pragma clang diagnostic ignored "-Wassume"
# 436 "../../libraries/sdk/drives/fsl_flexio_spi_edma.c"
...
void FLEXIO_SPI_MasterTransferAbortEDMA(FLEXIO_SPI_Type *base, flexio_spi_master_edma_handle_t *handle)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_flexio_spi_edma.c", 467),
# 467 "../../libraries/sdk/drives/fsl_flexio_spi_edma.c"
#pragma clang diagnostic push
# 467 "../../libraries/sdk/drives/fsl_flexio_spi_edma.c"
#pragma clang diagnostic ignored "-Wassume"
# 467 "../../libraries/sdk/drives/fsl_flexio_spi_edma.c"
...
# 467 "../../libraries/sdk/drives/fsl_flexio_spi_edma.c"
    ...
    FLEXIO_SPI_EnableDMA(base, (uint32_t)kFLEXIO_SPI_DmaAllEnable, 0);


    handle->txInProgress = 0;
    handle->rxInProgress = 0;
}
# 495 "../../libraries/sdk/drives/fsl_flexio_spi_edma.c"
status_t FLEXIO_SPI_SlaveTransferEDMA(FLEXIO_SPI_Type *base,
                                      flexio_spi_slave_edma_handle_t *handle,
                                      flexio_spi_transfer_t *xfer)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_flexio_spi_edma.c", 499),
# 499 "../../libraries/sdk/drives/fsl_flexio_spi_edma.c"
#pragma clang diagnostic push
# 499 "../../libraries/sdk/drives/fsl_flexio_spi_edma.c"
#pragma clang diagnostic ignored "-Wassume"
# 499 "../../libraries/sdk/drives/fsl_flexio_spi_edma.c"
...
# 499 "../../libraries/sdk/drives/fsl_flexio_spi_edma.c"
    ...
    ((xfer != 0) ? (void)0 : __aeabi_assert("xfer != NULL", "../../libraries/sdk/drives/fsl_flexio_spi_edma.c", 500),
# 500 "../../libraries/sdk/drives/fsl_flexio_spi_edma.c"
#pragma clang diagnostic push
# 500 "../../libraries/sdk/drives/fsl_flexio_spi_edma.c"
#pragma clang diagnostic ignored "-Wassume"
# 500 "../../libraries/sdk/drives/fsl_flexio_spi_edma.c"
