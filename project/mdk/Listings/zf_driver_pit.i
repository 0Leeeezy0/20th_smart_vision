# 1 "../../libraries/zf_driver/zf_driver_pit.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/zf_driver/zf_driver_pit.c" 2
# 36 "../../libraries/zf_driver/zf_driver_pit.c"
...
# 37 "../../libraries/zf_driver/zf_driver_pit.c" 2
...
# 38 "../../libraries/zf_driver/zf_driver_pit.c" 2
...
# 39 "../../libraries/zf_driver/zf_driver_pit.c" 2
...
# 42 "../../libraries/zf_driver/zf_driver_pit.c" 2
...
void pit_enable (pit_index_enum pit_chn)
{
    PIT_StartTimer(((PIT_Type *)(0x40084000u)), (pit_chnl_t)pit_chn);
}
# 62 "../../libraries/zf_driver/zf_driver_pit.c"
void pit_disable (pit_index_enum pit_chn)
{
    PIT_StopTimer(((PIT_Type *)(0x40084000u)), (pit_chnl_t)pit_chn);
}
# 75 "../../libraries/zf_driver/zf_driver_pit.c"
void pit_init (pit_index_enum pit_chn, uint32 period)
{
    ...
    if(0 == init_flag)
    {
        ...
        PIT_Init(((PIT_Type *)(0x40084000u)), &pitConfig);
        PIT_Deinit(((PIT_Type *)(0x40084000u)));
        PIT_Init(((PIT_Type *)(0x40084000u)), &pitConfig);
    }


    PIT_SetTimerPeriod(((PIT_Type *)(0x40084000u)), (pit_chnl_t)pit_chn, period);
    PIT_EnableInterrupts(((PIT_Type *)(0x40084000u)), (pit_chnl_t)pit_chn, kPIT_TimerInterruptEnable);
 PIT_SetTimerChainMode(((PIT_Type *)(0x40084000u)), (pit_chnl_t)pit_chn, 0);
    PIT_StartTimer(((PIT_Type *)(0x40084000u)), (pit_chnl_t)pit_chn);
    EnableIRQ(PIT_IRQn);
}
