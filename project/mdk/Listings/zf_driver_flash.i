# 1 "../../libraries/zf_driver/zf_driver_flash.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/zf_driver/zf_driver_flash.c" 2
# 36 "../../libraries/zf_driver/zf_driver_flash.c"
...
# 37 "../../libraries/zf_driver/zf_driver_flash.c" 2
...
# 38 "../../libraries/zf_driver/zf_driver_flash.c" 2
...
# 39 "../../libraries/zf_driver/zf_driver_flash.c" 2
...
# 40 "../../libraries/zf_driver/zf_driver_flash.c" 2
...
# 41 "../../libraries/zf_driver/zf_driver_flash.c" 2
...
flash_data_union flash_union_buffer[((0x00001000) / sizeof(flash_data_union))];
# 59 "../../libraries/zf_driver/zf_driver_flash.c"
uint8 flash_check (uint32 sector_num, flash_page_enum page_num)
{
    uint16 i;

    status_t state = kStatus_Success;
    DCACHE_CleanInvalidateByRange((0x70000000) + sector_num * ((0x00001000) * (8)) + page_num * (0x00001000), (0x00001000));

    for(i=0; i<(0x00001000)/4; i++)
    {
        if(0xFFFFFFFF != (*(uint32 *)((uint32)(((0x70000000) + sector_num*((0x00001000) * (8)) + page_num*(0x00001000)) + (i*4)))))
        {
            state = kStatus_Fail;
            break;
        }
...
# 86 "../../libraries/zf_driver/zf_driver_flash.c"
uint8 flash_erase_page (uint32 sector_num, flash_page_enum page_num)
{
    uint32 primask;
    status_t state = kStatus_Success;
    primask = interrupt_global_disable();
    state = rom_api_flexspi_nor_flash_erase(flash_instance, &config, sector_num * ((0x00001000) * (8)) + page_num * (0x00001000), (0x00001000));
...
# 111 "../../libraries/zf_driver/zf_driver_flash.c"
void flash_read_page (uint32 sector_num, flash_page_enum page_num, uint32 *buf, uint16 len)
{
    DCACHE_CleanInvalidateByRange((0x70000000) + sector_num * ((0x00001000) * (8)), len * 4);

    rom_api_flexspi_nor_flash_read(flash_instance, &config, buf, sector_num * ((0x00001000) * (8)) + page_num * (0x00001000), len * 4);
}
# 128 "../../libraries/zf_driver/zf_driver_flash.c"
uint8 flash_write_page (uint32 sector_num, flash_page_enum page_num, const uint32 *buf, uint16 len)
{
    ...
    uint32 primask;
    status_t state = kStatus_Success;
    flash_data_union block[64] = {0};

    (debug_assert_handler((len <= ((0x00001000) / sizeof(flash_data_union))), "../../libraries/zf_driver/zf_driver_flash.c", 136));
    ...
    for(i=0; i < (len / 64); i++)
    {
        ...
        state = rom_api_flexspi_nor_flash_page_program(flash_instance, &config, sector_num * ((0x00001000) * (8)) + page_num * (0x00001000) + (i * ((0x00001000) / (16))),(uint32 *)(buf+i * 64));
        interrupt_global_enable(primask);
        if(state != kStatus_Success)
        {
            state = kStatus_Fail;
    ...
    if(0 != len % 64)
    {
        ...
        memcpy(block, (uint32 *)(buf + (i * 64)), (len - (i * 64)) * 4);
        primask = interrupt_global_disable();

        state = rom_api_flexspi_nor_flash_page_program(flash_instance, &config, sector_num * ((0x00001000) * (8)) + page_num * (0x00001000) + (i * ((0x00001000) / (16))),(uint32 *)block);
        interrupt_global_enable(primask);
        if(state != kStatus_Success)
        {
            state = kStatus_Fail;
...
# 180 "../../libraries/zf_driver/zf_driver_flash.c"
void flash_read_page_to_buffer (uint32 sector_num, flash_page_enum page_num)
{
    DCACHE_CleanInvalidateByRange((0x70000000) + sector_num * ((0x00001000) * (8)), (0x00001000));

    rom_api_flexspi_nor_flash_read(flash_instance, &config, (uint32 *)&flash_union_buffer[0], sector_num * ((0x00001000) * (8)) + page_num * (0x00001000), (0x00001000));
}
# 195 "../../libraries/zf_driver/zf_driver_flash.c"
uint8 flash_write_page_from_buffer (uint32 sector_num, flash_page_enum page_num)
{
    uint32 primask;
    status_t state = kStatus_Success;
    primask = interrupt_global_disable();
    flash_write_page(sector_num, page_num, (const uint32 *)&flash_union_buffer[0], ((0x00001000) / sizeof(flash_data_union)));
    interrupt_global_enable(primask);
    return state;
}
# 212 "../../libraries/zf_driver/zf_driver_flash.c"
void flash_buffer_clear (void)
{
    memset(flash_union_buffer, 0xFF, (0x00001000));
}
# 224 "../../libraries/zf_driver/zf_driver_flash.c"
uint8 flash_init (void)
{
