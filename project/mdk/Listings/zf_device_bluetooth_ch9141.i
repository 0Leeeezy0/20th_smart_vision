# 1 "../../libraries/zf_device/zf_device_bluetooth_ch9141.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/zf_device/zf_device_bluetooth_ch9141.c" 2
# 48 "../../libraries/zf_device/zf_device_bluetooth_ch9141.c"
...
# 49 "../../libraries/zf_device/zf_device_bluetooth_ch9141.c" 2
...
# 50 "../../libraries/zf_device/zf_device_bluetooth_ch9141.c" 2
...
# 51 "../../libraries/zf_device/zf_device_bluetooth_ch9141.c" 2
...
# 52 "../../libraries/zf_device/zf_device_bluetooth_ch9141.c" 2
...
# 53 "../../libraries/zf_device/zf_device_bluetooth_ch9141.c" 2
...
# 54 "../../libraries/zf_device/zf_device_bluetooth_ch9141.c" 2
...
# 55 "../../libraries/zf_device/zf_device_bluetooth_ch9141.c" 2
...
# 57 "../../libraries/zf_device/zf_device_bluetooth_ch9141.c" 2

static fifo_struct bluetooth_ch9141_fifo;
static uint8 bluetooth_ch9141_buffer[(64)];

static uint8 bluetooth_ch9141_data = 0;
# 70 "../../libraries/zf_device/zf_device_bluetooth_ch9141.c"
uint32 bluetooth_ch9141_send_byte (const uint8 data)
{
    uint16 time_count = (500);
    while(time_count)
    {
        if(!gpio_get_level((D26)))
        {
            uart_write_byte((UART_8), data);
            break;
        }
        time_count --;
        system_delay_ms(1);
...
# 94 "../../libraries/zf_device/zf_device_bluetooth_ch9141.c"
uint32 bluetooth_ch9141_send_buffer (const uint8 *buff, uint32 len)
{
    (debug_assert_handler((0 != buff), "../../libraries/zf_device/zf_device_bluetooth_ch9141.c", 96));
    uint16 time_count = 0;
    while(0 != len)
    {
        if(!gpio_get_level((D26)))
        {
            if(30 <= len)
            {
                uart_write_buffer((UART_8), buff, 30);
                buff += 30;
                len -= 30;
                time_count = 0;
            }
...
# 135 "../../libraries/zf_device/zf_device_bluetooth_ch9141.c"
uint32 bluetooth_ch9141_send_string (const char *str)
{
    (debug_assert_handler((0 != str), "../../libraries/zf_device/zf_device_bluetooth_ch9141.c", 137));
    uint16 time_count = 0;
    ...
    while(0 != len)
    {
        if(!gpio_get_level((D26)))
        {
            if(30 <= len)
            {
                uart_write_buffer((UART_8), (const uint8 *)str, 30);
                str += 30;
                len -= 30;
                time_count = 0;
            }
            ...
            {
                uart_write_buffer((UART_8), (const uint8 *)str, len);
                len = 0;
                break;
            }
        }
...
# 178 "../../libraries/zf_device/zf_device_bluetooth_ch9141.c"
void bluetooth_ch9141_send_image (const uint8 *image_addr, uint32 image_size)
{
    (debug_assert_handler((0 != image_addr), "../../libraries/zf_device/zf_device_bluetooth_ch9141.c", 180));
...
# 195 "../../libraries/zf_device/zf_device_bluetooth_ch9141.c"
uint32 bluetooth_ch9141_read_buffer (uint8 *buff, uint32 len)
{
    (debug_assert_handler((0 != buff), "../../libraries/zf_device/zf_device_bluetooth_ch9141.c", 197));
    uint32 data_len = len;
    fifo_read_buffer(&bluetooth_ch9141_fifo, buff, &data_len, FIFO_READ_AND_CLEAN);
    return data_len;
}
# 212 "../../libraries/zf_device/zf_device_bluetooth_ch9141.c"
void bluetooth_ch9141_uart_callback (void)
{
    uart_query_byte((UART_8), &bluetooth_ch9141_data);
    fifo_write_buffer(&bluetooth_ch9141_fifo, &bluetooth_ch9141_data, 1);
}
# 225 "../../libraries/zf_device/zf_device_bluetooth_ch9141.c"
uint8 bluetooth_ch9141_init (void)
{
    uint8 return_state = 0;
    set_wireless_type(BLUETOOTH_CH9141, bluetooth_ch9141_uart_callback);

    fifo_init(&bluetooth_ch9141_fifo, FIFO_DATA_8BIT, bluetooth_ch9141_buffer, (64));

    gpio_init((D26), GPI, 1, GPI_PULL_UP);
