# 1 "../../libraries/sdk/drives/fsl_src.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/sdk/drives/fsl_src.c" 2
...
# 1 "../../libraries/sdk/drives/fsl_src.h" 1
# 12 "../../libraries/sdk/drives/fsl_src.h"
...
# 13 "../../libraries/sdk/drives/fsl_src.h" 2
# 32 "../../libraries/sdk/drives/fsl_src.h"
enum _src_reset_status_flags
{
# 42 "../../libraries/sdk/drives/fsl_src.h"
    kSRC_TemperatureSensorResetFlag = (0x100U),





    kSRC_Wdog3ResetFlag = (0x80U),
# 59 "../../libraries/sdk/drives/fsl_src.h"
    kSRC_JTAGSystemResetFlag =
        (0x40U),

    kSRC_JTAGSoftwareResetFlag = (0x40U),

    kSRC_JTAGGeneratedResetFlag = (0x20U),


    kSRC_WatchdogResetFlag = (0x10U),



    kSRC_IppUserResetFlag = (0x8U),
# 81 "../../libraries/sdk/drives/fsl_src.h"
    kSRC_CsuResetFlag = (0x4U),
# 93 "../../libraries/sdk/drives/fsl_src.h"
    ...
    kSRC_IppResetPinFlag = (0x1U),


};
# 149 "../../libraries/sdk/drives/fsl_src.h"
...
# 174 "../../libraries/sdk/drives/fsl_src.h"
static inline void SRC_EnableWDOG3Reset(SRC_Type *base, _Bool enable)
{
    if (enable)
    {
        base->SCR = (base->SCR & ~(0xF0000000U)) | (((uint32_t)(((uint32_t)(0xA)) << (28U))) & (0xF0000000U));
    }
    else
    {
        base->SCR = (base->SCR & ~(0xF0000000U)) | (((uint32_t)(((uint32_t)(0x5)) << (28U))) & (0xF0000000U));
    }
}
# 207 "../../libraries/sdk/drives/fsl_src.h"
static inline void SRC_EnableCoreDebugResetAfterPowerGate(SRC_Type *base, _Bool enable)
{
    if (enable)
    {
        base->SCR &= ~(0x2000000U);
...
# 306 "../../libraries/sdk/drives/fsl_src.h"
...
static inline _Bool SRC_GetSoftwareResetARMCore0Done(SRC_Type *base)
{
    return (0U == (base->SCR & (0x2000U)));
}
# 383 "../../libraries/sdk/drives/fsl_src.h"
static inline void SRC_EnableWDOGReset(SRC_Type *base, _Bool enable)
{
    if (enable)
    {
        base->SCR = (base->SCR & ~(0x780U)) | (((uint32_t)(((uint32_t)(0xA)) << (7U))) & (0x780U));
    }
    else
    {
        base->SCR = (base->SCR & ~(0x780U)) | (((uint32_t)(((uint32_t)(0x5)) << (7U))) & (0x780U));
    }
}
# 499 "../../libraries/sdk/drives/fsl_src.h"
static inline uint32_t SRC_GetBootModeWord1(SRC_Type *base)
{
    return base->SBMR1;
}
# 513 "../../libraries/sdk/drives/fsl_src.h"
static inline uint32_t SRC_GetBootModeWord2(SRC_Type *base)
{
    return base->SBMR2;
}
# 550 "../../libraries/sdk/drives/fsl_src.h"
...
# 575 "../../libraries/sdk/drives/fsl_src.h"
static inline void SRC_SetGeneralPurposeRegister(SRC_Type *base, uint32_t index, uint32_t value)
{
    ((index < (10U)) ? (void)0 : __aeabi_assert("index < SRC_GPR_COUNT", "../../libraries/sdk/drives/fsl_src.h", 577),
# 577 "../../libraries/sdk/drives/fsl_src.h"
#pragma clang diagnostic push
# 577 "../../libraries/sdk/drives/fsl_src.h"
#pragma clang diagnostic ignored "-Wassume"
# 577 "../../libraries/sdk/drives/fsl_src.h"
    (__builtin_assume)((index < (10U))?1:0)
# 577 "../../libraries/sdk/drives/fsl_src.h"
#pragma clang diagnostic pop
# 577 "../../libraries/sdk/drives/fsl_src.h"
    );
...
# 589 "../../libraries/sdk/drives/fsl_src.h"
static inline uint32_t SRC_GetGeneralPurposeRegister(SRC_Type *base, uint32_t index)
{
    ((index < (10U)) ? (void)0 : __aeabi_assert("index < SRC_GPR_COUNT", "../../libraries/sdk/drives/fsl_src.h", 591),
# 591 "../../libraries/sdk/drives/fsl_src.h"
#pragma clang diagnostic push
# 591 "../../libraries/sdk/drives/fsl_src.h"
#pragma clang diagnostic ignored "-Wassume"
# 591 "../../libraries/sdk/drives/fsl_src.h"
...
# 10 "../../libraries/sdk/drives/fsl_src.c" 2
# 34 "../../libraries/sdk/drives/fsl_src.c"
void SRC_ClearResetStatusFlags(SRC_Type *base, uint32_t flags)
{
    ...
    if (0U != (( (0x80U) | (0x40U) | (0x20U) | (0x10U) | (0x8U) | (0x4U) | (0x2U) | (0x1U)) & flags))
    {
        tmp32 |= (( (0x80U) | (0x40U) | (0x20U) | (0x10U) | (0x8U) | (0x4U) | (0x2U) | (0x1U)) & flags);
    }
