# 1 "../../libraries/sdk/drives/fsl_common.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/sdk/drives/fsl_common.c" 2
...
# 10 "../../libraries/sdk/drives/fsl_common.c" 2
...
void *SDK_Malloc(size_t size, size_t alignbytes)
{
    mem_align_cb_t *p_cb = 0;
    uint32_t alignedsize;


    alignedsize = (uint32_t)(unsigned int)((unsigned int)((size) + ((alignbytes)-1U)) & (unsigned int)(~(unsigned int)((alignbytes)-1U)));
    if (alignedsize < size)
    {
        return 0;
    }

    if (alignedsize > 4294967295u - alignbytes - sizeof(mem_align_cb_t))
    {
        return 0;
    }
    ...
    if (p_addr.pointer_value == 0)
    {
        return 0;
    }

    p_align_addr.unsigned_value = ((unsigned int)((p_addr.unsigned_value + sizeof(mem_align_cb_t)) + ((alignbytes)-1U)) & (unsigned int)(~(unsigned int)((alignbytes)-1U)));

    p_cb = (mem_align_cb_t *)(p_align_addr.unsigned_value - 4U);
    p_cb->identifier = 12345U;
