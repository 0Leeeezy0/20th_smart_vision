# 1 "../../libraries/sdk/drives/fsl_gpio.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/sdk/drives/fsl_gpio.c" 2
...
# 12 "../../libraries/sdk/drives/fsl_gpio.h"
...
# 13 "../../libraries/sdk/drives/fsl_gpio.h" 2
...
# 10 "../../libraries/sdk/drives/fsl_gpio.c" 2
# 22 "../../libraries/sdk/drives/fsl_gpio.c"
static GPIO_Type *const s_gpioBases[] = { (GPIO_Type *)0u, ((GPIO_Type *)(0x401B8000u)), ((GPIO_Type *)(0x401BC000u)), ((GPIO_Type *)(0x401C0000u)), ((GPIO_Type *)(0x401C4000u)), ((GPIO_Type *)(0x400C0000u)), ((GPIO_Type *)(0x42000000u)), ((GPIO_Type *)(0x42004000u)), ((GPIO_Type *)(0x42008000u)), ((GPIO_Type *)(0x4200C000u)), ((GPIO_Type *)(0x401C8000u)) };




static const clock_ip_name_t s_gpioClock[] = { kCLOCK_IpInvalid, kCLOCK_Gpio1, kCLOCK_Gpio2, kCLOCK_Gpio3, kCLOCK_Gpio4, kCLOCK_Gpio5 };
# 41 "../../libraries/sdk/drives/fsl_gpio.c"
...
static uint32_t GPIO_GetInstance(GPIO_Type *base)
{
    ...
    for (instance = 0U; instance < (sizeof(s_gpioBases) / sizeof((s_gpioBases)[0])); instance++)
    {
    ...
    ((instance < (sizeof(s_gpioBases) / sizeof((s_gpioBases)[0]))) ? (void)0 : __aeabi_assert("instance < ARRAY_SIZE(s_gpioBases)", "../../libraries/sdk/drives/fsl_gpio.c", 60),
# 60 "../../libraries/sdk/drives/fsl_gpio.c"
#pragma clang diagnostic push
# 60 "../../libraries/sdk/drives/fsl_gpio.c"
#pragma clang diagnostic ignored "-Wassume"
# 60 "../../libraries/sdk/drives/fsl_gpio.c"
    (__builtin_assume)((instance < (sizeof(s_gpioBases) / sizeof((s_gpioBases)[0])))?1:0)
# 60 "../../libraries/sdk/drives/fsl_gpio.c"
#pragma clang diagnostic pop
# 60 "../../libraries/sdk/drives/fsl_gpio.c"
    );
...
# 75 "../../libraries/sdk/drives/fsl_gpio.c"
void GPIO_PinInit(GPIO_Type *base, uint32_t pin, const gpio_pin_config_t *Config)
{
    ...
    if ((instance < (sizeof(s_gpioClock) / sizeof((s_gpioClock)[0]))) && (kCLOCK_IpInvalid != s_gpioClock[instance]))
    {
...
# 115 "../../libraries/sdk/drives/fsl_gpio.c"
void GPIO_PinWrite(GPIO_Type *base, uint32_t pin, uint8_t output)
{
    ((pin < 32U) ? (void)0 : __aeabi_assert("pin < 32U", "../../libraries/sdk/drives/fsl_gpio.c", 117),
# 117 "../../libraries/sdk/drives/fsl_gpio.c"
#pragma clang diagnostic push
# 117 "../../libraries/sdk/drives/fsl_gpio.c"
#pragma clang diagnostic ignored "-Wassume"
# 117 "../../libraries/sdk/drives/fsl_gpio.c"
...
# 144 "../../libraries/sdk/drives/fsl_gpio.c"
void GPIO_PinSetInterruptConfig(GPIO_Type *base, uint32_t pin, gpio_interrupt_mode_t pinInterruptMode)
{
