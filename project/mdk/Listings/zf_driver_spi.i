...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/zf_driver/zf_driver_spi.c" 2
# 37 "../../libraries/zf_driver/zf_driver_spi.c"
# 1 "../../libraries/zf_common\\zf_common_clock.h" 1
# 39 "../../libraries/zf_common\\zf_common_clock.h"
...
# 41 "../../libraries/zf_common/zf_common_typedef.h" 2
# 1 "D:\\KEIL\\ARM\\ARMCLANG\\Bin\\..\\include\\stdbool.h" 1 3
# 42 "../../libraries/zf_common/zf_common_typedef.h" 2
...
# 44 "../../libraries/zf_common/zf_common_typedef.h" 2
...
# 45 "../../libraries/zf_common/zf_common_typedef.h" 2
...
# 46 "../../libraries/zf_common/zf_common_typedef.h" 2
...
# 40 "../../libraries/zf_common\\zf_common_clock.h" 2
...
# 38 "../../libraries/zf_driver/zf_driver_spi.c" 2
...
# 39 "../../libraries/zf_driver/zf_driver_spi.c" 2
...
# 40 "../../libraries/zf_driver/zf_driver_spi.c" 2
...
# 41 "../../libraries/zf_driver/zf_driver_spi.c" 2
...
# 42 "../../libraries/zf_driver/zf_driver_spi.c" 2
...
# 44 "../../libraries/zf_driver/zf_driver_spi.c" 2
...
static LPSPI_Type *spi_index[] = { (LPSPI_Type *)0u, ((LPSPI_Type *)(0x40394000u)), ((LPSPI_Type *)(0x40398000u)), ((LPSPI_Type *)(0x4039C000u)), ((LPSPI_Type *)(0x403A0000u)) };
...
void spi_iomuxc(spi_index_enum spi_n, spi_sck_pin_enum sck_pin, spi_mosi_pin_enum mosi_pin, spi_miso_pin_enum miso_pin, spi_cs_pin_enum cs_pin)
{
    switch(spi_n)
    {
        case SPI_1:
        {
            if (SPI1_SCK_D12 == sck_pin) afio_init(0x401F81BCU, 0x4U, 0x401F84F0U, 0x1U, 0x401F83ACU, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);

            if (SPI1_MOSI_D14 == mosi_pin) afio_init(0x401F81C4U, 0x4U, 0x401F84F8U, 0x1U, 0x401F83B4U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);

            if (SPI1_MISO_D15 == miso_pin) afio_init(0x401F81C8U, 0x4U, 0x401F84F4U, 0x1U, 0x401F83B8U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);

            if (SPI1_CS0_D13 == cs_pin) afio_init(0x401F81C0U, 0x4U, 0x401F84ECU, 0x0U, 0x401F83B0U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);
            else if (SPI1_CS2_D26 == cs_pin) afio_init(0x401F80B4U, 0x2U, 0, 0, 0x401F82A4U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);
            else if (SPI1_CS3_D27 == cs_pin) afio_init(0x401F80B8U, 0x2U, 0, 0, 0x401F82A8U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);
        }break;

        case SPI_3:
        {
            if (SPI3_SCK_B0 == sck_pin) afio_init(0x401F80BCU, 0x7U, 0x401F8510U, 0x0U, 0x401F82ACU, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);
            else if (SPI3_SCK_B31 == sck_pin) afio_init(0x401F8138U, 0x2U, 0x401F8510U, 0x1U, 0x401F8328U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);

            if (SPI3_MOSI_B1 == mosi_pin) afio_init(0x401F80C0U, 0x7U, 0x401F8518U, 0x0U, 0x401F82B0U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);
            else if (SPI3_MOSI_B30 == mosi_pin) afio_init(0x401F8134U, 0x2U, 0x401F8518U, 0x1U, 0x401F8324U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);

            if (SPI3_MISO_B2 == miso_pin) afio_init(0x401F80C4U, 0x7U, 0x401F8514U, 0x0U, 0x401F82B4U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);
            else if (SPI3_MISO_B29 == miso_pin) afio_init(0x401F8130U, 0x2U, 0x401F8514U, 0x1U, 0x401F8320U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);

            if (SPI3_CS0_B3 == cs_pin) afio_init(0x401F80C8U, 0x7U, 0x401F850CU, 0x0U, 0x401F82B8U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);
            else if (SPI3_CS0_B28 == cs_pin) afio_init(0x401F812CU, 0x2U, 0x401F850CU, 0x1U, 0x401F831CU, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);
        }break;

        case SPI_4:
        {
            if (SPI4_SCK_C3 == sck_pin) afio_init(0x401F8148U, 0x3U, 0x401F8520U, 0x0U, 0x401F8338U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);
            else if (SPI4_SCK_C23 == sck_pin) afio_init(0x401F8198U, 0x1U, 0x401F8520U, 0x1U, 0x401F8388U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);

            if (SPI4_MOSI_C2 == mosi_pin) afio_init(0x401F8144U, 0x3U, 0x401F8528U, 0x0U, 0x401F8334U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);
            else if (SPI4_MOSI_C22 == mosi_pin) afio_init(0x401F8194U, 0x1U, 0x401F8528U, 0x1U, 0x401F8384U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);

            if (SPI4_MISO_C1 == miso_pin) afio_init(0x401F8140U, 0x3U, 0x401F8524U, 0x0U, 0x401F8330U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);
            else if (SPI4_MISO_C21 == miso_pin) afio_init(0x401F8190U, 0x1U, 0x401F8524U, 0x1U, 0x401F8380U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);

            if (SPI4_CS0_C0 == cs_pin) afio_init(0x401F813CU, 0x3U, 0x401F851CU, 0x0U, 0x401F832CU, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);
            else if (SPI4_CS0_C20 == cs_pin) afio_init(0x401F818CU, 0x1U, 0x401F851CU, 0x1U, 0x401F837CU, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);
            else if (SPI4_CS1_C19 == cs_pin) afio_init(0x401F8188U, 0x2U, 0, 0, 0x401F8378U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);
            else if (SPI4_CS2_C18 == cs_pin) afio_init(0x401F8184U, 0x2U, 0, 0, 0x401F8374U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);
            else if (SPI4_CS3_C27 == cs_pin) afio_init(0x401F81A8U, 0x6U, 0, 0, 0x401F8398U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);
        }break;

        default:
        {
            (debug_assert_handler((0), "../../libraries/zf_driver/zf_driver_spi.c", 106));
        }break;
    }
}
...
void spi_write(spi_index_enum spi_n, const uint8 *txdata, uint8 *rxdata, uint32 length, uint8 continuous, spi_bit_enum bit)
{
    ...
    (debug_assert_handler((0 < length), "../../libraries/zf_driver/zf_driver_spi.c", 117));

    if(SPI_8BIT == bit)
    {
        spi_index[spi_n]->TCR = ((spi_index[spi_n]->TCR & 0xFFFFF000) | (8 - 1));
    }
    ...
    {
        (debug_assert_handler((0), "../../libraries/zf_driver/zf_driver_spi.c", 129));
    }

    if(continuous) transfer.configFlags = ((spi_cs_index[spi_n]%16/2)<<(4U)) | kLPSPI_MasterPcsContinuous;
    else transfer.configFlags = ((spi_cs_index[spi_n]%16/2)<<(4U));
...
# 185 "../../libraries/zf_driver/zf_driver_spi.c"
void spi_write_8bit_array (spi_index_enum spi_n, const uint8 *data, uint32 length)
{

    lpspi_transfer_t transfer;
    spi_write(spi_n, data, 0, length, 1, SPI_8BIT);
...
# 223 "../../libraries/zf_driver/zf_driver_spi.c"
void spi_write_16bit (spi_index_enum spi_n, const uint16 data)
{

    spi_write(spi_n, (uint8*)&data, 0, 2, 1, SPI_16BIT);
...
{
    (debug_assert_handler((data != 0), "../../libraries/zf_driver/zf_driver_spi.c", 243));

    spi_write(spi_n, (uint8*)data, 0, length * 2, 1, SPI_16BIT);
...
void spi_write_8bit_register (spi_index_enum spi_n, const uint8 register_name, const uint8 data)
{
    ...
    spi_write(spi_n, &register_name, 0, 1, 0, SPI_8BIT);
    spi_write(spi_n, &data, 0, 1, 1, SPI_8BIT);




}
# 284 "../../libraries/zf_driver/zf_driver_spi.c"
void spi_write_8bit_registers (spi_index_enum spi_n, const uint8 register_name, const uint8 *data, uint32 length)
{
    (debug_assert_handler((data != 0), "../../libraries/zf_driver/zf_driver_spi.c", 286));

    spi_write(spi_n, &register_name, 0, 1, 1, SPI_8BIT);
    spi_write(spi_n, data, 0, length, 1, SPI_8BIT);
...
void spi_write_16bit_register (spi_index_enum spi_n, const uint16 register_name, const uint16 data)
{
    ...
    spi_write(spi_n, (uint8*)&register_name, 0, 2, 1, SPI_16BIT);
    spi_write(spi_n, (uint8*)&data, 0, 2, 1, SPI_16BIT);
...
# 329 "../../libraries/zf_driver/zf_driver_spi.c"
void spi_write_16bit_registers (spi_index_enum spi_n, const uint16 register_name, const uint16 *data, uint32 length)
{
    (debug_assert_handler((data != 0), "../../libraries/zf_driver/zf_driver_spi.c", 331));

    spi_write(spi_n, (const uint8 *)&register_name, 0, 2, 1, SPI_16BIT);
    spi_write(spi_n, (const uint8 *)&data, 0, 2 * length, 1, SPI_16BIT);
...
uint8 spi_read_8bit (spi_index_enum spi_n)
{
    ...
    uint8 data = 0;
    spi_write(spi_n, 0, &data, 1, 1, SPI_8BIT);
    return data;



}
# 372 "../../libraries/zf_driver/zf_driver_spi.c"
void spi_read_8bit_array (spi_index_enum spi_n, uint8 *data, uint32 length)
{
    (debug_assert_handler((data != 0), "../../libraries/zf_driver/zf_driver_spi.c", 374));

    spi_write(spi_n, 0, data, length, 1, SPI_8BIT);
...
uint16 spi_read_16bit (spi_index_enum spi_n)
{
    ...
    uint16 data = 0;
    spi_write(spi_n, 0, (uint8 *)&data, 2, 1, SPI_8BIT);
    return data;
...
{
    (debug_assert_handler((data != 0), "../../libraries/zf_driver/zf_driver_spi.c", 415));

    spi_write(spi_n, 0, (uint8 *)data, 2 * length, 1, SPI_8BIT);
...
# 434 "../../libraries/zf_driver/zf_driver_spi.c"
uint8 spi_read_8bit_register (spi_index_enum spi_n, const uint8 register_name)
{

    uint8 data = 0;

    spi_write(spi_n, (const uint8 *)&register_name, 0, 1, 1, SPI_8BIT);
    spi_write(spi_n, 0, (uint8 *)&data, 1, 1, SPI_8BIT);
    return data;
...
{
    (debug_assert_handler((data != 0), "../../libraries/zf_driver/zf_driver_spi.c", 460));

    spi_write(spi_n, (const uint8 *)&register_name, 0, 1, 1, SPI_8BIT);
    spi_write(spi_n, 0, (uint8 *)data, length, 1, SPI_8BIT);
...
# 481 "../../libraries/zf_driver/zf_driver_spi.c"
uint16 spi_read_16bit_register (spi_index_enum spi_n, const uint16 register_name)
{
...
# 504 "../../libraries/zf_driver/zf_driver_spi.c"
void spi_read_16bit_registers (spi_index_enum spi_n, const uint16 register_name, uint16 *data, uint32 length)
{
    (debug_assert_handler((data != 0), "../../libraries/zf_driver/zf_driver_spi.c", 506));
...
# 529 "../../libraries/zf_driver/zf_driver_spi.c"
void spi_transfer_8bit (spi_index_enum spi_n, const uint8 *write_buffer, uint8 *read_buffer, uint32 length)
{
    (debug_assert_handler((write_buffer != 0), "../../libraries/zf_driver/zf_driver_spi.c", 531));

    spi_write(spi_n, write_buffer, read_buffer, length, 1, SPI_8BIT);
# 542 "../../libraries/zf_driver/zf_driver_spi.c"
}
# 554 "../../libraries/zf_driver/zf_driver_spi.c"
void spi_transfer_16bit (spi_index_enum spi_n, const uint16 *write_buffer, uint16 *read_buffer, uint32 length)
{
    (debug_assert_handler((write_buffer != 0), "../../libraries/zf_driver/zf_driver_spi.c", 556));

    spi_write(spi_n, (const uint8 *)write_buffer, (uint8 *)read_buffer, 2 * length, 1, SPI_16BIT);
# 567 "../../libraries/zf_driver/zf_driver_spi.c"
}
# 582 "../../libraries/zf_driver/zf_driver_spi.c"
void spi_init (spi_index_enum spi_n, spi_mode_enum mode, uint32 baud, spi_sck_pin_enum sck_pin, spi_mosi_pin_enum mosi_pin, spi_miso_pin_enum miso_pin, spi_cs_pin_enum cs_pin)
{
    (debug_assert_handler((spi_n == (sck_pin / 16)), "../../libraries/zf_driver/zf_driver_spi.c", 584));
    (debug_assert_handler((spi_n == (mosi_pin / 16)), "../../libraries/zf_driver/zf_driver_spi.c", 585));
    (debug_assert_handler((spi_n == (miso_pin / 16) || (miso_pin == SPI_MISO_NULL)), "../../libraries/zf_driver/zf_driver_spi.c", 586));
    (debug_assert_handler((spi_n == (cs_pin / 16) || (cs_pin == SPI_CS_NULL)), "../../libraries/zf_driver/zf_driver_spi.c", 587));
    ...
    src_clock = (CLOCK_GetFreq(kCLOCK_SysPllClk) / (3 + 1U));

    LPSPI_MasterInit(spi_index[spi_n], &masterConfig, src_clock);
    LPSPI_Reset(spi_index[spi_n]);
    LPSPI_MasterInit(spi_index[spi_n], &masterConfig, src_clock);

    LPSPI_Enable(spi_index[spi_n], 0);
    spi_index[spi_n]->CFGR1 &= (~(0x8U));
    LPSPI_Enable(spi_index[spi_n], 1);

    LPSPI_FlushFifo(spi_index[spi_n], 1, 1);
    LPSPI_ClearStatusFlags(spi_index[spi_n], kLPSPI_AllStatusFlag);
    LPSPI_DisableInterrupts(spi_index[spi_n], kLPSPI_AllInterruptEnable);
}
