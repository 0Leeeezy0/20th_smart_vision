# 1 "../../libraries/zf_device/zf_device_wifi_spi.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/zf_device/zf_device_wifi_spi.c" 2
# 51 "../../libraries/zf_device/zf_device_wifi_spi.c"
...
# 52 "../../libraries/zf_device/zf_device_wifi_spi.c" 2
...
# 40 "../../libraries/zf_common/zf_common_typedef.h"
...
# 53 "../../libraries/zf_device/zf_device_wifi_spi.c" 2
...
# 54 "../../libraries/zf_device/zf_device_wifi_spi.c" 2
...
# 55 "../../libraries/zf_device/zf_device_wifi_spi.c" 2
...
# 56 "../../libraries/zf_device/zf_device_wifi_spi.c" 2
...
# 57 "../../libraries/zf_device/zf_device_wifi_spi.c" 2
...
# 58 "../../libraries/zf_device/zf_device_wifi_spi.c" 2
...
# 59 "../../libraries/zf_device/zf_device_wifi_spi.c" 2
...
# 61 "../../libraries/zf_device/zf_device_wifi_spi.c" 2
...
static uint8 wifi_spi_buffer[(1024)];
...
# 107 "../../libraries/zf_device/zf_device_wifi_spi.c"
static void wifi_spi_write (const uint8 *buffer1, uint16 length1, const uint8 *buffer2, uint16 length2)
{
    GPIO_ClearPinsOutput(PORTPTR[(D13) >> 5],1 << ((D13) & 0x1f));
    if(0 != buffer1)
    {
        spi_write_8bit_array((SPI_1), buffer1, length1);
    }
    if(0 != buffer2)
    {
        spi_write_8bit_array((SPI_1), buffer2, length2);
    }
    GPIO_SetPinsOutput(PORTPTR[(D13) >> 5],1 << ((D13) & 0x1f));
}
# 129 "../../libraries/zf_device/zf_device_wifi_spi.c"
static void wifi_spi_transfer_command (wifi_spi_packets_struct *packets, uint16 length)
{
    GPIO_ClearPinsOutput(PORTPTR[(D13) >> 5],1 << ((D13) & 0x1f));

    spi_transfer_8bit((SPI_1), (uint8 *)&(packets->head), (uint8 *)&(packets->head), sizeof(wifi_spi_head_struct));

    if(length)
    {
        spi_transfer_8bit((SPI_1), (const uint8 *)(packets->buffer), packets->buffer, length);
    }

    GPIO_SetPinsOutput(PORTPTR[(D13) >> 5],1 << ((D13) & 0x1f));
}
# 152 "../../libraries/zf_device/zf_device_wifi_spi.c"
static void wifi_spi_transfer_data (const uint8 *write_data, wifi_spi_packets_struct *read_data, uint16 length)
{
    ...
    spi_transfer_8bit((SPI_1), (uint8 *)&(read_data->head), (uint8 *)&(read_data->head), sizeof(wifi_spi_head_struct));

    if((32) < length)
    {
        spi_transfer_8bit((SPI_1), write_data, read_data->buffer, (32));
        spi_write_8bit_array((SPI_1), &write_data[(32)], length - (32));
    }
    else
    {

        memcpy(read_data->buffer, write_data, length);
        spi_transfer_8bit((SPI_1), read_data->buffer, read_data->buffer, (32));
    }
    GPIO_SetPinsOutput(PORTPTR[(D13) >> 5],1 << ((D13) & 0x1f));
}
# 185 "../../libraries/zf_device/zf_device_wifi_spi.c"
...
# 230 "../../libraries/zf_device/zf_device_wifi_spi.c"
static uint8 wifi_spi_get_parameter (wifi_spi_packets_command_enum command, wifi_spi_packets_struct *read_data, uint32 wait_time)
{
    ...
    do
    {
        ...
        wifi_spi_write(&(read_data->head.command), (32), 0, 0);
        ...
        wifi_spi_transfer_command(read_data, (32));
        return_state = 0;
    }while(0);
    return return_state;
}
# 264 "../../libraries/zf_device/zf_device_wifi_spi.c"
static uint8 wifi_spi_get_version (void)
{
    uint8 return_state;
    wifi_spi_packets_struct temp_packets;

    return_state = wifi_spi_get_parameter(WIFI_SPI_GET_VERSION, &temp_packets, 1000);
...
# 284 "../../libraries/zf_device/zf_device_wifi_spi.c"
static uint8 wifi_spi_get_mac_addr (void)
{
    uint8 return_state;
    wifi_spi_packets_struct temp_packets;

    return_state = wifi_spi_get_parameter(WIFI_SPI_GET_MAC_ADDR, &temp_packets, 1000);
...
# 305 "../../libraries/zf_device/zf_device_wifi_spi.c"
static uint8 wifi_spi_get_ip_addr_port (void)
{
    uint8 return_state;
    wifi_spi_packets_struct temp_packets;

    return_state = wifi_spi_get_parameter(WIFI_SPI_GET_IP_ADDR, &temp_packets, 1000);
...
# 326 "../../libraries/zf_device/zf_device_wifi_spi.c"
uint8 wifi_spi_wifi_connect (char *wifi_ssid, char *pass_word)
{
    uint8 return_state;
    ...
    return_state = wifi_spi_set_parameter(WIFI_SPI_SET_WIFI_INFORMATION, temp_buffer, length, 10000);
...
# 361 "../../libraries/zf_device/zf_device_wifi_spi.c"
uint8 wifi_spi_socket_connect (char *transport_type, char *ip_addr, char *port, char *local_port)
{
    uint8 return_state;
    ...
    return_state = wifi_spi_set_parameter(WIFI_SPI_SET_SOCKET_INFORMATION, temp_buffer, length, 50000);
...
# 384 "../../libraries/zf_device/zf_device_wifi_spi.c"
uint8 wifi_spi_socket_disconnect (void)
{
    wifi_spi_packets_struct temp_packets;

    return wifi_spi_get_parameter(WIFI_SPI_CLOSE_SOCKET, &temp_packets, 1000);
}
# 398 "../../libraries/zf_device/zf_device_wifi_spi.c"
uint8 wifi_spi_reset (void)
{
    ...
    do
    {
        ...
        head.length = 0xA5A5;
        return_state = wifi_spi_wait_idle(1000);
        if(return_state)
        {
            break;
        }
        wifi_spi_write(&head.command, sizeof(wifi_spi_head_struct), 0, 0);
    }while(0);

    return return_state;
}
# 425 "../../libraries/zf_device/zf_device_wifi_spi.c"
uint8 wifi_spi_udp_send_now (void)
{
    ...
    if(WIFI_SPI_IDLE == wifi_spi_mutex)
    {
        ...
        do
        {
            ...
            wifi_spi_transfer_command(&temp_packets, (32));
...
# 489 "../../libraries/zf_device/zf_device_wifi_spi.c"
uint32 wifi_spi_send_buffer (const uint8 *buffer, uint32 length)
{
    ...
    if(WIFI_SPI_IDLE == wifi_spi_mutex)
    {
        ...
        while(length)
        {
            send_length = length > (4088) ? (4088) : length;
...
# 559 "../../libraries/zf_device/zf_device_wifi_spi.c"
void wifi_spi_send_string(const char *string)
{
    wifi_spi_send_buffer((uint8*)string, strlen(string));
}
# 572 "../../libraries/zf_device/zf_device_wifi_spi.c"
uint32 wifi_spi_read_buffer (uint8 *buffer, uint32 length)
{
    (debug_assert_handler((0 != buffer), "../../libraries/zf_device/zf_device_wifi_spi.c", 574));
...
# 622 "../../libraries/zf_device/zf_device_wifi_spi.c"
uint8 wifi_spi_init (char *wifi_ssid, char *pass_word)
{
    uint8 return_state = 0;

    fifo_init(&wifi_spi_fifo, FIFO_DATA_8BIT, wifi_spi_buffer, (1024));
    spi_init((SPI_1), SPI_MODE3, (50 * 1000 * 1000), (SPI1_SCK_D12), (SPI1_MOSI_D14), (SPI1_MISO_D15), SPI_CS_NULL);
    gpio_init((D13), GPO, 1, GPO_PUSH_PULL);
    gpio_init((B16), GPO, 1, GPO_PUSH_PULL);
    gpio_init((B17), GPI, 0, GPI_PULL_DOWN);
...
# 675 "../../libraries/zf_device/zf_device_wifi_spi.c"
    }while(0);
