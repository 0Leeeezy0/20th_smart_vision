# 1 "../../libraries/sdk/drives/fsl_gpt.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/sdk/drives/fsl_gpt.c" 2
...
# 1 "../../libraries/sdk/drives/fsl_gpt.h" 1
# 12 "../../libraries/sdk/drives/fsl_gpt.h"
...
# 13 "../../libraries/sdk/drives/fsl_gpt.h" 2
# 32 "../../libraries/sdk/drives/fsl_gpt.h"
...
{
    kGPT_OutputCompare1InterruptEnable = (0x1U),
    kGPT_OutputCompare2InterruptEnable = (0x2U),
    kGPT_OutputCompare3InterruptEnable = (0x4U),
    kGPT_InputCapture1InterruptEnable = (0x8U),
    kGPT_InputCapture2InterruptEnable = (0x10U),
    kGPT_RollOverFlagInterruptEnable = (0x20U),
} gpt_interrupt_enable_t;


typedef enum _gpt_status_flag
{
    kGPT_OutputCompare1Flag = (0x1U),
    kGPT_OutputCompare2Flag = (0x2U),
    kGPT_OutputCompare3Flag = (0x4U),
    kGPT_InputCapture1Flag = (0x8U),
    kGPT_InputCapture2Flag = (0x10U),
    kGPT_RollOverFlag = (0x20U),
} gpt_status_flag_t;
...
typedef struct _gpt_init_config
{
    ...
    uint32_t divider;
    _Bool enableFreeRun;
    _Bool enableRunInWait;
    _Bool enableRunInStop;
    _Bool enableRunInDoze;
    _Bool enableRunInDbg;
    _Bool enableMode;

} gpt_config_t;
# 131 "../../libraries/sdk/drives/fsl_gpt.h"
...
{
    return (gpt_clock_source_t)(uint8_t)((base->CR & (0x1C0U)) >> (6U));
}
...
{
    ((divider - 1U <= (0xFFFU)) ? (void)0 : __aeabi_assert("divider - 1U <= GPT_PR_PRESCALER_MASK", "../../libraries/sdk/drives/fsl_gpt.h", 219),
# 219 "../../libraries/sdk/drives/fsl_gpt.h"
#pragma clang diagnostic push
# 219 "../../libraries/sdk/drives/fsl_gpt.h"
#pragma clang diagnostic ignored "-Wassume"
# 219 "../../libraries/sdk/drives/fsl_gpt.h"
    (__builtin_assume)((divider - 1U <= (0xFFFU))?1:0)
# 219 "../../libraries/sdk/drives/fsl_gpt.h"
#pragma clang diagnostic pop
# 219 "../../libraries/sdk/drives/fsl_gpt.h"
    );

    base->PR = (base->PR & ~(0xFFFU)) | (((uint32_t)(((uint32_t)(divider - 1U)) << (0U))) & (0xFFFU));
}
...
{
    ((divider - 1U <= ((0xF000U) >> (12U))) ? (void)0 : __aeabi_assert("divider - 1U <= (GPT_PR_PRESCALER24M_MASK >> GPT_PR_PRESCALER24M_SHIFT)", "../../libraries/sdk/drives/fsl_gpt.h", 243),
# 243 "../../libraries/sdk/drives/fsl_gpt.h"
#pragma clang diagnostic push
# 243 "../../libraries/sdk/drives/fsl_gpt.h"
#pragma clang diagnostic ignored "-Wassume"
# 243 "../../libraries/sdk/drives/fsl_gpt.h"
    (__builtin_assume)((divider - 1U <= ((0xF000U) >> (12U)))?1:0)
# 243 "../../libraries/sdk/drives/fsl_gpt.h"
#pragma clang diagnostic pop
# 243 "../../libraries/sdk/drives/fsl_gpt.h"
    );

    base->PR = (base->PR & ~(0xF000U)) | (((uint32_t)(((uint32_t)(divider - 1U)) << (12U))) & (0xF000U));
}
...
{
    return ((base->PR & (0xF000U)) >> (12U)) + 1U;
}
# 270 "../../libraries/sdk/drives/fsl_gpt.h"
...
# 296 "../../libraries/sdk/drives/fsl_gpt.h"
static inline uint32_t GPT_GetCurrentTimerCount(GPT_Type *base)
{
    return base->CNT;
}
# 315 "../../libraries/sdk/drives/fsl_gpt.h"
...
{
    ((channel <= kGPT_InputCapture_Channel2) ? (void)0 : __aeabi_assert("channel <= kGPT_InputCapture_Channel2", "../../libraries/sdk/drives/fsl_gpt.h", 319),
# 319 "../../libraries/sdk/drives/fsl_gpt.h"
#pragma clang diagnostic push
# 319 "../../libraries/sdk/drives/fsl_gpt.h"
#pragma clang diagnostic ignored "-Wassume"
# 319 "../../libraries/sdk/drives/fsl_gpt.h"
    (__builtin_assume)((channel <= kGPT_InputCapture_Channel2)?1:0)
# 319 "../../libraries/sdk/drives/fsl_gpt.h"
#pragma clang diagnostic pop
# 319 "../../libraries/sdk/drives/fsl_gpt.h"
    );
    ...
    base->CR =
        (base->CR & ~((0x30000U) << ((uint32_t)channel * 2UL))) | ((((uint32_t)(((uint32_t)(mode)) << (16U))) & (0x30000U)) << ((uint32_t)channel * 2UL));
}
# 332 "../../libraries/sdk/drives/fsl_gpt.h"
static inline gpt_input_operation_mode_t GPT_GetInputOperationMode(GPT_Type *base, gpt_input_capture_channel_t channel)
{
    ((channel <= kGPT_InputCapture_Channel2) ? (void)0 : __aeabi_assert("channel <= kGPT_InputCapture_Channel2", "../../libraries/sdk/drives/fsl_gpt.h", 334),
# 334 "../../libraries/sdk/drives/fsl_gpt.h"
#pragma clang diagnostic push
# 334 "../../libraries/sdk/drives/fsl_gpt.h"
#pragma clang diagnostic ignored "-Wassume"
# 334 "../../libraries/sdk/drives/fsl_gpt.h"
...
# 334 "../../libraries/sdk/drives/fsl_gpt.h"
    ...
    return (gpt_input_operation_mode_t)(uint8_t)((base->CR >> ((16U) + (uint32_t)channel * 2UL)) &
                                                 ((0x30000U) >> (16U)));
}
# 347 "../../libraries/sdk/drives/fsl_gpt.h"
static inline uint32_t GPT_GetInputCaptureValue(GPT_Type *base, gpt_input_capture_channel_t channel)
{
    ((channel <= kGPT_InputCapture_Channel2) ? (void)0 : __aeabi_assert("channel <= kGPT_InputCapture_Channel2", "../../libraries/sdk/drives/fsl_gpt.h", 349),
# 349 "../../libraries/sdk/drives/fsl_gpt.h"
#pragma clang diagnostic push
# 349 "../../libraries/sdk/drives/fsl_gpt.h"
#pragma clang diagnostic ignored "-Wassume"
# 349 "../../libraries/sdk/drives/fsl_gpt.h"
...
# 361 "../../libraries/sdk/drives/fsl_gpt.h"
...
{
    ((channel <= kGPT_OutputCompare_Channel3) ? (void)0 : __aeabi_assert("channel <= kGPT_OutputCompare_Channel3", "../../libraries/sdk/drives/fsl_gpt.h", 365),
# 365 "../../libraries/sdk/drives/fsl_gpt.h"
#pragma clang diagnostic push
# 365 "../../libraries/sdk/drives/fsl_gpt.h"
#pragma clang diagnostic ignored "-Wassume"
# 365 "../../libraries/sdk/drives/fsl_gpt.h"
    (__builtin_assume)((channel <= kGPT_OutputCompare_Channel3)?1:0)
# 365 "../../libraries/sdk/drives/fsl_gpt.h"
#pragma clang diagnostic pop
# 365 "../../libraries/sdk/drives/fsl_gpt.h"
    );
    ...
    base->CR =
        (base->CR & ~((0x700000U) << ((uint32_t)channel * 3UL))) | ((((uint32_t)(((uint32_t)(mode)) << (20U))) & (0x700000U)) << ((uint32_t)channel * 3UL));
}
# 378 "../../libraries/sdk/drives/fsl_gpt.h"
static inline gpt_output_operation_mode_t GPT_GetOutputOperationMode(GPT_Type *base,
                                                                     gpt_output_compare_channel_t channel)
{
    ((channel <= kGPT_OutputCompare_Channel3) ? (void)0 : __aeabi_assert("channel <= kGPT_OutputCompare_Channel3", "../../libraries/sdk/drives/fsl_gpt.h", 381),
# 381 "../../libraries/sdk/drives/fsl_gpt.h"
#pragma clang diagnostic push
# 381 "../../libraries/sdk/drives/fsl_gpt.h"
#pragma clang diagnostic ignored "-Wassume"
# 381 "../../libraries/sdk/drives/fsl_gpt.h"
...
# 381 "../../libraries/sdk/drives/fsl_gpt.h"
    ...
    return (gpt_output_operation_mode_t)(uint8_t)((base->CR >> ((20U) + (uint32_t)channel * 3UL)) &
                                                  ((0x700000U) >> (20U)));
}
# 394 "../../libraries/sdk/drives/fsl_gpt.h"
static inline void GPT_SetOutputCompareValue(GPT_Type *base, gpt_output_compare_channel_t channel, uint32_t value)
{
    ((channel <= kGPT_OutputCompare_Channel3) ? (void)0 : __aeabi_assert("channel <= kGPT_OutputCompare_Channel3", "../../libraries/sdk/drives/fsl_gpt.h", 396),
# 396 "../../libraries/sdk/drives/fsl_gpt.h"
#pragma clang diagnostic push
# 396 "../../libraries/sdk/drives/fsl_gpt.h"
#pragma clang diagnostic ignored "-Wassume"
# 396 "../../libraries/sdk/drives/fsl_gpt.h"
...
# 408 "../../libraries/sdk/drives/fsl_gpt.h"
static inline uint32_t GPT_GetOutputCompareValue(GPT_Type *base, gpt_output_compare_channel_t channel)
{
    ((channel <= kGPT_OutputCompare_Channel3) ? (void)0 : __aeabi_assert("channel <= kGPT_OutputCompare_Channel3", "../../libraries/sdk/drives/fsl_gpt.h", 410),
# 410 "../../libraries/sdk/drives/fsl_gpt.h"
#pragma clang diagnostic push
# 410 "../../libraries/sdk/drives/fsl_gpt.h"
#pragma clang diagnostic ignored "-Wassume"
# 410 "../../libraries/sdk/drives/fsl_gpt.h"
...
{
    ((channel <= kGPT_OutputCompare_Channel3) ? (void)0 : __aeabi_assert("channel <= kGPT_OutputCompare_Channel3", "../../libraries/sdk/drives/fsl_gpt.h", 423),
# 423 "../../libraries/sdk/drives/fsl_gpt.h"
#pragma clang diagnostic push
# 423 "../../libraries/sdk/drives/fsl_gpt.h"
#pragma clang diagnostic ignored "-Wassume"
# 423 "../../libraries/sdk/drives/fsl_gpt.h"
...
# 423 "../../libraries/sdk/drives/fsl_gpt.h"
    ...
    base->CR |= ((0x20000000U) << (uint32_t)channel);
}
# 442 "../../libraries/sdk/drives/fsl_gpt.h"
static inline void GPT_EnableInterrupts(GPT_Type *base, uint32_t mask)
{
    base->IR |= mask;
}
# 454 "../../libraries/sdk/drives/fsl_gpt.h"
static inline void GPT_DisableInterrupts(GPT_Type *base, uint32_t mask)
{
    base->IR &= ~mask;
}
# 467 "../../libraries/sdk/drives/fsl_gpt.h"
static inline uint32_t GPT_GetEnabledInterrupts(GPT_Type *base)
{
    return (base->IR & ((0x1U) | (0x2U) | (0x4U) | (0x8U) |
                        (0x10U) | (0x20U)));
}
# 485 "../../libraries/sdk/drives/fsl_gpt.h"
...
# 10 "../../libraries/sdk/drives/fsl_gpt.c" 2
# 25 "../../libraries/sdk/drives/fsl_gpt.c"
static GPT_Type *const s_gptBases[] = { (GPT_Type *)0u, ((GPT_Type *)(0x401EC000u)), ((GPT_Type *)(0x401F0000u)) };


static const clock_ip_name_t s_gptClocks[] = { kCLOCK_IpInvalid, kCLOCK_Gpt1, kCLOCK_Gpt2 };
...
static uint32_t GPT_GetInstance(GPT_Type *base)
{
    ...
    for (instance = 0U; instance < (sizeof(s_gptBases) / sizeof((s_gptBases)[0])); instance++)
    {
    ...
    ((instance < (sizeof(s_gptBases) / sizeof((s_gptBases)[0]))) ? (void)0 : __aeabi_assert("instance < ARRAY_SIZE(s_gptBases)", "../../libraries/sdk/drives/fsl_gpt.c", 46),
# 46 "../../libraries/sdk/drives/fsl_gpt.c"
#pragma clang diagnostic push
# 46 "../../libraries/sdk/drives/fsl_gpt.c"
#pragma clang diagnostic ignored "-Wassume"
# 46 "../../libraries/sdk/drives/fsl_gpt.c"
    (__builtin_assume)((instance < (sizeof(s_gptBases) / sizeof((s_gptBases)[0])))?1:0)
# 46 "../../libraries/sdk/drives/fsl_gpt.c"
#pragma clang diagnostic pop
# 46 "../../libraries/sdk/drives/fsl_gpt.c"
    );
...
# 58 "../../libraries/sdk/drives/fsl_gpt.c"
void GPT_Init(GPT_Type *base, const gpt_config_t *initConfig)
{
    ((0 != initConfig) ? (void)0 : __aeabi_assert("NULL != initConfig", "../../libraries/sdk/drives/fsl_gpt.c", 60),
# 60 "../../libraries/sdk/drives/fsl_gpt.c"
#pragma clang diagnostic push
# 60 "../../libraries/sdk/drives/fsl_gpt.c"
#pragma clang diagnostic ignored "-Wassume"
# 60 "../../libraries/sdk/drives/fsl_gpt.c"
    (__builtin_assume)((0 != initConfig)?1:0)
# 60 "../../libraries/sdk/drives/fsl_gpt.c"
#pragma clang diagnostic pop
# 60 "../../libraries/sdk/drives/fsl_gpt.c"
    );
    ...
    base->CR =
        (initConfig->enableFreeRun ? (0x200U) : 0UL) | (initConfig->enableRunInWait ? (0x8U) : 0UL) |
        (initConfig->enableRunInStop ? (0x20U) : 0UL) |
        (initConfig->enableRunInDoze ? (0x10U) : 0UL) |
        (initConfig->enableRunInDbg ? (0x4U) : 0UL) | (initConfig->enableMode ? (0x2U) : 0UL);
...
# 112 "../../libraries/sdk/drives/fsl_gpt.c"
void GPT_GetDefaultConfig(gpt_config_t *config)
{
    ((0 != config) ? (void)0 : __aeabi_assert("NULL != config", "../../libraries/sdk/drives/fsl_gpt.c", 114),
# 114 "../../libraries/sdk/drives/fsl_gpt.c"
#pragma clang diagnostic push
# 114 "../../libraries/sdk/drives/fsl_gpt.c"
#pragma clang diagnostic ignored "-Wassume"
# 114 "../../libraries/sdk/drives/fsl_gpt.c"
...
# 114 "../../libraries/sdk/drives/fsl_gpt.c"
    ...
    config->divider = 1U;
    config->enableRunInStop = 1;
    config->enableRunInWait = 1;
    config->enableRunInDoze = 0;
    config->enableRunInDbg = 0;
    config->enableFreeRun = 0;
    config->enableMode = 1;
}
