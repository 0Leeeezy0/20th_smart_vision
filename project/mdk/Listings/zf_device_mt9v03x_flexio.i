# 1 "../../libraries/zf_device/zf_device_mt9v03x_flexio.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/zf_device/zf_device_mt9v03x_flexio.c" 2
# 50 "../../libraries/zf_device/zf_device_mt9v03x_flexio.c"
...
# 51 "../../libraries/zf_device/zf_device_mt9v03x_flexio.c" 2
...
# 52 "../../libraries/zf_device/zf_device_mt9v03x_flexio.c" 2
...
# 53 "../../libraries/zf_device/zf_device_mt9v03x_flexio.c" 2
...
# 54 "../../libraries/zf_device/zf_device_mt9v03x_flexio.c" 2
...
# 56 "../../libraries/zf_device/zf_device_mt9v03x_flexio.c" 2
...
# 57 "../../libraries/zf_device/zf_device_mt9v03x_flexio.c" 2
...
# 58 "../../libraries/zf_device/zf_device_mt9v03x_flexio.c" 2
...
# 59 "../../libraries/zf_device/zf_device_mt9v03x_flexio.c" 2
...
# 60 "../../libraries/zf_device/zf_device_mt9v03x_flexio.c" 2
...
# 61 "../../libraries/zf_device/zf_device_mt9v03x_flexio.c" 2
...
# 63 "../../libraries/zf_device/zf_device_mt9v03x_flexio.c" 2

vuint8 mt9v03x_flexio_finish_flag = 0;

__attribute__((section(".bss.NonCacheable"))) __attribute__((aligned(4))) uint8 mt9v03x_flexio_image[(120)][(188)];
...
static int16 mt9v03x_flexio_set_confing_buffer[MT9V03X_FLEXIO_CONFIG_FINISH][2]=
{
    ...
    {MT9V03X_FLEXIO_AUTO_EXP, (0 )},
    {MT9V03X_FLEXIO_EXP_TIME, (512)},
    {MT9V03X_FLEXIO_FPS, (50 )},
    {MT9V03X_FLEXIO_SET_COL, (188)},
    {MT9V03X_FLEXIO_SET_ROW, (120)},
    {MT9V03X_FLEXIO_LR_OFFSET, (0 )},
    {MT9V03X_FLEXIO_UD_OFFSET, (0 )},
    {MT9V03X_FLEXIO_GAIN, (32 )},
    {MT9V03X_FLEXIO_PCLK_MODE, (0 )},
};
...
{
    {MT9V03X_FLEXIO_AUTO_EXP, 0},
    {MT9V03X_FLEXIO_EXP_TIME, 0},
    {MT9V03X_FLEXIO_FPS, 0},
    {MT9V03X_FLEXIO_SET_COL, 0},
    {MT9V03X_FLEXIO_SET_ROW, 0},
    {MT9V03X_FLEXIO_LR_OFFSET, 0},
    {MT9V03X_FLEXIO_UD_OFFSET, 0},
    {MT9V03X_FLEXIO_GAIN, 0},
    {MT9V03X_FLEXIO_PCLK_MODE, 0},
};
# 108 "../../libraries/zf_device/zf_device_mt9v03x_flexio.c"
...
# 162 "../../libraries/zf_device/zf_device_mt9v03x_flexio.c"
...
# 218 "../../libraries/zf_device/zf_device_mt9v03x_flexio.c"
uint16 mt9v03x_flexio_get_version (void)
{
    uint16 temp;
    uint8 uart_buffer[4];
...
# 256 "../../libraries/zf_device/zf_device_mt9v03x_flexio.c"
uint8 mt9v03x_flexio_set_exposure_time (uint16 light)
{
    uint8 return_state = 0;
    if(MT9V03X_FLEXIO_UART == mt9v03x_flexio_type)
    {
        ...
        if((temp != light) || ((0x0080) <= timeout_count))
        {
            return_state = 1;
        }
    }
...
# 304 "../../libraries/zf_device/zf_device_mt9v03x_flexio.c"
uint8 mt9v03x_flexio_set_reg (uint8 addr, uint16 data)
{
    uint8 return_state = 0;
    if(MT9V03X_FLEXIO_UART == mt9v03x_flexio_type)
...
# 360 "../../libraries/zf_device/zf_device_mt9v03x_flexio.c"
...
# 381 "../../libraries/zf_device/zf_device_mt9v03x_flexio.c"
...
# 397 "../../libraries/zf_device/zf_device_mt9v03x_flexio.c"
static void mt9v03x_flexio_dma_callback(edma_handle_t *handle, void *param, _Bool transferDone, uint32_t tcds)
{

 mt9v03x_flexio_finish_flag = 1;
}
# 410 "../../libraries/zf_device/zf_device_mt9v03x_flexio.c"
uint8 mt9v03x_flexio_init (void)
{
    uint8 return_state = 0;
    ...
    {
        system_delay_ms(200);
        set_flexio_camera_type(CAMERA_GRAYSCALE, &mt9v03x_flexio_vsync_callback, 0, &mt9v03x_flexio_uart_callback);


        mt9v03x_flexio_type = MT9V03X_FLEXIO_SCCB;
        soft_iic_init(&mt9v03x_flexio_iic_struct, 0, (800), (C17), (C16));
        if(mt9v03x_set_config_sccb(&mt9v03x_flexio_iic_struct, mt9v03x_flexio_set_confing_buffer))
        {
            ...
            camera_fifo_init();
            set_camera_type(CAMERA_GRAYSCALE, 0, 0, &mt9v03x_flexio_uart_callback);
            uart_init ((UART_4 ), (9600 ), (UART4_TX_C16), (UART4_RX_C17));
            uart_rx_interrupt((UART_4 ), 1);
            fifo_clear(&camera_receiver_fifo);
            mt9v03x_flexio_version = mt9v03x_flexio_get_version();
            ...
            if(mt9v03x_flexio_set_config(mt9v03x_flexio_set_confing_buffer))
            {
                ...
                (debug_log_handler((0), ("MT9V03X FLEXIO set config error."), "../../libraries/zf_device/zf_device_mt9v03x_flexio.c", 438));
            ...
            if(mt9v03x_flexio_get_config(mt9v03x_flexio_get_confing_buffer))
            {
                ...
                (debug_log_handler((0), ("MT9V03X FLEXIO get config error."), "../../libraries/zf_device/zf_device_mt9v03x_flexio.c", 450));
                set_camera_type(NO_CAMERE, 0, 0, 0);
                return_state = 1;
                break;
            }
        ...
        flexio_csi_init(FLEXIO2_D08_C8, FLEXIO2_D05_C5, FLEXIO2_D06_C6, (188), (120), mt9v03x_flexio_image[0], mt9v03x_flexio_dma_callback);
