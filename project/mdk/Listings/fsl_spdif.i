# 1 "../../libraries/sdk/drives/fsl_spdif.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/sdk/drives/fsl_spdif.c" 2
...
# 1 "../../libraries/sdk/drives/fsl_spdif.h" 1
# 13 "../../libraries/sdk/drives/fsl_spdif.h"
...
# 14 "../../libraries/sdk/drives/fsl_spdif.h" 2
# 30 "../../libraries/sdk/drives/fsl_spdif.h"
enum
{
    kStatus_SPDIF_RxDPLLLocked = ((((kStatusGroup_SPDIF)*100L) + (0))),
    kStatus_SPDIF_TxFIFOError = ((((kStatusGroup_SPDIF)*100L) + (1))),
    kStatus_SPDIF_TxFIFOResync = ((((kStatusGroup_SPDIF)*100L) + (2))),
    kStatus_SPDIF_RxCnew = ((((kStatusGroup_SPDIF)*100L) + (3))),
    kStatus_SPDIF_ValidatyNoGood = ((((kStatusGroup_SPDIF)*100L) + (4))),
    kStatus_SPDIF_RxIllegalSymbol = ((((kStatusGroup_SPDIF)*100L) + (5))),
    kStatus_SPDIF_RxParityBitError = ((((kStatusGroup_SPDIF)*100L) + (6))),
    kStatus_SPDIF_UChannelOverrun = ((((kStatusGroup_SPDIF)*100L) + (7))),
    kStatus_SPDIF_QChannelOverrun = ((((kStatusGroup_SPDIF)*100L) + (8))),
    kStatus_SPDIF_UQChannelSync = ((((kStatusGroup_SPDIF)*100L) + (9))),
    kStatus_SPDIF_UQChannelFrameError = ((((kStatusGroup_SPDIF)*100L) + (10))),
    kStatus_SPDIF_RxFIFOError = ((((kStatusGroup_SPDIF)*100L) + (11))),
    kStatus_SPDIF_RxFIFOResync = ((((kStatusGroup_SPDIF)*100L) + (12))),
    kStatus_SPDIF_LockLoss = ((((kStatusGroup_SPDIF)*100L) + (13))),
    kStatus_SPDIF_TxIdle = ((((kStatusGroup_SPDIF)*100L) + (14))),
    kStatus_SPDIF_RxIdle = ((((kStatusGroup_SPDIF)*100L) + (15))),
    kStatus_SPDIF_QueueFull = ((((kStatusGroup_SPDIF)*100L) + (16)))
};
...
enum
{
    kSPDIF_RxDPLLLocked = (0x100000U),
    kSPDIF_TxFIFOError = (0x80000U),
    kSPDIF_TxFIFOResync = (0x40000U),
    kSPDIF_RxControlChannelChange = (0x20000U),
    kSPDIF_ValidityFlagNoGood = (0x10000U),
    kSPDIF_RxIllegalSymbol = (0x8000U),
    kSPDIF_RxParityBitError = (0x4000U),
    kSPDIF_UChannelReceiveRegisterFull = (0x400U),
    kSPDIF_UChannelReceiveRegisterOverrun = (0x200U),
    kSPDIF_QChannelReceiveRegisterFull = (0x100U),
    kSPDIF_QChannelReceiveRegisterOverrun = (0x80U),
    kSPDIF_UQChannelSync = (0x40U),
    kSPDIF_UQChannelFrameError = (0x20U),
    kSPDIF_RxFIFOError = (0x10U),
    kSPDIF_RxFIFOResync = (0x8U),
    kSPDIF_LockLoss = (0x4U),
    kSPDIF_TxFIFOEmpty = (0x2U),
    kSPDIF_RxFIFOFull = (0x1U),
...
enum
{
    kSPDIF_RxDMAEnable = (0x200U),
    kSPDIF_TxDMAEnable = (0x100U),
};
...
# 212 "../../libraries/sdk/drives/fsl_spdif.h"
void SPDIF_Init(SPDIF_Type *base, const spdif_config_t *config);
# 228 "../../libraries/sdk/drives/fsl_spdif.h"
void SPDIF_GetDefaultConfig(spdif_config_t *config);
# 237 "../../libraries/sdk/drives/fsl_spdif.h"
...
# 253 "../../libraries/sdk/drives/fsl_spdif.h"
static inline void SPDIF_TxFIFOReset(SPDIF_Type *base)
{
    base->SCR |= (0x200000U);
}
# 265 "../../libraries/sdk/drives/fsl_spdif.h"
...
void SPDIF_TxEnable(SPDIF_Type *base, _Bool enable);
...
static inline void SPDIF_RxEnable(SPDIF_Type *base, _Bool enable)
{
    if (enable)
    {

        base->SCR &= ~((0x800000U) | (0x400000U));
    }
    else
    {
        base->SCR |= (0x400000U);
...
# 544 "../../libraries/sdk/drives/fsl_spdif.h"
...
# 10 "../../libraries/sdk/drives/fsl_spdif.c" 2
# 20 "../../libraries/sdk/drives/fsl_spdif.c"
enum
{
    kSPDIF_Busy = 0x0U,
    kSPDIF_Idle,
...
# 37 "../../libraries/sdk/drives/fsl_spdif.c"
static SPDIF_Type *const s_spdifBases[] = { ((SPDIF_Type *)(0x40380000u)) };

static spdif_handle_t *s_spdifHandle[(sizeof(s_spdifBases) / sizeof((s_spdifBases)[0]))][2];

static const IRQn_Type s_spdifIRQ[] = { SPDIF_IRQn };


static const clock_ip_name_t s_spdifClock[] = { kCLOCK_Spdif };
...
uint32_t SPDIF_GetInstance(SPDIF_Type *base)
{
    ...
    for (instance = 0; instance < (sizeof(s_spdifBases) / sizeof((s_spdifBases)[0])); instance++)
    {
    ...
    ((instance < (sizeof(s_spdifBases) / sizeof((s_spdifBases)[0]))) ? (void)0 : __aeabi_assert("instance < ARRAY_SIZE(s_spdifBases)", "../../libraries/sdk/drives/fsl_spdif.c", 71),
# 71 "../../libraries/sdk/drives/fsl_spdif.c"
#pragma clang diagnostic push
# 71 "../../libraries/sdk/drives/fsl_spdif.c"
#pragma clang diagnostic ignored "-Wassume"
# 71 "../../libraries/sdk/drives/fsl_spdif.c"
    (__builtin_assume)((instance < (sizeof(s_spdifBases) / sizeof((s_spdifBases)[0])))?1:0)
# 71 "../../libraries/sdk/drives/fsl_spdif.c"
#pragma clang diagnostic pop
# 71 "../../libraries/sdk/drives/fsl_spdif.c"
    );
...
# 90 "../../libraries/sdk/drives/fsl_spdif.c"
void SPDIF_Init(SPDIF_Type *base, const spdif_config_t *config)
{
    uint32_t val = 0;
    ...
    while ((base->SCR & (0x1000U)) != 0x00U)
    {
    }


    base->SCR = (((uint32_t)(((uint32_t)(config->rxFullSelect)) << (19U))) & (0x180000U)) | (((uint32_t)(((uint32_t)(config->isRxAutoSync)) << (18U))) & (0x40000U)) |
                (((uint32_t)(((uint32_t)(config->isRxAutoSync)) << (17U))) & (0x20000U)) | (((uint32_t)(((uint32_t)(config->txFullSelect)) << (15U))) & (0x18000U)) |
                (((uint32_t)(((uint32_t)(1U)) << (10U))) & (0xC00U)) | (((uint32_t)(((uint32_t)(config->validityConfig)) << (5U))) & (0x20U)) |
                (((uint32_t)(((uint32_t)(config->txSource)) << (2U))) & (0x1CU)) | (((uint32_t)(((uint32_t)(config->uChannelSrc)) << (0U))) & (0x3U));


    base->SRPC = (((uint32_t)(((uint32_t)(config->DPLLClkSource)) << (7U))) & (0x780U)) | (((uint32_t)(((uint32_t)(config->gain)) << (3U))) & (0x38U));


    val = base->STC & ~(0x700U);
    val |= (((uint32_t)(((uint32_t)(config->txClkSource)) << (8U))) & (0x700U));
    base->STC = val;
...
# 133 "../../libraries/sdk/drives/fsl_spdif.c"
void SPDIF_Deinit(SPDIF_Type *base)
{
    SPDIF_TxEnable(base, 0);
    SPDIF_RxEnable(base, 0);

    CLOCK_DisableClock(s_spdifClock[SPDIF_GetInstance(base)]);

}
# 156 "../../libraries/sdk/drives/fsl_spdif.c"
void SPDIF_GetDefaultConfig(spdif_config_t *config)
{

    (void)memset(config, 0, sizeof(*config));

    config->isTxAutoSync = 1;
    config->isRxAutoSync = 1;
...
void SPDIF_TxEnable(SPDIF_Type *base, _Bool enable)
{
    ...
    if (enable)
    {
        ...
        val = base->SCR & (~(0xC00U));
        val |= (((uint32_t)(((uint32_t)(1U)) << (10U))) & (0xC00U));
        base->SCR = val;
    ...
    {
        base->SCR &= ~((0xC00U) | (0x1CU));

        base->STC &= ~(0x80U);
    }
}
# 209 "../../libraries/sdk/drives/fsl_spdif.c"
void SPDIF_TxSetSampleRate(SPDIF_Type *base, uint32_t sampleRate_Hz, uint32_t sourceClockFreq_Hz)
{
    uint32_t clkDiv = sourceClockFreq_Hz / (sampleRate_Hz * 64U);
    uint32_t mod = sourceClockFreq_Hz % (sampleRate_Hz * 64U);
    uint32_t val = 0;
    uint8_t clockSource = (uint8_t)(((base->STC) & (0x700U)) >> (8U));
    ...
    if (clockSource == 5U)
    {
        if (clkDiv > 256U)
        {
            val = base->STC & (~((0x7FU) | (0xFF800U)));
            val |= (((uint32_t)(((uint32_t)((clkDiv / 128U) - 1U)) << (11U))) & (0xFF800U)) | (((uint32_t)(((uint32_t)(127U)) << (0U))) & (0x7FU));
            base->STC = val;
        }
        else
        {
            val = base->STC & (~((0x7FU) | (0xFF800U)));
            val |= (((uint32_t)(((uint32_t)(1U)) << (11U))) & (0xFF800U)) | (((uint32_t)(((uint32_t)(clkDiv - 1U)) << (0U))) & (0x7FU));
            base->STC = val;
        }
    }
    else
    {
        ...
        val = base->STC & (~((0x7FU) | (0xFF800U)));
        val |= (((uint32_t)(((uint32_t)(clkDiv - 1U)) << (0U))) & (0x7FU));
        base->STC = val;
    }
}
# 256 "../../libraries/sdk/drives/fsl_spdif.c"
uint32_t SPDIF_GetRxSampleRate(SPDIF_Type *base, uint32_t clockSourceFreq_Hz)
{
    uint64_t gain = s_spdif_gain[((base->SRPC & (0x38U)) >> (3U))];
    uint32_t measure = 0;
    uint32_t sampleRate = 0;
    uint64_t temp = 0;


    while ((base->SRPC & (0x40U)) == 0U)
    {
    }
...
# 286 "../../libraries/sdk/drives/fsl_spdif.c"
void SPDIF_WriteBlocking(SPDIF_Type *base, uint8_t *buffer, uint32_t size)
{
    ((buffer != 0) ? (void)0 : __aeabi_assert("buffer != NULL", "../../libraries/sdk/drives/fsl_spdif.c", 288),
# 288 "../../libraries/sdk/drives/fsl_spdif.c"
#pragma clang diagnostic push
# 288 "../../libraries/sdk/drives/fsl_spdif.c"
#pragma clang diagnostic ignored "-Wassume"
# 288 "../../libraries/sdk/drives/fsl_spdif.c"
...
# 288 "../../libraries/sdk/drives/fsl_spdif.c"
    ...
    (((size % 6U) == 0U) ? (void)0 : __aeabi_assert("(size % 6U) == 0U", "../../libraries/sdk/drives/fsl_spdif.c", 289),
# 289 "../../libraries/sdk/drives/fsl_spdif.c"
#pragma clang diagnostic push
# 289 "../../libraries/sdk/drives/fsl_spdif.c"
#pragma clang diagnostic ignored "-Wassume"
# 289 "../../libraries/sdk/drives/fsl_spdif.c"
    (__builtin_assume)(((size % 6U) == 0U)?1:0)
# 289 "../../libraries/sdk/drives/fsl_spdif.c"
#pragma clang diagnostic pop
# 289 "../../libraries/sdk/drives/fsl_spdif.c"
    );
...
# 330 "../../libraries/sdk/drives/fsl_spdif.c"
void SPDIF_ReadBlocking(SPDIF_Type *base, uint8_t *buffer, uint32_t size)
{
    ((buffer != 0) ? (void)0 : __aeabi_assert("buffer != NULL", "../../libraries/sdk/drives/fsl_spdif.c", 332),
# 332 "../../libraries/sdk/drives/fsl_spdif.c"
#pragma clang diagnostic push
# 332 "../../libraries/sdk/drives/fsl_spdif.c"
#pragma clang diagnostic ignored "-Wassume"
# 332 "../../libraries/sdk/drives/fsl_spdif.c"
...
# 332 "../../libraries/sdk/drives/fsl_spdif.c"
    ...
    (((size % 6U) == 0U) ? (void)0 : __aeabi_assert("(size % 6U) == 0U", "../../libraries/sdk/drives/fsl_spdif.c", 333),
# 333 "../../libraries/sdk/drives/fsl_spdif.c"
#pragma clang diagnostic push
# 333 "../../libraries/sdk/drives/fsl_spdif.c"
#pragma clang diagnostic ignored "-Wassume"
# 333 "../../libraries/sdk/drives/fsl_spdif.c"
...
# 375 "../../libraries/sdk/drives/fsl_spdif.c"
void SPDIF_TransferTxCreateHandle(SPDIF_Type *base,
                                  spdif_handle_t *handle,
                                  spdif_transfer_callback_t callback,
                                  void *userData)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_spdif.c", 380),
# 380 "../../libraries/sdk/drives/fsl_spdif.c"
#pragma clang diagnostic push
# 380 "../../libraries/sdk/drives/fsl_spdif.c"
#pragma clang diagnostic ignored "-Wassume"
# 380 "../../libraries/sdk/drives/fsl_spdif.c"
...
# 380 "../../libraries/sdk/drives/fsl_spdif.c"
    ...
    handle->watermark =
        s_spdif_tx_watermark[(base->SCR & (0x18000U)) >> (15U)];
...
# 410 "../../libraries/sdk/drives/fsl_spdif.c"
void SPDIF_TransferRxCreateHandle(SPDIF_Type *base,
                                  spdif_handle_t *handle,
                                  spdif_transfer_callback_t callback,
                                  void *userData)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_spdif.c", 415),
# 415 "../../libraries/sdk/drives/fsl_spdif.c"
#pragma clang diagnostic push
# 415 "../../libraries/sdk/drives/fsl_spdif.c"
#pragma clang diagnostic ignored "-Wassume"
# 415 "../../libraries/sdk/drives/fsl_spdif.c"
...
# 415 "../../libraries/sdk/drives/fsl_spdif.c"
    ...
    handle->userData = userData;
    handle->watermark =
        s_spdif_rx_watermark[(base->SCR & (0x180000U)) >> (19U)];
...
# 449 "../../libraries/sdk/drives/fsl_spdif.c"
status_t SPDIF_TransferSendNonBlocking(SPDIF_Type *base, spdif_handle_t *handle, spdif_transfer_t *xfer)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_spdif.c", 451),
# 451 "../../libraries/sdk/drives/fsl_spdif.c"
#pragma clang diagnostic push
# 451 "../../libraries/sdk/drives/fsl_spdif.c"
#pragma clang diagnostic ignored "-Wassume"
# 451 "../../libraries/sdk/drives/fsl_spdif.c"
...
# 451 "../../libraries/sdk/drives/fsl_spdif.c"
    ...
    if (handle->spdifQueue[handle->queueUser].data != 0)
    {
    ...
    handle->queueUser = (handle->queueUser + 0x01U) % (4U);
    ...
    SPDIF_TxEnable(base, 1);

    return kStatus_Success;
}
# 492 "../../libraries/sdk/drives/fsl_spdif.c"
status_t SPDIF_TransferReceiveNonBlocking(SPDIF_Type *base, spdif_handle_t *handle, spdif_transfer_t *xfer)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_spdif.c", 494),
# 494 "../../libraries/sdk/drives/fsl_spdif.c"
#pragma clang diagnostic push
# 494 "../../libraries/sdk/drives/fsl_spdif.c"
#pragma clang diagnostic ignored "-Wassume"
# 494 "../../libraries/sdk/drives/fsl_spdif.c"
...
# 494 "../../libraries/sdk/drives/fsl_spdif.c"
    ...
    SPDIF_RxEnable(base, 1);

    return kStatus_Success;
}
# 543 "../../libraries/sdk/drives/fsl_spdif.c"
status_t SPDIF_TransferGetSendCount(SPDIF_Type *base, spdif_handle_t *handle, size_t *count)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_spdif.c", 545),
# 545 "../../libraries/sdk/drives/fsl_spdif.c"
#pragma clang diagnostic push
# 545 "../../libraries/sdk/drives/fsl_spdif.c"
#pragma clang diagnostic ignored "-Wassume"
# 545 "../../libraries/sdk/drives/fsl_spdif.c"
...
# 571 "../../libraries/sdk/drives/fsl_spdif.c"
status_t SPDIF_TransferGetReceiveCount(SPDIF_Type *base, spdif_handle_t *handle, size_t *count)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_spdif.c", 573),
# 573 "../../libraries/sdk/drives/fsl_spdif.c"
#pragma clang diagnostic push
# 573 "../../libraries/sdk/drives/fsl_spdif.c"
#pragma clang diagnostic ignored "-Wassume"
# 573 "../../libraries/sdk/drives/fsl_spdif.c"
...
# 599 "../../libraries/sdk/drives/fsl_spdif.c"
void SPDIF_TransferAbortSend(SPDIF_Type *base, spdif_handle_t *handle)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_spdif.c", 601),
# 601 "../../libraries/sdk/drives/fsl_spdif.c"
#pragma clang diagnostic push
# 601 "../../libraries/sdk/drives/fsl_spdif.c"
#pragma clang diagnostic ignored "-Wassume"
# 601 "../../libraries/sdk/drives/fsl_spdif.c"
...
# 601 "../../libraries/sdk/drives/fsl_spdif.c"
    ...
    (void)memset(handle->spdifQueue, 0, sizeof(spdif_transfer_t) * (4U));
    handle->queueDriver = 0;
    handle->queueUser = 0;
}
# 623 "../../libraries/sdk/drives/fsl_spdif.c"
void SPDIF_TransferAbortReceive(SPDIF_Type *base, spdif_handle_t *handle)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_spdif.c", 625),
# 625 "../../libraries/sdk/drives/fsl_spdif.c"
#pragma clang diagnostic push
# 625 "../../libraries/sdk/drives/fsl_spdif.c"
#pragma clang diagnostic ignored "-Wassume"
# 625 "../../libraries/sdk/drives/fsl_spdif.c"
...
void SPDIF_TransferTxHandleIRQ(SPDIF_Type *base, spdif_handle_t *handle)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_spdif.c", 648),
# 648 "../../libraries/sdk/drives/fsl_spdif.c"
#pragma clang diagnostic push
# 648 "../../libraries/sdk/drives/fsl_spdif.c"
#pragma clang diagnostic ignored "-Wassume"
# 648 "../../libraries/sdk/drives/fsl_spdif.c"
...
# 648 "../../libraries/sdk/drives/fsl_spdif.c"
        ...
        ((base->SIE & (uint32_t)kSPDIF_TxFIFOEmpty) != 0x00U))
    {
        ...
        if (handle->spdifQueue[handle->queueDriver].dataSize == 0U)
        {
            ...
            handle->queueDriver = (handle->queueDriver + 0x01U) % (4U);
        ...
        if (handle->spdifQueue[handle->queueDriver].data == 0)
        {
...
void SPDIF_TransferRxHandleIRQ(SPDIF_Type *base, spdif_handle_t *handle)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_spdif.c", 711),
# 711 "../../libraries/sdk/drives/fsl_spdif.c"
#pragma clang diagnostic push
# 711 "../../libraries/sdk/drives/fsl_spdif.c"
#pragma clang diagnostic ignored "-Wassume"
# 711 "../../libraries/sdk/drives/fsl_spdif.c"
...
# 711 "../../libraries/sdk/drives/fsl_spdif.c"
    ...
    if ((SPDIF_GetStatusFlag(base) & (uint32_t)kSPDIF_RxControlChannelChange) != 0x00U)
    {
        ...
        SPDIF_ClearStatusFlags(base, (0x20000U));
        if (handle->callback != 0)
        {
...
void SPDIF_DriverIRQHandler(void)
{
    if ((s_spdifHandle[0][0] != 0) && (s_spdifTxIsr != 0))
    {
        s_spdifTxIsr(((SPDIF_Type *)(0x40380000u)), s_spdifHandle[0][0]);
    }

    if ((s_spdifHandle[0][1] != 0) && (s_spdifRxIsr != 0))
    {
        s_spdifRxIsr(((SPDIF_Type *)(0x40380000u)), s_spdifHandle[0][1]);
    }
    __builtin_arm_dsb(0xF);
}
