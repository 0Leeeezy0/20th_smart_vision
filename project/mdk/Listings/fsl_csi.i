# 1 "../../libraries/sdk/drives/fsl_csi.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/sdk/drives/fsl_csi.c" 2
...
# 12 "../../libraries/sdk/drives/fsl_csi.h"
...
# 13 "../../libraries/sdk/drives/fsl_csi.h" 2
...
# 126 "../../libraries/sdk/drives/fsl_csi.c"
static uint32_t CSI_GetRxBufferAddr(CSI_Type *base, uint8_t index);


typedef void (*csi_isr_t)(CSI_Type *base, csi_handle_t *handle);
# 141 "../../libraries/sdk/drives/fsl_csi.c"
static CSI_Type *const s_csiBases[] = { ((CSI_Type *)(0x402BC000u)) };



static const clock_ip_name_t s_csiClocks[] = { kCLOCK_Csi };




static csi_handle_t *s_csiHandle[(sizeof(s_csiBases) / sizeof((s_csiBases)[0]))];





static const IRQn_Type s_csiIRQ[] = { CSI_IRQn };
...
static uint32_t CSI_GetInstance(CSI_Type *base)
{
    ...
    for (instance = 0; instance < (sizeof(s_csiBases) / sizeof((s_csiBases)[0])); instance++)
    {
    ...
    ((instance < (sizeof(s_csiBases) / sizeof((s_csiBases)[0]))) ? (void)0 : __aeabi_assert("instance < ARRAY_SIZE(s_csiBases)", "../../libraries/sdk/drives/fsl_csi.c", 181),
# 181 "../../libraries/sdk/drives/fsl_csi.c"
#pragma clang diagnostic push
# 181 "../../libraries/sdk/drives/fsl_csi.c"
#pragma clang diagnostic ignored "-Wassume"
# 181 "../../libraries/sdk/drives/fsl_csi.c"
    (__builtin_assume)((instance < (sizeof(s_csiBases) / sizeof((s_csiBases)[0])))?1:0)
# 181 "../../libraries/sdk/drives/fsl_csi.c"
#pragma clang diagnostic pop
# 181 "../../libraries/sdk/drives/fsl_csi.c"
    );
...
static uint8_t CSI_TransferGetQueueDelta(uint8_t startIdx, uint8_t endIdx)
{
    ...
    {
        ret = (uint8_t)(endIdx + (4U + 1U) - startIdx);
    }
...
{
    uint8_t ret;
# 214 "../../libraries/sdk/drives/fsl_csi.c"
    ret = idx + 1U;
...
static uint32_t CSI_TransferGetEmptyBuffer(csi_handle_t *handle)
{
# 239 "../../libraries/sdk/drives/fsl_csi.c"
...
# 283 "../../libraries/sdk/drives/fsl_csi.c"
status_t CSI_Init(CSI_Type *base, const csi_config_t *config)
{
    ((0 != config) ? (void)0 : __aeabi_assert("NULL != config", "../../libraries/sdk/drives/fsl_csi.c", 285),
# 285 "../../libraries/sdk/drives/fsl_csi.c"
#pragma clang diagnostic push
# 285 "../../libraries/sdk/drives/fsl_csi.c"
#pragma clang diagnostic ignored "-Wassume"
# 285 "../../libraries/sdk/drives/fsl_csi.c"
...
# 285 "../../libraries/sdk/drives/fsl_csi.c"
    ...
    reg = ((uint32_t)config->workMode) | config->polarityFlags | (0x100U);
    ...
    (base)->IMAG_PARA =
        (((uint32_t)config->width * (uint32_t)busCyclePerPixel) << (16U)) |
        ((uint32_t)(config->height) << (0U));


    (base)->FBUF_PARA = (uint32_t)((config->linePitch_Bytes - imgWidth_Bytes) / 8U)
                              << (0U);
    ...
    {
        (base)->CR2 = (((uint32_t)(((uint32_t)(3U)) << (30U))) & (0xC0000000U));
        (base)->CR3 = ((base)->CR3 & ~(0x70U)) | ((2U << (4U)));
    }
    else if (0U == (imgWidth_Bytes % (8U * 8U)))
    {
        (base)->CR2 = (((uint32_t)(((uint32_t)(2U)) << (30U))) & (0xC0000000U));
        (base)->CR3 = ((base)->CR3 & ~(0x70U)) | ((1U << (4U)));
    }
    else
    {
        (base)->CR2 = (((uint32_t)(((uint32_t)(1U)) << (30U))) & (0xC0000000U));
        (base)->CR3 = ((base)->CR3 & ~(0x70U)) | ((0U << (4U)));
    }
...
# 384 "../../libraries/sdk/drives/fsl_csi.c"
void CSI_Deinit(CSI_Type *base)
{
...
# 401 "../../libraries/sdk/drives/fsl_csi.c"
void CSI_Reset(CSI_Type *base)
{
    uint32_t csisr;
    ...
    (base)->CR1 = (0x800U) | (0x40000000U);
    (base)->CR2 = 0U;
    (base)->CR3 = 0U;



    (base)->CR18 = (((uint32_t)(((uint32_t)(0x0DU)) << (12U))) & (0xF000U));

    (base)->FBUF_PARA = 0U;
    (base)->IMAG_PARA = 0U;
}
# 458 "../../libraries/sdk/drives/fsl_csi.c"
void CSI_GetDefaultConfig(csi_config_t *config)
{
    ((0 != config) ? (void)0 : __aeabi_assert("NULL != config", "../../libraries/sdk/drives/fsl_csi.c", 460),
# 460 "../../libraries/sdk/drives/fsl_csi.c"
#pragma clang diagnostic push
# 460 "../../libraries/sdk/drives/fsl_csi.c"
#pragma clang diagnostic ignored "-Wassume"
# 460 "../../libraries/sdk/drives/fsl_csi.c"
...
# 460 "../../libraries/sdk/drives/fsl_csi.c"
    ...
    config->useExtVsync = 1;
}
# 482 "../../libraries/sdk/drives/fsl_csi.c"
void CSI_SetRxBufferAddr(CSI_Type *base, uint8_t index, uint32_t addr)
{
    addr = (addr);
...
# 504 "../../libraries/sdk/drives/fsl_csi.c"
void CSI_ClearFifo(CSI_Type *base, csi_fifo_t fifo)
{
    uint32_t cr1;
    uint32_t mask = 0U;
    ...
    (base)->CR1 = (cr1 & ~(0x100U)) | mask;


    while (0U != ((base)->CR1 & mask))
    {
    }
...
# 547 "../../libraries/sdk/drives/fsl_csi.c"
void CSI_ReflashFifoDma(CSI_Type *base, csi_fifo_t fifo)
{
    uint32_t cr3 = 0U;
    ...
    while (0U != ((base)->CR3 & cr3))
    {
    }
}
# 576 "../../libraries/sdk/drives/fsl_csi.c"
void CSI_EnableFifoDmaRequest(CSI_Type *base, csi_fifo_t fifo, _Bool enable)
{
    uint32_t cr3 = 0U;
...
void CSI_EnableInterrupts(CSI_Type *base, uint32_t mask)
{
    (base)->CR1 |= (mask & 0xFFFF0000U);
    (base)->CR3 |= (mask & 0x000000FFU);
    (base)->CR18 |= ((mask & 0x0000FF00U) >> 6U);
}
...
# 640 "../../libraries/sdk/drives/fsl_csi.c"
status_t CSI_TransferCreateHandle(CSI_Type *base,
                                  csi_handle_t *handle,
                                  csi_transfer_callback_t callback,
                                  void *userData)
{
    ((0 != handle) ? (void)0 : __aeabi_assert("NULL != handle", "../../libraries/sdk/drives/fsl_csi.c", 645),
# 645 "../../libraries/sdk/drives/fsl_csi.c"
#pragma clang diagnostic push
# 645 "../../libraries/sdk/drives/fsl_csi.c"
#pragma clang diagnostic ignored "-Wassume"
# 645 "../../libraries/sdk/drives/fsl_csi.c"
...
# 682 "../../libraries/sdk/drives/fsl_csi.c"
status_t CSI_TransferStart(CSI_Type *base, csi_handle_t *handle)
{
    ((0 != handle) ? (void)0 : __aeabi_assert("NULL != handle", "../../libraries/sdk/drives/fsl_csi.c", 684),
# 684 "../../libraries/sdk/drives/fsl_csi.c"
#pragma clang diagnostic push
# 684 "../../libraries/sdk/drives/fsl_csi.c"
#pragma clang diagnostic ignored "-Wassume"
# 684 "../../libraries/sdk/drives/fsl_csi.c"
...
# 684 "../../libraries/sdk/drives/fsl_csi.c"
    ...
    (base)->CR18 = ((base)->CR18 & ~(0xC0000U)) | (((uint32_t)(((uint32_t)(0)) << (18U))) & (0xC0000U)) |
                         (0x20U) | (0x10U);


    (base)->DMASA_FB1 = (CSI_TransferGetEmptyBuffer(handle));
    (base)->DMASA_FB2 = (CSI_TransferGetEmptyBuffer(handle));

    handle->activeBufferNum = 2U;


    CSI_ReflashFifoDma(base, kCSI_RxFifo);

    handle->transferStarted = 1;
...
# 734 "../../libraries/sdk/drives/fsl_csi.c"
status_t CSI_TransferStop(CSI_Type *base, csi_handle_t *handle)
{
    ((0 != handle) ? (void)0 : __aeabi_assert("NULL != handle", "../../libraries/sdk/drives/fsl_csi.c", 736),
# 736 "../../libraries/sdk/drives/fsl_csi.c"
#pragma clang diagnostic push
# 736 "../../libraries/sdk/drives/fsl_csi.c"
#pragma clang diagnostic ignored "-Wassume"
# 736 "../../libraries/sdk/drives/fsl_csi.c"
...
# 777 "../../libraries/sdk/drives/fsl_csi.c"
status_t CSI_TransferSubmitEmptyBuffer(CSI_Type *base, csi_handle_t *handle, uint32_t frameBuffer)
{
    uint32_t csicr1;
    ...
    (base)->CR1 = (csicr1 & ~((0x100000U) | (0x80000U)));
...
# 809 "../../libraries/sdk/drives/fsl_csi.c"
status_t CSI_TransferGetFullBuffer(CSI_Type *base, csi_handle_t *handle, uint32_t *frameBuffer)
{
    uint32_t csicr1;
    status_t status;
...
# 852 "../../libraries/sdk/drives/fsl_csi.c"
void CSI_TransferHandleIRQ(CSI_Type *base, csi_handle_t *handle)
{
    uint8_t queueWriteIdx;
    uint8_t queueReadIdx;
    ...
    if ((csisr & ((0x100000U) | (0x80000U))) ==
        ((0x100000U) | (0x80000U)))
    {
        ;
    }
    else if (0U != (csisr & ((0x100000U) | (0x80000U))))
    {
        if (0U != (csisr & (0x100000U)))
        {
            dmaDoneBufferIdx = 1;
        }
        else
        ...
        if (handle->activeBufferNum == 2U)
        {
            queueWriteIdx = handle->queueWriteIdx;
            queueReadIdx = handle->queueReadIdx;

            if (CSI_TransferGetQueueDelta(queueReadIdx, queueWriteIdx) < 4U)
            {
...
# 1407 "../../libraries/sdk/drives/fsl_csi.c"
void CSI_DriverIRQHandler(void)
{
    s_csiIsr(((CSI_Type *)(0x402BC000u)), s_csiHandle[0]);
    __builtin_arm_dsb(0xF);
}
