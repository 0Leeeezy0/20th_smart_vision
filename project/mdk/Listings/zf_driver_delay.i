# 1 "../../libraries/zf_driver/zf_driver_delay.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/zf_driver/zf_driver_delay.c" 2
# 37 "../../libraries/zf_driver/zf_driver_delay.c"
...
# 38 "../../libraries/zf_driver/zf_driver_delay.c" 2
...
# 39 "../../libraries/zf_driver/zf_driver_delay.c" 2
...
# 41 "../../libraries/zf_driver/zf_driver_delay.c" 2
# 51 "../../libraries/zf_driver/zf_driver_delay.c"
void system_delay_ms (uint32 time)
{
    while(time --)
    {
        GPT_SetOutputCompareValue(((GPT_Type *)(0x401F0000u)), kGPT_OutputCompare_Channel1, (24000000)/1000);
        GPT_StartTimer(((GPT_Type *)(0x401F0000u)));
        while(!GPT_GetStatusFlags(((GPT_Type *)(0x401F0000u)), kGPT_OutputCompare1Flag));
        GPT_ClearStatusFlags(((GPT_Type *)(0x401F0000u)), kGPT_OutputCompare1Flag);
        GPT_StopTimer(((GPT_Type *)(0x401F0000u)));
    }
}
# 70 "../../libraries/zf_driver/zf_driver_delay.c"
void system_delay_us (uint32 time)
{
    while(time --)
    {
        GPT_SetOutputCompareValue(((GPT_Type *)(0x401F0000u)), kGPT_OutputCompare_Channel1, (24000000) / 1000 / 1000);
        GPT_StartTimer(((GPT_Type *)(0x401F0000u)));
        while(!GPT_GetStatusFlags(((GPT_Type *)(0x401F0000u)), kGPT_OutputCompare1Flag));
        GPT_ClearStatusFlags(((GPT_Type *)(0x401F0000u)), kGPT_OutputCompare1Flag);
        GPT_StopTimer(((GPT_Type *)(0x401F0000u)));
...
void system_delay_init(void)
{
    ...
    gptConfig.divider = 1;
    GPT_Init(((GPT_Type *)(0x401F0000u)), &gptConfig);
    GPT_Deinit(((GPT_Type *)(0x401F0000u)));
    GPT_Init(((GPT_Type *)(0x401F0000u)), &gptConfig);
}
