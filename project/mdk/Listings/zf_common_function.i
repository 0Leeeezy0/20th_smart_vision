# 1 "../../libraries/zf_common/zf_common_function.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/zf_common/zf_common_function.c" 2
# 36 "../../libraries/zf_common/zf_common_function.c"
...
# 37 "../../libraries/zf_common/zf_common_function.c" 2
...
# 39 "../../libraries/zf_common/zf_common_function.c" 2
...
# 40 "../../libraries/zf_common/zf_common_function.c" 2
# 51 "../../libraries/zf_common/zf_common_function.c"
void func_get_sin_amplitude_table (uint32 *data_buffer, uint32 sample_max, uint32 amplitude_max, uint32 offset_degree)
{
    uint32 i = 0, j = 0;
    double rad = 0.0;
    ...
    j = amplitude_max / 2;
    rad = 3.1415926535898 * 2 / sample_max;
...
# 78 "../../libraries/zf_common/zf_common_function.c"
uint32 func_get_greatest_common_divisor (uint32 num1, uint32 num2)
{
    while(num1 != num2)
    {
...
# 101 "../../libraries/zf_common/zf_common_function.c"
void func_soft_delay (volatile long t)
{
    while(t --);
}
# 113 "../../libraries/zf_common/zf_common_function.c"
int32 func_str_to_int (char *str)
{
    (debug_assert_handler((0 != str), "../../libraries/zf_common/zf_common_function.c", 115));
    uint8 sign = 0;
    int32 temp = 0;
    do
    {
...
# 157 "../../libraries/zf_common/zf_common_function.c"
void func_int_to_str (char *str, int32 number)
{
    (debug_assert_handler((0 != str), "../../libraries/zf_common/zf_common_function.c", 159));
    uint8 data_temp[16];
    uint8 bit = 0;
    int32 number_temp = 0;
    ...
    do
    {
        ...
        while(0 != number)
        {
            ...
            data_temp[bit ++] = ((number_temp) >= 0 ? (number_temp): -(number_temp));
            number /= 10;
        }
        while(0 != bit)
        {
...
# 203 "../../libraries/zf_common/zf_common_function.c"
uint32 func_str_to_uint (char *str)
{
    (debug_assert_handler((0 != str), "../../libraries/zf_common/zf_common_function.c", 205));
    uint32 temp = 0;
...
# 233 "../../libraries/zf_common/zf_common_function.c"
void func_uint_to_str (char *str, uint32 number)
{
    (debug_assert_handler((0 != str), "../../libraries/zf_common/zf_common_function.c", 235));
    int8 data_temp[16];
    uint8 bit = 0;
...
# 272 "../../libraries/zf_common/zf_common_function.c"
float func_str_to_float (char *str)
{
    (debug_assert_handler((0 != str), "../../libraries/zf_common/zf_common_function.c", 274));
    uint8 sign = 0;
    float temp = 0.0;
    ...
    do
    {
        ...
        {
            str ++;
            while(('0' <= *str) && ('9' >= *str) && 1000000.0 > point_bit)
            {
...
# 333 "../../libraries/zf_common/zf_common_function.c"
void func_float_to_str (char *str, float number, uint8 point_bit)
{
    (debug_assert_handler((0 != str), "../../libraries/zf_common/zf_common_function.c", 335));
    int data_int = 0;
    int data_float = 0.0;
    int data_temp[8];
...
# 418 "../../libraries/zf_common/zf_common_function.c"
double func_str_to_double (char *str)
{
    (debug_assert_handler((0 != str), "../../libraries/zf_common/zf_common_function.c", 420));
    uint8 sign = 0;
    double temp = 0.0;
    ...
    do
    {
        ...
        {
            str ++;
            while(('0' <= *str) && ('9' >= *str) && 1000000000.0 > point_bit)
            {
                temp_point = temp_point * 10 + ((uint8)(*str) - 0x30);
                point_bit *= 10;
                str ++;
...
# 480 "../../libraries/zf_common/zf_common_function.c"
void func_double_to_str (char *str, double number, uint8 point_bit)
{
    (debug_assert_handler((0 != str), "../../libraries/zf_common/zf_common_function.c", 482));
    int data_int = 0;
    int data_float = 0.0;
    int data_temp[12];
...
# 565 "../../libraries/zf_common/zf_common_function.c"
uint32 func_str_to_hex (char *str)
{
    (debug_assert_handler((0 != str), "../../libraries/zf_common/zf_common_function.c", 567));
...
# 623 "../../libraries/zf_common/zf_common_function.c"
void func_hex_to_str (char *str, uint32 number)
{
    (debug_assert_handler((0 != str), "../../libraries/zf_common/zf_common_function.c", 625));
    ...
    *str ++ = 'x';
    do
    {
        ...
        while(0 != bit)
        {
            *str ++ = hex_index[data_temp[bit - 1]];
            bit --;
        }
    }while(0);
}
# 672 "../../libraries/zf_common/zf_common_function.c"
...
# 737 "../../libraries/zf_common/zf_common_function.c"
...
# 758 "../../libraries/zf_common/zf_common_function.c"
uint32 zf_sprintf (int8 *buff, const int8 *format, ...)
{
    uint32 buff_len = 0;
 va_list arg;
    ...
    while (*format)
    {
        ...
        if ('%' == ret)
        {
            switch (*++ format)
            {
                ...
                case 'c':
                {
                    int8 ch = (int8)__builtin_va_arg(arg, uint32);
                    *buff = ch;
                    buff ++;
                    buff_len ++;
                }break;
                ...
                {
                    int8 vstr[33];
                    int32 ival = (int32)__builtin_va_arg(arg, int32);
                ...
                {
                    int8 vstr[33];
                    double ival = (double)__builtin_va_arg(arg, double);
                ...
                {
                    int8 vstr[33];
                    uint32 ival = (uint32)__builtin_va_arg(arg, uint32);
                ...
                case 's':
                {
                    int8 *pc = __builtin_va_arg(arg, int8 *);
                    while (*pc)
                    {
                        *buff = *pc;
                        buff ++;
