# 1 "../../libraries/sdk/drives/fsl_elcdif.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/sdk/drives/fsl_elcdif.c" 2
...
# 1 "../../libraries/sdk/drives/fsl_elcdif.h" 1
# 12 "../../libraries/sdk/drives/fsl_elcdif.h"
...
# 13 "../../libraries/sdk/drives/fsl_elcdif.h" 2
# 79 "../../libraries/sdk/drives/fsl_elcdif.h"
enum _elcdif_polarity_flags
{
    kELCDIF_VsyncActiveLow = 0U,
    kELCDIF_VsyncActiveHigh = (0x8000000U),
    kELCDIF_HsyncActiveLow = 0U,
    kELCDIF_HsyncActiveHigh = (0x4000000U),
    kELCDIF_DataEnableActiveLow = 0U,
    kELCDIF_DataEnableActiveHigh = (0x1000000U),
    kELCDIF_DriveDataOnFallingClkEdge = 0U,

    kELCDIF_DriveDataOnRisingClkEdge = (0x2000000U),
...
{
    kELCDIF_BusMasterErrorInterruptEnable = (0x4000000U),
    kELCDIF_TxFifoOverflowInterruptEnable = (0x8000U),
    kELCDIF_TxFifoUnderflowInterruptEnable = (0x4000U),
...
{
    kELCDIF_BusMasterError = (0x2000000U),
    kELCDIF_TxFifoOverflow = (0x800U),
    kELCDIF_TxFifoUnderflow = (0x400U),
    kELCDIF_CurFrameDone =
        (0x200U),
    kELCDIF_VsyncEdge = (0x100U),
...
{
    kELCDIF_LFifoFull = (0x20000000U),
    kELCDIF_LFifoEmpty = (0x10000000U),
    kELCDIF_TxFifoFull = (0x8000000U),
    kELCDIF_TxFifoEmpty = (0x4000000U),
...
{
    kELCDIF_DataBus8Bit = (((uint32_t)(((uint32_t)(1)) << (10U))) & (0xC00U)),
    kELCDIF_DataBus16Bit = (((uint32_t)(((uint32_t)(0)) << (10U))) & (0xC00U)),
    kELCDIF_DataBus18Bit = (((uint32_t)(((uint32_t)(2)) << (10U))) & (0xC00U)),
    kELCDIF_DataBus24Bit = (((uint32_t)(((uint32_t)(3)) << (10U))) & (0xC00U)),
} elcdif_lcd_data_bus_t;
# 181 "../../libraries/sdk/drives/fsl_elcdif.h"
...
# 252 "../../libraries/sdk/drives/fsl_elcdif.h"
...
# 289 "../../libraries/sdk/drives/fsl_elcdif.h"
typedef enum _elcdif_lut
{
    kELCDIF_Lut0 = 0,
    kELCDIF_Lut1,
} elcdif_lut_t;
# 317 "../../libraries/sdk/drives/fsl_elcdif.h"
void ELCDIF_RgbModeInit(LCDIF_Type *base, const elcdif_rgb_mode_config_t *config);
# 344 "../../libraries/sdk/drives/fsl_elcdif.h"
...
# 366 "../../libraries/sdk/drives/fsl_elcdif.h"
...
# 430 "../../libraries/sdk/drives/fsl_elcdif.h"
static inline void ELCDIF_EnablePxpHandShake(LCDIF_Type *base, _Bool enable)
{
    if (enable)
    {
        base->CTRL_SET = (0x40U);
...
{
    return (base->STAT & (0x1FFU)) >> (0U);
}
# 540 "../../libraries/sdk/drives/fsl_elcdif.h"
static inline void ELCDIF_EnableInterrupts(LCDIF_Type *base, uint32_t mask)
{
    base->CTRL1_SET = (mask & ((0x4000000U) | (0x8000U) | (0x4000U) | (0x2000U) | (0x1000U)));
...
{
    base->CTRL1_CLR = (mask & ((0x4000000U) | (0x8000U) | (0x4000U) | (0x2000U) | (0x1000U)));
...
static inline uint32_t ELCDIF_GetInterruptStatus(LCDIF_Type *base)
{
    ...
    flags = (base->CTRL1 & ((0x2000000U) | (0x800U) | (0x400U) | (0x200U) | (0x100U)));
...
{
    base->CTRL1_CLR = (mask & ((0x2000000U) | (0x800U) | (0x400U) | (0x200U) | (0x100U)));



}
# 727 "../../libraries/sdk/drives/fsl_elcdif.h"
static inline void ELCDIF_EnableLut(LCDIF_Type *base, _Bool enable)
{
    if (enable)
    {
        base->LUT_CTRL &= ~(0x1U);
...
static LCDIF_Type *const s_elcdifBases[] = { ((LCDIF_Type *)(0x402B8000u)) };



static const clock_ip_name_t s_elcdifApbClocks[] = { kCLOCK_Lcd };


static const clock_ip_name_t s_elcdifPixClocks[] = { kCLOCK_LcdPixel };
...
static const elcdif_pixel_format_reg_t s_pixelFormatReg[] = {
    ...
    {
     (((uint32_t)(((uint32_t)(1U)) << (8U))) & (0x300U)),

     (((uint32_t)(((uint32_t)(0x0FU)) << (16U))) & (0xF0000U))},

    {
     (((uint32_t)(((uint32_t)(0U)) << (8U))) & (0x300U)),

     (((uint32_t)(((uint32_t)(0x0FU)) << (16U))) & (0xF0000U))},

    {
     (((uint32_t)(((uint32_t)(3U)) << (8U))) & (0x300U)) | (((uint32_t)(((uint32_t)(1U)) << (1U))) & (0x2U)),

     (((uint32_t)(((uint32_t)(0x07U)) << (16U))) & (0xF0000U))},

    {
     (((uint32_t)(((uint32_t)(3U)) << (8U))) & (0x300U)),
...
static uint32_t ELCDIF_GetInstance(LCDIF_Type *base)
{
    ...
    for (instance = 0; instance < (sizeof(s_elcdifBases) / sizeof((s_elcdifBases)[0])); instance++)
    {
    ...
    ((instance < (sizeof(s_elcdifBases) / sizeof((s_elcdifBases)[0]))) ? (void)0 : __aeabi_assert("instance < ARRAY_SIZE(s_elcdifBases)", "../../libraries/sdk/drives/fsl_elcdif.c", 88),
# 88 "../../libraries/sdk/drives/fsl_elcdif.c"
#pragma clang diagnostic push
# 88 "../../libraries/sdk/drives/fsl_elcdif.c"
#pragma clang diagnostic ignored "-Wassume"
# 88 "../../libraries/sdk/drives/fsl_elcdif.c"
    (__builtin_assume)((instance < (sizeof(s_elcdifBases) / sizeof((s_elcdifBases)[0])))?1:0)
# 88 "../../libraries/sdk/drives/fsl_elcdif.c"
#pragma clang diagnostic pop
# 88 "../../libraries/sdk/drives/fsl_elcdif.c"
    );
...
# 102 "../../libraries/sdk/drives/fsl_elcdif.c"
void ELCDIF_RgbModeInit(LCDIF_Type *base, const elcdif_rgb_mode_config_t *config)
{
    ((0 != config) ? (void)0 : __aeabi_assert("NULL != config", "../../libraries/sdk/drives/fsl_elcdif.c", 104),
# 104 "../../libraries/sdk/drives/fsl_elcdif.c"
#pragma clang diagnostic push
# 104 "../../libraries/sdk/drives/fsl_elcdif.c"
#pragma clang diagnostic ignored "-Wassume"
# 104 "../../libraries/sdk/drives/fsl_elcdif.c"
...
# 104 "../../libraries/sdk/drives/fsl_elcdif.c"
    ...
    (((uint32_t)config->pixelFormat < (sizeof(s_pixelFormatReg) / sizeof((s_pixelFormatReg)[0]))) ? (void)0 : __aeabi_assert("(uint32_t)config->pixelFormat < ARRAY_SIZE(s_pixelFormatReg)", "../../libraries/sdk/drives/fsl_elcdif.c", 105),
# 105 "../../libraries/sdk/drives/fsl_elcdif.c"
#pragma clang diagnostic push
# 105 "../../libraries/sdk/drives/fsl_elcdif.c"
#pragma clang diagnostic ignored "-Wassume"
# 105 "../../libraries/sdk/drives/fsl_elcdif.c"
    (__builtin_assume)(((uint32_t)config->pixelFormat < (sizeof(s_pixelFormatReg) / sizeof((s_pixelFormatReg)[0])))?1:0)
# 105 "../../libraries/sdk/drives/fsl_elcdif.c"
#pragma clang diagnostic pop
# 105 "../../libraries/sdk/drives/fsl_elcdif.c"
    );
    ...
    base->CTRL2 = (base->CTRL2 & ~(0xE00000U)) | ((((uint32_t)(((uint32_t)(4)) << (21U))) & (0xE00000U)));

    base->TRANSFER_COUNT = ((uint32_t)config->panelHeight << (16U)) |
                           ((uint32_t)config->panelWidth << (0U));

    base->VDCTRL0 = (0x10000000U) |
                    (0x200000U) |
                    (0x100000U) |
    ...
    base->VDCTRL2 =
        ((uint32_t)config->hsw << (18U)) |
        (((uint32_t)config->hfp + (uint32_t)config->hbp + (uint32_t)config->panelWidth + (uint32_t)config->hsw))
            << (0U);

    base->VDCTRL3 = (((uint32_t)config->hbp + config->hsw) << (16U)) |
                    (((uint32_t)config->vbp + config->vsw) << (0U));

    base->VDCTRL4 = (0x40000U) |
                    ((uint32_t)config->panelWidth << (0U));

    base->CUR_BUF = (config->bufferAddr);
    base->NEXT_BUF = (config->bufferAddr);
}
# 178 "../../libraries/sdk/drives/fsl_elcdif.c"
void ELCDIF_RgbModeGetDefaultConfig(elcdif_rgb_mode_config_t *config)
{
    ((0 != config) ? (void)0 : __aeabi_assert("NULL != config", "../../libraries/sdk/drives/fsl_elcdif.c", 180),
# 180 "../../libraries/sdk/drives/fsl_elcdif.c"
#pragma clang diagnostic push
# 180 "../../libraries/sdk/drives/fsl_elcdif.c"
#pragma clang diagnostic ignored "-Wassume"
# 180 "../../libraries/sdk/drives/fsl_elcdif.c"
...
void ELCDIF_RgbModeSetPixelFormat(LCDIF_Type *base, elcdif_pixel_format_t pixelFormat)
{
    (((uint32_t)pixelFormat < (sizeof(s_pixelFormatReg) / sizeof((s_pixelFormatReg)[0]))) ? (void)0 : __aeabi_assert("(uint32_t)pixelFormat < ARRAY_SIZE(s_pixelFormatReg)", "../../libraries/sdk/drives/fsl_elcdif.c", 208),
# 208 "../../libraries/sdk/drives/fsl_elcdif.c"
#pragma clang diagnostic push
# 208 "../../libraries/sdk/drives/fsl_elcdif.c"
#pragma clang diagnostic ignored "-Wassume"
# 208 "../../libraries/sdk/drives/fsl_elcdif.c"
    (__builtin_assume)(((uint32_t)pixelFormat < (sizeof(s_pixelFormatReg) / sizeof((s_pixelFormatReg)[0])))?1:0)
# 208 "../../libraries/sdk/drives/fsl_elcdif.c"
#pragma clang diagnostic pop
# 208 "../../libraries/sdk/drives/fsl_elcdif.c"
    );

    base->CTRL = (base->CTRL & ~((0x300U) | (0x2U) |
                                 (0x4U) | (0x8U))) |
...
void ELCDIF_RgbModeStop(LCDIF_Type *base)
{
    base->CTRL_CLR = (0x20000U);


    while (0U != (base->CTRL & (0x20000U)))
    {
    }
}
...
void ELCDIF_Reset(LCDIF_Type *base)
{
# 269 "../../libraries/sdk/drives/fsl_elcdif.c"
    base->CTRL_CLR = (0x40000000U);





    if (0U == (base->CTRL & (0x80000000U)))
    {

        base->CTRL_SET = (0x80000000U);


        while (0U == (base->CTRL & (0x40000000U)))
        {
        }
    ...
    base->CTRL_CLR = (0x80000000U);
}
# 350 "../../libraries/sdk/drives/fsl_elcdif.c"
status_t ELCDIF_UpdateLut(
    LCDIF_Type *base, elcdif_lut_t lut, uint16_t startIndex, const uint32_t *lutData, uint16_t count)
{
