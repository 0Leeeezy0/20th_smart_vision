# 1 "../../libraries/sdk/deceive/system_MIMXRT1064.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/sdk/deceive/system_MIMXRT1064.c" 2
# 58 "../../libraries/sdk/deceive/system_MIMXRT1064.c"
...
# 59 "../../libraries/sdk/deceive/system_MIMXRT1064.c" 2
...
# 60 "../../libraries/sdk/deceive/system_MIMXRT1064.c" 2
...
uint32_t SystemCoreClock = 528000000UL;
...
# 99 "../../libraries/sdk/deceive/system_MIMXRT1064.c"
 uint32_t * VECTOR_RAM ;
 ...
 VECTOR_TABLE = (uint32_t *)0x70002000;
    ...
    uint32_t vector_size = ((uint32_t)RAM_VECTOR_TABLE_SIZE)/4;
    ...
    ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->VTOR = (uint32_t)VECTOR_RAM;



    ((WDOG_Type *)(0x400B8000u))->WMCR &= ~(uint16_t) (0x1U);
    ((WDOG_Type *)(0x400D0000u))->WMCR &= ~(uint16_t) (0x1U);




    if ((((WDOG_Type *)(0x400B8000u))->WCR & (0x4U)) != 0U)
    {
        ((WDOG_Type *)(0x400B8000u))->WCR &= ~(uint16_t) (0x4U);
    }
    if ((((WDOG_Type *)(0x400D0000u))->WCR & (0x4U)) != 0U)
    {
        ((WDOG_Type *)(0x400D0000u))->WCR &= ~(uint16_t) (0x4U);
    }
    if ((((RTWDOG_Type *)(0x400BC000u))->CS & (0x2000U)) != 0U)
    {
        ((RTWDOG_Type *)(0x400BC000u))->CNT = 0xD928C520U;
    }
    else
    {
        ((RTWDOG_Type *)(0x400BC000u))->CNT = 0xC520U;
        ((RTWDOG_Type *)(0x400BC000u))->CNT = 0xD928U;
    }
    ((RTWDOG_Type *)(0x400BC000u))->TOVAL = 0xFFFF;
    ((RTWDOG_Type *)(0x400BC000u))->CS = (uint32_t) ((((RTWDOG_Type *)(0x400BC000u))->CS) & ~(0x80U)) | (0x20U);



    if ((((SysTick_Type *) ((0xE000E000UL) + 0x0010UL) )->CTRL & (1UL )) != 0U)
    {
...
void SystemCoreClockUpdate (void) {
    ...
    if ((((CCM_Type *)(0x400FC000u))->CBCDR & (0x2000000U)) != 0U)
    {
        switch (((CCM_Type *)(0x400FC000u))->CBCMR & (0x3000U))
        {
            ...
            case (((uint32_t)(((uint32_t)(0U)) << (12U))) & (0x3000U)):
                if((((CCM_ANALOG_Type *)(0x400D8000u))->PLL_USB1 & (0x10000U)) != 0U)
                {
                    freq = (((((CCM_ANALOG_Type *)(0x400D8000u))->PLL_USB1 & (0xC000U)) >> (14U)) == 0U) ?
                           24000000UL : 0UL;
                }
                else
                {
                    freq = (24000000UL * (((((CCM_ANALOG_Type *)(0x400D8000u))->PLL_USB1 & (0x2U)) != 0U) ? 22U : 20U));
                }
                break;
            ...
            case (((uint32_t)(((uint32_t)(2U)) << (12U))) & (0x3000U)):
                freq = (((((CCM_ANALOG_Type *)(0x400D8000u))->PLL_SYS & (0xC000U)) >> (14U)) == 0U) ?
                   24000000UL : 0UL;
                break;
    ...
    else
    {
        ...
        if((((CCM_ANALOG_Type *)(0x400D8000u))->PLL_ARM & (0x10000U)) != 0U)
        {
            PLL1MainClock = (((((CCM_ANALOG_Type *)(0x400D8000u))->PLL_ARM & (0xC000U)) >> (14U)) == 0U) ?
                   24000000UL : 0UL;
        }
        else
        {
            PLL1MainClock = ((24000000UL * ((((CCM_ANALOG_Type *)(0x400D8000u))->PLL_ARM & (0x7FU)) >>
                                             (0U))) >> 1U);
        }


        if((((CCM_ANALOG_Type *)(0x400D8000u))->PLL_SYS & (0x10000U)) != 0U)
        {
            PLL2MainClock = (((((CCM_ANALOG_Type *)(0x400D8000u))->PLL_SYS & (0xC000U)) >> (14U)) == 0U) ?
                   24000000UL : 0UL;
        }
        else
        {
            PLL2MainClock = (24000000UL * (((((CCM_ANALOG_Type *)(0x400D8000u))->PLL_SYS & (0x1U)) != 0U) ? 22U : 20U));
        }
        PLL2MainClock += (uint32_t)(((uint64_t)24000000UL * ((uint64_t)(((CCM_ANALOG_Type *)(0x400D8000u))->PLL_SYS_NUM))) / ((uint64_t)(((CCM_ANALOG_Type *)(0x400D8000u))->PLL_SYS_DENOM)));
        ...
        switch (((CCM_Type *)(0x400FC000u))->CBCMR & (0xC0000U))
        {
            ...
            case (((uint32_t)(((uint32_t)(1U)) << (18U))) & (0xC0000U)):
                freq = PLL2MainClock / ((((CCM_ANALOG_Type *)(0x400D8000u))->PFD_528 & (0x3F0000U)) >> (16U)) * 18U;
                break;


            case (((uint32_t)(((uint32_t)(2U)) << (18U))) & (0xC0000U)):
                freq = PLL2MainClock / ((((CCM_ANALOG_Type *)(0x400D8000u))->PFD_528 & (0x3FU)) >> (0U)) * 18U;
                break;


            case (((uint32_t)(((uint32_t)(3U)) << (18U))) & (0xC0000U)):
                freq = PLL1MainClock / (((((CCM_Type *)(0x400FC000u))->CACRR & (0x7U)) >> (0U)) + 1U);
                break;
    ...
    SystemCoreClock = (freq / (((((CCM_Type *)(0x400FC000u))->CBCDR & (0x1C00U)) >> (10U)) + 1U));
