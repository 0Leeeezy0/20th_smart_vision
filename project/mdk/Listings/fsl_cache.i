# 1 "../../libraries/sdk/drives/fsl_cache.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/sdk/drives/fsl_cache.c" 2
...
# 9 "../../libraries/sdk/drives/fsl_cache.c" 2
# 496 "../../libraries/sdk/drives/fsl_cache.c"
void L1CACHE_InvalidateICacheByRange(uint32_t address, uint32_t size_byte)
{

    uint32_t addr = address & ~((uint32_t)(32) - 1U);
    ...
    while (size > 0)
    {
        ((SCB_Type *) ((0xE000E000UL) + 0x0D00UL) )->ICIMVAU = addr;
        addr += (uint32_t)(32);
        size -= (int32_t)(32);
    }
    __builtin_arm_dsb(0xF);
...
# 527 "../../libraries/sdk/drives/fsl_cache.c"
void ICACHE_InvalidateByRange(uint32_t address, uint32_t size_byte)
{
...
# 550 "../../libraries/sdk/drives/fsl_cache.c"
void DCACHE_InvalidateByRange(uint32_t address, uint32_t size_byte)
{
...
# 572 "../../libraries/sdk/drives/fsl_cache.c"
void DCACHE_CleanByRange(uint32_t address, uint32_t size_byte)
{
...
# 594 "../../libraries/sdk/drives/fsl_cache.c"
void DCACHE_CleanInvalidateByRange(uint32_t address, uint32_t size_byte)
{
