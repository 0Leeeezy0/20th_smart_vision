# 1 "../../libraries/zf_device/zf_device_tft180.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/zf_device/zf_device_tft180.c" 2
# 51 "../../libraries/zf_device/zf_device_tft180.c"
...
# 52 "../../libraries/zf_device/zf_device_tft180.c" 2
...
# 53 "../../libraries/zf_device/zf_device_tft180.c" 2
...
# 54 "../../libraries/zf_device/zf_device_tft180.c" 2
...
# 55 "../../libraries/zf_device/zf_device_tft180.c" 2
...
# 56 "../../libraries/zf_device/zf_device_tft180.c" 2
# 1 "../../libraries/zf_driver\\zf_driver_soft_spi.h" 1
# 39 "../../libraries/zf_driver\\zf_driver_soft_spi.h"
...
# 40 "../../libraries/zf_driver\\zf_driver_soft_spi.h" 2
...
# 57 "../../libraries/zf_device/zf_device_tft180.c" 2
...
# 58 "../../libraries/zf_device/zf_device_tft180.c" 2
...
# 60 "../../libraries/zf_device/zf_device_tft180.c" 2

static uint16 tft180_pencolor = (RGB565_RED);
static uint16 tft180_bgcolor = (RGB565_WHITE);

static tft180_dir_enum tft180_display_dir = (TFT180_PORTAIT);
static tft180_font_size_enum tft180_display_font = (TFT180_8X16_FONT);

static uint8 tft180_x_max = 160;
static uint8 tft180_y_max = 128;
# 156 "../../libraries/zf_device/zf_device_tft180.c"
static void tft180_write_index (const uint8 dat)
{
    ((0) ? (GPIO_SetPinsOutput(PORTPTR[(C19) >> 5],1 << ((C19) & 0x1f))) : (GPIO_ClearPinsOutput(PORTPTR[(C19) >> 5],1 << ((C19) & 0x1f))));
    (spi_write_8bit((SPI_3), (dat)));
    ((1) ? (GPIO_SetPinsOutput(PORTPTR[(C19) >> 5],1 << ((C19) & 0x1f))) : (GPIO_ClearPinsOutput(PORTPTR[(C19) >> 5],1 << ((C19) & 0x1f))));
}
# 173 "../../libraries/zf_device/zf_device_tft180.c"
static void tft180_set_region (uint16 x1, uint16 y1, uint16 x2, uint16 y2)
{



    (debug_assert_handler((x1 < tft180_x_max), "../../libraries/zf_device/zf_device_tft180.c", 178));
    (debug_assert_handler((y1 < tft180_y_max), "../../libraries/zf_device/zf_device_tft180.c", 179));
    (debug_assert_handler((x2 < tft180_x_max), "../../libraries/zf_device/zf_device_tft180.c", 180));
    (debug_assert_handler((y2 < tft180_y_max), "../../libraries/zf_device/zf_device_tft180.c", 181));
    ...
    switch(tft180_display_dir)
    {
        ...
        case TFT180_PORTAIT_180:
        {
            ...
            (spi_write_8bit((SPI_3), (0x00)));
            (spi_write_8bit((SPI_3), (x1 + 2)));
            (spi_write_8bit((SPI_3), (0x00)));
            (spi_write_8bit((SPI_3), (x2 + 2)));

            tft180_write_index(0x2b);
            (spi_write_8bit((SPI_3), (0x00)));
            (spi_write_8bit((SPI_3), (y1 + 1)));
            (spi_write_8bit((SPI_3), (0x00)));
            (spi_write_8bit((SPI_3), (y2 + 1)));
        }break;
        ...
        case TFT180_CROSSWISE_180:
        {
            tft180_write_index(0x2a);
            (spi_write_8bit((SPI_3), (0x00)));
            (spi_write_8bit((SPI_3), (x1 + 1)));
            (spi_write_8bit((SPI_3), (0x0)));
            (spi_write_8bit((SPI_3), (x2 + 1)));

            tft180_write_index(0x2b);
            (spi_write_8bit((SPI_3), (0x00)));
            (spi_write_8bit((SPI_3), (y1 + 2)));
            (spi_write_8bit((SPI_3), (0x00)));
            (spi_write_8bit((SPI_3), (y2 + 2)));
        }break;
    }
    tft180_write_index(0x2c);
}
# 226 "../../libraries/zf_device/zf_device_tft180.c"
...
# 265 "../../libraries/zf_device/zf_device_tft180.c"
void tft180_clear (void)
{
    uint16 color_buffer[tft180_x_max];
    uint16 i = 0, j = 0;

    ((0) ? (GPIO_SetPinsOutput(PORTPTR[(B3 ) >> 5],1 << ((B3 ) & 0x1f))) : (GPIO_ClearPinsOutput(PORTPTR[(B3 ) >> 5],1 << ((B3 ) & 0x1f))));
    ...
    {
        (spi_write_16bit_array((SPI_3), (color_buffer), (tft180_x_max)));
    }
    ((1) ? (GPIO_SetPinsOutput(PORTPTR[(B3 ) >> 5],1 << ((B3 ) & 0x1f))) : (GPIO_ClearPinsOutput(PORTPTR[(B3 ) >> 5],1 << ((B3 ) & 0x1f))));
}
# 290 "../../libraries/zf_device/zf_device_tft180.c"
void tft180_full (const uint16 color)
{
    uint16 color_buffer[tft180_x_max];
    uint16 i = 0, j = 0;
...
# 315 "../../libraries/zf_device/zf_device_tft180.c"
void tft180_set_dir (tft180_dir_enum dir)
{
...
# 342 "../../libraries/zf_device/zf_device_tft180.c"
void tft180_set_font (tft180_font_size_enum font)
{
    tft180_display_font = font;
}
# 355 "../../libraries/zf_device/zf_device_tft180.c"
void tft180_set_color (uint16 pen, const uint16 bgcolor)
{
    tft180_pencolor = pen;
    tft180_bgcolor = bgcolor;
}
# 370 "../../libraries/zf_device/zf_device_tft180.c"
void tft180_draw_point (uint16 x, uint16 y, const uint16 color)
{


    (debug_assert_handler((x < tft180_x_max), "../../libraries/zf_device/zf_device_tft180.c", 374));
    (debug_assert_handler((y < tft180_y_max), "../../libraries/zf_device/zf_device_tft180.c", 375));

    ((0) ? (GPIO_SetPinsOutput(PORTPTR[(B3 ) >> 5],1 << ((B3 ) & 0x1f))) : (GPIO_ClearPinsOutput(PORTPTR[(B3 ) >> 5],1 << ((B3 ) & 0x1f))));
    tft180_set_region(x, y, x, y);
    (spi_write_16bit((SPI_3), (color)));
    ((1) ? (GPIO_SetPinsOutput(PORTPTR[(B3 ) >> 5],1 << ((B3 ) & 0x1f))) : (GPIO_ClearPinsOutput(PORTPTR[(B3 ) >> 5],1 << ((B3 ) & 0x1f))));
}
# 394 "../../libraries/zf_device/zf_device_tft180.c"
void tft180_draw_line (uint16 x_start, uint16 y_start, uint16 x_end, uint16 y_end, const uint16 color)
{


    (debug_assert_handler((x_start < tft180_x_max), "../../libraries/zf_device/zf_device_tft180.c", 398));
    (debug_assert_handler((y_start < tft180_y_max), "../../libraries/zf_device/zf_device_tft180.c", 399));
    (debug_assert_handler((x_end < tft180_x_max), "../../libraries/zf_device/zf_device_tft180.c", 400));
    (debug_assert_handler((y_end < tft180_y_max), "../../libraries/zf_device/zf_device_tft180.c", 401));
    ...
    do
    {
        ...
        if(((y_start - y_end) >= 0 ? (y_start - y_end): -(y_start - y_end)) > ((x_start - x_end) >= 0 ? (x_start - x_end): -(x_start - x_end)))
        {
            while(y_start != y_end)
            {
                tft180_draw_point(x_start, y_start, color);
...
# 458 "../../libraries/zf_device/zf_device_tft180.c"
void tft180_show_char (uint16 x, uint16 y, const char dat)
{


    (debug_assert_handler((x < tft180_x_max), "../../libraries/zf_device/zf_device_tft180.c", 462));
    (debug_assert_handler((y < tft180_y_max), "../../libraries/zf_device/zf_device_tft180.c", 463));
    ...
    switch(tft180_display_font)
    {
        case TFT180_6X8_FONT:
        {
            ...
            (spi_write_16bit_array((SPI_3), (display_buffer), (6*8)));
        }break;
        case TFT180_8X16_FONT:
        {
            ...
            (spi_write_16bit_array((SPI_3), (display_buffer), (8 * 16)));
        }break;
        case TFT180_16X16_FONT:
        {
...
# 545 "../../libraries/zf_device/zf_device_tft180.c"
void tft180_show_string (uint16 x, uint16 y, const char dat[])
{


    (debug_assert_handler((x < tft180_x_max), "../../libraries/zf_device/zf_device_tft180.c", 549));
    (debug_assert_handler((y < tft180_y_max), "../../libraries/zf_device/zf_device_tft180.c", 550));
...
# 575 "../../libraries/zf_device/zf_device_tft180.c"
void tft180_show_int (uint16 x, uint16 y, const int32 dat, uint8 num)
{


    (debug_assert_handler((x < tft180_x_max), "../../libraries/zf_device/zf_device_tft180.c", 579));
    (debug_assert_handler((y < tft180_y_max), "../../libraries/zf_device/zf_device_tft180.c", 580));
    (debug_assert_handler((0 < num), "../../libraries/zf_device/zf_device_tft180.c", 581));
    (debug_assert_handler((10 >= num), "../../libraries/zf_device/zf_device_tft180.c", 582));
...
# 614 "../../libraries/zf_device/zf_device_tft180.c"
void tft180_show_uint (uint16 x, uint16 y, const uint32 dat, uint8 num)
{


    (debug_assert_handler((x < tft180_x_max), "../../libraries/zf_device/zf_device_tft180.c", 618));
    (debug_assert_handler((y < tft180_y_max), "../../libraries/zf_device/zf_device_tft180.c", 619));
    (debug_assert_handler((0 < num), "../../libraries/zf_device/zf_device_tft180.c", 620));
    (debug_assert_handler((10 >= num), "../../libraries/zf_device/zf_device_tft180.c", 621));
...
# 656 "../../libraries/zf_device/zf_device_tft180.c"
void tft180_show_float (uint16 x, uint16 y, const double dat, uint8 num, uint8 pointnum)
{


    (debug_assert_handler((x < tft180_x_max), "../../libraries/zf_device/zf_device_tft180.c", 660));
    (debug_assert_handler((y < tft180_y_max), "../../libraries/zf_device/zf_device_tft180.c", 661));
    (debug_assert_handler((0 < num), "../../libraries/zf_device/zf_device_tft180.c", 662));
    (debug_assert_handler((8 >= num), "../../libraries/zf_device/zf_device_tft180.c", 663));
    (debug_assert_handler((0 < pointnum), "../../libraries/zf_device/zf_device_tft180.c", 664));
    (debug_assert_handler((6 >= pointnum), "../../libraries/zf_device/zf_device_tft180.c", 665));
...
# 699 "../../libraries/zf_device/zf_device_tft180.c"
void tft180_show_binary_image (uint16 x, uint16 y, const uint8 *image, uint16 width, uint16 height, uint16 dis_width, uint16 dis_height)
{


    (debug_assert_handler((x < tft180_x_max), "../../libraries/zf_device/zf_device_tft180.c", 703));
    (debug_assert_handler((y < tft180_y_max), "../../libraries/zf_device/zf_device_tft180.c", 704));
    (debug_assert_handler((0 != image), "../../libraries/zf_device/zf_device_tft180.c", 705));
    ...
    for(j = 0; j < dis_height; j ++)
    {
        ...
        (spi_write_16bit_array((SPI_3), (data_buffer), (dis_width)));
    }
    ((1) ? (GPIO_SetPinsOutput(PORTPTR[(B3 ) >> 5],1 << ((B3 ) & 0x1f))) : (GPIO_ClearPinsOutput(PORTPTR[(B3 ) >> 5],1 << ((B3 ) & 0x1f))));
}
# 754 "../../libraries/zf_device/zf_device_tft180.c"
void tft180_show_gray_image (uint16 x, uint16 y, const uint8 *image, uint16 width, uint16 height, uint16 dis_width, uint16 dis_height, uint8 threshold)
{


    (debug_assert_handler((x < tft180_x_max), "../../libraries/zf_device/zf_device_tft180.c", 758));
    (debug_assert_handler((y < tft180_y_max), "../../libraries/zf_device/zf_device_tft180.c", 759));
    (debug_assert_handler((0 != image), "../../libraries/zf_device/zf_device_tft180.c", 760));
...
# 814 "../../libraries/zf_device/zf_device_tft180.c"
void tft180_show_rgb565_image (uint16 x, uint16 y, const uint16 *image, uint16 width, uint16 height, uint16 dis_width, uint16 dis_height, uint8 color_mode)
{


    (debug_assert_handler((x < tft180_x_max), "../../libraries/zf_device/zf_device_tft180.c", 818));
    (debug_assert_handler((y < tft180_y_max), "../../libraries/zf_device/zf_device_tft180.c", 819));
    (debug_assert_handler((0 != image), "../../libraries/zf_device/zf_device_tft180.c", 820));
    ...
    for(j = 0; j < dis_height; j ++)
    {
        ...
        for(i = 0; i < dis_width; i ++)
        {
            data_buffer[i] = *(image_temp + i * width / dis_width);
        }
        if(color_mode)
        {
            (spi_write_8bit_array((SPI_3), ((uint8 *)data_buffer), (dis_width * 2)));
        }
        else
        {
            (spi_write_16bit_array((SPI_3), (data_buffer), (dis_width)));
...
# 861 "../../libraries/zf_device/zf_device_tft180.c"
void tft180_show_wave (uint16 x, uint16 y, const uint16 *wave, uint16 width, uint16 value_max, uint16 dis_width, uint16 dis_value_max)
{


    (debug_assert_handler((x < tft180_x_max), "../../libraries/zf_device/zf_device_tft180.c", 865));
    (debug_assert_handler((y < tft180_y_max), "../../libraries/zf_device/zf_device_tft180.c", 866));
    (debug_assert_handler((0 != wave), "../../libraries/zf_device/zf_device_tft180.c", 867));
...
# 905 "../../libraries/zf_device/zf_device_tft180.c"
void tft180_show_chinese (uint16 x, uint16 y, uint8 size, const uint8 *chinese_buffer, uint8 number, const uint16 color)
{


    (debug_assert_handler((x < tft180_x_max), "../../libraries/zf_device/zf_device_tft180.c", 909));
    (debug_assert_handler((y < tft180_y_max), "../../libraries/zf_device/zf_device_tft180.c", 910));
    (debug_assert_handler((0 != chinese_buffer), "../../libraries/zf_device/zf_device_tft180.c", 911));
        ...
        while(temp1 --)
        {
            for(k = 0; k < temp2; k ++)
            {
                for(j = 8; 0 < j; j --)
                {
                    ...
                    {
                        (spi_write_16bit((SPI_3), (tft180_bgcolor)));
                    }
                }
                p_data ++;
            }
...
# 957 "../../libraries/zf_device/zf_device_tft180.c"
void tft180_init (void)
{



    spi_init((SPI_3), SPI_MODE0, (40 * 1000 * 1000), (SPI3_SCK_B0 ), (SPI3_MOSI_B1), SPI_MISO_NULL, SPI_CS_NULL);


    gpio_init((C19), GPO, GPIO_LOW, GPO_PUSH_PULL);
    gpio_init((B2 ), GPO, GPIO_LOW, GPO_PUSH_PULL);
    gpio_init((B3 ), GPO, GPIO_HIGH, GPO_PUSH_PULL);
    gpio_init((C18), GPO, GPIO_HIGH, GPO_PUSH_PULL);

    tft180_set_dir(tft180_display_dir);
    tft180_set_color(tft180_pencolor, tft180_bgcolor);

    ((0) ? (GPIO_SetPinsOutput(PORTPTR[(B2 ) >> 5],1 << ((B2 ) & 0x1f))) : (GPIO_ClearPinsOutput(PORTPTR[(B2 ) >> 5],1 << ((B2 ) & 0x1f))));
    system_delay_ms(10);

    ((1) ? (GPIO_SetPinsOutput(PORTPTR[(B2 ) >> 5],1 << ((B2 ) & 0x1f))) : (GPIO_ClearPinsOutput(PORTPTR[(B2 ) >> 5],1 << ((B2 ) & 0x1f))));
    system_delay_ms(120);
    ((0) ? (GPIO_SetPinsOutput(PORTPTR[(B3 ) >> 5],1 << ((B3 ) & 0x1f))) : (GPIO_ClearPinsOutput(PORTPTR[(B3 ) >> 5],1 << ((B3 ) & 0x1f))));
    ...
    (spi_write_8bit((SPI_3), (0x01)));
    (spi_write_8bit((SPI_3), (0x2C)));
    (spi_write_8bit((SPI_3), (0x2D)));
    ...
    (spi_write_8bit((SPI_3), (0x07)));

    tft180_write_index(0xC0);
    (spi_write_8bit((SPI_3), (0xA2)));
    (spi_write_8bit((SPI_3), (0x02)));
    (spi_write_8bit((SPI_3), (0x84)));
    tft180_write_index(0xC1);
    (spi_write_8bit((SPI_3), (0xC5)));

    tft180_write_index(0xC2);
    (spi_write_8bit((SPI_3), (0x0A)));
    (spi_write_8bit((SPI_3), (0x00)));

    tft180_write_index(0xC3);
    (spi_write_8bit((SPI_3), (0x8A)));
    (spi_write_8bit((SPI_3), (0x2A)));
    tft180_write_index(0xC4);
    (spi_write_8bit((SPI_3), (0x8A)));
    (spi_write_8bit((SPI_3), (0xEE)));

    tft180_write_index(0xC5);
    (spi_write_8bit((SPI_3), (0x0E)));

    tft180_write_index(0x36);
    switch(tft180_display_dir)
    {
        case TFT180_PORTAIT: (spi_write_8bit((SPI_3), (1<<7 | 1<<6 | 0<<5))); break;
        case TFT180_PORTAIT_180: (spi_write_8bit((SPI_3), (0<<7 | 0<<6 | 0<<5))); break;
        case TFT180_CROSSWISE: (spi_write_8bit((SPI_3), (1<<7 | 0<<6 | 1<<5))); break;
        case TFT180_CROSSWISE_180: (spi_write_8bit((SPI_3), (0<<7 | 1<<6 | 1<<5))); break;
    }

    tft180_write_index(0xe0);
    (spi_write_8bit((SPI_3), (0x0f)));
    (spi_write_8bit((SPI_3), (0x1a)));
    (spi_write_8bit((SPI_3), (0x0f)));
    (spi_write_8bit((SPI_3), (0x18)));
    (spi_write_8bit((SPI_3), (0x2f)));
    (spi_write_8bit((SPI_3), (0x28)));
    (spi_write_8bit((SPI_3), (0x20)));
    (spi_write_8bit((SPI_3), (0x22)));
    (spi_write_8bit((SPI_3), (0x1f)));
    (spi_write_8bit((SPI_3), (0x1b)));
    (spi_write_8bit((SPI_3), (0x23)));
    (spi_write_8bit((SPI_3), (0x37)));
    (spi_write_8bit((SPI_3), (0x00)));
    (spi_write_8bit((SPI_3), (0x07)));
    (spi_write_8bit((SPI_3), (0x02)));
    (spi_write_8bit((SPI_3), (0x10)));

    tft180_write_index(0xe1);
    (spi_write_8bit((SPI_3), (0x0f)));
    (spi_write_8bit((SPI_3), (0x1b)));
    (spi_write_8bit((SPI_3), (0x0f)));
    (spi_write_8bit((SPI_3), (0x17)));
    (spi_write_8bit((SPI_3), (0x33)));
    (spi_write_8bit((SPI_3), (0x2c)));
    (spi_write_8bit((SPI_3), (0x29)));
    (spi_write_8bit((SPI_3), (0x2e)));
    (spi_write_8bit((SPI_3), (0x30)));
    (spi_write_8bit((SPI_3), (0x30)));
    (spi_write_8bit((SPI_3), (0x39)));
    (spi_write_8bit((SPI_3), (0x3f)));
    (spi_write_8bit((SPI_3), (0x00)));
    (spi_write_8bit((SPI_3), (0x07)));
    (spi_write_8bit((SPI_3), (0x03)));
    (spi_write_8bit((SPI_3), (0x10)));

    tft180_write_index(0x2a);
    (spi_write_8bit((SPI_3), (0x00)));
    (spi_write_8bit((SPI_3), (0x00 + 2)));
    (spi_write_8bit((SPI_3), (0x00)));
    (spi_write_8bit((SPI_3), (0x80 + 2)));

    tft180_write_index(0x2b);
    (spi_write_8bit((SPI_3), (0x00)));
    (spi_write_8bit((SPI_3), (0x00 + 3)));
    (spi_write_8bit((SPI_3), (0x00)));
    (spi_write_8bit((SPI_3), (0x80 + 3)));
