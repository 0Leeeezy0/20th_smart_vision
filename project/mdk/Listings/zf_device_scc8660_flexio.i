# 1 "../../libraries/zf_device/zf_device_scc8660_flexio.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/zf_device/zf_device_scc8660_flexio.c" 2
# 50 "../../libraries/zf_device/zf_device_scc8660_flexio.c"
...
# 51 "../../libraries/zf_device/zf_device_scc8660_flexio.c" 2
...
# 52 "../../libraries/zf_device/zf_device_scc8660_flexio.c" 2
...
# 53 "../../libraries/zf_device/zf_device_scc8660_flexio.c" 2
...
# 54 "../../libraries/zf_device/zf_device_scc8660_flexio.c" 2
...
# 56 "../../libraries/zf_device/zf_device_scc8660_flexio.c" 2
...
# 57 "../../libraries/zf_device/zf_device_scc8660_flexio.c" 2
...
# 58 "../../libraries/zf_device/zf_device_scc8660_flexio.c" 2
...
# 59 "../../libraries/zf_device/zf_device_scc8660_flexio.c" 2
...
# 60 "../../libraries/zf_device/zf_device_scc8660_flexio.c" 2
...
# 61 "../../libraries/zf_device/zf_device_scc8660_flexio.c" 2
...
# 63 "../../libraries/zf_device/zf_device_scc8660_flexio.c" 2

vuint8 scc8660_flexio_finish_flag = 0;

__attribute__((section(".bss.NonCacheable"))) __attribute__((aligned(4))) uint16 scc8660_flexio_image[(120)][(160)];
...
{
    {SCC8660_FLEXIO_INIT, 0},

    {SCC8660_FLEXIO_AUTO_EXP, (0 )},
    {SCC8660_FLEXIO_BRIGHT, (800)},
    {SCC8660_FLEXIO_FPS, (50 )},
    {SCC8660_FLEXIO_SET_COL, (160)},
    {SCC8660_FLEXIO_SET_ROW, (120)},
    {SCC8660_FLEXIO_PCLK_DIV, (2 )},
    {SCC8660_FLEXIO_PCLK_MODE, (0 )},
    {SCC8660_FLEXIO_COLOR_MODE, (0 )},
    {SCC8660_FLEXIO_DATA_FORMAT, (0 )},
    {SCC8660_FLEXIO_MANUAL_WB, (0 )}
};
...
static int16 scc8660_flexio_get_confing_buffer[SCC8660_FLEXIO_CONFIG_FINISH - 1][2]=
{
    ...
    {SCC8660_FLEXIO_FPS, 0},
    {SCC8660_FLEXIO_SET_COL, 0},
    {SCC8660_FLEXIO_SET_ROW, 0},
    {SCC8660_FLEXIO_PCLK_DIV, 0},
    {SCC8660_FLEXIO_PCLK_MODE, 0},
    {SCC8660_FLEXIO_COLOR_MODE, 0},
    {SCC8660_FLEXIO_DATA_FORMAT, 0},
    {SCC8660_FLEXIO_MANUAL_WB, 0},
};
# 109 "../../libraries/zf_device/zf_device_scc8660_flexio.c"
static uint8 scc8660_flexio_set_config (int16 buff[SCC8660_FLEXIO_CONFIG_FINISH][2])
{
    ...
    for(loop_count = SCC8660_FLEXIO_MANUAL_WB; loop_count < SCC8660_FLEXIO_SET_REG_DATA; loop_count --)
    {
        ...
        uart_write_buffer((UART_4 ), uart_buffer, 4);
...
# 159 "../../libraries/zf_device/zf_device_scc8660_flexio.c"
...
# 205 "../../libraries/zf_device/zf_device_scc8660_flexio.c"
uint16 scc8660_flexio_get_id (void)
{
    uint16 temp;
    uint8 uart_buffer[4];
...
# 241 "../../libraries/zf_device/zf_device_scc8660_flexio.c"
uint16 scc8660_flexio_get_parameter (uint16 config)
{
    uint8 uart_buffer[4];
    uint16 timeout_count = 0;
...
# 275 "../../libraries/zf_device/zf_device_scc8660_flexio.c"
uint16 scc8660_flexio_get_version (void)
{
    uint16 temp;
    uint8 uart_buffer[4];
...
# 312 "../../libraries/zf_device/zf_device_scc8660_flexio.c"
uint8 scc8660_flexio_set_brightness (uint16 data)
{
    uint8 return_state = 0;
...
# 360 "../../libraries/zf_device/zf_device_scc8660_flexio.c"
uint8 scc8660_flexio_set_white_balance (uint16 data)
{
    uint8 return_state = 0;
...
# 410 "../../libraries/zf_device/zf_device_scc8660_flexio.c"
uint8 scc8660_flexio_set_reg (uint8 addr, uint16 data)
{
    uint8 return_state = 0;
...
# 467 "../../libraries/zf_device/zf_device_scc8660_flexio.c"
...
# 488 "../../libraries/zf_device/zf_device_scc8660_flexio.c"
static void scc8660_flexio_vsync_callback(void)
{
    if(((GPIO_GetPinsInterruptFlags(PORTPTR[C7>>5]) >> (C7&0x1f)) & 0x01))
    {
        (GPIO_ClearPinsInterruptFlags(PORTPTR[C7>>5], (uint32)1<<(C7&0x1f)));
        flexio_csi_dma_restart((uint8 *)scc8660_flexio_image[0]);
    }
}
# 504 "../../libraries/zf_device/zf_device_scc8660_flexio.c"
static void scc8660_flexio_dma_callback(edma_handle_t *handle, void *param, _Bool transferDone, uint32_t tcds)
{
 scc8660_flexio_finish_flag = 1;
}
# 516 "../../libraries/zf_device/zf_device_scc8660_flexio.c"
uint8 scc8660_flexio_init (void)
{
    uint8 return_state = 0;
    ...
    do
    {
        ...
        gpio_init(C7, GPO, 1, GPO_PUSH_PULL);

        system_delay_ms(200);
        set_flexio_camera_type(CAMERA_COLOR, &scc8660_flexio_vsync_callback, 0, 0);

        scc8660_flexio_type = SCC8660_FLEXIO_SCCB;
        soft_iic_init(&scc8660_flexio_iic_struct, 0, (800), (C17), (C16));
        if(scc8660_set_config_sccb(&scc8660_flexio_iic_struct, scc8660_flexio_set_confing_buffer))
        {
            ...
            camera_fifo_init();
            set_flexio_camera_type(CAMERA_COLOR, &scc8660_flexio_vsync_callback, 0, &scc8660_flexio_uart_callback);
            ...
            if(scc8660_flexio_set_config(scc8660_flexio_set_confing_buffer))
            {
                ...
                (debug_log_handler((0), ("SCC8660 set config error."), "../../libraries/zf_device/zf_device_scc8660_flexio.c", 547));
                set_flexio_camera_type(NO_CAMERE, 0, 0, 0);
                return_state = 1;
                break;
            }
            ...
            if(scc8660_flexio_get_config(scc8660_flexio_get_confing_buffer))
            {
                ...
                (debug_log_handler((0), ("SCC8660 get config error."), "../../libraries/zf_device/zf_device_scc8660_flexio.c", 559));
                set_flexio_camera_type(NO_CAMERE, 0, 0, 0);
                return_state = 1;
                break;
            }
        ...
        flexio_csi_init(FLEXIO2_D08_C8, FLEXIO2_D05_C5, FLEXIO2_D06_C6, (160) * 2, (120), (uint8 *)scc8660_flexio_image[0], scc8660_flexio_dma_callback);
        flexio_csi_enable_rxdma();
        __NVIC_SetPriority(DMA0_DMA16_IRQn, 1);
        interrupt_enable(DMA0_DMA16_IRQn);


        exti_init(C7, EXTI_TRIGGER_FALLING);
        __NVIC_SetPriority(GPIO2_Combined_0_15_IRQn, 0);
    }while(0);
