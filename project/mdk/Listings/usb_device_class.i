# 1 "../../libraries/components/usb/usb_cdc_adapter/usb_device_class.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/components/usb/usb_cdc_adapter/usb_device_class.c" 2
...
# 10 "../../libraries/components/usb/usb_cdc_adapter/usb_device_class.c" 2
...
# 11 "../../libraries/components/usb/usb_cdc_adapter/usb_device_class.c" 2
...
# 13 "../../libraries/components/usb/usb_cdc_adapter/usb_device_class.c" 2
...
# 14 "../../libraries/components/usb/usb_cdc_adapter/usb_device_class.c" 2
...
# 15 "../../libraries/components/usb/usb_cdc_adapter/usb_device_class.c" 2
...
# 24 "../../libraries/components/usb/usb_cdc_adapter/usb_device_class.c" 2
# 65 "../../libraries/components/usb/usb_cdc_adapter/usb_device_class.c"
...
# 119 "../../libraries/components/usb/usb_cdc_adapter/usb_device_class.c"
    {(usb_device_class_init_call_t)0, (usb_device_class_deinit_call_t)0, (usb_device_class_event_callback_t)0,
     (usb_device_class_type_t)0},
};

           __attribute__((aligned(4U))) static usb_device_common_class_struct_t
    s_UsbDeviceCommonClassStruct[((0U) + (1U) + (0U) + (0U))];
           __attribute__((aligned(4U))) static uint8_t
    s_UsbDeviceSetupBuffer[((0U) + (1U) + (0U) + (0U))][((((8U)) + 4U - 1U) & (~(4U - 1U)))];
# 145 "../../libraries/components/usb/usb_cdc_adapter/usb_device_class.c"
static usb_status_t USB_DeviceClassAllocateHandle(uint8_t controllerId, usb_device_common_class_struct_t **handle)
{
    uint32_t count;
    ...
    {
        if ((0 != s_UsbDeviceCommonClassStruct[count].handle) &&
...
# 188 "../../libraries/components/usb/usb_cdc_adapter/usb_device_class.c"
static usb_status_t USB_DeviceClassFreeHandle(uint8_t controllerId)
{
    uint32_t count = 0U;
    uint32_t osaCurrentSr = 0U;;
    ...
    OSA_EnterCritical(&osaCurrentSr);
    for (; count < ((0U) + (1U) + (0U) + (0U)); count++)
    {
        if ((0 != s_UsbDeviceCommonClassStruct[count].handle) &&
            (controllerId == s_UsbDeviceCommonClassStruct[count].controllerId))
        {
            s_UsbDeviceCommonClassStruct[count].handle = 0;
            s_UsbDeviceCommonClassStruct[count].configList = (usb_device_class_config_list_struct_t *)0;
...
# 223 "../../libraries/components/usb/usb_cdc_adapter/usb_device_class.c"
static usb_status_t USB_DeviceClassGetHandleByControllerId(uint8_t controllerId,
                                                           usb_device_common_class_struct_t **handle)
{
    uint32_t count = 0U;
...
# 256 "../../libraries/components/usb/usb_cdc_adapter/usb_device_class.c"
static usb_status_t USB_DeviceClassGetHandleByDeviceHandle(usb_device_handle deviceHandle,
                                                           usb_device_common_class_struct_t **handle)
{
    uint32_t count = 0U;
...
# 287 "../../libraries/components/usb/usb_cdc_adapter/usb_device_class.c"
usb_status_t USB_DeviceClassGetDeviceHandle(uint8_t controllerId, usb_device_handle *handle)
{
    uint32_t count = 0U;
    uint32_t osaCurrentSr = 0U;;
...
# 321 "../../libraries/components/usb/usb_cdc_adapter/usb_device_class.c"
usb_status_t USB_DeviceClassEvent(usb_device_handle handle, usb_device_class_event_t event, void *param)
{
    ...
    {
        for (mapIndex = 0U; mapIndex < ((sizeof(s_UsbDeviceClassInterfaceMap) / sizeof((s_UsbDeviceClassInterfaceMap)[0])) - 1U); mapIndex++)
        {
...
# 381 "../../libraries/components/usb/usb_cdc_adapter/usb_device_class.c"
usb_status_t USB_DeviceClassCallback(usb_device_handle handle, uint32_t event, void *param)
{
    usb_device_common_class_struct_t *classHandle;
    usb_status_t status;
    ...
    {
# 403 "../../libraries/components/usb/usb_cdc_adapter/usb_device_class.c"
...
# 433 "../../libraries/components/usb/usb_cdc_adapter/usb_device_class.c"
...
)
{
    ...
    if ((0 == handle) || (0 == configList) || ((usb_device_callback_t)0 == configList->deviceCallback))
    {
        return kStatus_USB_InvalidParameter;
    }
    ...
    for (classIndex = 0U; classIndex < classHandle->configList->count; classIndex++)
    {
             ...
             mapIndex++)
        {
            ...
            {
# 494 "../../libraries/components/usb/usb_cdc_adapter/usb_device_class.c"
...
# 515 "../../libraries/components/usb/usb_cdc_adapter/usb_device_class.c"
usb_status_t USB_DeviceClassDeinit(uint8_t controllerId
)
{
    usb_device_common_class_struct_t *classHandle;
    ...
    for (classIndex = 0U; classIndex < classHandle->configList->count; classIndex++)
    {
             ...
             mapIndex++)
        {
            if (classHandle->configList->config[classIndex].classInfomation->type ==
                s_UsbDeviceClassInterfaceMap[mapIndex].type)
            {
# 548 "../../libraries/components/usb/usb_cdc_adapter/usb_device_class.c"
...
# 582 "../../libraries/components/usb/usb_cdc_adapter/usb_device_class.c"
usb_status_t USB_DeviceClassGetSpeed(uint8_t controllerId,
                                     uint8_t *speed
)
{
    usb_device_common_class_struct_t *classHandle;
