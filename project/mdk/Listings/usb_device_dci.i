# 1 "../../libraries/components/usb/device/usb_device_dci.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/components/usb/device/usb_device_dci.c" 2
...
# 10 "../../libraries/components/usb/device/usb_device_dci.c" 2
# 1 "../../libraries/components/usb/include\\usb.h" 1
# 12 "../../libraries/components/usb/include\\usb.h"
...
# 13 "../../libraries/components/usb/include\\usb.h" 2
...
# 11 "../../libraries/components/usb/device/usb_device_dci.c" 2
...
# 13 "../../libraries/components/usb/device/usb_device_dci.c" 2
...
# 14 "../../libraries/components/usb/device/usb_device_dci.c" 2
# 24 "../../libraries/components/usb/device/usb_device_dci.c"
...
usb_status_t USB_DeviceEhciControl(usb_device_handle ehciHandle,
                                   ...
                                   void *param);
# 25 "../../libraries/components/usb/device/usb_device_dci.c" 2
# 58 "../../libraries/components/usb/device/usb_device_dci.c"
...
# 86 "../../libraries/components/usb/device/usb_device_dci.c"
static usb_status_t USB_DeviceNotification(usb_device_struct_t *handle, usb_device_callback_message_struct_t *message);
           ...
           static usb_device_struct_t s_UsbDevice[((0U) + (1U) + (0U) + (0U))];
# 110 "../../libraries/components/usb/device/usb_device_dci.c"
static usb_status_t USB_DeviceAllocateHandle(uint8_t controllerId, usb_device_struct_t **handle)
{
    uint32_t count;
    ...
    for (count = 0U; count < ((0U) + (1U) + (0U) + (0U)); count++)
    {
        if ((0 != s_UsbDevice[count].controllerHandle) && (controllerId == s_UsbDevice[count].controllerId))
        {
    ...
    for (count = 0U; count < ((0U) + (1U) + (0U) + (0U)); count++)
    {
        if (0 == s_UsbDevice[count].controllerHandle)
        {
...
# 149 "../../libraries/components/usb/device/usb_device_dci.c"
static usb_status_t USB_DeviceFreeHandle(usb_device_struct_t *handle)
{
    uint32_t osaCurrentSr = 0U;;

    OSA_EnterCritical(&osaCurrentSr);
    handle->controllerHandle = 0;
    handle->controllerId = 0U;
    OSA_ExitCritical(osaCurrentSr);
    return kStatus_USB_Success;
}
# 169 "../../libraries/components/usb/device/usb_device_dci.c"
...
# 201 "../../libraries/components/usb/device/usb_device_dci.c"
static usb_status_t USB_DeviceGetControllerInterface(
    uint8_t controllerId, const usb_device_controller_interface_struct_t **controllerInterface)
{
...
# 217 "../../libraries/components/usb/device/usb_device_dci.c"
...
# 242 "../../libraries/components/usb/device/usb_device_dci.c"
    return error;
}
# 261 "../../libraries/components/usb/device/usb_device_dci.c"
static usb_status_t USB_DeviceTransfer(usb_device_handle handle,
                                       uint8_t endpointAddress,
                                       uint8_t *buffer,
                                       uint32_t length)
{
    ...
    usb_status_t status;
    uint8_t endpoint = endpointAddress & (0x0FU);
    uint8_t direction = (endpointAddress & (0x80U)) >>
                        (7U);
    uint32_t osaCurrentSr = 0U;;
    ...
    if (0 != deviceHandle->controllerInterface)
    {
        ...
        OSA_ExitCritical(osaCurrentSr);
        if (0U != (endpointAddress & (0x80U)))
        {
# 297 "../../libraries/components/usb/device/usb_device_dci.c"
            status = deviceHandle->controllerInterface->deviceSend(deviceHandle->controllerHandle, endpointAddress,
                                                                   buffer, length);
        }
        else
        {
# 310 "../../libraries/components/usb/device/usb_device_dci.c"
...
# 342 "../../libraries/components/usb/device/usb_device_dci.c"
static usb_status_t USB_DeviceControl(usb_device_handle handle, usb_device_control_type_t type, void *param)
{
    usb_device_struct_t *deviceHandle = (usb_device_struct_t *)handle;
    usb_status_t status;
...
# 375 "../../libraries/components/usb/device/usb_device_dci.c"
static usb_status_t USB_DeviceResetNotification(usb_device_struct_t *handle,
                                                usb_device_callback_message_struct_t *message)
{
    uint32_t count;
# 387 "../../libraries/components/usb/device/usb_device_dci.c"
    handle->isResetting = 1U;
# 407 "../../libraries/components/usb/device/usb_device_dci.c"
    (void)USB_DeviceControl(handle, kUSB_DeviceControlSetDefaultStatus, 0);
    ...
    for (count = 0U; count < ((4U) * 2U); count++)
    {
        handle->epCallback[count].callbackFn = (usb_device_endpoint_callback_t)0;
        handle->epCallback[count].callbackParam = 0;
        handle->epCallback[count].isBusy = 0U;
    }
# 434 "../../libraries/components/usb/device/usb_device_dci.c"
    (void)handle->deviceCallback(handle, kUSB_DeviceEventBusReset, 0);


    handle->isResetting = 0U;
    return kStatus_USB_Success;
}
# 589 "../../libraries/components/usb/device/usb_device_dci.c"
static usb_status_t USB_DeviceNotification(usb_device_struct_t *handle, usb_device_callback_message_struct_t *message)
{
    uint8_t endpoint = message->code & (0x0FU);
    uint8_t direction = (message->code & (0x80U)) >>
                        (7U);
    ...
    switch (deviceNotify)
    {
        case kUSB_DeviceNotifyBusReset:
            ...
            break;
# 635 "../../libraries/components/usb/device/usb_device_dci.c"
        default:
            if (endpoint < (4U))
            {
                if (0 != handle->epCallback[(uint8_t)((uint32_t)endpoint << 1U) | direction].callbackFn)
                {
...
# 674 "../../libraries/components/usb/device/usb_device_dci.c"
usb_status_t USB_DeviceNotificationTrigger(void *handle, void *msg)
{
    usb_device_struct_t *deviceHandle = (usb_device_struct_t *)handle;
    ...
    if (0 == deviceHandle->deviceCallback)
    {
        return kStatus_USB_Error;
    }
# 707 "../../libraries/components/usb/device/usb_device_dci.c"
    return USB_DeviceNotification(deviceHandle, message);

}
# 730 "../../libraries/components/usb/device/usb_device_dci.c"
usb_status_t USB_DeviceInit(uint8_t controllerId, usb_device_callback_t deviceCallback, usb_device_handle *handle)
{
    usb_device_struct_t *deviceHandle = 0;
    usb_status_t error;
    uint32_t count;
    ...
    for (count = 0U; count < ((4U) * 2U); count++)
    {
        deviceHandle->epCallback[count].callbackFn = (usb_device_endpoint_callback_t)0;
        deviceHandle->epCallback[count].callbackParam = 0;
    ...
    if (((usb_device_controller_init_t)0 == deviceHandle->controllerInterface->deviceInit) ||
        ((usb_device_controller_deinit_t)0 == deviceHandle->controllerInterface->deviceDeinit) ||
        ((usb_device_controller_send_t)0 == deviceHandle->controllerInterface->deviceSend) ||
        ((usb_device_controller_recv_t)0 == deviceHandle->controllerInterface->deviceRecv) ||
        ((usb_device_controller_cancel_t)0 == deviceHandle->controllerInterface->deviceCancel) ||
        ((usb_device_controller_control_t)0 == deviceHandle->controllerInterface->deviceControl))
    {
...
# 829 "../../libraries/components/usb/device/usb_device_dci.c"
    *handle = deviceHandle;
...
# 865 "../../libraries/components/usb/device/usb_device_dci.c"
usb_status_t USB_DeviceRun(usb_device_handle handle)
{
    return USB_DeviceControl(handle, kUSB_DeviceControlRun, 0);
}
# 881 "../../libraries/components/usb/device/usb_device_dci.c"
usb_status_t USB_DeviceStop(usb_device_handle handle)
{
    return USB_DeviceControl(handle, kUSB_DeviceControlStop, 0);
}
# 895 "../../libraries/components/usb/device/usb_device_dci.c"
usb_status_t USB_DeviceDeinit(usb_device_handle handle)
{
    ...
    if (0 != deviceHandle->controllerInterface)
    {
        ...
        deviceHandle->controllerInterface = (usb_device_controller_interface_struct_t *)0;
    }
# 941 "../../libraries/components/usb/device/usb_device_dci.c"
    (void)USB_DeviceFreeHandle(deviceHandle);

    return kStatus_USB_Success;
}
# 970 "../../libraries/components/usb/device/usb_device_dci.c"
...
# 1002 "../../libraries/components/usb/device/usb_device_dci.c"
...
# 1022 "../../libraries/components/usb/device/usb_device_dci.c"
...
# 1061 "../../libraries/components/usb/device/usb_device_dci.c"
                                    ...
                                    usb_device_endpoint_callback_struct_t *epCallback)
{
    ...
    if ((0 == epInit) || (0 == epCallback))
    {
        return kStatus_USB_InvalidParameter;
    }

    endpoint = epInit->endpointAddress & (0x0FU);
    direction = (epInit->endpointAddress & (0x80U)) >>
                (7U);
...
# 1111 "../../libraries/components/usb/device/usb_device_dci.c"
usb_status_t USB_DeviceDeinitEndpoint(usb_device_handle handle, uint8_t endpointAddress)
{
    ...
    if (endpoint < (4U))
    {
        deviceHandle->epCallback[(uint8_t)((uint32_t)endpoint << 1U) | direction].callbackFn =
            (usb_device_endpoint_callback_t)0;
        deviceHandle->epCallback[(uint8_t)((uint32_t)endpoint << 1U) | direction].callbackParam = 0;
        deviceHandle->epCallback[(uint8_t)((uint32_t)endpoint << 1U) | direction].isBusy = 0U;
    }
    else
    {
...
# 1190 "../../libraries/components/usb/device/usb_device_dci.c"
...
# 1217 "../../libraries/components/usb/device/usb_device_dci.c"
...
# 1286 "../../libraries/components/usb/device/usb_device_dci.c"
usb_status_t USB_DeviceSetStatus(usb_device_handle handle, usb_device_status_t type, void *param)
{
    ...
    switch (type)
    {
        ...
        case kUSB_DeviceStatusBusSleepResume:
            ...
            break;
# 1341 "../../libraries/components/usb/device/usb_device_dci.c"
...
# 1437 "../../libraries/components/usb/device/usb_device_dci.c"
void USB_DeviceGetVersion(uint32_t *version)
{
    if (0 != version)
    {
        *version =
            (uint32_t)((((2UL)) << 16) | (((8UL)) << 8) | ((2U)));
    }
}
