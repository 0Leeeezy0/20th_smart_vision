# 1 "../../libraries/sdk/drives/fsl_pmu.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/sdk/drives/fsl_pmu.c" 2
...
# 1 "../../libraries/sdk/drives/fsl_pmu.h" 1
# 11 "../../libraries/sdk/drives/fsl_pmu.h"
...
# 12 "../../libraries/sdk/drives/fsl_pmu.h" 2
# 29 "../../libraries/sdk/drives/fsl_pmu.h"
enum
{
...
# 91 "../../libraries/sdk/drives/fsl_pmu.h"
typedef enum _pmu_power_bandgap
{
    kPMU_NormalPowerBandgap = 0U,
    kPMU_LowPowerBandgap = 1U,
} pmu_power_bandgap_t;
# 117 "../../libraries/sdk/drives/fsl_pmu.h"
uint32_t PMU_GetStatusFlags(PMU_Type *base);
# 132 "../../libraries/sdk/drives/fsl_pmu.h"
static inline void PMU_1P1SetWeakReferenceSource(PMU_Type *base, pmu_1p1_weak_reference_source_t option)
{
    base->REG_1P1 = (base->REG_1P1 & ~(0x80000U)) | (((uint32_t)(((uint32_t)(option)) << (19U))) & (0x80000U));
}
# 145 "../../libraries/sdk/drives/fsl_pmu.h"
static inline void PMU_1P1EnableWeakRegulator(PMU_Type *base, _Bool enable)
{
    if (enable)
    {
        base->REG_1P1 |= (0x40000U);
    }
    else
    {
        base->REG_1P1 &= ~(0x40000U);
...
# 171 "../../libraries/sdk/drives/fsl_pmu.h"
static inline void PMU_1P1SetRegulatorOutputVoltage(PMU_Type *base, uint32_t value)
{
    base->REG_1P1 = (base->REG_1P1 & ~(0x1F00U)) | (((uint32_t)(((uint32_t)(value)) << (8U))) & (0x1F00U));
}
# 187 "../../libraries/sdk/drives/fsl_pmu.h"
static inline void PMU_1P1SetBrownoutOffsetVoltage(PMU_Type *base, uint32_t value)
{
    base->REG_1P1 = (base->REG_1P1 & ~(0x70U)) | (((uint32_t)(((uint32_t)(value)) << (4U))) & (0x70U));
}
...
static inline void PMU_1P1EnablePullDown(PMU_Type *base, _Bool enable)
{
    if (enable)
    {
        base->REG_1P1 |= (0x8U);
...
static inline void PMU_1P1EnableCurrentLimit(PMU_Type *base, _Bool enable)
{
    if (enable)
    {
        base->REG_1P1 |= (0x4U);
...
static inline void PMU_1P1EnableBrownout(PMU_Type *base, _Bool enable)
{
    if (enable)
    {
        base->REG_1P1 |= (0x2U);
...
static inline void PMU_1P1EnableOutput(PMU_Type *base, _Bool enable)
{
    if (enable)
    {
        base->REG_1P1 |= (0x1U);
...
# 284 "../../libraries/sdk/drives/fsl_pmu.h"
static inline void PMU_3P0SetRegulatorOutputVoltage(PMU_Type *base, uint32_t value)
{
    base->REG_3P0 = (base->REG_3P0 & ~(0x1F00U)) | (((uint32_t)(((uint32_t)(value)) << (8U))) & (0x1F00U));
}
# 298 "../../libraries/sdk/drives/fsl_pmu.h"
static inline void PMU_3P0SetVBusVoltageSource(PMU_Type *base, pmu_3p0_vbus_voltage_source_t option)
{
    base->REG_3P0 = (base->REG_3P0 & ~(0x80U)) | (((uint32_t)(((uint32_t)(option)) << (7U))) & (0x80U));
}
# 314 "../../libraries/sdk/drives/fsl_pmu.h"
static inline void PMU_3P0SetBrownoutOffsetVoltage(PMU_Type *base, uint32_t value)
{
    base->REG_3P0 = (base->REG_3P0 & ~(0x70U)) | (((uint32_t)(((uint32_t)(value)) << (4U))) & (0x70U));
}
...
static inline void PMU_3P0EnableCurrentLimit(PMU_Type *base, _Bool enable)
{
    if (enable)
    {
        base->REG_3P0 |= (0x4U);
...
static inline void PMU_3P0EnableBrownout(PMU_Type *base, _Bool enable)
{
    if (enable)
    {
        base->REG_3P0 |= (0x2U);
...
static inline void PMU_3P0EnableOutput(PMU_Type *base, _Bool enable)
{
    if (enable)
    {
        base->REG_3P0 |= (0x1U);
...
# 389 "../../libraries/sdk/drives/fsl_pmu.h"
static inline void PMU_2P5EnableWeakRegulator(PMU_Type *base, _Bool enable)
{
    if (enable)
    {
        base->REG_2P5 |= (0x40000U);
    }
    else
    {
        base->REG_2P5 &= ~(0x40000U);
...
# 415 "../../libraries/sdk/drives/fsl_pmu.h"
static inline void PMU_2P5SetRegulatorOutputVoltage(PMU_Type *base, uint32_t value)
{
    base->REG_2P5 = (base->REG_2P5 & ~(0x1F00U)) | (((uint32_t)(((uint32_t)(value)) << (8U))) & (0x1F00U));
}
# 431 "../../libraries/sdk/drives/fsl_pmu.h"
static inline void PMU_2P5SetBrownoutOffsetVoltage(PMU_Type *base, uint32_t value)
{
    base->REG_2P5 = (base->REG_2P5 & ~(0x70U)) | (((uint32_t)(((uint32_t)(value)) << (4U))) & (0x70U));
}
...
static inline void PMU_2P5EnablePullDown(PMU_Type *base, _Bool enable)
{
    if (enable)
    {
        base->REG_2P5 |= (0x8U);
...
static inline void PMU_2P1EnablePullDown(PMU_Type *base, _Bool enable)
{
    if (enable)
    {
        base->REG_2P5 |= (0x8U);
...
static inline void PMU_2P5EnableCurrentLimit(PMU_Type *base, _Bool enable)
{
    if (enable)
    {
        base->REG_2P5 |= (0x4U);
...
static inline void PMU_2P5nableBrownout(PMU_Type *base, _Bool enable)
{
    if (enable)
    {
        base->REG_2P5 |= (0x2U);
...
static inline void PMU_2P5EnableOutput(PMU_Type *base, _Bool enable)
{
    if (enable)
    {
        base->REG_2P5 |= (0x1U);
...
# 543 "../../libraries/sdk/drives/fsl_pmu.h"
static inline void PMU_CoreEnableIncreaseGateDrive(PMU_Type *base, _Bool enable)
{
    if (enable)
    {
        base->REG_CORE |= (0x20000000U);
    }
    else
    {
        base->REG_CORE &= ~(0x20000000U);
...
{
    base->REG_CORE = (base->REG_CORE & ~(0x18000000U)) | (((uint32_t)(((uint32_t)(option)) << (27U))) & (0x18000000U));
}
# 585 "../../libraries/sdk/drives/fsl_pmu.h"
static inline void PMU_CoreSetSOCDomainVoltage(PMU_Type *base, uint32_t value)
{
    base->REG_CORE = (base->REG_CORE & ~(0x7C0000U)) | (((uint32_t)(((uint32_t)(value)) << (18U))) & (0x7C0000U));
}
# 609 "../../libraries/sdk/drives/fsl_pmu.h"
static inline void PMU_CoreSetARMCoreDomainVoltage(PMU_Type *base, uint32_t value)
{
    base->REG_CORE = (base->REG_CORE & ~(0x1FU)) | (((uint32_t)(((uint32_t)(value)) << (0U))) & (0x1FU));
}
# 9 "../../libraries/sdk/drives/fsl_pmu.c" 2
# 20 "../../libraries/sdk/drives/fsl_pmu.c"
uint32_t PMU_GetStatusFlags(PMU_Type *base)
{
    uint32_t ret = 0U;


    if ((0x20000U) == ((0x20000U) & base->REG_1P1))
    {
        ret |= (uint32_t)kPMU_1P1RegulatorOutputOK;
    }
    if ((0x10000U) == ((0x10000U) & base->REG_1P1))
    {
        ret |= (uint32_t)kPMU_1P1BrownoutOnOutput;
    }


    if ((0x20000U) == ((0x20000U) & base->REG_3P0))
    {
        ret |= (uint32_t)kPMU_3P0RegulatorOutputOK;
    }
    if ((0x10000U) == ((0x10000U) & base->REG_3P0))
    {
        ret |= (uint32_t)kPMU_3P0BrownoutOnOutput;
    }


    if ((0x20000U) == ((0x20000U) & base->REG_2P5))
    {
        ret |= (uint32_t)kPMU_2P5RegulatorOutputOK;
    }
    if ((0x10000U) == ((0x10000U) & base->REG_2P5))
    {
