# 1 "../../libraries/zf_common/zf_common_debug.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/zf_common/zf_common_debug.c" 2
# 36 "../../libraries/zf_common/zf_common_debug.c"
...
# 37 "../../libraries/zf_common/zf_common_debug.c" 2
# 1 "../../libraries/zf_common/zf_common_fifo.h" 1
# 39 "../../libraries/zf_common/zf_common_fifo.h"
...
# 40 "../../libraries/zf_common/zf_common_fifo.h" 2
...
# 38 "../../libraries/zf_common/zf_common_debug.c" 2
...
# 39 "../../libraries/zf_common/zf_common_debug.c" 2
...
# 40 "../../libraries/zf_common/zf_common_debug.c" 2
...
# 41 "../../libraries/zf_common/zf_common_debug.c" 2
...
# 42 "../../libraries/zf_common/zf_common_debug.c" 2
...
# 44 "../../libraries/zf_common/zf_common_debug.c" 2


uint8 debug_uart_buffer[(64)];
...
# 62 "../../libraries/zf_common/zf_common_debug.c"
...
# 81 "../../libraries/zf_common/zf_common_debug.c"
...
# 115 "../../libraries/zf_common/zf_common_debug.c"
static void debug_uart_str_output (const char *str)
{
    uart_write_string((UART_1), str);
}
# 130 "../../libraries/zf_common/zf_common_debug.c"
...
# 257 "../../libraries/zf_common/zf_common_debug.c"
uint32 debug_send_buffer(const uint8 *buff, uint32 len)
{
    uart_write_buffer((UART_1), buff, len);
    return 0;
}
# 272 "../../libraries/zf_common/zf_common_debug.c"
uint32 debug_read_ring_buffer (uint8 *buff, uint32 len)
{
    fifo_read_buffer(&debug_uart_fifo, buff, &len, FIFO_READ_AND_CLEAN);
    return len;
}
# 287 "../../libraries/zf_common/zf_common_debug.c"
void debug_interrupr_handler (void)
{
    if(zf_debug_init_flag && !debug_output_info.type_index)
    {
        uart_query_byte((UART_1), &debug_uart_data);
        fifo_write_buffer(&debug_uart_fifo, &debug_uart_data, 1);
    }
}
# 353 "../../libraries/zf_common/zf_common_debug.c"
int32_t fputc (int32_t ch, FILE* f)
{
    if(zf_debug_init_flag)
    {
        uart_write_byte((UART_1), (ch & 0xFF));
    }
    return ch;
}
...
int fgetc(FILE *f)
{
    ...
    if(zf_debug_init_flag)
    {
        data = uart_read_byte((UART_1));
    }
    return data;
}
# 381 "../../libraries/zf_common/zf_common_debug.c"
void debug_assert_enable (void)
{
    zf_debug_assert_enable = 1;
}
# 393 "../../libraries/zf_common/zf_common_debug.c"
void debug_assert_disable (void)
{
    zf_debug_assert_enable = 0;
}
# 408 "../../libraries/zf_common/zf_common_debug.c"
void debug_assert_handler (uint8 pass, char *file, int line)
{
    do
    {
        ...
        while(1)
        {
# 443 "../../libraries/zf_common/zf_common_debug.c"
            debug_output("Assert error", file, line, 0);
            debug_delay();
        }
    }while(0);
}
# 460 "../../libraries/zf_common/zf_common_debug.c"
void debug_log_handler (uint8 pass, char *str, char *file, int line)
{
    do
    {
...
# 483 "../../libraries/zf_common/zf_common_debug.c"
void debug_output_struct_init (debug_output_struct *info)
{
    info->type_index = 0;
    ...
    info->output_uart = 0;
    info->output_screen = 0;
    info->output_screen_clear = 0;
}
# 505 "../../libraries/zf_common/zf_common_debug.c"
void debug_output_init (debug_output_struct *info)
{
...
# 529 "../../libraries/zf_common/zf_common_debug.c"
void debug_init (void)
{
