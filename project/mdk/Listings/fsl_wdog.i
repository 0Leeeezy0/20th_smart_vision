# 1 "../../libraries/sdk/drives/fsl_wdog.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/sdk/drives/fsl_wdog.c" 2
...
# 11 "../../libraries/sdk/drives/fsl_wdog.h"
...
# 12 "../../libraries/sdk/drives/fsl_wdog.h" 2
...
# 10 "../../libraries/sdk/drives/fsl_wdog.c" 2
# 19 "../../libraries/sdk/drives/fsl_wdog.c"
static WDOG_Type *const s_wdogBases[] = { (WDOG_Type *)0u, ((WDOG_Type *)(0x400B8000u)), ((WDOG_Type *)(0x400D0000u)) };


static const clock_ip_name_t s_wdogClock[] = { kCLOCK_IpInvalid, kCLOCK_Wdog1, kCLOCK_Wdog2 };


static const IRQn_Type s_wdogIRQ[] = { NotAvail_IRQn, WDOG1_IRQn, WDOG2_IRQn };
...
static uint32_t WDOG_GetInstance(WDOG_Type *base)
{
    ...
    for (instance = 0; instance < (sizeof(s_wdogBases) / sizeof((s_wdogBases)[0])); instance++)
    {
    ...
    ((instance < (sizeof(s_wdogBases) / sizeof((s_wdogBases)[0]))) ? (void)0 : __aeabi_assert("instance < ARRAY_SIZE(s_wdogBases)", "../../libraries/sdk/drives/fsl_wdog.c", 43),
# 43 "../../libraries/sdk/drives/fsl_wdog.c"
#pragma clang diagnostic push
# 43 "../../libraries/sdk/drives/fsl_wdog.c"
#pragma clang diagnostic ignored "-Wassume"
# 43 "../../libraries/sdk/drives/fsl_wdog.c"
    (__builtin_assume)((instance < (sizeof(s_wdogBases) / sizeof((s_wdogBases)[0])))?1:0)
# 43 "../../libraries/sdk/drives/fsl_wdog.c"
#pragma clang diagnostic pop
# 43 "../../libraries/sdk/drives/fsl_wdog.c"
    );
...
# 68 "../../libraries/sdk/drives/fsl_wdog.c"
void WDOG_GetDefaultConfig(wdog_config_t *config)
{
    ((0 != config) ? (void)0 : __aeabi_assert("NULL != config", "../../libraries/sdk/drives/fsl_wdog.c", 70),
# 70 "../../libraries/sdk/drives/fsl_wdog.c"
#pragma clang diagnostic push
# 70 "../../libraries/sdk/drives/fsl_wdog.c"
#pragma clang diagnostic ignored "-Wassume"
# 70 "../../libraries/sdk/drives/fsl_wdog.c"
...
# 70 "../../libraries/sdk/drives/fsl_wdog.c"
    ...
    config->enableWdog = 1;
    config->workMode.enableWait = 0;
    config->workMode.enableStop = 0;
    config->workMode.enableDebug = 0;
    config->enableInterrupt = 0;
    config->softwareResetExtension = 0;
    config->enablePowerDown = 0;
    config->timeoutValue = 0xffu;
    config->interruptTimeValue = 0x04u;
    config->enableTimeOutAssert = 0;
}
# 104 "../../libraries/sdk/drives/fsl_wdog.c"
void WDOG_Init(WDOG_Type *base, const wdog_config_t *config)
{
    ((0 != config) ? (void)0 : __aeabi_assert("NULL != config", "../../libraries/sdk/drives/fsl_wdog.c", 106),
# 106 "../../libraries/sdk/drives/fsl_wdog.c"
#pragma clang diagnostic push
# 106 "../../libraries/sdk/drives/fsl_wdog.c"
#pragma clang diagnostic ignored "-Wassume"
# 106 "../../libraries/sdk/drives/fsl_wdog.c"
...
# 106 "../../libraries/sdk/drives/fsl_wdog.c"
    ...
    value = (((uint16_t)(((uint16_t)(config->enableWdog)) << (2U))) & (0x4U)) | (((uint16_t)(((uint16_t)(config->workMode.enableWait)) << (7U))) & (0x80U)) |
            (((uint16_t)(((uint16_t)(config->workMode.enableStop)) << (0U))) & (0x1U)) | (((uint16_t)(((uint16_t)(config->workMode.enableDebug)) << (1U))) & (0x2U)) |
            (((uint16_t)(((uint16_t)(config->softwareResetExtension)) << (6U))) & (0x40U)) | (((uint16_t)(((uint16_t)(config->timeoutValue)) << (8U))) & (0xFF00U)) |
            (((uint16_t)(((uint16_t)(config->enableTimeOutAssert)) << (3U))) & (0x8U)) | (0x10U) | (0x20U);
    ...
    base->WICR = (((uint16_t)(((uint16_t)(config->interruptTimeValue)) << (0U))) & (0xFFU)) | (((uint16_t)(((uint16_t)(config->enableInterrupt)) << (15U))) & (0x8000U));
    base->WMCR = (((uint16_t)(((uint16_t)(config->enablePowerDown)) << (0U))) & (0x1U));
    base->WCR = value;
...
# 140 "../../libraries/sdk/drives/fsl_wdog.c"
void WDOG_Deinit(WDOG_Type *base)
{
    if (0U != (base->WCR & (0x2U)))
    {
...
# 162 "../../libraries/sdk/drives/fsl_wdog.c"
uint16_t WDOG_GetStatusFlags(WDOG_Type *base)
{
    uint16_t status_flag = 0U;

    status_flag |= (base->WCR & (0x4U));
    status_flag |= (base->WRSR & (0x10U));
    status_flag |= (base->WRSR & (0x2U));
    status_flag |= (base->WRSR & (0x1U));
    status_flag |= (base->WICR & (0x4000U));

    return status_flag;
}
# 189 "../../libraries/sdk/drives/fsl_wdog.c"
void WDOG_ClearInterruptStatus(WDOG_Type *base, uint16_t mask)
{
...
# 205 "../../libraries/sdk/drives/fsl_wdog.c"
void WDOG_Refresh(WDOG_Type *base)
{
    uint32_t primaskValue = 0U;
    ...
    primaskValue = DisableGlobalIRQ();
    base->WSR = (0xAAAA5555U) & 0xFFFFU;
    base->WSR = ((0xAAAA5555U) >> 16U) & 0xFFFFU;
    EnableGlobalIRQ(primaskValue);
}
