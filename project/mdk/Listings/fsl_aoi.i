# 1 "../../libraries/sdk/drives/fsl_aoi.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/sdk/drives/fsl_aoi.c" 2
...
# 1 "../../libraries/sdk/drives/fsl_aoi.h" 1
# 11 "../../libraries/sdk/drives/fsl_aoi.h"
...
# 12 "../../libraries/sdk/drives/fsl_aoi.h" 2
# 35 "../../libraries/sdk/drives/fsl_aoi.h"
...
# 101 "../../libraries/sdk/drives/fsl_aoi.h"
void AOI_Init(AOI_Type *base);
# 110 "../../libraries/sdk/drives/fsl_aoi.h"
void AOI_Deinit(AOI_Type *base);
# 135 "../../libraries/sdk/drives/fsl_aoi.h"
void AOI_GetEventLogicConfig(AOI_Type *base, aoi_event_t event, aoi_event_config_t *config);
# 176 "../../libraries/sdk/drives/fsl_aoi.h"
void AOI_SetEventLogicConfig(AOI_Type *base, aoi_event_t event, const aoi_event_config_t *eventConfig);
# 9 "../../libraries/sdk/drives/fsl_aoi.c" 2
# 19 "../../libraries/sdk/drives/fsl_aoi.c"
static AOI_Type *const s_aoiBases[] = { (AOI_Type *)0u, ((AOI_Type *)(0x403B4000u)), ((AOI_Type *)(0x403B8000u)) };



static const clock_ip_name_t s_aoiClocks[] = { kCLOCK_IpInvalid, kCLOCK_Aoi1, kCLOCK_Aoi2 };
# 35 "../../libraries/sdk/drives/fsl_aoi.c"
...
static uint32_t AOI_GetInstance(AOI_Type *base)
{
    ...
    for (instance = 0; instance < (sizeof(s_aoiBases) / sizeof((s_aoiBases)[0])); instance++)
    {
    ...
    ((instance < (sizeof(s_aoiBases) / sizeof((s_aoiBases)[0]))) ? (void)0 : __aeabi_assert("instance < ARRAY_SIZE(s_aoiBases)", "../../libraries/sdk/drives/fsl_aoi.c", 53),
# 53 "../../libraries/sdk/drives/fsl_aoi.c"
#pragma clang diagnostic push
# 53 "../../libraries/sdk/drives/fsl_aoi.c"
#pragma clang diagnostic ignored "-Wassume"
# 53 "../../libraries/sdk/drives/fsl_aoi.c"
    (__builtin_assume)((instance < (sizeof(s_aoiBases) / sizeof((s_aoiBases)[0])))?1:0)
# 53 "../../libraries/sdk/drives/fsl_aoi.c"
#pragma clang diagnostic pop
# 53 "../../libraries/sdk/drives/fsl_aoi.c"
    );
...
# 65 "../../libraries/sdk/drives/fsl_aoi.c"
void AOI_Init(AOI_Type *base)
{
...
# 80 "../../libraries/sdk/drives/fsl_aoi.c"
void AOI_Deinit(AOI_Type *base)
{
...
# 104 "../../libraries/sdk/drives/fsl_aoi.c"
void AOI_GetEventLogicConfig(AOI_Type *base, aoi_event_t event, aoi_event_config_t *config)
{
    (((uint32_t)event < (uint32_t)(4)) ? (void)0 : __aeabi_assert("(uint32_t)event < (uint32_t)FSL_FEATURE_AOI_EVENT_COUNT", "../../libraries/sdk/drives/fsl_aoi.c", 106),
# 106 "../../libraries/sdk/drives/fsl_aoi.c"
#pragma clang diagnostic push
# 106 "../../libraries/sdk/drives/fsl_aoi.c"
#pragma clang diagnostic ignored "-Wassume"
# 106 "../../libraries/sdk/drives/fsl_aoi.c"
    (__builtin_assume)(((uint32_t)event < (uint32_t)(4))?1:0)
# 106 "../../libraries/sdk/drives/fsl_aoi.c"
#pragma clang diagnostic pop
# 106 "../../libraries/sdk/drives/fsl_aoi.c"
    );
    ((config != 0) ? (void)0 : __aeabi_assert("config != NULL", "../../libraries/sdk/drives/fsl_aoi.c", 107),
# 107 "../../libraries/sdk/drives/fsl_aoi.c"
#pragma clang diagnostic push
# 107 "../../libraries/sdk/drives/fsl_aoi.c"
#pragma clang diagnostic ignored "-Wassume"
# 107 "../../libraries/sdk/drives/fsl_aoi.c"
...
# 193 "../../libraries/sdk/drives/fsl_aoi.c"
void AOI_SetEventLogicConfig(AOI_Type *base, aoi_event_t event, const aoi_event_config_t *eventConfig)
{
    ((eventConfig != 0) ? (void)0 : __aeabi_assert("eventConfig != NULL", "../../libraries/sdk/drives/fsl_aoi.c", 195),
# 195 "../../libraries/sdk/drives/fsl_aoi.c"
#pragma clang diagnostic push
# 195 "../../libraries/sdk/drives/fsl_aoi.c"
#pragma clang diagnostic ignored "-Wassume"
# 195 "../../libraries/sdk/drives/fsl_aoi.c"
    (__builtin_assume)((eventConfig != 0)?1:0)
# 195 "../../libraries/sdk/drives/fsl_aoi.c"
#pragma clang diagnostic pop
# 195 "../../libraries/sdk/drives/fsl_aoi.c"
    );
    (((uint32_t)event < (uint32_t)(4)) ? (void)0 : __aeabi_assert("(uint32_t)event < (uint32_t)FSL_FEATURE_AOI_EVENT_COUNT", "../../libraries/sdk/drives/fsl_aoi.c", 196),
# 196 "../../libraries/sdk/drives/fsl_aoi.c"
#pragma clang diagnostic push
# 196 "../../libraries/sdk/drives/fsl_aoi.c"
#pragma clang diagnostic ignored "-Wassume"
# 196 "../../libraries/sdk/drives/fsl_aoi.c"
...
# 196 "../../libraries/sdk/drives/fsl_aoi.c"
    ...
    value = (((uint16_t)(((uint16_t)(eventConfig->PT0AC)) << (14U))) & (0xC000U)) | (((uint16_t)(((uint16_t)(eventConfig->PT0BC)) << (12U))) & (0x3000U)) |
            (((uint16_t)(((uint16_t)(eventConfig->PT0CC)) << (10U))) & (0xC00U)) | (((uint16_t)(((uint16_t)(eventConfig->PT0DC)) << (8U))) & (0x300U)) |
            (((uint16_t)(((uint16_t)(eventConfig->PT1AC)) << (6U))) & (0xC0U)) | (((uint16_t)(((uint16_t)(eventConfig->PT1BC)) << (4U))) & (0x30U)) |
            (((uint16_t)(((uint16_t)(eventConfig->PT1CC)) << (2U))) & (0xCU)) | (((uint16_t)(((uint16_t)(eventConfig->PT1DC)) << (0U))) & (0x3U));

    base->BFCRT[event].BFCRT01 = value;


    value = (((uint16_t)(((uint16_t)(eventConfig->PT2AC)) << (14U))) & (0xC000U)) | (((uint16_t)(((uint16_t)(eventConfig->PT2BC)) << (12U))) & (0x3000U)) |
            (((uint16_t)(((uint16_t)(eventConfig->PT2CC)) << (10U))) & (0xC00U)) | (((uint16_t)(((uint16_t)(eventConfig->PT2DC)) << (8U))) & (0x300U)) |
            (((uint16_t)(((uint16_t)(eventConfig->PT3AC)) << (6U))) & (0xC0U)) | (((uint16_t)(((uint16_t)(eventConfig->PT3BC)) << (4U))) & (0x30U)) |
            (((uint16_t)(((uint16_t)(eventConfig->PT3CC)) << (2U))) & (0xCU)) | (((uint16_t)(((uint16_t)(eventConfig->PT3DC)) << (0U))) & (0x3U));
