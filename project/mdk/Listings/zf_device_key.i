# 1 "../../libraries/zf_device/zf_device_key.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/zf_device/zf_device_key.c" 2
# 47 "../../libraries/zf_device/zf_device_key.c"
...
# 48 "../../libraries/zf_device/zf_device_key.c" 2

# 1 "../../libraries/zf_device/zf_device_key.h" 1
# 52 "../../libraries/zf_device/zf_device_key.h"
...
# 53 "../../libraries/zf_device/zf_device_key.h" 2
...
# 50 "../../libraries/zf_device/zf_device_key.c" 2

static uint32 scanner_period = 0;
static uint32 key_press_time[KEY_NUMBER];
static key_state_enum key_state[KEY_NUMBER];

static const gpio_pin_enum key_index[KEY_NUMBER] = {C15, C14, C13, C12};
# 64 "../../libraries/zf_device/zf_device_key.c"
void key_scanner (void)
{
    uint8 i = 0;
    for(i = 0; KEY_NUMBER > i; i ++)
    {
        if((GPIO_HIGH) != gpio_get_level(key_index[i]))
        {
            key_press_time[i] ++;
            if((1000 ) / scanner_period <= key_press_time[i])
            {
        ...
        {
            if((KEY_LONG_PRESS != key_state[i]) && ((10 ) / scanner_period <= key_press_time[i]))
            {
...
# 99 "../../libraries/zf_device/zf_device_key.c"
key_state_enum key_get_state (key_index_enum key_n)
{
    return key_state[key_n];
}
# 111 "../../libraries/zf_device/zf_device_key.c"
void key_clear_state (key_index_enum key_n)
{
    key_state[key_n] = KEY_RELEASE;
}
# 123 "../../libraries/zf_device/zf_device_key.c"
void key_clear_all_state (void)
{
...
# 138 "../../libraries/zf_device/zf_device_key.c"
void key_init (uint32 period)
{
    (debug_assert_handler((0 < period), "../../libraries/zf_device/zf_device_key.c", 140));
    uint8 loop_temp = 0;
