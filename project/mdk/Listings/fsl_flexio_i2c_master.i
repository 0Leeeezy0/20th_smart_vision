# 1 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c" 2
...
# 1 "../../libraries/sdk/drives/fsl_flexio_i2c_master.h" 1
# 11 "../../libraries/sdk/drives/fsl_flexio_i2c_master.h"
...
# 12 "../../libraries/sdk/drives/fsl_flexio_i2c_master.h" 2
...
# 13 "../../libraries/sdk/drives/fsl_flexio_i2c_master.h" 2
# 34 "../../libraries/sdk/drives/fsl_flexio_i2c_master.h"
enum
{
    kStatus_FLEXIO_I2C_Busy = ((((kStatusGroup_FLEXIO_I2C)*100L) + (0))),
    kStatus_FLEXIO_I2C_Idle = ((((kStatusGroup_FLEXIO_I2C)*100L) + (1))),
    kStatus_FLEXIO_I2C_Nak = ((((kStatusGroup_FLEXIO_I2C)*100L) + (2))),
    kStatus_FLEXIO_I2C_Timeout = ((((kStatusGroup_FLEXIO_I2C)*100L) + (3))),
};
...
# 142 "../../libraries/sdk/drives/fsl_flexio_i2c_master.h"
status_t FLEXIO_I2C_CheckForBusyBus(FLEXIO_I2C_Type *base);
# 173 "../../libraries/sdk/drives/fsl_flexio_i2c_master.h"
...
# 194 "../../libraries/sdk/drives/fsl_flexio_i2c_master.h"
...
static inline void FLEXIO_I2C_MasterEnable(FLEXIO_I2C_Type *base, _Bool enable)
{
    if (enable)
    {
...
# 224 "../../libraries/sdk/drives/fsl_flexio_i2c_master.h"
uint32_t FLEXIO_I2C_MasterGetStatusFlags(FLEXIO_I2C_Type *base);
# 236 "../../libraries/sdk/drives/fsl_flexio_i2c_master.h"
void FLEXIO_I2C_MasterClearStatusFlags(FLEXIO_I2C_Type *base, uint32_t mask);
# 253 "../../libraries/sdk/drives/fsl_flexio_i2c_master.h"
...
# 277 "../../libraries/sdk/drives/fsl_flexio_i2c_master.h"
void FLEXIO_I2C_MasterSetBaudRate(FLEXIO_I2C_Type *base, uint32_t baudRate_Bps, uint32_t srcClock_Hz);
# 294 "../../libraries/sdk/drives/fsl_flexio_i2c_master.h"
...
void FLEXIO_I2C_MasterEnableAck(FLEXIO_I2C_Type *base, _Bool enable);
# 336 "../../libraries/sdk/drives/fsl_flexio_i2c_master.h"
status_t FLEXIO_I2C_MasterSetTransferCount(FLEXIO_I2C_Type *base, uint16_t count);
# 348 "../../libraries/sdk/drives/fsl_flexio_i2c_master.h"
...
# 362 "../../libraries/sdk/drives/fsl_flexio_i2c_master.h"
...
# 10 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c" 2
# 21 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
enum _flexio_i2c_master_transfer_states
{
    kFLEXIO_I2C_Idle = 0x0U,
    kFLEXIO_I2C_Start = 0x1U,
    kFLEXIO_I2C_SendCommand = 0x2U,
    kFLEXIO_I2C_SendData = 0x3U,
    kFLEXIO_I2C_ReceiveDataBegin = 0x4U,
    kFLEXIO_I2C_ReceiveData = 0x5U,
};
# 43 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
static status_t FLEXIO_I2C_MasterTransferInitStateMachine(FLEXIO_I2C_Type *base,
                                                          flexio_i2c_master_handle_t *handle,
                                                          flexio_i2c_master_transfer_t *xfer);
# 56 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
static status_t FLEXIO_I2C_MasterTransferRunStateMachine(FLEXIO_I2C_Type *base,
                                                         flexio_i2c_master_handle_t *handle,
                                                         uint32_t statusFlags);
# 67 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
                                                          ...
                                                          flexio_i2c_master_transfer_t *xfer)
{
    ...
    tmpConfig &= ~(0x7000U);
    tmpConfig |= (((uint32_t)(((uint32_t)(kFLEXIO_TimerDisableOnPreTimerDisable)) << (12U))) & (0x7000U));
    base->flexioBase->TIMCFG[base->timerIndex[1]] = tmpConfig;
# 143 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
                                                         ...
                                                         uint32_t statusFlags)
{
    ...
    if ((statusFlags & (uint32_t)kFLEXIO_I2C_ReceiveNakFlag) != 0U)
    {
               ...
               (handle->transfer.dataSize == 1U))))
        {
            ...
            SDK_DelayAtLeastUs(1000000UL / base->baudrate, (600000000UL));
            ...
            if ((statusFlags & (uint32_t)kFLEXIO_I2C_TxEmptyFlag) != 0U)
            {
                if (handle->transfer.subaddressSize > 0U)
                {
                    ...
                    if (handle->transfer.subaddressSize == 0U)
                    {
                        ...
                        {
# 246 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
                            while (0U ==
...
# 283 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
        ...
        case (uint8_t)kFLEXIO_I2C_SendData:
            if ((statusFlags & (uint32_t)kFLEXIO_I2C_TxEmptyFlag) != 0U)
            {
                ...
                {
                    FLEXIO_I2C_MasterStop(base);
# 332 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
                    while (0U == (FLEXIO_I2C_MasterGetStatusFlags(base) & (uint32_t)kFLEXIO_I2C_RxFullFlag))
                    {
                    }
        ...
        case (uint8_t)kFLEXIO_I2C_ReceiveDataBegin:
            if ((statusFlags & (uint32_t)kFLEXIO_I2C_RxFullFlag) != 0U)
            {
                ...
                {
                    FLEXIO_I2C_MasterEnableAck(base, 0);
# 361 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
                    while (0U == (FLEXIO_GetShifterStatusFlags(base->flexioBase) & (1UL << base->shifterIndex[0])))
                    {
                    }
                ...
                {
                    FLEXIO_I2C_MasterEnableAck(base, 1);
                }
            }
            ...
            if ((statusFlags & (uint32_t)kFLEXIO_I2C_RxFullFlag) != 0U)
            {
                *handle->transfer.data = FLEXIO_I2C_MasterReadByte(base);
                ...
                if (0U != handle->transfer.dataSize--)
                {
                    ...
                    {
                        FLEXIO_I2C_MasterEnableAck(base, 0);
# 416 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
                        while (0U == (FLEXIO_GetShifterStatusFlags(base->flexioBase) & (1UL << base->shifterIndex[0])))
                        {
                        }
...
# 468 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
status_t FLEXIO_I2C_CheckForBusyBus(FLEXIO_I2C_Type *base)
{
    uint32_t mask;


    for (uint32_t i = 0U; i < (600000000UL) / 600000U; ++i)
    {
...
# 513 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
status_t FLEXIO_I2C_MasterInit(FLEXIO_I2C_Type *base, flexio_i2c_master_config_t *masterConfig, uint32_t srcClock_Hz)
{
    (((base != 0) && (masterConfig != 0)) ? (void)0 : __aeabi_assert("(base != NULL) && (masterConfig != NULL)", "../../libraries/sdk/drives/fsl_flexio_i2c_master.c", 515),
# 515 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
#pragma clang diagnostic push
# 515 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
#pragma clang diagnostic ignored "-Wassume"
# 515 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
    (__builtin_assume)(((base != 0) && (masterConfig != 0))?1:0)
# 515 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
#pragma clang diagnostic pop
# 515 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
    );
    ...
    controlVal &=
        ~((0x80000000U) | (0x40000000U) | (0x4U) | (0x1U));
    controlVal |= ((((uint32_t)(((uint32_t)(masterConfig->enableInDebug)) << (30U))) & (0x40000000U)) | (((uint32_t)(((uint32_t)(masterConfig->enableFastAccess)) << (2U))) & (0x4U)) |
                   (((uint32_t)(((uint32_t)(masterConfig->enableMaster)) << (0U))) & (0x1U)));
    if (!masterConfig->enableInDoze)
    {
        controlVal |= (0x80000000U);
    }
...
# 683 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
void FLEXIO_I2C_MasterGetDefaultConfig(flexio_i2c_master_config_t *masterConfig)
{
    ((masterConfig != 0) ? (void)0 : __aeabi_assert("masterConfig != NULL", "../../libraries/sdk/drives/fsl_flexio_i2c_master.c", 685),
# 685 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
#pragma clang diagnostic push
# 685 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
#pragma clang diagnostic ignored "-Wassume"
# 685 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
...
# 706 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
uint32_t FLEXIO_I2C_MasterGetStatusFlags(FLEXIO_I2C_Type *base)
{
    uint32_t status = 0;
...
# 732 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
void FLEXIO_I2C_MasterClearStatusFlags(FLEXIO_I2C_Type *base, uint32_t mask)
{
...
# 758 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
void FLEXIO_I2C_MasterEnableInterrupts(FLEXIO_I2C_Type *base, uint32_t mask)
{
...
# 795 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
void FLEXIO_I2C_MasterSetBaudRate(FLEXIO_I2C_Type *base, uint32_t baudRate_Bps, uint32_t srcClock_Hz)
{
    uint16_t timerDiv = 0;
...
# 820 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
status_t FLEXIO_I2C_MasterSetTransferCount(FLEXIO_I2C_Type *base, uint16_t count)
{
    ...
    timerConfig &= ~(0x7000U);
    timerConfig |= (((uint32_t)(((uint32_t)(kFLEXIO_TimerDisableOnTimerCompare)) << (12U))) & (0x7000U));
    flexioBase->TIMCFG[base->timerIndex[0]] = timerConfig;

    return kStatus_Success;
}
# 855 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
void FLEXIO_I2C_MasterStart(FLEXIO_I2C_Type *base, uint8_t address, flexio_i2c_direction_t direction)
{
    uint32_t data;
...
void FLEXIO_I2C_MasterAbortStop(FLEXIO_I2C_Type *base)
{
    ...
    tmpConfig &= ~(0x7000U);
    tmpConfig |= (((uint32_t)(((uint32_t)(kFLEXIO_TimerDisableOnPinBothEdge)) << (12U))) & (0x7000U));
...
void FLEXIO_I2C_MasterEnableAck(FLEXIO_I2C_Type *base, _Bool enable)
{
    ...
    if (enable)
    {
        tmpConfig |= (((uint32_t)(((uint32_t)(kFLEXIO_ShifterStopBitLow)) << (4U))) & (0x30U));
    }
    else
    {
        tmpConfig |= (((uint32_t)(((uint32_t)(kFLEXIO_ShifterStopBitHigh)) << (4U))) & (0x30U));
    }
    base->flexioBase->SHIFTCFG[base->shifterIndex[0]] = tmpConfig;
}
# 945 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
status_t FLEXIO_I2C_MasterWriteBlocking(FLEXIO_I2C_Type *base, const uint8_t *txBuff, uint8_t txSize)
{
    ((txBuff != 0) ? (void)0 : __aeabi_assert("txBuff != NULL", "../../libraries/sdk/drives/fsl_flexio_i2c_master.c", 947),
# 947 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
#pragma clang diagnostic push
# 947 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
#pragma clang diagnostic ignored "-Wassume"
# 947 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
    (__builtin_assume)((txBuff != 0)?1:0)
# 947 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
#pragma clang diagnostic pop
# 947 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
    );
    ((txSize != 0U) ? (void)0 : __aeabi_assert("txSize != 0U", "../../libraries/sdk/drives/fsl_flexio_i2c_master.c", 948),
# 948 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
#pragma clang diagnostic push
# 948 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
#pragma clang diagnostic ignored "-Wassume"
# 948 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
    (__builtin_assume)((txSize != 0U)?1:0)
# 948 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
#pragma clang diagnostic pop
# 948 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
    );
...
# 971 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
...
# 996 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
status_t FLEXIO_I2C_MasterReadBlocking(FLEXIO_I2C_Type *base, uint8_t *rxBuff, uint8_t rxSize)
{
    ((rxBuff != 0) ? (void)0 : __aeabi_assert("rxBuff != NULL", "../../libraries/sdk/drives/fsl_flexio_i2c_master.c", 998),
# 998 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
#pragma clang diagnostic push
# 998 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
#pragma clang diagnostic ignored "-Wassume"
# 998 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
    (__builtin_assume)((rxBuff != 0)?1:0)
# 998 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
#pragma clang diagnostic pop
# 998 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
    );
    ((rxSize != 0U) ? (void)0 : __aeabi_assert("rxSize != 0U", "../../libraries/sdk/drives/fsl_flexio_i2c_master.c", 999),
# 999 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
#pragma clang diagnostic push
# 999 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
#pragma clang diagnostic ignored "-Wassume"
# 999 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
    (__builtin_assume)((rxSize != 0U)?1:0)
# 999 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
#pragma clang diagnostic pop
# 999 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
    );
    ...
    while (0U != rxSize--)
    {
# 1019 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
        while (0U == (FLEXIO_I2C_MasterGetStatusFlags(base) & (uint32_t)kFLEXIO_I2C_RxFullFlag))
        {
        }
...
# 1038 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
status_t FLEXIO_I2C_MasterTransferBlocking(FLEXIO_I2C_Type *base, flexio_i2c_master_transfer_t *xfer)
{
    ((xfer != 0) ? (void)0 : __aeabi_assert("xfer != NULL", "../../libraries/sdk/drives/fsl_flexio_i2c_master.c", 1040),
# 1040 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
#pragma clang diagnostic push
# 1040 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
#pragma clang diagnostic ignored "-Wassume"
# 1040 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
...
# 1040 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
    ...
    do
    {
# 1083 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
...
# 1112 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
status_t FLEXIO_I2C_MasterTransferCreateHandle(FLEXIO_I2C_Type *base,
                                               flexio_i2c_master_handle_t *handle,
                                               flexio_i2c_master_transfer_callback_t callback,
                                               void *userData)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_flexio_i2c_master.c", 1117),
# 1117 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
#pragma clang diagnostic push
# 1117 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
#pragma clang diagnostic ignored "-Wassume"
# 1117 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
...
# 1117 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
    ...
    __NVIC_ClearPendingIRQ(flexio_irqs[FLEXIO_I2C_GetInstance(base)]);
...
# 1150 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
status_t FLEXIO_I2C_MasterTransferNonBlocking(FLEXIO_I2C_Type *base,
                                              flexio_i2c_master_handle_t *handle,
                                              flexio_i2c_master_transfer_t *xfer)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_flexio_i2c_master.c", 1154),
# 1154 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
#pragma clang diagnostic push
# 1154 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
#pragma clang diagnostic ignored "-Wassume"
# 1154 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
...
# 1154 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
    ...
    ((xfer != 0) ? (void)0 : __aeabi_assert("xfer != NULL", "../../libraries/sdk/drives/fsl_flexio_i2c_master.c", 1155),
# 1155 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
#pragma clang diagnostic push
# 1155 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
#pragma clang diagnostic ignored "-Wassume"
# 1155 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
...
# 1198 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
void FLEXIO_I2C_MasterTransferAbort(FLEXIO_I2C_Type *base, flexio_i2c_master_handle_t *handle)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_flexio_i2c_master.c", 1200),
# 1200 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
#pragma clang diagnostic push
# 1200 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
#pragma clang diagnostic ignored "-Wassume"
# 1200 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
...
# 1220 "../../libraries/sdk/drives/fsl_flexio_i2c_master.c"
status_t FLEXIO_I2C_MasterTransferGetCount(FLEXIO_I2C_Type *base, flexio_i2c_master_handle_t *handle, size_t *count)
{
    if (0 == count)
    {
