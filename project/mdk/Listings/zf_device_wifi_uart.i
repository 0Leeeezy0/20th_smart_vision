# 1 "../../libraries/zf_device/zf_device_wifi_uart.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/zf_device/zf_device_wifi_uart.c" 2
# 49 "../../libraries/zf_device/zf_device_wifi_uart.c"
...
# 50 "../../libraries/zf_device/zf_device_wifi_uart.c" 2
...
# 51 "../../libraries/zf_device/zf_device_wifi_uart.c" 2
...
# 52 "../../libraries/zf_device/zf_device_wifi_uart.c" 2
...
# 53 "../../libraries/zf_device/zf_device_wifi_uart.c" 2
...
# 54 "../../libraries/zf_device/zf_device_wifi_uart.c" 2
...
# 55 "../../libraries/zf_device/zf_device_wifi_uart.c" 2
...
# 56 "../../libraries/zf_device/zf_device_wifi_uart.c" 2
...
# 57 "../../libraries/zf_device/zf_device_wifi_uart.c" 2
...
# 59 "../../libraries/zf_device/zf_device_wifi_uart.c" 2




wifi_uart_information_struct wifi_uart_information;

static fifo_struct wifi_uart_fifo;
static uint8 wifi_uart_buffer[(256)];
static uint8 wifi_uart_data;
# 76 "../../libraries/zf_device/zf_device_wifi_uart.c"
...
# 110 "../../libraries/zf_device/zf_device_wifi_uart.c"
static void wifi_uart_clear_receive_buffer (void)
{

    fifo_clear(&wifi_uart_fifo);
}
# 126 "../../libraries/zf_device/zf_device_wifi_uart.c"
...
# 159 "../../libraries/zf_device/zf_device_wifi_uart.c"
static uint8 wifi_uart_get_version (void)
{
    ...
    uart_write_string((UART_8), "AT+GMR\r\n");
    do
    {

        if(wifi_uart_wait_ack("OK", (10000)))
        {
            return_state = 1;
            break;
        }
...
# 197 "../../libraries/zf_device/zf_device_wifi_uart.c"
static uint8 wifi_uart_echo_set (char *model)
{
    uint8 return_state = 0;

    wifi_uart_clear_receive_buffer();
    uart_write_string((UART_8), "ATE");
    uart_write_string((UART_8), model);
    uart_write_string((UART_8), "\r\n");
    return_state = wifi_uart_wait_ack("OK", (10000));
    wifi_uart_clear_receive_buffer();

    return return_state;
}
# 222 "../../libraries/zf_device/zf_device_wifi_uart.c"
static uint8 wifi_uart_uart_config_set (char *baudrate, char *databits, char *stopbits, char *parity, char *flow_control)
{
    uint8 return_state = 0;

    wifi_uart_clear_receive_buffer();
    uart_write_string((UART_8), "AT+UART_CUR=");
    uart_write_string((UART_8), baudrate);
    uart_write_string((UART_8), ",");
    uart_write_string((UART_8), databits);
    uart_write_string((UART_8), ",");
    uart_write_string((UART_8), stopbits);
    uart_write_string((UART_8), ",");
    uart_write_string((UART_8), parity);
    uart_write_string((UART_8), ",");
    uart_write_string((UART_8), flow_control);
    uart_write_string((UART_8), "\r\n");
    return_state = wifi_uart_wait_ack("OK", (10000));
    wifi_uart_clear_receive_buffer();
...
# 251 "../../libraries/zf_device/zf_device_wifi_uart.c"
static uint8 wifi_uart_get_mac (void)
{
    ...
    wifi_uart_clear_receive_buffer();
    uart_write_string((UART_8), "AT+CIPAPMAC?\r\n");
    do
    {
        if(wifi_uart_wait_ack("OK", (10000)))
        {
...
# 287 "../../libraries/zf_device/zf_device_wifi_uart.c"
static uint8 wifi_uart_get_ip (void)
{
    ...
    {
        uart_write_string((UART_8), "AT+CIPSTA?\r\n");
    }
    else if(WIFI_UART_SOFTAP == wifi_uart_information.wifi_uart_mode)
    {
        uart_write_string((UART_8), "AT+CIPAP?\r\n");
    }
...
# 329 "../../libraries/zf_device/zf_device_wifi_uart.c"
...
# 366 "../../libraries/zf_device/zf_device_wifi_uart.c"
static uint8 wifi_uart_set_wifi (char *wifi_ssid, char *pass_word)
{
    ...
    {
        uart_write_string((UART_8), "AT+CWSAP=\"");
        uart_write_string((UART_8), wifi_ssid);
        uart_write_string((UART_8), "\",\"");
        uart_write_string((UART_8), pass_word);
        uart_write_string((UART_8), "\",5,3\r\n");
    }
    else
    {
        uart_write_string((UART_8), "AT+CWJAP=\"");
        uart_write_string((UART_8), wifi_ssid);
        uart_write_string((UART_8), "\",\"");
        uart_write_string((UART_8), pass_word);
        uart_write_string((UART_8), "\"\r\n");
...
# 400 "../../libraries/zf_device/zf_device_wifi_uart.c"
static uint8 wifi_uart_auto_connect_wifi (char *model)
{
    uint8 return_state = 0;

    wifi_uart_clear_receive_buffer();
    uart_write_string((UART_8), "AT+CWAUTOCONN=");
    uart_write_string((UART_8), model);
    uart_write_string((UART_8), "\r\n");
    return_state = wifi_uart_wait_ack("OK", (10000));
    wifi_uart_clear_receive_buffer();
...
# 421 "../../libraries/zf_device/zf_device_wifi_uart.c"
static uint8 wifi_uart_set_connect_model (char *model)
{
    uint8 return_state = 0;

    wifi_uart_clear_receive_buffer();
    uart_write_string((UART_8), "AT+CIPMUX=");
    uart_write_string((UART_8), model);
    uart_write_string((UART_8), "\r\n");
    return_state = wifi_uart_wait_ack("OK", (10000));
    wifi_uart_clear_receive_buffer();
...
# 443 "../../libraries/zf_device/zf_device_wifi_uart.c"
static uint8 wifi_uart_set_transfer_model (char *model)
{
    uint8 return_state = 0;

    wifi_uart_clear_receive_buffer();
    uart_write_string((UART_8), "AT+CIPMODE=");
    uart_write_string((UART_8), model);
    uart_write_string((UART_8), "\r\n");
    return_state = wifi_uart_wait_ack("OK", (10000));
    wifi_uart_clear_receive_buffer();
...
# 464 "../../libraries/zf_device/zf_device_wifi_uart.c"
uint8 wifi_uart_soft_reset (void)
{
    ...
    system_delay_ms(100);
    wifi_uart_clear_receive_buffer();
    uart_write_string((UART_8), "AT+RST\r\n");
    return_state = wifi_uart_wait_ack("ready", (10000));
    wifi_uart_clear_receive_buffer();

    return return_state;
}
# 488 "../../libraries/zf_device/zf_device_wifi_uart.c"
uint8 wifi_uart_reset (void)
{

    uint8 return_state = 0;

    gpio_set_level((D27), 0);
    system_delay_ms(50);
    gpio_set_level((D27), 1);
    system_delay_ms(200);
    wifi_uart_clear_receive_buffer();
    return_state = wifi_uart_wait_ack("ready", (10000));
    wifi_uart_clear_receive_buffer();
...
# 514 "../../libraries/zf_device/zf_device_wifi_uart.c"
uint8 wifi_uart_set_model (wifi_uart_mode_enum mode)
{
    ...
    {
        uart_write_string((UART_8), "AT+CWMODE=2\r\n");
    }
    else
    {
        uart_write_string((UART_8), "AT+CWMODE=1\r\n");
    }
...
# 542 "../../libraries/zf_device/zf_device_wifi_uart.c"
uint8 wifi_uart_disconnected_wifi (void)
{
    uint8 return_state = 0;

    wifi_uart_clear_receive_buffer();
    uart_write_string((UART_8), "AT+CWQAP\r\n");
    return_state = wifi_uart_wait_ack("OK", (10000));
    wifi_uart_clear_receive_buffer();

    return return_state;
}
# 561 "../../libraries/zf_device/zf_device_wifi_uart.c"
uint8 wifi_uart_entry_serianet (void)
{
    uint8 return_state = 0;

    wifi_uart_clear_receive_buffer();
    uart_write_string((UART_8), "AT+CIPSEND\r\n");
    return_state = wifi_uart_wait_ack("OK", (10000));
    wifi_uart_clear_receive_buffer();

    return return_state;
}
# 580 "../../libraries/zf_device/zf_device_wifi_uart.c"
uint8 wifi_uart_exit_serianet (void)
{
    wifi_uart_clear_receive_buffer();
...
# 600 "../../libraries/zf_device/zf_device_wifi_uart.c"
uint8 wifi_uart_connect_tcp_servers (char *ip, char *port, wifi_uart_transfer_mode_enum mode)
{
    (debug_assert_handler((0 != ip), "../../libraries/zf_device/zf_device_wifi_uart.c", 602));
    (debug_assert_handler((0 != port), "../../libraries/zf_device/zf_device_wifi_uart.c", 603));
    ...
    do
    {
        ...
        uart_write_string((UART_8), "AT+CIPSTARTEX=\"TCP\",\"");
        uart_write_string((UART_8), ip);
        uart_write_string((UART_8), "\",");
        uart_write_string((UART_8), port);
        uart_write_string((UART_8), "\r\n");
        if(wifi_uart_wait_ack("OK", (10000)))
        {
            return_state = 1;
        ...
        wifi_uart_clear_receive_buffer();
        uart_write_string((UART_8), "AT+CIPSTATE?\r\n");
        if(wifi_uart_wait_ack("OK", (10000)))
        {
            return_state = 1;
            break;
...
# 693 "../../libraries/zf_device/zf_device_wifi_uart.c"
uint8 wifi_uart_connect_udp_client (char *ip, char *port, char *local_port, wifi_uart_transfer_mode_enum mode)
{
    (debug_assert_handler((0 != ip), "../../libraries/zf_device/zf_device_wifi_uart.c", 695));
    (debug_assert_handler((0 != port), "../../libraries/zf_device/zf_device_wifi_uart.c", 696));
    (debug_assert_handler((0 != local_port), "../../libraries/zf_device/zf_device_wifi_uart.c", 697));
    uint8 return_state = 0;
    ...
    do
    {
        ...
        uart_write_string((UART_8), "AT+CIPSTARTEX=\"UDP\",\"");
        uart_write_string((UART_8), ip);
        uart_write_string((UART_8), "\",");
        uart_write_string((UART_8), port);
        uart_write_string((UART_8), ",");
        uart_write_string((UART_8), local_port);
        uart_write_string((UART_8), "\r\n");
...
# 760 "../../libraries/zf_device/zf_device_wifi_uart.c"
uint8 wifi_uart_disconnect_link (void)
{
    uint8 return_state = 0;
    ...
    do
    {
        ...
        {
            uart_write_string((UART_8), "AT+CIPCLOSE=5\r\n");
        }
        else
        {
            uart_write_string((UART_8), "AT+CIPCLOSE\r\n");
        }
...
# 795 "../../libraries/zf_device/zf_device_wifi_uart.c"
uint8 wifi_uart_disconnect_link_with_id (wifi_uart_link_id_enum link_id)
{
    uint8 return_state = 0;
    ...
    do
    {
        ...
        {
            uart_write_string((UART_8), "AT+CIPCLOSE=");
            uart_write_byte((UART_8), link_id + 0x30);
            uart_write_string((UART_8), "\r\n");
        }
        else
        {
...
# 832 "../../libraries/zf_device/zf_device_wifi_uart.c"
uint8 wifi_uart_entry_tcp_servers (char *port)
{
    (debug_assert_handler((0 != port), "../../libraries/zf_device/zf_device_wifi_uart.c", 834));
    uint8 return_state = 0;

    wifi_uart_clear_receive_buffer();
    do
    {
        if(wifi_uart_set_transfer_model("0"))
        {
            return_state = 1;
            break;
        }
        ...
        if(wifi_uart_set_connect_model("1"))
        {
            return_state = 1;
            break;
        }
        ...
        uart_write_string((UART_8), "AT+CIPSERVER=1,");
        uart_write_string((UART_8), port);
        uart_write_string((UART_8), "\r\n");
...
# 882 "../../libraries/zf_device/zf_device_wifi_uart.c"
uint8 wifi_uart_exit_tcp_servers (void)
{
    uint8 return_state = 0;

    wifi_uart_clear_receive_buffer();
    uart_write_string((UART_8), "AT+CIPSERVER=0,1\r\n");
    return_state = wifi_uart_wait_ack("OK", (10000));
    wifi_uart_clear_receive_buffer();

    return return_state;
}
# 901 "../../libraries/zf_device/zf_device_wifi_uart.c"
uint8 wifi_uart_tcp_servers_check_link (void)
{
    ...
    if(0 == wifi_uart_wait_ack("OK", (10000)))
    {
        fifo_read_buffer(&wifi_uart_fifo, receiver_buffer, &receiver_len, FIFO_READ_ONLY);
...
# 954 "../../libraries/zf_device/zf_device_wifi_uart.c"
uint32 wifi_uart_send_buffer (const uint8 *buff, uint32 len)
{
    (debug_assert_handler((0 != buff), "../../libraries/zf_device/zf_device_wifi_uart.c", 956));
    int32 timeout = (10000);
    ...
    if(WIFI_UART_SERVER_ON == wifi_uart_information.wifi_uart_connect_state)
    {
        if(WIFI_UART_COMMAND == wifi_uart_information.wifi_uart_transfer_mode)
        {
            ...
            if(8192 < len)
            {
                uart_write_string((UART_8), "AT+CIPSENDL=");
            }
            else
            {
                uart_write_string((UART_8), "AT+CIPSEND=");
            ...
            if(WIFI_UART_TCP_SERVER == wifi_uart_information.wifi_uart_connect_mode)
            {
                uart_write_string((UART_8), "0,");
            }

            uart_write_string((UART_8), lenth);
            uart_write_string((UART_8), "\r\n");

            if(0 == wifi_uart_wait_ack("OK", (10000)))
            {
                wifi_uart_clear_receive_buffer();
                uart_write_buffer((UART_8), buff, len);
                if(0 == wifi_uart_wait_ack("OK", (10000)))
                {
                    len = 0;
                }
        ...
        else
        {
            while(len --)
            {
                while(gpio_get_level((D26)) && 0 < timeout -- );
                if(0 >= timeout)
                {
                    break;
                }
                uart_write_byte((UART_8), *buff);
                buff ++;
            }
        }
    }
...
# 1022 "../../libraries/zf_device/zf_device_wifi_uart.c"
uint32 wifi_uart_tcp_servers_send_buffer (const uint8 *buff, uint32 len, wifi_uart_link_id_enum id)
{
    (debug_assert_handler((0 != buff), "../../libraries/zf_device/zf_device_wifi_uart.c", 1024));
    char lenth[32] = {0};

    if( WIFI_UART_COMMAND == wifi_uart_information.wifi_uart_transfer_mode && WIFI_UART_TCP_SERVER == wifi_uart_information.wifi_uart_connect_mode)
...
# 1071 "../../libraries/zf_device/zf_device_wifi_uart.c"
uint32 wifi_uart_read_buffer (uint8 *buffer, uint32 len)
{
    (debug_assert_handler((0 != buffer), "../../libraries/zf_device/zf_device_wifi_uart.c", 1073));
    uint32 read_len = len;
    fifo_read_buffer(&wifi_uart_fifo, buffer, &read_len, FIFO_READ_AND_CLEAN);
    return read_len;
}
# 1088 "../../libraries/zf_device/zf_device_wifi_uart.c"
void wifi_uart_callback (void)
{
    uart_query_byte((UART_8), &wifi_uart_data);
    fifo_write_buffer(&wifi_uart_fifo, &wifi_uart_data, 1);
}
# 1104 "../../libraries/zf_device/zf_device_wifi_uart.c"
uint8 wifi_uart_init (char *wifi_ssid, char *pass_word, wifi_uart_mode_enum wifi_mode)
{
    (debug_assert_handler((0 != wifi_ssid), "../../libraries/zf_device/zf_device_wifi_uart.c", 1106));
    (debug_assert_handler((0 != pass_word), "../../libraries/zf_device/zf_device_wifi_uart.c", 1107));
    char uart_baud[32] = {0};
    uint8 return_state = 0;


    set_wireless_type(WIFI_UART, wifi_uart_callback);
    fifo_init(&wifi_uart_fifo, FIFO_DATA_8BIT, wifi_uart_buffer, (256));
    gpio_init((D26), GPI, 0, GPI_PULL_UP);

    gpio_init((D27), GPO, 1, GPO_PUSH_PULL);
    ...
    do
    {
        if(wifi_uart_reset())
        {
            ...
            (debug_log_handler((0), ("reset failed"), "../../libraries/zf_device/zf_device_wifi_uart.c", 1129));
            return_state = 1;
            break;
        }
        func_int_to_str(uart_baud, (115200));
        if(wifi_uart_uart_config_set(uart_baud, "8", "1", "0", "1"))
        {
            (debug_log_handler((0), ("set config failed"), "../../libraries/zf_device/zf_device_wifi_uart.c", 1136));
            return_state = 1;
            break;
        }
        ...
        if(wifi_uart_echo_set("0"))
        {
            (debug_log_handler((0), ("exit echo failed"), "../../libraries/zf_device/zf_device_wifi_uart.c", 1147));
            return_state = 1;
            break;
        }

        if(wifi_uart_auto_connect_wifi("0"))
        {
            (debug_log_handler((0), ("close auto connect failed"), "../../libraries/zf_device/zf_device_wifi_uart.c", 1154));
            return_state = 1;
            break;
        }

        if(wifi_uart_set_model(wifi_mode))
        {
            (debug_log_handler((0), ("set run mode failed"), "../../libraries/zf_device/zf_device_wifi_uart.c", 1161));
            return_state = 1;
            break;
        }

        if(wifi_uart_set_wifi((char *)wifi_ssid, (char *)pass_word))
        {
            (debug_log_handler((0), ("wifi set failed"), "../../libraries/zf_device/zf_device_wifi_uart.c", 1168));
            return_state = 1;
            break;
        }

        if(wifi_uart_get_information())
        {
            (debug_log_handler((0), ("get module information failed"), "../../libraries/zf_device/zf_device_wifi_uart.c", 1175));
            return_state = 1;
            break;
        }
# 1207 "../../libraries/zf_device/zf_device_wifi_uart.c"
    }while(0);
