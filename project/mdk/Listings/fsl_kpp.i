# 1 "../../libraries/sdk/drives/fsl_kpp.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/sdk/drives/fsl_kpp.c" 2
...
# 1 "../../libraries/sdk/drives/fsl_kpp.h" 1
# 10 "../../libraries/sdk/drives/fsl_kpp.h"
...
# 11 "../../libraries/sdk/drives/fsl_kpp.h" 2
# 35 "../../libraries/sdk/drives/fsl_kpp.h"
typedef enum _kpp_interrupt_enable
{
    kKPP_keyDepressInterrupt = (0x100U),
    kKPP_keyReleaseInterrupt = (0x200U)
} kpp_interrupt_enable_t;


typedef enum _kpp_sync_operation
{
    kKPP_ClearKeyDepressSyncChain = (0x4U),
    kKPP_SetKeyReleasesSyncChain = (0x8U),
...
# 77 "../../libraries/sdk/drives/fsl_kpp.h"
void KPP_Init(KPP_Type *base, kpp_config_t *configure);
# 86 "../../libraries/sdk/drives/fsl_kpp.h"
void KPP_Deinit(KPP_Type *base);
# 102 "../../libraries/sdk/drives/fsl_kpp.h"
static inline void KPP_EnableInterrupts(KPP_Type *base, uint16_t mask)
{
    uint16_t data = (uint16_t)(base->KPSR & ~((0x2U) | (0x1U)));
    base->KPSR = data | mask;
}
# 115 "../../libraries/sdk/drives/fsl_kpp.h"
static inline void KPP_DisableInterrupts(KPP_Type *base, uint16_t mask)
{
    base->KPSR &= ~(mask | (0x2U) | (0x1U));
}
# 127 "../../libraries/sdk/drives/fsl_kpp.h"
static inline uint16_t KPP_GetStatusFlag(KPP_Type *base)
{
    return (base->KPSR & ((0x2U) | (0x1U))) << (8U);
}
# 139 "../../libraries/sdk/drives/fsl_kpp.h"
static inline void KPP_ClearStatusFlag(KPP_Type *base, uint16_t mask)
{
    base->KPSR |= (uint16_t)((mask) >> (8U));
}
# 151 "../../libraries/sdk/drives/fsl_kpp.h"
static inline void KPP_SetSynchronizeChain(KPP_Type *base, uint16_t mask)
{
    uint16_t data = base->KPSR & ((0x8U) | (0x4U) | (0x200U) | (0x100U));
    base->KPSR = data | mask;
}
# 170 "../../libraries/sdk/drives/fsl_kpp.h"
void KPP_keyPressScanning(KPP_Type *base, uint8_t *data, uint32_t clockSrc_Hz);
# 9 "../../libraries/sdk/drives/fsl_kpp.c" 2
# 30 "../../libraries/sdk/drives/fsl_kpp.c"
static const clock_ip_name_t s_kppClock[(1)] = { kCLOCK_Kpp };



static KPP_Type *const s_kppBases[] = { ((KPP_Type *)(0x401FC000u)) };


static const IRQn_Type s_kppIrqs[] = { KPP_IRQn };
...
static uint32_t KPP_GetInstance(KPP_Type *base)
{
    ...
    for (instance = 0; instance < (sizeof(s_kppBases) / sizeof((s_kppBases)[0])); instance++)
    {
    ...
    ((instance < (sizeof(s_kppBases) / sizeof((s_kppBases)[0]))) ? (void)0 : __aeabi_assert("instance < ARRAY_SIZE(s_kppBases)", "../../libraries/sdk/drives/fsl_kpp.c", 54),
# 54 "../../libraries/sdk/drives/fsl_kpp.c"
#pragma clang diagnostic push
# 54 "../../libraries/sdk/drives/fsl_kpp.c"
#pragma clang diagnostic ignored "-Wassume"
# 54 "../../libraries/sdk/drives/fsl_kpp.c"
    (__builtin_assume)((instance < (sizeof(s_kppBases) / sizeof((s_kppBases)[0])))?1:0)
# 54 "../../libraries/sdk/drives/fsl_kpp.c"
#pragma clang diagnostic pop
# 54 "../../libraries/sdk/drives/fsl_kpp.c"
    );
...
# 74 "../../libraries/sdk/drives/fsl_kpp.c"
void KPP_Init(KPP_Type *base, kpp_config_t *configure)
{
    ((configure) ? (void)0 : __aeabi_assert("configure", "../../libraries/sdk/drives/fsl_kpp.c", 76),
# 76 "../../libraries/sdk/drives/fsl_kpp.c"
#pragma clang diagnostic push
# 76 "../../libraries/sdk/drives/fsl_kpp.c"
#pragma clang diagnostic ignored "-Wassume"
# 76 "../../libraries/sdk/drives/fsl_kpp.c"
    (__builtin_assume)((configure)?1:0)
# 76 "../../libraries/sdk/drives/fsl_kpp.c"
#pragma clang diagnostic pop
# 76 "../../libraries/sdk/drives/fsl_kpp.c"
    );
    ...
    base->KPSR &= (uint16_t)(~((0x200U) | (0x100U)));


    base->KPCR = (((uint16_t)(((uint16_t)(configure->activeRow)) << (0U))) & (0xFFU));
    base->KPDR = (((uint16_t)(((uint16_t)((uint8_t) ~(configure->activeColumn))) << (8U))) & (0xFF00U));
    base->KPCR |= (((uint16_t)(((uint16_t)(configure->activeColumn)) << (8U))) & (0xFF00U));


    base->KDDR = (((uint16_t)(((uint16_t)(configure->activeColumn)) << (8U))) & (0xFF00U)) | (((uint16_t)(((uint16_t)((uint8_t) ~(configure->activeRow))) << (0U))) & (0xFFU));


    base->KPSR = (0x2U) | (0x1U) | (0x4U) | configure->interrupt;
...
# 113 "../../libraries/sdk/drives/fsl_kpp.c"
void KPP_Deinit(KPP_Type *base)
{
...
# 138 "../../libraries/sdk/drives/fsl_kpp.c"
void KPP_keyPressScanning(KPP_Type *base, uint8_t *data, uint32_t clockSrc_Hz)
{
    ((data) ? (void)0 : __aeabi_assert("data", "../../libraries/sdk/drives/fsl_kpp.c", 140),
# 140 "../../libraries/sdk/drives/fsl_kpp.c"
#pragma clang diagnostic push
# 140 "../../libraries/sdk/drives/fsl_kpp.c"
#pragma clang diagnostic ignored "-Wassume"
# 140 "../../libraries/sdk/drives/fsl_kpp.c"
    (__builtin_assume)((data)?1:0)
# 140 "../../libraries/sdk/drives/fsl_kpp.c"
#pragma clang diagnostic pop
# 140 "../../libraries/sdk/drives/fsl_kpp.c"
    );

    uint16_t kppKCO = base->KPCR & (0xFF00U);
    uint8_t columIndex = 0;
    uint8_t activeColumn = (uint8_t)((base->KPCR & (0xFF00U)) >> (8U));
    uint8_t times;
    uint8_t rowData[(3U)][(8U)];
    _Bool press = 0;
    uint8_t column;
    ...
    base->KPCR &= (uint16_t)(((uint16_t)~kppKCO) | (0xFFU));

    base->KPCR |= kppKCO;

    for (times = 0; times < (3U); times++)
    {
        for (columIndex = 0; columIndex < (8U); columIndex++)
        {
            column = activeColumn & (1U << columIndex);
            if (column != 0U)
            {

                base->KPDR = (((uint16_t)(((uint16_t)(~(uint16_t)column)) << (8U))) & (0xFF00U));

                KPP_Mdelay(((uint64_t)clockSrc_Hz / 10000000UL));

                rowData[times][columIndex] = (uint8_t)(~(base->KPDR & (0xFFU)));
            }
            else
            {
