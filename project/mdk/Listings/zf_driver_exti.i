# 1 "../../libraries/zf_driver/zf_driver_exti.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/zf_driver/zf_driver_exti.c" 2
# 36 "../../libraries/zf_driver/zf_driver_exti.c"
# 1 "../../libraries/zf_driver/zf_driver_exti.h" 1
# 39 "../../libraries/zf_driver/zf_driver_exti.h"
...
# 40 "../../libraries/zf_driver/zf_driver_exti.h" 2
...
# 37 "../../libraries/zf_driver/zf_driver_exti.c" 2
# 48 "../../libraries/zf_driver/zf_driver_exti.c"
void exti_enable (gpio_pin_enum pin)
{
    GPIO_PortEnableInterrupts(PORTPTR[pin >> 5],1 << (pin & 0x1f));
}
# 60 "../../libraries/zf_driver/zf_driver_exti.c"
void exti_disable (gpio_pin_enum pin)
{
    GPIO_PortDisableInterrupts(PORTPTR[pin >> 5],1 << (pin & 0x1f));
}
# 73 "../../libraries/zf_driver/zf_driver_exti.c"
void exti_init (gpio_pin_enum pin, exti_trigger_enum trigger)
{
    gpio_pin_config_t gpio_config;

    gpio_iomuxc(pin, SPEED_100MHZ | HYS_EN | PULL_EN | PULLUP_100K);
    ...
    EnableIRQ((IRQn_Type)((IRQn_Type)((pin >> 4) - 2) + GPIO1_Combined_0_15_IRQn));
