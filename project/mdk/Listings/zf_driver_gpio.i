# 1 "../../libraries/zf_driver/zf_driver_gpio.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/zf_driver/zf_driver_gpio.c" 2
# 36 "../../libraries/zf_driver/zf_driver_gpio.c"
...
# 37 "../../libraries/zf_driver/zf_driver_gpio.c" 2
...
# 38 "../../libraries/zf_driver/zf_driver_gpio.c" 2

GPIO_Type * PORTPTR[] = { (GPIO_Type *)0u, ((GPIO_Type *)(0x401B8000u)), ((GPIO_Type *)(0x401BC000u)), ((GPIO_Type *)(0x401C0000u)), ((GPIO_Type *)(0x401C4000u)), ((GPIO_Type *)(0x400C0000u)), ((GPIO_Type *)(0x42000000u)), ((GPIO_Type *)(0x42004000u)), ((GPIO_Type *)(0x42008000u)), ((GPIO_Type *)(0x4200C000u)), ((GPIO_Type *)(0x401C8000u)) };
...
# 59 "../../libraries/zf_driver/zf_driver_gpio.c"
void gpio_iomuxc(gpio_pin_enum pin, uint32 pinconf)
{
    if((pin >= B0) && (pin <= C31))
    {
        *((volatile uint32_t *)(0x401F80BCU + 4 * (pin - B0))) = (((uint32_t)(((uint32_t)(5)) << (0U))) & (0xFU)) | (((uint32_t)(((uint32_t)(0)) << (4U))) & (0x10U));
        *((volatile uint32_t *)(0x401F82ACU + 4 * (pin - B0))) = pinconf;
    }

    if((pin >= D0) && (pin <= D4))
    {
        *((volatile uint32_t *)(0x401F81D4U + 4 * (pin - D0))) = (((uint32_t)(((uint32_t)(5)) << (0U))) & (0xFU)) | (((uint32_t)(((uint32_t)(0)) << (4U))) & (0x10U));
        *((volatile uint32_t *)(0x401F83C4U + 4 * (pin - D0))) = pinconf;
    }

    if((pin >= D12) && (pin <= D17))
    {
        *((volatile uint32_t *)(0x401F81BCU + 4 * (pin - D12))) = (((uint32_t)(((uint32_t)(5)) << (0U))) & (0xFU)) | (((uint32_t)(((uint32_t)(0)) << (4U))) & (0x10U));
        *((volatile uint32_t *)(0x401F83ACU + 4 * (pin - D12))) = pinconf;
    }

    if((pin >= D26) && (pin <= D27))
    {
        *((volatile uint32_t *)(0x401F80B4U + 4 * (pin - D26))) = (((uint32_t)(((uint32_t)(5)) << (0U))) & (0xFU)) | (((uint32_t)(((uint32_t)(0)) << (4U))) & (0x10U));
        *((volatile uint32_t *)(0x401F82A4U + 4 * (pin - D26))) = pinconf;
    }
}
# 93 "../../libraries/zf_driver/zf_driver_gpio.c"
void gpio_set_level(gpio_pin_enum pin, uint8 dat)
{
...
# 128 "../../libraries/zf_driver/zf_driver_gpio.c"
void gpio_set_dir(gpio_pin_enum pin, gpio_dir_enum dir, gpio_mode_enum pinconf)
{
...
# 144 "../../libraries/zf_driver/zf_driver_gpio.c"
void gpio_init(gpio_pin_enum pin, gpio_dir_enum dir, uint8 dat, uint32 pinconf)
{
...
# 172 "../../libraries/zf_driver/zf_driver_gpio.c"
void fast_gpio_set_level(gpio_pin_enum pin, uint8 dat)
{
...
# 198 "../../libraries/zf_driver/zf_driver_gpio.c"
void fast_gpio_toggle_level(gpio_pin_enum pin)
{
    GPIO_PortToggle(PORTPTR[(pin>>5) + 5],1<<(pin&0x1f));
}
# 210 "../../libraries/zf_driver/zf_driver_gpio.c"
void fast_gpio_set_dir(gpio_pin_enum pin, gpio_dir_enum dir, gpio_mode_enum pinconf)
{
...
# 227 "../../libraries/zf_driver/zf_driver_gpio.c"
void fast_gpio_init(gpio_pin_enum pin, gpio_dir_enum dir, uint8 dat, uint32 pinconf)
{
    uint16 temp_pin;
    gpio_iomuxc(pin, pinconf);
    ...
    switch(pin>>5)
    {
        case 1:
        {
            ((IOMUXC_GPR_Type *)(0x400AC000u))->GPR26 |= 1<<(pin&0x1f);
        }break;
        case 2:
        {
            ((IOMUXC_GPR_Type *)(0x400AC000u))->GPR27 |= 1<<(pin&0x1f);
        }break;
        case 3:
        {
            ((IOMUXC_GPR_Type *)(0x400AC000u))->GPR28 |= 1<<(pin&0x1f);
        }break;
    }
