# 1 "../../libraries/sdk/drives/fsl_common_arm.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/sdk/drives/fsl_common_arm.c" 2
...
# 10 "../../libraries/sdk/drives/fsl_common_arm.c" 2
# 159 "../../libraries/sdk/drives/fsl_common_arm.c"
...
# 189 "../../libraries/sdk/drives/fsl_common_arm.c"
void SDK_DelayAtLeastUs(uint32_t delayTime_us, uint32_t coreClock_Hz)
{
    uint64_t count;
    ...
    if (delayTime_us > 0U)
    {
        count = (uint64_t)(((uint64_t)(delayTime_us) * (coreClock_Hz)) / 1000000U);

        ((count <= 4294967295u) ? (void)0 : __aeabi_assert("count <= UINT32_MAX", "../../libraries/sdk/drives/fsl_common_arm.c", 197),
# 197 "../../libraries/sdk/drives/fsl_common_arm.c"
#pragma clang diagnostic push
# 197 "../../libraries/sdk/drives/fsl_common_arm.c"
#pragma clang diagnostic ignored "-Wassume"
# 197 "../../libraries/sdk/drives/fsl_common_arm.c"
        (__builtin_assume)((count <= 4294967295u)?1:0)
# 197 "../../libraries/sdk/drives/fsl_common_arm.c"
#pragma clang diagnostic pop
# 197 "../../libraries/sdk/drives/fsl_common_arm.c"
        );
# 226 "../../libraries/sdk/drives/fsl_common_arm.c"
        count = count / 3U * 2U;
