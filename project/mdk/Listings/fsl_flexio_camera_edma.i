# 1 "../../libraries/sdk/drives/fsl_flexio_camera_edma.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/sdk/drives/fsl_flexio_camera_edma.c" 2
...
# 1 "../../libraries/sdk/drives/fsl_flexio_camera_edma.h" 1
# 11 "../../libraries/sdk/drives/fsl_flexio_camera_edma.h"
...
# 12 "../../libraries/sdk/drives/fsl_flexio_camera_edma.h" 2
...
# 13 "../../libraries/sdk/drives/fsl_flexio_camera_edma.h" 2
# 30 "../../libraries/sdk/drives/fsl_flexio_camera_edma.h"
...
{
    kFLEXIO_CAMERA_RxIdle,
    kFLEXIO_CAMERA_RxBusy
};
# 42 "../../libraries/sdk/drives/fsl_flexio_camera_edma.c"
static flexio_camera_edma_private_handle_t s_edmaPrivateHandle[1];
# 57 "../../libraries/sdk/drives/fsl_flexio_camera_edma.c"
                                                      ...
                                                      uint32_t tcds)
{
    ...
    if (transferDone)
    {
        ...
        if (cameraPrivateHandle->handle->callback != 0)
        {
...
# 99 "../../libraries/sdk/drives/fsl_flexio_camera_edma.c"
status_t FLEXIO_CAMERA_TransferCreateHandleEDMA(FLEXIO_CAMERA_Type *base,
                                                flexio_camera_edma_handle_t *handle,
                                                flexio_camera_edma_transfer_callback_t callback,
                                                void *userData,
                                                edma_handle_t *rxEdmaHandle)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_flexio_camera_edma.c", 105),
# 105 "../../libraries/sdk/drives/fsl_flexio_camera_edma.c"
#pragma clang diagnostic push
# 105 "../../libraries/sdk/drives/fsl_flexio_camera_edma.c"
#pragma clang diagnostic ignored "-Wassume"
# 105 "../../libraries/sdk/drives/fsl_flexio_camera_edma.c"
...
# 105 "../../libraries/sdk/drives/fsl_flexio_camera_edma.c"
    ...
    for (index = 0U; index < (uint8_t)1; index++)
    {
...
# 157 "../../libraries/sdk/drives/fsl_flexio_camera_edma.c"
status_t FLEXIO_CAMERA_TransferReceiveEDMA(FLEXIO_CAMERA_Type *base,
                                           flexio_camera_edma_handle_t *handle,
                                           flexio_camera_transfer_t *xfer)
{
    ((handle->rxEdmaHandle != 0) ? (void)0 : __aeabi_assert("handle->rxEdmaHandle != NULL", "../../libraries/sdk/drives/fsl_flexio_camera_edma.c", 161),
# 161 "../../libraries/sdk/drives/fsl_flexio_camera_edma.c"
#pragma clang diagnostic push
# 161 "../../libraries/sdk/drives/fsl_flexio_camera_edma.c"
#pragma clang diagnostic ignored "-Wassume"
# 161 "../../libraries/sdk/drives/fsl_flexio_camera_edma.c"
...
# 161 "../../libraries/sdk/drives/fsl_flexio_camera_edma.c"
    ...
    else
    {
        ...
        FLEXIO_CAMERA_EnableRxDMA(base, 1);
        status = kStatus_Success;
    }

    return status;
}
# 201 "../../libraries/sdk/drives/fsl_flexio_camera_edma.c"
void FLEXIO_CAMERA_TransferAbortReceiveEDMA(FLEXIO_CAMERA_Type *base, flexio_camera_edma_handle_t *handle)
{
    ((handle->rxEdmaHandle != 0) ? (void)0 : __aeabi_assert("handle->rxEdmaHandle != NULL", "../../libraries/sdk/drives/fsl_flexio_camera_edma.c", 203),
# 203 "../../libraries/sdk/drives/fsl_flexio_camera_edma.c"
#pragma clang diagnostic push
# 203 "../../libraries/sdk/drives/fsl_flexio_camera_edma.c"
#pragma clang diagnostic ignored "-Wassume"
# 203 "../../libraries/sdk/drives/fsl_flexio_camera_edma.c"
...
# 203 "../../libraries/sdk/drives/fsl_flexio_camera_edma.c"
    ...
    FLEXIO_CAMERA_EnableRxDMA(base, 0);
...
# 225 "../../libraries/sdk/drives/fsl_flexio_camera_edma.c"
status_t FLEXIO_CAMERA_TransferGetReceiveCountEDMA(FLEXIO_CAMERA_Type *base,
                                                   flexio_camera_edma_handle_t *handle,
                                                   size_t *count)
{
    ((handle->rxEdmaHandle != 0) ? (void)0 : __aeabi_assert("handle->rxEdmaHandle != NULL", "../../libraries/sdk/drives/fsl_flexio_camera_edma.c", 229),
# 229 "../../libraries/sdk/drives/fsl_flexio_camera_edma.c"
#pragma clang diagnostic push
# 229 "../../libraries/sdk/drives/fsl_flexio_camera_edma.c"
#pragma clang diagnostic ignored "-Wassume"
# 229 "../../libraries/sdk/drives/fsl_flexio_camera_edma.c"
