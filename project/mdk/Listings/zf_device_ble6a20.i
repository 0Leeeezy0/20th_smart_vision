# 1 "../../libraries/zf_device/zf_device_ble6a20.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/zf_device/zf_device_ble6a20.c" 2
# 48 "../../libraries/zf_device/zf_device_ble6a20.c"
# 1 "../../libraries/zf_device/zf_device_ble6a20.h" 1
# 52 "../../libraries/zf_device/zf_device_ble6a20.h"
...
# 53 "../../libraries/zf_device/zf_device_ble6a20.h" 2
...
# 49 "../../libraries/zf_device/zf_device_ble6a20.c" 2
...
# 50 "../../libraries/zf_device/zf_device_ble6a20.c" 2
...
# 51 "../../libraries/zf_device/zf_device_ble6a20.c" 2
...
# 52 "../../libraries/zf_device/zf_device_ble6a20.c" 2
...
# 53 "../../libraries/zf_device/zf_device_ble6a20.c" 2
...
# 54 "../../libraries/zf_device/zf_device_ble6a20.c" 2
...
# 55 "../../libraries/zf_device/zf_device_ble6a20.c" 2
...
# 56 "../../libraries/zf_device/zf_device_ble6a20.c" 2

static fifo_struct ble6a20_fifo;
static uint8 ble6a20_buffer[( 64 )];

static uint8 ble6a20_data = 0;
# 73 "../../libraries/zf_device/zf_device_ble6a20.c"
uint32 ble6a20_send_byte (const uint8 data)
{
    uint16 time_count = ( 0x64 );
    while(time_count)
    {
...
# 97 "../../libraries/zf_device/zf_device_ble6a20.c"
uint32 ble6a20_send_buffer (const uint8 *buff, uint32 len)
{
    (debug_assert_handler((0 != buff), "../../libraries/zf_device/zf_device_ble6a20.c", 99));
    uint16 time_count = 0;
    while(0 != len)
    {
        if(!gpio_get_level((D26)))
...
# 138 "../../libraries/zf_device/zf_device_ble6a20.c"
uint32 ble6a20_send_string (const char *str)
{
    (debug_assert_handler((0 != str), "../../libraries/zf_device/zf_device_ble6a20.c", 140));
    uint16 time_count = 0;
    ...
    while(0 != len)
    {
        if(!gpio_get_level((D26)))
        {
            if(128 <= len)
            {
                uart_write_buffer((UART_8), (const uint8 *)str, 128);
                str += 128;
                len -= 128;
                time_count = 0;
            }
...
# 181 "../../libraries/zf_device/zf_device_ble6a20.c"
void ble6a20_send_image (const uint8 *image_addr, uint32 image_size)
{
    (debug_assert_handler((0 != image_addr), "../../libraries/zf_device/zf_device_ble6a20.c", 183));
...
# 197 "../../libraries/zf_device/zf_device_ble6a20.c"
uint32 ble6a20_read_buffer (uint8 *buff, uint32 len)
{
    (debug_assert_handler((0 != buff), "../../libraries/zf_device/zf_device_ble6a20.c", 199));
    uint32 data_len = len;
    fifo_read_buffer(&ble6a20_fifo, buff, &data_len, FIFO_READ_AND_CLEAN);
    return data_len;
}
# 214 "../../libraries/zf_device/zf_device_ble6a20.c"
void ble6a20_callback (void)
{
    if(uart_query_byte((UART_8), &ble6a20_data))
 {
  fifo_write_buffer(&ble6a20_fifo, &ble6a20_data, 1);
# 227 "../../libraries/zf_device/zf_device_ble6a20.c"
 }

}
# 238 "../../libraries/zf_device/zf_device_ble6a20.c"
uint8 ble6a20_init (void)
{
