# 1 "../../libraries/sdk/drives/fsl_xbara.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/sdk/drives/fsl_xbara.c" 2
...
# 1 "../../libraries/sdk/drives/fsl_xbara.h" 1
# 12 "../../libraries/sdk/drives/fsl_xbara.h"
...
# 13 "../../libraries/sdk/drives/fsl_xbara.h" 2
# 37 "../../libraries/sdk/drives/fsl_xbara.h"
...
# 174 "../../libraries/sdk/drives/fsl_xbara.h"
void XBARA_SetOutputSignalConfig(XBARA_Type *base,
                                 xbar_output_signal_t output,
                                 const xbara_control_config_t *controlConfig);
# 10 "../../libraries/sdk/drives/fsl_xbara.c" 2
# 23 "../../libraries/sdk/drives/fsl_xbara.c"
typedef union
{
    uint8_t _u8[2];
    uint16_t _u16;
} xbara_u8_u16_t;
# 39 "../../libraries/sdk/drives/fsl_xbara.c"
...
static XBARA_Type *const s_xbaraBases[] = { (XBARA_Type *)0u, ((XBARA_Type *)(0x403BC000u)) };



static const clock_ip_name_t s_xbaraClock[] = { kCLOCK_IpInvalid, kCLOCK_Xbar1 };
...
static uint32_t XBARA_GetInstance(XBARA_Type *base)
{
    ...
    for (instance = 0; instance < (sizeof(s_xbaraBases) / sizeof((s_xbaraBases)[0])); instance++)
    {
    ...
    ((instance < (sizeof(s_xbaraBases) / sizeof((s_xbaraBases)[0]))) ? (void)0 : __aeabi_assert("instance < ARRAY_SIZE(s_xbaraBases)", "../../libraries/sdk/drives/fsl_xbara.c", 70),
# 70 "../../libraries/sdk/drives/fsl_xbara.c"
#pragma clang diagnostic push
# 70 "../../libraries/sdk/drives/fsl_xbara.c"
#pragma clang diagnostic ignored "-Wassume"
# 70 "../../libraries/sdk/drives/fsl_xbara.c"
    (__builtin_assume)((instance < (sizeof(s_xbaraBases) / sizeof((s_xbaraBases)[0])))?1:0)
# 70 "../../libraries/sdk/drives/fsl_xbara.c"
#pragma clang diagnostic pop
# 70 "../../libraries/sdk/drives/fsl_xbara.c"
    );
...
# 82 "../../libraries/sdk/drives/fsl_xbara.c"
void XBARA_Init(XBARA_Type *base)
{
...
# 97 "../../libraries/sdk/drives/fsl_xbara.c"
void XBARA_Deinit(XBARA_Type *base)
{
...
# 121 "../../libraries/sdk/drives/fsl_xbara.c"
void XBARA_SetSignalsConnection(XBARA_Type *base, xbar_input_signal_t input, xbar_output_signal_t output)
{
    ...
    regVal._u16 = (((volatile uint16_t *)(&((base)->SEL0)))[(uint32_t)(outputIndex) / 2UL]);

    regVal._u8[byteInReg] = (uint8_t)input;

    (((volatile uint16_t *)(&((base)->SEL0)))[(uint32_t)(outputIndex) / 2UL]) = regVal._u16;
}
# 148 "../../libraries/sdk/drives/fsl_xbara.c"
uint32_t XBARA_GetStatusFlags(XBARA_Type *base)
{
    uint32_t status_flag;

    status_flag = ((uint32_t)base->CTRL0 & ((0x10U) | (0x1000U)));

    status_flag |= (((uint32_t)base->CTRL1 & ((0x10U) | (0x1000U))) << 16U);
...
void XBARA_ClearStatusFlags(XBARA_Type *base, uint32_t mask)
{
    ...
    regVal &= (uint16_t)(~((0x10U) | (0x1000U)));

    regVal |= (uint16_t)(mask & ((0x10U) | (0x1000U)));
    ...
    regVal |= (uint16_t)((mask >> 16U) & ((0x10U) | (0x1000U)));

    base->CTRL1 = regVal;
}
# 206 "../../libraries/sdk/drives/fsl_xbara.c"
void XBARA_SetOutputSignalConfig(XBARA_Type *base,
                                 xbar_output_signal_t output,
                                 const xbara_control_config_t *controlConfig)
{
    ...
    ((outputIndex < (uint32_t)(4)) ? (void)0 : __aeabi_assert("outputIndex < (uint32_t)FSL_FEATURE_XBARA_INTERRUPT_COUNT", "../../libraries/sdk/drives/fsl_xbara.c", 215),
# 215 "../../libraries/sdk/drives/fsl_xbara.c"
#pragma clang diagnostic push
# 215 "../../libraries/sdk/drives/fsl_xbara.c"
#pragma clang diagnostic ignored "-Wassume"
# 215 "../../libraries/sdk/drives/fsl_xbara.c"
    (__builtin_assume)((outputIndex < (uint32_t)(4))?1:0)
# 215 "../../libraries/sdk/drives/fsl_xbara.c"
#pragma clang diagnostic pop
# 215 "../../libraries/sdk/drives/fsl_xbara.c"
    );
    ...
    regVal._u16 = (((volatile uint16_t *)(&((base)->CTRL0)))[(regIndex)]);


    regVal._u16 &= (uint16_t)(~((0x10U) | (0x1000U)));

    regVal._u8[byteInReg] = (uint8_t)((((uint16_t)(((uint16_t)(controlConfig->activeEdge)) << (2U))) & (0xCU)) |
                                      (uint16_t)(((uint32_t)controlConfig->requestType) << (0U)));

    (((volatile uint16_t *)(&((base)->CTRL0)))[(regIndex)]) = regVal._u16;
}
