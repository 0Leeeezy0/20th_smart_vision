# 1 "../../libraries/zf_device/zf_device_dl1b.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/zf_device/zf_device_dl1b.c" 2
# 48 "../../libraries/zf_device/zf_device_dl1b.c"
...
# 49 "../../libraries/zf_device/zf_device_dl1b.c" 2
...
# 51 "../../libraries/zf_device/zf_device_dl1b.c" 2
...
# 52 "../../libraries/zf_device/zf_device_dl1b.c" 2
...
# 53 "../../libraries/zf_device/zf_device_dl1b.c" 2
...
# 55 "../../libraries/zf_device/zf_device_dl1b.c" 2
...
# 56 "../../libraries/zf_device/zf_device_dl1b.c" 2
...
# 57 "../../libraries/zf_device/zf_device_dl1b.c" 2
...
# 77 "../../libraries/zf_device/zf_device_dl1b.c"
void dl1b_get_distance (void)
{
    if(dl1b_init_flag)
    {
        ...
        data_buffer[0] = ( 0x0031 ) >> 8;
        data_buffer[1] = ( 0x0031 ) & 0xFF;
        (soft_iic_transfer_8bit_array(&dl1b_iic_struct, (data_buffer), (2), (&data_buffer[2]), (1)));

        if(data_buffer[2])
        {

            data_buffer[0] = ( 0x0086 ) >> 8;
            data_buffer[1] = ( 0x0086 ) & 0xFF;
            data_buffer[2] = 0x01;
            (soft_iic_transfer_8bit_array(&dl1b_iic_struct, (data_buffer), (3), (data_buffer), (0)));

            data_buffer[0] = ( 0x0089 ) >> 8;
            data_buffer[1] = ( 0x0089 ) & 0xFF;
            (soft_iic_transfer_8bit_array(&dl1b_iic_struct, (data_buffer), (2), (&data_buffer[2]), (1)));

            if(0x89 == data_buffer[2])
            {
                data_buffer[0] = ( 0x0096 ) >> 8;
                data_buffer[1] = ( 0x0096 ) & 0xFF;
                (soft_iic_transfer_8bit_array(&dl1b_iic_struct, (data_buffer), (2), (data_buffer), (2)));
...
# 140 "../../libraries/zf_device/zf_device_dl1b.c"
void dl1b_int_handler (void)
{
...
# 158 "../../libraries/zf_device/zf_device_dl1b.c"
uint8 dl1b_init (void)
{
    ...
    soft_iic_init(&dl1b_iic_struct, ( 0x52 >> 1 ), ( 100 ), ( B9 ), ( B10 ));
    ...
    do
    {
        ...
        data_buffer[0] = ( 0x00E5 ) >> 8;
        data_buffer[1] = ( 0x00E5 ) & 0xFF;
        (soft_iic_transfer_8bit_array(&dl1b_iic_struct, (data_buffer), (2), (&data_buffer[2]), (1)));
        ...
        data_buffer[0] = ( 0x0001 ) >> 8;
        data_buffer[1] = ( 0x0001 ) & 0xFF;
        memcpy(&data_buffer[2], (uint8 *)dl1b_config_file, sizeof(dl1b_config_file));
        (soft_iic_transfer_8bit_array(&dl1b_iic_struct, (data_buffer), (2 + sizeof(dl1b_config_file)), (data_buffer), (0)));
