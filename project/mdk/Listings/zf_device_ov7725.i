# 1 "../../libraries/zf_device/zf_device_ov7725.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/zf_device/zf_device_ov7725.c" 2
# 50 "../../libraries/zf_device/zf_device_ov7725.c"
...
# 51 "../../libraries/zf_device/zf_device_ov7725.c" 2
...
# 52 "../../libraries/zf_device/zf_device_ov7725.c" 2
...
# 53 "../../libraries/zf_device/zf_device_ov7725.c" 2
...
# 54 "../../libraries/zf_device/zf_device_ov7725.c" 2
...
# 55 "../../libraries/zf_device/zf_device_ov7725.c" 2
...
# 56 "../../libraries/zf_device/zf_device_ov7725.c" 2
...
# 57 "../../libraries/zf_device/zf_device_ov7725.c" 2
...
# 58 "../../libraries/zf_device/zf_device_ov7725.c" 2
...
# 59 "../../libraries/zf_device/zf_device_ov7725.c" 2
...
# 60 "../../libraries/zf_device/zf_device_ov7725.c" 2
...
# 62 "../../libraries/zf_device/zf_device_ov7725.c" 2

vuint8 ov7725_finish_flag = 0;


__attribute__((section(".bss.NonCacheable"))) __attribute__((aligned(64))) uint8 ov7725_image_binary1[(120)][(160) / 8];
__attribute__((section(".bss.NonCacheable"))) __attribute__((aligned(64))) uint8 ov7725_image_binary2[(120)][(160) / 8];




uint8 (*ov7725_image_binary)[(160) / 8];
...
# 103 "../../libraries/zf_device/zf_device_ov7725.c"
static uint8 ov7725_set_config (uint16 buff[OV7725_CONFIG_FINISH][2])
{
    ...
    do
    {
        ...
        system_delay_ms(1);
    }while((0x00FF) > timeout_count ++);



    return return_state;
}
# 151 "../../libraries/zf_device/zf_device_ov7725.c"
...
# 200 "../../libraries/zf_device/zf_device_ov7725.c"
static uint8 ov7725_iic_init (void)
{
    ...
    uart_rx_interrupt((UART_5 ), 0);

    soft_iic_init(&ov7725_iic_struct, (0x42>>1), (800), (C29), (C28));

    soft_iic_sccb_write_register(&ov7725_iic_struct, (0x12), 0x80);
    system_delay_ms(50);

    do
    {
        ov7725_idcode = soft_iic_sccb_read_register(&ov7725_iic_struct, (0x0B));
        if((0x21) != ov7725_idcode)
        {
            return_state = 1;
            break;
        }
        ...
        soft_iic_sccb_write_register(&ov7725_iic_struct, (0x0D) , 0xC1);
        soft_iic_sccb_write_register(&ov7725_iic_struct, (0x11) , 0x01);
        soft_iic_sccb_write_register(&ov7725_iic_struct, (0x09) , 0x03);
        soft_iic_sccb_write_register(&ov7725_iic_struct, (0x0C) , 0xD0);
        soft_iic_sccb_write_register(&ov7725_iic_struct, (0x12) , 0x40);
        soft_iic_sccb_write_register(&ov7725_iic_struct, (0x13) , 0xCE);
        soft_iic_sccb_write_register(&ov7725_iic_struct, (0x17) , 0x3F);
        soft_iic_sccb_write_register(&ov7725_iic_struct, (0x18) , 0x50);
        soft_iic_sccb_write_register(&ov7725_iic_struct, (0x19) , 0x03);
        soft_iic_sccb_write_register(&ov7725_iic_struct, (0x1A) , 0x78);
        soft_iic_sccb_write_register(&ov7725_iic_struct, (0x32) , 0x00);
        soft_iic_sccb_write_register(&ov7725_iic_struct, (0xA0) , 0x0A);
        soft_iic_sccb_write_register(&ov7725_iic_struct, (0x63) , 0xE0);
        soft_iic_sccb_write_register(&ov7725_iic_struct, (0xAC) , 0xff);
        soft_iic_sccb_write_register(&ov7725_iic_struct, (0x65) , 0x0C);
        soft_iic_sccb_write_register(&ov7725_iic_struct, (0x66) , 0x00);
        soft_iic_sccb_write_register(&ov7725_iic_struct, (0x67) , 0x00);

        if((160) == 80)
        {
            soft_iic_sccb_write_register(&ov7725_iic_struct, (0x29), 0x14);
        }
        else if((160) == 160)
        {
            soft_iic_sccb_write_register(&ov7725_iic_struct, (0x29), 0x28);
        }
        else if((160) == 240)
        {
            soft_iic_sccb_write_register(&ov7725_iic_struct, (0x29), 0x3c);
        }
        else if((160) == 320)
        {
            soft_iic_sccb_write_register(&ov7725_iic_struct, (0x29), 0x50);
        }

        if((120) == 60)
        {
            soft_iic_sccb_write_register(&ov7725_iic_struct, (0x2C), 0x1E);
        }
        else if((120) == 120)
        {
            soft_iic_sccb_write_register(&ov7725_iic_struct, (0x2C), 0x3c);
        }
        else if((120) == 180)
        {
            soft_iic_sccb_write_register(&ov7725_iic_struct, (0x2C), 0x5a);
        }
        else if((120) == 240)
        {
            soft_iic_sccb_write_register(&ov7725_iic_struct, (0x2C), 0x78);
        }

        soft_iic_sccb_write_register(&ov7725_iic_struct, (0x28) , 0x01);
        soft_iic_sccb_write_register(&ov7725_iic_struct, (0x2A) , 0x10);
        soft_iic_sccb_write_register(&ov7725_iic_struct, (0x2B) , 0x1F);
        soft_iic_sccb_write_register(&ov7725_iic_struct, (0x7E) , 0x0c);
        soft_iic_sccb_write_register(&ov7725_iic_struct, (0x7F) , 0x16);
        soft_iic_sccb_write_register(&ov7725_iic_struct, (0x80) , 0x2a);
        soft_iic_sccb_write_register(&ov7725_iic_struct, (0x81) , 0x4e);
        soft_iic_sccb_write_register(&ov7725_iic_struct, (0x82) , 0x61);
        soft_iic_sccb_write_register(&ov7725_iic_struct, (0x83) , 0x6f);
        soft_iic_sccb_write_register(&ov7725_iic_struct, (0x84) , 0x7b);
        soft_iic_sccb_write_register(&ov7725_iic_struct, (0x85) , 0x86);
        soft_iic_sccb_write_register(&ov7725_iic_struct, (0x86) , 0x8e);
        soft_iic_sccb_write_register(&ov7725_iic_struct, (0x87) , 0x97);
        soft_iic_sccb_write_register(&ov7725_iic_struct, (0x88) , 0xa4);
        soft_iic_sccb_write_register(&ov7725_iic_struct, (0x89) , 0xaf);
        soft_iic_sccb_write_register(&ov7725_iic_struct, (0x8A) , 0xc5);
        soft_iic_sccb_write_register(&ov7725_iic_struct, (0x8B) , 0xd7);
        soft_iic_sccb_write_register(&ov7725_iic_struct, (0x8C) , 0xe8);
        soft_iic_sccb_write_register(&ov7725_iic_struct, (0x8D) , 0x20);
        soft_iic_sccb_write_register(&ov7725_iic_struct, (0x4A) , 0x00);
        soft_iic_sccb_write_register(&ov7725_iic_struct, (0x49) , 0x13);
        soft_iic_sccb_write_register(&ov7725_iic_struct, (0x47) , 0x08);
        soft_iic_sccb_write_register(&ov7725_iic_struct, (0x4B) , 0x14);
        soft_iic_sccb_write_register(&ov7725_iic_struct, (0x4C) , 0x17);
        soft_iic_sccb_write_register(&ov7725_iic_struct, (0x46) , 0x05);
        soft_iic_sccb_write_register(&ov7725_iic_struct, (0x22) , 0x99);
        soft_iic_sccb_write_register(&ov7725_iic_struct, (0x23) , 0x03);
        soft_iic_sccb_write_register(&ov7725_iic_struct, (0xA6) , 0x04);
        soft_iic_sccb_write_register(&ov7725_iic_struct, (0x9B) , 0x00);
        soft_iic_sccb_write_register(&ov7725_iic_struct, (0x9C) , 0x40);
        soft_iic_sccb_write_register(&ov7725_iic_struct, (0xAB) , 0x06);
        soft_iic_sccb_write_register(&ov7725_iic_struct, (0x9E) , 0x11);
        soft_iic_sccb_write_register(&ov7725_iic_struct, (0x9F) , 0x02);
    }while(0);
    return return_state;
}
# 319 "../../libraries/zf_device/zf_device_ov7725.c"
uint16 ov7725_uart_get_id (void)
{
    uint16 temp = 0;
    uint8 uart_buffer[4];
...
# 358 "../../libraries/zf_device/zf_device_ov7725.c"
uint16 ov7725_get_version (void)
{
    uint16 temp = 0;
    uint8 uart_buffer[4];
...
# 396 "../../libraries/zf_device/zf_device_ov7725.c"
...
# 417 "../../libraries/zf_device/zf_device_ov7725.c"
...
uint8 ov7725_init (void)
{
    ...
    do
    {
        set_camera_type(CAMERA_BIN_UART, 0, 0, &ov7725_uart_callback);
        camera_fifo_init();
        ...
        {
            system_delay_ms(200);
            set_camera_type(CAMERA_BIN_IIC, 0, 0, 0);
            if(ov7725_iic_init())
            {



                (debug_log_handler((0), ("OV7725 IIC error."), "../../libraries/zf_device/zf_device_ov7725.c", 468));
        ...
        else
        {
            ...
            if(ov7725_set_config(ov7725_set_confing_buffer))
            {
                ...
                (debug_log_handler((0), ("OV7725 set confing error."), "../../libraries/zf_device/zf_device_ov7725.c", 482));
                set_camera_type(NO_CAMERE, 0, 0, 0);
                return_state = 1;
                break;
            }
            ...
            if(ov7725_get_config(ov7725_get_confing_buffer))
            {
                ...
                (debug_log_handler((0), ("OV7725 get confing error."), "../../libraries/zf_device/zf_device_ov7725.c", 493));
                set_camera_type(NO_CAMERE, 0, 0, 0);
                return_state = 1;
                break;
            }
        ...
        csi_init((160) / 8, (120), &csi_handle, ov7725_finished_callback, (CSI_VSYNC_B22), (CSI_PIXCLK_B20), CSI_PIXCLK_FALLING);
        csi_add_empty_buffer(&csi_handle, ov7725_image_binary1[0]);
        csi_add_empty_buffer(&csi_handle, ov7725_image_binary2[0]);
