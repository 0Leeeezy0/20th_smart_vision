# 1 "../../libraries/zf_device/zf_device_absolute_encoder.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/zf_device/zf_device_absolute_encoder.c" 2
# 48 "../../libraries/zf_device/zf_device_absolute_encoder.c"
...
# 49 "../../libraries/zf_device/zf_device_absolute_encoder.c" 2
...
# 50 "../../libraries/zf_device/zf_device_absolute_encoder.c" 2
...
# 51 "../../libraries/zf_device/zf_device_absolute_encoder.c" 2
...
# 52 "../../libraries/zf_device/zf_device_absolute_encoder.c" 2
...
# 53 "../../libraries/zf_device/zf_device_absolute_encoder.c" 2
...
# 54 "../../libraries/zf_device/zf_device_absolute_encoder.c" 2
...
# 56 "../../libraries/zf_device/zf_device_absolute_encoder.c" 2

static int16 now_location = 0;
static int16 last_location = 0;
# 77 "../../libraries/zf_device/zf_device_absolute_encoder.c"
static void absolute_encoder_write_register(uint8 reg, uint8 data)
{
    ...
    (spi_write_8bit((SPI_4), (reg | (0x80))));
    (spi_write_8bit((SPI_4), (data)));
...
# 97 "../../libraries/zf_device/zf_device_absolute_encoder.c"
static uint8 absolute_encoder_read_register(uint8 reg)
{
    uint8 data = 0;
    ((0) ? (GPIO_SetPinsOutput(PORTPTR[(C20) >> 5],1 << ((C20) & 0x1f))): (GPIO_ClearPinsOutput(PORTPTR[(C20) >> 5],1 << ((C20) & 0x1f))));
    (spi_write_8bit((SPI_4), (reg | (0x40))));
    (spi_write_8bit((SPI_4), (0x00)));
    ((1) ? (GPIO_SetPinsOutput(PORTPTR[(C20) >> 5],1 << ((C20) & 0x1f))): (GPIO_ClearPinsOutput(PORTPTR[(C20) >> 5],1 << ((C20) & 0x1f))));
    system_delay_us(1);
    ((0) ? (GPIO_SetPinsOutput(PORTPTR[(C20) >> 5],1 << ((C20) & 0x1f))): (GPIO_ClearPinsOutput(PORTPTR[(C20) >> 5],1 << ((C20) & 0x1f))));
    data = (spi_read_8bit((SPI_4)));
    (spi_read_8bit((SPI_4)));
    ((1) ? (GPIO_SetPinsOutput(PORTPTR[(C20) >> 5],1 << ((C20) & 0x1f))): (GPIO_ClearPinsOutput(PORTPTR[(C20) >> 5],1 << ((C20) & 0x1f))));
    return data;
}
# 119 "../../libraries/zf_device/zf_device_absolute_encoder.c"
...
# 137 "../../libraries/zf_device/zf_device_absolute_encoder.c"
static uint8 absolute_encoder_self_check (void)
{
    uint8 i = 0, return_state = 0;
    uint8 dat[6] = {0, 0, 0, 0xC0, 0xFF, 0x1C};
    uint16 time_count = 0;
    while(0x1C != absolute_encoder_read_register(6))
    {
        for(i = 0; 6 > i; i ++)
        {
            absolute_encoder_write_register(i + 1, dat[i]);
            system_delay_ms(1);
        }
        if((100) < time_count ++)
        {
...
# 165 "../../libraries/zf_device/zf_device_absolute_encoder.c"
int16 absolute_encoder_get_location (void)
{
...
# 179 "../../libraries/zf_device/zf_device_absolute_encoder.c"
int16 absolute_encoder_get_offset (void)
{
    int16 result_data = 0;
    if(2048 < ((now_location - last_location) >= 0 ? (now_location - last_location): -(now_location - last_location)))
    {
...
# 200 "../../libraries/zf_device/zf_device_absolute_encoder.c"
uint8 absolute_encoder_init (void)
{
    ...
    do
    {
        if(absolute_encoder_self_check())
        {
            ...
            return_state = 1;
            (debug_log_handler((0), ("absolute encoder init errror."), "../../libraries/zf_device/zf_device_absolute_encoder.c", 219));
            break;
        }
        absolute_encoder_write_register((0X09), 0x00);
        zero_position = (uint16)(4096 - zero_position);
        zero_position = zero_position << 4;
        absolute_encoder_write_register((0x00), (uint8)zero_position);
        absolute_encoder_write_register((0x01), zero_position >> 8);
    }while(0);
    return return_state;
}
