# 1 "../../libraries/sdk/drives/fsl_semc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/sdk/drives/fsl_semc.c" 2
...
# 1 "../../libraries/sdk/drives/fsl_semc.h" 1
# 10 "../../libraries/sdk/drives/fsl_semc.h"
...
# 11 "../../libraries/sdk/drives/fsl_semc.h" 2
# 28 "../../libraries/sdk/drives/fsl_semc.h"
enum
{
    kStatus_SEMC_InvalidDeviceType = ((((kStatusGroup_SEMC)*100L) + (0))),
    kStatus_SEMC_IpCommandExecutionError = ((((kStatusGroup_SEMC)*100L) + (1))),
    kStatus_SEMC_AxiCommandExecutionError = ((((kStatusGroup_SEMC)*100L) + (2))),
    kStatus_SEMC_InvalidMemorySize = ((((kStatusGroup_SEMC)*100L) + (3))),
    kStatus_SEMC_InvalidIpcmdDataSize = ((((kStatusGroup_SEMC)*100L) + (4))),
    kStatus_SEMC_InvalidAddressPortWidth = ((((kStatusGroup_SEMC)*100L) + (5))),
    kStatus_SEMC_InvalidDataPortWidth = ((((kStatusGroup_SEMC)*100L) + (6))),
    kStatus_SEMC_InvalidSwPinmuxSelection = ((((kStatusGroup_SEMC)*100L) + (7))),
    kStatus_SEMC_InvalidBurstLength = ((((kStatusGroup_SEMC)*100L) + (8))),

    kStatus_SEMC_InvalidColumnAddressBitWidth = ((((kStatusGroup_SEMC)*100L) + (9))),
    kStatus_SEMC_InvalidBaseAddress = ((((kStatusGroup_SEMC)*100L) + (10))),
    kStatus_SEMC_InvalidTimerSetting = ((((kStatusGroup_SEMC)*100L) + (11))),
};
...
{
    kSEMC_IPCmdDoneInterrupt = (0x1U),
    kSEMC_IPCmdErrInterrupt = (0x2U),
    kSEMC_AXICmdErrInterrupt = (0x4U),
    kSEMC_AXIBusErrInterrupt = (0x8U)
...
{
    kSEMC_MORA27_NONE = 0,
    kSEMC_NORA27_MUXCSX3 = (12U),
    kSEMC_NORA27_MUXRDY = (15U)
...
# 383 "../../libraries/sdk/drives/fsl_semc.h"
...
typedef struct _semc_sram_config
{
    ...
    sem_norsram_burst_len_t burstLen;
    smec_port_size_t portSize;
# 514 "../../libraries/sdk/drives/fsl_semc.h"
    uint8_t tCeSetup_Ns;
    uint8_t tCeHold_Ns;
    uint8_t tCeInterval_Ns;
...
# 614 "../../libraries/sdk/drives/fsl_semc.h"
...
# 858 "../../libraries/sdk/drives/fsl_semc.h"
...
static const clock_ip_name_t s_semcClock[(1)] = { kCLOCK_Semc };

static const clock_ip_name_t s_semcExtClock[(1)] = { kCLOCK_SemcExsc };




static SEMC_Type *const s_semcBases[] = { ((SEMC_Type *)(0x402F0000u)) };
...
static uint32_t SEMC_GetInstance(SEMC_Type *base)
{
    ...
    for (instance = 0; instance < (sizeof(s_semcBases) / sizeof((s_semcBases)[0])); instance++)
    {
    ...
    ((instance < (sizeof(s_semcBases) / sizeof((s_semcBases)[0]))) ? (void)0 : __aeabi_assert("instance < ARRAY_SIZE(s_semcBases)", "../../libraries/sdk/drives/fsl_semc.c", 132),
# 132 "../../libraries/sdk/drives/fsl_semc.c"
#pragma clang diagnostic push
# 132 "../../libraries/sdk/drives/fsl_semc.c"
#pragma clang diagnostic ignored "-Wassume"
# 132 "../../libraries/sdk/drives/fsl_semc.c"
    (__builtin_assume)((instance < (sizeof(s_semcBases) / sizeof((s_semcBases)[0])))?1:0)
# 132 "../../libraries/sdk/drives/fsl_semc.c"
#pragma clang diagnostic pop
# 132 "../../libraries/sdk/drives/fsl_semc.c"
    );
...
static status_t SEMC_CovertMemorySize(uint32_t size_kbytes, uint8_t *sizeConverted)
{
    ((sizeConverted != 0) ? (void)0 : __aeabi_assert("sizeConverted != NULL", "../../libraries/sdk/drives/fsl_semc.c", 139),
# 139 "../../libraries/sdk/drives/fsl_semc.c"
#pragma clang diagnostic push
# 139 "../../libraries/sdk/drives/fsl_semc.c"
#pragma clang diagnostic ignored "-Wassume"
# 139 "../../libraries/sdk/drives/fsl_semc.c"
    (__builtin_assume)((sizeConverted != 0)?1:0)
# 139 "../../libraries/sdk/drives/fsl_semc.c"
#pragma clang diagnostic pop
# 139 "../../libraries/sdk/drives/fsl_semc.c"
    );
    ...
    if ((size_kbytes < (4U)) || (size_kbytes > (4UL * 1024UL * 1024UL)))
    {
...
static uint8_t SEMC_ConvertTiming(uint32_t time_ns, uint32_t clkSrc_Hz)
{
    ((clkSrc_Hz != 0x00U) ? (void)0 : __aeabi_assert("clkSrc_Hz != 0x00U", "../../libraries/sdk/drives/fsl_semc.c", 163),
# 163 "../../libraries/sdk/drives/fsl_semc.c"
#pragma clang diagnostic push
# 163 "../../libraries/sdk/drives/fsl_semc.c"
#pragma clang diagnostic ignored "-Wassume"
# 163 "../../libraries/sdk/drives/fsl_semc.c"
    (__builtin_assume)((clkSrc_Hz != 0x00U)?1:0)
# 163 "../../libraries/sdk/drives/fsl_semc.c"
#pragma clang diagnostic pop
# 163 "../../libraries/sdk/drives/fsl_semc.c"
    );
...
static status_t SEMC_ConfigureIPCommand(SEMC_Type *base, uint8_t size_bytes)
{
    ...
    if ((size_bytes > (4U)) || (size_bytes == 0x00U))
    {
    ...
    else
    {
        ...
        base->IPCR1 = (((uint32_t)(((uint32_t)(size_bytes)) << (0U))) & (0x7U));
...
static status_t SEMC_IsIPCommandDone(SEMC_Type *base)
{
    ...
    while ((base->INTR & (uint32_t)(0x1U)) == 0x00U)
    {
    };
    ...
    if ((base->INTR & (uint32_t)(0x2U)) != 0x00U)
    {
        base->INTR |= (0x2U);
...
# 253 "../../libraries/sdk/drives/fsl_semc.c"
void SEMC_GetDefaultConfig(semc_config_t *config)
{
    ((config != 0) ? (void)0 : __aeabi_assert("config != NULL", "../../libraries/sdk/drives/fsl_semc.c", 255),
# 255 "../../libraries/sdk/drives/fsl_semc.c"
#pragma clang diagnostic push
# 255 "../../libraries/sdk/drives/fsl_semc.c"
#pragma clang diagnostic ignored "-Wassume"
# 255 "../../libraries/sdk/drives/fsl_semc.c"
...
# 255 "../../libraries/sdk/drives/fsl_semc.c"
    ...
    queueaWeight->qos = (5U);
    queueaWeight->aging = (8U);
    queueaWeight->slaveHitSwith = (0x40U);
    queueaWeight->slaveHitNoswitch = (0x10U);
    queuebWeight->qos = (5U);
    queuebWeight->aging = (8U);
    queuebWeight->slaveHitSwith = (0x24U);
    queuebWeight->weightPagehit = (0x60U);
    queuebWeight->bankRotation = (0x40U);
}
# 289 "../../libraries/sdk/drives/fsl_semc.c"
void SEMC_Init(SEMC_Type *base, semc_config_t *configure)
{
    ((configure != 0) ? (void)0 : __aeabi_assert("configure != NULL", "../../libraries/sdk/drives/fsl_semc.c", 291),
# 291 "../../libraries/sdk/drives/fsl_semc.c"
#pragma clang diagnostic push
# 291 "../../libraries/sdk/drives/fsl_semc.c"
#pragma clang diagnostic ignored "-Wassume"
# 291 "../../libraries/sdk/drives/fsl_semc.c"
    (__builtin_assume)((configure != 0)?1:0)
# 291 "../../libraries/sdk/drives/fsl_semc.c"
#pragma clang diagnostic pop
# 291 "../../libraries/sdk/drives/fsl_semc.c"
    );
    ...
    base->MCR = (0x1U);
    while ((base->MCR & (uint32_t)(0x1U)) != 0x00U)
    {
    }


    base->MCR |= (0x2U) | (((uint32_t)(((uint32_t)(configure->busTimeoutCycles)) << (24U))) & (0x1F000000U)) |
                 (((uint32_t)(((uint32_t)(configure->cmdTimeoutCycles)) << (16U))) & (0xFF0000U)) | (((uint32_t)(((uint32_t)(configure->dqsMode)) << (2U))) & (0x4U));

    if (configure->queueWeight.queueaEnable == 1)
    {
    ...
    if (configure->queueWeight.queuebEnable == 1)
    {
...
# 350 "../../libraries/sdk/drives/fsl_semc.c"
void SEMC_Deinit(SEMC_Type *base)
{

    while ((base->STS0 & (uint32_t)(0x1U)) == 0x00U)
    {
        ;
    }
...
# 377 "../../libraries/sdk/drives/fsl_semc.c"
status_t SEMC_ConfigureSDRAM(SEMC_Type *base, semc_sdram_cs_t cs, semc_sdram_config_t *config, uint32_t clkSrc_Hz)
{
    ((config != 0) ? (void)0 : __aeabi_assert("config != NULL", "../../libraries/sdk/drives/fsl_semc.c", 379),
# 379 "../../libraries/sdk/drives/fsl_semc.c"
#pragma clang diagnostic push
# 379 "../../libraries/sdk/drives/fsl_semc.c"
#pragma clang diagnostic ignored "-Wassume"
# 379 "../../libraries/sdk/drives/fsl_semc.c"
...
# 379 "../../libraries/sdk/drives/fsl_semc.c"
    ...
    ((clkSrc_Hz > 0x00U) ? (void)0 : __aeabi_assert("clkSrc_Hz > 0x00U", "../../libraries/sdk/drives/fsl_semc.c", 380),
# 380 "../../libraries/sdk/drives/fsl_semc.c"
#pragma clang diagnostic push
# 380 "../../libraries/sdk/drives/fsl_semc.c"
#pragma clang diagnostic ignored "-Wassume"
# 380 "../../libraries/sdk/drives/fsl_semc.c"
...
# 380 "../../libraries/sdk/drives/fsl_semc.c"
    ...
    ((config->refreshBurstLen > 0x00U) ? (void)0 : __aeabi_assert("config->refreshBurstLen > 0x00U", "../../libraries/sdk/drives/fsl_semc.c", 381),
# 381 "../../libraries/sdk/drives/fsl_semc.c"
#pragma clang diagnostic push
# 381 "../../libraries/sdk/drives/fsl_semc.c"
#pragma clang diagnostic ignored "-Wassume"
# 381 "../../libraries/sdk/drives/fsl_semc.c"
    (__builtin_assume)((config->refreshBurstLen > 0x00U)?1:0)
# 381 "../../libraries/sdk/drives/fsl_semc.c"
#pragma clang diagnostic pop
# 381 "../../libraries/sdk/drives/fsl_semc.c"
    );
    ...
    if ((config->address < (0x80000000UL)) || (config->address > (0xDFFFFFFFUL)))
    {
    ...
    uint32_t iocReg = base->IOCR & (~((0x3UL) << (uint32_t)config->csxPinMux));
    ...
    base->BR[cs] = (config->address & (0xFFFFF000U)) | (((uint32_t)(((uint32_t)(memsize)) << (1U))) & (0x3EU)) | (0x1U);


    if (kSEMC_SdramColunm_8bit == config->columnAddrBitNum)
    {
        base->SDRAMCR0 = (((uint32_t)(((uint32_t)(config->portSize)) << (0U))) & (0x1U)) | (((uint32_t)(((uint32_t)(config->burstLen)) << (4U))) & (0x70U)) |
                         (((uint32_t)(((uint32_t)(1)) << (7U))) & (0x80U)) | (((uint32_t)(((uint32_t)(config->casLatency)) << (10U))) & (0xC00U));
    }
    else

    {
        base->SDRAMCR0 = (((uint32_t)(((uint32_t)(config->portSize)) << (0U))) & (0x1U)) | (((uint32_t)(((uint32_t)(config->burstLen)) << (4U))) & (0x70U)) |
                         (((uint32_t)(((uint32_t)(config->columnAddrBitNum)) << (8U))) & (0x300U)) | (((uint32_t)(((uint32_t)(config->casLatency)) << (10U))) & (0xC00U));
    }
    ...
    base->IOCR &= ~(0x7U);
# 451 "../../libraries/sdk/drives/fsl_semc.c"
    timing = (((uint32_t)(((uint32_t)(SEMC_ConvertTiming(config->tPrecharge2Act_Ns, clkSrc_Hz))) << (0U))) & (0xFU));
    timing |= (((uint32_t)(((uint32_t)(SEMC_ConvertTiming(config->tAct2ReadWrite_Ns, clkSrc_Hz))) << (4U))) & (0xF0U));
    timing |= (((uint32_t)(((uint32_t)(SEMC_ConvertTiming(config->tRefreshRecovery_Ns, clkSrc_Hz))) << (8U))) & (0x1F00U));
    timing |= (((uint32_t)(((uint32_t)(SEMC_ConvertTiming(config->tWriteRecovery_Ns, clkSrc_Hz))) << (13U))) & (0xE000U));
    timing |= (((uint32_t)(((uint32_t)(SEMC_ConvertTiming(config->tCkeOff_Ns, clkSrc_Hz))) << (16U))) & (0xF0000U));
    timing |= (((uint32_t)(((uint32_t)(SEMC_ConvertTiming(config->tAct2Prechage_Ns, clkSrc_Hz))) << (20U))) & (0xF00000U));

    base->SDRAMCR1 = timing;

    timing = (((uint32_t)(((uint32_t)(SEMC_ConvertTiming(config->tSelfRefRecovery_Ns, clkSrc_Hz))) << (0U))) & (0xFFU));
    timing |= (((uint32_t)(((uint32_t)(SEMC_ConvertTiming(config->tRefresh2Refresh_Ns, clkSrc_Hz))) << (8U))) & (0xFF00U));
    timing |= (((uint32_t)(((uint32_t)(SEMC_ConvertTiming(config->tAct2Act_Ns, clkSrc_Hz))) << (16U))) & (0xFF0000U)) | (((uint32_t)(((uint32_t)(idle)) << (24U))) & (0xFF000000U));

    base->SDRAMCR2 = timing;


    base->SDRAMCR3 = (((uint32_t)(((uint32_t)((uint32_t)config->refreshBurstLen - 1UL)) << (1U))) & (0xEU)) |

                     (((uint32_t)(((uint32_t)(prescale)) << (8U))) & (0xFF00U)) | (((uint32_t)(((uint32_t)(refresh - 1UL)) << (16U))) & (0xFF0000U)) | (((uint32_t)(((uint32_t)(urgentRef)) << (24U))) & (0xFF000000U));

    ((SEMC_Type *)(0x402F0000u))->IPCR1 = 0x2U;
    ((SEMC_Type *)(0x402F0000u))->IPCR2 = 0U;

    result =
        SEMC_SendIPCommand(base, kSEMC_MemType_SDRAM, config->address, (uint32_t)kSEMC_SDRAMCM_Prechargeall, 0, 0);
    if (result != kStatus_Success)
    {
        return result;
    }
    result =
        SEMC_SendIPCommand(base, kSEMC_MemType_SDRAM, config->address, (uint32_t)kSEMC_SDRAMCM_AutoRefresh, 0, 0);
    if (result != kStatus_Success)
    {
        return result;
    }
    ...
    mode = (uint32_t)config->burstLen | (((uint32_t)config->casLatency) << (4U));
    result =
        SEMC_SendIPCommand(base, kSEMC_MemType_SDRAM, config->address, (uint32_t)kSEMC_SDRAMCM_Modeset, mode, 0);
    if (result != kStatus_Success)
    {
        return result;
    }
...
# 513 "../../libraries/sdk/drives/fsl_semc.c"
status_t SEMC_ConfigureNAND(SEMC_Type *base, semc_nand_config_t *config, uint32_t clkSrc_Hz)
{
    ((config != 0) ? (void)0 : __aeabi_assert("config != NULL", "../../libraries/sdk/drives/fsl_semc.c", 515),
# 515 "../../libraries/sdk/drives/fsl_semc.c"
#pragma clang diagnostic push
# 515 "../../libraries/sdk/drives/fsl_semc.c"
#pragma clang diagnostic ignored "-Wassume"
# 515 "../../libraries/sdk/drives/fsl_semc.c"
...
# 515 "../../libraries/sdk/drives/fsl_semc.c"
    ...
    ((config->timingConfig != 0) ? (void)0 : __aeabi_assert("config->timingConfig != NULL", "../../libraries/sdk/drives/fsl_semc.c", 516),
# 516 "../../libraries/sdk/drives/fsl_semc.c"
#pragma clang diagnostic push
# 516 "../../libraries/sdk/drives/fsl_semc.c"
#pragma clang diagnostic ignored "-Wassume"
# 516 "../../libraries/sdk/drives/fsl_semc.c"
    (__builtin_assume)((config->timingConfig != 0)?1:0)
# 516 "../../libraries/sdk/drives/fsl_semc.c"
#pragma clang diagnostic pop
# 516 "../../libraries/sdk/drives/fsl_semc.c"
    );
    ...
    if ((config->axiAddress < (0x80000000UL)) || (config->axiAddress > (0xDFFFFFFFUL)))
    {
        return kStatus_SEMC_InvalidBaseAddress;
    }
    ...
    uint32_t iocReg =
        base->IOCR & (~(((0x3UL) << (uint32_t)config->cePinMux) | (0x38000U)));
    ...
    base->BR[4] = (config->axiAddress & (0xFFFFF000U)) | (((uint32_t)(((uint32_t)(memsize)) << (1U))) & (0x3EU)) | (0x1U);
    ...
    base->BR[8] = (config->ipgAddress & (0xFFFFF000U)) | (((uint32_t)(((uint32_t)(memsize)) << (1U))) & (0x3EU)) | (0x1U);


    if ((uint32_t)config->cePinMux != 0x00U)
    {
        base->IOCR = iocReg | ((4UL) << (uint32_t)config->cePinMux);
    }
    else
    {
    ...
    base->NANDCR0 = (((uint32_t)(((uint32_t)(config->portSize)) << (0U))) & (0x1U)) | (((uint32_t)(((uint32_t)(config->burstLen)) << (4U))) & (0x70U)) |
                    (((uint32_t)(((uint32_t)(config->edoModeEnabled)) << (7U))) & (0x80U)) | (((uint32_t)(((uint32_t)(config->columnAddrBitNum)) << (8U))) & (0x700U));

    timing = (((uint32_t)(((uint32_t)(SEMC_ConvertTiming(config->timingConfig->tCeSetup_Ns, clkSrc_Hz))) << (0U))) & (0xFU));
    timing |= (((uint32_t)(((uint32_t)(SEMC_ConvertTiming(config->timingConfig->tCeHold_Ns, clkSrc_Hz))) << (4U))) & (0xF0U));
    timing |= (((uint32_t)(((uint32_t)(SEMC_ConvertTiming(config->timingConfig->tWeLow_Ns, clkSrc_Hz))) << (8U))) & (0xF00U));
    timing |= (((uint32_t)(((uint32_t)(SEMC_ConvertTiming(config->timingConfig->tWeHigh_Ns, clkSrc_Hz))) << (12U))) & (0xF000U));
    timing |= (((uint32_t)(((uint32_t)(SEMC_ConvertTiming(config->timingConfig->tReLow_Ns, clkSrc_Hz))) << (16U))) & (0xF0000U));
    timing |= (((uint32_t)(((uint32_t)(SEMC_ConvertTiming(config->timingConfig->tReHigh_Ns, clkSrc_Hz))) << (20U))) & (0xF00000U));
    timing |= (((uint32_t)(((uint32_t)(SEMC_ConvertTiming(config->timingConfig->tTurnAround_Ns, clkSrc_Hz))) << (24U))) & (0xF000000U));
    timing |= (((uint32_t)(((uint32_t)(SEMC_ConvertTiming(config->timingConfig->tCeInterval_Ns, clkSrc_Hz))) << (28U))) & (0xF0000000U));

    base->NANDCR1 = timing;

    timing = (((uint32_t)(((uint32_t)(SEMC_ConvertTiming(config->timingConfig->tWehigh2Relow_Ns, clkSrc_Hz))) << (0U))) & (0x3FU));
    timing |= (((uint32_t)(((uint32_t)(SEMC_ConvertTiming(config->timingConfig->tRehigh2Welow_Ns, clkSrc_Hz))) << (6U))) & (0xFC0U));
    timing |= (((uint32_t)(((uint32_t)(SEMC_ConvertTiming(config->timingConfig->tAle2WriteStart_Ns, clkSrc_Hz))) << (12U))) & (0x3F000U));
    timing |= (((uint32_t)(((uint32_t)(SEMC_ConvertTiming(config->timingConfig->tReady2Relow_Ns, clkSrc_Hz))) << (18U))) & (0xFC0000U));
    timing |= (((uint32_t)(((uint32_t)(SEMC_ConvertTiming(config->timingConfig->tWehigh2Busy_Ns, clkSrc_Hz))) << (24U))) & (0x3F000000U));
...
# 610 "../../libraries/sdk/drives/fsl_semc.c"
status_t SEMC_ConfigureNOR(SEMC_Type *base, semc_nor_config_t *config, uint32_t clkSrc_Hz)
{
    ((config != 0) ? (void)0 : __aeabi_assert("config != NULL", "../../libraries/sdk/drives/fsl_semc.c", 612),
# 612 "../../libraries/sdk/drives/fsl_semc.c"
#pragma clang diagnostic push
# 612 "../../libraries/sdk/drives/fsl_semc.c"
#pragma clang diagnostic ignored "-Wassume"
# 612 "../../libraries/sdk/drives/fsl_semc.c"
...
# 612 "../../libraries/sdk/drives/fsl_semc.c"
    ...
    uint32_t iocReg = base->IOCR & (~((0x3UL) << (uint32_t)config->cePinMux));
    uint32_t muxCe = (config->cePinMux == kSEMC_MUXRDY) ?
                         ((5UL) - 1U) :
                         ((config->cePinMux == kSEMC_MUXA8) ? (2UL) : (5UL));


    base->IOCR = iocReg | (muxCe << (uint32_t)config->cePinMux);

    if (config->addrPortWidth > (24U))
    {
        if (config->addrPortWidth >= ((24U) + 1U))
        {

            base->IOCR &= ~(uint32_t)(0x38U);
            if (config->cePinMux == kSEMC_MUXCSX0)
            {
                return kStatus_SEMC_InvalidSwPinmuxSelection;
            }
        }
        if (config->addrPortWidth >= ((24U) + 2U))
        {

            base->IOCR &= ~(uint32_t)(0x1C0U);
            if (config->cePinMux == kSEMC_MUXCSX1)
            {
                return kStatus_SEMC_InvalidSwPinmuxSelection;
            }
        }
        if (config->addrPortWidth >= ((24U) + 3U))
        {

            base->IOCR &= ~(uint32_t)(0xE00U);
            if (config->cePinMux == kSEMC_MUXCSX2)
            {
                return kStatus_SEMC_InvalidSwPinmuxSelection;
            }
        }
        if (config->addrPortWidth >= ((24U) + 4U))
        {
            if (config->addr27 == kSEMC_NORA27_MUXCSX3)
            {

                base->IOCR &= ~(uint32_t)(0x7000U);
            }
    ...
    base->BR[5] = (config->address & (0xFFFFF000U)) | (((uint32_t)(((uint32_t)(memsize)) << (1U))) & (0x3EU)) | (0x1U);
    base->NORCR0 = (((uint32_t)(((uint32_t)(config->portSize)) << (0U))) & (0x1U)) | (((uint32_t)(((uint32_t)(config->burstLen)) << (4U))) & (0x70U)) |
                   (((uint32_t)(((uint32_t)(config->addrMode)) << (8U))) & (0x300U)) | (((uint32_t)(((uint32_t)(config->advActivePolarity)) << (10U))) & (0x400U)) |
                   (((uint32_t)(((uint32_t)(config->columnAddrBitNum)) << (12U))) & (0xF000U));
# 713 "../../libraries/sdk/drives/fsl_semc.c"
    timing = (((uint32_t)(((uint32_t)(SEMC_ConvertTiming(config->tCeSetup_Ns, clkSrc_Hz))) << (0U))) & (0xFU));
    timing |= (((uint32_t)(((uint32_t)(SEMC_ConvertTiming(config->tCeHold_Ns, clkSrc_Hz))) << (4U))) & (0xF0U));
    timing |= (((uint32_t)(((uint32_t)(SEMC_ConvertTiming(config->tAddrSetup_Ns, clkSrc_Hz))) << (8U))) & (0xF00U));
    timing |= (((uint32_t)(((uint32_t)(SEMC_ConvertTiming(config->tAddrHold_Ns, clkSrc_Hz))) << (12U))) & (0xF000U));
    timing |= (((uint32_t)(((uint32_t)(SEMC_ConvertTiming(config->tWeLow_Ns, clkSrc_Hz))) << (16U))) & (0xF0000U));
    timing |= (((uint32_t)(((uint32_t)(SEMC_ConvertTiming(config->tWeHigh_Ns, clkSrc_Hz))) << (20U))) & (0xF00000U));
    timing |= (((uint32_t)(((uint32_t)(SEMC_ConvertTiming(config->tReLow_Ns, clkSrc_Hz))) << (24U))) & (0xF000000U));
    timing |= (((uint32_t)(((uint32_t)(SEMC_ConvertTiming(config->tReHigh_Ns, clkSrc_Hz))) << (28U))) & (0xF0000000U));


    base->NORCR1 = timing;

    timing = (((uint32_t)(((uint32_t)(SEMC_ConvertTiming(config->tCeInterval_Ns, clkSrc_Hz))) << (24U))) & (0xF000000U));
    ...
    timing |= (((uint32_t)(((uint32_t)(SEMC_ConvertTiming(config->tTurnAround_Ns, clkSrc_Hz))) << (8U))) & (0xF00U));
    timing |= (((uint32_t)(((uint32_t)((uint32_t)SEMC_ConvertTiming(config->tAddr2WriteHold_Ns, clkSrc_Hz) + 0x01UL)) << (12U))) & (0xF000U));

    timing |= (((uint32_t)(((uint32_t)(config->latencyCount)) << (16U))) & (0xF0000U));


    timing |= (((uint32_t)(((uint32_t)((uint32_t)config->readCycle - 0x01UL)) << (20U))) & (0xF00000U));
...
# 754 "../../libraries/sdk/drives/fsl_semc.c"
status_t SEMC_ConfigureSRAM(SEMC_Type *base, semc_sram_config_t *config, uint32_t clkSrc_Hz)
{
    return SEMC_ConfigureSRAMWithChipSelection(base, kSEMC_SRAM_CS0, config, clkSrc_Hz);
}
# 767 "../../libraries/sdk/drives/fsl_semc.c"
status_t SEMC_ConfigureSRAMWithChipSelection(SEMC_Type *base,
                                             semc_sram_cs_t cs,
                                             semc_sram_config_t *config,
                                             uint32_t clkSrc_Hz)
{
    ((config != 0) ? (void)0 : __aeabi_assert("config != NULL", "../../libraries/sdk/drives/fsl_semc.c", 772),
# 772 "../../libraries/sdk/drives/fsl_semc.c"
#pragma clang diagnostic push
# 772 "../../libraries/sdk/drives/fsl_semc.c"
#pragma clang diagnostic ignored "-Wassume"
# 772 "../../libraries/sdk/drives/fsl_semc.c"
...
# 772 "../../libraries/sdk/drives/fsl_semc.c"
    ...
    uint32_t muxCe = (config->cePinMux == kSEMC_MUXRDY) ?
                         ((6UL) - 1U) :
                         ((config->cePinMux == kSEMC_MUXA8) ? (3UL) : (6UL));
    ...
    tempBRVal = (config->address & (0xFFFFF000U)) | (((uint32_t)(((uint32_t)(memsize)) << (1U))) & (0x3EU)) | (0x1U);
    ...
    switch (cs)
    {
        case kSEMC_SRAM_CS0:
            base->BR[6] = tempBRVal;
            break;
# 875 "../../libraries/sdk/drives/fsl_semc.c"
        default:
            ((0) ? (void)0 : __aeabi_assert("NULL", "../../libraries/sdk/drives/fsl_semc.c", 876),
# 876 "../../libraries/sdk/drives/fsl_semc.c"
#pragma clang diagnostic push
# 876 "../../libraries/sdk/drives/fsl_semc.c"
#pragma clang diagnostic ignored "-Wassume"
# 876 "../../libraries/sdk/drives/fsl_semc.c"
...
# 876 "../../libraries/sdk/drives/fsl_semc.c"
    ...
    {
# 906 "../../libraries/sdk/drives/fsl_semc.c"
        {
            tempCtrlVal = (((uint32_t)(((uint32_t)(config->portSize)) << (0U))) & (0x1U)) |



                          (((uint32_t)(((uint32_t)(config->burstLen)) << (4U))) & (0x70U)) | (((uint32_t)(((uint32_t)(config->addrMode)) << (8U))) & (0x300U)) |
                          (((uint32_t)(((uint32_t)(config->advActivePolarity)) << (10U))) & (0x400U)) |
...
# 974 "../../libraries/sdk/drives/fsl_semc.c"
    if (kSEMC_SRAM_CS0 == cs)
    {
        timing = (((uint32_t)(((uint32_t)(SEMC_ConvertTiming(config->tCeSetup_Ns, clkSrc_Hz))) << (0U))) & (0xFU));
        timing |= (((uint32_t)(((uint32_t)(SEMC_ConvertTiming(config->tCeHold_Ns, clkSrc_Hz))) << (4U))) & (0xF0U));
        ...
        timing |= (((uint32_t)(((uint32_t)(SEMC_ConvertTiming(config->tWriteSetup_Ns, clkSrc_Hz))) << (0U))) & (0xFU));


        timing |= (((uint32_t)(((uint32_t)((uint32_t)SEMC_ConvertTiming(config->tWriteHold_Ns, clkSrc_Hz) + 1UL)) << (4U))) & (0xF0U));

        timing |= (((uint32_t)(((uint32_t)(SEMC_ConvertTiming(config->tTurnAround_Ns, clkSrc_Hz))) << (8U))) & (0xF00U));
        timing |= (((uint32_t)(((uint32_t)(SEMC_ConvertTiming(config->tAddr2WriteHold_Ns, clkSrc_Hz))) << (12U))) & (0xF000U));

        timing |= (((uint32_t)(((uint32_t)(config->latencyCount)) << (16U))) & (0xF0000U));


        timing |= (((uint32_t)(((uint32_t)((uint32_t)config->readCycle - 1UL)) << (20U))) & (0xF00000U));
...
# 1051 "../../libraries/sdk/drives/fsl_semc.c"
    return result;
}
# 1061 "../../libraries/sdk/drives/fsl_semc.c"
status_t SEMC_ConfigureDBI(SEMC_Type *base, semc_dbi_config_t *config, uint32_t clkSrc_Hz)
{
    ((config != 0) ? (void)0 : __aeabi_assert("config != NULL", "../../libraries/sdk/drives/fsl_semc.c", 1063),
# 1063 "../../libraries/sdk/drives/fsl_semc.c"
#pragma clang diagnostic push
# 1063 "../../libraries/sdk/drives/fsl_semc.c"
#pragma clang diagnostic ignored "-Wassume"
# 1063 "../../libraries/sdk/drives/fsl_semc.c"
...
# 1063 "../../libraries/sdk/drives/fsl_semc.c"
    ...
    uint32_t muxCsx = (config->csxPinMux == kSEMC_MUXRDY) ?
                          ((7UL) - 1U) :
                          ((config->csxPinMux == kSEMC_MUXA8) ? (4UL) : (7UL));
    ...
    base->BR[7] = (config->address & (0xFFFFF000U)) | (((uint32_t)(((uint32_t)(memsize)) << (1U))) & (0x3EU)) | (0x1U);


    base->DBICR0 =
        (((uint32_t)(((uint32_t)(config->portSize)) << (0U))) & (0x1U)) | (((uint32_t)(((uint32_t)(config->burstLen)) << (4U))) & (0x70U)) | (((uint32_t)(((uint32_t)(config->columnAddrBitNum)) << (12U))) & (0xF000U));

    timing = (((uint32_t)(((uint32_t)(SEMC_ConvertTiming(config->tCsxSetup_Ns, clkSrc_Hz))) << (0U))) & (0xFU));
    timing |= (((uint32_t)(((uint32_t)(SEMC_ConvertTiming(config->tCsxHold_Ns, clkSrc_Hz))) << (4U))) & (0xF0U));
    timing |= (((uint32_t)(((uint32_t)(SEMC_ConvertTiming(config->tWexLow_Ns, clkSrc_Hz))) << (8U))) & (0xF00U));
    timing |= (((uint32_t)(((uint32_t)(SEMC_ConvertTiming(config->tWexHigh_Ns, clkSrc_Hz))) << (12U))) & (0xF000U));
    timing |= (((uint32_t)(((uint32_t)(SEMC_ConvertTiming(config->tRdxLow_Ns, clkSrc_Hz))) << (16U))) & (0xF0000U));
    timing |= (((uint32_t)(((uint32_t)(SEMC_ConvertTiming(config->tRdxHigh_Ns, clkSrc_Hz))) << (20U))) & (0xF00000U));

    timing |= (((uint32_t)(((uint32_t)(SEMC_ConvertTiming(config->tCsxInterval_Ns, clkSrc_Hz))) << (24U))) & (0xF000000U));



    base->DBICR1 = timing;
# 1113 "../../libraries/sdk/drives/fsl_semc.c"
    return SEMC_ConfigureIPCommand(base, ((uint8_t)config->portSize + 1U));
}
# 1130 "../../libraries/sdk/drives/fsl_semc.c"
status_t SEMC_SendIPCommand(
    SEMC_Type *base, semc_mem_type_t memType, uint32_t address, uint32_t command, uint32_t write, uint32_t *read)
{
    uint32_t cmdMode;
    ...
    switch (memType)
    {
        ...
        case kSEMC_MemType_SDRAM:
            ...
            break;
        default:
            ((0) ? (void)0 : __aeabi_assert("false", "../../libraries/sdk/drives/fsl_semc.c", 1167),
# 1167 "../../libraries/sdk/drives/fsl_semc.c"
#pragma clang diagnostic push
# 1167 "../../libraries/sdk/drives/fsl_semc.c"
#pragma clang diagnostic ignored "-Wassume"
# 1167 "../../libraries/sdk/drives/fsl_semc.c"
...
# 1167 "../../libraries/sdk/drives/fsl_semc.c"
    ...
    base->IPCMD = command | (((uint32_t)(((uint32_t)((0xA55A))) << (16U))) & (0xFFFF0000U));
...
# 1203 "../../libraries/sdk/drives/fsl_semc.c"
status_t SEMC_IPCommandNandWrite(SEMC_Type *base, uint32_t address, uint8_t *data, uint32_t size_bytes)
{
    ((data != 0) ? (void)0 : __aeabi_assert("data != NULL", "../../libraries/sdk/drives/fsl_semc.c", 1205),
# 1205 "../../libraries/sdk/drives/fsl_semc.c"
#pragma clang diagnostic push
# 1205 "../../libraries/sdk/drives/fsl_semc.c"
#pragma clang diagnostic ignored "-Wassume"
# 1205 "../../libraries/sdk/drives/fsl_semc.c"
...
# 1205 "../../libraries/sdk/drives/fsl_semc.c"
    ...
    while (size_bytes >= (4U))
    {
        ...
        (void)SEMC_ConfigureIPCommand(base, (4U));
        result = SEMC_SendIPCommand(base, kSEMC_MemType_NAND, address, ipCmd, *(uint32_t *)(void *)data, 0);
        if (result != kStatus_Success)
        {
            break;
        }
    ...
    if ((result == kStatus_Success) && (size_bytes != 0x00U))
    {
        ...
        result = SEMC_SendIPCommand(base, kSEMC_MemType_NAND, address, ipCmd, tempData, 0);
    }

    return result;
}
# 1252 "../../libraries/sdk/drives/fsl_semc.c"
status_t SEMC_IPCommandNandRead(SEMC_Type *base, uint32_t address, uint8_t *data, uint32_t size_bytes)
{
    ((data != 0) ? (void)0 : __aeabi_assert("data != NULL", "../../libraries/sdk/drives/fsl_semc.c", 1254),
# 1254 "../../libraries/sdk/drives/fsl_semc.c"
#pragma clang diagnostic push
# 1254 "../../libraries/sdk/drives/fsl_semc.c"
#pragma clang diagnostic ignored "-Wassume"
# 1254 "../../libraries/sdk/drives/fsl_semc.c"
...
# 1254 "../../libraries/sdk/drives/fsl_semc.c"
    ...
    if ((result == kStatus_Success) && (size_bytes != 0x00U))
    {
        ...
        {
            size_bytes--;
            *(data + size_bytes) = (uint8_t)((tempData >> ((8U) * size_bytes)) & 0xFFU);
        }
    }

    return result;
}
# 1300 "../../libraries/sdk/drives/fsl_semc.c"
status_t SEMC_IPCommandNorRead(SEMC_Type *base, uint32_t address, uint8_t *data, uint32_t size_bytes)
{
    ((data != 0) ? (void)0 : __aeabi_assert("data != NULL", "../../libraries/sdk/drives/fsl_semc.c", 1302),
# 1302 "../../libraries/sdk/drives/fsl_semc.c"
#pragma clang diagnostic push
# 1302 "../../libraries/sdk/drives/fsl_semc.c"
#pragma clang diagnostic ignored "-Wassume"
# 1302 "../../libraries/sdk/drives/fsl_semc.c"
...
# 1302 "../../libraries/sdk/drives/fsl_semc.c"
    ...
    uint32_t tempData = 0;
    status_t result = kStatus_Success;
    uint8_t dataSize = (uint8_t)base->NORCR0 & (0x1U);
...
# 1347 "../../libraries/sdk/drives/fsl_semc.c"
status_t SEMC_IPCommandNorWrite(SEMC_Type *base, uint32_t address, uint8_t *data, uint32_t size_bytes)
{
    ((data != 0) ? (void)0 : __aeabi_assert("data != NULL", "../../libraries/sdk/drives/fsl_semc.c", 1349),
# 1349 "../../libraries/sdk/drives/fsl_semc.c"
#pragma clang diagnostic push
# 1349 "../../libraries/sdk/drives/fsl_semc.c"
#pragma clang diagnostic ignored "-Wassume"
# 1349 "../../libraries/sdk/drives/fsl_semc.c"
...
# 1349 "../../libraries/sdk/drives/fsl_semc.c"
    ...
    if ((result == kStatus_Success) && (size_bytes != 0x00U))
    {
        ...
        while (size_bytes != 0x00U)
        {
            tempData |= ((uint32_t) * (data + size_bytes - 1U) << ((size_bytes - 1U) * (8U)));
            size_bytes--;
        }

        result = SEMC_SendIPCommand(base, kSEMC_MemType_NOR, address, (uint16_t)kSEMC_NORDBICM_Write, tempData, 0);
    }
    (void)SEMC_ConfigureIPCommand(base, dataSize);
