# 1 "../../libraries/components/usb/usb_cdc_adapter/usb_device_cdc_acm.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/components/usb/usb_cdc_adapter/usb_device_cdc_acm.c" 2
...
# 10 "../../libraries/components/usb/usb_cdc_adapter/usb_device_cdc_acm.c" 2
...
# 11 "../../libraries/components/usb/usb_cdc_adapter/usb_device_cdc_acm.c" 2

# 1 "../../libraries/components/usb/usb_cdc_adapter/usb_device_config.h" 1
# 13 "../../libraries/components/usb/usb_cdc_adapter/usb_device_cdc_acm.c" 2
...
# 14 "../../libraries/components/usb/usb_cdc_adapter/usb_device_cdc_acm.c" 2
...
# 15 "../../libraries/components/usb/usb_cdc_adapter/usb_device_cdc_acm.c" 2
...
# 17 "../../libraries/components/usb/usb_cdc_adapter/usb_device_cdc_acm.c" 2
...
# 20 "../../libraries/components/usb/usb_cdc_adapter/usb_device_cdc_acm.c" 2
# 35 "../../libraries/components/usb/usb_cdc_adapter/usb_device_cdc_acm.c"
           __attribute__((aligned(4U))) static usb_device_cdc_acm_struct_t
    g_cdcAcmHandle[(1U)];
# 50 "../../libraries/components/usb/usb_cdc_adapter/usb_device_cdc_acm.c"
static usb_status_t USB_DeviceCdcAcmAllocateHandle(usb_device_cdc_acm_struct_t **handle)
{
    uint32_t count;
    for (count = 0U; count < (uint32_t)(1U); count++)
    {
        if (0 == g_cdcAcmHandle[count].handle)
        {
...
# 73 "../../libraries/components/usb/usb_cdc_adapter/usb_device_cdc_acm.c"
static usb_status_t USB_DeviceCdcAcmFreeHandle(usb_device_cdc_acm_struct_t *handle)
{
    handle->handle = 0;
    handle->configStruct = 0;
    handle->configuration = 0U;
    handle->alternate = 0U;
    return kStatus_USB_Success;
}
# 92 "../../libraries/components/usb/usb_cdc_adapter/usb_device_cdc_acm.c"
                                                ...
                                                void *callbackParam)
{
    ...
    if ((0 != cdcAcmHandle->configStruct) && (0 != cdcAcmHandle->configStruct->classCallback))
    {
...
# 126 "../../libraries/components/usb/usb_cdc_adapter/usb_device_cdc_acm.c"
...
# 161 "../../libraries/components/usb/usb_cdc_adapter/usb_device_cdc_acm.c"
...
# 194 "../../libraries/components/usb/usb_cdc_adapter/usb_device_cdc_acm.c"
static usb_status_t USB_DeviceCdcAcmEndpointsInit(usb_device_cdc_acm_struct_t *cdcAcmHandle)
{
    usb_device_interface_list_t *interfaceList;
    usb_device_interface_struct_t *interface = 0;
    usb_device_endpoint_callback_struct_t epCallback;
    usb_status_t error = kStatus_USB_Error;
    uint32_t count;
    uint32_t index;
    ...
    epCallback.callbackFn = (usb_device_endpoint_callback_t)0;
    ...
    {
        if ((0x02U) == interfaceList->interfaces[count].classCode)
        {
    ...
    for (count = 0U; count < interface->endpointList.count; count++)
    {
        ...
        if (((1U) == ((epInitStruct.endpointAddress & (0x80U)) >>
                        (7U))) &&
            ((0x03U) == epInitStruct.transferType))
        {
            cdcAcmHandle->interruptIn.ep = (epInitStruct.endpointAddress & (0x0FU));
            cdcAcmHandle->interruptIn.isBusy = 0U;
            cdcAcmHandle->interruptIn.pipeDataBuffer = (uint8_t *)(0xFFFFFFFEU);
    ...
    for (count = 0U; count < interfaceList->count; count++)
    {
        if ((0x0AU) == interfaceList->interfaces[count].classCode)
        {
            for (index = 0U; index < interfaceList->interfaces[count].count; index++)
            {
                if (interfaceList->interfaces[count].interface[index].alternateSetting == cdcAcmHandle->alternate)
    ...
    for (count = 0U; count < interface->endpointList.count; count++)
    {
        ...
        if (((1U) == ((epInitStruct.endpointAddress & (0x80U)) >>
                        (7U))) &&
            ((0x02U) == epInitStruct.transferType))
        {
            cdcAcmHandle->bulkIn.ep = (epInitStruct.endpointAddress & (0x0FU));
            cdcAcmHandle->bulkIn.isBusy = 0U;
            cdcAcmHandle->bulkIn.pipeDataBuffer = (uint8_t *)(0xFFFFFFFEU);
            cdcAcmHandle->bulkIn.pipeStall = 0U;
            cdcAcmHandle->bulkIn.pipeDataLen = 0U;
            epCallback.callbackFn = USB_DeviceCdcAcmBulkIn;
        }
        else if (((0U) == ((epInitStruct.endpointAddress & (0x80U)) >>
                              (7U))) &&
                 ((0x02U) == epInitStruct.transferType))
        {
            cdcAcmHandle->bulkOut.ep = (epInitStruct.endpointAddress & (0x0FU));
            cdcAcmHandle->bulkOut.isBusy = 0U;
            cdcAcmHandle->bulkOut.pipeDataBuffer = (uint8_t *)(0xFFFFFFFEU);
...
# 336 "../../libraries/components/usb/usb_cdc_adapter/usb_device_cdc_acm.c"
static usb_status_t USB_DeviceCdcAcmEndpointsDeinit(usb_device_cdc_acm_struct_t *cdcAcmHandle)
{
    usb_status_t status = kStatus_USB_Error;
    uint32_t count;

    if ((0 == cdcAcmHandle->commInterfaceHandle) || (0 == cdcAcmHandle->dataInterfaceHandle))
    {
        return status;
    }
    ...
    cdcAcmHandle->commInterfaceHandle = 0;
    cdcAcmHandle->dataInterfaceHandle = 0;

    return status;
}
# 373 "../../libraries/components/usb/usb_cdc_adapter/usb_device_cdc_acm.c"
usb_status_t USB_DeviceCdcAcmEvent(void *handle, uint32_t event, void *param)
{
    ...
    switch (eventCode)
    {
        ...
        case kUSB_DeviceClassEventSetConfiguration:
            temp8 = ((uint8_t *)param);
            if (0 == cdcAcmHandle->configStruct)
            {
                break;
            }
        ...
        case kUSB_DeviceClassEventSetEndpointHalt:
            if ((0 == cdcAcmHandle->configStruct) || (0 == cdcAcmHandle->commInterfaceHandle) ||
                (0 == cdcAcmHandle->dataInterfaceHandle))
            {
                break;
            }
            temp8 = ((uint8_t *)param);
            ...
            for (count = 0U; count < cdcAcmHandle->commInterfaceHandle->endpointList.count; count++)
            {
                if (*temp8 == cdcAcmHandle->commInterfaceHandle->endpointList.endpoint[count].endpointAddress)
                {
                                   ...
                                   (7U)))
                    {
                        ...
                        {
                            cdcAcmHandle->interruptIn.pipeStall = 0U;
                            if ((uint8_t *)(0xFFFFFFFEU) != cdcAcmHandle->interruptIn.pipeDataBuffer)
                            {
...
# 517 "../../libraries/components/usb/usb_cdc_adapter/usb_device_cdc_acm.c"
            ...
            for (count = 0U; count < cdcAcmHandle->dataInterfaceHandle->endpointList.count; count++)
            {
                if (*temp8 == cdcAcmHandle->dataInterfaceHandle->endpointList.endpoint[count].endpointAddress)
                {
                                   ...
                                   (7U)))
                    {
                        ...
                        {
                            cdcAcmHandle->bulkIn.pipeStall = 0U;
                            if ((uint8_t *)(0xFFFFFFFEU) != cdcAcmHandle->bulkIn.pipeDataBuffer)
                            {
                                ...
                                if (kStatus_USB_Success != error)
                                {
                                    ...
                                    endpointCallbackMessage.isSetup = 0U;
# 558 "../../libraries/components/usb/usb_cdc_adapter/usb_device_cdc_acm.c"
                                    (void)USB_DeviceCdcAcmBulkIn(cdcAcmHandle->handle, (void *)&endpointCallbackMessage,
                                                                 handle);
                    ...
                    else
                    {
                        ...
                        {
                            cdcAcmHandle->bulkOut.pipeStall = 0U;
                            if ((uint8_t *)(0xFFFFFFFEU) != cdcAcmHandle->bulkOut.pipeDataBuffer)
                            {
                                ...
                                if (kStatus_USB_Success != error)
                                {
                                    ...
                                    endpointCallbackMessage.isSetup = 0U;
# 591 "../../libraries/components/usb/usb_cdc_adapter/usb_device_cdc_acm.c"
...

        {
            ...
            if ((controlRequest->setup->bmRequestType & (0x1FU)) !=
                (0x01U))
            {
                break;
            }
            ...
            {
                case (0x00U):
                    if (((controlRequest->setup->bmRequestType & (0x80U)) ==
                         (0x00U)) &&
...
# 754 "../../libraries/components/usb/usb_cdc_adapter/usb_device_cdc_acm.c"
...
# 817 "../../libraries/components/usb/usb_cdc_adapter/usb_device_cdc_acm.c"
...
# 871 "../../libraries/components/usb/usb_cdc_adapter/usb_device_cdc_acm.c"
...
# 933 "../../libraries/components/usb/usb_cdc_adapter/usb_device_cdc_acm.c"
