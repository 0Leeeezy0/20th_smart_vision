# 1 "../../libraries/components/usb/phy/usb_phy.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/components/usb/phy/usb_phy.c" 2
...
# 10 "../../libraries/components/usb/phy/usb_phy.c" 2
...
# 13 "../../libraries/components/usb/phy/usb_phy.c" 2
...
void *USB_EhciPhyGetBase(uint8_t controllerId)
{
    ...
    uint32_t usbphy_base_temp[] = { 0u, (0x400D9000u), (0x400DA000u) };
    uint32_t usbphy_base[] = { 0u, (0x400D9000u), (0x400DA000u) };
    uint32_t *temp;
...
# 75 "../../libraries/components/usb/phy/usb_phy.c"
...
# 96 "../../libraries/components/usb/phy/usb_phy.c"
    ((USB_ANALOG_Type *)(0x400D8000u))->INSTANCE[controllerId - (uint8_t)kUSB_ControllerEhci0].CHRG_DETECT_SET =
        (((uint32_t)(((uint32_t)(1)) << (19U))) & (0x80000U)) | (((uint32_t)(((uint32_t)(1)) << (20U))) & (0x100000U));
    ...
    usbPhyBase->CTRL |= (0x4000U);
    usbPhyBase->CTRL |= (0x8000U);
    ...
    {
        usbPhyBase->CTRL_SET = (0x80000U);
        usbPhyBase->CTRL_SET = (0x100000U);
    }
    if (0 != phyConfig)
    {

        usbPhyBase->TX =
            ((usbPhyBase->TX & (~((0xFU) | (0xF00U) | (0xF0000U)))) |
             ((((uint32_t)(((uint32_t)(phyConfig->D_CAL)) << (0U))) & (0xFU)) | (((uint32_t)(((uint32_t)(phyConfig->TXCAL45DP)) << (16U))) & (0xF0000U)) |
              (((uint32_t)(((uint32_t)(phyConfig->TXCAL45DM)) << (8U))) & (0xF00U))));
    }


    return (uint8_t)kStatus_USB_Success;
}
# 140 "../../libraries/components/usb/phy/usb_phy.c"
...
# 158 "../../libraries/components/usb/phy/usb_phy.c"
    usbPhyBase->CTRL |= (0x40000U);

    usbPhyBase->CTRL |= (0x80000U) | (0x100000U);
    usbPhyBase->CTRL |= (0x4000U);
    usbPhyBase->CTRL |= (0x8000U);

    usbPhyBase->PWD = 0U;
# 179 "../../libraries/components/usb/phy/usb_phy.c"
    if (0 != phyConfig)
    {
...
# 199 "../../libraries/components/usb/phy/usb_phy.c"
void USB_EhciPhyDeinit(uint8_t controllerId)
{
    ...
    usbPhyBase->CTRL |= (0x40000000U);

}
# 227 "../../libraries/components/usb/phy/usb_phy.c"
