# 1 "../../libraries/sdk/drives/fsl_qtmr.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/sdk/drives/fsl_qtmr.c" 2
...
# 10 "../../libraries/sdk/drives/fsl_qtmr.h"
...
# 11 "../../libraries/sdk/drives/fsl_qtmr.h" 2
...
# 9 "../../libraries/sdk/drives/fsl_qtmr.c" 2
# 25 "../../libraries/sdk/drives/fsl_qtmr.c"
...
static TMR_Type *const s_qtmrBases[] = { (TMR_Type *)0u, ((TMR_Type *)(0x401DC000u)), ((TMR_Type *)(0x401E0000u)), ((TMR_Type *)(0x401E4000u)), ((TMR_Type *)(0x401E8000u)) };



static const clock_ip_name_t s_qtmrClocks[] = { kCLOCK_IpInvalid, kCLOCK_Timer1, kCLOCK_Timer2, kCLOCK_Timer3, kCLOCK_Timer4 };
...
static uint32_t QTMR_GetInstance(TMR_Type *base)
{
    ...
    for (instance = 0; instance < (sizeof(s_qtmrBases) / sizeof((s_qtmrBases)[0])); instance++)
    {
    ...
    ((instance < (sizeof(s_qtmrBases) / sizeof((s_qtmrBases)[0]))) ? (void)0 : __aeabi_assert("instance < ARRAY_SIZE(s_qtmrBases)", "../../libraries/sdk/drives/fsl_qtmr.c", 54),
# 54 "../../libraries/sdk/drives/fsl_qtmr.c"
#pragma clang diagnostic push
# 54 "../../libraries/sdk/drives/fsl_qtmr.c"
#pragma clang diagnostic ignored "-Wassume"
# 54 "../../libraries/sdk/drives/fsl_qtmr.c"
    (__builtin_assume)((instance < (sizeof(s_qtmrBases) / sizeof((s_qtmrBases)[0])))?1:0)
# 54 "../../libraries/sdk/drives/fsl_qtmr.c"
#pragma clang diagnostic pop
# 54 "../../libraries/sdk/drives/fsl_qtmr.c"
    );
...
# 68 "../../libraries/sdk/drives/fsl_qtmr.c"
void QTMR_Init(TMR_Type *base, qtmr_channel_selection_t channel, const qtmr_config_t *config)
{
    ((0 != config) ? (void)0 : __aeabi_assert("NULL != config", "../../libraries/sdk/drives/fsl_qtmr.c", 70),
# 70 "../../libraries/sdk/drives/fsl_qtmr.c"
#pragma clang diagnostic push
# 70 "../../libraries/sdk/drives/fsl_qtmr.c"
#pragma clang diagnostic ignored "-Wassume"
# 70 "../../libraries/sdk/drives/fsl_qtmr.c"
...
# 70 "../../libraries/sdk/drives/fsl_qtmr.c"
    ...
    base->CHANNEL[channel].CTRL = ((((uint16_t)(((uint16_t)(config->primarySource)) << (9U))) & (0x1E00U)) | (((uint16_t)(((uint16_t)(config->secondarySource)) << (7U))) & (0x180U)));


    base->CHANNEL[channel].SCTRL =
        ((((uint16_t)(((uint16_t)(config->enableExternalForce)) << (4U))) & (0x10U)) | (((uint16_t)(((uint16_t)(config->enableMasterMode)) << (5U))) & (0x20U)));


    base->CHANNEL[channel].CSCTRL = (((uint16_t)(((uint16_t)(config->debugMode)) << (14U))) & (0xC000U));

    base->CHANNEL[channel].FILT &= (uint16_t)(~((0x700U) | (0xFFU)));

    base->CHANNEL[channel].FILT =
        ((((uint16_t)(((uint16_t)(config->faultFilterCount)) << (8U))) & (0x700U)) | (((uint16_t)(((uint16_t)(config->faultFilterPeriod)) << (0U))) & (0xFFU)));
}
...
# 125 "../../libraries/sdk/drives/fsl_qtmr.c"
void QTMR_GetDefaultConfig(qtmr_config_t *config)
{
    ((0 != config) ? (void)0 : __aeabi_assert("NULL != config", "../../libraries/sdk/drives/fsl_qtmr.c", 127),
# 127 "../../libraries/sdk/drives/fsl_qtmr.c"
#pragma clang diagnostic push
# 127 "../../libraries/sdk/drives/fsl_qtmr.c"
#pragma clang diagnostic ignored "-Wassume"
# 127 "../../libraries/sdk/drives/fsl_qtmr.c"
...
# 127 "../../libraries/sdk/drives/fsl_qtmr.c"
    ...
    config->enableExternalForce = 0;

    config->enableMasterMode = 0;
...
# 165 "../../libraries/sdk/drives/fsl_qtmr.c"
status_t QTMR_SetupPwm(TMR_Type *base,
                       qtmr_channel_selection_t channel,
                       uint32_t pwmFreqHz,
                       uint8_t dutyCyclePercent,
                       ...
                       uint32_t srcClock_Hz)
{
    ...
    if (dutyCyclePercent <= 100U)
    {
        ...
        base->CHANNEL[channel].SCTRL |= ((0x4U) | (0x1U));
        ...
        ((highCount <= 0xFFFFU) ? (void)0 : __aeabi_assert("highCount <= 0xFFFFU", "../../libraries/sdk/drives/fsl_qtmr.c", 196),
# 196 "../../libraries/sdk/drives/fsl_qtmr.c"
#pragma clang diagnostic push
# 196 "../../libraries/sdk/drives/fsl_qtmr.c"
#pragma clang diagnostic ignored "-Wassume"
# 196 "../../libraries/sdk/drives/fsl_qtmr.c"
        (__builtin_assume)((highCount <= 0xFFFFU)?1:0)
# 196 "../../libraries/sdk/drives/fsl_qtmr.c"
#pragma clang diagnostic pop
# 196 "../../libraries/sdk/drives/fsl_qtmr.c"
        );
        ((lowCount <= 0xFFFFU) ? (void)0 : __aeabi_assert("lowCount <= 0xFFFFU", "../../libraries/sdk/drives/fsl_qtmr.c", 197),
# 197 "../../libraries/sdk/drives/fsl_qtmr.c"
#pragma clang diagnostic push
# 197 "../../libraries/sdk/drives/fsl_qtmr.c"
#pragma clang diagnostic ignored "-Wassume"
# 197 "../../libraries/sdk/drives/fsl_qtmr.c"
        (__builtin_assume)((lowCount <= 0xFFFFU)?1:0)
# 197 "../../libraries/sdk/drives/fsl_qtmr.c"
#pragma clang diagnostic pop
# 197 "../../libraries/sdk/drives/fsl_qtmr.c"
        );
        ...
        reg &= (uint16_t)(~((0x3U) | (0xCU)));
        reg |= ((((uint16_t)(((uint16_t)(kQTMR_LoadOnComp2)) << (0U))) & (0x3U)) | (((uint16_t)(((uint16_t)(kQTMR_LoadOnComp1)) << (2U))) & (0xCU)));
        base->CHANNEL[channel].CSCTRL = reg;

        if (outputPolarity)
        {

            base->CHANNEL[channel].SCTRL |= (0x2U);
        }
        else
        {

            base->CHANNEL[channel].SCTRL &= ~(uint16_t)(0x2U);
        }
        ...
        reg |= ((0x20U) | (((uint16_t)(((uint16_t)(kQTMR_ToggleOnAltCompareReg)) << (0U))) & (0x7U)));
        base->CHANNEL[channel].CTRL = reg;
...
# 257 "../../libraries/sdk/drives/fsl_qtmr.c"
void QTMR_SetupInputCapture(TMR_Type *base,
                            qtmr_channel_selection_t channel,
                            qtmr_input_source_t capturePin,
                            _Bool inputPolarity,
                            ...
                            qtmr_input_capture_edge_t captureMode)
{
    ...
    reg = base->CHANNEL[channel].CTRL & (uint16_t)(~(0x180U));


    reg |= (((uint16_t)(((uint16_t)(capturePin)) << (7U))) & (0x180U));
    base->CHANNEL[channel].CTRL = reg;


    reg = base->CHANNEL[channel].SCTRL &
          (uint16_t)(~((0x200U) | (0xC0U) | (0x1U)));

    reg |= ((((uint16_t)(((uint16_t)(inputPolarity)) << (9U))) & (0x200U)) | (((uint16_t)(((uint16_t)(captureMode)) << (6U))) & (0xC0U)));
    base->CHANNEL[channel].SCTRL = reg;


    if (reloadOnCapture)
    {
        base->CHANNEL[channel].CSCTRL |= (0x800U);
    }
    else
    {
        base->CHANNEL[channel].CSCTRL &= (uint16_t)(~(0x800U));
    }
}
# 299 "../../libraries/sdk/drives/fsl_qtmr.c"
void QTMR_EnableInterrupts(TMR_Type *base, qtmr_channel_selection_t channel, uint32_t mask)
{
    uint16_t reg;
    ...
    if ((mask & (uint16_t)kQTMR_EdgeInterruptEnable) != 0UL)
    {
        ...
        base->CHANNEL[channel].DMA &= ~(uint16_t)(0x1U);
        reg |= (0x400U);
    }
    base->CHANNEL[channel].SCTRL = reg;
...
# 345 "../../libraries/sdk/drives/fsl_qtmr.c"
void QTMR_DisableInterrupts(TMR_Type *base, qtmr_channel_selection_t channel, uint32_t mask)
{
    uint16_t reg;
    ...
    if ((mask & (uint16_t)kQTMR_CompareInterruptEnable) != 0UL)
    {
        reg &= (uint16_t)(~(0x4000U));
    }

    if ((mask & (uint16_t)kQTMR_OverflowInterruptEnable) != 0UL)
    {
        reg &= (uint16_t)(~(0x1000U));
    }
...
# 390 "../../libraries/sdk/drives/fsl_qtmr.c"
uint32_t QTMR_GetEnabledInterrupts(TMR_Type *base, qtmr_channel_selection_t channel)
{
...
# 436 "../../libraries/sdk/drives/fsl_qtmr.c"
uint32_t QTMR_GetStatus(TMR_Type *base, qtmr_channel_selection_t channel)
{
...
# 481 "../../libraries/sdk/drives/fsl_qtmr.c"
void QTMR_ClearStatusFlags(TMR_Type *base, qtmr_channel_selection_t channel, uint32_t mask)
{
    uint16_t reg;
...
# 535 "../../libraries/sdk/drives/fsl_qtmr.c"
void QTMR_SetTimerPeriod(TMR_Type *base, qtmr_channel_selection_t channel, uint16_t ticks)
{

    base->CHANNEL[channel].CTRL |= (0x20U);


    base->CHANNEL[channel].LOAD &= (uint16_t)(~(0xFFFFU));

    if ((base->CHANNEL[channel].CTRL & (0x10U)) != 0U)
    {
...
# 564 "../../libraries/sdk/drives/fsl_qtmr.c"
void QTMR_SetCompareValue(TMR_Type *base, qtmr_channel_selection_t channel, uint16_t ticks)
{
    base->CHANNEL[channel].CTRL |= (0x20U);
...
# 588 "../../libraries/sdk/drives/fsl_qtmr.c"
void QTMR_EnableDma(TMR_Type *base, qtmr_channel_selection_t channel, uint32_t mask)
{
    uint16_t reg;
    ...
    if ((mask & (uint32_t)kQTMR_InputEdgeFlagDmaEnable) != 0U)
    {
        ...
        base->CHANNEL[channel].SCTRL &= (uint16_t)(~(0x400U));
        reg |= (0x1U);
    }
...
# 621 "../../libraries/sdk/drives/fsl_qtmr.c"
void QTMR_DisableDma(TMR_Type *base, qtmr_channel_selection_t channel, uint32_t mask)
{
    uint16_t reg;
