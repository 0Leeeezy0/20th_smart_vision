# 1 "../../libraries/zf_common/zf_common_interrupt.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/zf_common/zf_common_interrupt.c" 2
# 36 "../../libraries/zf_common/zf_common_interrupt.c"
# 1 "../../libraries/zf_common/zf_common_interrupt.h" 1
# 40 "../../libraries/zf_common/zf_common_interrupt.h"
...
# 41 "../../libraries/zf_common/zf_common_interrupt.h" 2
...
# 37 "../../libraries/zf_common/zf_common_interrupt.c" 2


static uint32 interrupt_nest_count = 0;
# 48 "../../libraries/zf_common/zf_common_interrupt.c"
void interrupt_global_enable (uint32 primask)
{
...
# 64 "../../libraries/zf_common/zf_common_interrupt.c"
uint32 interrupt_global_disable (void)
{
    interrupt_nest_count++;
    return DisableGlobalIRQ();
}
# 77 "../../libraries/zf_common/zf_common_interrupt.c"
void interrupt_enable (IRQn_Type irqn)
{
    EnableIRQ(irqn);
}
# 89 "../../libraries/zf_common/zf_common_interrupt.c"
void interrupt_disable (IRQn_Type irqn)
{
    DisableIRQ(irqn);
}
# 102 "../../libraries/zf_common/zf_common_interrupt.c"
void interrupt_set_priority (IRQn_Type irqn, uint8 priority)
{
    __NVIC_SetPriority(irqn, priority);
}
# 114 "../../libraries/zf_common/zf_common_interrupt.c"
void interrupt_init (void)
{
