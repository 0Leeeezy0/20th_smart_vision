# 1 "../../libraries/sdk/drives/fsl_pwm.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/sdk/drives/fsl_pwm.c" 2
...
# 1 "../../libraries/sdk/drives/fsl_pwm.h" 1
# 11 "../../libraries/sdk/drives/fsl_pwm.h"
...
# 12 "../../libraries/sdk/drives/fsl_pwm.h" 2
# 31 "../../libraries/sdk/drives/fsl_pwm.h"
...
# 348 "../../libraries/sdk/drives/fsl_pwm.h"
...
# 454 "../../libraries/sdk/drives/fsl_pwm.h"
void PWM_GetDefaultConfig(pwm_config_t *config);
# 481 "../../libraries/sdk/drives/fsl_pwm.h"
...
# 504 "../../libraries/sdk/drives/fsl_pwm.h"
void PWM_UpdatePwmDutycycle(PWM_Type *base,
                            pwm_submodule_t subModule,
                            pwm_channels_t pwmSignal,
                            pwm_mode_t currPwmMode,
                            uint8_t dutyCyclePercent);
# 525 "../../libraries/sdk/drives/fsl_pwm.h"
...
# 541 "../../libraries/sdk/drives/fsl_pwm.h"
...
# 668 "../../libraries/sdk/drives/fsl_pwm.h"
                                              ...
                                              pwm_dma_source_select_t pwm_dma_source_select)
{
    ...
    reg &= ~((uint16_t)(0xC0U));
    reg |= (((uint16_t)pwm_dma_source_select << (uint16_t)(6U)) & (uint16_t)(0xC0U));

    base->SM[subModule].DMAEN = reg;
}
# 689 "../../libraries/sdk/drives/fsl_pwm.h"
static inline void PWM_EnableDMACapture(PWM_Type *base, pwm_submodule_t subModule, uint16_t mask, _Bool activate)
{
    uint16_t reg = base->SM[subModule].DMAEN;
    if (activate)
    {
...
# 710 "../../libraries/sdk/drives/fsl_pwm.h"
static inline void PWM_EnableDMAWrite(PWM_Type *base, pwm_submodule_t subModule, _Bool activate)
{
    uint16_t reg = base->SM[subModule].DMAEN;
    if (activate)
    {
...
# 828 "../../libraries/sdk/drives/fsl_pwm.h"
static inline void PWM_ActivateOutputTrigger(PWM_Type *base, pwm_submodule_t subModule, uint16_t valueRegisterMask)
{
    base->SM[subModule].TCTRL |= ((0x3FU) & (valueRegisterMask));
}
# 843 "../../libraries/sdk/drives/fsl_pwm.h"
static inline void PWM_DeactivateOutputTrigger(PWM_Type *base, pwm_submodule_t subModule, uint16_t valueRegisterMask)
{
    base->SM[subModule].TCTRL &= ~((0x3FU) & (valueRegisterMask));
}
# 859 "../../libraries/sdk/drives/fsl_pwm.h"
static inline void PWM_SetupSwCtrlOut(PWM_Type *base, pwm_submodule_t subModule, pwm_channels_t pwmChannel, _Bool value)
{
    if (value)
    {
        base->SWCOUT |=
            ((uint16_t)1U << (((uint16_t)subModule * (uint16_t)2) + (uint16_t)pwmChannel));
    }
    else
    {
        base->SWCOUT &=
...
# 886 "../../libraries/sdk/drives/fsl_pwm.h"
static inline void PWM_SetPwmLdok(PWM_Type *base, uint8_t subModulesToUpdate, _Bool value)
{
    if (value)
    {
        base->MCTRL |= (((uint16_t)(((uint16_t)(subModulesToUpdate)) << (0U))) & (0xFU));
    }
    else
    {
        base->MCTRL |= (((uint16_t)(((uint16_t)(subModulesToUpdate)) << (4U))) & (0xF0U));
    }
}
# 911 "../../libraries/sdk/drives/fsl_pwm.h"
                                        ...
                                        pwm_fault_state_t faultState)
{
    ...
    switch (pwmChannel)
    {
        case kPWM_PwmA:
            reg &= ~((uint16_t)(0x30U));
            reg |= (((uint16_t)faultState << (uint16_t)(4U)) & (uint16_t)(0x30U));
            break;
        case kPWM_PwmB:
            reg &= ~((uint16_t)(0xCU));
            reg |= (((uint16_t)faultState << (uint16_t)(2U)) & (uint16_t)(0xCU));
            break;
        case kPWM_PwmX:
            reg &= ~((uint16_t)(0x3U));
            reg |= (((uint16_t)faultState << (uint16_t)(0U)) & (uint16_t)(0x3U));
            break;
        default:
            ((0) ? (void)0 : __aeabi_assert("false", "../../libraries/sdk/drives/fsl_pwm.h", 932),
# 932 "../../libraries/sdk/drives/fsl_pwm.h"
#pragma clang diagnostic push
# 932 "../../libraries/sdk/drives/fsl_pwm.h"
#pragma clang diagnostic ignored "-Wassume"
# 932 "../../libraries/sdk/drives/fsl_pwm.h"
...
# 953 "../../libraries/sdk/drives/fsl_pwm.h"
                                            ...
                                            uint16_t value)
{
    ...
    switch (pwmChannel)
    {
        case kPWM_PwmA:
            reg &= ~((uint16_t)(0xFU));
            reg |= (((uint16_t)(value) << (uint16_t)(0U)) & (uint16_t)(0xFU));
            break;
        case kPWM_PwmB:
            reg &= ~((uint16_t)(0xF0U));
            reg |= (((uint16_t)(value) << (uint16_t)(4U)) & (uint16_t)(0xF0U));
            break;
        case kPWM_PwmX:
            reg &= ~((uint16_t)(0xF00U));
            reg |= (((uint16_t)(value) << (uint16_t)(8U)) & (uint16_t)(0xF00U));
            break;
        default:
            ((0) ? (void)0 : __aeabi_assert("false", "../../libraries/sdk/drives/fsl_pwm.h", 975),
# 975 "../../libraries/sdk/drives/fsl_pwm.h"
#pragma clang diagnostic push
# 975 "../../libraries/sdk/drives/fsl_pwm.h"
#pragma clang diagnostic ignored "-Wassume"
# 975 "../../libraries/sdk/drives/fsl_pwm.h"
...
# 10 "../../libraries/sdk/drives/fsl_pwm.c" 2
# 26 "../../libraries/sdk/drives/fsl_pwm.c"
...
static PWM_Type *const s_pwmBases[] = { (PWM_Type *)0u, ((PWM_Type *)(0x403DC000u)), ((PWM_Type *)(0x403E0000u)), ((PWM_Type *)(0x403E4000u)), ((PWM_Type *)(0x403E8000u)) };



static const clock_ip_name_t s_pwmClocks[][(4U)] = { {kCLOCK_IpInvalid, kCLOCK_IpInvalid, kCLOCK_IpInvalid, kCLOCK_IpInvalid}, {kCLOCK_Pwm1, kCLOCK_Pwm1, kCLOCK_Pwm1, kCLOCK_Pwm1}, {kCLOCK_Pwm2, kCLOCK_Pwm2, kCLOCK_Pwm2, kCLOCK_Pwm2}, {kCLOCK_Pwm3, kCLOCK_Pwm3, kCLOCK_Pwm3, kCLOCK_Pwm3}, { kCLOCK_Pwm4, kCLOCK_Pwm4, kCLOCK_Pwm4, kCLOCK_Pwm4 } };
# 51 "../../libraries/sdk/drives/fsl_pwm.c"
...
static uint32_t PWM_GetInstance(PWM_Type *base)
{
    ...
    for (instance = 0; instance < (sizeof(s_pwmBases) / sizeof((s_pwmBases)[0])); instance++)
    {
    ...
    ((instance < (sizeof(s_pwmBases) / sizeof((s_pwmBases)[0]))) ? (void)0 : __aeabi_assert("instance < ARRAY_SIZE(s_pwmBases)", "../../libraries/sdk/drives/fsl_pwm.c", 75),
# 75 "../../libraries/sdk/drives/fsl_pwm.c"
#pragma clang diagnostic push
# 75 "../../libraries/sdk/drives/fsl_pwm.c"
#pragma clang diagnostic ignored "-Wassume"
# 75 "../../libraries/sdk/drives/fsl_pwm.c"
    (__builtin_assume)((instance < (sizeof(s_pwmBases) / sizeof((s_pwmBases)[0])))?1:0)
# 75 "../../libraries/sdk/drives/fsl_pwm.c"
#pragma clang diagnostic pop
# 75 "../../libraries/sdk/drives/fsl_pwm.c"
    );
...
# 91 "../../libraries/sdk/drives/fsl_pwm.c"
status_t PWM_Init(PWM_Type *base, pwm_submodule_t subModule, const pwm_config_t *config)
{
    ((config) ? (void)0 : __aeabi_assert("config", "../../libraries/sdk/drives/fsl_pwm.c", 93),
# 93 "../../libraries/sdk/drives/fsl_pwm.c"
#pragma clang diagnostic push
# 93 "../../libraries/sdk/drives/fsl_pwm.c"
#pragma clang diagnostic ignored "-Wassume"
# 93 "../../libraries/sdk/drives/fsl_pwm.c"
    (__builtin_assume)((config)?1:0)
# 93 "../../libraries/sdk/drives/fsl_pwm.c"
#pragma clang diagnostic pop
# 93 "../../libraries/sdk/drives/fsl_pwm.c"
    );
    ...
    reg &= ~(uint16_t)((0x3U) | (0x38U) | (0x300U) |
                       (0x2000U) | (0x4000U) | (0x8000U) | (0x4U));
    reg |= ((((uint16_t)(((uint16_t)(config->clockSource)) << (0U))) & (0x3U)) | (((uint16_t)(((uint16_t)(config->forceTrigger)) << (3U))) & (0x38U)) |
            (((uint16_t)(((uint16_t)(config->initializationControl)) << (8U))) & (0x300U)) | (((uint16_t)(((uint16_t)(config->enableDebugMode)) << (15U))) & (0x8000U)) |
            (((uint16_t)(((uint16_t)(config->enableWait)) << (14U))) & (0x4000U)) | (((uint16_t)(((uint16_t)(config->reloadSelect)) << (2U))) & (0x4U)));
    ...
    switch (config->pairOperation)
    {
        ...
        case kPWM_ComplementaryPwmA:
            base->MCTRL &= ~((uint16_t)1U << ((12U) + (uint16_t)subModule));
            break;
        case kPWM_ComplementaryPwmB:
            base->MCTRL |= ((uint16_t)1U << ((12U) + (uint16_t)subModule));
            break;
        default:
            ((0) ? (void)0 : __aeabi_assert("false", "../../libraries/sdk/drives/fsl_pwm.c", 141),
# 141 "../../libraries/sdk/drives/fsl_pwm.c"
#pragma clang diagnostic push
# 141 "../../libraries/sdk/drives/fsl_pwm.c"
#pragma clang diagnostic ignored "-Wassume"
# 141 "../../libraries/sdk/drives/fsl_pwm.c"
...
# 141 "../../libraries/sdk/drives/fsl_pwm.c"
    ...
    reg &= ~(uint16_t)((0x70U) | (0xF000U) | (0x4U));
    reg |= ((((uint16_t)(((uint16_t)(config->prescale)) << (4U))) & (0x70U)) | (((uint16_t)(((uint16_t)(config->reloadFrequency)) << (12U))) & (0xF000U)));
    ...
    switch (config->reloadLogic)
    {
        ...
        case kPWM_ReloadPwmHalfAndFullCycle:
            ...
            break;
        default:
            ((0) ? (void)0 : __aeabi_assert("false", "../../libraries/sdk/drives/fsl_pwm.c", 171),
# 171 "../../libraries/sdk/drives/fsl_pwm.c"
#pragma clang diagnostic push
# 171 "../../libraries/sdk/drives/fsl_pwm.c"
#pragma clang diagnostic ignored "-Wassume"
# 171 "../../libraries/sdk/drives/fsl_pwm.c"
...
# 171 "../../libraries/sdk/drives/fsl_pwm.c"
    ...
    {
        base->SM[subModule].CTRL2 |= (((uint16_t)(((uint16_t)(1U)) << (6U))) & (0x40U));
    }
...
void PWM_Deinit(PWM_Type *base, pwm_submodule_t subModule)
{
    ...
    base->MCTRL &= ~((uint16_t)1U << ((8U) + (uint16_t)subModule));
...
# 220 "../../libraries/sdk/drives/fsl_pwm.c"
void PWM_GetDefaultConfig(pwm_config_t *config)
{
    ((config) ? (void)0 : __aeabi_assert("config", "../../libraries/sdk/drives/fsl_pwm.c", 222),
# 222 "../../libraries/sdk/drives/fsl_pwm.c"
#pragma clang diagnostic push
# 222 "../../libraries/sdk/drives/fsl_pwm.c"
#pragma clang diagnostic ignored "-Wassume"
# 222 "../../libraries/sdk/drives/fsl_pwm.c"
...
# 270 "../../libraries/sdk/drives/fsl_pwm.c"
status_t PWM_SetupPwm(PWM_Type *base,
                      pwm_submodule_t subModule,
                      const pwm_signal_param_t *chnlParams,
                      uint8_t numOfChnls,
                      ...
                      uint32_t srcClock_Hz)
{
    ((chnlParams) ? (void)0 : __aeabi_assert("chnlParams", "../../libraries/sdk/drives/fsl_pwm.c", 278),
# 278 "../../libraries/sdk/drives/fsl_pwm.c"
#pragma clang diagnostic push
# 278 "../../libraries/sdk/drives/fsl_pwm.c"
#pragma clang diagnostic ignored "-Wassume"
# 278 "../../libraries/sdk/drives/fsl_pwm.c"
    (__builtin_assume)((chnlParams)?1:0)
# 278 "../../libraries/sdk/drives/fsl_pwm.c"
#pragma clang diagnostic pop
# 278 "../../libraries/sdk/drives/fsl_pwm.c"
    );
    ((pwmFreq_Hz) ? (void)0 : __aeabi_assert("pwmFreq_Hz", "../../libraries/sdk/drives/fsl_pwm.c", 279),
# 279 "../../libraries/sdk/drives/fsl_pwm.c"
#pragma clang diagnostic push
# 279 "../../libraries/sdk/drives/fsl_pwm.c"
#pragma clang diagnostic ignored "-Wassume"
# 279 "../../libraries/sdk/drives/fsl_pwm.c"
    (__builtin_assume)((pwmFreq_Hz)?1:0)
# 279 "../../libraries/sdk/drives/fsl_pwm.c"
#pragma clang diagnostic pop
# 279 "../../libraries/sdk/drives/fsl_pwm.c"
    );
    ((numOfChnls) ? (void)0 : __aeabi_assert("numOfChnls", "../../libraries/sdk/drives/fsl_pwm.c", 280),
# 280 "../../libraries/sdk/drives/fsl_pwm.c"
#pragma clang diagnostic push
# 280 "../../libraries/sdk/drives/fsl_pwm.c"
#pragma clang diagnostic ignored "-Wassume"
# 280 "../../libraries/sdk/drives/fsl_pwm.c"
    (__builtin_assume)((numOfChnls)?1:0)
# 280 "../../libraries/sdk/drives/fsl_pwm.c"
#pragma clang diagnostic pop
# 280 "../../libraries/sdk/drives/fsl_pwm.c"
    );
    ((srcClock_Hz) ? (void)0 : __aeabi_assert("srcClock_Hz", "../../libraries/sdk/drives/fsl_pwm.c", 281),
# 281 "../../libraries/sdk/drives/fsl_pwm.c"
#pragma clang diagnostic push
# 281 "../../libraries/sdk/drives/fsl_pwm.c"
#pragma clang diagnostic ignored "-Wassume"
# 281 "../../libraries/sdk/drives/fsl_pwm.c"
    (__builtin_assume)((srcClock_Hz)?1:0)
# 281 "../../libraries/sdk/drives/fsl_pwm.c"
#pragma clang diagnostic pop
# 281 "../../libraries/sdk/drives/fsl_pwm.c"
    );
    ...
    pwmClock = (srcClock_Hz / (1UL << ((base->SM[subModule].CTRL & (0x70U)) >> (4U))));
    ...
    for (i = 0; i < numOfChnls; i++)
    {
        ...
        switch (mode)
        {
            ...
            case kPWM_EdgeAligned:
                ...
                break;
            default:
                ((0) ? (void)0 : __aeabi_assert("false", "../../libraries/sdk/drives/fsl_pwm.c", 410),
# 410 "../../libraries/sdk/drives/fsl_pwm.c"
#pragma clang diagnostic push
# 410 "../../libraries/sdk/drives/fsl_pwm.c"
#pragma clang diagnostic ignored "-Wassume"
# 410 "../../libraries/sdk/drives/fsl_pwm.c"
...
# 410 "../../libraries/sdk/drives/fsl_pwm.c"
        ...
        {
            polarityShift = (10U);
            outputEnableShift = (8U);
            base->SM[subModule].DTCNT0 = (((uint16_t)(((uint16_t)(chnlParams->deadtimeValue)) << (0U))) & (0xFFFFU));
        }
        else
        {
            polarityShift = (9U);
            outputEnableShift = (4U);
            base->SM[subModule].DTCNT1 = (((uint16_t)(((uint16_t)(chnlParams->deadtimeValue)) << (0U))) & (0xFFFFU));
        }
        ...
        {
            case kPWM_PwmA:
                base->SM[subModule].OCTRL &= ~((uint16_t)(0x30U));
                base->SM[subModule].OCTRL |= (((uint16_t)(chnlParams->faultState) << (uint16_t)(4U)) &
                                              (uint16_t)(0x30U));
                break;
            case kPWM_PwmB:
                base->SM[subModule].OCTRL &= ~((uint16_t)(0xCU));
                base->SM[subModule].OCTRL |= (((uint16_t)(chnlParams->faultState) << (uint16_t)(2U)) &
                                              (uint16_t)(0xCU));
                break;
            case kPWM_PwmX:
                base->SM[subModule].OCTRL &= ~((uint16_t)(0x3U));
                base->SM[subModule].OCTRL |= (((uint16_t)(chnlParams->faultState) << (uint16_t)(0U)) &
                                              (uint16_t)(0x3U));
                break;
            default:
                ((0) ? (void)0 : __aeabi_assert("false", "../../libraries/sdk/drives/fsl_pwm.c", 448),
# 448 "../../libraries/sdk/drives/fsl_pwm.c"
#pragma clang diagnostic push
# 448 "../../libraries/sdk/drives/fsl_pwm.c"
#pragma clang diagnostic ignored "-Wassume"
# 448 "../../libraries/sdk/drives/fsl_pwm.c"
...
# 448 "../../libraries/sdk/drives/fsl_pwm.c"
        ...
        if ((_Bool)chnlParams->level == kPWM_HighTrue)
        {
...
# 486 "../../libraries/sdk/drives/fsl_pwm.c"
void PWM_UpdatePwmDutycycle(PWM_Type *base,
                            pwm_submodule_t subModule,
                            pwm_channels_t pwmSignal,
                            pwm_mode_t currPwmMode,
                            uint8_t dutyCyclePercent)
{
    ((dutyCyclePercent <= 100U) ? (void)0 : __aeabi_assert("dutyCyclePercent <= 100U", "../../libraries/sdk/drives/fsl_pwm.c", 492),
# 492 "../../libraries/sdk/drives/fsl_pwm.c"
#pragma clang diagnostic push
# 492 "../../libraries/sdk/drives/fsl_pwm.c"
#pragma clang diagnostic ignored "-Wassume"
# 492 "../../libraries/sdk/drives/fsl_pwm.c"
    (__builtin_assume)((dutyCyclePercent <= 100U)?1:0)
# 492 "../../libraries/sdk/drives/fsl_pwm.c"
#pragma clang diagnostic pop
# 492 "../../libraries/sdk/drives/fsl_pwm.c"
    );
    (((uint16_t)pwmSignal < 2U) ? (void)0 : __aeabi_assert("(uint16_t)pwmSignal < 2U", "../../libraries/sdk/drives/fsl_pwm.c", 493),
# 493 "../../libraries/sdk/drives/fsl_pwm.c"
#pragma clang diagnostic push
# 493 "../../libraries/sdk/drives/fsl_pwm.c"
#pragma clang diagnostic ignored "-Wassume"
# 493 "../../libraries/sdk/drives/fsl_pwm.c"
    (__builtin_assume)(((uint16_t)pwmSignal < 2U)?1:0)
# 493 "../../libraries/sdk/drives/fsl_pwm.c"
#pragma clang diagnostic pop
# 493 "../../libraries/sdk/drives/fsl_pwm.c"
    );
...
# 514 "../../libraries/sdk/drives/fsl_pwm.c"
void PWM_UpdatePwmDutycycleHighAccuracy(
    PWM_Type *base, pwm_submodule_t subModule, pwm_channels_t pwmSignal, pwm_mode_t currPwmMode, uint16_t dutyCycle)
{
    (((uint16_t)pwmSignal < 2U) ? (void)0 : __aeabi_assert("(uint16_t)pwmSignal < 2U", "../../libraries/sdk/drives/fsl_pwm.c", 517),
# 517 "../../libraries/sdk/drives/fsl_pwm.c"
#pragma clang diagnostic push
# 517 "../../libraries/sdk/drives/fsl_pwm.c"
#pragma clang diagnostic ignored "-Wassume"
# 517 "../../libraries/sdk/drives/fsl_pwm.c"
...
# 517 "../../libraries/sdk/drives/fsl_pwm.c"
    ...
    switch (currPwmMode)
    {
        ...
        case kPWM_EdgeAligned:
            ...
            break;
        default:
            ((0) ? (void)0 : __aeabi_assert("false", "../../libraries/sdk/drives/fsl_pwm.c", 594),
# 594 "../../libraries/sdk/drives/fsl_pwm.c"
#pragma clang diagnostic push
# 594 "../../libraries/sdk/drives/fsl_pwm.c"
#pragma clang diagnostic ignored "-Wassume"
# 594 "../../libraries/sdk/drives/fsl_pwm.c"
...
# 610 "../../libraries/sdk/drives/fsl_pwm.c"
void PWM_SetupInputCapture(PWM_Type *base,
                           pwm_submodule_t subModule,
                           pwm_channels_t pwmChannel,
                           const pwm_input_capture_param_t *inputCaptureParams)
{
    ...
    switch (pwmChannel)
    {
        case kPWM_PwmA:
            ...
            reg = ((((uint16_t)(((uint16_t)(inputCaptureParams->captureInputSel)) << (6U))) & (0x40U)) |
                   (((uint16_t)(((uint16_t)(inputCaptureParams->edge0)) << (2U))) & (0xCU)) | (((uint16_t)(((uint16_t)(inputCaptureParams->edge1)) << (4U))) & (0x30U)) |
                   (((uint16_t)(((uint16_t)(inputCaptureParams->enableOneShotCapture)) << (1U))) & (0x2U)) |
                   (((uint16_t)(((uint16_t)(inputCaptureParams->fifoWatermark)) << (8U))) & (0x300U)));
            ...
            base->SM[subModule].CAPTCOMPA = (((uint16_t)(((uint16_t)(inputCaptureParams->edgeCompareValue)) << (0U))) & (0xFFU));

            base->OUTEN &= ~((uint16_t)1U << ((8U) + (uint16_t)subModule));
            break;
        case kPWM_PwmB:
            ...
            base->SM[subModule].CAPTCOMPB = (((uint16_t)(((uint16_t)(inputCaptureParams->edgeCompareValue)) << (0U))) & (0xFFU));

            base->OUTEN &= ~((uint16_t)1U << ((4U) + (uint16_t)subModule));
            break;
        case kPWM_PwmX:
            reg = ((((uint16_t)(((uint16_t)(inputCaptureParams->captureInputSel)) << (6U))) & (0x40U)) |
                   (((uint16_t)(((uint16_t)(inputCaptureParams->edge0)) << (2U))) & (0xCU)) | (((uint16_t)(((uint16_t)(inputCaptureParams->edge1)) << (4U))) & (0x30U)) |
            ...
            base->SM[subModule].CAPTCOMPX = (((uint16_t)(((uint16_t)(inputCaptureParams->edgeCompareValue)) << (0U))) & (0xFFU));

            base->OUTEN &= ~((uint16_t)1U << ((0U) + (uint16_t)subModule));
            break;
        default:
            ((0) ? (void)0 : __aeabi_assert("false", "../../libraries/sdk/drives/fsl_pwm.c", 681),
# 681 "../../libraries/sdk/drives/fsl_pwm.c"
#pragma clang diagnostic push
# 681 "../../libraries/sdk/drives/fsl_pwm.c"
#pragma clang diagnostic ignored "-Wassume"
# 681 "../../libraries/sdk/drives/fsl_pwm.c"
...
void PWM_SetupFaultInputFilter(PWM_Type *base, const pwm_fault_input_filter_param_t *faultInputFilterParams)
{
    ((0 != faultInputFilterParams) ? (void)0 : __aeabi_assert("NULL != faultInputFilterParams", "../../libraries/sdk/drives/fsl_pwm.c", 694),
# 694 "../../libraries/sdk/drives/fsl_pwm.c"
#pragma clang diagnostic push
# 694 "../../libraries/sdk/drives/fsl_pwm.c"
#pragma clang diagnostic ignored "-Wassume"
# 694 "../../libraries/sdk/drives/fsl_pwm.c"
    (__builtin_assume)((0 != faultInputFilterParams)?1:0)
# 694 "../../libraries/sdk/drives/fsl_pwm.c"
#pragma clang diagnostic pop
# 694 "../../libraries/sdk/drives/fsl_pwm.c"
    );
    ...
    if (0U != (base->FFILT & (0xFFU)))
    {
        base->FFILT &= ~(uint16_t)((0xFFU));
    }

    base->FFILT = (uint16_t)((((uint16_t)(((uint16_t)(faultInputFilterParams->faultFilterPeriod)) << (0U))) & (0xFFU)) |
                             (((uint16_t)(((uint16_t)(faultInputFilterParams->faultFilterCount)) << (8U))) & (0x700U)) |
                             (((uint16_t)(((uint16_t)(faultInputFilterParams->faultGlitchStretch ? 1U : 0U)) << (15U))) & (0x8000U)));
}
# 716 "../../libraries/sdk/drives/fsl_pwm.c"
void PWM_SetupFaults(PWM_Type *base, pwm_fault_input_t faultNum, const pwm_fault_param_t *faultParams)
{
    ((faultParams) ? (void)0 : __aeabi_assert("faultParams", "../../libraries/sdk/drives/fsl_pwm.c", 718),
# 718 "../../libraries/sdk/drives/fsl_pwm.c"
#pragma clang diagnostic push
# 718 "../../libraries/sdk/drives/fsl_pwm.c"
#pragma clang diagnostic ignored "-Wassume"
# 718 "../../libraries/sdk/drives/fsl_pwm.c"
    (__builtin_assume)((faultParams)?1:0)
# 718 "../../libraries/sdk/drives/fsl_pwm.c"
#pragma clang diagnostic pop
# 718 "../../libraries/sdk/drives/fsl_pwm.c"
    );
    ...
    {
        reg |= ((uint16_t)1U << ((12U) + (uint16_t)faultNum));
    }
    else
    {
        reg &= ~((uint16_t)1U << ((12U) + (uint16_t)faultNum));
    ...
    if ((uint16_t)faultParams->faultClearingMode != 0U)
    {
        ...
        reg &= ~((uint16_t)1U << ((8U) + (uint16_t)faultNum));
        if (faultParams->faultClearingMode == kPWM_ManualSafety)
        {

            reg |= ((uint16_t)1U << ((4U) + (uint16_t)faultNum));
        }
        else
        {
    ...
    reg = base->FSTS;
    reg &= ~(((uint16_t)1U << ((4U) + (uint16_t)faultNum)) |
             ((uint16_t)1U << ((12U) + (uint16_t)faultNum)));
    ...
    switch (faultParams->recoverMode)
    {
        ...
        case kPWM_RecoverHalfAndFullCycle:
            ...
            break;
        default:
            ((0) ? (void)0 : __aeabi_assert("false", "../../libraries/sdk/drives/fsl_pwm.c", 786),
# 786 "../../libraries/sdk/drives/fsl_pwm.c"
#pragma clang diagnostic push
# 786 "../../libraries/sdk/drives/fsl_pwm.c"
#pragma clang diagnostic ignored "-Wassume"
# 786 "../../libraries/sdk/drives/fsl_pwm.c"
...
# 804 "../../libraries/sdk/drives/fsl_pwm.c"
void PWM_FaultDefaultConfig(pwm_fault_param_t *config)
{
    ((config) ? (void)0 : __aeabi_assert("config", "../../libraries/sdk/drives/fsl_pwm.c", 806),
# 806 "../../libraries/sdk/drives/fsl_pwm.c"
#pragma clang diagnostic push
# 806 "../../libraries/sdk/drives/fsl_pwm.c"
#pragma clang diagnostic ignored "-Wassume"
# 806 "../../libraries/sdk/drives/fsl_pwm.c"
...
# 806 "../../libraries/sdk/drives/fsl_pwm.c"
    ...
    config->enableCombinationalPath = 1;

    config->recoverMode = kPWM_NoRecovery;
}
# 832 "../../libraries/sdk/drives/fsl_pwm.c"
...
# 856 "../../libraries/sdk/drives/fsl_pwm.c"
void PWM_EnableInterrupts(PWM_Type *base, pwm_submodule_t subModule, uint32_t mask)
{

    base->SM[subModule].INTEN |= ((uint16_t)mask & 0xFFFFU);

    base->FCTRL |= ((uint16_t)(mask >> 16U) & (0xFU));
}
# 872 "../../libraries/sdk/drives/fsl_pwm.c"
void PWM_DisableInterrupts(PWM_Type *base, pwm_submodule_t subModule, uint32_t mask)
{
    base->SM[subModule].INTEN &= ~((uint16_t)mask & 0xFFFFU);
    base->FCTRL &= ~((uint16_t)(mask >> 16U) & (0xFU));
}
# 887 "../../libraries/sdk/drives/fsl_pwm.c"
uint32_t PWM_GetEnabledInterrupts(PWM_Type *base, pwm_submodule_t subModule)
{
    uint32_t enabledInterrupts;

    enabledInterrupts = base->SM[subModule].INTEN;
    enabledInterrupts |= (((uint32_t)base->FCTRL & (0xFU)) << 16UL);
    return enabledInterrupts;
}
# 905 "../../libraries/sdk/drives/fsl_pwm.c"
uint32_t PWM_GetStatusFlags(PWM_Type *base, pwm_submodule_t subModule)
{
    uint32_t statusFlags;

    statusFlags = base->SM[subModule].STS;
    statusFlags |= (((uint32_t)base->FSTS & (0xFU)) << 16UL);

    return statusFlags;
}
# 923 "../../libraries/sdk/drives/fsl_pwm.c"
void PWM_ClearStatusFlags(PWM_Type *base, pwm_submodule_t subModule, uint32_t mask)
{
    uint16_t reg;
