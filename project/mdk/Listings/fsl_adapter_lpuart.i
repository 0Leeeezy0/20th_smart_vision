# 1 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c" 2
...
# 10 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c" 2

# 1 "../../libraries/sdk/components/uart/fsl_adapter_uart.h" 1
# 126 "../../libraries/sdk/components/uart/fsl_adapter_uart.h"
...
typedef enum _hal_uart_status
{
    ...
    kStatus_HAL_UartTxBusy = ((((kStatusGroup_HAL_UART)*100L) + (1))),
    kStatus_HAL_UartRxBusy = ((((kStatusGroup_HAL_UART)*100L) + (2))),
    kStatus_HAL_UartTxIdle = ((((kStatusGroup_HAL_UART)*100L) + (3))),
    kStatus_HAL_UartRxIdle = ((((kStatusGroup_HAL_UART)*100L) + (4))),
    kStatus_HAL_UartBaudrateNotSupport =
        ((((kStatusGroup_HAL_UART)*100L) + (5))),
    kStatus_HAL_UartProtocolError = ((((kStatusGroup_HAL_UART)*100L) + (6))),



    kStatus_HAL_UartError = ((((kStatusGroup_HAL_UART)*100L) + (7))),
} hal_uart_status_t;
...
# 232 "../../libraries/sdk/components/uart/fsl_adapter_uart.h"
typedef void (*hal_uart_transfer_callback_t)(hal_uart_handle_t handle, hal_uart_status_t status, void *callbackParam);
# 249 "../../libraries/sdk/components/uart/fsl_adapter_uart.h"
typedef struct _hal_uart_transfer
{
    uint8_t *data;
    size_t dataSize;
} hal_uart_transfer_t;
# 299 "../../libraries/sdk/components/uart/fsl_adapter_uart.h"
hal_uart_status_t HAL_UartInit(hal_uart_handle_t handle, const hal_uart_config_t *config);
# 309 "../../libraries/sdk/components/uart/fsl_adapter_uart.h"
hal_uart_status_t HAL_UartDeinit(hal_uart_handle_t handle);
# 335 "../../libraries/sdk/components/uart/fsl_adapter_uart.h"
hal_uart_status_t HAL_UartReceiveBlocking(hal_uart_handle_t handle, uint8_t *data, size_t length);
# 352 "../../libraries/sdk/components/uart/fsl_adapter_uart.h"
hal_uart_status_t HAL_UartSendBlocking(hal_uart_handle_t handle, const uint8_t *data, size_t length);
# 794 "../../libraries/sdk/components/uart/fsl_adapter_uart.h"
hal_uart_status_t HAL_UartEnterLowpower(hal_uart_handle_t handle);
# 805 "../../libraries/sdk/components/uart/fsl_adapter_uart.h"
hal_uart_status_t HAL_UartExitLowpower(hal_uart_handle_t handle);
# 12 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c" 2
# 131 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c"
typedef struct _hal_uart_state
{
    uint8_t instance;
# 156 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c"
} hal_uart_state_t;
# 165 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c"
static LPUART_Type *const s_LpuartAdapterBase[] = { (LPUART_Type *)0u, ((LPUART_Type *)(0x40184000u)), ((LPUART_Type *)(0x40188000u)), ((LPUART_Type *)(0x4018C000u)), ((LPUART_Type *)(0x40190000u)), ((LPUART_Type *)(0x40194000u)), ((LPUART_Type *)(0x40198000u)), ((LPUART_Type *)(0x4019C000u)), ((LPUART_Type *)(0x401A0000u)) };
# 249 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c"
...
# 552 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c"
static hal_uart_status_t HAL_UartInitCommon(hal_uart_handle_t handle, const hal_uart_config_t *config)
{
    ...
    lpuartConfig.enableRx = (_Bool)config->enableRx;
    lpuartConfig.enableTx = (_Bool)config->enableTx;
# 583 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c"
    lpuartConfig.enableRxRTS = (_Bool)config->enableRxRTS;
    lpuartConfig.enableTxCTS = (_Bool)config->enableTxCTS;
    ...
    if ((int32_t)kStatus_Success != status)
    {
        uartStatus = HAL_UartGetStatus(status);
    }
...
hal_uart_status_t HAL_UartInit(hal_uart_handle_t handle, const hal_uart_config_t *config)
{
    ...
    hal_uart_status_t uartStatus;
    ((0 != handle) ? (void)0 : __aeabi_assert("NULL != handle", "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c", 608),
# 608 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c"
#pragma clang diagnostic push
# 608 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c"
#pragma clang diagnostic ignored "-Wassume"
# 608 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c"
...
# 608 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c"
    ...
    ((0 != config) ? (void)0 : __aeabi_assert("NULL != config", "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c", 609),
# 609 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c"
#pragma clang diagnostic push
# 609 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c"
#pragma clang diagnostic ignored "-Wassume"
# 609 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c"
...
# 609 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c"
    ...
    ((config->instance < (sizeof(s_LpuartAdapterBase) / sizeof(LPUART_Type *))) ? (void)0 : __aeabi_assert("config->instance < (sizeof(s_LpuartAdapterBase) / sizeof(LPUART_Type *))", "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c", 610),
# 610 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c"
#pragma clang diagnostic push
# 610 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c"
#pragma clang diagnostic ignored "-Wassume"
# 610 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c"
    (__builtin_assume)((config->instance < (sizeof(s_LpuartAdapterBase) / sizeof(LPUART_Type *)))?1:0)
# 610 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c"
#pragma clang diagnostic pop
# 610 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c"
    );
    ((0 != s_LpuartAdapterBase[config->instance]) ? (void)0 : __aeabi_assert("NULL != s_LpuartAdapterBase[config->instance]", "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c", 611),
# 611 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c"
#pragma clang diagnostic push
# 611 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c"
#pragma clang diagnostic ignored "-Wassume"
# 611 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c"
    (__builtin_assume)((0 != s_LpuartAdapterBase[config->instance])?1:0)
# 611 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c"
#pragma clang diagnostic pop
# 611 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c"
    );
    (((8U + (0U) * 16U + (0U) * 4U) >= sizeof(hal_uart_state_t)) ? (void)0 : __aeabi_assert("HAL_UART_HANDLE_SIZE >= sizeof(hal_uart_state_t)", "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c", 612),
# 612 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c"
#pragma clang diagnostic push
# 612 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c"
#pragma clang diagnostic ignored "-Wassume"
# 612 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c"
    (__builtin_assume)(((8U + (0U) * 16U + (0U) * 4U) >= sizeof(hal_uart_state_t))?1:0)
# 612 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c"
#pragma clang diagnostic pop
# 612 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c"
    );
...
# 653 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c"
    }
...
hal_uart_status_t HAL_UartDeinit(hal_uart_handle_t handle)
{
    ...
    ((0 != handle) ? (void)0 : __aeabi_assert("NULL != handle", "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c", 662),
# 662 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c"
#pragma clang diagnostic push
# 662 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c"
#pragma clang diagnostic ignored "-Wassume"
# 662 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c"
...
# 676 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c"
...
hal_uart_status_t HAL_UartReceiveBlocking(hal_uart_handle_t handle, uint8_t *data, size_t length)
{
    hal_uart_state_t *uartHandle;
    status_t status;
    ((0 != handle) ? (void)0 : __aeabi_assert("NULL != handle", "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c", 683),
# 683 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c"
#pragma clang diagnostic push
# 683 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c"
#pragma clang diagnostic ignored "-Wassume"
# 683 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c"
...
# 683 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c"
    ...
    ((0 != data) ? (void)0 : __aeabi_assert("NULL != data", "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c", 684),
# 684 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c"
#pragma clang diagnostic push
# 684 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c"
#pragma clang diagnostic ignored "-Wassume"
# 684 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c"
...
# 684 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c"
    ...
    ((length > 0U) ? (void)0 : __aeabi_assert("length > 0U", "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c", 685),
# 685 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c"
#pragma clang diagnostic push
# 685 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c"
#pragma clang diagnostic ignored "-Wassume"
# 685 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c"
    (__builtin_assume)((length > 0U)?1:0)
# 685 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c"
#pragma clang diagnostic pop
# 685 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c"
    );
...
hal_uart_status_t HAL_UartSendBlocking(hal_uart_handle_t handle, const uint8_t *data, size_t length)
{
    ...
    ((0 != handle) ? (void)0 : __aeabi_assert("NULL != handle", "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c", 698),
# 698 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c"
#pragma clang diagnostic push
# 698 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c"
#pragma clang diagnostic ignored "-Wassume"
# 698 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c"
...
# 698 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c"
    ...
    ((0 != data) ? (void)0 : __aeabi_assert("NULL != data", "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c", 699),
# 699 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c"
#pragma clang diagnostic push
# 699 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c"
#pragma clang diagnostic ignored "-Wassume"
# 699 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c"
...
# 699 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c"
    ...
    ((length > 0U) ? (void)0 : __aeabi_assert("length > 0U", "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c", 700),
# 700 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c"
#pragma clang diagnostic push
# 700 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c"
#pragma clang diagnostic ignored "-Wassume"
# 700 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c"
...
hal_uart_status_t HAL_UartEnterLowpower(hal_uart_handle_t handle)
{
    ((0 != handle) ? (void)0 : __aeabi_assert("NULL != handle", "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c", 711),
# 711 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c"
#pragma clang diagnostic push
# 711 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c"
#pragma clang diagnostic ignored "-Wassume"
# 711 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c"
...
hal_uart_status_t HAL_UartExitLowpower(hal_uart_handle_t handle)
{
# 757 "../../libraries/sdk/components/uart/fsl_adapter_lpuart.c"
    return kStatus_HAL_UartSuccess;
}
