# 1 "../../libraries/zf_device/zf_device_icm20602.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/zf_device/zf_device_icm20602.c" 2
# 57 "../../libraries/zf_device/zf_device_icm20602.c"
...
# 58 "../../libraries/zf_device/zf_device_icm20602.c" 2
...
# 59 "../../libraries/zf_device/zf_device_icm20602.c" 2
...
# 60 "../../libraries/zf_device/zf_device_icm20602.c" 2
...
# 61 "../../libraries/zf_device/zf_device_icm20602.c" 2
...
# 62 "../../libraries/zf_device/zf_device_icm20602.c" 2
...
# 64 "../../libraries/zf_device/zf_device_icm20602.c" 2

int16 icm20602_gyro_x = 0, icm20602_gyro_y = 0, icm20602_gyro_z = 0;
int16 icm20602_acc_x = 0, icm20602_acc_y = 0, icm20602_acc_z = 0;
float icm20602_transition_factor[2] = {4096, 16.4};
# 110 "../../libraries/zf_device/zf_device_icm20602.c"
...
# 124 "../../libraries/zf_device/zf_device_icm20602.c"
...
# 142 "../../libraries/zf_device/zf_device_icm20602.c"
...
# 157 "../../libraries/zf_device/zf_device_icm20602.c"
static uint8 icm20602_self_check (void)
{
    ...
    while(0x12 != dat)
    {
        ...
        dat = icm20602_read_register(( 0x75 ));
        system_delay_ms(10);
    }
    return return_state;
}
# 182 "../../libraries/zf_device/zf_device_icm20602.c"
void icm20602_get_acc (void)
{
    uint8 dat[6];

    icm20602_read_registers(( 0x3B ), dat, 6);
...
# 199 "../../libraries/zf_device/zf_device_icm20602.c"
void icm20602_get_gyro (void)
{
    uint8 dat[6];

    icm20602_read_registers(( 0x43 ), dat, 6);
...
# 216 "../../libraries/zf_device/zf_device_icm20602.c"
uint8 icm20602_init (void)
{
    ...
    gpio_init((C20), GPO, GPIO_HIGH, GPO_PUSH_PULL);
    ...
    do
    {
        if(icm20602_self_check())
        {
            ...
            (debug_log_handler((0), ("icm20602 self check error."), "../../libraries/zf_device/zf_device_icm20602.c", 237));
            return_state = 1;
            break;
        }

        icm20602_write_register(( 0x6B ), 0x80);
        system_delay_ms(2);

        do
        {
            val = icm20602_read_register(( 0x6B ));
            if(( 0x00FF ) < timeout_count ++)
            {



                (debug_log_handler((0), ("icm20602 reset error."), "../../libraries/zf_device/zf_device_icm20602.c", 253));
                return_state = 1;
                break;
            }
        }while(0x41 != val);
        ...
        icm20602_write_register(( 0x6B ), 0x01);
        icm20602_write_register(( 0x6C ), 0x00);
        icm20602_write_register(( 0x1A ), 0x01);
        icm20602_write_register(( 0x19 ), 0x07);
        ...
        switch(( ICM20602_ACC_SAMPLE_SGN_8G ))
        {
            default:
            {
                (debug_log_handler((0), ("ICM20602_ACC_SAMPLE_DEFAULT set error."), "../../libraries/zf_device/zf_device_icm20602.c", 277));
                return_state = 1;
            }break;
            case ICM20602_ACC_SAMPLE_SGN_2G:
            {
                icm20602_write_register(( 0x1C ), 0x00);
                icm20602_transition_factor[0] = 16384;
            }break;
            case ICM20602_ACC_SAMPLE_SGN_4G:
            {
                icm20602_write_register(( 0x1C ), 0x08);
                icm20602_transition_factor[0] = 8192;
            }break;
            case ICM20602_ACC_SAMPLE_SGN_8G:
            {
                icm20602_write_register(( 0x1C ), 0x10);
                icm20602_transition_factor[0] = 4096;
            }break;
            case ICM20602_ACC_SAMPLE_SGN_16G:
            {
                icm20602_write_register(( 0x1C ), 0x18);
        ...
        switch(( ICM20602_GYRO_SAMPLE_SGN_2000DPS ))
        {
            default:
            {
                (debug_log_handler((0), ("ICM20602_GYRO_SAMPLE_DEFAULT set error."), "../../libraries/zf_device/zf_device_icm20602.c", 315));
                return_state = 1;
            }break;
            case ICM20602_GYRO_SAMPLE_SGN_250DPS:
            {
                icm20602_write_register(( 0x1B ), 0x00);
                icm20602_transition_factor[1] = 131.0;
            }break;
            case ICM20602_GYRO_SAMPLE_SGN_500DPS:
            {
                icm20602_write_register(( 0x1B ), 0x08);
                icm20602_transition_factor[1] = 65.5;
            }break;
            case ICM20602_GYRO_SAMPLE_SGN_1000DPS:
            {
                icm20602_write_register(( 0x1B ), 0x10);
                icm20602_transition_factor[1] = 32.8;
            }break;
            case ICM20602_GYRO_SAMPLE_SGN_2000DPS:
            {
                icm20602_write_register(( 0x1B ), 0x18);
        ...
        icm20602_write_register(( 0x1D ), 0x03);
    }while(0);
    return return_state;
}
