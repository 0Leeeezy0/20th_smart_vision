# 1 "../../libraries/sdk/drives/fsl_gpc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/sdk/drives/fsl_gpc.c" 2
# 10 "../../libraries/sdk/drives/fsl_gpc.c"
# 1 "../../libraries/sdk/drives/fsl_gpc.h" 1
# 13 "../../libraries/sdk/drives/fsl_gpc.h"
...
# 14 "../../libraries/sdk/drives/fsl_gpc.h" 2
# 66 "../../libraries/sdk/drives/fsl_gpc.h"
...
# 83 "../../libraries/sdk/drives/fsl_gpc.h"
_Bool GPC_GetIRQStatusFlag(GPC_Type *base, uint32_t irqId);
# 124 "../../libraries/sdk/drives/fsl_gpc.h"
static inline void GPC_RequestPdram0PowerDown(GPC_Type *base, _Bool enable)
{
    if (enable)
    {
        base->CNTR |= (0x400000U);
...
# 209 "../../libraries/sdk/drives/fsl_gpc.h"
static inline void GPC_RequestMEGAPowerOn(GPC_Type *base, _Bool enable)
{
    if (enable)
    {
        base->CNTR |= (0x8U);
...
# 11 "../../libraries/sdk/drives/fsl_gpc.c" 2
# 23 "../../libraries/sdk/drives/fsl_gpc.c"
void GPC_EnableIRQ(GPC_Type *base, uint32_t irqId)
{
    uint32_t irqRegNum = irqId / 32U;
    uint32_t irqRegShiftNum = irqId % 32U;

    ((irqRegNum <= (4U)) ? (void)0 : __aeabi_assert("irqRegNum <= GPC_IMR_COUNT", "../../libraries/sdk/drives/fsl_gpc.c", 28),
# 28 "../../libraries/sdk/drives/fsl_gpc.c"
#pragma clang diagnostic push
# 28 "../../libraries/sdk/drives/fsl_gpc.c"
#pragma clang diagnostic ignored "-Wassume"
# 28 "../../libraries/sdk/drives/fsl_gpc.c"
    (__builtin_assume)((irqRegNum <= (4U))?1:0)
# 28 "../../libraries/sdk/drives/fsl_gpc.c"
#pragma clang diagnostic pop
# 28 "../../libraries/sdk/drives/fsl_gpc.c"
    );
...
void GPC_DisableIRQ(GPC_Type *base, uint32_t irqId)
{
    ...
    ((irqRegNum <= (4U)) ? (void)0 : __aeabi_assert("irqRegNum <= GPC_IMR_COUNT", "../../libraries/sdk/drives/fsl_gpc.c", 56),
# 56 "../../libraries/sdk/drives/fsl_gpc.c"
#pragma clang diagnostic push
# 56 "../../libraries/sdk/drives/fsl_gpc.c"
#pragma clang diagnostic ignored "-Wassume"
# 56 "../../libraries/sdk/drives/fsl_gpc.c"
...
# 80 "../../libraries/sdk/drives/fsl_gpc.c"
_Bool GPC_GetIRQStatusFlag(GPC_Type *base, uint32_t irqId)
{
    uint32_t irqRegNum = irqId / 32U;
    uint32_t irqRegShiftNum = irqId % 32U;
    ...
    ((irqRegNum <= (4U)) ? (void)0 : __aeabi_assert("irqRegNum <= GPC_IMR_COUNT", "../../libraries/sdk/drives/fsl_gpc.c", 86),
# 86 "../../libraries/sdk/drives/fsl_gpc.c"
#pragma clang diagnostic push
# 86 "../../libraries/sdk/drives/fsl_gpc.c"
#pragma clang diagnostic ignored "-Wassume"
# 86 "../../libraries/sdk/drives/fsl_gpc.c"
