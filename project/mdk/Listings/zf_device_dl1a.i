# 1 "../../libraries/zf_device/zf_device_dl1a.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/zf_device/zf_device_dl1a.c" 2
# 47 "../../libraries/zf_device/zf_device_dl1a.c"
...
# 48 "../../libraries/zf_device/zf_device_dl1a.c" 2
...
# 49 "../../libraries/zf_device/zf_device_dl1a.c" 2
# 1 "../../libraries/zf_driver\\zf_driver_soft_iic.h" 1
# 39 "../../libraries/zf_driver\\zf_driver_soft_iic.h"
...
# 40 "../../libraries/zf_driver\\zf_driver_soft_iic.h" 2
...
# 50 "../../libraries/zf_device/zf_device_dl1a.c" 2
...
# 51 "../../libraries/zf_device/zf_device_dl1a.c" 2
# 1 "../../libraries/zf_driver\\zf_driver_exti.h" 1
# 44 "../../libraries/zf_driver\\zf_driver_exti.h"
typedef enum{
    EXTI_TRIGGER_LOW = 1,
    EXTI_TRIGGER_HIGH,
    EXTI_TRIGGER_RISING,
...
# 52 "../../libraries/zf_device/zf_device_dl1a.c" 2
...
# 53 "../../libraries/zf_device/zf_device_dl1a.c" 2
...
# 94 "../../libraries/zf_device/zf_device_dl1a.c"
static uint8 dl1a_get_spad_info (uint8 *index, uint8 *type_is_aperture)
{
    ...
    do
    {
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x80), (0x01)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0xFF), (0x01)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x00), (0x00)));

        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0xFF), (0x06)));
        (soft_iic_read_8bit_registers(&dl1a_iic_struct, (0x83), (&tmp), (1)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x83), (tmp | 0x04)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0xFF), (0x07)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x81), (0x01)));

        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x80), (0x01)));

        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x94), (0x6b)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x83), (0x00)));
        ...
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x83), (0x01)));
        (soft_iic_read_8bit_registers(&dl1a_iic_struct, (0x92), (&tmp), (1)));

        *index = tmp & 0x7f;
        *type_is_aperture = (tmp >> 7) & 0x01;

        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x81), (0x00)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0xFF), (0x06)));
        (soft_iic_read_8bit_registers(&dl1a_iic_struct, (0x83), (&tmp), (1)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x83), (tmp)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0xFF), (0x01)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x00), (0x01)));

        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0xFF), (0x00)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x80), (0x00)));
    }while(0);

    return return_state;
}
# 161 "../../libraries/zf_device/zf_device_dl1a.c"
static uint32 dl1a_timeout_mclks_to_microseconds (uint16 timeout_period_mclks, uint8 vcsel_period_pclks)
{
    uint32 macro_period_ns = ((((uint32)2304 * (vcsel_period_pclks) * 1655) + 500) / 1000);

    return ((timeout_period_mclks * macro_period_ns) + (macro_period_ns / 2)) / 1000;
}
# 176 "../../libraries/zf_device/zf_device_dl1a.c"
...
# 190 "../../libraries/zf_device/zf_device_dl1a.c"
...
# 204 "../../libraries/zf_device/zf_device_dl1a.c"
...
# 231 "../../libraries/zf_device/zf_device_dl1a.c"
static void dl1a_get_sequence_step_enables(dl1a_sequence_enables_step_struct *enables)
{
    uint8 sequence_config = 0;
    (soft_iic_read_8bit_registers(&dl1a_iic_struct, (( 0x01 )), (&sequence_config), (1)));
...
# 278 "../../libraries/zf_device/zf_device_dl1a.c"
static void dl1a_get_sequence_step_timeouts (dl1a_sequence_enables_step_struct const *enables, dl1a_sequence_timeout_step_struct *timeouts)
{
    ...
    (soft_iic_read_8bit_registers(&dl1a_iic_struct, (( 0x46 )), (reg_buffer), (1)));
    ...
    (soft_iic_read_8bit_registers(&dl1a_iic_struct, (( 0x51 )), (reg_buffer), (2)));
    ...
    (soft_iic_read_8bit_registers(&dl1a_iic_struct, (( 0x71 )), (reg_buffer), (2)));
    reg16_buffer = ((uint16) reg_buffer[0] << 8) | reg_buffer[1];
...
# 315 "../../libraries/zf_device/zf_device_dl1a.c"
static uint8 dl1a_perform_single_ref_calibration (uint8 vhv_init_byte)
{
    ...
    do
    {
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (( 0x00 )), (0x01 | vhv_init_byte)));
        (soft_iic_read_8bit_registers(&dl1a_iic_struct, (( 0x46 )), (&data_buffer), (1)));
        ...
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (( 0x0B )), (0x01)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (( 0x00 )), (0x00)));
    }while(0);

    return return_state;
}
# 356 "../../libraries/zf_device/zf_device_dl1a.c"
static uint8 dl1a_set_measurement_timing_budget (uint32 budget_us)
{
    ...
    do
    {
        ...
        uint32 used_budget_us = ( 1320 ) + ( 960 );
        ...
        if(enables.final_range)
        {
            ...
            (soft_iic_write_8bit_array(&dl1a_iic_struct, (data_buffer), (3)));
        }
    }while(0);
    return return_state;
}
# 439 "../../libraries/zf_device/zf_device_dl1a.c"
...
# 488 "../../libraries/zf_device/zf_device_dl1a.c"
static void dl1a_set_signal_rate_limit (float limit_mcps)
{
    (debug_assert_handler((0 <= limit_mcps || 511.99 >= limit_mcps), "../../libraries/zf_device/zf_device_dl1a.c", 490));
    uint8 data_buffer[3];
...
# 508 "../../libraries/zf_device/zf_device_dl1a.c"
void dl1a_get_distance (void)
{
    uint8 reg_databuffer[3];

    (soft_iic_read_8bit_registers(&dl1a_iic_struct, (( 0x13 )), (reg_databuffer), (1)));
    if(0 != (reg_databuffer[0] & 0x07))
    {

        (soft_iic_read_8bit_registers(&dl1a_iic_struct, (( 0x14 ) + 10), (reg_databuffer), (2)));
...
# 537 "../../libraries/zf_device/zf_device_dl1a.c"
void dl1a_int_handler (void)
{

    if(((GPIO_GetPinsInterruptFlags(PORTPTR[( C20 )>>5]) >> (( C20 )&0x1f)) & 0x01))
    {
        (GPIO_ClearPinsInterruptFlags(PORTPTR[( C20 )>>5], (uint32)1<<(( C20 )&0x1f)));
        dl1a_get_distance();
    }


}
# 556 "../../libraries/zf_device/zf_device_dl1a.c"
uint8 dl1a_init (void)
{
    ...
    soft_iic_init(&dl1a_iic_struct, ( 0x52 >> 1 ), (100 ), (B9 ), (B10 ));
    ...
    {
        system_delay_ms(100);
        GPIO_ClearPinsOutput(PORTPTR[(D4) >> 5],1 << ((D4) & 0x1f));
        system_delay_ms(50);
        GPIO_SetPinsOutput(PORTPTR[(D4) >> 5],1 << ((D4) & 0x1f));
        system_delay_ms(100);


        reg_data_buffer = (soft_iic_read_8bit_register(&dl1a_iic_struct, (( 0x89 ))));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (( 0x89 )), (reg_data_buffer | 0x01)));

        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x88), (0x00)));

        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x80), (0x01)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0xFF), (0x01)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x00), (0x00)));

        (soft_iic_read_8bit_registers(&dl1a_iic_struct, (0x91), (&stop_variable), (1)));
        ...
        reg_data_buffer = (soft_iic_read_8bit_register(&dl1a_iic_struct, (( 0x60 ))));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (( 0x60 )), (reg_data_buffer | 0x12)));

        dl1a_set_signal_rate_limit((0.25));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (( 0x01 )), (0xFF)));
        ...
        {
            return_state = 1;
            (debug_log_handler((0), ("DL1A self check error."), "../../libraries/zf_device/zf_device_dl1a.c", 612));
            break;
        }


        (soft_iic_read_8bit_registers(&dl1a_iic_struct, (( 0xB0 )), (ref_spad_map), (6)));

        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0xFF), (0x01)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (( 0x4F )), (0x00)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (( 0x4E )), (0x2C)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0xFF), (0x00)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (( 0xB6 )), (0xB4)));
        ...
        (soft_iic_write_8bit_array(&dl1a_iic_struct, (data_buffer), (7)));


        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0xFF), (0x01)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x00), (0x00)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0xFF), (0x00)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x09), (0x00)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x10), (0x00)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x11), (0x00)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x24), (0x01)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x25), (0xFF)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x75), (0x00)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0xFF), (0x01)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x4E), (0x2C)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x48), (0x00)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x30), (0x20)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0xFF), (0x00)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x30), (0x09)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x54), (0x00)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x31), (0x04)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x32), (0x03)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x40), (0x83)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x46), (0x25)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x60), (0x00)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x27), (0x00)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x50), (0x06)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x51), (0x00)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x52), (0x96)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x56), (0x08)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x57), (0x30)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x61), (0x00)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x62), (0x00)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x64), (0x00)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x65), (0x00)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x66), (0xA0)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0xFF), (0x01)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x22), (0x32)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x47), (0x14)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x49), (0xFF)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x4A), (0x00)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0xFF), (0x00)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x7A), (0x0A)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x7B), (0x00)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x78), (0x21)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0xFF), (0x01)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x23), (0x34)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x42), (0x00)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x44), (0xFF)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x45), (0x26)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x46), (0x05)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x40), (0x40)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x0E), (0x06)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x20), (0x1A)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x43), (0x40)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0xFF), (0x00)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x34), (0x03)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x35), (0x44)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0xFF), (0x01)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x31), (0x04)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x4B), (0x09)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x4C), (0x05)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x4D), (0x04)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0xFF), (0x00)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x44), (0x00)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x45), (0x20)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x47), (0x08)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x48), (0x28)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x67), (0x00)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x70), (0x04)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x71), (0x01)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x72), (0xFE)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x76), (0x00)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x77), (0x00)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0xFF), (0x01)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x0D), (0x01)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0xFF), (0x00)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x80), (0x01)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x01), (0xF8)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0xFF), (0x01)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x8E), (0x01)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x00), (0x01)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0xFF), (0x00)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x80), (0x00)));


        (soft_iic_write_8bit_register(&dl1a_iic_struct, (( 0x0A )), (0x04)));
        reg_data_buffer = (soft_iic_read_8bit_register(&dl1a_iic_struct, (( 0x84 ))));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (( 0x84 )), (reg_data_buffer & ~0x10)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (( 0x0B )), (0x01)));
        ...
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (( 0x01 )), (0xE8)));
        dl1a_set_measurement_timing_budget(measurement_timing_budget_us);


        (soft_iic_write_8bit_register(&dl1a_iic_struct, (( 0x01 )), (0x01)));
        if(dl1a_perform_single_ref_calibration(0x40))
        {
            return_state = 1;
            (debug_log_handler((0), ("DL1A perform single reference calibration error."), "../../libraries/zf_device/zf_device_dl1a.c", 749));
            break;
        }
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (( 0x01 )), (0x02)));
        if(dl1a_perform_single_ref_calibration(0x00))
        {
            return_state = 1;
            (debug_log_handler((0), ("DL1A perform single reference calibration error."), "../../libraries/zf_device/zf_device_dl1a.c", 756));
            break;
        }
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (( 0x01 )), (0xE8)));
        ...
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0xFF), (0x01)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x00), (0x00)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x91), (stop_variable)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x00), (0x01)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0xFF), (0x00)));
        (soft_iic_write_8bit_register(&dl1a_iic_struct, (0x80), (0x00)));

        (soft_iic_write_8bit_register(&dl1a_iic_struct, (( 0x00 )), (0x02)));
    }while(0);


    set_tof_type(TOF_DL1A, dl1a_int_handler);
    exti_init(( C20 ), EXTI_TRIGGER_FALLING);
    dl1a_int_handler();
    dl1a_finsh_flag = 0;
