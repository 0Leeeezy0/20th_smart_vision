# 1 "../../libraries/sdk/drives/fsl_ewm.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/sdk/drives/fsl_ewm.c" 2
...
# 1 "../../libraries/sdk/drives/fsl_ewm.h" 1
# 11 "../../libraries/sdk/drives/fsl_ewm.h"
...
# 12 "../../libraries/sdk/drives/fsl_ewm.h" 2
# 30 "../../libraries/sdk/drives/fsl_ewm.h"
...
{
    _Bool enableEwm;
    _Bool enableEwmInput;
    _Bool setInputAssertLogic;
...
{
    kEWM_RunningFlag = (0x1U),
};
# 112 "../../libraries/sdk/drives/fsl_ewm.h"
void EWM_Init(EWM_Type *base, const ewm_config_t *config);
# 121 "../../libraries/sdk/drives/fsl_ewm.h"
void EWM_Deinit(EWM_Type *base);
# 142 "../../libraries/sdk/drives/fsl_ewm.h"
void EWM_GetDefaultConfig(ewm_config_t *config);
# 161 "../../libraries/sdk/drives/fsl_ewm.h"
static inline void EWM_EnableInterrupts(EWM_Type *base, uint32_t mask)
{
    base->CTRL |= (uint8_t)mask;
}
# 176 "../../libraries/sdk/drives/fsl_ewm.h"
static inline void EWM_DisableInterrupts(EWM_Type *base, uint32_t mask)
{
    base->CTRL &= (uint8_t)(~mask);
}
# 196 "../../libraries/sdk/drives/fsl_ewm.h"
static inline uint32_t EWM_GetStatusFlags(EWM_Type *base)
{
    return ((uint32_t)base->CTRL & (0x1U));
}
# 208 "../../libraries/sdk/drives/fsl_ewm.h"
void EWM_Refresh(EWM_Type *base);
# 10 "../../libraries/sdk/drives/fsl_ewm.c" 2
# 39 "../../libraries/sdk/drives/fsl_ewm.c"
void EWM_Init(EWM_Type *base, const ewm_config_t *config)
{
    ((0 != config) ? (void)0 : __aeabi_assert("NULL != config", "../../libraries/sdk/drives/fsl_ewm.c", 41),
# 41 "../../libraries/sdk/drives/fsl_ewm.c"
#pragma clang diagnostic push
# 41 "../../libraries/sdk/drives/fsl_ewm.c"
#pragma clang diagnostic ignored "-Wassume"
# 41 "../../libraries/sdk/drives/fsl_ewm.c"
...
# 41 "../../libraries/sdk/drives/fsl_ewm.c"
    ...
    value = (((uint8_t)(((uint8_t)(config->enableEwm)) << (0U))) & (0x1U)) | (((uint8_t)(((uint8_t)(config->setInputAssertLogic)) << (1U))) & (0x2U)) |
            (((uint8_t)(((uint8_t)(config->enableEwmInput)) << (2U))) & (0x4U)) | (((uint8_t)(((uint8_t)(config->enableInterrupt)) << (3U))) & (0x8U));
...
# 73 "../../libraries/sdk/drives/fsl_ewm.c"
void EWM_Deinit(EWM_Type *base)
{
...
# 103 "../../libraries/sdk/drives/fsl_ewm.c"
void EWM_GetDefaultConfig(ewm_config_t *config)
{
    ((0 != config) ? (void)0 : __aeabi_assert("NULL != config", "../../libraries/sdk/drives/fsl_ewm.c", 105),
# 105 "../../libraries/sdk/drives/fsl_ewm.c"
#pragma clang diagnostic push
# 105 "../../libraries/sdk/drives/fsl_ewm.c"
#pragma clang diagnostic ignored "-Wassume"
# 105 "../../libraries/sdk/drives/fsl_ewm.c"
...
# 105 "../../libraries/sdk/drives/fsl_ewm.c"
    ...
    config->enableEwm = 1;
    config->enableEwmInput = 0;
    config->setInputAssertLogic = 0;
...
# 131 "../../libraries/sdk/drives/fsl_ewm.c"
void EWM_Refresh(EWM_Type *base)
{
