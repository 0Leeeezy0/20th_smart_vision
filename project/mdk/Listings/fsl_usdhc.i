# 1 "../../libraries/sdk/drives/fsl_usdhc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/sdk/drives/fsl_usdhc.c" 2
...
# 11 "../../libraries/sdk/drives/fsl_usdhc.h"
...
# 12 "../../libraries/sdk/drives/fsl_usdhc.h" 2
...
# 10 "../../libraries/sdk/drives/fsl_usdhc.c" 2
# 35 "../../libraries/sdk/drives/fsl_usdhc.c"
...
{
    kUSDHC_CommandOnly = 1U,
    kUSDHC_CommandAndTxData = 2U,
    kUSDHC_CommandAndRxData = 4U,
    kUSDHC_DataWithAutoCmd12 = 8U,
    kUSDHC_DataWithAutoCmd23 = 16U,
    kUSDHC_BootData = 32U,
    kUSDHC_BootDataContinuous = 64U,
};
# 65 "../../libraries/sdk/drives/fsl_usdhc.c"
static uint32_t USDHC_GetInstance(USDHC_Type *base);
# 75 "../../libraries/sdk/drives/fsl_usdhc.c"
...
# 200 "../../libraries/sdk/drives/fsl_usdhc.c"
...
static USDHC_Type *const s_usdhcBase[] = { (USDHC_Type *)0u, ((USDHC_Type *)(0x402C0000u)), ((USDHC_Type *)(0x402C4000u)) };


static usdhc_handle_t *s_usdhcHandle[(sizeof(s_usdhcBase) / sizeof((s_usdhcBase)[0]))] = {0};


static const IRQn_Type s_usdhcIRQ[] = { NotAvail_IRQn, USDHC1_IRQn, USDHC2_IRQn };



static const clock_ip_name_t s_usdhcClock[] = { kCLOCK_IpInvalid, kCLOCK_Usdhc1, kCLOCK_Usdhc2 };
# 226 "../../libraries/sdk/drives/fsl_usdhc.c"
static usdhc_isr_t s_usdhcIsr = (usdhc_isr_t)DefaultISR;




__attribute__((section(".bss.NonCacheable"))) __attribute__((aligned((4U)))) static uint32_t s_usdhcBootDummy;
...
static uint32_t USDHC_GetInstance(USDHC_Type *base)
{
    ...
    while ((instance < (sizeof(s_usdhcBase) / sizeof((s_usdhcBase)[0]))) && (s_usdhcBase[instance] != base))
    {
        instance++;
    }

    ((instance < (sizeof(s_usdhcBase) / sizeof((s_usdhcBase)[0]))) ? (void)0 : __aeabi_assert("instance < ARRAY_SIZE(s_usdhcBase)", "../../libraries/sdk/drives/fsl_usdhc.c", 245),
# 245 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic push
# 245 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic ignored "-Wassume"
# 245 "../../libraries/sdk/drives/fsl_usdhc.c"
    (__builtin_assume)((instance < (sizeof(s_usdhcBase) / sizeof((s_usdhcBase)[0])))?1:0)
# 245 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic pop
# 245 "../../libraries/sdk/drives/fsl_usdhc.c"
    );
...
static status_t USDHC_SetTransferConfig(USDHC_Type *base, uint32_t transferFlags, size_t blockSize, uint32_t blockCount)
{
    ...
    if (((uint32_t)kUSDHC_CommandOnly & transferFlags) != 0U)
    {
        ...
        mixCtrl &= ~((0x20U) | (0x2U) | (0x10U) |
                     (0x4U) | (0x80U));

        if ((((base->PRES_STATE) & ((uint32_t)kUSDHC_CommandInhibitFlag)) != 0UL))
        {
    ...
    else
    {
        ...
        if ((((base->PRES_STATE) & ((uint32_t)kUSDHC_DataInhibitFlag)) != 0UL))
        {
            return kStatus_USDHC_BusyTransferring;
        }

        if ((blockCount > ((0xFFFF0000U) >> (16U))))
        {
        ...
        if ((transferFlags & (uint32_t)kUSDHC_BootData) == 0U)
        {
            ...
            base->BLK_ATT = ((base->BLK_ATT & ~((0x1FFFU) | (0xFFFF0000U))) |
                             ((((uint32_t)(((uint32_t)(blockSize)) << (0U))) & (0x1FFFU)) | (((uint32_t)(((uint32_t)(blockCount)) << (16U))) & (0xFFFF0000U))));
        }
        else
        {
            mixCtrl |= (0x20U) | (0x2U);
            base->PROT_CTRL |= (0x100000U);
        }
    }
...
void USDHC_SetDataConfig(USDHC_Type *base,
                         ...
                         uint32_t blockSize)
{
    ((blockCount <= ((0xFFFF0000U) >> (16U))) ? (void)0 : __aeabi_assert("blockCount <= USDHC_MAX_BLOCK_COUNT", "../../libraries/sdk/drives/fsl_usdhc.c", 345),
# 345 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic push
# 345 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic ignored "-Wassume"
# 345 "../../libraries/sdk/drives/fsl_usdhc.c"
    (__builtin_assume)((blockCount <= ((0xFFFF0000U) >> (16U)))?1:0)
# 345 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic pop
# 345 "../../libraries/sdk/drives/fsl_usdhc.c"
    );
    ...
    mixCtrl |= (((uint32_t)(((uint32_t)(dataDirection)) << (4U))) & (0x10U)) | (blockCount > 1U ? (0x20U) : 0U);
...
static status_t USDHC_ReceiveCommandResponse(USDHC_Type *base, usdhc_command_t *command)
{
    ((command != 0) ? (void)0 : __aeabi_assert("command != NULL", "../../libraries/sdk/drives/fsl_usdhc.c", 363),
# 363 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic push
# 363 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic ignored "-Wassume"
# 363 "../../libraries/sdk/drives/fsl_usdhc.c"
    (__builtin_assume)((command != 0)?1:0)
# 363 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic pop
# 363 "../../libraries/sdk/drives/fsl_usdhc.c"
    );
...
static uint32_t USDHC_ReadDataPort(USDHC_Type *base, usdhc_data_t *data, uint32_t transferredWords)
{
    uint32_t i;
    uint32_t totalWords;
    uint32_t wordsCanBeRead;
    uint32_t readWatermark = ((base->WTMK_LVL & (0xFFU)) >> (0U));


    if ((base->MIX_CTRL & (0x1U)) == 0U)
    {
        ...
        {
            data->blockSize +=
                sizeof(uint32_t) - (data->blockSize % sizeof(uint32_t));
        }
...
static status_t USDHC_ReadByDataPortBlocking(USDHC_Type *base, usdhc_data_t *data)
{
    ...
    {
        while (
            !((((interruptStatus) & ((uint32_t)((uint32_t)kUSDHC_BufferReadReadyFlag | (uint32_t)kUSDHC_DataErrorFlag | (uint32_t)kUSDHC_TuningErrorFlag))) != 0UL)))
        ...
        if ((data->dataType == (uint32_t)kUSDHC_TransferDataTuning) &&
            ((((interruptStatus) & ((uint32_t)kUSDHC_BufferReadReadyFlag)) != 0UL)))
        {
        ...
        else if ((((interruptStatus) & ((uint32_t)kUSDHC_TuningErrorFlag)) != 0UL))
        {
        ...
        else if ((((interruptStatus) & ((uint32_t)kUSDHC_DataErrorFlag)) != 0UL))
        {
...
static uint32_t USDHC_WriteDataPort(USDHC_Type *base, usdhc_data_t *data, uint32_t transferredWords)
{
    uint32_t i;
    uint32_t totalWords;
    uint32_t wordsCanBeWrote;
    uint32_t writeWatermark = ((base->WTMK_LVL & (0xFF0000U)) >> (16U));
...
static status_t USDHC_WriteByDataPortBlocking(USDHC_Type *base, usdhc_data_t *data)
{
    ...
    while ((error == kStatus_Success) && (transferredWords < totalWords))
    {
        while (!((((interruptStatus) & ((uint32_t)(uint32_t)kUSDHC_BufferWriteReadyFlag | (uint32_t)kUSDHC_DataErrorFlag | (uint32_t)kUSDHC_TuningErrorFlag)) != 0UL)))
        ...
        if ((((interruptStatus) & ((uint32_t)kUSDHC_TuningErrorFlag)) != 0UL))
        {
            USDHC_ClearInterruptStatusFlags(base, kUSDHC_TuningErrorFlag);
    ...
    while (!((((interruptStatus) & ((uint32_t)(uint32_t)kUSDHC_DataCompleteFlag | (uint32_t)kUSDHC_DataErrorFlag)) != 0UL)))
    {
        interruptStatus = USDHC_GetInterruptStatusFlags(base);
    }
...
void USDHC_SendCommand(USDHC_Type *base, usdhc_command_t *command)
{
    ((0 != command) ? (void)0 : __aeabi_assert("NULL != command", "../../libraries/sdk/drives/fsl_usdhc.c", 661),
# 661 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic push
# 661 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic ignored "-Wassume"
# 661 "../../libraries/sdk/drives/fsl_usdhc.c"
    (__builtin_assume)((0 != command)?1:0)
# 661 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic pop
# 661 "../../libraries/sdk/drives/fsl_usdhc.c"
    );
    ...
    if (((base->PRES_STATE & (uint32_t)kUSDHC_CommandInhibitFlag) == 0U) && (command->type != kCARD_CommandTypeEmpty))
    {
        ...
        xferType &= ~((0x3F000000U) | (0xC00000U) | (0x100000U) |
                      (0x80000U) | (0x30000U) | (0x200000U));

        xferType |=
            (((command->index << (24U)) & (0x3F000000U)) |
             ((flags) & ((0xC00000U) | (0x100000U) | (0x80000U) |
                         (0x30000U) | (0x200000U))));
    ...
    if (command->type == kCARD_CommandTypeEmpty)
    {
        ...
        base->INT_SIGNAL_EN &= ~(0x1U);
    }
}

static status_t USDHC_WaitCommandDone(USDHC_Type *base, usdhc_command_t *command, _Bool pollingCmdDone)
{
    ((0 != command) ? (void)0 : __aeabi_assert("NULL != command", "../../libraries/sdk/drives/fsl_usdhc.c", 719),
# 719 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic push
# 719 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic ignored "-Wassume"
# 719 "../../libraries/sdk/drives/fsl_usdhc.c"
...
# 719 "../../libraries/sdk/drives/fsl_usdhc.c"
    ...
    if (pollingCmdDone)
    {
        ...
        while (!((((interruptStatus) & ((uint32_t)kUSDHC_CommandFlag)) != 0UL)))
        {
            interruptStatus = USDHC_GetInterruptStatusFlags(base);
        }
...
static status_t USDHC_TransferDataBlocking(USDHC_Type *base, usdhc_data_t *data, _Bool enDMA)
{
    ...
    if (enDMA)
    {
        ...
        while (!((((interruptStatus) & ((uint32_t)((uint32_t)kUSDHC_DataDMAFlag | (uint32_t)kUSDHC_TuningErrorFlag))) != 0UL)))
        {
            interruptStatus = USDHC_GetInterruptStatusFlags(base);
        }
        ...
        if ((((interruptStatus) & ((uint32_t)kUSDHC_TuningErrorFlag)) != 0UL))
        {
            ...
            if ((((interruptStatus) & ((uint32_t)((uint32_t)kUSDHC_DataErrorFlag | (uint32_t)kUSDHC_DmaErrorFlag))) != 0UL))
        {
            if ((!(data->enableIgnoreError)) || ((((interruptStatus) & ((uint32_t)kUSDHC_DataTimeoutFlag)) != 0UL)))
            {
...
# 831 "../../libraries/sdk/drives/fsl_usdhc.c"
void USDHC_Init(USDHC_Type *base, const usdhc_config_t *config)
{
    ((config != 0) ? (void)0 : __aeabi_assert("config != NULL", "../../libraries/sdk/drives/fsl_usdhc.c", 833),
# 833 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic push
# 833 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic ignored "-Wassume"
# 833 "../../libraries/sdk/drives/fsl_usdhc.c"
...
# 833 "../../libraries/sdk/drives/fsl_usdhc.c"
    ...
    (((config->writeWatermarkLevel >= 1U) && (config->writeWatermarkLevel <= 128U)) ? (void)0 : __aeabi_assert("(config->writeWatermarkLevel >= 1U) && (config->writeWatermarkLevel <= 128U)", "../../libraries/sdk/drives/fsl_usdhc.c", 834),
# 834 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic push
# 834 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic ignored "-Wassume"
# 834 "../../libraries/sdk/drives/fsl_usdhc.c"
    (__builtin_assume)(((config->writeWatermarkLevel >= 1U) && (config->writeWatermarkLevel <= 128U))?1:0)
# 834 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic pop
# 834 "../../libraries/sdk/drives/fsl_usdhc.c"
    );
    (((config->readWatermarkLevel >= 1U) && (config->readWatermarkLevel <= 128U)) ? (void)0 : __aeabi_assert("(config->readWatermarkLevel >= 1U) && (config->readWatermarkLevel <= 128U)", "../../libraries/sdk/drives/fsl_usdhc.c", 835),
# 835 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic push
# 835 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic ignored "-Wassume"
# 835 "../../libraries/sdk/drives/fsl_usdhc.c"
    (__builtin_assume)(((config->readWatermarkLevel >= 1U) && (config->readWatermarkLevel <= 128U))?1:0)
# 835 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic pop
# 835 "../../libraries/sdk/drives/fsl_usdhc.c"
    );

    ((config->writeBurstLen <= 16U) ? (void)0 : __aeabi_assert("config->writeBurstLen <= 16U", "../../libraries/sdk/drives/fsl_usdhc.c", 837),
# 837 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic push
# 837 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic ignored "-Wassume"
# 837 "../../libraries/sdk/drives/fsl_usdhc.c"
    (__builtin_assume)((config->writeBurstLen <= 16U)?1:0)
# 837 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic pop
# 837 "../../libraries/sdk/drives/fsl_usdhc.c"
    );
...
# 852 "../../libraries/sdk/drives/fsl_usdhc.c"
    base->SYS_CTRL |= (0x1000000U) | (0x2000000U) | (0x4000000U);
    ...
    proctl |= (((uint32_t)(((uint32_t)(config->endianMode)) << (4U))) & (0x30U));
    ...
    wml &= ~((0xFFU) | (0xFF0000U) | (0x1F00U) |
             (0x1F000000U));
    wml |= ((((uint32_t)(((uint32_t)(config->readWatermarkLevel)) << (0U))) & (0xFFU)) | (((uint32_t)(((uint32_t)(config->writeWatermarkLevel)) << (16U))) & (0xFF0000U)) |
            (((uint32_t)(((uint32_t)(config->readBurstLen)) << (8U))) & (0x1F00U)) | (((uint32_t)(((uint32_t)(config->writeBurstLen)) << (24U))) & (0x1F000000U)));



    sysctl &= ~(0xF0000U);
    sysctl |= (((uint32_t)(((uint32_t)(config->dataTimeout)) << (16U))) & (0xF0000U));
...
# 916 "../../libraries/sdk/drives/fsl_usdhc.c"
_Bool USDHC_Reset(USDHC_Type *base, uint32_t mask, uint32_t timeout)
{
    base->SYS_CTRL |= (mask & ((0x1000000U) | (0x2000000U) | (0x4000000U)

                               | (0x10000000U)

                               ));

    while ((((base->SYS_CTRL) & ((uint32_t)mask)) != 0UL))
    {
        if (timeout == 0UL)
        {
            break;
...
void USDHC_GetCapability(USDHC_Type *base, usdhc_capability_t *capability)
{
    ((capability != 0) ? (void)0 : __aeabi_assert("capability != NULL", "../../libraries/sdk/drives/fsl_usdhc.c", 944),
# 944 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic push
# 944 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic ignored "-Wassume"
# 944 "../../libraries/sdk/drives/fsl_usdhc.c"
    (__builtin_assume)((capability != 0)?1:0)
# 944 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic pop
# 944 "../../libraries/sdk/drives/fsl_usdhc.c"
    );
    ...
    maxBlockLength = ((htCapability & (0x70000U)) >> (16U));
    capability->maxBlockLength = (512UL << maxBlockLength);

    capability->maxBlockCount = ((0xFFFF0000U) >> (16U));
    capability->flags =
        (htCapability & ((0x100000U) | (0x200000U) | (0x400000U) |
                         (0x800000U) | (0x1000000U)));
    capability->flags |= htCapability & (0x2000000U);
    capability->flags |= htCapability & (0x4000000U);
    capability->flags |= htCapability & (0x4U);

    capability->flags |= (0x2U);



    capability->flags |= (0x1U);


    capability->flags |= ((16U) << 0UL) | ((16U) << 1UL);
}
# 982 "../../libraries/sdk/drives/fsl_usdhc.c"
uint32_t USDHC_SetSdClock(USDHC_Type *base, uint32_t srcClock_Hz, uint32_t busClock_Hz)
{
    ((srcClock_Hz != 0U) ? (void)0 : __aeabi_assert("srcClock_Hz != 0U", "../../libraries/sdk/drives/fsl_usdhc.c", 984),
# 984 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic push
# 984 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic ignored "-Wassume"
# 984 "../../libraries/sdk/drives/fsl_usdhc.c"
    (__builtin_assume)((srcClock_Hz != 0U)?1:0)
# 984 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic pop
# 984 "../../libraries/sdk/drives/fsl_usdhc.c"
    );
    ((busClock_Hz != 0U) ? (void)0 : __aeabi_assert("busClock_Hz != 0U", "../../libraries/sdk/drives/fsl_usdhc.c", 985),
# 985 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic push
# 985 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic ignored "-Wassume"
# 985 "../../libraries/sdk/drives/fsl_usdhc.c"
    (__builtin_assume)((busClock_Hz != 0U)?1:0)
# 985 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic pop
# 985 "../../libraries/sdk/drives/fsl_usdhc.c"
    );
    ...
    if (totalDiv > ((((0xFF00U) >> (8U)) + 1U) * (((0xF0U) >> (4U)) + 1U)))
    {
        return 0UL;
    }
    ...
    if (totalDiv != 0UL)
    {
        ...
        if (totalDiv > (((0xF0U) >> (4U)) + 1U))
        {
            prescaler = totalDiv / (((0xF0U) >> (4U)) + 1U);

            while ((((((0xFF00U) >> (8U)) + 1U) % prescaler) != 0UL) || (prescaler == 1UL))
            {
                prescaler++;
            }
            ...
            {
                divisor++;
                if (divisor > (((0xF0U) >> (4U)) + 1U))
                {
                    prescaler <<= 1UL;
                    if (prescaler > (((0xFF00U) >> (8U)) + 1U))
                    {
                        return 0UL;
                    }
                    divisor = totalDiv / prescaler;
    ...
    sysctl = base->SYS_CTRL;
    sysctl &= ~((0xF0U) | (0xFF00U));
    sysctl |= ((((uint32_t)(((uint32_t)(divisor)) << (4U))) & (0xF0U)) | (((uint32_t)(((uint32_t)(prescaler)) << (8U))) & (0xFF00U)));
    base->SYS_CTRL = sysctl;


    while (!(((base->PRES_STATE) & ((uint32_t)(0x8U))) != 0UL))
    {
    }

    return nearestFrequency;
}
# 1103 "../../libraries/sdk/drives/fsl_usdhc.c"
_Bool USDHC_SetCardActive(USDHC_Type *base, uint32_t timeout)
{
    base->SYS_CTRL |= (0x8000000U);

    while ((((base->SYS_CTRL) & ((uint32_t)(0x8000000U))) != 0UL))
    {
        if (0UL == timeout)
        {
            break;
...
# 1126 "../../libraries/sdk/drives/fsl_usdhc.c"
void USDHC_EnableDDRMode(USDHC_Type *base, _Bool enable, uint32_t nibblePos)
{
    uint32_t prescaler = (base->SYS_CTRL & (0xFF00U)) >> (8U);

    if (enable)
    {
        base->MIX_CTRL &= ~(0x40U);
        base->MIX_CTRL |= ((0x8U) | (((uint32_t)(((uint32_t)(nibblePos)) << (6U))) & (0x40U)));
        prescaler >>= 1UL;
    }
    else
    {
    ...
    base->SYS_CTRL = (base->SYS_CTRL & (~(0xFF00U))) | (((uint32_t)(((uint32_t)(prescaler)) << (8U))) & (0xFF00U));
}
# 1171 "../../libraries/sdk/drives/fsl_usdhc.c"
void USDHC_SetMmcBootConfig(USDHC_Type *base, const usdhc_boot_config_t *config)
{
    ((config != 0) ? (void)0 : __aeabi_assert("config != NULL", "../../libraries/sdk/drives/fsl_usdhc.c", 1173),
# 1173 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic push
# 1173 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic ignored "-Wassume"
# 1173 "../../libraries/sdk/drives/fsl_usdhc.c"
...
# 1173 "../../libraries/sdk/drives/fsl_usdhc.c"
    ...
    ((config->ackTimeoutCount <= ((0xFU) >> (0U))) ? (void)0 : __aeabi_assert("config->ackTimeoutCount <= (USDHC_MMC_BOOT_DTOCV_ACK_MASK >> USDHC_MMC_BOOT_DTOCV_ACK_SHIFT)", "../../libraries/sdk/drives/fsl_usdhc.c", 1174),
# 1174 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic push
# 1174 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic ignored "-Wassume"
# 1174 "../../libraries/sdk/drives/fsl_usdhc.c"
    (__builtin_assume)((config->ackTimeoutCount <= ((0xFU) >> (0U)))?1:0)
# 1174 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic pop
# 1174 "../../libraries/sdk/drives/fsl_usdhc.c"
    );
    ((config->blockCount <= ((0xFFFF0000U) >> (16U))) ? (void)0 : __aeabi_assert("config->blockCount <= (USDHC_MMC_BOOT_BOOT_BLK_CNT_MASK >> USDHC_MMC_BOOT_BOOT_BLK_CNT_SHIFT)", "../../libraries/sdk/drives/fsl_usdhc.c", 1175),
# 1175 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic push
# 1175 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic ignored "-Wassume"
# 1175 "../../libraries/sdk/drives/fsl_usdhc.c"
    (__builtin_assume)((config->blockCount <= ((0xFFFF0000U) >> (16U)))?1:0)
# 1175 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic pop
# 1175 "../../libraries/sdk/drives/fsl_usdhc.c"
    );
    ...
    mmcboot &= ~((0xFU) | (0x20U) | (0xFFFF0000U));
    mmcboot |= (((uint32_t)(((uint32_t)(config->ackTimeoutCount)) << (0U))) & (0xFU)) | (((uint32_t)(((uint32_t)(config->bootMode)) << (5U))) & (0x20U));
    ...
    {
        mmcboot |=
            (0x80U) | (((uint32_t)(((uint32_t)(((0xFFFF0000U) >> (16U)) - config->blockCount)) << (16U))) & (0xFFFF0000U));

        base->BLK_ATT = ((base->BLK_ATT & ~((0x1FFFU) | (0xFFFF0000U))) |
                         ((((uint32_t)(((uint32_t)(config->blockSize)) << (0U))) & (0x1FFFU)) | (((uint32_t)(((uint32_t)(((0xFFFF0000U) >> (16U)))) << (16U))) & (0xFFFF0000U))));
    }
    else
    {
        base->BLK_ATT = ((base->BLK_ATT & ~((0x1FFFU) | (0xFFFF0000U))) |
                         ((((uint32_t)(((uint32_t)(config->blockSize)) << (0U))) & (0x1FFFU)) | (((uint32_t)(((uint32_t)(config->blockCount)) << (16U))) & (0xFFFF0000U))));
    }

    base->MMC_BOOT = mmcboot;
}
# 1215 "../../libraries/sdk/drives/fsl_usdhc.c"
status_t USDHC_SetADMA1Descriptor(
    uint32_t *admaTable, uint32_t admaTableWords, const uint32_t *dataBufferAddr, uint32_t dataBytes, uint32_t flags)
{
    ((0 != admaTable) ? (void)0 : __aeabi_assert("NULL != admaTable", "../../libraries/sdk/drives/fsl_usdhc.c", 1218),
# 1218 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic push
# 1218 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic ignored "-Wassume"
# 1218 "../../libraries/sdk/drives/fsl_usdhc.c"
    (__builtin_assume)((0 != admaTable)?1:0)
# 1218 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic pop
# 1218 "../../libraries/sdk/drives/fsl_usdhc.c"
    );
    ((0 != dataBufferAddr) ? (void)0 : __aeabi_assert("NULL != dataBufferAddr", "../../libraries/sdk/drives/fsl_usdhc.c", 1219),
# 1219 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic push
# 1219 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic ignored "-Wassume"
# 1219 "../../libraries/sdk/drives/fsl_usdhc.c"
    (__builtin_assume)((0 != dataBufferAddr)?1:0)
# 1219 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic pop
# 1219 "../../libraries/sdk/drives/fsl_usdhc.c"
    );
    ...
    if ((dataBytes % ((0xFFFFU) + 1U - 4096U)) == 0UL)
    {
        miniEntries = dataBytes / ((0xFFFFU) + 1U - 4096U);
    }
    else
    {
        miniEntries = ((dataBytes / ((0xFFFFU) + 1U - 4096U)) + 1UL);
    }
    ...
    {
        if (dataBytes > ((0xFFFFU) + 1U - 4096U))
        {
            dmaBufferLen = ((0xFFFFU) + 1U - 4096U);
        }
        else
        {
        ...
        adma1EntryAddress[i] = (dmaBufferLen << (12U));
...
# 1302 "../../libraries/sdk/drives/fsl_usdhc.c"
status_t USDHC_SetADMA2Descriptor(
    uint32_t *admaTable, uint32_t admaTableWords, const uint32_t *dataBufferAddr, uint32_t dataBytes, uint32_t flags)
{
    ((0 != admaTable) ? (void)0 : __aeabi_assert("NULL != admaTable", "../../libraries/sdk/drives/fsl_usdhc.c", 1305),
# 1305 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic push
# 1305 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic ignored "-Wassume"
# 1305 "../../libraries/sdk/drives/fsl_usdhc.c"
...
# 1305 "../../libraries/sdk/drives/fsl_usdhc.c"
    ...
    ((0 != dataBufferAddr) ? (void)0 : __aeabi_assert("NULL != dataBufferAddr", "../../libraries/sdk/drives/fsl_usdhc.c", 1306),
# 1306 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic push
# 1306 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic ignored "-Wassume"
# 1306 "../../libraries/sdk/drives/fsl_usdhc.c"
...
# 1306 "../../libraries/sdk/drives/fsl_usdhc.c"
    ...
    if ((dataBytes % ((0xFFFFU) - 3U)) == 0UL)
    {
        miniEntries = dataBytes / ((0xFFFFU) - 3U);
    }
    else
    {
        miniEntries = ((dataBytes / ((0xFFFFU) - 3U)) + 1UL);
    }
    ...
    for (i = startEntries; i < (miniEntries + startEntries); i++)
    {
        ...
        adma2EntryAddress[i].attribute = (dmaBufferLen << (16U));
...
# 1413 "../../libraries/sdk/drives/fsl_usdhc.c"
status_t USDHC_SetInternalDmaConfig(USDHC_Type *base,
                                    usdhc_adma_config_t *dmaConfig,
                                    const uint32_t *dataAddr,
                                    _Bool enAutoCmd23)
{
    ((dmaConfig != 0) ? (void)0 : __aeabi_assert("dmaConfig != NULL", "../../libraries/sdk/drives/fsl_usdhc.c", 1418),
# 1418 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic push
# 1418 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic ignored "-Wassume"
# 1418 "../../libraries/sdk/drives/fsl_usdhc.c"
    (__builtin_assume)((dmaConfig != 0)?1:0)
# 1418 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic pop
# 1418 "../../libraries/sdk/drives/fsl_usdhc.c"
    );
    ((dataAddr != 0) ? (void)0 : __aeabi_assert("dataAddr != NULL", "../../libraries/sdk/drives/fsl_usdhc.c", 1419),
# 1419 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic push
# 1419 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic ignored "-Wassume"
# 1419 "../../libraries/sdk/drives/fsl_usdhc.c"
    (__builtin_assume)((dataAddr != 0)?1:0)
# 1419 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic pop
# 1419 "../../libraries/sdk/drives/fsl_usdhc.c"
    );
    (((0 != dmaConfig->admaTable) && ((((4U) - 1U) & (uint32_t)dmaConfig->admaTable) == 0UL)) ? (void)0 : __aeabi_assert("(NULL != dmaConfig->admaTable) && (((USDHC_ADMA_TABLE_ADDRESS_ALIGN - 1U) & (uint32_t)dmaConfig->admaTable) == 0UL)", "../../libraries/sdk/drives/fsl_usdhc.c", 1421),
# 1420 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic push
# 1420 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic ignored "-Wassume"
# 1420 "../../libraries/sdk/drives/fsl_usdhc.c"
    (__builtin_assume)(((0 != dmaConfig->admaTable) && ((((4U) - 1U) & (uint32_t)dmaConfig->admaTable) == 0UL))?1:0)
# 1420 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic pop
# 1420 "../../libraries/sdk/drives/fsl_usdhc.c"
    );
    ...
    base->PROT_CTRL &= ~((0x300U) | (0x38000000U));
    base->PROT_CTRL |= (((uint32_t)(((uint32_t)(dmaConfig->dmaMode)) << (8U))) & (0x300U)) | (((uint32_t)(((uint32_t)(dmaConfig->burstLen)) << (27U))) & (0x38000000U));
...
# 1479 "../../libraries/sdk/drives/fsl_usdhc.c"
status_t USDHC_SetAdmaTableConfig(USDHC_Type *base,
                                  usdhc_adma_config_t *dmaConfig,
                                  usdhc_data_t *dataConfig,
                                  uint32_t flags)
{
    ((0 != dmaConfig) ? (void)0 : __aeabi_assert("NULL != dmaConfig", "../../libraries/sdk/drives/fsl_usdhc.c", 1484),
# 1484 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic push
# 1484 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic ignored "-Wassume"
# 1484 "../../libraries/sdk/drives/fsl_usdhc.c"
    (__builtin_assume)((0 != dmaConfig)?1:0)
# 1484 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic pop
# 1484 "../../libraries/sdk/drives/fsl_usdhc.c"
    );
    (((0 != dmaConfig->admaTable) && ((((4U) - 1U) & (uint32_t)dmaConfig->admaTable) == 0UL)) ? (void)0 : __aeabi_assert("(NULL != dmaConfig->admaTable) && (((USDHC_ADMA_TABLE_ADDRESS_ALIGN - 1U) & (uint32_t)dmaConfig->admaTable) == 0UL)", "../../libraries/sdk/drives/fsl_usdhc.c", 1486),
# 1485 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic push
# 1485 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic ignored "-Wassume"
# 1485 "../../libraries/sdk/drives/fsl_usdhc.c"
...
# 1485 "../../libraries/sdk/drives/fsl_usdhc.c"
    ...
    ((0 != dataConfig) ? (void)0 : __aeabi_assert("NULL != dataConfig", "../../libraries/sdk/drives/fsl_usdhc.c", 1487),
# 1487 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic push
# 1487 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic ignored "-Wassume"
# 1487 "../../libraries/sdk/drives/fsl_usdhc.c"
    (__builtin_assume)((0 != dataConfig)?1:0)
# 1487 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic pop
# 1487 "../../libraries/sdk/drives/fsl_usdhc.c"
    );
    ...
    const uint32_t *data = (const uint32_t *)((uint32_t)( (uint32_t)((dataConfig->rxData == 0) ? dataConfig->txData : dataConfig->rxData) + bootDummyOffset));

    uint32_t blockSize = dataConfig->blockSize * dataConfig->blockCount - bootDummyOffset;
# 1504 "../../libraries/sdk/drives/fsl_usdhc.c"
        if (dmaConfig->dmaMode == kUSDHC_DmaModeSimple)
    {
...
# 1549 "../../libraries/sdk/drives/fsl_usdhc.c"
status_t USDHC_TransferBlocking(USDHC_Type *base, usdhc_adma_config_t *dmaConfig, usdhc_transfer_t *transfer)
{
    ((transfer != 0) ? (void)0 : __aeabi_assert("transfer != NULL", "../../libraries/sdk/drives/fsl_usdhc.c", 1551),
# 1551 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic push
# 1551 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic ignored "-Wassume"
# 1551 "../../libraries/sdk/drives/fsl_usdhc.c"
    (__builtin_assume)((transfer != 0)?1:0)
# 1551 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic pop
# 1551 "../../libraries/sdk/drives/fsl_usdhc.c"
    );
    ...
    _Bool enDMA = 1;
    _Bool executeTuning = ((data == 0) ? 0 : data->dataType == (uint32_t)kUSDHC_TransferDataTuning);
    ...
    if (data != 0)
    {
        ...
        if ((dmaConfig != 0) && (!executeTuning))
        {
            error = USDHC_SetAdmaTableConfig(base, dmaConfig, data,
                                             (uint32_t)((((data->dataType) & ((uint32_t)kUSDHC_TransferDataBoot)) != 0UL) ?
                                                            kUSDHC_AdmaDescriptorMultipleFlag :
        ...
        transferFlags |= data->txData != 0 ? (uint32_t)kUSDHC_CommandAndTxData : (uint32_t)kUSDHC_CommandAndRxData;
    ...
    if (error != kStatus_Success)
    {
        ...
        USDHC_EnableInternalDMA(base, 0);
    }
# 1617 "../../libraries/sdk/drives/fsl_usdhc.c"
    ...
    error =
        USDHC_WaitCommandDone(base, command, (data == 0) || (data->dataType == (uint32_t)kUSDHC_TransferDataNormal));
...
# 1858 "../../libraries/sdk/drives/fsl_usdhc.c"
status_t USDHC_TransferNonBlocking(USDHC_Type *base,
                                   usdhc_handle_t *handle,
                                   usdhc_adma_config_t *dmaConfig,
                                   usdhc_transfer_t *transfer)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_usdhc.c", 1863),
# 1863 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic push
# 1863 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic ignored "-Wassume"
# 1863 "../../libraries/sdk/drives/fsl_usdhc.c"
...
# 1863 "../../libraries/sdk/drives/fsl_usdhc.c"
    ...
    ((transfer != 0) ? (void)0 : __aeabi_assert("transfer != NULL", "../../libraries/sdk/drives/fsl_usdhc.c", 1864),
# 1864 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic push
# 1864 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic ignored "-Wassume"
# 1864 "../../libraries/sdk/drives/fsl_usdhc.c"
    ...
    if (data != 0)
    {
        ...
        if ((dmaConfig != 0) && (!executeTuning))
        {
            error = USDHC_SetAdmaTableConfig(
                base, dmaConfig, data,
                (uint32_t)((((data->dataType) & ((uint32_t)(uint32_t)kUSDHC_TransferDataBoot)) != 0UL) ?
                               kUSDHC_AdmaDescriptorMultipleFlag :
                               kUSDHC_AdmaDescriptorSingleFlag));
        }
...
# 1938 "../../libraries/sdk/drives/fsl_usdhc.c"
    error = USDHC_SetTransferConfig(base, transferFlags, blockSize, blockCount);
    if (error != kStatus_Success)
    {
        return error;
    ...
    if (handle->data != 0)
    {
        USDHC_ClearInterruptStatusFlags(
            base, (uint32_t)(enDMA == 0 ? kUSDHC_DataFlag : kUSDHC_DataDMAFlag) | (uint32_t)kUSDHC_CommandFlag |
                      (uint32_t)(data->dataType == (uint8_t)kUSDHC_TransferDataBootcontinous ?
                                     (uint32_t)kUSDHC_DmaCompleteFlag :
                                     0U));
        USDHC_EnableInterruptSignal(base, (uint32_t)(enDMA == 0 ? kUSDHC_DataFlag : kUSDHC_DataDMAFlag) |
...
# 1980 "../../libraries/sdk/drives/fsl_usdhc.c"
void USDHC_EnableManualTuning(USDHC_Type *base, _Bool enable)
{
    if (enable)
    {

        base->TUNING_CTRL &= ~(0x1000000U);

        base->MIX_CTRL &= ~(0x1000000U);

        base->MIX_CTRL |= (0x400000U) | (0x800000U);
    }
    else
    {
        base->MIX_CTRL &= ~(0x400000U);
    }
}
# 2005 "../../libraries/sdk/drives/fsl_usdhc.c"
status_t USDHC_AdjustDelayForManualTuning(USDHC_Type *base, uint32_t delay)
{
    ...
    clkTuneCtrl |= (((uint32_t)(((uint32_t)(delay)) << (8U))) & (0x7F00U));


    base->CLK_TUNE_CTRL_STATUS = clkTuneCtrl;

    if ((((base->CLK_TUNE_CTRL_STATUS) & ((uint32_t)(0x80000000U) | (0x8000U))) != 0UL))
...
# 2037 "../../libraries/sdk/drives/fsl_usdhc.c"
status_t USDHC_SetTuningDelay(USDHC_Type *base, uint32_t preDelay, uint32_t outDelay, uint32_t postDelay)
{
    ((preDelay <= ((0x7F00U) >> (8U))) ? (void)0 : __aeabi_assert("preDelay <= (USDHC_CLK_TUNE_CTRL_STATUS_DLY_CELL_SET_PRE_MASK >> USDHC_CLK_TUNE_CTRL_STATUS_DLY_CELL_SET_PRE_SHIFT)", "../../libraries/sdk/drives/fsl_usdhc.c", 2040),
# 2039 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic push
# 2039 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic ignored "-Wassume"
# 2039 "../../libraries/sdk/drives/fsl_usdhc.c"
    (__builtin_assume)((preDelay <= ((0x7F00U) >> (8U)))?1:0)
# 2039 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic pop
# 2039 "../../libraries/sdk/drives/fsl_usdhc.c"
    );

    ((outDelay <= ((0xF0U) >> (4U))) ? (void)0 : __aeabi_assert("outDelay <= (USDHC_CLK_TUNE_CTRL_STATUS_DLY_CELL_SET_OUT_MASK >> USDHC_CLK_TUNE_CTRL_STATUS_DLY_CELL_SET_OUT_SHIFT)", "../../libraries/sdk/drives/fsl_usdhc.c", 2042),
# 2041 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic push
# 2041 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic ignored "-Wassume"
# 2041 "../../libraries/sdk/drives/fsl_usdhc.c"
    (__builtin_assume)((outDelay <= ((0xF0U) >> (4U)))?1:0)
# 2041 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic pop
# 2041 "../../libraries/sdk/drives/fsl_usdhc.c"
    );

    ((postDelay <= ((0xFU) >> (0U))) ? (void)0 : __aeabi_assert("postDelay <= (USDHC_CLK_TUNE_CTRL_STATUS_DLY_CELL_SET_POST_MASK >> USDHC_CLK_TUNE_CTRL_STATUS_DLY_CELL_SET_POST_SHIFT)", "../../libraries/sdk/drives/fsl_usdhc.c", 2044),
# 2043 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic push
# 2043 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic ignored "-Wassume"
# 2043 "../../libraries/sdk/drives/fsl_usdhc.c"
    (__builtin_assume)((postDelay <= ((0xFU) >> (0U)))?1:0)
# 2043 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic pop
# 2043 "../../libraries/sdk/drives/fsl_usdhc.c"
    );
    ...
    clkTuneCtrl |= (((uint32_t)(((uint32_t)(preDelay)) << (8U))) & (0x7F00U)) |
                   (((uint32_t)(((uint32_t)(outDelay)) << (4U))) & (0xF0U)) |
                   (((uint32_t)(((uint32_t)(postDelay)) << (0U))) & (0xFU));
...
# 2080 "../../libraries/sdk/drives/fsl_usdhc.c"
void USDHC_EnableStandardTuning(USDHC_Type *base, uint32_t tuningStartTap, uint32_t step, _Bool enable)
{
    ...
    if (enable)
    {
        ...
        base->MIX_CTRL |= (0x2000000U);

        tuningCtrl = base->TUNING_CTRL;
        tuningCtrl &= ~((0x7FU) | (0x70000U));
        tuningCtrl |= ((((uint32_t)(((uint32_t)(tuningStartTap)) << (0U))) & (0x7FU)) | (((uint32_t)(((uint32_t)(step)) << (16U))) & (0x70000U)) |
                       (0x1000000U));
...
# 2145 "../../libraries/sdk/drives/fsl_usdhc.c"
void USDHC_EnableAutoTuningForCmdAndData(USDHC_Type *base)
{
    uint32_t busWidth = (base->PROT_CTRL & (0x6U)) >> (1U);

    base->VEND_SPEC2 |= (0x40U);


    if (busWidth == 0UL)
    {
        base->VEND_SPEC2 &= ~(0x10U);
        base->VEND_SPEC2 |= (0x20U);
    }
...
static void USDHC_TransferHandleCardDetect(USDHC_Type *base, usdhc_handle_t *handle, uint32_t interruptFlags)
{
    if ((((interruptFlags) & ((uint32_t)kUSDHC_CardInsertionFlag)) != 0UL))
    {
        if (handle->callback.CardInserted != 0)
        {
    ...
    {
        if (handle->callback.CardRemoved != 0)
        {
...
static void USDHC_TransferHandleCommand(USDHC_Type *base, usdhc_handle_t *handle, uint32_t interruptFlags)
{
    ((handle->command != 0) ? (void)0 : __aeabi_assert("handle->command != NULL", "../../libraries/sdk/drives/fsl_usdhc.c", 2192),
# 2192 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic push
# 2192 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic ignored "-Wassume"
# 2192 "../../libraries/sdk/drives/fsl_usdhc.c"
    (__builtin_assume)((handle->command != 0)?1:0)
# 2192 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic pop
# 2192 "../../libraries/sdk/drives/fsl_usdhc.c"
    );

    if ((((interruptFlags) & ((uint32_t)kUSDHC_CommandErrorFlag)) != 0UL))
    {
        if (handle->callback.TransferComplete != 0)
        {
...
# 2282 "../../libraries/sdk/drives/fsl_usdhc.c"
static void USDHC_TransferHandleData(USDHC_Type *base, usdhc_handle_t *handle, uint32_t interruptFlags)
{
    ((handle->data != 0) ? (void)0 : __aeabi_assert("handle->data != NULL", "../../libraries/sdk/drives/fsl_usdhc.c", 2284),
# 2284 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic push
# 2284 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic ignored "-Wassume"
# 2284 "../../libraries/sdk/drives/fsl_usdhc.c"
    (__builtin_assume)((handle->data != 0)?1:0)
# 2284 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic pop
# 2284 "../../libraries/sdk/drives/fsl_usdhc.c"
    );
    ...
    if ((!(handle->data->enableIgnoreError)) &&
        ((((interruptFlags) & ((uint32_t)(uint32_t)kUSDHC_DataErrorFlag | (uint32_t)kUSDHC_DmaErrorFlag)) != 0UL)))
    {
        transferStatus = kStatus_USDHC_TransferDataFailed;
    }
    else
    {
        if ((((interruptFlags) & ((uint32_t)kUSDHC_BufferReadReadyFlag)) != 0UL))
        {
        ...
        else if ((((interruptFlags) & ((uint32_t)kUSDHC_BufferWriteReadyFlag)) != 0UL))
        {
            handle->transferredWords = USDHC_WriteDataPort(base, handle->data, transferredWords);
        }
        else
        {
            if (((((interruptFlags) & ((uint32_t)kUSDHC_DmaCompleteFlag)) != 0UL)) &&
                (handle->data->dataType == (uint32_t)kUSDHC_TransferDataBootcontinous))
            {
                *(handle->data->rxData) = s_usdhcBootDummy;
            }

            if ((((interruptFlags) & ((uint32_t)kUSDHC_DataCompleteFlag)) != 0UL))
            {
                transferStatus = kStatus_USDHC_TransferDataComplete;
# 2331 "../../libraries/sdk/drives/fsl_usdhc.c"
            }
        }
    }

    if ((handle->callback.TransferComplete != 0) && (transferStatus != kStatus_USDHC_BusyTransferring))
    {
...
static void USDHC_TransferHandleSdioInterrupt(USDHC_Type *base, usdhc_handle_t *handle)
{
    if (handle->callback.SdioInterrupt != 0)
    {
...
static void USDHC_TransferHandleReTuning(USDHC_Type *base, usdhc_handle_t *handle, uint32_t interruptFlags)
{
    ((handle->callback.ReTuning != 0) ? (void)0 : __aeabi_assert("handle->callback.ReTuning != NULL", "../../libraries/sdk/drives/fsl_usdhc.c", 2355),
# 2355 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic push
# 2355 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic ignored "-Wassume"
# 2355 "../../libraries/sdk/drives/fsl_usdhc.c"
    (__builtin_assume)((handle->callback.ReTuning != 0)?1:0)
# 2355 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic pop
# 2355 "../../libraries/sdk/drives/fsl_usdhc.c"
    );

    if ((((interruptFlags) & ((uint32_t)kUSDHC_TuningErrorFlag)) != 0UL))
    {
        handle->callback.ReTuning(base, handle->userData);
    }
}
...
static void USDHC_TransferHandleBlockGap(USDHC_Type *base, usdhc_handle_t *handle)
{
    if (handle->callback.BlockGap != 0)
    {
        handle->callback.BlockGap(base, handle->userData);
    }
}
# 2380 "../../libraries/sdk/drives/fsl_usdhc.c"
void USDHC_TransferCreateHandle(USDHC_Type *base,
                                usdhc_handle_t *handle,
                                const usdhc_transfer_callback_t *callback,
                                void *userData)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_usdhc.c", 2385),
# 2385 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic push
# 2385 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic ignored "-Wassume"
# 2385 "../../libraries/sdk/drives/fsl_usdhc.c"
...
# 2385 "../../libraries/sdk/drives/fsl_usdhc.c"
    ...
    ((callback != 0) ? (void)0 : __aeabi_assert("callback != NULL", "../../libraries/sdk/drives/fsl_usdhc.c", 2386),
# 2386 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic push
# 2386 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic ignored "-Wassume"
# 2386 "../../libraries/sdk/drives/fsl_usdhc.c"
    (__builtin_assume)((callback != 0)?1:0)
# 2386 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic pop
# 2386 "../../libraries/sdk/drives/fsl_usdhc.c"
    );
...
# 2417 "../../libraries/sdk/drives/fsl_usdhc.c"
void USDHC_TransferHandleIRQ(USDHC_Type *base, usdhc_handle_t *handle)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_usdhc.c", 2419),
# 2419 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic push
# 2419 "../../libraries/sdk/drives/fsl_usdhc.c"
#pragma clang diagnostic ignored "-Wassume"
# 2419 "../../libraries/sdk/drives/fsl_usdhc.c"
...
# 2419 "../../libraries/sdk/drives/fsl_usdhc.c"
    ...
    if ((((interruptFlags) & ((uint32_t)kUSDHC_CardDetectFlag)) != 0UL))
    {
        USDHC_TransferHandleCardDetect(base, handle, interruptFlags);
    }
    if ((((interruptFlags) & ((uint32_t)kUSDHC_CommandFlag)) != 0UL))
    {
        USDHC_TransferHandleCommand(base, handle, interruptFlags);
    }
    if ((((interruptFlags) & ((uint32_t)kUSDHC_DataFlag)) != 0UL))
    {
        USDHC_TransferHandleData(base, handle, interruptFlags);
    }
    if ((((interruptFlags) & ((uint32_t)kUSDHC_CardInterruptFlag)) != 0UL))
    {
        USDHC_TransferHandleSdioInterrupt(base, handle);
    }
    if ((((interruptFlags) & ((uint32_t)kUSDHC_BlockGapEventFlag)) != 0UL))
    {
        USDHC_TransferHandleBlockGap(base, handle);
    }

    if ((((interruptFlags) & ((uint32_t)kUSDHC_SDR104TuningFlag)) != 0UL))
    {
...
# 2464 "../../libraries/sdk/drives/fsl_usdhc.c"
