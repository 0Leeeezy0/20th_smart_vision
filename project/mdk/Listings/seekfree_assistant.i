# 1 "../../libraries/zf_components/seekfree_assistant.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/zf_components/seekfree_assistant.c" 2
# 36 "../../libraries/zf_components/seekfree_assistant.c"
...
# 37 "../../libraries/zf_components/seekfree_assistant.c" 2
...
# 39 "../../libraries/zf_components/seekfree_assistant.c" 2
...
# 46 "../../libraries/zf_components/seekfree_assistant.c" 2
static uint8 seekfree_assistant_buffer[( 0x80 )];
...
static seekfree_assistant_camera_dot_struct seekfree_assistant_camera_dot_data;
static seekfree_assistant_camera_buffer_struct seekfree_assistant_camera_buffer;
...
float seekfree_assistant_parameter[( 0x08 )] = {0};
vuint8 seekfree_assistant_parameter_update_flag[( 0x08 )] = {0};
# 77 "../../libraries/zf_components/seekfree_assistant.c"
...
# 99 "../../libraries/zf_components/seekfree_assistant.c"
void seekfree_assistant_camera_data_send (seekfree_assistant_image_type_enum camera_type, void *image_addr, uint8 boundary_num, uint16 width, uint16 height)
{
    ...
    seekfree_assistant_camera_data.head = ( 0xAA );
    seekfree_assistant_camera_data.function = ( 0x02 );
    seekfree_assistant_camera_data.camera_type = (camera_type << 5) | ((image_addr != 0 ? 0 : 1) << 4) | boundary_num;
...
# 151 "../../libraries/zf_components/seekfree_assistant.c"
...
void seekfree_assistant_oscilloscope_send (seekfree_assistant_oscilloscope_struct *seekfree_assistant_oscilloscope)
{
    ...
    (debug_assert_handler((( 0x08 ) >= seekfree_assistant_oscilloscope->channel_num), "../../libraries/zf_components/seekfree_assistant.c", 197));


    seekfree_assistant_oscilloscope->head = ( 0xAA );


    packet_size = sizeof(seekfree_assistant_oscilloscope_struct) - (( 0x08 ) - seekfree_assistant_oscilloscope->channel_num) * 4;
    seekfree_assistant_oscilloscope->length = packet_size;


    seekfree_assistant_oscilloscope->channel_num |= ( 0x10 );
...
# 228 "../../libraries/zf_components/seekfree_assistant.c"
void seekfree_assistant_camera_information_config (seekfree_assistant_image_type_enum camera_type, void *image_addr, uint16 width, uint16 height)
{
    seekfree_assistant_camera_dot_data.head = ( 0xAA );
    seekfree_assistant_camera_dot_data.function = ( 0x03 );
...
# 257 "../../libraries/zf_components/seekfree_assistant.c"
void seekfree_assistant_camera_boundary_config (seekfree_assistant_boundary_type_enum boundary_type, uint16 dot_num, void *dot_x1, void *dot_x2, void *dot_x3, void *dot_y1, void *dot_y2, void *dot_y3)
{
    uint8 i = 0;
    ...
    (debug_assert_handler((0 != seekfree_assistant_camera_buffer.camera_type), "../../libraries/zf_components/seekfree_assistant.c", 264));

    seekfree_assistant_camera_dot_data.dot_num = dot_num;
    seekfree_assistant_camera_dot_data.valid_flag = 0;
    for(i = 0; i < 3; i++)
    {
        seekfree_assistant_camera_buffer.boundary_x[i] = 0;
        seekfree_assistant_camera_buffer.boundary_y[i] = 0;
    }
...
# 373 "../../libraries/zf_components/seekfree_assistant.c"
void seekfree_assistant_camera_send (void)
{

    (debug_assert_handler((0 != seekfree_assistant_camera_buffer.camera_type), "../../libraries/zf_components/seekfree_assistant.c", 376));
...
# 394 "../../libraries/zf_components/seekfree_assistant.c"
void seekfree_assistant_data_analysis (void)
{
    uint8 temp_sum;
    uint32 read_length;
    ...
    uint32 temp_buffer[( 0x80 ) / 4];


    read_length = seekfree_assistant_receive_callback((uint8 *)temp_buffer, ( 0x80 ));
    if(read_length)
    {
