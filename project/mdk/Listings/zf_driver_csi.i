# 1 "../../libraries/zf_driver/zf_driver_csi.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/zf_driver/zf_driver_csi.c" 2
# 36 "../../libraries/zf_driver/zf_driver_csi.c"
...
# 37 "../../libraries/zf_driver/zf_driver_csi.c" 2
# 1 "../../libraries/zf_driver/zf_driver_gpio.h" 1
# 40 "../../libraries/zf_driver/zf_driver_gpio.h"
...
# 41 "../../libraries/zf_driver/zf_driver_gpio.h" 2
...
# 38 "../../libraries/zf_driver/zf_driver_csi.c" 2
...
# 40 "../../libraries/zf_driver/zf_driver_csi.c" 2
...
void csi_iomuxc(vsync_pin_enum vsync, pixclk_pin_enum pixclk)
{
    ...
    afio_init(0x401F811CU, 0x4U, 0x401F841CU, 0x0U, 0x401F830CU, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);
    afio_init(0x401F8120U, 0x4U, 0x401F8418U, 0x0U, 0x401F8310U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);
    afio_init(0x401F8124U, 0x4U, 0x401F8414U, 0x0U, 0x401F8314U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);
    afio_init(0x401F8128U, 0x4U, 0x401F8410U, 0x0U, 0x401F8318U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);
    afio_init(0x401F812CU, 0x4U, 0x401F840CU, 0x0U, 0x401F831CU, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);
    afio_init(0x401F8130U, 0x4U, 0x401F8408U, 0x0U, 0x401F8320U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);
    afio_init(0x401F8134U, 0x4U, 0x401F8404U, 0x0U, 0x401F8324U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);
    afio_init(0x401F8138U, 0x4U, 0x401F8400U, 0x0U, 0x401F8328U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);

    if (CSI_VSYNC_B14 == vsync) afio_init(0x401F80F4U, 0x4U, 0x401F8428U, 0x0U, 0x401F82E4U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);
    else if (CSI_VSYNC_B22 == vsync) afio_init(0x401F8114U, 0x4U, 0x401F8428U, 0x1U, 0x401F8304U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);
    else if (CSI_VSYNC_C29 == vsync) afio_init(0x401F81B0U, 0x2U, 0x401F8428U, 0x2U, 0x401F83A0U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);

    if (CSI_PIXCLK_B20 == pixclk) afio_init(0x401F810CU, 0x4U, 0x401F8424U, 0x0U, 0x401F82FCU, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);
    else if (CSI_PIXCLK_C28 == pixclk) afio_init(0x401F81ACU, 0x2U, 0x401F8424U, 0x1U, 0x401F839CU, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);
}
# 74 "../../libraries/zf_driver/zf_driver_csi.c"
void csi_add_empty_buffer(csi_handle_t *handle, uint8 *buff)
{
    CSI_TransferSubmitEmptyBuffer(((CSI_Type *)(0x402BC000u)),handle,(uint32_t)buff);
}
# 87 "../../libraries/zf_driver/zf_driver_csi.c"
uint8 csi_get_full_buffer(csi_handle_t *handle, uint32 *buffaddr)
{
    if(kStatus_Success == CSI_TransferGetFullBuffer(((CSI_Type *)(0x402BC000u)),handle,(uint32_t *)buffaddr))
    {
        return 1;
    }
    return 0;
}
# 103 "../../libraries/zf_driver/zf_driver_csi.c"
void csi_start(csi_handle_t *handle)
{
    CSI_TransferStart(((CSI_Type *)(0x402BC000u)),handle);
}
# 115 "../../libraries/zf_driver/zf_driver_csi.c"
void csi_stop(csi_handle_t *handle)
{
    CSI_TransferStop(((CSI_Type *)(0x402BC000u)),handle);
}
# 130 "../../libraries/zf_driver/zf_driver_csi.c"
void csi_init(uint16 width, uint16 height, csi_handle_t *handle, csi_transfer_callback_t callback, vsync_pin_enum vsync, pixclk_pin_enum pixclk, pixclk_polarity_enum pixclk_polarity)
{
    uint16 i;
    uint32 pixel_num;
    ...
    if(pixel_num%8) ((0) ? (void)0 : __aeabi_assert("0", "../../libraries/zf_driver/zf_driver_csi.c", 146),
# 146 "../../libraries/zf_driver/zf_driver_csi.c"
#pragma clang diagnostic push
# 146 "../../libraries/zf_driver/zf_driver_csi.c"
#pragma clang diagnostic ignored "-Wassume"
# 146 "../../libraries/zf_driver/zf_driver_csi.c"
...
# 146 "../../libraries/zf_driver/zf_driver_csi.c"
    ...
    csi_config.useExtVsync = 1;
    CSI_Init(((CSI_Type *)(0x402BC000u)), &csi_config);
    CSI_TransferCreateHandle(((CSI_Type *)(0x402BC000u)),handle, callback, 0);
}
