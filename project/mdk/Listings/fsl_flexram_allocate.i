# 1 "../../libraries/sdk/drives/fsl_flexram_allocate.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/sdk/drives/fsl_flexram_allocate.c" 2
...
# 12 "../../libraries/sdk/drives/fsl_flexram_allocate.h"
...
# 13 "../../libraries/sdk/drives/fsl_flexram_allocate.h" 2
...
# 10 "../../libraries/sdk/drives/fsl_flexram_allocate.c" 2
# 39 "../../libraries/sdk/drives/fsl_flexram_allocate.c"
status_t FLEXRAM_AllocateRam(flexram_allocate_ram_t *config)
{
    ((config != 0) ? (void)0 : __aeabi_assert("config != NULL", "../../libraries/sdk/drives/fsl_flexram_allocate.c", 41),
# 41 "../../libraries/sdk/drives/fsl_flexram_allocate.c"
#pragma clang diagnostic push
# 41 "../../libraries/sdk/drives/fsl_flexram_allocate.c"
#pragma clang diagnostic ignored "-Wassume"
# 41 "../../libraries/sdk/drives/fsl_flexram_allocate.c"
...
# 41 "../../libraries/sdk/drives/fsl_flexram_allocate.c"
    ...
    if ((uint8_t)(16) < (dtcmBankNum + itcmBankNum + ocramBankNum))
    {
    ...
    else
    {
        ...
        ((IOMUXC_GPR_Type *)(0x400AC000u))->GPR17 = bankCfg;
