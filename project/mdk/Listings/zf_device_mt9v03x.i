# 1 "../../libraries/zf_device/zf_device_mt9v03x.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/zf_device/zf_device_mt9v03x.c" 2
# 50 "../../libraries/zf_device/zf_device_mt9v03x.c"
...
# 51 "../../libraries/zf_device/zf_device_mt9v03x.c" 2
...
# 52 "../../libraries/zf_device/zf_device_mt9v03x.c" 2
...
# 53 "../../libraries/zf_device/zf_device_mt9v03x.c" 2
...
# 54 "../../libraries/zf_device/zf_device_mt9v03x.c" 2
...
# 55 "../../libraries/zf_device/zf_device_mt9v03x.c" 2
...
# 56 "../../libraries/zf_device/zf_device_mt9v03x.c" 2
...
# 57 "../../libraries/zf_device/zf_device_mt9v03x.c" 2
...
# 58 "../../libraries/zf_device/zf_device_mt9v03x.c" 2
...
# 59 "../../libraries/zf_device/zf_device_mt9v03x.c" 2
...
# 60 "../../libraries/zf_device/zf_device_mt9v03x.c" 2
...
# 62 "../../libraries/zf_device/zf_device_mt9v03x.c" 2

vuint8 mt9v03x_finish_flag = 0;

__attribute__((section(".bss.NonCacheable"))) __attribute__((aligned(64))) uint8 mt9v03x_image1[(120)][(160)];
__attribute__((section(".bss.NonCacheable"))) __attribute__((aligned(64))) uint8 mt9v03x_image2[(120)][(160)];




uint8 (*mt9v03x_image)[(160)];
...
# 115 "../../libraries/zf_device/zf_device_mt9v03x.c"
...
# 169 "../../libraries/zf_device/zf_device_mt9v03x.c"
...
# 225 "../../libraries/zf_device/zf_device_mt9v03x.c"
uint16 mt9v03x_get_version (void)
{
    uint16 temp = 0;
    uint8 uart_buffer[4];
...
# 263 "../../libraries/zf_device/zf_device_mt9v03x.c"
uint8 mt9v03x_set_exposure_time (uint16 light)
{
    uint8 return_state = 0;
...
# 312 "../../libraries/zf_device/zf_device_mt9v03x.c"
uint8 mt9v03x_set_reg (uint8 addr, uint16 data)
{
    uint8 return_state = 0;
    if(MT9V03X_UART == mt9v03x_type)
...
# 368 "../../libraries/zf_device/zf_device_mt9v03x.c"
...
# 389 "../../libraries/zf_device/zf_device_mt9v03x.c"
...
uint8 mt9v03x_init (void)
{
    ...
    {
        system_delay_ms(200);
        set_camera_type(CAMERA_GRAYSCALE, 0, 0, 0);

        mt9v03x_type = MT9V03X_SCCB;
        soft_iic_init(&mt9v03x_iic_struct, 0, (800), (C29), (C28));
        if(mt9v03x_set_config_sccb(&mt9v03x_iic_struct, mt9v03x_set_confing_buffer))
        {

            mt9v03x_type = MT9V03X_UART;
            camera_fifo_init();
            set_camera_type(CAMERA_GRAYSCALE, 0, 0, &mt9v03x_uart_callback);
            ...
            if(mt9v03x_set_config(mt9v03x_set_confing_buffer))
            {
                ...
                (debug_log_handler((0), ("MT9V03X set config error."), "../../libraries/zf_device/zf_device_mt9v03x.c", 442));
            ...
            if(mt9v03x_get_config(mt9v03x_get_confing_buffer))
            {
                ...
                (debug_log_handler((0), ("MT9V03X get config error."), "../../libraries/zf_device/zf_device_mt9v03x.c", 454));
                set_camera_type(NO_CAMERE, 0, 0, 0);
                return_state = 1;
                break;
            }
        ...
        csi_init((160), (120), &csi_handle, mt9v03x_finished_callback, (CSI_VSYNC_B22), (CSI_PIXCLK_B20), CSI_PIXCLK_RISING);
        csi_add_empty_buffer(&csi_handle, mt9v03x_image1[0]);
        csi_add_empty_buffer(&csi_handle, mt9v03x_image2[0]);
