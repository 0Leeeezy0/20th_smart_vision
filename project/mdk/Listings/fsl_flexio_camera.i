# 1 "../../libraries/sdk/drives/fsl_flexio_camera.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/sdk/drives/fsl_flexio_camera.c" 2
...
# 10 "../../libraries/sdk/drives/fsl_flexio_camera.c" 2
# 28 "../../libraries/sdk/drives/fsl_flexio_camera.c"
static uint32_t FLEXIO_CAMERA_GetInstance(FLEXIO_CAMERA_Type *base)
{
    return FLEXIO_GetInstance(base->flexioBase);
}
# 43 "../../libraries/sdk/drives/fsl_flexio_camera.c"
void FLEXIO_CAMERA_GetDefaultConfig(flexio_camera_config_t *config)
{
    ((config != 0) ? (void)0 : __aeabi_assert("config != NULL", "../../libraries/sdk/drives/fsl_flexio_camera.c", 45),
# 45 "../../libraries/sdk/drives/fsl_flexio_camera.c"
#pragma clang diagnostic push
# 45 "../../libraries/sdk/drives/fsl_flexio_camera.c"
#pragma clang diagnostic ignored "-Wassume"
# 45 "../../libraries/sdk/drives/fsl_flexio_camera.c"
...
# 45 "../../libraries/sdk/drives/fsl_flexio_camera.c"
    ...
    config->enablecamera = 0;
    config->enableInDoze = 0;
    config->enableInDebug = 0;
    config->enableFastAccess = 0;
}
...
void FLEXIO_CAMERA_Init(FLEXIO_CAMERA_Type *base, const flexio_camera_config_t *config)
{
    (((base != 0) && (config != 0)) ? (void)0 : __aeabi_assert("(base != NULL) && (config != NULL)", "../../libraries/sdk/drives/fsl_flexio_camera.c", 64),
# 64 "../../libraries/sdk/drives/fsl_flexio_camera.c"
#pragma clang diagnostic push
# 64 "../../libraries/sdk/drives/fsl_flexio_camera.c"
#pragma clang diagnostic ignored "-Wassume"
# 64 "../../libraries/sdk/drives/fsl_flexio_camera.c"
...
# 64 "../../libraries/sdk/drives/fsl_flexio_camera.c"
    ...
    ((base->shifterCount > 0U) ? (void)0 : __aeabi_assert("base->shifterCount > 0U", "../../libraries/sdk/drives/fsl_flexio_camera.c", 65),
# 65 "../../libraries/sdk/drives/fsl_flexio_camera.c"
#pragma clang diagnostic push
# 65 "../../libraries/sdk/drives/fsl_flexio_camera.c"
#pragma clang diagnostic ignored "-Wassume"
# 65 "../../libraries/sdk/drives/fsl_flexio_camera.c"
    (__builtin_assume)((base->shifterCount > 0U)?1:0)
# 65 "../../libraries/sdk/drives/fsl_flexio_camera.c"
#pragma clang diagnostic pop
# 65 "../../libraries/sdk/drives/fsl_flexio_camera.c"
    );
    ...
    controlVal |= ((((uint32_t)(((uint32_t)(config->enableInDebug)) << (30U))) & (0x40000000U)) | (((uint32_t)(((uint32_t)(config->enableFastAccess)) << (2U))) & (0x4U)) |
                   (((uint32_t)(((uint32_t)(config->enablecamera)) << (0U))) & (0x1U)));
    ...
    shifterConfig.parallelWidth = (8U) - 1U;
    ...
    timerConfig.triggerSelect = ((uint32_t)(base->hrefPinIdx) << 1U);
...
# 144 "../../libraries/sdk/drives/fsl_flexio_camera.c"
void FLEXIO_CAMERA_Deinit(FLEXIO_CAMERA_Type *base)
{
...
# 165 "../../libraries/sdk/drives/fsl_flexio_camera.c"
uint32_t FLEXIO_CAMERA_GetStatusFlags(FLEXIO_CAMERA_Type *base)
{
    uint32_t status = 0;
...
# 182 "../../libraries/sdk/drives/fsl_flexio_camera.c"
void FLEXIO_CAMERA_ClearStatusFlags(FLEXIO_CAMERA_Type *base, uint32_t mask)
{
