# 1 "../../libraries/zf_driver/zf_driver_sdio.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/zf_driver/zf_driver_sdio.c" 2
# 37 "../../libraries/zf_driver/zf_driver_sdio.c"
...
# 38 "../../libraries/zf_driver/zf_driver_sdio.c" 2
# 1 "../../libraries/components/fatfs/source/fsl_sd_disk\\fsl_sd_disk.h" 1
# 14 "../../libraries/components/fatfs/source/fsl_sd_disk\\fsl_sd_disk.h"
...
# 15 "../../libraries/components/fatfs/source/fsl_sd_disk\\fsl_sd_disk.h" 2
...
# 16 "../../libraries/components/fatfs/source/fsl_sd_disk\\fsl_sd_disk.h" 2
...
# 39 "../../libraries/zf_driver/zf_driver_sdio.c" 2
...
# 41 "../../libraries/zf_driver/zf_driver_sdio.c" 2
...
# 42 "../../libraries/zf_driver/zf_driver_sdio.c" 2
...
# 43 "../../libraries/zf_driver/zf_driver_sdio.c" 2
...
# 44 "../../libraries/zf_driver/zf_driver_sdio.c" 2
...
# 45 "../../libraries/zf_driver/zf_driver_sdio.c" 2
...
# 46 "../../libraries/zf_driver/zf_driver_sdio.c" 2

# 1 "../../libraries/zf_driver/zf_driver_sdio.h" 1
# 42 "../../libraries/zf_driver/zf_driver_sdio.h"
void sdio_init (void);
# 48 "../../libraries/zf_driver/zf_driver_sdio.c" 2
...
void sdhc_iomuxc(void)
{
    ...
    gpio_iomuxc(B23, SPEED_200MHZ | KEEPER_EN | PULLDOWN_100K | DSE_R0_6);
    gpio_iomuxc(D4 , SPEED_200MHZ | PULL_EN | PULLUP_47K | DSE_R0 | SRE_FAST);

    afio_init(0x401F81B4U, 0x6U, 0, 0, 0x401F83A4U, 0, SPEED_200MHZ | PULL_EN | PULLUP_47K | DSE_R0 | SRE_FAST);
    afio_init(0x401F81BCU, 0x0U, 0, 0, 0x401F83ACU, 0, SPEED_200MHZ | PULL_EN | PULLUP_47K | DSE_R0 | SRE_FAST);
    afio_init(0x401F81C0U, 0x0U, 0, 0, 0x401F83B0U, 0, SPEED_200MHZ | PULL_EN | PULLUP_47K | DSE_R0 | SRE_FAST);
    afio_init(0x401F81C4U, 0x0U, 0, 0, 0x401F83B4U, 0, SPEED_200MHZ | PULL_EN | PULLUP_47K | DSE_R0 | SRE_FAST);
    afio_init(0x401F81C8U, 0x0U, 0, 0, 0x401F83B8U, 0, SPEED_200MHZ | PULL_EN | PULLUP_47K | DSE_R0 | SRE_FAST);
    afio_init(0x401F81CCU, 0x0U, 0, 0, 0x401F83BCU, 0, SPEED_200MHZ | PULL_EN | PULLUP_47K | DSE_R0 | SRE_FAST);
    afio_init(0x401F81D0U, 0x0U, 0, 0, 0x401F83C0U, 0, SPEED_200MHZ | PULL_EN | PULLUP_47K | DSE_R0 | SRE_FAST);
}
# 73 "../../libraries/zf_driver/zf_driver_sdio.c"
void sdio_init (void)
{

    sdhc_iomuxc();

    BOARD_SD_Config(&g_sd, 0, (5U), 0);

    if (SD_HostInit(&g_sd) != kStatus_Success)
    {
        (debug_assert_handler((0), "../../libraries/zf_driver/zf_driver_sdio.c", 82));
    }

    if (SD_PollingCardInsert(&g_sd, kSD_Inserted) == kStatus_Success)
    {
        SD_SetCardPower(&g_sd, 0);
        SD_SetCardPower(&g_sd, 1);
    }
    else
    {
        (debug_assert_handler((0), "../../libraries/zf_driver/zf_driver_sdio.c", 92));
    }
}
