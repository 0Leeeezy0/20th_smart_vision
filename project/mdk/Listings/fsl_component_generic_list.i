# 1 "../../libraries/sdk/components/lists/fsl_component_generic_list.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/sdk/components/lists/fsl_component_generic_list.c" 2
# 14 "../../libraries/sdk/components/lists/fsl_component_generic_list.c"
...
# 15 "../../libraries/sdk/components/lists/fsl_component_generic_list.c" 2
# 32 "../../libraries/sdk/components/lists/fsl_component_generic_list.c"
static list_status_t LIST_Error_Check(list_handle_t list, list_element_handle_t newElement)
{
    ...
    {
        listStatus = kLIST_Full;
    }
# 57 "../../libraries/sdk/components/lists/fsl_component_generic_list.c"
    return listStatus;
}
# 80 "../../libraries/sdk/components/lists/fsl_component_generic_list.c"
void LIST_Init(list_handle_t list, uint32_t max)
{
    list->head = 0;
    list->tail = 0;
...
# 103 "../../libraries/sdk/components/lists/fsl_component_generic_list.c"
list_handle_t LIST_GetList(list_element_handle_t element)
{
    return element->list;
}
# 124 "../../libraries/sdk/components/lists/fsl_component_generic_list.c"
list_status_t LIST_AddTail(list_handle_t list, list_element_handle_t element)
{
...
# 170 "../../libraries/sdk/components/lists/fsl_component_generic_list.c"
list_status_t LIST_AddHead(list_handle_t list, list_element_handle_t element)
{
    uint32_t regPrimask = DisableGlobalIRQ();;
    list_status_t listStatus = kLIST_Ok;
...
# 191 "../../libraries/sdk/components/lists/fsl_component_generic_list.c"
        element->list = list;
...
# 216 "../../libraries/sdk/components/lists/fsl_component_generic_list.c"
list_element_handle_t LIST_RemoveHead(list_handle_t list)
{
...
# 264 "../../libraries/sdk/components/lists/fsl_component_generic_list.c"
list_element_handle_t LIST_GetHead(list_handle_t list)
{
    return list->head;
}
# 284 "../../libraries/sdk/components/lists/fsl_component_generic_list.c"
list_element_handle_t LIST_GetNext(list_element_handle_t element)
{
    return element->next;
}
# 304 "../../libraries/sdk/components/lists/fsl_component_generic_list.c"
list_element_handle_t LIST_GetPrev(list_element_handle_t element)
{
...
# 328 "../../libraries/sdk/components/lists/fsl_component_generic_list.c"
list_status_t LIST_RemoveElement(list_element_handle_t element)
{
    list_status_t listStatus = kLIST_Ok;
    uint32_t regPrimask = DisableGlobalIRQ();;
...
# 373 "../../libraries/sdk/components/lists/fsl_component_generic_list.c"
        element->list->size--;
        element->list = 0;
    }
...
# 399 "../../libraries/sdk/components/lists/fsl_component_generic_list.c"
list_status_t LIST_AddPrevElement(list_element_handle_t element, list_element_handle_t newElement)
{
    list_status_t listStatus = kLIST_Ok;
    uint32_t regPrimask = DisableGlobalIRQ();;
...
# 450 "../../libraries/sdk/components/lists/fsl_component_generic_list.c"
        }
    }
...
# 471 "../../libraries/sdk/components/lists/fsl_component_generic_list.c"
uint32_t LIST_GetSize(list_handle_t list)
{
    return list->size;
}
# 490 "../../libraries/sdk/components/lists/fsl_component_generic_list.c"
uint32_t LIST_GetAvailableSize(list_handle_t list)
{
