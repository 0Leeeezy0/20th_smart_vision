# 1 "../../libraries/components/sdmmc/common/fsl_sdmmc_common.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/components/sdmmc/common/fsl_sdmmc_common.c" 2
...
# 10 "../../libraries/components/sdmmc/common/fsl_sdmmc_common.c" 2
...
status_t SDMMC_SendApplicationCommand(sdmmchost_t *host, uint32_t relativeAddress)
{
    ...
    if (0U == (command.response[0U] & (1UL << (kSDMMC_R1ApplicationCommandFlag))))
    {
