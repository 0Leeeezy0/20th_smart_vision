# 1 "../../libraries/sdk/drives/fsl_spdif_edma.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/sdk/drives/fsl_spdif_edma.c" 2
# 10 "../../libraries/sdk/drives/fsl_spdif_edma.c"
# 1 "../../libraries/sdk/drives/fsl_spdif_edma.h" 1
# 12 "../../libraries/sdk/drives/fsl_spdif_edma.h"
...
# 13 "../../libraries/sdk/drives/fsl_spdif_edma.h" 2
...
# 14 "../../libraries/sdk/drives/fsl_spdif_edma.h" 2
# 29 "../../libraries/sdk/drives/fsl_spdif_edma.h"
...
# 87 "../../libraries/sdk/drives/fsl_spdif_edma.h"
void SPDIF_TransferTxCreateHandleEDMA(SPDIF_Type *base,
                                      ...
                                      edma_handle_t *dmaLeftHandle,
                                      edma_handle_t *dmaRightHandle);
# 108 "../../libraries/sdk/drives/fsl_spdif_edma.h"
...
static spdif_edma_private_handle_t s_edmaPrivateHandle[(1)][2];
static uint8_t s_spdif_tx_watermark[4] = {16, 12, 8, 4};
static uint8_t s_spdif_rx_watermark[4] = {1, 4, 8, 16};
# 59 "../../libraries/sdk/drives/fsl_spdif_edma.c"
static status_t SPDIF_SubmitTransfer(edma_handle_t *handle,
                                     const edma_transfer_config_t *config,
                                     uint32_t rightChannel);
# 71 "../../libraries/sdk/drives/fsl_spdif_edma.c"
static void SPDIF_TxEDMACallback(edma_handle_t *handle, void *userData, _Bool done, uint32_t tcds);
# 81 "../../libraries/sdk/drives/fsl_spdif_edma.c"
static void SPDIF_RxEDMACallback(edma_handle_t *handle, void *userData, _Bool done, uint32_t tcds);
...
static void SPDIF_TxEDMACallback(edma_handle_t *handle, void *userData, _Bool done, uint32_t tcds)
{
    ...
    spdifHandle->queueDriver = (spdifHandle->queueDriver + 0x01U) % (4U);
    if (spdifHandle->callback != 0)
    {
        (spdifHandle->callback)(privHandle->base, spdifHandle, kStatus_SPDIF_TxIdle, spdifHandle->userData);
    }


    if (spdifHandle->spdifQueue[spdifHandle->queueDriver].rightData == 0)
    {
...
static status_t SPDIF_SubmitTransfer(edma_handle_t *handle, const edma_transfer_config_t *config, uint32_t rightChannel)
{
    ...
    if (currentTcd != previousTcd)
    {
        ...
        csr = (handle->tcdPool[previousTcd].CSR | (uint16_t)(0x10U)) & ~(uint16_t)(0x8U);
        ...
        if (tcdRegs->DLAST_SGA == (uint32_t)&handle->tcdPool[currentTcd])
        {
            ...
            csr = (tcdRegs->CSR | (uint16_t)(0x10U)) & ~(uint16_t)(0x8U);

            tcdRegs->CSR = csr;
# 196 "../../libraries/sdk/drives/fsl_spdif_edma.c"
            if ((tcdRegs->CSR & (0x10U)) != 0x00U)
            {
...
# 256 "../../libraries/sdk/drives/fsl_spdif_edma.c"
void SPDIF_TransferTxCreateHandleEDMA(SPDIF_Type *base,
                                      spdif_edma_handle_t *handle,
                                      spdif_edma_callback_t callback,
                                      void *userData,
                                      ...
                                      edma_handle_t *dmaRightHandle)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_spdif_edma.c", 263),
# 263 "../../libraries/sdk/drives/fsl_spdif_edma.c"
#pragma clang diagnostic push
# 263 "../../libraries/sdk/drives/fsl_spdif_edma.c"
#pragma clang diagnostic ignored "-Wassume"
# 263 "../../libraries/sdk/drives/fsl_spdif_edma.c"
...
# 263 "../../libraries/sdk/drives/fsl_spdif_edma.c"
    ...
    ((dmaLeftHandle != 0) ? (void)0 : __aeabi_assert("dmaLeftHandle != NULL", "../../libraries/sdk/drives/fsl_spdif_edma.c", 264),
# 264 "../../libraries/sdk/drives/fsl_spdif_edma.c"
#pragma clang diagnostic push
# 264 "../../libraries/sdk/drives/fsl_spdif_edma.c"
#pragma clang diagnostic ignored "-Wassume"
# 264 "../../libraries/sdk/drives/fsl_spdif_edma.c"
    (__builtin_assume)((dmaLeftHandle != 0)?1:0)
# 264 "../../libraries/sdk/drives/fsl_spdif_edma.c"
#pragma clang diagnostic pop
# 264 "../../libraries/sdk/drives/fsl_spdif_edma.c"
    );
    ((dmaRightHandle != 0) ? (void)0 : __aeabi_assert("dmaRightHandle != NULL", "../../libraries/sdk/drives/fsl_spdif_edma.c", 265),
# 265 "../../libraries/sdk/drives/fsl_spdif_edma.c"
#pragma clang diagnostic push
# 265 "../../libraries/sdk/drives/fsl_spdif_edma.c"
#pragma clang diagnostic ignored "-Wassume"
# 265 "../../libraries/sdk/drives/fsl_spdif_edma.c"
    (__builtin_assume)((dmaRightHandle != 0)?1:0)
# 265 "../../libraries/sdk/drives/fsl_spdif_edma.c"
#pragma clang diagnostic pop
# 265 "../../libraries/sdk/drives/fsl_spdif_edma.c"
    );
    ...
    EDMA_InstallTCDMemory(dmaLeftHandle, (edma_tcd_t *)(((uint32_t)(handle->leftTcd) + 32U) & ~0x1FU), (4U));
    EDMA_InstallTCDMemory(dmaRightHandle, (edma_tcd_t *)(((uint32_t)(handle->rightTcd) + 32U) & ~0x1FU), (4U));


    EDMA_SetCallback(dmaRightHandle, SPDIF_TxEDMACallback, &s_edmaPrivateHandle[instance][0]);
}
# 308 "../../libraries/sdk/drives/fsl_spdif_edma.c"
void SPDIF_TransferRxCreateHandleEDMA(SPDIF_Type *base,
                                      spdif_edma_handle_t *handle,
                                      spdif_edma_callback_t callback,
                                      void *userData,
                                      ...
                                      edma_handle_t *dmaRightHandle)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_spdif_edma.c", 315),
# 315 "../../libraries/sdk/drives/fsl_spdif_edma.c"
#pragma clang diagnostic push
# 315 "../../libraries/sdk/drives/fsl_spdif_edma.c"
#pragma clang diagnostic ignored "-Wassume"
# 315 "../../libraries/sdk/drives/fsl_spdif_edma.c"
...
# 315 "../../libraries/sdk/drives/fsl_spdif_edma.c"
    ...
    ((dmaLeftHandle != 0) ? (void)0 : __aeabi_assert("dmaLeftHandle != NULL", "../../libraries/sdk/drives/fsl_spdif_edma.c", 316),
# 316 "../../libraries/sdk/drives/fsl_spdif_edma.c"
#pragma clang diagnostic push
# 316 "../../libraries/sdk/drives/fsl_spdif_edma.c"
#pragma clang diagnostic ignored "-Wassume"
# 316 "../../libraries/sdk/drives/fsl_spdif_edma.c"
...
# 316 "../../libraries/sdk/drives/fsl_spdif_edma.c"
    ...
    ((dmaRightHandle != 0) ? (void)0 : __aeabi_assert("dmaRightHandle != NULL", "../../libraries/sdk/drives/fsl_spdif_edma.c", 317),
# 317 "../../libraries/sdk/drives/fsl_spdif_edma.c"
#pragma clang diagnostic push
# 317 "../../libraries/sdk/drives/fsl_spdif_edma.c"
#pragma clang diagnostic ignored "-Wassume"
# 317 "../../libraries/sdk/drives/fsl_spdif_edma.c"
...
# 317 "../../libraries/sdk/drives/fsl_spdif_edma.c"
    ...
    handle->callback = callback;
    handle->userData = userData;
    handle->count = s_spdif_rx_watermark[(base->SCR & (0x180000U)) >> (19U)];
...
# 358 "../../libraries/sdk/drives/fsl_spdif_edma.c"
status_t SPDIF_TransferSendEDMA(SPDIF_Type *base, spdif_edma_handle_t *handle, spdif_edma_transfer_t *xfer)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_spdif_edma.c", 360),
# 360 "../../libraries/sdk/drives/fsl_spdif_edma.c"
#pragma clang diagnostic push
# 360 "../../libraries/sdk/drives/fsl_spdif_edma.c"
#pragma clang diagnostic ignored "-Wassume"
# 360 "../../libraries/sdk/drives/fsl_spdif_edma.c"
...
# 360 "../../libraries/sdk/drives/fsl_spdif_edma.c"
    ...
    ((xfer != 0) ? (void)0 : __aeabi_assert("xfer != NULL", "../../libraries/sdk/drives/fsl_spdif_edma.c", 361),
# 361 "../../libraries/sdk/drives/fsl_spdif_edma.c"
#pragma clang diagnostic push
# 361 "../../libraries/sdk/drives/fsl_spdif_edma.c"
#pragma clang diagnostic ignored "-Wassume"
# 361 "../../libraries/sdk/drives/fsl_spdif_edma.c"
...
# 361 "../../libraries/sdk/drives/fsl_spdif_edma.c"
    ...
    if ((xfer->leftData == 0) || (xfer->dataSize == 0U) || (xfer->rightData == 0))
    {
        return kStatus_InvalidArgument;
    }

    if ((handle->spdifQueue[handle->queueUser].leftData != 0) ||
        (handle->spdifQueue[handle->queueUser].rightData != 0))
    {
    ...
    SPDIF_EnableDMA(base, kSPDIF_TxDMAEnable, 1);
...
# 429 "../../libraries/sdk/drives/fsl_spdif_edma.c"
status_t SPDIF_TransferReceiveEDMA(SPDIF_Type *base, spdif_edma_handle_t *handle, spdif_edma_transfer_t *xfer)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_spdif_edma.c", 431),
# 431 "../../libraries/sdk/drives/fsl_spdif_edma.c"
#pragma clang diagnostic push
# 431 "../../libraries/sdk/drives/fsl_spdif_edma.c"
#pragma clang diagnostic ignored "-Wassume"
# 431 "../../libraries/sdk/drives/fsl_spdif_edma.c"
...
# 431 "../../libraries/sdk/drives/fsl_spdif_edma.c"
    ...
    ((xfer != 0) ? (void)0 : __aeabi_assert("xfer != NULL", "../../libraries/sdk/drives/fsl_spdif_edma.c", 432),
# 432 "../../libraries/sdk/drives/fsl_spdif_edma.c"
#pragma clang diagnostic push
# 432 "../../libraries/sdk/drives/fsl_spdif_edma.c"
#pragma clang diagnostic ignored "-Wassume"
# 432 "../../libraries/sdk/drives/fsl_spdif_edma.c"
...
# 432 "../../libraries/sdk/drives/fsl_spdif_edma.c"
    ...
    SPDIF_EnableDMA(base, kSPDIF_RxDMAEnable, 1);
...
void SPDIF_TransferAbortSendEDMA(SPDIF_Type *base, spdif_edma_handle_t *handle)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_spdif_edma.c", 496),
# 496 "../../libraries/sdk/drives/fsl_spdif_edma.c"
#pragma clang diagnostic push
# 496 "../../libraries/sdk/drives/fsl_spdif_edma.c"
#pragma clang diagnostic ignored "-Wassume"
# 496 "../../libraries/sdk/drives/fsl_spdif_edma.c"
...
# 496 "../../libraries/sdk/drives/fsl_spdif_edma.c"
    ...
    SPDIF_EnableDMA(base, kSPDIF_TxDMAEnable, 0);
...
void SPDIF_TransferAbortReceiveEDMA(SPDIF_Type *base, spdif_edma_handle_t *handle)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_spdif_edma.c", 523),
# 523 "../../libraries/sdk/drives/fsl_spdif_edma.c"
#pragma clang diagnostic push
# 523 "../../libraries/sdk/drives/fsl_spdif_edma.c"
#pragma clang diagnostic ignored "-Wassume"
# 523 "../../libraries/sdk/drives/fsl_spdif_edma.c"
...
# 523 "../../libraries/sdk/drives/fsl_spdif_edma.c"
    ...
    SPDIF_EnableDMA(base, kSPDIF_RxDMAEnable, 0);
...
# 551 "../../libraries/sdk/drives/fsl_spdif_edma.c"
status_t SPDIF_TransferGetSendCountEDMA(SPDIF_Type *base, spdif_edma_handle_t *handle, size_t *count)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_spdif_edma.c", 553),
# 553 "../../libraries/sdk/drives/fsl_spdif_edma.c"
#pragma clang diagnostic push
# 553 "../../libraries/sdk/drives/fsl_spdif_edma.c"
#pragma clang diagnostic ignored "-Wassume"
# 553 "../../libraries/sdk/drives/fsl_spdif_edma.c"
...
# 580 "../../libraries/sdk/drives/fsl_spdif_edma.c"
status_t SPDIF_TransferGetReceiveCountEDMA(SPDIF_Type *base, spdif_edma_handle_t *handle, size_t *count)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_spdif_edma.c", 582),
# 582 "../../libraries/sdk/drives/fsl_spdif_edma.c"
#pragma clang diagnostic push
# 582 "../../libraries/sdk/drives/fsl_spdif_edma.c"
#pragma clang diagnostic ignored "-Wassume"
# 582 "../../libraries/sdk/drives/fsl_spdif_edma.c"
