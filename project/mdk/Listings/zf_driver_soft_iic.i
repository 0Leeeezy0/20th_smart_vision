# 1 "../../libraries/zf_driver/zf_driver_soft_iic.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/zf_driver/zf_driver_soft_iic.c" 2
# 36 "../../libraries/zf_driver/zf_driver_soft_iic.c"
...
# 37 "../../libraries/zf_driver/zf_driver_soft_iic.c" 2
...
# 39 "../../libraries/zf_driver/zf_driver_soft_iic.c" 2
# 63 "../../libraries/zf_driver/zf_driver_soft_iic.c"
static void soft_iic_start (soft_iic_info_struct *soft_iic_obj)
{
    (debug_assert_handler((0 != soft_iic_obj), "../../libraries/zf_driver/zf_driver_soft_iic.c", 65));
    GPIO_SetPinsOutput(PORTPTR[soft_iic_obj->scl_pin >> 5],1 << (soft_iic_obj->scl_pin & 0x1f));
    GPIO_SetPinsOutput(PORTPTR[soft_iic_obj->sda_pin >> 5],1 << (soft_iic_obj->sda_pin & 0x1f));

    for(vuint32 i = soft_iic_obj->delay; i --; );
    GPIO_ClearPinsOutput(PORTPTR[soft_iic_obj->sda_pin >> 5],1 << (soft_iic_obj->sda_pin & 0x1f));
    for(vuint32 i = soft_iic_obj->delay; i --; );
    GPIO_ClearPinsOutput(PORTPTR[soft_iic_obj->scl_pin >> 5],1 << (soft_iic_obj->scl_pin & 0x1f));
    for(vuint32 i = soft_iic_obj->delay; i --; );
}
# 83 "../../libraries/zf_driver/zf_driver_soft_iic.c"
static void soft_iic_stop (soft_iic_info_struct *soft_iic_obj)
{
    (debug_assert_handler((0 != soft_iic_obj), "../../libraries/zf_driver/zf_driver_soft_iic.c", 85));
    GPIO_ClearPinsOutput(PORTPTR[soft_iic_obj->sda_pin >> 5],1 << (soft_iic_obj->sda_pin & 0x1f));
    GPIO_ClearPinsOutput(PORTPTR[soft_iic_obj->scl_pin >> 5],1 << (soft_iic_obj->scl_pin & 0x1f));
...
# 104 "../../libraries/zf_driver/zf_driver_soft_iic.c"
static void soft_iic_send_ack (soft_iic_info_struct *soft_iic_obj, uint8 ack)
{
    (debug_assert_handler((0 != soft_iic_obj), "../../libraries/zf_driver/zf_driver_soft_iic.c", 106));
    GPIO_ClearPinsOutput(PORTPTR[soft_iic_obj->scl_pin >> 5],1 << (soft_iic_obj->scl_pin & 0x1f));
...
# 132 "../../libraries/zf_driver/zf_driver_soft_iic.c"
static uint8 soft_iic_wait_ack (soft_iic_info_struct *soft_iic_obj)
{
    (debug_assert_handler((0 != soft_iic_obj), "../../libraries/zf_driver/zf_driver_soft_iic.c", 134));
    uint8 temp = 0;
    GPIO_ClearPinsOutput(PORTPTR[soft_iic_obj->scl_pin >> 5],1 << (soft_iic_obj->scl_pin & 0x1f));
    GPIO_SetPinsOutput(PORTPTR[soft_iic_obj->sda_pin >> 5],1 << (soft_iic_obj->sda_pin & 0x1f));
...
# 166 "../../libraries/zf_driver/zf_driver_soft_iic.c"
static uint8 soft_iic_send_data (soft_iic_info_struct *soft_iic_obj, const uint8 data)
{
    (debug_assert_handler((0 != soft_iic_obj), "../../libraries/zf_driver/zf_driver_soft_iic.c", 168));
    uint8 temp = 0x80;
    while(temp)
    {

        ((data & temp) ? (GPIO_SetPinsOutput(PORTPTR[soft_iic_obj->sda_pin >> 5],1 << (soft_iic_obj->sda_pin & 0x1f))) : (GPIO_ClearPinsOutput(PORTPTR[soft_iic_obj->sda_pin >> 5],1 << (soft_iic_obj->sda_pin & 0x1f))));
        temp >>= 1;

        for(vuint32 i = soft_iic_obj->delay / 2; i --; );
        GPIO_SetPinsOutput(PORTPTR[soft_iic_obj->scl_pin >> 5],1 << (soft_iic_obj->scl_pin & 0x1f));
        for(vuint32 i = soft_iic_obj->delay; i --; );
        GPIO_ClearPinsOutput(PORTPTR[soft_iic_obj->scl_pin >> 5],1 << (soft_iic_obj->scl_pin & 0x1f));
        for(vuint32 i = soft_iic_obj->delay / 2; i --; );
...
# 192 "../../libraries/zf_driver/zf_driver_soft_iic.c"
static uint8 soft_iic_read_data (soft_iic_info_struct *soft_iic_obj, uint8 ack)
{
    (debug_assert_handler((0 != soft_iic_obj), "../../libraries/zf_driver/zf_driver_soft_iic.c", 194));
    uint8 data = 0x00;
    uint8 temp = 8;
    GPIO_ClearPinsOutput(PORTPTR[soft_iic_obj->scl_pin >> 5],1 << (soft_iic_obj->scl_pin & 0x1f));
    for(vuint32 i = soft_iic_obj->delay; i --; );
...
# 229 "../../libraries/zf_driver/zf_driver_soft_iic.c"
void soft_iic_write_8bit (soft_iic_info_struct *soft_iic_obj, const uint8 data)
{
    (debug_assert_handler((0 != soft_iic_obj), "../../libraries/zf_driver/zf_driver_soft_iic.c", 231));
...
# 247 "../../libraries/zf_driver/zf_driver_soft_iic.c"
void soft_iic_write_8bit_array (soft_iic_info_struct *soft_iic_obj, const uint8 *data, uint32 len)
{
    (debug_assert_handler((0 != soft_iic_obj), "../../libraries/zf_driver/zf_driver_soft_iic.c", 249));
    (debug_assert_handler((0 != data), "../../libraries/zf_driver/zf_driver_soft_iic.c", 250));
    soft_iic_start(soft_iic_obj);
    soft_iic_send_data(soft_iic_obj, soft_iic_obj->addr << 1);
    while(len --)
    {
...
# 268 "../../libraries/zf_driver/zf_driver_soft_iic.c"
void soft_iic_write_16bit (soft_iic_info_struct *soft_iic_obj, const uint16 data)
{
    (debug_assert_handler((0 != soft_iic_obj), "../../libraries/zf_driver/zf_driver_soft_iic.c", 270));
    soft_iic_start(soft_iic_obj);
    soft_iic_send_data(soft_iic_obj, soft_iic_obj->addr << 1);
...
# 287 "../../libraries/zf_driver/zf_driver_soft_iic.c"
void soft_iic_write_16bit_array (soft_iic_info_struct *soft_iic_obj, const uint16 *data, uint32 len)
{
    (debug_assert_handler((0 != soft_iic_obj), "../../libraries/zf_driver/zf_driver_soft_iic.c", 289));
    (debug_assert_handler((0 != data), "../../libraries/zf_driver/zf_driver_soft_iic.c", 290));
    soft_iic_start(soft_iic_obj);
    soft_iic_send_data(soft_iic_obj, soft_iic_obj->addr << 1);
    while(len --)
    {
...
# 310 "../../libraries/zf_driver/zf_driver_soft_iic.c"
void soft_iic_write_8bit_register (soft_iic_info_struct *soft_iic_obj, const uint8 register_name, const uint8 data)
{
    (debug_assert_handler((0 != soft_iic_obj), "../../libraries/zf_driver/zf_driver_soft_iic.c", 312));
    soft_iic_start(soft_iic_obj);
    soft_iic_send_data(soft_iic_obj, soft_iic_obj->addr << 1);
...
# 330 "../../libraries/zf_driver/zf_driver_soft_iic.c"
void soft_iic_write_8bit_registers (soft_iic_info_struct *soft_iic_obj, const uint8 register_name, const uint8 *data, uint32 len)
{
    (debug_assert_handler((0 != soft_iic_obj), "../../libraries/zf_driver/zf_driver_soft_iic.c", 332));
    (debug_assert_handler((0 != data), "../../libraries/zf_driver/zf_driver_soft_iic.c", 333));
    soft_iic_start(soft_iic_obj);
    soft_iic_send_data(soft_iic_obj, soft_iic_obj->addr << 1);
    soft_iic_send_data(soft_iic_obj, register_name);
    while(len --)
...
# 353 "../../libraries/zf_driver/zf_driver_soft_iic.c"
void soft_iic_write_16bit_register (soft_iic_info_struct *soft_iic_obj, const uint16 register_name, const uint16 data)
{
    (debug_assert_handler((0 != soft_iic_obj), "../../libraries/zf_driver/zf_driver_soft_iic.c", 355));
    soft_iic_start(soft_iic_obj);
    soft_iic_send_data(soft_iic_obj, soft_iic_obj->addr << 1);
...
# 375 "../../libraries/zf_driver/zf_driver_soft_iic.c"
void soft_iic_write_16bit_registers (soft_iic_info_struct *soft_iic_obj, const uint16 register_name, const uint16 *data, uint32 len)
{
    (debug_assert_handler((0 != soft_iic_obj), "../../libraries/zf_driver/zf_driver_soft_iic.c", 377));
    (debug_assert_handler((0 != data), "../../libraries/zf_driver/zf_driver_soft_iic.c", 378));
    soft_iic_start(soft_iic_obj);
    soft_iic_send_data(soft_iic_obj, soft_iic_obj->addr << 1);
    soft_iic_send_data(soft_iic_obj, (uint8)((register_name & 0xFF00) >> 8));
    soft_iic_send_data(soft_iic_obj, (uint8)(register_name & 0x00FF));
...
# 398 "../../libraries/zf_driver/zf_driver_soft_iic.c"
uint8 soft_iic_read_8bit (soft_iic_info_struct *soft_iic_obj)
{
    (debug_assert_handler((0 != soft_iic_obj), "../../libraries/zf_driver/zf_driver_soft_iic.c", 400));
    uint8 temp = 0;
    soft_iic_start(soft_iic_obj);
...
# 419 "../../libraries/zf_driver/zf_driver_soft_iic.c"
void soft_iic_read_8bit_array (soft_iic_info_struct *soft_iic_obj, uint8 *data, uint32 len)
{
    (debug_assert_handler((0 != soft_iic_obj), "../../libraries/zf_driver/zf_driver_soft_iic.c", 421));
    (debug_assert_handler((0 != data), "../../libraries/zf_driver/zf_driver_soft_iic.c", 422));
    soft_iic_start(soft_iic_obj);
    soft_iic_send_data(soft_iic_obj, soft_iic_obj->addr << 1 | 0x01);
    while(len --)
    {
...
# 440 "../../libraries/zf_driver/zf_driver_soft_iic.c"
uint16 soft_iic_read_16bit (soft_iic_info_struct *soft_iic_obj)
{
    (debug_assert_handler((0 != soft_iic_obj), "../../libraries/zf_driver/zf_driver_soft_iic.c", 442));
    uint16 temp = 0;
    soft_iic_start(soft_iic_obj);
    soft_iic_send_data(soft_iic_obj, soft_iic_obj->addr << 1 | 0x01);
...
# 461 "../../libraries/zf_driver/zf_driver_soft_iic.c"
void soft_iic_read_16bit_array (soft_iic_info_struct *soft_iic_obj, uint16 *data, uint32 len)
{
    (debug_assert_handler((0 != soft_iic_obj), "../../libraries/zf_driver/zf_driver_soft_iic.c", 463));
    (debug_assert_handler((0 != data), "../../libraries/zf_driver/zf_driver_soft_iic.c", 464));
    soft_iic_start(soft_iic_obj);
    soft_iic_send_data(soft_iic_obj, soft_iic_obj->addr << 1 | 0x01);
    while(len --)
    {
...
# 484 "../../libraries/zf_driver/zf_driver_soft_iic.c"
uint8 soft_iic_read_8bit_register (soft_iic_info_struct *soft_iic_obj, const uint8 register_name)
{
    (debug_assert_handler((0 != soft_iic_obj), "../../libraries/zf_driver/zf_driver_soft_iic.c", 486));
    uint8 temp = 0;
    soft_iic_start(soft_iic_obj);
    soft_iic_send_data(soft_iic_obj, soft_iic_obj->addr << 1);
    soft_iic_send_data(soft_iic_obj, register_name);
...
# 508 "../../libraries/zf_driver/zf_driver_soft_iic.c"
void soft_iic_read_8bit_registers (soft_iic_info_struct *soft_iic_obj, const uint8 register_name, uint8 *data, uint32 len)
{
    (debug_assert_handler((0 != soft_iic_obj), "../../libraries/zf_driver/zf_driver_soft_iic.c", 510));
    (debug_assert_handler((0 != data), "../../libraries/zf_driver/zf_driver_soft_iic.c", 511));
    soft_iic_start(soft_iic_obj);
    soft_iic_send_data(soft_iic_obj, soft_iic_obj->addr << 1);
    soft_iic_send_data(soft_iic_obj, register_name);
    soft_iic_start(soft_iic_obj);
...
# 532 "../../libraries/zf_driver/zf_driver_soft_iic.c"
uint16 soft_iic_read_16bit_register (soft_iic_info_struct *soft_iic_obj, const uint16 register_name)
{
    (debug_assert_handler((0 != soft_iic_obj), "../../libraries/zf_driver/zf_driver_soft_iic.c", 534));
    uint16 temp = 0;
    soft_iic_start(soft_iic_obj);
    soft_iic_send_data(soft_iic_obj, soft_iic_obj->addr << 1);
    soft_iic_send_data(soft_iic_obj, (uint8)((register_name & 0xFF00) >> 8));
...
# 558 "../../libraries/zf_driver/zf_driver_soft_iic.c"
void soft_iic_read_16bit_registers (soft_iic_info_struct *soft_iic_obj, const uint16 register_name, uint16 *data, uint32 len)
{
    (debug_assert_handler((0 != soft_iic_obj), "../../libraries/zf_driver/zf_driver_soft_iic.c", 560));
    (debug_assert_handler((0 != data), "../../libraries/zf_driver/zf_driver_soft_iic.c", 561));
    soft_iic_start(soft_iic_obj);
    soft_iic_send_data(soft_iic_obj, soft_iic_obj->addr << 1);
    soft_iic_send_data(soft_iic_obj, (uint8)((register_name & 0xFF00) >> 8));
    soft_iic_send_data(soft_iic_obj, (uint8)(register_name & 0x00FF));
...
# 588 "../../libraries/zf_driver/zf_driver_soft_iic.c"
void soft_iic_transfer_8bit_array (soft_iic_info_struct *soft_iic_obj, const uint8 *write_data, uint32 write_len, uint8 *read_data, uint32 read_len)
{
    (debug_assert_handler((0 != soft_iic_obj), "../../libraries/zf_driver/zf_driver_soft_iic.c", 590));
    (debug_assert_handler((0 != write_data), "../../libraries/zf_driver/zf_driver_soft_iic.c", 591));
    (debug_assert_handler((0 != read_data), "../../libraries/zf_driver/zf_driver_soft_iic.c", 592));
    soft_iic_start(soft_iic_obj);
    soft_iic_send_data(soft_iic_obj, soft_iic_obj->addr << 1);
    while(write_len --)
    {
...
# 622 "../../libraries/zf_driver/zf_driver_soft_iic.c"
void soft_iic_transfer_16bit_array (soft_iic_info_struct *soft_iic_obj, const uint16 *write_data, uint32 write_len, uint16 *read_data, uint32 read_len)
{
    (debug_assert_handler((0 != soft_iic_obj), "../../libraries/zf_driver/zf_driver_soft_iic.c", 624));
    (debug_assert_handler((0 != write_data), "../../libraries/zf_driver/zf_driver_soft_iic.c", 625));
    (debug_assert_handler((0 != read_data), "../../libraries/zf_driver/zf_driver_soft_iic.c", 626));
    soft_iic_start(soft_iic_obj);
    soft_iic_send_data(soft_iic_obj, soft_iic_obj->addr << 1);
    while(write_len--)
    {
...
# 657 "../../libraries/zf_driver/zf_driver_soft_iic.c"
void soft_iic_sccb_write_register (soft_iic_info_struct *soft_iic_obj, const uint8 register_name, uint8 data)
{
    (debug_assert_handler((0 != soft_iic_obj), "../../libraries/zf_driver/zf_driver_soft_iic.c", 659));
    soft_iic_start(soft_iic_obj);
    soft_iic_send_data(soft_iic_obj, soft_iic_obj->addr << 1);
    soft_iic_send_data(soft_iic_obj, register_name);
    soft_iic_send_data(soft_iic_obj, data);
...
# 675 "../../libraries/zf_driver/zf_driver_soft_iic.c"
uint8 soft_iic_sccb_read_register (soft_iic_info_struct *soft_iic_obj, const uint8 register_name)
{
    (debug_assert_handler((0 != soft_iic_obj), "../../libraries/zf_driver/zf_driver_soft_iic.c", 677));
    uint8 temp = 0;
    soft_iic_start(soft_iic_obj);
    soft_iic_send_data(soft_iic_obj, soft_iic_obj->addr << 1);
    soft_iic_send_data(soft_iic_obj, register_name);
...
# 702 "../../libraries/zf_driver/zf_driver_soft_iic.c"
void soft_iic_init (soft_iic_info_struct *soft_iic_obj, uint8 addr, uint32 delay, gpio_pin_enum scl_pin, gpio_pin_enum sda_pin)
{
    (debug_assert_handler((0 != soft_iic_obj), "../../libraries/zf_driver/zf_driver_soft_iic.c", 704));
    (debug_assert_handler((scl_pin != sda_pin), "../../libraries/zf_driver/zf_driver_soft_iic.c", 705));
