# 1 "../../libraries/zf_device/zf_device_imu963ra.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/zf_device/zf_device_imu963ra.c" 2
# 57 "../../libraries/zf_device/zf_device_imu963ra.c"
...
# 58 "../../libraries/zf_device/zf_device_imu963ra.c" 2
...
# 59 "../../libraries/zf_device/zf_device_imu963ra.c" 2
...
# 60 "../../libraries/zf_device/zf_device_imu963ra.c" 2
...
# 61 "../../libraries/zf_device/zf_device_imu963ra.c" 2
...
# 62 "../../libraries/zf_device/zf_device_imu963ra.c" 2
...
# 64 "../../libraries/zf_device/zf_device_imu963ra.c" 2
...
# 111 "../../libraries/zf_device/zf_device_imu963ra.c"
static void imu963ra_write_acc_gyro_register (uint8 reg, uint8 data)
{
    (0? (GPIO_SetPinsOutput(PORTPTR[C20 >> 5],1 << (C20 & 0x1f))): (GPIO_ClearPinsOutput(PORTPTR[C20 >> 5],1 << (C20 & 0x1f))));
    spi_write_8bit_register((SPI_4 ), reg | ( 0x00 ), data);

    (1? (GPIO_SetPinsOutput(PORTPTR[C20 >> 5],1 << (C20 & 0x1f))): (GPIO_ClearPinsOutput(PORTPTR[C20 >> 5],1 << (C20 & 0x1f))));
}
# 126 "../../libraries/zf_device/zf_device_imu963ra.c"
static uint8 imu963ra_read_acc_gyro_register (uint8 reg)
{
    uint8 data = 0;
    (0? (GPIO_SetPinsOutput(PORTPTR[C20 >> 5],1 << (C20 & 0x1f))): (GPIO_ClearPinsOutput(PORTPTR[C20 >> 5],1 << (C20 & 0x1f))));
    data = spi_read_8bit_register((SPI_4 ), reg | ( 0x80 ));

    (1? (GPIO_SetPinsOutput(PORTPTR[C20 >> 5],1 << (C20 & 0x1f))): (GPIO_ClearPinsOutput(PORTPTR[C20 >> 5],1 << (C20 & 0x1f))));
    return data;
}
# 145 "../../libraries/zf_device/zf_device_imu963ra.c"
static void imu963ra_read_acc_gyro_registers (uint8 reg, uint8 *data, uint32 len)
{
    (0? (GPIO_SetPinsOutput(PORTPTR[C20 >> 5],1 << (C20 & 0x1f))): (GPIO_ClearPinsOutput(PORTPTR[C20 >> 5],1 << (C20 & 0x1f))));
    spi_read_8bit_registers((SPI_4 ), reg | ( 0x80 ), data, len);

    (1? (GPIO_SetPinsOutput(PORTPTR[C20 >> 5],1 << (C20 & 0x1f))): (GPIO_ClearPinsOutput(PORTPTR[C20 >> 5],1 << (C20 & 0x1f))));
}
# 163 "../../libraries/zf_device/zf_device_imu963ra.c"
static uint8 imu963ra_write_mag_register (uint8 addr, uint8 reg, uint8 data)
{
    ...
    addr = addr << 1;
    imu963ra_write_acc_gyro_register(( 0x17 ), 0x00);
    imu963ra_write_acc_gyro_register(( 0x15 ), addr | 0);
    imu963ra_write_acc_gyro_register(( 0x16 ), reg);
    imu963ra_write_acc_gyro_register(( 0x21 ), data);
    imu963ra_write_acc_gyro_register(( 0x14 ), 0x4C);


    while(0 == (0x80 & imu963ra_read_acc_gyro_register(( 0x22 ))))
    {
...
# 196 "../../libraries/zf_device/zf_device_imu963ra.c"
static uint8 imu963ra_read_mag_register (uint8 addr, uint8 reg)
{
    uint16 timeout_count = 0;

    addr = addr << 1;
    imu963ra_write_acc_gyro_register(( 0x15 ), addr | 1);
    imu963ra_write_acc_gyro_register(( 0x16 ), reg);
    imu963ra_write_acc_gyro_register(( 0x17 ), 0x01);
    imu963ra_write_acc_gyro_register(( 0x14 ), 0x4C);


    while(0 == (0x01 & imu963ra_read_acc_gyro_register(( 0x22 ))))
    {
        if(( 0x00FF ) < timeout_count ++)
        {
            break;
    ...
    return (imu963ra_read_acc_gyro_register(( 0x02 )));
}
# 227 "../../libraries/zf_device/zf_device_imu963ra.c"
static void imu963ra_connect_mag (uint8 addr, uint8 reg)
{
    ...
    imu963ra_write_acc_gyro_register(( 0x15 ), addr | 1);
    imu963ra_write_acc_gyro_register(( 0x16 ), reg);
    imu963ra_write_acc_gyro_register(( 0x17 ), 0x06);
    imu963ra_write_acc_gyro_register(( 0x14 ), 0x6C);
}
# 245 "../../libraries/zf_device/zf_device_imu963ra.c"
static uint8 imu963ra_acc_gyro_self_check (void)
{
    ...
    while(0x6B != dat)
    {
        ...
        dat = imu963ra_read_acc_gyro_register(( 0x0F ));
        system_delay_ms(10);
    }
    return return_state;
}
# 271 "../../libraries/zf_device/zf_device_imu963ra.c"
static uint8 imu963ra_mag_self_check (void)
{
    ...
    while(0xff != dat)
    {
        ...
        dat = imu963ra_read_mag_register(( 0x0D ), ( 0x0D ));
        system_delay_ms(10);
    }
    return return_state;
}
# 297 "../../libraries/zf_device/zf_device_imu963ra.c"
void imu963ra_get_acc (void)
{
    uint8 dat[6];

    imu963ra_read_acc_gyro_registers(( 0x28 ), dat, 6);
...
# 315 "../../libraries/zf_device/zf_device_imu963ra.c"
void imu963ra_get_gyro (void)
{
    uint8 dat[6];

    imu963ra_read_acc_gyro_registers(( 0x22 ), dat, 6);
...
# 333 "../../libraries/zf_device/zf_device_imu963ra.c"
void imu963ra_get_mag (void)
{
    uint8 temp_status;
    uint8 dat[6];

    imu963ra_write_acc_gyro_register(( 0x01 ), 0x40);
    temp_status = imu963ra_read_acc_gyro_register(( 0x22 ));
    if(0x01 & temp_status)
    {
        imu963ra_read_acc_gyro_registers(( 0x02 ), dat, 6);
    ...
    imu963ra_write_acc_gyro_register(( 0x01 ), 0x00);
}
# 357 "../../libraries/zf_device/zf_device_imu963ra.c"
uint8 imu963ra_init (void)
{
    uint8 return_state = 0;
    system_delay_ms(10);
    ...
    spi_init((SPI_4 ), SPI_MODE0, (10 * 1000 * 1000), (SPI4_SCK_C23 ), (SPI4_MOSI_C22), (SPI4_MISO_C21), SPI_CS_NULL);
    gpio_init(C20, GPO, GPIO_LOW, GPO_PUSH_PULL);


    do
    {
        imu963ra_write_acc_gyro_register(( 0x01 ), 0x00);
        imu963ra_write_acc_gyro_register(( 0x12 ), 0x01);
        system_delay_ms(2);
        imu963ra_write_acc_gyro_register(( 0x01 ), 0x00);
        if(imu963ra_acc_gyro_self_check())
        {
            (debug_log_handler((0), ("IMU963RA acc and gyro self check error."), "../../libraries/zf_device/zf_device_imu963ra.c", 377));
            return_state = 1;
            break;
        }

        imu963ra_write_acc_gyro_register(( 0x0D ), 0x03);
        ...
        switch(( IMU963RA_ACC_SAMPLE_SGN_8G ))
        {
            default:
            {
                (debug_log_handler((0), ("IMU963RA_ACC_SAMPLE_DEFAULT set error."), "../../libraries/zf_device/zf_device_imu963ra.c", 393));
                return_state = 1;
            }break;
            case IMU963RA_ACC_SAMPLE_SGN_2G:
            {
                imu963ra_write_acc_gyro_register(( 0x10 ), 0x30);
                imu963ra_transition_factor[0] = 16393;
            }break;
            case IMU963RA_ACC_SAMPLE_SGN_4G:
            {
                imu963ra_write_acc_gyro_register(( 0x10 ), 0x38);
                imu963ra_transition_factor[0] = 8197;
            }break;
            case IMU963RA_ACC_SAMPLE_SGN_8G:
            {
                imu963ra_write_acc_gyro_register(( 0x10 ), 0x3C);
                imu963ra_transition_factor[0] = 4098;
            }break;
            case IMU963RA_ACC_SAMPLE_SGN_16G:
            {
                imu963ra_write_acc_gyro_register(( 0x10 ), 0x34);
...
# 429 "../../libraries/zf_device/zf_device_imu963ra.c"
        switch(( IMU963RA_GYRO_SAMPLE_SGN_2000DPS ))
        {
            default:
            {
                (debug_log_handler((0), ("IMU963RA_GYRO_SAMPLE_DEFAULT set error."), "../../libraries/zf_device/zf_device_imu963ra.c", 433));
                return_state = 1;
            }break;
            case IMU963RA_GYRO_SAMPLE_SGN_125DPS:
            {
                imu963ra_write_acc_gyro_register(( 0x11 ), 0x52);
                imu963ra_transition_factor[1] = 228.6;
            }break;
            case IMU963RA_GYRO_SAMPLE_SGN_250DPS:
            {
                imu963ra_write_acc_gyro_register(( 0x11 ), 0x50);
                imu963ra_transition_factor[1] = 114.3;
            }break;
            case IMU963RA_GYRO_SAMPLE_SGN_500DPS:
            {
                imu963ra_write_acc_gyro_register(( 0x11 ), 0x54);
                imu963ra_transition_factor[1] = 57.1;
            }break;
            case IMU963RA_GYRO_SAMPLE_SGN_1000DPS:
            {
                imu963ra_write_acc_gyro_register(( 0x11 ), 0x58);
                imu963ra_transition_factor[1] = 28.6;
            }break;
            case IMU963RA_GYRO_SAMPLE_SGN_2000DPS:
            {
                imu963ra_write_acc_gyro_register(( 0x11 ), 0x5C);
                imu963ra_transition_factor[1] = 14.3;
            }break;
            case IMU963RA_GYRO_SAMPLE_SGN_4000DPS:
            {
                imu963ra_write_acc_gyro_register(( 0x11 ), 0x51);
        ...
        imu963ra_write_acc_gyro_register(( 0x12 ), 0x44);
        imu963ra_write_acc_gyro_register(( 0x13 ), 0x02);
        imu963ra_write_acc_gyro_register(( 0x14 ), 0x00);
        imu963ra_write_acc_gyro_register(( 0x15 ), 0x00);
        imu963ra_write_acc_gyro_register(( 0x16 ), 0x00);
        imu963ra_write_acc_gyro_register(( 0x18 ), 0x01);

        imu963ra_write_acc_gyro_register(( 0x01 ), 0x40);
        imu963ra_write_acc_gyro_register(( 0x14 ), 0x80);
        system_delay_ms(2);
        imu963ra_write_acc_gyro_register(( 0x14 ), 0x00);
        system_delay_ms(2);

        imu963ra_write_mag_register(( 0x0D ), ( 0x0A ), 0x80);
        system_delay_ms(2);
        imu963ra_write_mag_register(( 0x0D ), ( 0x0A ), 0x00);
        system_delay_ms(2);

        if(imu963ra_mag_self_check())
        {
            (debug_log_handler((0), ("IMU963RA mag self check error."), "../../libraries/zf_device/zf_device_imu963ra.c", 492));
            return_state = 1;
            break;
        }
        ...
        switch(( IMU963RA_MAG_SAMPLE_8G ))
        {
            default:
            {
                (debug_log_handler((0), ("IMU963RA_MAG_SAMPLE_DEFAULT set error."), "../../libraries/zf_device/zf_device_imu963ra.c", 504));
                return_state = 1;
            }break;
            case IMU963RA_MAG_SAMPLE_2G:
            {
                imu963ra_write_mag_register(( 0x0D ), ( 0x09 ), 0x09);
                imu963ra_transition_factor[2] = 12000;
            }break;
            case IMU963RA_MAG_SAMPLE_8G:
            {
                imu963ra_write_mag_register(( 0x0D ), ( 0x09 ), 0x19);
        ...
        imu963ra_write_mag_register(( 0x0D ), ( 0x0B ), 0x01);
        imu963ra_connect_mag(( 0x0D ), ( 0x00 ));
