# 1 "../../libraries/sdk/drives/fsl_rtwdog.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/sdk/drives/fsl_rtwdog.c" 2
...
# 11 "../../libraries/sdk/drives/fsl_rtwdog.h"
...
# 12 "../../libraries/sdk/drives/fsl_rtwdog.h" 2
...
# 10 "../../libraries/sdk/drives/fsl_rtwdog.c" 2
# 34 "../../libraries/sdk/drives/fsl_rtwdog.c"
void RTWDOG_ClearStatusFlags(RTWDOG_Type *base, uint32_t mask)
{
...
# 65 "../../libraries/sdk/drives/fsl_rtwdog.c"
void RTWDOG_GetDefaultConfig(rtwdog_config_t *config)
{
    ((config != 0) ? (void)0 : __aeabi_assert("config != NULL", "../../libraries/sdk/drives/fsl_rtwdog.c", 67),
# 67 "../../libraries/sdk/drives/fsl_rtwdog.c"
#pragma clang diagnostic push
# 67 "../../libraries/sdk/drives/fsl_rtwdog.c"
#pragma clang diagnostic ignored "-Wassume"
# 67 "../../libraries/sdk/drives/fsl_rtwdog.c"
...
# 67 "../../libraries/sdk/drives/fsl_rtwdog.c"
    ...
    config->enableRtwdog = 1;
    config->clockSource = kRTWDOG_ClockSource1;
    config->prescaler = kRTWDOG_ClockPrescalerDivide1;
    config->workMode.enableWait = 1;
    config->workMode.enableStop = 0;
    config->workMode.enableDebug = 0;
    config->testMode = kRTWDOG_TestModeDisabled;
    config->enableUpdate = 1;
    config->enableInterrupt = 0;
    config->enableWindowMode = 0;
    config->windowValue = 0U;
    config->timeoutValue = 0xFFFFU;
}
# 105 "../../libraries/sdk/drives/fsl_rtwdog.c"
void RTWDOG_Init(RTWDOG_Type *base, const rtwdog_config_t *config)
{
    ((0 != config) ? (void)0 : __aeabi_assert("NULL != config", "../../libraries/sdk/drives/fsl_rtwdog.c", 107),
# 107 "../../libraries/sdk/drives/fsl_rtwdog.c"
#pragma clang diagnostic push
# 107 "../../libraries/sdk/drives/fsl_rtwdog.c"
#pragma clang diagnostic ignored "-Wassume"
# 107 "../../libraries/sdk/drives/fsl_rtwdog.c"
...
# 107 "../../libraries/sdk/drives/fsl_rtwdog.c"
    ...
    value = (((uint32_t)(((uint32_t)(config->enableRtwdog)) << (7U))) & (0x80U)) | (((uint32_t)(((uint32_t)(config->clockSource)) << (8U))) & (0x300U)) |
            (((uint32_t)(((uint32_t)(config->enableInterrupt)) << (6U))) & (0x40U)) | (((uint32_t)(((uint32_t)(config->enableWindowMode)) << (15U))) & (0x8000U)) |
            (((uint32_t)(((uint32_t)(config->enableUpdate)) << (5U))) & (0x20U)) | (((uint32_t)(((uint32_t)(config->workMode.enableDebug)) << (2U))) & (0x4U)) |
            (((uint32_t)(((uint32_t)(config->workMode.enableStop)) << (0U))) & (0x1U)) | (((uint32_t)(((uint32_t)(config->workMode.enableWait)) << (1U))) & (0x2U)) |
            (((uint32_t)(((uint32_t)(config->prescaler)) << (12U))) & (0x1000U)) | (((uint32_t)(((uint32_t)(1U)) << (13U))) & (0x2000U)) | (((uint32_t)(((uint32_t)(config->testMode)) << (3U))) & (0x18U));
    ...
    base->CS = value;
    while ((base->CS & (0x400U)) == 0U)
    {
    }
    EnableGlobalIRQ(primaskValue);
}
# 139 "../../libraries/sdk/drives/fsl_rtwdog.c"
void RTWDOG_Deinit(RTWDOG_Type *base)
{
    uint32_t primaskValue = 0U;
