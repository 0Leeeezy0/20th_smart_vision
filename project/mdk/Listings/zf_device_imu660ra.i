# 1 "../../libraries/zf_device/zf_device_imu660ra.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/zf_device/zf_device_imu660ra.c" 2
# 57 "../../libraries/zf_device/zf_device_imu660ra.c"
...
# 58 "../../libraries/zf_device/zf_device_imu660ra.c" 2
...
# 59 "../../libraries/zf_device/zf_device_imu660ra.c" 2
...
# 60 "../../libraries/zf_device/zf_device_imu660ra.c" 2
...
# 61 "../../libraries/zf_device/zf_device_imu660ra.c" 2
...
# 62 "../../libraries/zf_device/zf_device_imu660ra.c" 2
...
# 63 "../../libraries/zf_device/zf_device_imu660ra.c" 2
...
# 64 "../../libraries/zf_device/zf_device_imu660ra.c" 2
...
# 85 "../../libraries/zf_device/zf_device_imu660ra.c"
...
# 100 "../../libraries/zf_device/zf_device_imu660ra.c"
static void imu660ra_write_registers (uint8 reg, const uint8 *data, uint32 len)
{
    ((0) ? (GPIO_SetPinsOutput(PORTPTR[(C20) >> 5],1 << ((C20) & 0x1f))) : (GPIO_ClearPinsOutput(PORTPTR[(C20) >> 5],1 << ((C20) & 0x1f))));
    spi_write_8bit_registers((SPI_4), reg | ( 0x00 ), data, len);
    ((1) ? (GPIO_SetPinsOutput(PORTPTR[(C20) >> 5],1 << ((C20) & 0x1f))) : (GPIO_ClearPinsOutput(PORTPTR[(C20) >> 5],1 << ((C20) & 0x1f))));
}
# 114 "../../libraries/zf_device/zf_device_imu660ra.c"
static uint8 imu660ra_read_register (uint8 reg)
{
    uint8 data[2];
    ((0) ? (GPIO_SetPinsOutput(PORTPTR[(C20) >> 5],1 << ((C20) & 0x1f))) : (GPIO_ClearPinsOutput(PORTPTR[(C20) >> 5],1 << ((C20) & 0x1f))));
    spi_read_8bit_registers((SPI_4), reg | ( 0x80 ), data, 2);
    ((1) ? (GPIO_SetPinsOutput(PORTPTR[(C20) >> 5],1 << ((C20) & 0x1f))) : (GPIO_ClearPinsOutput(PORTPTR[(C20) >> 5],1 << ((C20) & 0x1f))));
    return data[1];
}
# 132 "../../libraries/zf_device/zf_device_imu660ra.c"
static void imu660ra_read_registers (uint8 reg, uint8 *data, uint32 len)
{
    uint8 temp_data[8];
    ((0) ? (GPIO_SetPinsOutput(PORTPTR[(C20) >> 5],1 << ((C20) & 0x1f))) : (GPIO_ClearPinsOutput(PORTPTR[(C20) >> 5],1 << ((C20) & 0x1f))));
    spi_read_8bit_registers((SPI_4), reg | ( 0x80 ), temp_data, len + 1);
    ((1) ? (GPIO_SetPinsOutput(PORTPTR[(C20) >> 5],1 << ((C20) & 0x1f))) : (GPIO_ClearPinsOutput(PORTPTR[(C20) >> 5],1 << ((C20) & 0x1f))));
    for(int i = 0; i < len; i ++)
    {
        *(data ++) = temp_data[i + 1];
...
# 152 "../../libraries/zf_device/zf_device_imu660ra.c"
static uint8 imu660ra_self_check (void)
{
    ...
    do
    {
        ...
        dat = imu660ra_read_register(( 0x00 ));
        system_delay_ms(1);
    }while(0x24 != dat);
    return return_state;
}
# 177 "../../libraries/zf_device/zf_device_imu660ra.c"
void imu660ra_get_acc (void)
{
    uint8 dat[6];

    imu660ra_read_registers(( 0x0C ), dat, 6);
...
# 194 "../../libraries/zf_device/zf_device_imu660ra.c"
void imu660ra_get_gyro (void)
{
    uint8 dat[6];

    imu660ra_read_registers(( 0x12 ), dat, 6);
...
# 211 "../../libraries/zf_device/zf_device_imu660ra.c"
uint8 imu660ra_init (void)
{
    ...
    do{
        if(imu660ra_self_check())
        {
            ...
            (debug_log_handler((0), ("imu660ra self check error."), "../../libraries/zf_device/zf_device_imu660ra.c", 232));
            return_state = 1;
            break;
        }
        imu660ra_write_register(( 0x7C ), 0x00);
        system_delay_ms(1);
        imu660ra_write_register(( 0x59 ), 0x00);
        imu660ra_write_registers(( 0x5E ), imu660ra_config_file, sizeof(imu660ra_config_file));
        imu660ra_write_register(( 0x59 ), 0x01);
        system_delay_ms(20);
        if(1 != imu660ra_read_register(( 0x21 )))
        {



            (debug_log_handler((0), ("imu660ra init error."), "../../libraries/zf_device/zf_device_imu660ra.c", 247));
            return_state = 1;
            break;
        }
        imu660ra_write_register(( 0x7D ), 0x0E);
        imu660ra_write_register(( 0x40 ), 0xA7);
        imu660ra_write_register(( 0x42 ), 0xA9);
        ...
        switch(( IMU660RA_ACC_SAMPLE_SGN_8G ))
        {
            default:
            {
                (debug_log_handler((0), ("IMU660RA_ACC_SAMPLE_DEFAULT set error."), "../../libraries/zf_device/zf_device_imu660ra.c", 264));
                return_state = 1;
            }break;
            case IMU660RA_ACC_SAMPLE_SGN_2G:
            {
                imu660ra_write_register(( 0x41 ), 0x00);
                imu660ra_transition_factor[0] = 16384;
            }break;
            case IMU660RA_ACC_SAMPLE_SGN_4G:
            {
                imu660ra_write_register(( 0x41 ), 0x01);
                imu660ra_transition_factor[0] = 8192;
            }break;
            case IMU660RA_ACC_SAMPLE_SGN_8G:
            {
                imu660ra_write_register(( 0x41 ), 0x02);
                imu660ra_transition_factor[0] = 4096;
            }break;
            case IMU660RA_ACC_SAMPLE_SGN_16G:
            {
                imu660ra_write_register(( 0x41 ), 0x03);
