# 1 "../../libraries/sdk/drives/fsl_tsc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/sdk/drives/fsl_tsc.c" 2
...
# 1 "../../libraries/sdk/drives/fsl_tsc.h" 1
# 12 "../../libraries/sdk/drives/fsl_tsc.h"
...
# 13 "../../libraries/sdk/drives/fsl_tsc.h" 2
# 28 "../../libraries/sdk/drives/fsl_tsc.h"
...
{
    kTSC_IdleSoftwareSignalEnable = (0x1000U),



    kTSC_ValidSignalEnable = (0x100U),

    kTSC_DetectSignalEnable =
        (0x10U),
    kTSC_MeasureSignalEnable = (0x1U),
...
enum _tsc_interrupt_mask
{
    ...
    kTSC_DetectInterruptEnable =
        (0x10U),
    kTSC_MeasureInterruptEnable = (0x1U),
...
enum _tsc_adc_status_flag_mask
{
    kTSC_ADCCOCOSignalFlag =
        (0x1000U),
    kTSC_ADCConversionValueFlag = (0xFFFU),
...
{
    kTSC_IntermediateStateFlag = (0x800000U),

    kTSC_DetectFiveWireFlag = (0x20000U),



    kTSC_DetectFourWireFlag = (0x10000U),



    kTSC_GlitchThresholdFlag = (0x60000000U),
# 127 "../../libraries/sdk/drives/fsl_tsc.h"
...
{
    kTSC_IdleState = 0U << (20U),
    kTSC_1stPreChargeState = 1U << (20U),
    kTSC_1stDetectState = 2U << (20U),
    kTSC_XMeasureState = 3U << (20U),
    kTSC_YMeasureState = 4U << (20U),
    kTSC_2ndPreChargeState = 5U << (20U),
    kTSC_2ndDetectState = 6U << (20U),
} tsc_state_machine_t;
...
{
    kTSC_glitchThresholdALT0 = 0U << (29U),

    kTSC_glitchThresholdALT1 = 1U << (29U),

    kTSC_glitchThresholdALT2 = 2U << (29U),
...
# 234 "../../libraries/sdk/drives/fsl_tsc.h"
...
# 257 "../../libraries/sdk/drives/fsl_tsc.h"
...
# 438 "../../libraries/sdk/drives/fsl_tsc.h"
static inline void TSC_EnableDebugMode(TSC_Type *base, _Bool enable)
{
    if (enable)
    {
        base->DEBUG_MODE |= (0x10000000U);
    }
    else
    {
        base->DEBUG_MODE &= ~(0x10000000U);
...
# 459 "../../libraries/sdk/drives/fsl_tsc.h"
void TSC_DebugTriggerSignalToADC(TSC_Type *base, tsc_trigger_signal_t hwts, _Bool enable);
# 469 "../../libraries/sdk/drives/fsl_tsc.h"
static inline void TSC_DebugDisableHWClear(TSC_Type *base, _Bool enable)
{
    if (enable)
    {
        base->DEBUG_MODE |= (0x4000000U);
    }
    else
    {
        base->DEBUG_MODE &= ~(0x4000000U);
...
# 488 "../../libraries/sdk/drives/fsl_tsc.h"
static inline void TSC_DebugClearSignalToADC(TSC_Type *base, _Bool enable)
{
    if (enable)
    {
        base->DEBUG_MODE |= (0x2000000U);
    }
    else
    {
        base->DEBUG_MODE &= ~(0x2000000U);
...
# 507 "../../libraries/sdk/drives/fsl_tsc.h"
void TSC_DebugEnableDetection(TSC_Type *base, tsc_detection_mode_t detectionMode, _Bool enable);
# 516 "../../libraries/sdk/drives/fsl_tsc.h"
void TSC_DebugSetPortMode(TSC_Type *base, tsc_port_source_t port, tsc_port_mode_t mode);
# 10 "../../libraries/sdk/drives/fsl_tsc.c" 2
# 24 "../../libraries/sdk/drives/fsl_tsc.c"
...
static TSC_Type *const s_tscBases[] = { ((TSC_Type *)(0x400E0000u)) };



static const clock_ip_name_t s_tscClocks[] = { kCLOCK_Tsc };
...
static uint32_t TSC_GetInstance(TSC_Type *base)
{
    ...
    for (instance = 0; instance < (sizeof(s_tscBases) / sizeof((s_tscBases)[0])); instance++)
    {
    ...
    ((instance < (sizeof(s_tscBases) / sizeof((s_tscBases)[0]))) ? (void)0 : __aeabi_assert("instance < ARRAY_SIZE(s_tscBases)", "../../libraries/sdk/drives/fsl_tsc.c", 53),
# 53 "../../libraries/sdk/drives/fsl_tsc.c"
#pragma clang diagnostic push
# 53 "../../libraries/sdk/drives/fsl_tsc.c"
#pragma clang diagnostic ignored "-Wassume"
# 53 "../../libraries/sdk/drives/fsl_tsc.c"
    (__builtin_assume)((instance < (sizeof(s_tscBases) / sizeof((s_tscBases)[0])))?1:0)
# 53 "../../libraries/sdk/drives/fsl_tsc.c"
#pragma clang diagnostic pop
# 53 "../../libraries/sdk/drives/fsl_tsc.c"
    );
...
void TSC_Init(TSC_Type *base, const tsc_config_t *config)
{
    ((0 != config) ? (void)0 : __aeabi_assert("NULL != config", "../../libraries/sdk/drives/fsl_tsc.c", 66),
# 66 "../../libraries/sdk/drives/fsl_tsc.c"
#pragma clang diagnostic push
# 66 "../../libraries/sdk/drives/fsl_tsc.c"
#pragma clang diagnostic ignored "-Wassume"
# 66 "../../libraries/sdk/drives/fsl_tsc.c"
...
# 66 "../../libraries/sdk/drives/fsl_tsc.c"
    ...
    ((config->measureDelayTime <= 0xFFFFFFU) ? (void)0 : __aeabi_assert("config->measureDelayTime <= 0xFFFFFFU", "../../libraries/sdk/drives/fsl_tsc.c", 67),
# 67 "../../libraries/sdk/drives/fsl_tsc.c"
#pragma clang diagnostic push
# 67 "../../libraries/sdk/drives/fsl_tsc.c"
#pragma clang diagnostic ignored "-Wassume"
# 67 "../../libraries/sdk/drives/fsl_tsc.c"
    (__builtin_assume)((config->measureDelayTime <= 0xFFFFFFU)?1:0)
# 67 "../../libraries/sdk/drives/fsl_tsc.c"
#pragma clang diagnostic pop
# 67 "../../libraries/sdk/drives/fsl_tsc.c"
    );
    ...
    tmp32 = (((uint32_t)(((uint32_t)(config->measureDelayTime)) << (8U))) & (0xFFFFFF00U)) |
            (((uint32_t)(((uint32_t)(config->detectionMode)) << (4U))) & (0x10U));
    ...
    base->PRE_CHARGE_TIME = (((uint32_t)(((uint32_t)(config->prechargeTime)) << (0U))) & (0xFFFFFFFFU));
}
...
uint32_t TSC_GetMeasureValue(TSC_Type *base, tsc_corrdinate_value_selection_t selection)
{
    ...
    {
        tmp32 = ((base->MEASEURE_VALUE) & (0xFFF0000U)) >> (16U);
    }
    else if (selection == kTSC_YCoordinateValueSelection)
    {
        tmp32 = ((base->MEASEURE_VALUE) & (0xFFFU)) >> (0U);
    }
    else
    {
...
# 163 "../../libraries/sdk/drives/fsl_tsc.c"
void TSC_DebugTriggerSignalToADC(TSC_Type *base, tsc_trigger_signal_t hwts, _Bool enable)
{
    if (enable)
    {
        ...
        base->DEBUG_MODE &= ~(0x1F0000U);
        base->DEBUG_MODE |= (((uint32_t)(((uint32_t)(hwts)) << (16U))) & (0x1F0000U));
        base->DEBUG_MODE |= (0x1000000U);
    }
    else
    {
        base->DEBUG_MODE &= ~(0x1000000U);
...
# 186 "../../libraries/sdk/drives/fsl_tsc.c"
void TSC_DebugEnableDetection(TSC_Type *base, tsc_detection_mode_t detectionMode, _Bool enable)
{
...
# 223 "../../libraries/sdk/drives/fsl_tsc.c"
void TSC_DebugSetPortMode(TSC_Type *base, tsc_port_source_t port, tsc_port_mode_t mode)
{
    uint32_t tmp32;
    ...
    switch (port)
    {
        case kTSC_WiperPortSource:
            tmp32 &= ~((0x4000U) | (0x2000U) |
                       (0x1000U));
            tmp32 |= ((uint32_t)mode << (12U));
            break;
        case kTSC_YnlrPortSource:
            tmp32 &= ~((0x800U) | (0x400U) |
                       (0x200U));
            tmp32 |= ((uint32_t)mode << (9U));
            break;
        case kTSC_YpllPortSource:
            tmp32 &= ~((0x100U) | (0x80U) |
                       (0x40U));
            tmp32 |= ((uint32_t)mode << (6U));
            break;
        case kTSC_XnurPortSource:
            tmp32 &= ~((0x20U) | (0x10U) |
                       (0x8U));
            tmp32 |= ((uint32_t)mode << (3U));
            break;
        case kTSC_XpulPortSource:
            tmp32 &= ~((0x4U) | (0x2U) |
                       (0x1U));
            tmp32 |= ((uint32_t)mode << (0U));
            break;
        default:
            ((0) ? (void)0 : __aeabi_assert("false", "../../libraries/sdk/drives/fsl_tsc.c", 256),
# 256 "../../libraries/sdk/drives/fsl_tsc.c"
#pragma clang diagnostic push
# 256 "../../libraries/sdk/drives/fsl_tsc.c"
#pragma clang diagnostic ignored "-Wassume"
# 256 "../../libraries/sdk/drives/fsl_tsc.c"
