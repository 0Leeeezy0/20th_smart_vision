# 1 "../../libraries/sdk/board/clock_config.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/sdk/board/clock_config.c" 2
# 33 "../../libraries/sdk/board/clock_config.c"
...
# 34 "../../libraries/sdk/board/clock_config.c" 2
# 43 "../../libraries/sdk/board/clock_config.c"
extern uint32_t SystemCoreClock;
...
# 134 "../../libraries/sdk/board/clock_config.c"
...
void BOARD_BootClockRUN(void)
{
    ...
    ((XTALOSC24M_Type *)(0x400D8000u))->OSC_CONFIG2 |= (0x10000U);

    ((XTALOSC24M_Type *)(0x400D8000u))->OSC_CONFIG2 &= ~(0x20000U);
    ...
    ((CCM_Type *)(0x400FC000u))->CCR = (((CCM_Type *)(0x400FC000u))->CCR & (~(0xFFU))) | (((uint32_t)(((uint32_t)(127)) << (0U))) & (0xFFU));

    CLOCK_SetMux(kCLOCK_PeriphClk2Mux, 1);
    CLOCK_SetMux(kCLOCK_PeriphMux, 1);

    ((DCDC_Type *)(0x40080000u))->REG3 = (((DCDC_Type *)(0x40080000u))->REG3 & (~(0x1FU))) | (((uint32_t)(((uint32_t)(0x13)) << (0U))) & (0x1FU));

    while ((0x80000000U) != ((0x80000000U) & ((DCDC_Type *)(0x40080000u))->REG0))
    {
    }

    CLOCK_InitArmPll(&armPllConfig_BOARD_BootClockRUN);
# 218 "../../libraries/sdk/board/clock_config.c"
    CLOCK_DeinitAudioPll();

    CLOCK_SetPllBypass(((CCM_ANALOG_Type *)(0x400D8000u)), kCLOCK_PllAudio, 1);

    ((CCM_ANALOG_Type *)(0x400D8000u))->MISC2 &= ~(0x8000U);
    ((CCM_ANALOG_Type *)(0x400D8000u))->MISC2 &= ~(0x800000U);

    ((CCM_ANALOG_Type *)(0x400D8000u))->PLL_AUDIO |= (0x2000U);

    CLOCK_DeinitVideoPll();

    ((CCM_ANALOG_Type *)(0x400D8000u))->PLL_VIDEO |= (0x10000U);

    ((CCM_ANALOG_Type *)(0x400D8000u))->MISC2 = (((CCM_ANALOG_Type *)(0x400D8000u))->MISC2 & (~(0xC0000000U))) | (((uint32_t)(((uint32_t)(0)) << (30U))) & (0xC0000000U));

    ((CCM_ANALOG_Type *)(0x400D8000u))->PLL_VIDEO |= (0x2000U);

    CLOCK_DeinitEnetPll();

    CLOCK_SetPllBypass(((CCM_ANALOG_Type *)(0x400D8000u)), kCLOCK_PllEnet, 1);

    ((CCM_ANALOG_Type *)(0x400D8000u))->PLL_ENET = (((CCM_ANALOG_Type *)(0x400D8000u))->PLL_ENET & (~(0x3U))) | (((uint32_t)(((uint32_t)(1)) << (0U))) & (0x3U));

    ((CCM_ANALOG_Type *)(0x400D8000u))->PLL_ENET |= (0x2000U);

    ((CCM_ANALOG_Type *)(0x400D8000u))->PLL_ENET = (((CCM_ANALOG_Type *)(0x400D8000u))->PLL_ENET & (~(0xCU))) | (((uint32_t)(((uint32_t)(0)) << (2U))) & (0xCU));

    ((CCM_ANALOG_Type *)(0x400D8000u))->PLL_ENET |= (0x100000U);

    ((CCM_ANALOG_Type *)(0x400D8000u))->PLL_ENET |= (0x200000U);

    CLOCK_DeinitUsb2Pll();

    CLOCK_SetPllBypass(((CCM_ANALOG_Type *)(0x400D8000u)), kCLOCK_PllUsb2, 1);

    ((CCM_ANALOG_Type *)(0x400D8000u))->PLL_USB2 |= (0x2000U);
...
# 309 "../../libraries/sdk/board/clock_config.c"
    CLOCK_DisableClock(kCLOCK_FlexSpi);

    CLOCK_SetDiv(kCLOCK_FlexspiDiv, 0);

    CLOCK_SetMux(kCLOCK_FlexspiMux, 3);
# 326 "../../libraries/sdk/board/clock_config.c"
    ...
    ((CCM_ANALOG_Type *)(0x400D8000u))->MISC1 = (((CCM_ANALOG_Type *)(0x400D8000u))->MISC1 & (~(0x1FU))) | (((uint32_t)(((uint32_t)(0)) << (0U))) & (0x1FU));

    ((CCM_Type *)(0x400FC000u))->CCOSR = (((CCM_Type *)(0x400FC000u))->CCOSR & (~(0x70U))) | (((uint32_t)(((uint32_t)(0)) << (4U))) & (0x70U));

    ((CCM_Type *)(0x400FC000u))->CCOSR = (((CCM_Type *)(0x400FC000u))->CCOSR & (~(0xFU))) | (((uint32_t)(((uint32_t)(1)) << (0U))) & (0xFU));

    ((CCM_Type *)(0x400FC000u))->CCOSR = (((CCM_Type *)(0x400FC000u))->CCOSR & (~(0xE00000U))) | (((uint32_t)(((uint32_t)(0)) << (21U))) & (0xE00000U));

    ((CCM_Type *)(0x400FC000u))->CCOSR = (((CCM_Type *)(0x400FC000u))->CCOSR & (~(0x1F0000U))) | (((uint32_t)(((uint32_t)(18)) << (16U))) & (0x1F0000U));

    ((CCM_Type *)(0x400FC000u))->CCOSR &= ~(0x100U);

    ((CCM_Type *)(0x400FC000u))->CCOSR &= ~(0x80U);

    ((CCM_Type *)(0x400FC000u))->CCOSR &= ~(0x1000000U);
