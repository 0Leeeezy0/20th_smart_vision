# 1 "../../libraries/zf_driver/zf_driver_uart.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/zf_driver/zf_driver_uart.c" 2
# 36 "../../libraries/zf_driver/zf_driver_uart.c"
# 1 "../../libraries/sdk/drives\\fsl_iomuxc.h" 1
# 12 "../../libraries/sdk/drives\\fsl_iomuxc.h"
...
# 13 "../../libraries/sdk/drives\\fsl_iomuxc.h" 2
...
# 37 "../../libraries/zf_driver/zf_driver_uart.c" 2
...
# 38 "../../libraries/zf_driver/zf_driver_uart.c" 2
...
# 39 "../../libraries/zf_driver/zf_driver_uart.c" 2
...
# 40 "../../libraries/zf_driver/zf_driver_uart.c" 2
...
# 41 "../../libraries/zf_driver/zf_driver_uart.c" 2
...
# 42 "../../libraries/zf_driver/zf_driver_uart.c" 2
...
# 44 "../../libraries/zf_driver/zf_driver_uart.c" 2

static LPUART_Type *uart_index[] = { (LPUART_Type *)0u, ((LPUART_Type *)(0x40184000u)), ((LPUART_Type *)(0x40188000u)), ((LPUART_Type *)(0x4018C000u)), ((LPUART_Type *)(0x40190000u)), ((LPUART_Type *)(0x40194000u)), ((LPUART_Type *)(0x40198000u)), ((LPUART_Type *)(0x4019C000u)), ((LPUART_Type *)(0x401A0000u)) };
...
void uart_iomuxc(uart_index_enum uartn, uart_tx_pin_enum tx_pin, uart_rx_pin_enum rx_pin)
{
    switch(uartn)
    {
        case UART_1:
        {
            if (UART1_TX_B12 == tx_pin) afio_init(0x401F80ECU, 0x2U, 0, 0, 0x401F82DCU, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);
            if (UART1_RX_B13 == rx_pin) afio_init(0x401F80F0U, 0x2U, 0, 0, 0x401F82E0U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);
        }break;
        case UART_2:
        {
            if (UART2_TX_B18 == tx_pin) afio_init(0x401F8104U, 0x2U, 0x401F8530U, 0x1U, 0x401F82F4U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);

            if (UART2_RX_B19 == rx_pin) afio_init(0x401F8108U, 0x2U, 0x401F852CU, 0x1U, 0x401F82F8U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);
        }break;
        case UART_3:
        {
            if (UART3_TX_B22 == tx_pin) afio_init(0x401F8114U, 0x2U, 0x401F853CU, 0x0U, 0x401F8304U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);
            else if (UART3_TX_C8 == tx_pin) afio_init(0x401F815CU, 0x3U, 0x401F853CU, 0x2U, 0x401F834CU, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);

            if (UART3_RX_B23 == rx_pin) afio_init(0x401F8118U, 0x2U, 0x401F8538U, 0x0U, 0x401F8308U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);
            else if (UART3_RX_C9 == rx_pin) afio_init(0x401F8160U, 0x3U, 0x401F8538U, 0x2U, 0x401F8350U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);
        }break;
        case UART_4:
        {
            if (UART4_TX_C16 == tx_pin) afio_init(0x401F817CU, 0x2U, 0x401F8544U, 0x2U, 0x401F836CU, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);
            else if (UART4_TX_D0 == tx_pin) afio_init(0x401F81D4U, 0x4U, 0x401F8544U, 0x0U, 0x401F83C4U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);

            if (UART4_RX_C17 == rx_pin) afio_init(0x401F8180U, 0x2U, 0x401F8540U, 0x2U, 0x401F8370U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);
            else if (UART4_RX_D1 == rx_pin) afio_init(0x401F81D8U, 0x4U, 0x401F8540U, 0x0U, 0x401F83C8U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);
        }break;
        case UART_5:
        {
            if (UART5_TX_C28 == tx_pin) afio_init(0x401F81ACU, 0x1U, 0x401F854CU, 0x1U, 0x401F839CU, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);

            if (UART5_RX_C29 == rx_pin) afio_init(0x401F81B0U, 0x1U, 0x401F8548U, 0x1U, 0x401F83A0U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);
        }break;
        case UART_6:
        {
            if (UART6_TX_B2 == tx_pin) afio_init(0x401F80C4U, 0x2U, 0x401F8554U, 0x1U, 0x401F82B4U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);

            if (UART6_RX_B3 == rx_pin) afio_init(0x401F80C8U, 0x2U, 0x401F8550U, 0x1U, 0x401F82B8U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);
        }break;

        case UART_8:
        {
            if (UART8_TX_B26 == tx_pin) afio_init(0x401F8124U, 0x2U, 0x401F8564U, 0x1U, 0x401F8314U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);
            else if (UART8_TX_D16 == tx_pin) afio_init(0x401F81CCU, 0x2U, 0x401F8564U, 0x0U, 0x401F83BCU, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);

            if (UART8_RX_B27 == rx_pin) afio_init(0x401F8128U, 0x2U, 0x401F8560U, 0x1U, 0x401F8318U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);
            else if (UART8_RX_D17 == rx_pin) afio_init(0x401F81D0U, 0x2U, 0x401F8560U, 0x0U, 0x401F83C0U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);
        }break;

        default: (debug_assert_handler((0), "../../libraries/zf_driver/zf_driver_uart.c", 103));break;
    }
}
# 115 "../../libraries/zf_driver/zf_driver_uart.c"
void uart_write_byte (uart_index_enum uart_n, const uint8 dat)
{
    while(!(uart_index[uart_n]->STAT & (0x800000U)));
    LPUART_WriteByte(uart_index[uart_n], dat);
}
# 130 "../../libraries/zf_driver/zf_driver_uart.c"
void uart_write_buffer (uart_index_enum uart_n, const uint8 *buff, uint32 len)
{
    while(!(uart_index[uart_n]->STAT & (0x800000U)));
    LPUART_WriteBlocking(uart_index[uart_n], buff, len);
}
# 144 "../../libraries/zf_driver/zf_driver_uart.c"
...
# 160 "../../libraries/zf_driver/zf_driver_uart.c"
uint8 uart_read_byte (uart_index_enum uart_n)
{
    while (!((uart_index[uart_n]->WATER & (0x7000000U)) >> (24U)));
    return LPUART_ReadByte(uart_index[uart_n]);
}
# 174 "../../libraries/zf_driver/zf_driver_uart.c"
uint8 uart_query_byte (uart_index_enum uart_n, uint8 *dat)
{
    uint8 return_state = 0;

    if((uart_index[uart_n]->WATER & (0x7000000U)) >> (24U))
    {
...
# 195 "../../libraries/zf_driver/zf_driver_uart.c"
...
# 218 "../../libraries/zf_driver/zf_driver_uart.c"
...
# 242 "../../libraries/zf_driver/zf_driver_uart.c"
void uart_init(uart_index_enum uart_n, uint32 baud, uart_tx_pin_enum tx_pin, uart_rx_pin_enum rx_pin)
{
    uint32_t uartClkSrcFreq;
    lpuart_config_t lpuartConfig;

    (debug_assert_handler(((tx_pin / 16) == (rx_pin / 16)), "../../libraries/zf_driver/zf_driver_uart.c", 247));
    ...
    LPUART_Init(uart_index[uart_n], &lpuartConfig, uartClkSrcFreq);
    LPUART_Deinit(uart_index[uart_n]);
    LPUART_Init(uart_index[uart_n], &lpuartConfig, uartClkSrcFreq);
}
