# 1 "../../libraries/sdk/drives/fsl_lpi2c.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/sdk/drives/fsl_lpi2c.c" 2
...
# 1 "../../libraries/sdk/drives/fsl_lpi2c.h" 1
# 11 "../../libraries/sdk/drives/fsl_lpi2c.h"
# 1 "D:\\KEIL\\ARM\\ARMCLANG\\Bin\\..\\include\\stddef.h" 1 3
# 38 "D:\\KEIL\\ARM\\ARMCLANG\\Bin\\..\\include\\stddef.h" 3
  typedef signed int ptrdiff_t;
# 53 "D:\\KEIL\\ARM\\ARMCLANG\\Bin\\..\\include\\stddef.h" 3
    typedef unsigned int size_t;
# 71 "D:\\KEIL\\ARM\\ARMCLANG\\Bin\\..\\include\\stddef.h" 3
      typedef unsigned short wchar_t;
# 12 "../../libraries/sdk/drives/fsl_lpi2c.h" 2
...
# 35 "../../libraries/sdk/CMSIS/Include\\core_cm7.h" 2 3
...
# 13 "../../libraries/sdk/drives/fsl_lpi2c.h" 2
...
# 96 "D:\\KEIL\\ARM\\ARMCLANG\\Bin\\..\\include\\stdlib.h" 3
...
# 14 "../../libraries/sdk/drives/fsl_lpi2c.h" 2
# 36 "../../libraries/sdk/drives/fsl_lpi2c.h"
enum
{
    kStatus_LPI2C_Busy = ((((kStatusGroup_LPI2C)*100L) + (0))),
    kStatus_LPI2C_Idle = ((((kStatusGroup_LPI2C)*100L) + (1))),
    kStatus_LPI2C_Nak = ((((kStatusGroup_LPI2C)*100L) + (2))),
    kStatus_LPI2C_FifoError = ((((kStatusGroup_LPI2C)*100L) + (3))),
    kStatus_LPI2C_BitError = ((((kStatusGroup_LPI2C)*100L) + (4))),
    kStatus_LPI2C_ArbitrationLost = ((((kStatusGroup_LPI2C)*100L) + (5))),
    kStatus_LPI2C_PinLowTimeout =
        ((((kStatusGroup_LPI2C)*100L) + (6))),
    kStatus_LPI2C_NoTransferInProgress =
        ((((kStatusGroup_LPI2C)*100L) + (7))),
    kStatus_LPI2C_DmaRequestFail = ((((kStatusGroup_LPI2C)*100L) + (8))),
    kStatus_LPI2C_Timeout = ((((kStatusGroup_LPI2C)*100L) + (9))),
};
# 76 "../../libraries/sdk/drives/fsl_lpi2c.h"
enum _lpi2c_master_flags
{
    kLPI2C_MasterTxReadyFlag = (0x1U),
    kLPI2C_MasterRxReadyFlag = (0x2U),
    kLPI2C_MasterEndOfPacketFlag = (0x100U),
    kLPI2C_MasterStopDetectFlag = (0x200U),
    kLPI2C_MasterNackDetectFlag = (0x400U),
    kLPI2C_MasterArbitrationLostFlag = (0x800U),
    kLPI2C_MasterFifoErrFlag = (0x1000U),
    kLPI2C_MasterPinLowTimeoutFlag = (0x2000U),
    kLPI2C_MasterDataMatchFlag = (0x4000U),
    kLPI2C_MasterBusyFlag = (0x1000000U),
    kLPI2C_MasterBusBusyFlag = (0x2000000U),
...
# 149 "../../libraries/sdk/drives/fsl_lpi2c.h"
...
# 208 "../../libraries/sdk/drives/fsl_lpi2c.h"
...
# 285 "../../libraries/sdk/drives/fsl_lpi2c.h"
enum _lpi2c_slave_flags
{
    kLPI2C_SlaveTxReadyFlag = (0x1U),
    kLPI2C_SlaveRxReadyFlag = (0x2U),
    kLPI2C_SlaveAddressValidFlag = (0x4U),
    kLPI2C_SlaveTransmitAckFlag = (0x8U),
    kLPI2C_SlaveRepeatedStartDetectFlag = (0x100U),
    kLPI2C_SlaveStopDetectFlag = (0x200U),
    kLPI2C_SlaveBitErrFlag = (0x400U),
    kLPI2C_SlaveFifoErrFlag = (0x800U),
    kLPI2C_SlaveAddressMatch0Flag = (0x1000U),
    kLPI2C_SlaveAddressMatch1Flag = (0x2000U),
    kLPI2C_SlaveGeneralCallFlag = (0x4000U),
    kLPI2C_SlaveBusyFlag = (0x1000000U),
    kLPI2C_SlaveBusBusyFlag = (0x2000000U),
...
# 328 "../../libraries/sdk/drives/fsl_lpi2c.h"
typedef struct _lpi2c_slave_config
{
    ...
    _Bool filterDozeEnable;
    _Bool filterEnable;
    _Bool enableGeneralCall;
    struct
    {
        _Bool enableAck;
    ...
    _Bool ignoreAck;
    _Bool enableReceivedAddressRead;
...
# 371 "../../libraries/sdk/drives/fsl_lpi2c.h"
...
# 412 "../../libraries/sdk/drives/fsl_lpi2c.h"
...
# 436 "../../libraries/sdk/drives/fsl_lpi2c.h"
...
# 463 "../../libraries/sdk/drives/fsl_lpi2c.h"
uint32_t LPI2C_GetInstance(LPI2C_Type *base);
# 497 "../../libraries/sdk/drives/fsl_lpi2c.h"
void LPI2C_MasterGetDefaultConfig(lpi2c_master_config_t *masterConfig);
# 512 "../../libraries/sdk/drives/fsl_lpi2c.h"
void LPI2C_MasterInit(LPI2C_Type *base, const lpi2c_master_config_t *masterConfig, uint32_t sourceClock_Hz);
# 522 "../../libraries/sdk/drives/fsl_lpi2c.h"
...
# 545 "../../libraries/sdk/drives/fsl_lpi2c.h"
...
static inline void LPI2C_MasterEnable(LPI2C_Type *base, _Bool enable)
{
    base->MCR = (base->MCR & ~(0x1U)) | (((uint32_t)(((uint32_t)(enable)) << (0U))) & (0x1U));
}
# 579 "../../libraries/sdk/drives/fsl_lpi2c.h"
static inline uint32_t LPI2C_MasterGetStatusFlags(LPI2C_Type *base)
{
    return base->MSR;
}
# 604 "../../libraries/sdk/drives/fsl_lpi2c.h"
static inline void LPI2C_MasterClearStatusFlags(LPI2C_Type *base, uint32_t statusMask)
{
    base->MSR = statusMask;
}
# 624 "../../libraries/sdk/drives/fsl_lpi2c.h"
static inline void LPI2C_MasterEnableInterrupts(LPI2C_Type *base, uint32_t interruptMask)
{
    base->MIER |= interruptMask;
}
# 639 "../../libraries/sdk/drives/fsl_lpi2c.h"
static inline void LPI2C_MasterDisableInterrupts(LPI2C_Type *base, uint32_t interruptMask)
{
    base->MIER &= ~interruptMask;
}
# 651 "../../libraries/sdk/drives/fsl_lpi2c.h"
static inline uint32_t LPI2C_MasterGetEnabledInterrupts(LPI2C_Type *base)
{
    return base->MIER;
}
# 668 "../../libraries/sdk/drives/fsl_lpi2c.h"
static inline void LPI2C_MasterEnableDMA(LPI2C_Type *base, _Bool enableTx, _Bool enableRx)
{
    base->MDER = (((uint32_t)(((uint32_t)(enableTx)) << (0U))) & (0x1U)) | (((uint32_t)(((uint32_t)(enableRx)) << (1U))) & (0x2U));
}
...
# 711 "../../libraries/sdk/drives/fsl_lpi2c.h"
static inline void LPI2C_MasterSetWatermarks(LPI2C_Type *base, size_t txWords, size_t rxWords)
{
    base->MFCR = (((uint32_t)(((uint32_t)(txWords)) << (0U))) & (0x3U)) | (((uint32_t)(((uint32_t)(rxWords)) << (16U))) & (0x30000U));
}
# 725 "../../libraries/sdk/drives/fsl_lpi2c.h"
static inline void LPI2C_MasterGetFifoCounts(LPI2C_Type *base, size_t *rxCount, size_t *txCount)
{
    if (0 != txCount)
    {
        *txCount = (base->MFSR & (0x7U)) >> (0U);
    }
    if (0 != rxCount)
    {
        *rxCount = (base->MFSR & (0x70000U)) >> (16U);
    }
}
# 756 "../../libraries/sdk/drives/fsl_lpi2c.h"
void LPI2C_MasterSetBaudRate(LPI2C_Type *base, uint32_t sourceClock_Hz, uint32_t baudRate_Hz);
# 767 "../../libraries/sdk/drives/fsl_lpi2c.h"
static inline _Bool LPI2C_MasterGetBusIdleState(LPI2C_Type *base)
{
    return ((base->MSR & (0x2000000U)) >> (25U)) == 1U ? 1 : 0;
}
# 787 "../../libraries/sdk/drives/fsl_lpi2c.h"
status_t LPI2C_MasterStart(LPI2C_Type *base, uint8_t address, lpi2c_direction_t dir);
# 805 "../../libraries/sdk/drives/fsl_lpi2c.h"
...
# 827 "../../libraries/sdk/drives/fsl_lpi2c.h"
status_t LPI2C_MasterSend(LPI2C_Type *base, void *txBuff, size_t txSize);
# 842 "../../libraries/sdk/drives/fsl_lpi2c.h"
status_t LPI2C_MasterReceive(LPI2C_Type *base, void *rxBuff, size_t rxSize);
# 857 "../../libraries/sdk/drives/fsl_lpi2c.h"
status_t LPI2C_MasterStop(LPI2C_Type *base);
# 874 "../../libraries/sdk/drives/fsl_lpi2c.h"
status_t LPI2C_MasterTransferBlocking(LPI2C_Type *base, lpi2c_master_transfer_t *transfer);
# 898 "../../libraries/sdk/drives/fsl_lpi2c.h"
void LPI2C_MasterTransferCreateHandle(LPI2C_Type *base,
                                      lpi2c_master_handle_t *handle,
                                      lpi2c_master_transfer_callback_t callback,
                                      void *userData);
# 913 "../../libraries/sdk/drives/fsl_lpi2c.h"
status_t LPI2C_MasterTransferNonBlocking(LPI2C_Type *base,
                                         lpi2c_master_handle_t *handle,
                                         lpi2c_master_transfer_t *transfer);
# 925 "../../libraries/sdk/drives/fsl_lpi2c.h"
status_t LPI2C_MasterTransferGetCount(LPI2C_Type *base, lpi2c_master_handle_t *handle, size_t *count);
# 938 "../../libraries/sdk/drives/fsl_lpi2c.h"
void LPI2C_MasterTransferAbort(LPI2C_Type *base, lpi2c_master_handle_t *handle);
# 952 "../../libraries/sdk/drives/fsl_lpi2c.h"
void LPI2C_MasterTransferHandleIRQ(LPI2C_Type *base, void *lpi2cMasterHandle);
# 997 "../../libraries/sdk/drives/fsl_lpi2c.h"
void LPI2C_SlaveGetDefaultConfig(lpi2c_slave_config_t *slaveConfig);
# 1011 "../../libraries/sdk/drives/fsl_lpi2c.h"
void LPI2C_SlaveInit(LPI2C_Type *base, const lpi2c_slave_config_t *slaveConfig, uint32_t sourceClock_Hz);
# 1021 "../../libraries/sdk/drives/fsl_lpi2c.h"
...
static inline void LPI2C_SlaveEnable(LPI2C_Type *base, _Bool enable)
{
    base->SCR = (base->SCR & ~(0x1U)) | (((uint32_t)(((uint32_t)(enable)) << (0U))) & (0x1U));
}
# 1062 "../../libraries/sdk/drives/fsl_lpi2c.h"
static inline uint32_t LPI2C_SlaveGetStatusFlags(LPI2C_Type *base)
{
    return base->SSR;
}
# 1084 "../../libraries/sdk/drives/fsl_lpi2c.h"
static inline void LPI2C_SlaveClearStatusFlags(LPI2C_Type *base, uint32_t statusMask)
{
    base->SSR = statusMask;
}
# 1104 "../../libraries/sdk/drives/fsl_lpi2c.h"
static inline void LPI2C_SlaveEnableInterrupts(LPI2C_Type *base, uint32_t interruptMask)
{
    base->SIER |= interruptMask;
}
# 1119 "../../libraries/sdk/drives/fsl_lpi2c.h"
...
# 1149 "../../libraries/sdk/drives/fsl_lpi2c.h"
static inline void LPI2C_SlaveEnableDMA(LPI2C_Type *base, _Bool enableAddressValid, _Bool enableRx, _Bool enableTx)
{
    base->SDER = (base->SDER & ~((0x4U) | (0x2U) | (0x1U))) |
                 (((uint32_t)(((uint32_t)(enableAddressValid)) << (2U))) & (0x4U)) | (((uint32_t)(((uint32_t)(enableRx)) << (1U))) & (0x2U)) | (((uint32_t)(((uint32_t)(enableTx)) << (0U))) & (0x1U));
}
# 1169 "../../libraries/sdk/drives/fsl_lpi2c.h"
static inline _Bool LPI2C_SlaveGetBusIdleState(LPI2C_Type *base)
{
    return ((base->SSR & (0x2000000U)) >> (25U)) == 1U ? 1 : 0;
}
# 1184 "../../libraries/sdk/drives/fsl_lpi2c.h"
static inline void LPI2C_SlaveTransmitAck(LPI2C_Type *base, _Bool ackOrNack)
{
    base->STAR = (((uint32_t)(((uint32_t)(!ackOrNack)) << (0U))) & (0x1U));
}
# 1198 "../../libraries/sdk/drives/fsl_lpi2c.h"
static inline uint32_t LPI2C_SlaveGetReceivedAddress(LPI2C_Type *base)
{
    return base->SASR & (0x7FFU);
}
# 1212 "../../libraries/sdk/drives/fsl_lpi2c.h"
status_t LPI2C_SlaveSend(LPI2C_Type *base, void *txBuff, size_t txSize, size_t *actualTxSize);
# 1223 "../../libraries/sdk/drives/fsl_lpi2c.h"
status_t LPI2C_SlaveReceive(LPI2C_Type *base, void *rxBuff, size_t rxSize, size_t *actualRxSize);
# 1246 "../../libraries/sdk/drives/fsl_lpi2c.h"
void LPI2C_SlaveTransferCreateHandle(LPI2C_Type *base,
                                     lpi2c_slave_handle_t *handle,
                                     lpi2c_slave_transfer_callback_t callback,
                                     void *userData);
# 1275 "../../libraries/sdk/drives/fsl_lpi2c.h"
status_t LPI2C_SlaveTransferNonBlocking(LPI2C_Type *base, lpi2c_slave_handle_t *handle, uint32_t eventMask);
# 1286 "../../libraries/sdk/drives/fsl_lpi2c.h"
status_t LPI2C_SlaveTransferGetCount(LPI2C_Type *base, lpi2c_slave_handle_t *handle, size_t *count);
# 1296 "../../libraries/sdk/drives/fsl_lpi2c.h"
void LPI2C_SlaveTransferAbort(LPI2C_Type *base, lpi2c_slave_handle_t *handle);
# 1310 "../../libraries/sdk/drives/fsl_lpi2c.h"
void LPI2C_SlaveTransferHandleIRQ(LPI2C_Type *base, lpi2c_slave_handle_t *handle);
# 10 "../../libraries/sdk/drives/fsl_lpi2c.c" 2
# 23 "../../libraries/sdk/drives/fsl_lpi2c.c"
enum
{
    kTxDataCmd = (((uint32_t)(((uint32_t)(0x0U)) << (8U))) & (0x700U)),
    kRxDataCmd = (((uint32_t)(((uint32_t)(0X1U)) << (8U))) & (0x700U)),
    kStopCmd = (((uint32_t)(((uint32_t)(0x2U)) << (8U))) & (0x700U)),
    kStartCmd = (((uint32_t)(((uint32_t)(0x4U)) << (8U))) & (0x700U)),
};
...
static status_t LPI2C_RunTransferStateMachine(LPI2C_Type *base, lpi2c_master_handle_t *handle, _Bool *isDone);
...
static LPI2C_Type *const kLpi2cBases[] = { (LPI2C_Type *)0u, ((LPI2C_Type *)(0x403F0000u)), ((LPI2C_Type *)(0x403F4000u)), ((LPI2C_Type *)(0x403F8000u)), ((LPI2C_Type *)(0x403FC000u)) };



IRQn_Type const kLpi2cIrqs[] = { NotAvail_IRQn, LPI2C1_IRQn, LPI2C2_IRQn, LPI2C3_IRQn, LPI2C4_IRQn };



static clock_ip_name_t const kLpi2cClocks[] = { kCLOCK_IpInvalid, kCLOCK_Lpi2c1, kCLOCK_Lpi2c2, kCLOCK_Lpi2c3, kCLOCK_Lpi2c4 };
# 96 "../../libraries/sdk/drives/fsl_lpi2c.c"
lpi2c_master_isr_t s_lpi2cMasterIsr;



void *s_lpi2cMasterHandle[(sizeof(kLpi2cBases) / sizeof((kLpi2cBases)[0]))];


static lpi2c_slave_isr_t s_lpi2cSlaveIsr;


static lpi2c_slave_handle_t *s_lpi2cSlaveHandle[(sizeof(kLpi2cBases) / sizeof((kLpi2cBases)[0]))];
# 121 "../../libraries/sdk/drives/fsl_lpi2c.c"
uint32_t LPI2C_GetInstance(LPI2C_Type *base)
{
    uint32_t instance;
    for (instance = 0U; instance < (sizeof(kLpi2cBases) / sizeof((kLpi2cBases)[0])); ++instance)
    {
    ...
    ((instance < (sizeof(kLpi2cBases) / sizeof((kLpi2cBases)[0]))) ? (void)0 : __aeabi_assert("instance < ARRAY_SIZE(kLpi2cBases)", "../../libraries/sdk/drives/fsl_lpi2c.c", 132),
# 132 "../../libraries/sdk/drives/fsl_lpi2c.c"
#pragma clang diagnostic push
# 132 "../../libraries/sdk/drives/fsl_lpi2c.c"
#pragma clang diagnostic ignored "-Wassume"
# 132 "../../libraries/sdk/drives/fsl_lpi2c.c"
    (__builtin_assume)((instance < (sizeof(kLpi2cBases) / sizeof((kLpi2cBases)[0])))?1:0)
# 132 "../../libraries/sdk/drives/fsl_lpi2c.c"
#pragma clang diagnostic pop
# 132 "../../libraries/sdk/drives/fsl_lpi2c.c"
    );
...
# 144 "../../libraries/sdk/drives/fsl_lpi2c.c"
static uint32_t LPI2C_GetCyclesForWidth(
    uint32_t sourceClock_Hz, uint32_t width_ns, uint32_t minCycles, uint32_t maxCycles, uint32_t prescaler)
{
    ((sourceClock_Hz > 0U) ? (void)0 : __aeabi_assert("sourceClock_Hz > 0U", "../../libraries/sdk/drives/fsl_lpi2c.c", 147),
# 147 "../../libraries/sdk/drives/fsl_lpi2c.c"
#pragma clang diagnostic push
# 147 "../../libraries/sdk/drives/fsl_lpi2c.c"
#pragma clang diagnostic ignored "-Wassume"
# 147 "../../libraries/sdk/drives/fsl_lpi2c.c"
    (__builtin_assume)((sourceClock_Hz > 0U)?1:0)
# 147 "../../libraries/sdk/drives/fsl_lpi2c.c"
#pragma clang diagnostic pop
# 147 "../../libraries/sdk/drives/fsl_lpi2c.c"
    );
...
# 186 "../../libraries/sdk/drives/fsl_lpi2c.c"
status_t LPI2C_MasterCheckAndClearError(LPI2C_Type *base, uint32_t status)
{
...
# 240 "../../libraries/sdk/drives/fsl_lpi2c.c"
static status_t LPI2C_MasterWaitForTxReady(LPI2C_Type *base)
{
    status_t result = kStatus_Success;
    uint32_t status;
    size_t txCount;
    size_t txFifoSize = (size_t)(4);
    ...
    do
    {
        ...
        LPI2C_MasterGetFifoCounts(base, 0, &txCount);
...
# 272 "../../libraries/sdk/drives/fsl_lpi2c.c"
    } while (0U == txCount);


    return result;
}
# 288 "../../libraries/sdk/drives/fsl_lpi2c.c"
status_t LPI2C_CheckForBusyBus(LPI2C_Type *base)
{
...
# 325 "../../libraries/sdk/drives/fsl_lpi2c.c"
void LPI2C_MasterGetDefaultConfig(lpi2c_master_config_t *masterConfig)
{
    ...
    masterConfig->debugEnable = 0;
    masterConfig->enableDoze = 1;
    masterConfig->ignoreAck = 0;
    ...
    masterConfig->hostRequest.enable = 0;
    masterConfig->hostRequest.source = kLPI2C_HostRequestExternalPin;
    masterConfig->hostRequest.polarity = kLPI2C_HostRequestPinActiveHigh;
}
# 358 "../../libraries/sdk/drives/fsl_lpi2c.c"
void LPI2C_MasterInit(LPI2C_Type *base, const lpi2c_master_config_t *masterConfig, uint32_t sourceClock_Hz)
{
    uint32_t prescaler;
    uint32_t cycles;
...
# 379 "../../libraries/sdk/drives/fsl_lpi2c.c"
    LPI2C_MasterReset(base);


    base->MCR = (((uint32_t)(((uint32_t)(masterConfig->debugEnable)) << (3U))) & (0x8U)) | (((uint32_t)(((uint32_t)(!(masterConfig->enableDoze))) << (2U))) & (0x4U));


    value = base->MCFGR0;
    value &= (~((0x1U) | (0x2U) | (0x4U)));
    value |= (((uint32_t)(((uint32_t)(masterConfig->hostRequest.enable)) << (0U))) & (0x1U)) |
             (((uint32_t)(((uint32_t)(masterConfig->hostRequest.polarity)) << (1U))) & (0x2U)) |
             (((uint32_t)(((uint32_t)(masterConfig->hostRequest.source)) << (2U))) & (0x4U));
    base->MCFGR0 = value;


    value = base->MCFGR1;
    value &= ~((0x7000000U) | (0x200U));
    value |= (((uint32_t)(((uint32_t)(masterConfig->pinConfig)) << (24U))) & (0x7000000U));
    value |= (((uint32_t)(((uint32_t)(masterConfig->ignoreAck)) << (9U))) & (0x200U));
    base->MCFGR1 = value;
    ...
    if (0U != (masterConfig->sdaGlitchFilterWidth_ns))
    {
        ...
        cycles = LPI2C_GetCyclesForWidth(sourceClock_Hz, masterConfig->sdaGlitchFilterWidth_ns, 1U,
                                         ((0xF000000U) >> (24U)), 0U);
        cfgr2 &= ~(0xF000000U);
        cfgr2 |= (((uint32_t)(((uint32_t)(cycles)) << (24U))) & (0xF000000U));
    }
    if (0U != masterConfig->sclGlitchFilterWidth_ns)
    {
        ...
        cycles = LPI2C_GetCyclesForWidth(sourceClock_Hz, masterConfig->sclGlitchFilterWidth_ns, 1U,
                                         ((0xF0000U) >> (16U)), 0U);
        cfgr2 &= ~(0xF0000U);
        cfgr2 |= (((uint32_t)(((uint32_t)(cycles)) << (16U))) & (0xF0000U));
    }
    base->MCFGR2 = cfgr2;
    ...
    if (0U != (masterConfig->busIdleTimeout_ns))
    {
        ...
        cycles = LPI2C_GetCyclesForWidth(sourceClock_Hz, masterConfig->busIdleTimeout_ns, 1U,
                                         ((0xFFFU) >> (0U)), prescaler);
        cfgr2 &= ~(0xFFFU);
        cfgr2 |= (((uint32_t)(((uint32_t)(cycles)) << (0U))) & (0xFFFU));
    }
    base->MCFGR2 = cfgr2;
    if (0U != masterConfig->pinLowTimeout_ns)
    {
        ...
        cycles = LPI2C_GetCyclesForWidth(sourceClock_Hz, masterConfig->pinLowTimeout_ns / 256U, 1U,
                                         ((0xFFFU) >> (0U)), prescaler);
        base->MCFGR3 = (base->MCFGR3 & ~(0xFFF00U)) | (((uint32_t)(((uint32_t)(cycles)) << (8U))) & (0xFFF00U));
    }

    LPI2C_MasterEnable(base, masterConfig->enableMaster);
}
# 461 "../../libraries/sdk/drives/fsl_lpi2c.c"
void LPI2C_MasterDeinit(LPI2C_Type *base)
{
...
void LPI2C_MasterConfigureDataMatch(LPI2C_Type *base, const lpi2c_data_match_config_t *matchConfig)
{
    ...
    _Bool wasEnabled = (0U != ((base->MCR & (0x1U)) >> (0U)));
    LPI2C_MasterEnable(base, 0);

    base->MCFGR1 = (base->MCFGR1 & ~(0x70000U)) | (((uint32_t)(((uint32_t)(matchConfig->matchMode)) << (16U))) & (0x70000U));
    base->MCFGR0 = (base->MCFGR0 & ~(0x200U)) | (((uint32_t)(((uint32_t)(matchConfig->rxDataMatchOnly)) << (9U))) & (0x200U));
    base->MDMR = (((uint32_t)(((uint32_t)(matchConfig->match0)) << (0U))) & (0xFFU)) | (((uint32_t)(((uint32_t)(matchConfig->match1)) << (16U))) & (0xFF0000U));


    if (wasEnabled)
    {
        LPI2C_MasterEnable(base, 1);
    }
}
# 517 "../../libraries/sdk/drives/fsl_lpi2c.c"
void LPI2C_MasterSetBaudRate(LPI2C_Type *base, uint32_t sourceClock_Hz, uint32_t baudRate_Hz)
{
    _Bool wasEnabled;
    uint8_t filtScl = (uint8_t)((base->MCFGR2 & (0xF0000U)) >> (16U));
    ...
    wasEnabled = (0U != ((base->MCR & (0x1U)) >> (0U)));
    LPI2C_MasterEnable(base, 0);
...
# 557 "../../libraries/sdk/drives/fsl_lpi2c.c"
...
# 594 "../../libraries/sdk/drives/fsl_lpi2c.c"
    ...
    if ((sourceClock_Hz / baudRate_Hz / 20U) > (bestDivider + 2U))
    {
        ...
        uint8_t filtSda = (uint8_t)((base->MCFGR2 & (0xF000000U)) >> (24U));
        if (filtSda < (sourceClock_Hz / baudRate_Hz / 20U - bestDivider - 2U))
        {
            filtSda = (uint8_t)(sourceClock_Hz / baudRate_Hz / 20U) - bestDivider - 2U;
        }
        base->MCFGR2 = (base->MCFGR2 & ~(0xF000000U)) | (((uint32_t)(((uint32_t)(filtSda)) << (24U))) & (0xF000000U));
    }


    tmpReg = (((uint32_t)(((uint32_t)((uint32_t)tmpHigh)) << (8U))) & (0x3F00U)) |
             (((uint32_t)(((uint32_t)((uint32_t)((uint32_t)bestclkCycle - (uint32_t)tmpHigh))) << (0U))) & (0x3FU)) |
             (((uint32_t)(((uint32_t)((uint32_t)tmpHold)) << (16U))) & (0x3F0000U)) | (((uint32_t)(((uint32_t)((uint32_t)tmpDataVd)) << (24U))) & (0x3F000000U));
    base->MCCR0 = tmpReg;


    base->MCFGR1 = (base->MCFGR1 & ~(0x7U)) | (((uint32_t)(((uint32_t)(bestPre)) << (0U))) & (0x7U));
...
# 656 "../../libraries/sdk/drives/fsl_lpi2c.c"
status_t LPI2C_MasterStart(LPI2C_Type *base, uint8_t address, lpi2c_direction_t dir)
{
...
# 693 "../../libraries/sdk/drives/fsl_lpi2c.c"
status_t LPI2C_MasterStop(LPI2C_Type *base)
{
...
# 713 "../../libraries/sdk/drives/fsl_lpi2c.c"
...
# 754 "../../libraries/sdk/drives/fsl_lpi2c.c"
status_t LPI2C_MasterReceive(LPI2C_Type *base, void *rxBuff, size_t rxSize)
{
    ((0 != rxBuff) ? (void)0 : __aeabi_assert("NULL != rxBuff", "../../libraries/sdk/drives/fsl_lpi2c.c", 756),
# 756 "../../libraries/sdk/drives/fsl_lpi2c.c"
#pragma clang diagnostic push
# 756 "../../libraries/sdk/drives/fsl_lpi2c.c"
#pragma clang diagnostic ignored "-Wassume"
# 756 "../../libraries/sdk/drives/fsl_lpi2c.c"
    (__builtin_assume)((0 != rxBuff)?1:0)
# 756 "../../libraries/sdk/drives/fsl_lpi2c.c"
#pragma clang diagnostic pop
# 756 "../../libraries/sdk/drives/fsl_lpi2c.c"
    );
    ...
    if (rxSize != 0U)
    {
        ...
        if (kStatus_Success == result)
        {
            ...
            while (tmpRxSize != 0U)
            {
                if (tmpRxSize > 256U)
                {
                    base->MTDR = (uint32_t)(kRxDataCmd) | (uint32_t)(((uint32_t)(((uint32_t)(0xFFU)) << (0U))) & (0xFFU));
                    tmpRxSize -= 256U;
                }
                else
                {
                    base->MTDR = (uint32_t)(kRxDataCmd) | (uint32_t)(((uint32_t)(((uint32_t)(tmpRxSize - 1U)) << (0U))) & (0xFFU));
                    tmpRxSize = 0U;
                }
            }
            ...
            while (0U != (rxSize--))
            {
                ...
                do
                {
                    ...
                    value = base->MRDR;
# 824 "../../libraries/sdk/drives/fsl_lpi2c.c"
                } while (0U != (value & (0x4000U)));
...
# 856 "../../libraries/sdk/drives/fsl_lpi2c.c"
status_t LPI2C_MasterSend(LPI2C_Type *base, void *txBuff, size_t txSize)
{
    status_t result = kStatus_Success;
    uint8_t *buf = (uint8_t *)txBuff;

    ((0 != txBuff) ? (void)0 : __aeabi_assert("NULL != txBuff", "../../libraries/sdk/drives/fsl_lpi2c.c", 861),
# 861 "../../libraries/sdk/drives/fsl_lpi2c.c"
#pragma clang diagnostic push
# 861 "../../libraries/sdk/drives/fsl_lpi2c.c"
#pragma clang diagnostic ignored "-Wassume"
# 861 "../../libraries/sdk/drives/fsl_lpi2c.c"
    (__builtin_assume)((0 != txBuff)?1:0)
# 861 "../../libraries/sdk/drives/fsl_lpi2c.c"
#pragma clang diagnostic pop
# 861 "../../libraries/sdk/drives/fsl_lpi2c.c"
    );
...
# 895 "../../libraries/sdk/drives/fsl_lpi2c.c"
status_t LPI2C_MasterTransferBlocking(LPI2C_Type *base, lpi2c_master_transfer_t *transfer)
{
    ((0 != transfer) ? (void)0 : __aeabi_assert("NULL != transfer", "../../libraries/sdk/drives/fsl_lpi2c.c", 897),
# 897 "../../libraries/sdk/drives/fsl_lpi2c.c"
#pragma clang diagnostic push
# 897 "../../libraries/sdk/drives/fsl_lpi2c.c"
#pragma clang diagnostic ignored "-Wassume"
# 897 "../../libraries/sdk/drives/fsl_lpi2c.c"
    (__builtin_assume)((0 != transfer)?1:0)
# 897 "../../libraries/sdk/drives/fsl_lpi2c.c"
#pragma clang diagnostic pop
# 897 "../../libraries/sdk/drives/fsl_lpi2c.c"
    );
    ((transfer->subaddressSize <= sizeof(transfer->subaddress)) ? (void)0 : __aeabi_assert("transfer->subaddressSize <= sizeof(transfer->subaddress)", "../../libraries/sdk/drives/fsl_lpi2c.c", 898),
# 898 "../../libraries/sdk/drives/fsl_lpi2c.c"
#pragma clang diagnostic push
# 898 "../../libraries/sdk/drives/fsl_lpi2c.c"
#pragma clang diagnostic ignored "-Wassume"
# 898 "../../libraries/sdk/drives/fsl_lpi2c.c"
    (__builtin_assume)((transfer->subaddressSize <= sizeof(transfer->subaddress))?1:0)
# 898 "../../libraries/sdk/drives/fsl_lpi2c.c"
#pragma clang diagnostic pop
# 898 "../../libraries/sdk/drives/fsl_lpi2c.c"
    );
    ...
    if ((transfer->direction == kLPI2C_Read) &&
        (transfer->dataSize > (256UL * (uint32_t)(4))))
    {
        return kStatus_InvalidArgument;
    }
...
# 1013 "../../libraries/sdk/drives/fsl_lpi2c.c"
void LPI2C_MasterTransferCreateHandle(LPI2C_Type *base,
                                      lpi2c_master_handle_t *handle,
                                      lpi2c_master_transfer_callback_t callback,
                                      void *userData)
{
    ...
    ((0 != handle) ? (void)0 : __aeabi_assert("NULL != handle", "../../libraries/sdk/drives/fsl_lpi2c.c", 1020),
# 1020 "../../libraries/sdk/drives/fsl_lpi2c.c"
#pragma clang diagnostic push
# 1020 "../../libraries/sdk/drives/fsl_lpi2c.c"
#pragma clang diagnostic ignored "-Wassume"
# 1020 "../../libraries/sdk/drives/fsl_lpi2c.c"
...
# 1057 "../../libraries/sdk/drives/fsl_lpi2c.c"
static status_t LPI2C_RunTransferStateMachine(LPI2C_Type *base, lpi2c_master_handle_t *handle, _Bool *isDone)
{
    uint32_t status;
    status_t result = kStatus_Success;
        ...
        while (!state_complete)
        {
            ...
            switch (handle->state)
            {
                ...
                case (uint8_t)kIssueReadCommandState:
                    ...
                    base->MTDR = (uint32_t)kRxDataCmd | (((uint32_t)(((uint32_t)(xfer->dataSize - 1U)) << (0U))) & (0xFFU));
                ...
                case (uint8_t)kTransferDataState:
                    ...
                    else
                    {
                        ...
                        *(handle->buf)++ = (uint8_t)(base->MRDR & (0xFFU));
                    }
                ...
                case (uint8_t)kWaitForCompletionState:
                    ...
                    else
                    {
                        ...
                        if ((xfer->direction == kLPI2C_Write) && ((base->MFSR & (0x7U)) == 0U))
                        {
                    ...
                    break;
                default:
                    ((0) ? (void)0 : __aeabi_assert("false", "../../libraries/sdk/drives/fsl_lpi2c.c", 1272),
# 1272 "../../libraries/sdk/drives/fsl_lpi2c.c"
#pragma clang diagnostic push
# 1272 "../../libraries/sdk/drives/fsl_lpi2c.c"
#pragma clang diagnostic ignored "-Wassume"
# 1272 "../../libraries/sdk/drives/fsl_lpi2c.c"
...
# 1357 "../../libraries/sdk/drives/fsl_lpi2c.c"
status_t LPI2C_MasterTransferNonBlocking(LPI2C_Type *base,
                                         lpi2c_master_handle_t *handle,
                                         lpi2c_master_transfer_t *transfer)
{
    ((0 != handle) ? (void)0 : __aeabi_assert("NULL != handle", "../../libraries/sdk/drives/fsl_lpi2c.c", 1361),
# 1361 "../../libraries/sdk/drives/fsl_lpi2c.c"
#pragma clang diagnostic push
# 1361 "../../libraries/sdk/drives/fsl_lpi2c.c"
#pragma clang diagnostic ignored "-Wassume"
# 1361 "../../libraries/sdk/drives/fsl_lpi2c.c"
...
# 1361 "../../libraries/sdk/drives/fsl_lpi2c.c"
    ...
    ((0 != transfer) ? (void)0 : __aeabi_assert("NULL != transfer", "../../libraries/sdk/drives/fsl_lpi2c.c", 1362),
# 1362 "../../libraries/sdk/drives/fsl_lpi2c.c"
#pragma clang diagnostic push
# 1362 "../../libraries/sdk/drives/fsl_lpi2c.c"
#pragma clang diagnostic ignored "-Wassume"
# 1362 "../../libraries/sdk/drives/fsl_lpi2c.c"
...
# 1362 "../../libraries/sdk/drives/fsl_lpi2c.c"
    ...
    ((transfer->subaddressSize <= sizeof(transfer->subaddress)) ? (void)0 : __aeabi_assert("transfer->subaddressSize <= sizeof(transfer->subaddress)", "../../libraries/sdk/drives/fsl_lpi2c.c", 1363),
# 1363 "../../libraries/sdk/drives/fsl_lpi2c.c"
#pragma clang diagnostic push
# 1363 "../../libraries/sdk/drives/fsl_lpi2c.c"
#pragma clang diagnostic ignored "-Wassume"
# 1363 "../../libraries/sdk/drives/fsl_lpi2c.c"
...
# 1363 "../../libraries/sdk/drives/fsl_lpi2c.c"
    ...
    if ((transfer->direction == kLPI2C_Read) &&
        (transfer->dataSize > (256U * (uint32_t)(4))))
    {
        return kStatus_InvalidArgument;
    }
...
# 1419 "../../libraries/sdk/drives/fsl_lpi2c.c"
status_t LPI2C_MasterTransferGetCount(LPI2C_Type *base, lpi2c_master_handle_t *handle, size_t *count)
{
    status_t result = kStatus_Success;

    ((0 != handle) ? (void)0 : __aeabi_assert("NULL != handle", "../../libraries/sdk/drives/fsl_lpi2c.c", 1423),
# 1423 "../../libraries/sdk/drives/fsl_lpi2c.c"
#pragma clang diagnostic push
# 1423 "../../libraries/sdk/drives/fsl_lpi2c.c"
#pragma clang diagnostic ignored "-Wassume"
# 1423 "../../libraries/sdk/drives/fsl_lpi2c.c"
...
# 1487 "../../libraries/sdk/drives/fsl_lpi2c.c"
void LPI2C_MasterTransferAbort(LPI2C_Type *base, lpi2c_master_handle_t *handle)
{
    if (handle->state != (uint8_t)kIdleState)
    {
...
# 1517 "../../libraries/sdk/drives/fsl_lpi2c.c"
void LPI2C_MasterTransferHandleIRQ(LPI2C_Type *base, void *lpi2cMasterHandle)
{
    ((lpi2cMasterHandle != 0) ? (void)0 : __aeabi_assert("lpi2cMasterHandle != NULL", "../../libraries/sdk/drives/fsl_lpi2c.c", 1519),
# 1519 "../../libraries/sdk/drives/fsl_lpi2c.c"
#pragma clang diagnostic push
# 1519 "../../libraries/sdk/drives/fsl_lpi2c.c"
#pragma clang diagnostic ignored "-Wassume"
# 1519 "../../libraries/sdk/drives/fsl_lpi2c.c"
    (__builtin_assume)((lpi2cMasterHandle != 0)?1:0)
# 1519 "../../libraries/sdk/drives/fsl_lpi2c.c"
#pragma clang diagnostic pop
# 1519 "../../libraries/sdk/drives/fsl_lpi2c.c"
    );
    ...
    if (0 != handle)
    {
        if (handle->state != (uint8_t)kIdleState)
        {
            ...
            if ((result != kStatus_Success) || isDone)
            {
                ...
                if (0 != handle->completionCallback)
                {
...
# 1587 "../../libraries/sdk/drives/fsl_lpi2c.c"
void LPI2C_SlaveGetDefaultConfig(lpi2c_slave_config_t *slaveConfig)
{

    (void)memset(slaveConfig, 0, sizeof(*slaveConfig));

    slaveConfig->enableSlave = 1;
    slaveConfig->address0 = 0U;
    slaveConfig->address1 = 0U;
    slaveConfig->addressMatchMode = kLPI2C_MatchAddress0;
    slaveConfig->filterDozeEnable = 1;
    slaveConfig->filterEnable = 1;
    slaveConfig->enableGeneralCall = 0;
    slaveConfig->sclStall.enableAck = 0;
    slaveConfig->sclStall.enableTx = 1;
    slaveConfig->sclStall.enableRx = 1;
    slaveConfig->sclStall.enableAddress = 0;
    slaveConfig->ignoreAck = 0;
    slaveConfig->enableReceivedAddressRead = 0;
    slaveConfig->sdaGlitchFilterWidth_ns = 0U;
...
# 1626 "../../libraries/sdk/drives/fsl_lpi2c.c"
void LPI2C_SlaveInit(LPI2C_Type *base, const lpi2c_slave_config_t *slaveConfig, uint32_t sourceClock_Hz)
{
    uint32_t tmpReg;
    uint32_t tmpCycle;
    ...
    (void)CLOCK_EnableClock(kLpi2cClocks[instance]);
# 1645 "../../libraries/sdk/drives/fsl_lpi2c.c"
    LPI2C_SlaveReset(base);


    base->SAMR = (((uint32_t)(((uint32_t)(slaveConfig->address0)) << (1U))) & (0x7FEU)) | (((uint32_t)(((uint32_t)(slaveConfig->address1)) << (17U))) & (0x7FE0000U));

    base->SCFGR1 =
        (((uint32_t)(((uint32_t)(slaveConfig->addressMatchMode)) << (16U))) & (0x70000U)) | (((uint32_t)(((uint32_t)(slaveConfig->ignoreAck)) << (12U))) & (0x1000U)) |
        (((uint32_t)(((uint32_t)(slaveConfig->enableReceivedAddressRead)) << (11U))) & (0x800U)) | (((uint32_t)(((uint32_t)(slaveConfig->enableGeneralCall)) << (8U))) & (0x100U)) |
        (((uint32_t)(((uint32_t)(slaveConfig->sclStall.enableAck)) << (3U))) & (0x8U)) | (((uint32_t)(((uint32_t)(slaveConfig->sclStall.enableTx)) << (2U))) & (0x4U)) |
        (((uint32_t)(((uint32_t)(slaveConfig->sclStall.enableRx)) << (1U))) & (0x2U)) |
        (((uint32_t)(((uint32_t)(slaveConfig->sclStall.enableAddress)) << (0U))) & (0x1U));



    tmpReg = (((uint32_t)(((uint32_t)(LPI2C_GetCyclesForWidth(sourceClock_Hz, slaveConfig->sdaGlitchFilterWidth_ns, 4U, ((0xF000000U) >> (24U)) + 3U, 0U) - 3U)) << (24U))) & (0xF000000U));
    ...
    tmpCycle = LPI2C_GetCyclesForWidth(sourceClock_Hz, slaveConfig->sclGlitchFilterWidth_ns, 4U,
                                       ((0xF0000U) >> (16U)) + 3U, 0U);
    tmpReg |= (((uint32_t)(((uint32_t)(tmpCycle - 3U)) << (16U))) & (0xF0000U));



    tmpReg |= (((uint32_t)(((uint32_t)(LPI2C_GetCyclesForWidth(sourceClock_Hz, slaveConfig->dataValidDelay_ns, tmpCycle, tmpCycle + ((0x3F00U) >> (8U)), 0U) - tmpCycle)) << (8U))) & (0x3F00U));
    ...
    base->SCFGR2 =
        tmpReg | (((uint32_t)(((uint32_t)(LPI2C_GetCyclesForWidth(sourceClock_Hz, slaveConfig->clockHoldTime_ns, 3U, ((0xFU) >> (0U)) + 3U, 0U) - 3U)) << (0U))) & (0xFU));





    base->SCR = (((uint32_t)(((uint32_t)(!slaveConfig->filterDozeEnable)) << (5U))) & (0x20U)) | (((uint32_t)(((uint32_t)(slaveConfig->filterEnable)) << (4U))) & (0x10U)) |
                (((uint32_t)(((uint32_t)(slaveConfig->enableSlave)) << (0U))) & (0x1U));
}
# 1698 "../../libraries/sdk/drives/fsl_lpi2c.c"
void LPI2C_SlaveDeinit(LPI2C_Type *base)
{
    LPI2C_SlaveReset(base);
...
# 1725 "../../libraries/sdk/drives/fsl_lpi2c.c"
static status_t LPI2C_SlaveCheckAndClearError(LPI2C_Type *base, uint32_t flags)
{
    status_t result = kStatus_Success;
...
# 1765 "../../libraries/sdk/drives/fsl_lpi2c.c"
status_t LPI2C_SlaveSend(LPI2C_Type *base, void *txBuff, size_t txSize, size_t *actualTxSize)
{
    status_t result = kStatus_Success;
    uint8_t *buf = (uint8_t *)txBuff;
    ...
    ((0 != txBuff) ? (void)0 : __aeabi_assert("NULL != txBuff", "../../libraries/sdk/drives/fsl_lpi2c.c", 1771),
# 1771 "../../libraries/sdk/drives/fsl_lpi2c.c"
#pragma clang diagnostic push
# 1771 "../../libraries/sdk/drives/fsl_lpi2c.c"
#pragma clang diagnostic ignored "-Wassume"
# 1771 "../../libraries/sdk/drives/fsl_lpi2c.c"
...
# 1809 "../../libraries/sdk/drives/fsl_lpi2c.c"
...
# 1852 "../../libraries/sdk/drives/fsl_lpi2c.c"
status_t LPI2C_SlaveReceive(LPI2C_Type *base, void *rxBuff, size_t rxSize, size_t *actualRxSize)
{
    status_t result = kStatus_Success;
    ...
    ((0 != rxBuff) ? (void)0 : __aeabi_assert("NULL != rxBuff", "../../libraries/sdk/drives/fsl_lpi2c.c", 1858),
# 1858 "../../libraries/sdk/drives/fsl_lpi2c.c"
#pragma clang diagnostic push
# 1858 "../../libraries/sdk/drives/fsl_lpi2c.c"
#pragma clang diagnostic ignored "-Wassume"
# 1858 "../../libraries/sdk/drives/fsl_lpi2c.c"
...
# 1896 "../../libraries/sdk/drives/fsl_lpi2c.c"
...
# 1946 "../../libraries/sdk/drives/fsl_lpi2c.c"
void LPI2C_SlaveTransferCreateHandle(LPI2C_Type *base,
                                     lpi2c_slave_handle_t *handle,
                                     lpi2c_slave_transfer_callback_t callback,
                                     void *userData)
{
    ...
    ((0 != handle) ? (void)0 : __aeabi_assert("NULL != handle", "../../libraries/sdk/drives/fsl_lpi2c.c", 1953),
# 1953 "../../libraries/sdk/drives/fsl_lpi2c.c"
#pragma clang diagnostic push
# 1953 "../../libraries/sdk/drives/fsl_lpi2c.c"
#pragma clang diagnostic ignored "-Wassume"
# 1953 "../../libraries/sdk/drives/fsl_lpi2c.c"
...
# 2003 "../../libraries/sdk/drives/fsl_lpi2c.c"
status_t LPI2C_SlaveTransferNonBlocking(LPI2C_Type *base, lpi2c_slave_handle_t *handle, uint32_t eventMask)
{
    status_t result = kStatus_Success;

    ((0 != handle) ? (void)0 : __aeabi_assert("NULL != handle", "../../libraries/sdk/drives/fsl_lpi2c.c", 2007),
# 2007 "../../libraries/sdk/drives/fsl_lpi2c.c"
#pragma clang diagnostic push
# 2007 "../../libraries/sdk/drives/fsl_lpi2c.c"
#pragma clang diagnostic ignored "-Wassume"
# 2007 "../../libraries/sdk/drives/fsl_lpi2c.c"
...
# 2060 "../../libraries/sdk/drives/fsl_lpi2c.c"
status_t LPI2C_SlaveTransferGetCount(LPI2C_Type *base, lpi2c_slave_handle_t *handle, size_t *count)
{
    status_t status = kStatus_Success;

    ((0 != handle) ? (void)0 : __aeabi_assert("NULL != handle", "../../libraries/sdk/drives/fsl_lpi2c.c", 2064),
# 2064 "../../libraries/sdk/drives/fsl_lpi2c.c"
#pragma clang diagnostic push
# 2064 "../../libraries/sdk/drives/fsl_lpi2c.c"
#pragma clang diagnostic ignored "-Wassume"
# 2064 "../../libraries/sdk/drives/fsl_lpi2c.c"
...
# 2095 "../../libraries/sdk/drives/fsl_lpi2c.c"
void LPI2C_SlaveTransferAbort(LPI2C_Type *base, lpi2c_slave_handle_t *handle)
{
    ((0 != handle) ? (void)0 : __aeabi_assert("NULL != handle", "../../libraries/sdk/drives/fsl_lpi2c.c", 2097),
# 2097 "../../libraries/sdk/drives/fsl_lpi2c.c"
#pragma clang diagnostic push
# 2097 "../../libraries/sdk/drives/fsl_lpi2c.c"
#pragma clang diagnostic ignored "-Wassume"
# 2097 "../../libraries/sdk/drives/fsl_lpi2c.c"
...
# 2123 "../../libraries/sdk/drives/fsl_lpi2c.c"
void LPI2C_SlaveTransferHandleIRQ(LPI2C_Type *base, lpi2c_slave_handle_t *handle)
{
    uint32_t flags;
    ...
    if (0 != handle)
    {
        ...
        if (0U != (flags & ((uint32_t)kLPI2C_SlaveBitErrFlag | (uint32_t)kLPI2C_SlaveFifoErrFlag)))
        {
            ...
            if ((0U != (handle->eventMask & (uint32_t)kLPI2C_SlaveCompletionEvent)) && (0 != handle->callback))
            {
        ...
        else
        {
                ...
                (flags & (((uint32_t)kLPI2C_SlaveRepeatedStartDetectFlag) | ((uint32_t)kLPI2C_SlaveStopDetectFlag))))
            {
                ...
                if ((0U != (handle->eventMask & (uint32_t)xfer->event)) && (0 != handle->callback))
                {
                    handle->callback(base, xfer, handle->userData);
                }
            ...
            if (0U != (flags & (uint32_t)kLPI2C_SlaveAddressValidFlag))
            {
                ...
                xfer->receivedAddress = (uint8_t)(base->SASR & (0x7FFU));


                handle->isBusy = 1;
                if ((0U != (handle->eventMask & (uint32_t)kLPI2C_SlaveAddressMatchEvent)) && (0 != handle->callback))
                {
                    handle->callback(base, xfer, handle->userData);
                }
            }
            if (0U != (flags & (uint32_t)kLPI2C_SlaveTransmitAckFlag))
            {
                ...
                if ((0U != (handle->eventMask & (uint32_t)kLPI2C_SlaveTransmitAckEvent)) && (0 != handle->callback))
                {
                    handle->callback(base, xfer, handle->userData);
                }
            }
            ...
            if (0U != (flags & (uint32_t)kLPI2C_SlaveTxReadyFlag))
            {
                handle->wasTransmit = 1;


                if ((0 == xfer->data) || (0U == xfer->dataSize))
                {
...
# 2281 "../../libraries/sdk/drives/fsl_lpi2c.c"
static void LPI2C_CommonIRQHandler(LPI2C_Type *base, uint32_t instance)
{

    if ((0U != (base->MCR & (0x1U))) && (0 != s_lpi2cMasterIsr))
    {
    ...
    if ((0U != (base->SCR & (0x1U))) && (0 != s_lpi2cSlaveIsr))
    {
...
# 2311 "../../libraries/sdk/drives/fsl_lpi2c.c"
void LPI2C1_DriverIRQHandler(void);
void LPI2C1_DriverIRQHandler(void)
{
    LPI2C_CommonIRQHandler(((LPI2C_Type *)(0x403F0000u)), 1U);
}
...
void LPI2C2_DriverIRQHandler(void)
{
    LPI2C_CommonIRQHandler(((LPI2C_Type *)(0x403F4000u)), 2U);
}
...
void LPI2C3_DriverIRQHandler(void)
{
    LPI2C_CommonIRQHandler(((LPI2C_Type *)(0x403F8000u)), 3U);
}
...
void LPI2C4_DriverIRQHandler(void)
{
    LPI2C_CommonIRQHandler(((LPI2C_Type *)(0x403FC000u)), 4U);
}
