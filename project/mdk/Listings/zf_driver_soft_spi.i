# 1 "../../libraries/zf_driver/zf_driver_soft_spi.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/zf_driver/zf_driver_soft_spi.c" 2
# 36 "../../libraries/zf_driver/zf_driver_soft_spi.c"
...
# 37 "../../libraries/zf_driver/zf_driver_soft_spi.c" 2
...
# 39 "../../libraries/zf_driver/zf_driver_soft_spi.c" 2
# 62 "../../libraries/zf_driver/zf_driver_soft_spi.c"
static uint8 soft_spi_8bit_data_handler (soft_spi_info_struct *soft_spi_obj, const uint8 data)
{
    ...
    {
        GPIO_ClearPinsOutput(PORTPTR[soft_spi_obj->cs_pin >> 5],1 << (soft_spi_obj->cs_pin & 0x1f));
    }

    if(0 == soft_spi_obj->config.mode || 1 == soft_spi_obj->config.mode)
    {
        GPIO_ClearPinsOutput(PORTPTR[soft_spi_obj->sck_pin >> 5],1 << (soft_spi_obj->sck_pin & 0x1f));
    }
    else
    {
        GPIO_SetPinsOutput(PORTPTR[soft_spi_obj->sck_pin >> 5],1 << (soft_spi_obj->sck_pin & 0x1f));
    }

    if(0 == soft_spi_obj->config.mode % 2)
    {
        for(temp = 8; 0 < temp; temp --)
        {
            if(0x80 & write_data)
            {
                GPIO_SetPinsOutput(PORTPTR[soft_spi_obj->mosi_pin >> 5],1 << (soft_spi_obj->mosi_pin & 0x1f));
            }
            else
            {
                GPIO_ClearPinsOutput(PORTPTR[soft_spi_obj->mosi_pin >> 5],1 << (soft_spi_obj->mosi_pin & 0x1f));
            }
            for(vuint32 i = soft_spi_obj->delay; i --; );
    ...
    if(soft_spi_obj->config.use_cs)
    {
        GPIO_SetPinsOutput(PORTPTR[soft_spi_obj->cs_pin >> 5],1 << (soft_spi_obj->cs_pin & 0x1f));
    }
    return read_data;
}
# 146 "../../libraries/zf_driver/zf_driver_soft_spi.c"
...
# 230 "../../libraries/zf_driver/zf_driver_soft_spi.c"
void soft_spi_write_8bit (soft_spi_info_struct *soft_spi_obj, const uint8 data)
{
    (debug_assert_handler((0 != soft_spi_obj), "../../libraries/zf_driver/zf_driver_soft_spi.c", 232));
    soft_spi_8bit_data_handler(soft_spi_obj, data);
}
# 245 "../../libraries/zf_driver/zf_driver_soft_spi.c"
void soft_spi_write_8bit_array (soft_spi_info_struct *soft_spi_obj, const uint8 *data, uint32 len)
{
    (debug_assert_handler((0 != soft_spi_obj), "../../libraries/zf_driver/zf_driver_soft_spi.c", 247));
    (debug_assert_handler((0 != data), "../../libraries/zf_driver/zf_driver_soft_spi.c", 248));
    while(len --)
    {
        soft_spi_8bit_data_handler(soft_spi_obj, *data ++);
    }
}
# 263 "../../libraries/zf_driver/zf_driver_soft_spi.c"
void soft_spi_write_16bit (soft_spi_info_struct *soft_spi_obj, uint16 data)
{
    (debug_assert_handler((0 != soft_spi_obj), "../../libraries/zf_driver/zf_driver_soft_spi.c", 265));
    soft_spi_16bit_data_handler(soft_spi_obj, data);
}
# 278 "../../libraries/zf_driver/zf_driver_soft_spi.c"
void soft_spi_write_16bit_array (soft_spi_info_struct *soft_spi_obj, const uint16 *data, uint32 len)
{
    (debug_assert_handler((0 != soft_spi_obj), "../../libraries/zf_driver/zf_driver_soft_spi.c", 280));
    (debug_assert_handler((0 != data), "../../libraries/zf_driver/zf_driver_soft_spi.c", 281));
    while(len --)
    {
        soft_spi_16bit_data_handler(soft_spi_obj, *data ++);
    }
}
# 297 "../../libraries/zf_driver/zf_driver_soft_spi.c"
void soft_spi_write_8bit_register (soft_spi_info_struct *soft_spi_obj, const uint8 register_name, const uint8 data)
{
    (debug_assert_handler((0 != soft_spi_obj), "../../libraries/zf_driver/zf_driver_soft_spi.c", 299));
    soft_spi_8bit_data_handler(soft_spi_obj, register_name);
    soft_spi_8bit_data_handler(soft_spi_obj, data);
}
# 313 "../../libraries/zf_driver/zf_driver_soft_spi.c"
void soft_spi_write_8bit_registers (soft_spi_info_struct *soft_spi_obj, const uint8 register_name, const uint8 *data, uint32 len)
{
    (debug_assert_handler((0 != soft_spi_obj), "../../libraries/zf_driver/zf_driver_soft_spi.c", 315));
    (debug_assert_handler((0 != data), "../../libraries/zf_driver/zf_driver_soft_spi.c", 316));
    soft_spi_8bit_data_handler(soft_spi_obj, register_name);
    while(len --)
    {
        soft_spi_8bit_data_handler(soft_spi_obj, *data ++);
...
# 333 "../../libraries/zf_driver/zf_driver_soft_spi.c"
void soft_spi_write_16bit_register (soft_spi_info_struct *soft_spi_obj, const uint16 register_name, uint16 data)
{
    (debug_assert_handler((0 != soft_spi_obj), "../../libraries/zf_driver/zf_driver_soft_spi.c", 335));
    soft_spi_16bit_data_handler(soft_spi_obj, register_name);
    soft_spi_16bit_data_handler(soft_spi_obj, data);
}
# 350 "../../libraries/zf_driver/zf_driver_soft_spi.c"
void soft_spi_write_16bit_registers (soft_spi_info_struct *soft_spi_obj, const uint16 register_name, const uint16 *data, uint32 len)
{
    (debug_assert_handler((0 != soft_spi_obj), "../../libraries/zf_driver/zf_driver_soft_spi.c", 352));
    (debug_assert_handler((0 != data), "../../libraries/zf_driver/zf_driver_soft_spi.c", 353));
    soft_spi_16bit_data_handler(soft_spi_obj, register_name);
    while(len --)
    {
        soft_spi_16bit_data_handler(soft_spi_obj, *data ++);
...
# 369 "../../libraries/zf_driver/zf_driver_soft_spi.c"
uint8 soft_spi_read_8bit (soft_spi_info_struct *soft_spi_obj)
{
    (debug_assert_handler((0 != soft_spi_obj), "../../libraries/zf_driver/zf_driver_soft_spi.c", 371));
    return soft_spi_8bit_data_handler(soft_spi_obj, 0);
}
# 384 "../../libraries/zf_driver/zf_driver_soft_spi.c"
void soft_spi_read_8bit_array (soft_spi_info_struct *soft_spi_obj, uint8 *data, uint32 len)
{
    (debug_assert_handler((0 != soft_spi_obj), "../../libraries/zf_driver/zf_driver_soft_spi.c", 386));
    (debug_assert_handler((0 != data), "../../libraries/zf_driver/zf_driver_soft_spi.c", 387));
    while(len --)
    {
        *data ++ = soft_spi_8bit_data_handler(soft_spi_obj, 0);
    }
}
# 402 "../../libraries/zf_driver/zf_driver_soft_spi.c"
uint16 soft_spi_read_16bit (soft_spi_info_struct *soft_spi_obj)
{
    (debug_assert_handler((0 != soft_spi_obj), "../../libraries/zf_driver/zf_driver_soft_spi.c", 404));
    return soft_spi_16bit_data_handler(soft_spi_obj, 0);
}
# 417 "../../libraries/zf_driver/zf_driver_soft_spi.c"
void soft_spi_read_16bit_array (soft_spi_info_struct *soft_spi_obj, uint16 *data, uint32 len)
{
    (debug_assert_handler((0 != soft_spi_obj), "../../libraries/zf_driver/zf_driver_soft_spi.c", 419));
    (debug_assert_handler((0 != data), "../../libraries/zf_driver/zf_driver_soft_spi.c", 420));
    while(len --)
    {
        *data ++ = soft_spi_16bit_data_handler(soft_spi_obj, 0);
    }
}
# 436 "../../libraries/zf_driver/zf_driver_soft_spi.c"
uint8 soft_spi_read_8bit_register (soft_spi_info_struct *soft_spi_obj, const uint8 register_name)
{
    (debug_assert_handler((0 != soft_spi_obj), "../../libraries/zf_driver/zf_driver_soft_spi.c", 438));
    soft_spi_8bit_data_handler(soft_spi_obj, register_name);
    return soft_spi_8bit_data_handler(soft_spi_obj, 0);
}
# 453 "../../libraries/zf_driver/zf_driver_soft_spi.c"
void soft_spi_read_8bit_registers (soft_spi_info_struct *soft_spi_obj, const uint8 register_name, uint8 *data, uint32 len)
{
    (debug_assert_handler((0 != soft_spi_obj), "../../libraries/zf_driver/zf_driver_soft_spi.c", 455));
    (debug_assert_handler((0 != data), "../../libraries/zf_driver/zf_driver_soft_spi.c", 456));
    soft_spi_8bit_data_handler(soft_spi_obj, register_name);
    while(len --)
    {
        *data ++ = soft_spi_8bit_data_handler(soft_spi_obj, 0);
...
# 473 "../../libraries/zf_driver/zf_driver_soft_spi.c"
uint16 soft_spi_read_16bit_register (soft_spi_info_struct *soft_spi_obj, const uint16 register_name)
{
    (debug_assert_handler((0 != soft_spi_obj), "../../libraries/zf_driver/zf_driver_soft_spi.c", 475));
    soft_spi_16bit_data_handler(soft_spi_obj, register_name);
    return soft_spi_16bit_data_handler(soft_spi_obj, 0);
}
# 490 "../../libraries/zf_driver/zf_driver_soft_spi.c"
void soft_spi_read_16bit_registers (soft_spi_info_struct *soft_spi_obj, const uint16 register_name, uint16 *data, uint32 len)
{
    (debug_assert_handler((0 != soft_spi_obj), "../../libraries/zf_driver/zf_driver_soft_spi.c", 492));
    (debug_assert_handler((0 != data), "../../libraries/zf_driver/zf_driver_soft_spi.c", 493));
    soft_spi_16bit_data_handler(soft_spi_obj, register_name);
    while(len --)
    {
        *data ++ = soft_spi_16bit_data_handler(soft_spi_obj, 0);
...
# 511 "../../libraries/zf_driver/zf_driver_soft_spi.c"
void soft_spi_transfer_8bit (soft_spi_info_struct *soft_spi_obj, const uint8 *write_buffer, uint8 *read_buffer, uint32 len)
{
    (debug_assert_handler((0 != soft_spi_obj), "../../libraries/zf_driver/zf_driver_soft_spi.c", 513));
    (debug_assert_handler((0 != write_buffer), "../../libraries/zf_driver/zf_driver_soft_spi.c", 514));
    while(len --)
    {
        if(0 != read_buffer)
        {
...
# 541 "../../libraries/zf_driver/zf_driver_soft_spi.c"
void soft_spi_transfer_16bit (soft_spi_info_struct *soft_spi_obj, const uint16 *write_buffer, uint16 *read_buffer, uint32 len)
{
    (debug_assert_handler((0 != soft_spi_obj), "../../libraries/zf_driver/zf_driver_soft_spi.c", 543));
    (debug_assert_handler((0 != write_buffer), "../../libraries/zf_driver/zf_driver_soft_spi.c", 544));
    while(len --)
    {
        if(0 != read_buffer)
        {
...
# 574 "../../libraries/zf_driver/zf_driver_soft_spi.c"
void soft_spi_init (soft_spi_info_struct *soft_spi_obj, uint8 mode, uint32 delay, gpio_pin_enum sck_pin, gpio_pin_enum mosi_pin, uint32 miso_pin, uint32 cs_pin)
{
    (debug_assert_handler((0 != soft_spi_obj), "../../libraries/zf_driver/zf_driver_soft_spi.c", 576));
    (debug_assert_handler((sck_pin != mosi_pin), "../../libraries/zf_driver/zf_driver_soft_spi.c", 577));
    (debug_assert_handler((sck_pin != miso_pin), "../../libraries/zf_driver/zf_driver_soft_spi.c", 578));
    (debug_assert_handler((sck_pin != cs_pin), "../../libraries/zf_driver/zf_driver_soft_spi.c", 579));
    (debug_assert_handler((mosi_pin != miso_pin), "../../libraries/zf_driver/zf_driver_soft_spi.c", 580));
    (debug_assert_handler((mosi_pin != cs_pin), "../../libraries/zf_driver/zf_driver_soft_spi.c", 581));
    (debug_assert_handler(((miso_pin != cs_pin) || (cs_pin == (0xFFFF))), "../../libraries/zf_driver/zf_driver_soft_spi.c", 582));

    (debug_assert_handler((4 > mode), "../../libraries/zf_driver/zf_driver_soft_spi.c", 584));
    ...
    if(0 == mode || 1 == mode)
    {
        gpio_init(sck_pin, GPO, GPIO_LOW, GPO_PUSH_PULL);
    }
    else
    {
        gpio_init(sck_pin, GPO, GPIO_HIGH, GPO_PUSH_PULL);
    }
    gpio_init(mosi_pin, GPO, GPIO_HIGH, GPO_PUSH_PULL);
    ...
    else
    {
        ...
        gpio_init(soft_spi_obj->miso_pin, GPI, GPIO_HIGH, GPI_FLOATING_IN);
    }
    if((0xFFFF) == cs_pin)
    {
    ...
    else
    {
        ...
        gpio_init(soft_spi_obj->cs_pin, GPO, GPIO_HIGH, GPO_PUSH_PULL);
    }
}
