# 1 "../../libraries/components/fatfs/source/diskio.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/components/fatfs/source/diskio.c" 2
# 17 "../../libraries/components/fatfs/source/diskio.c"
# 1 "../../libraries/components/fatfs/source/ffconf.h" 1
# 18 "../../libraries/components/fatfs/source/diskio.c" 2
...
# 19 "../../libraries/components/fatfs/source/diskio.c" 2
...
# 20 "../../libraries/components/fatfs/source/diskio.c" 2
# 30 "../../libraries/components/fatfs/source/diskio.c"
...
# 31 "../../libraries/components/fatfs/source/diskio.c" 2
# 49 "../../libraries/components/fatfs/source/diskio.c"
DSTATUS disk_status (
 BYTE pdrv
)
{
 DSTATUS stat;
    switch (pdrv)
    {
# 67 "../../libraries/components/fatfs/source/diskio.c"
        case 2:
            stat = sd_disk_status(pdrv);
            return stat;
# 86 "../../libraries/components/fatfs/source/diskio.c"
        default:
            break;
    }
    return 0x01;
...
)
{
 DSTATUS stat;
    switch (pdrv)
    {
# 116 "../../libraries/components/fatfs/source/diskio.c"
        case 2:
            stat = sd_disk_initialize(pdrv);
            return stat;
# 136 "../../libraries/components/fatfs/source/diskio.c"
        default:
            break;
    }
    return 0x01;
...
)
{
 DRESULT res;
    switch (pdrv)
    {
# 169 "../../libraries/components/fatfs/source/diskio.c"
        case 2:
            res = sd_disk_read(pdrv, buff, sector, count);
            return res;
# 189 "../../libraries/components/fatfs/source/diskio.c"
        default:
            break;
    }
...
# 203 "../../libraries/components/fatfs/source/diskio.c"
DRESULT disk_write (
 BYTE pdrv,
 const BYTE *buff,
 LBA_t sector,
...
)
{
 DRESULT res;
    switch (pdrv)
    {
# 224 "../../libraries/components/fatfs/source/diskio.c"
        case 2:
            res = sd_disk_write(pdrv, buff, sector, count);
            return res;
# 244 "../../libraries/components/fatfs/source/diskio.c"
        default:
            break;
    }
    return RES_PARERR;
...
)
{
 DRESULT res;
    switch (pdrv)
    {
# 276 "../../libraries/components/fatfs/source/diskio.c"
        case 2:
            res = sd_disk_ioctl(pdrv, cmd, buff);
            return res;
# 296 "../../libraries/components/fatfs/source/diskio.c"
        default:
            break;
    }
    return RES_PARERR;
