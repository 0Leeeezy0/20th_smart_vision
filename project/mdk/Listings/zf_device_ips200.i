# 1 "../../libraries/zf_device/zf_device_ips200.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/zf_device/zf_device_ips200.c" 2
# 63 "../../libraries/zf_device/zf_device_ips200.c"
...
# 64 "../../libraries/zf_device/zf_device_ips200.c" 2
...
# 65 "../../libraries/zf_device/zf_device_ips200.c" 2
...
# 66 "../../libraries/zf_device/zf_device_ips200.c" 2
...
# 67 "../../libraries/zf_device/zf_device_ips200.c" 2
...
# 68 "../../libraries/zf_device/zf_device_ips200.c" 2
...
# 69 "../../libraries/zf_device/zf_device_ips200.c" 2
...
# 70 "../../libraries/zf_device/zf_device_ips200.c" 2
...
# 71 "../../libraries/zf_device/zf_device_ips200.c" 2
...
# 73 "../../libraries/zf_device/zf_device_ips200.c" 2

static uint16 ips200_pencolor = (RGB565_RED );
static uint16 ips200_bgcolor = (RGB565_WHITE );

static ips200_type_enum ips200_display_type = IPS200_TYPE_SPI;
static ips200_dir_enum ips200_display_dir = (IPS200_PORTAIT);
static ips200_font_size_enum ips200_display_font = (IPS200_8X16_FONT);

static uint16 ips200_x_max = 240;
static uint16 ips200_y_max = 320;

static gpio_pin_enum ips_rst_pin = (B2 );
static gpio_pin_enum ips_bl_pin = (C18);
gpio_pin_enum ips_cs_pin = (B3 );
# 174 "../../libraries/zf_device/zf_device_ips200.c"
static void ips200_write_data (const uint8 dat)
{

    (((GPIO_Type *)(0x42000000u))->DR) = (dat << ((B16) & 0x1f)) | ((((GPIO_Type *)(0x42000000u))->DR) & ~((uint32)(0x0F << ((B16) & 0x1f))) );

    (((GPIO_Type *)(0x42008000u))->DR) = ((dat>>4) << ((D12) & 0x1f)) | ((((GPIO_Type *)(0x42008000u))->DR) & ~((uint32)(0x0F << ((D12) & 0x1f))) );
}
# 189 "../../libraries/zf_device/zf_device_ips200.c"
static void ips200_write_command (const uint8 command)
{
    if(IPS200_TYPE_SPI == ips200_display_type)
    {
        fast_gpio_set_level((C19),0);
        (spi_write_8bit((SPI_3 ), (command)));
        fast_gpio_set_level((C19),1);
    }
    else
    {
        fast_gpio_set_level(ips_cs_pin,0);
        fast_gpio_set_level((B2 ),0);
        fast_gpio_set_level((B0 ),1);
        fast_gpio_set_level((B1 ),0);
        ips200_write_data(command);
        fast_gpio_set_level((B1 ),1);
        fast_gpio_set_level(ips_cs_pin,1);
    }
}
# 216 "../../libraries/zf_device/zf_device_ips200.c"
...
# 241 "../../libraries/zf_device/zf_device_ips200.c"
static void ips200_write_8bit_data_array (const uint8 *dat, uint32 len)
{
    if(IPS200_TYPE_SPI == ips200_display_type)
    {
        (spi_write_8bit_array((SPI_3 ), (dat), (len)));
    }
    else
    {
        fast_gpio_set_level(ips_cs_pin,0);
...
# 270 "../../libraries/zf_device/zf_device_ips200.c"
static void ips200_write_16bit_data (const uint16 dat)
{
    if(IPS200_TYPE_SPI == ips200_display_type)
    {
        (spi_write_16bit((SPI_3 ), (dat)));
    }
    else
    {
        fast_gpio_set_level(ips_cs_pin,0);
...
# 298 "../../libraries/zf_device/zf_device_ips200.c"
static void ips200_write_16bit_data_array (const uint16 *dat, uint32 len)
{
    if(IPS200_TYPE_SPI == ips200_display_type)
    {
        (spi_write_16bit_array((SPI_3 ), (dat), (len)));
    }
    else
    {
        fast_gpio_set_level(ips_cs_pin,0);
...
# 333 "../../libraries/zf_device/zf_device_ips200.c"
static void ips200_set_region (uint16 x1, uint16 y1, uint16 x2, uint16 y2)
{



    (debug_assert_handler((x1 < ips200_x_max), "../../libraries/zf_device/zf_device_ips200.c", 338));
    (debug_assert_handler((y1 < ips200_y_max), "../../libraries/zf_device/zf_device_ips200.c", 339));
    (debug_assert_handler((x2 < ips200_x_max), "../../libraries/zf_device/zf_device_ips200.c", 340));
    (debug_assert_handler((y2 < ips200_y_max), "../../libraries/zf_device/zf_device_ips200.c", 341));
...
# 361 "../../libraries/zf_device/zf_device_ips200.c"
...
# 400 "../../libraries/zf_device/zf_device_ips200.c"
void ips200_clear (void)
{
...
# 431 "../../libraries/zf_device/zf_device_ips200.c"
void ips200_full (const uint16 color)
{
    uint16 color_buffer[ips200_x_max];
    uint16 i = 0, j = 0;
...
# 462 "../../libraries/zf_device/zf_device_ips200.c"
void ips200_set_dir (ips200_dir_enum dir)
{
...
# 489 "../../libraries/zf_device/zf_device_ips200.c"
void ips200_set_font (ips200_font_size_enum font)
{
    ips200_display_font = font;
}
# 502 "../../libraries/zf_device/zf_device_ips200.c"
void ips200_set_color (const uint16 pen, const uint16 bgcolor)
{
    ips200_pencolor = pen;
    ips200_bgcolor = bgcolor;
}
# 517 "../../libraries/zf_device/zf_device_ips200.c"
void ips200_draw_point (uint16 x, uint16 y, const uint16 color)
{


    (debug_assert_handler((x < ips200_x_max), "../../libraries/zf_device/zf_device_ips200.c", 521));
    (debug_assert_handler((y < ips200_y_max), "../../libraries/zf_device/zf_device_ips200.c", 522));
...
# 547 "../../libraries/zf_device/zf_device_ips200.c"
void ips200_draw_line (uint16 x_start, uint16 y_start, uint16 x_end, uint16 y_end, const uint16 color)
{


    (debug_assert_handler((x_start < ips200_x_max), "../../libraries/zf_device/zf_device_ips200.c", 551));
    (debug_assert_handler((y_start < ips200_y_max), "../../libraries/zf_device/zf_device_ips200.c", 552));
    (debug_assert_handler((x_end < ips200_x_max), "../../libraries/zf_device/zf_device_ips200.c", 553));
    (debug_assert_handler((y_end < ips200_y_max), "../../libraries/zf_device/zf_device_ips200.c", 554));
...
# 610 "../../libraries/zf_device/zf_device_ips200.c"
void ips200_show_char (uint16 x, uint16 y, const char dat)
{


    (debug_assert_handler((x < ips200_x_max), "../../libraries/zf_device/zf_device_ips200.c", 614));
    (debug_assert_handler((y < ips200_y_max), "../../libraries/zf_device/zf_device_ips200.c", 615));
...
# 703 "../../libraries/zf_device/zf_device_ips200.c"
void ips200_show_string (uint16 x, uint16 y, const char dat[])
{


    (debug_assert_handler((x < ips200_x_max), "../../libraries/zf_device/zf_device_ips200.c", 707));
    (debug_assert_handler((y < ips200_y_max), "../../libraries/zf_device/zf_device_ips200.c", 708));
    ...
    while('\0' != dat[j])
    {
        switch(ips200_display_font)
        {
            ...
            case IPS200_16X16_FONT: break;
        }
        j ++;
    }
}
# 733 "../../libraries/zf_device/zf_device_ips200.c"
void ips200_show_int (uint16 x, uint16 y, const int32 dat, uint8 num)
{


    (debug_assert_handler((x < ips200_x_max), "../../libraries/zf_device/zf_device_ips200.c", 737));
    (debug_assert_handler((y < ips200_y_max), "../../libraries/zf_device/zf_device_ips200.c", 738));
    (debug_assert_handler((0 < num), "../../libraries/zf_device/zf_device_ips200.c", 739));
    (debug_assert_handler((10 >= num), "../../libraries/zf_device/zf_device_ips200.c", 740));
...
# 772 "../../libraries/zf_device/zf_device_ips200.c"
void ips200_show_uint (uint16 x, uint16 y, const uint32 dat, uint8 num)
{


    (debug_assert_handler((x < ips200_x_max), "../../libraries/zf_device/zf_device_ips200.c", 776));
    (debug_assert_handler((y < ips200_y_max), "../../libraries/zf_device/zf_device_ips200.c", 777));
    (debug_assert_handler((0 < num), "../../libraries/zf_device/zf_device_ips200.c", 778));
    (debug_assert_handler((10 >= num), "../../libraries/zf_device/zf_device_ips200.c", 779));
...
# 814 "../../libraries/zf_device/zf_device_ips200.c"
void ips200_show_float (uint16 x, uint16 y, const double dat, uint8 num, uint8 pointnum)
{


    (debug_assert_handler((x < ips200_x_max), "../../libraries/zf_device/zf_device_ips200.c", 818));
    (debug_assert_handler((y < ips200_y_max), "../../libraries/zf_device/zf_device_ips200.c", 819));
    (debug_assert_handler((0 < num), "../../libraries/zf_device/zf_device_ips200.c", 820));
    (debug_assert_handler((8 >= num), "../../libraries/zf_device/zf_device_ips200.c", 821));
    (debug_assert_handler((0 < pointnum), "../../libraries/zf_device/zf_device_ips200.c", 822));
    (debug_assert_handler((6 >= pointnum), "../../libraries/zf_device/zf_device_ips200.c", 823));
...
# 857 "../../libraries/zf_device/zf_device_ips200.c"
void ips200_show_binary_image (uint16 x, uint16 y, const uint8 *image, uint16 width, uint16 height, uint16 dis_width, uint16 dis_height)
{


    (debug_assert_handler((x < ips200_x_max), "../../libraries/zf_device/zf_device_ips200.c", 861));
    (debug_assert_handler((y < ips200_y_max), "../../libraries/zf_device/zf_device_ips200.c", 862));
    (debug_assert_handler((0 != image), "../../libraries/zf_device/zf_device_ips200.c", 863));
...
# 918 "../../libraries/zf_device/zf_device_ips200.c"
void ips200_show_gray_image (uint16 x, uint16 y, const uint8 *image, uint16 width, uint16 height, uint16 dis_width, uint16 dis_height, uint8 threshold)
{


    (debug_assert_handler((x < ips200_x_max), "../../libraries/zf_device/zf_device_ips200.c", 922));
    (debug_assert_handler((y < ips200_y_max), "../../libraries/zf_device/zf_device_ips200.c", 923));
    (debug_assert_handler((0 != image), "../../libraries/zf_device/zf_device_ips200.c", 924));
...
# 984 "../../libraries/zf_device/zf_device_ips200.c"
void ips200_show_rgb565_image (uint16 x, uint16 y, const uint16 *image, uint16 width, uint16 height, uint16 dis_width, uint16 dis_height, uint8 color_mode)
{


    (debug_assert_handler((x < ips200_x_max), "../../libraries/zf_device/zf_device_ips200.c", 988));
    (debug_assert_handler((y < ips200_y_max), "../../libraries/zf_device/zf_device_ips200.c", 989));
    (debug_assert_handler((0 != image), "../../libraries/zf_device/zf_device_ips200.c", 990));
...
# 1037 "../../libraries/zf_device/zf_device_ips200.c"
void ips200_show_wave (uint16 x, uint16 y, const uint16 *wave, uint16 width, uint16 value_max, uint16 dis_width, uint16 dis_value_max)
{


    (debug_assert_handler((x < ips200_x_max), "../../libraries/zf_device/zf_device_ips200.c", 1041));
    (debug_assert_handler((y < ips200_y_max), "../../libraries/zf_device/zf_device_ips200.c", 1042));
    (debug_assert_handler((0 != wave), "../../libraries/zf_device/zf_device_ips200.c", 1043));
...
# 1087 "../../libraries/zf_device/zf_device_ips200.c"
void ips200_show_chinese (uint16 x, uint16 y, uint8 size, const uint8 *chinese_buffer, uint8 number, const uint16 color)
{


    (debug_assert_handler((x < ips200_x_max), "../../libraries/zf_device/zf_device_ips200.c", 1091));
    (debug_assert_handler((y < ips200_y_max), "../../libraries/zf_device/zf_device_ips200.c", 1092));
    (debug_assert_handler((0 != chinese_buffer), "../../libraries/zf_device/zf_device_ips200.c", 1093));
...
# 1145 "../../libraries/zf_device/zf_device_ips200.c"
void ips200_init (ips200_type_enum type_select)
{
    if(IPS200_TYPE_SPI == type_select)
    {
        ...
        fast_gpio_init((C19), GPO, GPIO_LOW , FAST_GPO_PUSH_PULL);
    ...
    else
    {
        ...
        fast_gpio_init((B16), GPO, 0, FAST_GPO_PUSH_PULL);
        fast_gpio_init((B17), GPO, 0, FAST_GPO_PUSH_PULL);
        fast_gpio_init((B18), GPO, 0, FAST_GPO_PUSH_PULL);
        fast_gpio_init((B19), GPO, 0, FAST_GPO_PUSH_PULL);
        fast_gpio_init((D12), GPO, 0, FAST_GPO_PUSH_PULL);
        fast_gpio_init((D13), GPO, 0, FAST_GPO_PUSH_PULL);
        fast_gpio_init((D14), GPO, 0, FAST_GPO_PUSH_PULL);
        fast_gpio_init((D15), GPO, 0, FAST_GPO_PUSH_PULL);

        fast_gpio_init(ips_bl_pin , GPO, 0, FAST_GPO_PUSH_PULL);
        fast_gpio_init((B3 ), GPO, 0, FAST_GPO_PUSH_PULL);
        fast_gpio_init(ips_rst_pin , GPO, 0, FAST_GPO_PUSH_PULL);
        fast_gpio_init((B2 ), GPO, 0, FAST_GPO_PUSH_PULL);
        fast_gpio_init((B1 ), GPO, 0, FAST_GPO_PUSH_PULL);
        fast_gpio_init((B0 ), GPO, 0, FAST_GPO_PUSH_PULL);
    }

    ips200_set_dir(ips200_display_dir);
    ips200_set_color(ips200_pencolor, ips200_bgcolor);

    fast_gpio_set_level(ips_bl_pin,1);
    fast_gpio_set_level(ips_rst_pin,0);
    system_delay_ms(5);
    fast_gpio_set_level(ips_rst_pin,1);
    system_delay_ms(5);
