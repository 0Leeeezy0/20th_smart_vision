# 1 "../../libraries/zf_device/zf_device_tsl1401.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/zf_device/zf_device_tsl1401.c" 2
# 47 "../../libraries/zf_device/zf_device_tsl1401.c"
...
# 48 "../../libraries/zf_device/zf_device_tsl1401.c" 2
...
# 49 "../../libraries/zf_device/zf_device_tsl1401.c" 2
...
# 50 "../../libraries/zf_device/zf_device_tsl1401.c" 2
...
# 51 "../../libraries/zf_device/zf_device_tsl1401.c" 2
...
# 52 "../../libraries/zf_device/zf_device_tsl1401.c" 2
...
# 53 "../../libraries/zf_device/zf_device_tsl1401.c" 2

# 1 "../../libraries/zf_device/zf_device_tsl1401.h" 1
# 51 "../../libraries/zf_device/zf_device_tsl1401.h"
...
# 52 "../../libraries/zf_device/zf_device_tsl1401.h" 2
...
# 55 "../../libraries/zf_device/zf_device_tsl1401.c" 2

uint16 tsl1401_data[2][(128 )];

static uint8 tsl1401_init_state = 0;
uint8 tsl1401_finish_flag;
# 68 "../../libraries/zf_device/zf_device_tsl1401.c"
void tsl1401_collect_pit_handler (void)
{
    ...
    {
        ((0) ? (GPIO_SetPinsOutput(PORTPTR[(B2) >> 5],1 << ((B2) & 0x1f))) : (GPIO_ClearPinsOutput(PORTPTR[(B2) >> 5],1 << ((B2) & 0x1f))));
        tsl1401_data[0][i] = adc_convert((ADC1_CH0_B27));
        tsl1401_data[1][i] = adc_convert((ADC1_CH1_B12));
        ((1) ? (GPIO_SetPinsOutput(PORTPTR[(B2) >> 5],1 << ((B2) & 0x1f))) : (GPIO_ClearPinsOutput(PORTPTR[(B2) >> 5],1 << ((B2) & 0x1f))));
    }

    tsl1401_finish_flag = 1;
}
# 103 "../../libraries/zf_device/zf_device_tsl1401.c"
void tsl1401_send_data (uart_index_enum uart_n, uint8 index)
{
    uint8 i;
    ...
    for(i=0; i<(128 ); i++)
    {
        uart_write_byte(uart_n, tsl1401_data[index][i] >> 8);
        uart_write_byte(uart_n, tsl1401_data[index][i] & 0xFF);
    }
}
# 126 "../../libraries/zf_device/zf_device_tsl1401.c"
void tsl1401_init (void)
{
    tsl1401_init_state = 1;
    adc_init((ADC1_CH0_B27), (ADC_8BIT));
    adc_init((ADC1_CH1_B12), (ADC_8BIT));
    gpio_init((B2), GPO, GPIO_LOW, GPO_PUSH_PULL);
    gpio_init((B3), GPO, GPIO_LOW, GPO_PUSH_PULL);
    (pit_init(((PIT_CH3)), ((10 )) * (CLOCK_GetFreq(kCLOCK_PerClk) / 1000)));
}
