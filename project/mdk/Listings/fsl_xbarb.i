# 1 "../../libraries/sdk/drives/fsl_xbarb.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/sdk/drives/fsl_xbarb.c" 2
...
# 1 "../../libraries/sdk/drives/fsl_xbarb.h" 1
# 12 "../../libraries/sdk/drives/fsl_xbarb.h"
...
# 13 "../../libraries/sdk/drives/fsl_xbarb.h" 2
# 50 "../../libraries/sdk/drives/fsl_xbarb.h"
void XBARB_Init(XBARB_Type *base);
# 59 "../../libraries/sdk/drives/fsl_xbarb.h"
void XBARB_Deinit(XBARB_Type *base);
# 72 "../../libraries/sdk/drives/fsl_xbarb.h"
void XBARB_SetSignalsConnection(XBARB_Type *base, xbar_input_signal_t input, xbar_output_signal_t output);
# 10 "../../libraries/sdk/drives/fsl_xbarb.c" 2
# 20 "../../libraries/sdk/drives/fsl_xbarb.c"
typedef union
{
    uint8_t _u8[2];
    uint16_t _u16;
} xbarb_u8_u16_t;
# 36 "../../libraries/sdk/drives/fsl_xbarb.c"
...
static XBARB_Type *const s_xbarbBases[] = { (XBARB_Type *)0u, (XBARB_Type *)0u, ((XBARB_Type *)(0x403C0000u)), ((XBARB_Type *)(0x403C4000u)) };



static const clock_ip_name_t s_xbarbClock[] = { kCLOCK_IpInvalid, kCLOCK_IpInvalid, kCLOCK_Xbar2, kCLOCK_Xbar3 };
...
static uint32_t XBARB_GetInstance(XBARB_Type *base)
{
    ...
    for (instance = 0; instance < (sizeof(s_xbarbBases) / sizeof((s_xbarbBases)[0])); instance++)
    {
    ...
    ((instance < (sizeof(s_xbarbBases) / sizeof((s_xbarbBases)[0]))) ? (void)0 : __aeabi_assert("instance < ARRAY_SIZE(s_xbarbBases)", "../../libraries/sdk/drives/fsl_xbarb.c", 67),
# 67 "../../libraries/sdk/drives/fsl_xbarb.c"
#pragma clang diagnostic push
# 67 "../../libraries/sdk/drives/fsl_xbarb.c"
#pragma clang diagnostic ignored "-Wassume"
# 67 "../../libraries/sdk/drives/fsl_xbarb.c"
    (__builtin_assume)((instance < (sizeof(s_xbarbBases) / sizeof((s_xbarbBases)[0])))?1:0)
# 67 "../../libraries/sdk/drives/fsl_xbarb.c"
#pragma clang diagnostic pop
# 67 "../../libraries/sdk/drives/fsl_xbarb.c"
    );
...
# 79 "../../libraries/sdk/drives/fsl_xbarb.c"
void XBARB_Init(XBARB_Type *base)
{
...
# 94 "../../libraries/sdk/drives/fsl_xbarb.c"
void XBARB_Deinit(XBARB_Type *base)
{
...
# 113 "../../libraries/sdk/drives/fsl_xbarb.c"
void XBARB_SetSignalsConnection(XBARB_Type *base, xbar_input_signal_t input, xbar_output_signal_t output)
{
