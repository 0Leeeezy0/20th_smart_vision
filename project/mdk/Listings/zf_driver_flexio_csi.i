# 1 "../../libraries/zf_driver/zf_driver_flexio_csi.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/zf_driver/zf_driver_flexio_csi.c" 2
# 37 "../../libraries/zf_driver/zf_driver_flexio_csi.c"
# 1 "../../libraries/sdk/drives\\fsl_flexio_camera.h" 1
# 12 "../../libraries/sdk/drives\\fsl_flexio_camera.h"
...
# 13 "../../libraries/sdk/drives\\fsl_flexio_camera.h" 2
...
# 14 "../../libraries/sdk/drives\\fsl_flexio_camera.h" 2
# 33 "../../libraries/sdk/drives\\fsl_flexio_camera.h"
enum
{
    kStatus_FLEXIO_CAMERA_RxBusy = ((((kStatusGroup_FLEXIO_CAMERA)*100L) + (0))),
    kStatus_FLEXIO_CAMERA_RxIdle = ((((kStatusGroup_FLEXIO_CAMERA)*100L) + (1))),
};
...
# 100 "../../libraries/sdk/drives\\fsl_flexio_camera.h"
void FLEXIO_CAMERA_Init(FLEXIO_CAMERA_Type *base, const flexio_camera_config_t *config);
# 109 "../../libraries/sdk/drives\\fsl_flexio_camera.h"
void FLEXIO_CAMERA_Deinit(FLEXIO_CAMERA_Type *base);
# 121 "../../libraries/sdk/drives\\fsl_flexio_camera.h"
...
static inline void FLEXIO_CAMERA_Enable(FLEXIO_CAMERA_Type *base, _Bool enable)
{
    if (enable)
    {
...
# 206 "../../libraries/sdk/drives\\fsl_flexio_camera.h"
static inline void FLEXIO_CAMERA_EnableRxDMA(FLEXIO_CAMERA_Type *base, _Bool enable)
{
...
# 38 "../../libraries/zf_driver/zf_driver_flexio_csi.c" 2
...
# 40 "../../libraries/zf_driver/zf_driver_flexio_csi.c" 2
# 1 "../../libraries/sdk/drives\\fsl_dmamux.h" 1
# 50 "../../libraries/sdk/drives\\fsl_dmamux.h"
void DMAMUX_Init(DMAMUX_Type *base);
# 59 "../../libraries/sdk/drives\\fsl_dmamux.h"
void DMAMUX_Deinit(DMAMUX_Type *base);
# 75 "../../libraries/sdk/drives\\fsl_dmamux.h"
static inline void DMAMUX_EnableChannel(DMAMUX_Type *base, uint32_t channel)
{
    ((channel < (uint32_t)(32)) ? (void)0 : __aeabi_assert("channel < (uint32_t)FSL_FEATURE_DMAMUX_MODULE_CHANNEL", "../../libraries/sdk/drives\\fsl_dmamux.h", 77),
# 77 "../../libraries/sdk/drives\\fsl_dmamux.h"
#pragma clang diagnostic push
# 77 "../../libraries/sdk/drives\\fsl_dmamux.h"
#pragma clang diagnostic ignored "-Wassume"
# 77 "../../libraries/sdk/drives\\fsl_dmamux.h"
...
# 77 "../../libraries/sdk/drives\\fsl_dmamux.h"
    ...
    base->CHCFG[channel] |= (0x80000000U);
}
# 91 "../../libraries/sdk/drives\\fsl_dmamux.h"
static inline void DMAMUX_DisableChannel(DMAMUX_Type *base, uint32_t channel)
{
    ((channel < (uint32_t)(32)) ? (void)0 : __aeabi_assert("channel < (uint32_t)FSL_FEATURE_DMAMUX_MODULE_CHANNEL", "../../libraries/sdk/drives\\fsl_dmamux.h", 93),
# 93 "../../libraries/sdk/drives\\fsl_dmamux.h"
#pragma clang diagnostic push
# 93 "../../libraries/sdk/drives\\fsl_dmamux.h"
#pragma clang diagnostic ignored "-Wassume"
# 93 "../../libraries/sdk/drives\\fsl_dmamux.h"
...
# 109 "../../libraries/sdk/drives\\fsl_dmamux.h"
static inline void DMAMUX_SetSource(DMAMUX_Type *base, uint32_t channel, uint32_t source)
{
    ((channel < (uint32_t)(32)) ? (void)0 : __aeabi_assert("channel < (uint32_t)FSL_FEATURE_DMAMUX_MODULE_CHANNEL", "../../libraries/sdk/drives\\fsl_dmamux.h", 111),
# 111 "../../libraries/sdk/drives\\fsl_dmamux.h"
#pragma clang diagnostic push
# 111 "../../libraries/sdk/drives\\fsl_dmamux.h"
#pragma clang diagnostic ignored "-Wassume"
# 111 "../../libraries/sdk/drives\\fsl_dmamux.h"
...
# 111 "../../libraries/sdk/drives\\fsl_dmamux.h"
    ...
    base->CHCFG[channel] = ((base->CHCFG[channel] & ~(0x7FU)) | (((uint32_t)(((uint32_t)(source)) << (0U))) & (0x7FU)));



}
# 129 "../../libraries/sdk/drives\\fsl_dmamux.h"
static inline void DMAMUX_EnablePeriodTrigger(DMAMUX_Type *base, uint32_t channel)
{
    ((channel < (uint32_t)(32)) ? (void)0 : __aeabi_assert("channel < (uint32_t)FSL_FEATURE_DMAMUX_MODULE_CHANNEL", "../../libraries/sdk/drives\\fsl_dmamux.h", 131),
# 131 "../../libraries/sdk/drives\\fsl_dmamux.h"
#pragma clang diagnostic push
# 131 "../../libraries/sdk/drives\\fsl_dmamux.h"
#pragma clang diagnostic ignored "-Wassume"
# 131 "../../libraries/sdk/drives\\fsl_dmamux.h"
...
# 131 "../../libraries/sdk/drives\\fsl_dmamux.h"
    ...
    base->CHCFG[channel] |= (0x40000000U);
}
# 144 "../../libraries/sdk/drives\\fsl_dmamux.h"
static inline void DMAMUX_DisablePeriodTrigger(DMAMUX_Type *base, uint32_t channel)
{
    ((channel < (uint32_t)(32)) ? (void)0 : __aeabi_assert("channel < (uint32_t)FSL_FEATURE_DMAMUX_MODULE_CHANNEL", "../../libraries/sdk/drives\\fsl_dmamux.h", 146),
# 146 "../../libraries/sdk/drives\\fsl_dmamux.h"
#pragma clang diagnostic push
# 146 "../../libraries/sdk/drives\\fsl_dmamux.h"
#pragma clang diagnostic ignored "-Wassume"
# 146 "../../libraries/sdk/drives\\fsl_dmamux.h"
...
# 166 "../../libraries/sdk/drives\\fsl_dmamux.h"
static inline void DMAMUX_EnableAlwaysOn(DMAMUX_Type *base, uint32_t channel, _Bool enable)
{
    ((channel < (uint32_t)(32)) ? (void)0 : __aeabi_assert("channel < (uint32_t)FSL_FEATURE_DMAMUX_MODULE_CHANNEL", "../../libraries/sdk/drives\\fsl_dmamux.h", 168),
# 168 "../../libraries/sdk/drives\\fsl_dmamux.h"
#pragma clang diagnostic push
# 168 "../../libraries/sdk/drives\\fsl_dmamux.h"
#pragma clang diagnostic ignored "-Wassume"
# 168 "../../libraries/sdk/drives\\fsl_dmamux.h"
...
# 168 "../../libraries/sdk/drives\\fsl_dmamux.h"
    ...
    if (enable)
    {
        base->CHCFG[channel] |= (0x20000000U);
    }
    else
    {
        base->CHCFG[channel] &= ~(0x20000000U);
...
# 41 "../../libraries/zf_driver/zf_driver_flexio_csi.c" 2
...
# 42 "../../libraries/zf_driver/zf_driver_flexio_csi.c" 2
...
# 43 "../../libraries/zf_driver/zf_driver_flexio_csi.c" 2
...
# 45 "../../libraries/zf_driver/zf_driver_flexio_csi.c" 2
...
{
    uint8 i;
    uint32 temp_config[5] = {0x401F813CU, 0x4U, 0, 0, 0x401F832CU};
    (debug_assert_handler((FLEXIO2_D24_C24 >= dat_pin_start), "../../libraries/zf_driver/zf_driver_flexio_csi.c", 64));
    (debug_assert_handler(((pclk_pin < dat_pin_start) || (pclk_pin > (dat_pin_start + 7))), "../../libraries/zf_driver/zf_driver_flexio_csi.c", 65));
    (debug_assert_handler(((href_pin < dat_pin_start) || (href_pin > (dat_pin_start + 7))), "../../libraries/zf_driver/zf_driver_flexio_csi.c", 66));
    (debug_assert_handler((href_pin != pclk_pin), "../../libraries/zf_driver/zf_driver_flexio_csi.c", 67));

    afio_init(temp_config[0] + pclk_pin * 4, temp_config[1], temp_config[2], temp_config[3], temp_config[4] + pclk_pin * 4, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);
    afio_init(temp_config[0] + href_pin * 4, temp_config[1], temp_config[2], temp_config[3], temp_config[4] + href_pin * 4, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);

    for(i=0; i<8; i++)
    {
        afio_init(temp_config[0] + (dat_pin_start + i) * 4, temp_config[1], temp_config[2], temp_config[3], temp_config[4] + (dat_pin_start + i) * 4, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);
    }
}
# 86 "../../libraries/zf_driver/zf_driver_flexio_csi.c"
void flexio_csi_enable(uint8 enable)
{
    if(enable)
    {
        s_FlexioCameraDevice.flexioBase->CTRL |= (0x1U);
    }
    else
    {
        s_FlexioCameraDevice.flexioBase->CTRL &= ~(0x1U);
...
# 106 "../../libraries/zf_driver/zf_driver_flexio_csi.c"
void flexio_csi_flag_clear(void)
{
...
void flexio_csi_dma_restart(uint8 *dest_addr)
{
    ((DMA_Type *)(0x400E8000u))->TCD[0u].DADDR = (uint32_t)(dest_addr);
    flexio_csi_flag_clear();
    ((DMA_Type *)(0x400E8000u))->SERQ = (((uint8_t)(((uint8_t)(0u)) << (0U))) & (0x1FU));
}
...
void flexio_csi_enable_rxdma(void)
{
    FLEXIO_CAMERA_EnableRxDMA(&s_FlexioCameraDevice, 1);
}
# 143 "../../libraries/zf_driver/zf_driver_flexio_csi.c"
void flexio_csi_dma_init(uint8 *dest_addr, uint32 count, edma_callback callback)
{
    edma_modulo_t s_addr_modulo;

    DMAMUX_Deinit(((DMAMUX_Type *)(0x400EC000u)));
    DMAMUX_Init(((DMAMUX_Type *)(0x400EC000u)));
    DMAMUX_SetSource(((DMAMUX_Type *)(0x400EC000u)), 0u, kDmaRequestMuxFlexIO2Request2Request3);
    DMAMUX_EnableChannel(((DMAMUX_Type *)(0x400EC000u)), 0u);

    EDMA_GetDefaultConfig(&edma_config);
    EDMA_Deinit(((DMA_Type *)(0x400E8000u)));
    EDMA_Init(((DMA_Type *)(0x400E8000u)), &edma_config);
    ((DMA_Type *)(0x400E8000u))->CERR = (0x1FU) | (0x40U);

    EDMA_CreateHandle(&g_EDMA_Handle, ((DMA_Type *)(0x400E8000u)), 0u);
    EDMA_SetCallback(&g_EDMA_Handle, callback, 0);
    ...
    switch(4*flexio_shift_count)
    {
        ...
        default:((0) ? (void)0 : __aeabi_assert("0", "../../libraries/zf_driver/zf_driver_flexio_csi.c", 177),
# 177 "../../libraries/zf_driver/zf_driver_flexio_csi.c"
#pragma clang diagnostic push
# 177 "../../libraries/zf_driver/zf_driver_flexio_csi.c"
#pragma clang diagnostic ignored "-Wassume"
# 177 "../../libraries/zf_driver/zf_driver_flexio_csi.c"
...
# 177 "../../libraries/zf_driver/zf_driver_flexio_csi.c"
    ...
    EDMA_SetModulo(((DMA_Type *)(0x400E8000u)),0u,s_addr_modulo,kEDMA_ModuloDisable);
    EDMA_StartTransfer(&g_EDMA_Handle);
}
# 193 "../../libraries/zf_driver/zf_driver_flexio_csi.c"
void flexio_csi_init(flexio_pin_enum dat_pin_start, flexio_pin_enum pclk_pin, flexio_pin_enum href_pin, uint16 width, uint16 height, uint8 *dest_addr, edma_callback callback)
{
    ...
    s_FlexioCameraDevice.flexioBase = ((FLEXIO_Type *)(0x401B0000u));
    s_FlexioCameraDevice.datPinStartIdx = dat_pin_start;
    s_FlexioCameraDevice.pclkPinIdx = pclk_pin;
    s_FlexioCameraDevice.hrefPinIdx = href_pin;
    s_FlexioCameraDevice.shifterStartIdx = 4-flexio_shift_count;
    s_FlexioCameraDevice.shifterCount = flexio_shift_count;
    s_FlexioCameraDevice.timerIdx = 3;

    CLOCK_EnableClock(kCLOCK_Flexio2);
    FLEXIO_Reset(((FLEXIO_Type *)(0x401B0000u)));
    FLEXIO_CAMERA_GetDefaultConfig(&s_FlexioCameraConfig);
    FLEXIO_CAMERA_Init(&s_FlexioCameraDevice, &s_FlexioCameraConfig);
    FLEXIO_CAMERA_ClearStatusFlags(&s_FlexioCameraDevice, kFLEXIO_CAMERA_RxDataRegFullFlag | kFLEXIO_CAMERA_RxErrorFlag);
    FLEXIO_CAMERA_Enable(&s_FlexioCameraDevice, 1);
