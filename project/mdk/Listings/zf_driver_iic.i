# 1 "../../libraries/zf_driver/zf_driver_iic.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/zf_driver/zf_driver_iic.c" 2
# 37 "../../libraries/zf_driver/zf_driver_iic.c"
...
# 38 "../../libraries/zf_driver/zf_driver_iic.c" 2
...
# 39 "../../libraries/zf_driver/zf_driver_iic.c" 2
...
# 40 "../../libraries/zf_driver/zf_driver_iic.c" 2
...
# 41 "../../libraries/zf_driver/zf_driver_iic.c" 2
...
# 42 "../../libraries/zf_driver/zf_driver_iic.c" 2
...
# 44 "../../libraries/zf_driver/zf_driver_iic.c" 2

static LPI2C_Type *iic_index[] = { (LPI2C_Type *)0u, ((LPI2C_Type *)(0x403F0000u)), ((LPI2C_Type *)(0x403F4000u)), ((LPI2C_Type *)(0x403F8000u)), ((LPI2C_Type *)(0x403FC000u)) };
...
void iic_iomuxc(iic_index_enum iic_n, iic_scl_pin_enum scl_pin, iic_sda_pin_enum sda_pin)
{
    switch(iic_n)
    {
        case IIC_1:
        {
            if (IIC1_SDA_B17 == sda_pin) afio_init(0x401F8100U, 0x3U, 0x401F84D0U, 0x1U, 0x401F82F0U, 1, SPEED_100MHZ | KEEPER_EN | PULLUP_22K | DSE_R0_6 | OD_EN);

            if (IIC1_SCL_B16 == scl_pin) afio_init(0x401F80FCU, 0x3U, 0x401F84CCU, 0x1U, 0x401F82ECU, 1, SPEED_100MHZ | KEEPER_EN | PULLUP_22K | DSE_R0_6 | OD_EN);
            else if (IIC1_SCL_D4 == scl_pin) afio_init(0x401F81E4U, 0x2U, 0x401F84CCU, 0x0U, 0x401F83D4U, 1, SPEED_100MHZ | KEEPER_EN | PULLUP_22K | DSE_R0_6 | OD_EN);
        }break;

        case IIC_2:
        {
            if (IIC2_SDA_C5 == sda_pin) afio_init(0x401F8150U, 0x2U, 0x401F84D8U, 0x1U, 0x401F8340U, 1, SPEED_100MHZ | KEEPER_EN | PULLUP_22K | DSE_R0_6 | OD_EN);

            if (IIC2_SCL_C4 == scl_pin) afio_init(0x401F814CU, 0x2U, 0x401F84D4U, 0x1U, 0x401F833CU, 1, SPEED_100MHZ | KEEPER_EN | PULLUP_22K | DSE_R0_6 | OD_EN);
        }break;

        case IIC_3:
        {
            if (IIC3_SDA_B22 == sda_pin) afio_init(0x401F8114U, 0x1U, 0x401F84E0U, 0x2U, 0x401F8304U, 1, SPEED_100MHZ | KEEPER_EN | PULLUP_22K | DSE_R0_6 | OD_EN);
            else if (IIC3_SDA_D13 == sda_pin) afio_init(0x401F81C0U, 0x2U, 0x401F84E0U, 0x1U, 0x401F83B0U, 1, SPEED_100MHZ | KEEPER_EN | PULLUP_22K | DSE_R0_6 | OD_EN);

            if (IIC3_SCL_B23 == scl_pin) afio_init(0x401F8118U, 0x1U, 0x401F84DCU, 0x2U, 0x401F8308U, 1, SPEED_100MHZ | KEEPER_EN | PULLUP_22K | DSE_R0_6 | OD_EN);
            else if (IIC3_SCL_D12 == scl_pin) afio_init(0x401F81BCU, 0x2U, 0x401F84DCU, 0x1U, 0x401F83ACU, 1, SPEED_100MHZ | KEEPER_EN | PULLUP_22K | DSE_R0_6 | OD_EN);
        }break;

        case IIC_4:
        {
            if (IIC4_SDA_B13 == sda_pin) afio_init(0x401F80F0U, 0x0U, 0x401F84E8U, 0x1U, 0x401F82E0U, 1, SPEED_100MHZ | KEEPER_EN | PULLUP_22K | DSE_R0_6 | OD_EN);

            if (IIC4_SCL_B12 == scl_pin) afio_init(0x401F80ECU, 0x0U, 0x401F84E4U, 0x1U, 0x401F82DCU, 1, SPEED_100MHZ | KEEPER_EN | PULLUP_22K | DSE_R0_6 | OD_EN);
        }break;

        default:(debug_assert_handler((0), "../../libraries/zf_driver/zf_driver_iic.c", 87));break;
    }
}
# 99 "../../libraries/zf_driver/zf_driver_iic.c"
void iic_write_8bit (iic_index_enum iic_n, uint8 target_addr, const uint8 data)
{
...
# 133 "../../libraries/zf_driver/zf_driver_iic.c"
void iic_write_8bit_array (iic_index_enum iic_n, uint8 target_addr, const uint8 *data, uint32 len)
{
    status_t state = kStatus_Fail;
...
# 166 "../../libraries/zf_driver/zf_driver_iic.c"
void iic_write_16bit (iic_index_enum iic_n, uint8 target_addr, const uint16 data)
{
    status_t state = kStatus_Fail;
    uint8 temp_data[2];
...
# 201 "../../libraries/zf_driver/zf_driver_iic.c"
void iic_write_16bit_array (iic_index_enum iic_n, uint8 target_addr, const uint16 *data, uint32 len)
{
    status_t state = kStatus_Fail;
    uint8 temp_data[2];
...
# 241 "../../libraries/zf_driver/zf_driver_iic.c"
void iic_write_8bit_register (iic_index_enum iic_n, uint8 target_addr, const uint8 register_name, const uint8 data)
{
    status_t state = kStatus_Fail;
...
# 285 "../../libraries/zf_driver/zf_driver_iic.c"
void iic_write_8bit_registers (iic_index_enum iic_n, uint8 target_addr, const uint8 register_name, const uint8 *data, uint32 len)
{
    status_t state = kStatus_Fail;
...
# 328 "../../libraries/zf_driver/zf_driver_iic.c"
void iic_write_16bit_register (iic_index_enum iic_n, uint8 target_addr, const uint16 register_name, const uint16 data)
{
    status_t state = kStatus_Fail;
    uint8 temp_data[2];
...
# 373 "../../libraries/zf_driver/zf_driver_iic.c"
void iic_write_16bit_registers (iic_index_enum iic_n, uint8 target_addr, const uint16 register_name, const uint16 *data, uint32 len)
{
    status_t state = kStatus_Fail;
    uint8 temp_data[2];
...
# 416 "../../libraries/zf_driver/zf_driver_iic.c"
uint8 iic_read_8bit (iic_index_enum iic_n, uint8 target_addr)
{
    status_t state = kStatus_Fail;
    uint8 return_data = 0;
...
# 451 "../../libraries/zf_driver/zf_driver_iic.c"
void iic_read_8bit_array (iic_index_enum iic_n, uint8 target_addr, uint8 *data, uint32 len)
{
    status_t state = kStatus_Fail;
    do
...
# 482 "../../libraries/zf_driver/zf_driver_iic.c"
uint16 iic_read_16bit (iic_index_enum iic_n, uint8 target_addr)
{
    status_t state = kStatus_Fail;
...
# 519 "../../libraries/zf_driver/zf_driver_iic.c"
void iic_read_16bit_array (iic_index_enum iic_n, uint8 target_addr, uint16 *data, uint32 len)
{
    status_t state = kStatus_Fail;
    uint8 temp_data[2];
...
# 556 "../../libraries/zf_driver/zf_driver_iic.c"
uint8 iic_read_8bit_register (iic_index_enum iic_n, uint8 target_addr, const uint8 register_name)
{
    status_t state = kStatus_Fail;
    uint8 return_data = 0;
...
# 594 "../../libraries/zf_driver/zf_driver_iic.c"
void iic_read_8bit_registers (iic_index_enum iic_n, uint8 target_addr, const uint8 register_name, uint8 *data, uint32 len)
{
    status_t state = kStatus_Fail;
    do
...
# 628 "../../libraries/zf_driver/zf_driver_iic.c"
uint16 iic_read_16bit_register (iic_index_enum iic_n, uint8 target_addr, const uint16 register_name)
{
    status_t state = kStatus_Fail;
    uint16 return_data = 0;
...
# 676 "../../libraries/zf_driver/zf_driver_iic.c"
void iic_read_16bit_registers (iic_index_enum iic_n, uint8 target_addr, const uint16 register_name, uint16 *data, uint32 len)
{
    status_t state = kStatus_Fail;
    uint8 temp_data[2];
...
# 725 "../../libraries/zf_driver/zf_driver_iic.c"
void iic_transfer_8bit_array (iic_index_enum iic_n, uint8 target_addr, const uint8 *write_data, uint32 write_len, uint8 *read_data, uint32 read_len)
{
    status_t state = kStatus_Fail;
    do
...
# 762 "../../libraries/zf_driver/zf_driver_iic.c"
void iic_transfer_16bit_array (iic_index_enum iic_n, uint8 target_addr, const uint16 *write_data, uint32 write_len, uint16 *read_data, uint32 read_len)
{
    status_t state = kStatus_Fail;
    uint8 temp_data[2];
...
# 811 "../../libraries/zf_driver/zf_driver_iic.c"
void iic_sccb_write_register (iic_index_enum iic_n, uint8 target_addr, const uint8 register_name, uint8 data)
{
    status_t state = kStatus_Fail;
...
# 853 "../../libraries/zf_driver/zf_driver_iic.c"
uint8 iic_sccb_read_register (iic_index_enum iic_n, uint8 target_addr, const uint8 register_name)
{
    uint8 data = 0;
...
# 913 "../../libraries/zf_driver/zf_driver_iic.c"
void iic_init(iic_index_enum iic_n, uint8 addr, uint32 baud, iic_scl_pin_enum scl_pin, iic_sda_pin_enum sda_pin)
{
    (debug_assert_handler(((baud >= 1000)&&(baud <= 1000000)), "../../libraries/zf_driver/zf_driver_iic.c", 915));
    (debug_assert_handler(((scl_pin / 16) == (sda_pin / 16)), "../../libraries/zf_driver/zf_driver_iic.c", 916));
    ...
    CLOCK_SetDiv(kCLOCK_Lpi2cDiv, (0x05));
# 935 "../../libraries/zf_driver/zf_driver_iic.c"
    LPI2C_MasterGetDefaultConfig(&masterConfig);
    masterConfig.baudRate_Hz = baud;
    LPI2C_MasterInit(iic_index[iic_n], &masterConfig, ((CLOCK_GetFreq(kCLOCK_Usb1PllClk) / 8) / ((0x05) + 1)));
    LPI2C_MasterReset(iic_index[iic_n]);
    LPI2C_MasterInit(iic_index[iic_n], &masterConfig, ((CLOCK_GetFreq(kCLOCK_Usb1PllClk) / 8) / ((0x05) + 1)));
}
