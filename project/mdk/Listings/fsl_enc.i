# 1 "../../libraries/sdk/drives/fsl_enc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/sdk/drives/fsl_enc.c" 2
...
# 1 "../../libraries/sdk/drives/fsl_enc.h" 1
# 12 "../../libraries/sdk/drives/fsl_enc.h"
...
# 13 "../../libraries/sdk/drives/fsl_enc.h" 2
# 26 "../../libraries/sdk/drives/fsl_enc.h"
...
{
    kENC_RawHOMEStatusFlag = (0x1U),
    kENC_RawINDEXStatusFlag = (0x2U),
    kENC_RawPHBStatusFlag = (0x4U),
    kENC_RawPHAEXStatusFlag = (0x8U),
    kENC_FilteredHOMEStatusFlag = (0x10U),
    kENC_FilteredINDEXStatusFlag = (0x20U),
    kENC_FilteredPHBStatusFlag = (0x40U),
    kENC_FilteredPHAStatusFlag = (0x80U),
};
...
# 108 "../../libraries/sdk/drives/fsl_enc.h"
...
void ENC_EnableWatchdog(ENC_Type *base, _Bool enable);
...
# 353 "../../libraries/sdk/drives/fsl_enc.h"
...
# 370 "../../libraries/sdk/drives/fsl_enc.h"
static inline uint16_t ENC_GetSignalStatusFlags(ENC_Type *base)
{
    return base->IMR;
}
# 387 "../../libraries/sdk/drives/fsl_enc.h"
...
static ENC_Type *const s_encBases[] = { (ENC_Type *)0u, ((ENC_Type *)(0x403C8000u)), ((ENC_Type *)(0x403CC000u)), ((ENC_Type *)(0x403D0000u)), ((ENC_Type *)(0x403D4000u)) };



static const clock_ip_name_t s_encClocks[] = { kCLOCK_IpInvalid, kCLOCK_Enc1, kCLOCK_Enc2, kCLOCK_Enc3, kCLOCK_Enc4 };
...
static uint32_t ENC_GetInstance(ENC_Type *base)
{
    ...
    for (instance = 0; instance < (sizeof(s_encBases) / sizeof((s_encBases)[0])); instance++)
    {
    ...
    ((instance < (sizeof(s_encBases) / sizeof((s_encBases)[0]))) ? (void)0 : __aeabi_assert("instance < ARRAY_SIZE(s_encBases)", "../../libraries/sdk/drives/fsl_enc.c", 64),
# 64 "../../libraries/sdk/drives/fsl_enc.c"
#pragma clang diagnostic push
# 64 "../../libraries/sdk/drives/fsl_enc.c"
#pragma clang diagnostic ignored "-Wassume"
# 64 "../../libraries/sdk/drives/fsl_enc.c"
    (__builtin_assume)((instance < (sizeof(s_encBases) / sizeof((s_encBases)[0])))?1:0)
# 64 "../../libraries/sdk/drives/fsl_enc.c"
#pragma clang diagnostic pop
# 64 "../../libraries/sdk/drives/fsl_enc.c"
    );
...
# 80 "../../libraries/sdk/drives/fsl_enc.c"
void ENC_Init(ENC_Type *base, const enc_config_t *config)
{
    ((0 != config) ? (void)0 : __aeabi_assert("NULL != config", "../../libraries/sdk/drives/fsl_enc.c", 82),
# 82 "../../libraries/sdk/drives/fsl_enc.c"
#pragma clang diagnostic push
# 82 "../../libraries/sdk/drives/fsl_enc.c"
#pragma clang diagnostic ignored "-Wassume"
# 82 "../../libraries/sdk/drives/fsl_enc.c"
...
# 82 "../../libraries/sdk/drives/fsl_enc.c"
    ...
    tmp16 = base->CTRL & (uint16_t)(~(((0x8000U) | (0x100U) | (0x10U) | (0x2U)) | (0x2000U) | (0x1000U) | (0x400U) |
                                      (0x200U) | (0x40U) | (0x20U) | (0x4U)));
    ...
    base->FILT = (((uint16_t)(((uint16_t)(config->filterCount)) << (8U))) & (0x700U)) | (((uint16_t)(((uint16_t)(config->filterSamplePeriod)) << (0U))) & (0xFFU));


    tmp16 = base->CTRL2 & (uint16_t)(~(((0x80U) | (0x20U)) | (0x200U) | (0x100U) |
                                       (0x4U) | (0x2U) | (0x1U)));
    ...
    base->CTRL2 = tmp16;
# 173 "../../libraries/sdk/drives/fsl_enc.c"
...
# 190 "../../libraries/sdk/drives/fsl_enc.c"
void ENC_Deinit(ENC_Type *base)
{
...
# 224 "../../libraries/sdk/drives/fsl_enc.c"
void ENC_GetDefaultConfig(enc_config_t *config)
{
    ((0 != config) ? (void)0 : __aeabi_assert("NULL != config", "../../libraries/sdk/drives/fsl_enc.c", 226),
# 226 "../../libraries/sdk/drives/fsl_enc.c"
#pragma clang diagnostic push
# 226 "../../libraries/sdk/drives/fsl_enc.c"
#pragma clang diagnostic ignored "-Wassume"
# 226 "../../libraries/sdk/drives/fsl_enc.c"
...
# 226 "../../libraries/sdk/drives/fsl_enc.c"
    ...
    config->enableReverseDirection = 0;
    config->decoderWorkMode = kENC_DecoderWorkAsNormalMode;
    config->HOMETriggerMode = kENC_HOMETriggerDisabled;
    config->INDEXTriggerMode = kENC_INDEXTriggerDisabled;
    config->enableTRIGGERClearPositionCounter = 0;
    config->enableTRIGGERClearHoldPositionCounter = 0;
    ...
    config->enableModuloCountMode = 0;
...
# 261 "../../libraries/sdk/drives/fsl_enc.c"
void ENC_DoSoftwareLoadInitialPositionValue(ENC_Type *base)
{
    uint16_t tmp16 = base->CTRL & (uint16_t)(~((0x8000U) | (0x100U) | (0x10U) | (0x2U)));

    tmp16 |= (0x800U);
    base->CTRL = tmp16;
}
# 279 "../../libraries/sdk/drives/fsl_enc.c"
void ENC_SetSelfTestConfig(ENC_Type *base, const enc_self_test_config_t *config)
{
    uint16_t tmp16 = 0U;
    ...
    {
        tmp16 = (0x8000U) | (0x4000U) | (((uint16_t)(((uint16_t)(config->signalPeriod)) << (8U))) & (0x1F00U)) |
                (((uint16_t)(((uint16_t)(config->signalCount)) << (0U))) & (0xFFU));
...
void ENC_EnableWatchdog(ENC_Type *base, _Bool enable)
{
    uint16_t tmp16 = base->CTRL & (uint16_t)(~(((0x8000U) | (0x100U) | (0x10U) | (0x2U)) | (0x4U)));
...
void ENC_ClearStatusFlags(ENC_Type *base, uint32_t mask)
{
    ...
    if (0U != tmp16)
    {
        base->CTRL = (uint16_t)(((uint32_t)base->CTRL & (~((0x8000U) | (0x100U) | (0x10U) | (0x2U)))) | tmp16);
    }
    ...
    if (0U != tmp16)
    {
        base->CTRL2 = (uint16_t)(((uint32_t)base->CTRL2 & (~((0x80U) | (0x20U)))) | tmp16);
    }
}
...
void ENC_DisableInterrupts(ENC_Type *base, uint32_t mask)
{
    ...
    if (0U != tmp16)
    {
        base->CTRL = (uint16_t)(base->CTRL & (uint16_t)(~((0x8000U) | (0x100U) | (0x10U) | (0x2U)))) & (uint16_t)(~tmp16);
    }
    ...
    if (tmp16 != 0U)
    {
        base->CTRL2 = (uint16_t)(base->CTRL2 & (uint16_t)(~((0x80U) | (0x20U)))) & (uint16_t)(~tmp16);
    }
}
# 536 "../../libraries/sdk/drives/fsl_enc.c"
uint32_t ENC_GetEnabledInterrupts(ENC_Type *base)
{
    uint32_t ret32 = 0U;


    if (0U != ((0x4000U) & base->CTRL))
    {
        ret32 |= (uint32_t)kENC_HOMETransitionInterruptEnable;
    }
    if (0U != ((0x80U) & base->CTRL))
    {
        ret32 |= (uint32_t)kENC_INDEXPulseInterruptEnable;
    }
    if (0U != ((0x8U) & base->CTRL))
    {
        ret32 |= (uint32_t)kENC_WatchdogTimeoutInterruptEnable;
    }
    if (0U != ((0x1U) & base->CTRL))
    {
...
# 594 "../../libraries/sdk/drives/fsl_enc.c"
uint32_t ENC_GetPositionValue(ENC_Type *base)
{
    uint32_t ret32;
...
# 616 "../../libraries/sdk/drives/fsl_enc.c"
uint32_t ENC_GetHoldPositionValue(ENC_Type *base)
{
    uint32_t ret32;
