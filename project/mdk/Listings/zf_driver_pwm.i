# 1 "../../libraries/zf_driver/zf_driver_pwm.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/zf_driver/zf_driver_pwm.c" 2
# 36 "../../libraries/zf_driver/zf_driver_pwm.c"
...
# 37 "../../libraries/zf_driver/zf_driver_pwm.c" 2
...
# 38 "../../libraries/zf_driver/zf_driver_pwm.c" 2
...
# 39 "../../libraries/zf_driver/zf_driver_pwm.c" 2
...
# 40 "../../libraries/zf_driver/zf_driver_pwm.c" 2
...
# 41 "../../libraries/zf_driver/zf_driver_pwm.c" 2
...
# 42 "../../libraries/zf_driver/zf_driver_pwm.c" 2
...
# 44 "../../libraries/zf_driver/zf_driver_pwm.c" 2




static PWM_Type * PWMPTR[] = { (PWM_Type *)0u, ((PWM_Type *)(0x403DC000u)), ((PWM_Type *)(0x403E0000u)), ((PWM_Type *)(0x403E4000u)), ((PWM_Type *)(0x403E8000u)) };

void pwm_iomuxc(pwm_channel_enum pin)
{
    switch(pin)
    {
        case PWM1_MODULE0_CHA_D12: afio_init(0x401F81BCU, 0x1U, 0x401F8458U, 0x1U, 0x401F83ACU, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6); break;
        case PWM1_MODULE0_CHB_D13: afio_init(0x401F81C0U, 0x1U, 0x401F8468U, 0x1U, 0x401F83B0U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6); break;
        case PWM1_MODULE1_CHA_D14: afio_init(0x401F81C4U, 0x1U, 0x401F845CU, 0x1U, 0x401F83B4U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6); break;
        case PWM1_MODULE1_CHB_D15: afio_init(0x401F81C8U, 0x1U, 0x401F846CU, 0x1U, 0x401F83B8U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6); break;
        case PWM1_MODULE2_CHA_D16: afio_init(0x401F81CCU, 0x1U, 0x401F8460U, 0x1U, 0x401F83BCU, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6); break;
        case PWM1_MODULE2_CHB_D17: afio_init(0x401F81D0U, 0x1U, 0x401F8470U, 0x1U, 0x401F83C0U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6); break;
        case PWM1_MODULE3_CHA_B10: afio_init(0x401F80E4U, 0x1U, 0x401F8454U, 0x3U, 0x401F82D4U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6); break;
        case PWM1_MODULE3_CHA_C16: afio_init(0x401F817CU, 0x6U, 0x401F8454U, 0x4U, 0x401F836CU, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6); break;
        case PWM1_MODULE3_CHA_D0 : afio_init(0x401F81D4U, 0x2U, 0x401F8454U, 0x0U, 0x401F83C4U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6); break;
        case PWM1_MODULE3_CHB_B11: afio_init(0x401F80E8U, 0x1U, 0x401F8464U, 0x3U, 0x401F82D8U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6); break;
        case PWM1_MODULE3_CHB_C17: afio_init(0x401F8180U, 0x6U, 0x401F8464U, 0x4U, 0x401F8370U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6); break;
        case PWM1_MODULE3_CHB_D1 : afio_init(0x401F81D8U, 0x2U, 0x401F8464U, 0x0U, 0x401F83C8U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6); break;

        case PWM2_MODULE0_CHA_C6 : afio_init(0x401F8154U, 0x2U, 0x401F8478U, 0x1U, 0x401F8344U , 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6); break;
        case PWM2_MODULE0_CHB_C7 : afio_init(0x401F8158U, 0x2U, 0x401F8488U, 0x1U, 0x401F8348U , 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6); break;
        case PWM2_MODULE1_CHA_C8 : afio_init(0x401F815CU, 0x2U, 0x401F847CU, 0x1U, 0x401F834CU , 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6); break;
        case PWM2_MODULE1_CHB_C9 : afio_init(0x401F8160U, 0x2U, 0x401F848CU, 0x1U, 0x401F8350U , 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6); break;
        case PWM2_MODULE2_CHA_C10: afio_init(0x401F8164U, 0x2U, 0x401F8480U, 0x1U, 0x401F8354U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6); break;
        case PWM2_MODULE2_CHB_C11: afio_init(0x401F8168U, 0x2U, 0x401F8490U, 0x1U, 0x401F8358U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6); break;
        case PWM2_MODULE3_CHA_B0 : afio_init(0x401F80BCU, 0x0U, 0x401F8474U, 0x2U, 0x401F82ACU, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6); break;
        case PWM2_MODULE3_CHA_C18: afio_init(0x401F8184U, 0x6U, 0x401F8474U, 0x4U, 0x401F8374U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6); break;
        case PWM2_MODULE3_CHA_D2 : afio_init(0x401F81DCU, 0x2U, 0x401F8474U, 0x0U, 0x401F83CCU, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6); break;
        case PWM2_MODULE3_CHA_B9 : afio_init(0x401F80E0U, 0x1U, 0x401F8474U, 0x3U, 0x401F82D0U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6); break;
        case PWM2_MODULE3_CHB_B1 : afio_init(0x401F80C0U, 0x0U, 0x401F8484U, 0x2U, 0x401F82B0U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6); break;
        case PWM2_MODULE3_CHB_C19: afio_init(0x401F8188U, 0x6U, 0x401F8484U, 0x3U, 0x401F8378U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6); break;
        case PWM2_MODULE3_CHB_D3 : afio_init(0x401F81E0U, 0x2U, 0x401F8484U, 0x0U, 0x401F83D0U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6); break;

        case PWM4_MODULE0_CHA_B24: afio_init(0x401F811CU, 0x1U, 0x401F8494U, 0x1U, 0x401F830CU, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6); break;
        case PWM4_MODULE1_CHA_B25: afio_init(0x401F8120U, 0x1U, 0x401F8498U, 0x1U, 0x401F8310U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6); break;
        case PWM4_MODULE2_CHA_C30: afio_init(0x401F81B4U, 0x1U, 0x401F849CU, 0x1U, 0x401F83A4U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6); break;
        case PWM4_MODULE3_CHA_C31: afio_init(0x401F81B8U, 0x1U, 0x401F84A0U, 0x1U, 0x401F83A8U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6); break;

        default :(debug_assert_handler((0), "../../libraries/zf_driver/zf_driver_pwm.c", 86));break;
    }
}
# 98 "../../libraries/zf_driver/zf_driver_pwm.c"
void pwm_set_duty (pwm_channel_enum pin, const uint32 duty)
{
    uint16 temp_duty;

    (debug_assert_handler(((10000) >= duty), "../../libraries/zf_driver/zf_driver_pwm.c", 102));
    ...
    pwm_num = pin/40;
    pwm_module = pin%40/10;
    pwm_module_ch = pin%40%10/5;

    temp_duty = (uint32)duty * 65535/ (10000);

    PWM_SetPwmLdok(PWMPTR[pwm_num], (pwm_module_control_t)(1<<(pwm_module)), 0);
    ...
    PWM_SetPwmLdok(PWMPTR[pwm_num], (pwm_module_control_t)(1<<(pwm_module)), 1);
}
# 129 "../../libraries/zf_driver/zf_driver_pwm.c"
void pwm_init (pwm_channel_enum pin, const uint32 freq, const uint32 duty)
{

    (debug_assert_handler(((10000) >= duty), "../../libraries/zf_driver/zf_driver_pwm.c", 132));
    ...
    pwm_iomuxc(pin);
# 155 "../../libraries/zf_driver/zf_driver_pwm.c"
    PWM_GetDefaultConfig(&pwmConfig);

    pwmConfig.reloadLogic = kPWM_ReloadPwmFullCycle;
    pwmConfig.pairOperation = kPWM_Independent;
    pwmConfig.enableDebugMode = 1;



    temp_prsc = (CLOCK_GetFreq(kCLOCK_IpgClk)/freq)>>16;
 if(CLOCK_GetFreq(kCLOCK_IpgClk)%(freq<<16)) temp_prsc++;
    ...
    {
        (debug_assert_handler((0), "../../libraries/zf_driver/zf_driver_pwm.c", 176)) ;
    }
    ...
    {
        (debug_assert_handler((0), "../../libraries/zf_driver/zf_driver_pwm.c", 185)) ;
    }
    PWM_Deinit(PWMPTR[pwm_num], (pwm_submodule_t)pwm_module);

    if (PWM_Init(PWMPTR[pwm_num], (pwm_submodule_t)pwm_module, &pwmConfig) == kStatus_Fail)
    {
        (debug_assert_handler((0), "../../libraries/zf_driver/zf_driver_pwm.c", 191)) ;
    }
    ...
    PWM_SetPwmLdok(PWMPTR[pwm_num], (pwm_module_control_t)(1<<(pwm_module)), 0);
    PWM_SetupPwm(PWMPTR[pwm_num], (pwm_submodule_t)pwm_module, &pwmSignal, 1, kPWM_EdgeAligned, freq, CLOCK_GetFreq(kCLOCK_IpgClk));
