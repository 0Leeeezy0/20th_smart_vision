# 1 "../../libraries/sdk/drives/fsl_adc_etc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/sdk/drives/fsl_adc_etc.c" 2
...
# 1 "../../libraries/sdk/drives/fsl_adc_etc.h" 1
# 12 "../../libraries/sdk/drives/fsl_adc_etc.h"
...
# 13 "../../libraries/sdk/drives/fsl_adc_etc.h" 2
# 30 "../../libraries/sdk/drives/fsl_adc_etc.h"
...
typedef enum _adc_etc_external_trigger_source
{
    ...
    kADC_ETC_Trg0TriggerSource = 0U,
    kADC_ETC_Trg1TriggerSource = 1U,
    kADC_ETC_Trg2TriggerSource = 2U,
    kADC_ETC_Trg3TriggerSource = 3U,
    kADC_ETC_Trg4TriggerSource = 4U,
    kADC_ETC_Trg5TriggerSource = 5U,
    kADC_ETC_Trg6TriggerSource = 6U,
    kADC_ETC_Trg7TriggerSource = 7U,

    kADC_ETC_TSC0TriggerSource = 8U,
    kADC_ETC_TSC1TriggerSource = 9U,
...
typedef enum _adc_etc_interrupt_enable
{
    ...
    kADC_ETC_InterruptDisable = 0U,
    kADC_ETC_Done0InterruptEnable = 1U,
    kADC_ETC_Done1InterruptEnable = 2U,
    kADC_ETC_Done2InterruptEnable = 3U,
...
typedef enum _adc_etc_dma_mode_selection
{
    kADC_ETC_TrigDMAWithLatchedSignal =
        0U,
    kADC_ETC_TrigDMAWithPulsedSignal = 1U,
...
typedef struct _adc_etc_config
{
    ...
    _Bool enableTSCBypass;




    _Bool enableTSC0Trigger;



    _Bool enableTSC1Trigger;
...
static inline void ADC_ETC_EnableDMA(ADC_ETC_Type *base, uint32_t triggerGroup)
{
    ...
    base->DMA_CTRL = (base->DMA_CTRL | ((uint32_t)(0x1U) << (uint32_t)triggerGroup)) &
                     ~0xFF0000U;
}
...
# 281 "../../libraries/sdk/drives/fsl_adc_etc.h"
static inline uint32_t ADC_ETC_GetDMAStatusFlags(ADC_ETC_Type *base)
{
    return (((base->DMA_CTRL) & 0xFF0000U) >> (16U));
}
# 293 "../../libraries/sdk/drives/fsl_adc_etc.h"
static inline void ADC_ETC_ClearDMAStatusFlags(ADC_ETC_Type *base, uint32_t mask)
{
    base->DMA_CTRL = ((base->DMA_CTRL) & ~0xFF0000U) | (mask << (16U));
}
...
static inline void ADC_ETC_DoSoftwareReset(ADC_ETC_Type *base, _Bool enable)
{
    if (enable)
    {
...
# 325 "../../libraries/sdk/drives/fsl_adc_etc.h"
static inline void ADC_ETC_DoSoftwareTrigger(ADC_ETC_Type *base, uint32_t triggerGroup)
{
    ((triggerGroup < (8U)) ? (void)0 : __aeabi_assert("triggerGroup < ADC_ETC_TRIGn_CTRL_COUNT", "../../libraries/sdk/drives/fsl_adc_etc.h", 327),
# 327 "../../libraries/sdk/drives/fsl_adc_etc.h"
#pragma clang diagnostic push
# 327 "../../libraries/sdk/drives/fsl_adc_etc.h"
#pragma clang diagnostic ignored "-Wassume"
# 327 "../../libraries/sdk/drives/fsl_adc_etc.h"
    (__builtin_assume)((triggerGroup < (8U))?1:0)
# 327 "../../libraries/sdk/drives/fsl_adc_etc.h"
#pragma clang diagnostic pop
# 327 "../../libraries/sdk/drives/fsl_adc_etc.h"
    );

    base->TRIG[triggerGroup].TRIGn_CTRL |= (0x1U);
}
# 342 "../../libraries/sdk/drives/fsl_adc_etc.h"
uint32_t ADC_ETC_GetADCConversionValue(ADC_ETC_Type *base, uint32_t triggerGroup, uint32_t chainGroup);
# 10 "../../libraries/sdk/drives/fsl_adc_etc.c" 2
# 66 "../../libraries/sdk/drives/fsl_adc_etc.c"
void ADC_ETC_Init(ADC_ETC_Type *base, const adc_etc_config_t *config)
{
    ((0 != config) ? (void)0 : __aeabi_assert("NULL != config", "../../libraries/sdk/drives/fsl_adc_etc.c", 68),
# 68 "../../libraries/sdk/drives/fsl_adc_etc.c"
#pragma clang diagnostic push
# 68 "../../libraries/sdk/drives/fsl_adc_etc.c"
#pragma clang diagnostic ignored "-Wassume"
# 68 "../../libraries/sdk/drives/fsl_adc_etc.c"
...
# 68 "../../libraries/sdk/drives/fsl_adc_etc.c"
    ...
    uint32_t tmp32 = 0U;
# 80 "../../libraries/sdk/drives/fsl_adc_etc.c"
    ADC_ETC_DoSoftwareReset(base, 0);


    tmp32 =

        (((uint32_t)(((uint32_t)(config->TSC0triggerPriority)) << (9U))) & (0xE00U)) |


        (((uint32_t)(((uint32_t)(config->TSC1triggerPriority)) << (13U))) & (0xE000U)) |

        (((uint32_t)(((uint32_t)(config->clockPreDivider)) << (16U))) & (0xFF0000U)) | (((uint32_t)(((uint32_t)(config->XBARtriggerMask)) << (0U))) & (0xFFU))

        | (((uint32_t)(((uint32_t)(config->dmaMode)) << (29U))) & (0x20000000U))
...
void ADC_ETC_Deinit(ADC_ETC_Type *base)
{
    ...
    ADC_ETC_DoSoftwareReset(base, 1);
...
# 151 "../../libraries/sdk/drives/fsl_adc_etc.c"
void ADC_ETC_GetDefaultConfig(adc_etc_config_t *config)
{
    ...
    config->enableTSCBypass = 1;



    config->enableTSC0Trigger = 0;



    config->enableTSC1Trigger = 0;
...
# 191 "../../libraries/sdk/drives/fsl_adc_etc.c"
void ADC_ETC_SetTriggerConfig(ADC_ETC_Type *base, uint32_t triggerGroup, const adc_etc_trigger_config_t *config)
{
    ((triggerGroup < (8U)) ? (void)0 : __aeabi_assert("triggerGroup < ADC_ETC_TRIGn_CTRL_COUNT", "../../libraries/sdk/drives/fsl_adc_etc.c", 193),
# 193 "../../libraries/sdk/drives/fsl_adc_etc.c"
#pragma clang diagnostic push
# 193 "../../libraries/sdk/drives/fsl_adc_etc.c"
#pragma clang diagnostic ignored "-Wassume"
# 193 "../../libraries/sdk/drives/fsl_adc_etc.c"
...
# 193 "../../libraries/sdk/drives/fsl_adc_etc.c"
    ...
    (((8U) > triggerGroup) ? (void)0 : __aeabi_assert("ADC_ETC_TRIGn_COUNTER_COUNT > triggerGroup", "../../libraries/sdk/drives/fsl_adc_etc.c", 194),
# 194 "../../libraries/sdk/drives/fsl_adc_etc.c"
#pragma clang diagnostic push
# 194 "../../libraries/sdk/drives/fsl_adc_etc.c"
#pragma clang diagnostic ignored "-Wassume"
# 194 "../../libraries/sdk/drives/fsl_adc_etc.c"
    (__builtin_assume)(((8U) > triggerGroup)?1:0)
# 194 "../../libraries/sdk/drives/fsl_adc_etc.c"
#pragma clang diagnostic pop
# 194 "../../libraries/sdk/drives/fsl_adc_etc.c"
    );
    ...
    tmp32 = (((uint32_t)(((uint32_t)(config->triggerChainLength)) << (8U))) & (0x700U)) |
            (((uint32_t)(((uint32_t)(config->triggerPriority)) << (12U))) & (0x7000U));
    ...
    tmp32 = (((uint32_t)(((uint32_t)(config->initialDelay)) << (0U))) & (0xFFFFU)) |
            (((uint32_t)(((uint32_t)(config->sampleIntervalDelay)) << (16U))) & (0xFFFF0000U));
    base->TRIG[triggerGroup].TRIGn_COUNTER = tmp32;
}
# 227 "../../libraries/sdk/drives/fsl_adc_etc.c"
void ADC_ETC_SetTriggerChainConfig(ADC_ETC_Type *base,
                                   uint32_t triggerGroup,
                                   uint32_t chainGroup,
                                   const adc_etc_trigger_chain_config_t *config)
{
    ((triggerGroup < (8U)) ? (void)0 : __aeabi_assert("triggerGroup < ADC_ETC_TRIGn_CTRL_COUNT", "../../libraries/sdk/drives/fsl_adc_etc.c", 232),
# 232 "../../libraries/sdk/drives/fsl_adc_etc.c"
#pragma clang diagnostic push
# 232 "../../libraries/sdk/drives/fsl_adc_etc.c"
#pragma clang diagnostic ignored "-Wassume"
# 232 "../../libraries/sdk/drives/fsl_adc_etc.c"
...
# 232 "../../libraries/sdk/drives/fsl_adc_etc.c"
    ...
    tmp32 = (((uint32_t)(((uint32_t)(config->ADCHCRegisterSelect)) << (4U))) & (0xFF0U)) |
            (((uint32_t)(((uint32_t)(config->ADCChannelSelect)) << (0U))) & (0xFU)) |
            (((uint32_t)(((uint32_t)(config->InterruptEnable)) << (13U))) & (0x6000U));
    if (1 == config->enableB2BMode)
    {
        tmp32 |= (0x1000U);
    }
    ...
    switch (chainGroup / 2U)
    {
        case 0U:
            ...
            {
                tmpReg &= ~((0xF0000U) | (0xFF00000U) |
                            (0x10000000U) | (0x60000000U));
                tmpReg |= (tmp32 << (16U));
            }
        ...
        case 3U:
            ...
            break;
        default:
            ((0) ? (void)0 : __aeabi_assert("false", "../../libraries/sdk/drives/fsl_adc_etc.c", 319),
# 319 "../../libraries/sdk/drives/fsl_adc_etc.c"
#pragma clang diagnostic push
# 319 "../../libraries/sdk/drives/fsl_adc_etc.c"
#pragma clang diagnostic ignored "-Wassume"
# 319 "../../libraries/sdk/drives/fsl_adc_etc.c"
...
# 332 "../../libraries/sdk/drives/fsl_adc_etc.c"
uint32_t ADC_ETC_GetInterruptStatusFlags(ADC_ETC_Type *base, adc_etc_external_trigger_source_t sourceIndex)
{
    uint32_t tmp32 = 0U;

    if (((base->DONE0_1_IRQ) & ((uint32_t)(0x1U) << (uint32_t)sourceIndex)) != 0U)
    {
        tmp32 |= (uint32_t)kADC_ETC_Done0StatusFlagMask;

    }
    if (((base->DONE0_1_IRQ) & ((uint32_t)(0x10000U) << (uint32_t)sourceIndex)) != 0U)
    {
        tmp32 |= (uint32_t)kADC_ETC_Done1StatusFlagMask;

    }
    if (((base->DONE2_3_ERR_IRQ) & ((uint32_t)(0x1U) << (uint32_t)sourceIndex)) != 0U)
    {
        tmp32 |= (uint32_t)kADC_ETC_Done2StatusFlagMask;
    ...
    if (((base->DONE2_3_ERR_IRQ) & ((uint32_t)(0x10000U) << (uint32_t)sourceIndex)) != 0U)
    {
...
# 373 "../../libraries/sdk/drives/fsl_adc_etc.c"
void ADC_ETC_ClearInterruptStatusFlags(ADC_ETC_Type *base, adc_etc_external_trigger_source_t sourceIndex, uint32_t mask)
{
    if (0U != (mask & (uint32_t)kADC_ETC_Done0StatusFlagMask))
    {
        base->DONE0_1_IRQ = ((uint32_t)(0x1U) << (uint32_t)sourceIndex);
    }
    if (0U != (mask & (uint32_t)kADC_ETC_Done1StatusFlagMask))
    {
        base->DONE0_1_IRQ = ((uint32_t)(0x10000U) << (uint32_t)sourceIndex);
    }
    if (0U != (mask & (uint32_t)kADC_ETC_Done2StatusFlagMask))
    {
        base->DONE2_3_ERR_IRQ = ((uint32_t)(0x1U) << (uint32_t)sourceIndex);
    }
    ...
    {
        base->DONE2_3_ERR_IRQ = ((uint32_t)(0x10000U) << (uint32_t)sourceIndex);
    }
}
# 409 "../../libraries/sdk/drives/fsl_adc_etc.c"
uint32_t ADC_ETC_GetADCConversionValue(ADC_ETC_Type *base, uint32_t triggerGroup, uint32_t chainGroup)
{
    ((triggerGroup < (8U)) ? (void)0 : __aeabi_assert("triggerGroup < ADC_ETC_TRIGn_RESULT_1_0_COUNT", "../../libraries/sdk/drives/fsl_adc_etc.c", 411),
# 411 "../../libraries/sdk/drives/fsl_adc_etc.c"
#pragma clang diagnostic push
# 411 "../../libraries/sdk/drives/fsl_adc_etc.c"
#pragma clang diagnostic ignored "-Wassume"
# 411 "../../libraries/sdk/drives/fsl_adc_etc.c"
...
# 411 "../../libraries/sdk/drives/fsl_adc_etc.c"
    ...
    switch (chainGroup / 2U)
    {
        case 0U:
            if (0U == mRemainder)
            {
                mADCResult = (0xFFFU) & (base->TRIG[triggerGroup].TRIGn_RESULT_1_0);
            }
            else
            {
                mADCResult = (base->TRIG[triggerGroup].TRIGn_RESULT_1_0) >> (16U);
            }
            break;
        case 1U:
            if (0U == mRemainder)
            {
                mADCResult = (0xFFFU) & (base->TRIG[triggerGroup].TRIGn_RESULT_3_2);
            }
            else
            {
                mADCResult = (base->TRIG[triggerGroup].TRIGn_RESULT_3_2) >> (16U);
            }
            break;
        case 2U:
            if (0U == mRemainder)
            {
                mADCResult = (0xFFFU) & (base->TRIG[triggerGroup].TRIGn_RESULT_5_4);
            }
            else
            {
                mADCResult = (base->TRIG[triggerGroup].TRIGn_RESULT_5_4) >> (16U);
            }
            break;
        case 3U:
            if (0U == mRemainder)
            {
                mADCResult = (0xFFFU) & (base->TRIG[triggerGroup].TRIGn_RESULT_7_6);
            }
            else
            {
                mADCResult = (base->TRIG[triggerGroup].TRIGn_RESULT_7_6) >> (16U);
            }
            break;
        default:
            mADCResult = 0U;
            ((0) ? (void)0 : __aeabi_assert("false", "../../libraries/sdk/drives/fsl_adc_etc.c", 460),
# 460 "../../libraries/sdk/drives/fsl_adc_etc.c"
#pragma clang diagnostic push
# 460 "../../libraries/sdk/drives/fsl_adc_etc.c"
#pragma clang diagnostic ignored "-Wassume"
# 460 "../../libraries/sdk/drives/fsl_adc_etc.c"
