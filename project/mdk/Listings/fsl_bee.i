# 1 "../../libraries/sdk/drives/fsl_bee.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/sdk/drives/fsl_bee.c" 2
...
# 1 "../../libraries/sdk/drives/fsl_bee.h" 1
# 12 "../../libraries/sdk/drives/fsl_bee.h"
...
# 13 "../../libraries/sdk/drives/fsl_bee.h" 2
# 54 "../../libraries/sdk/drives/fsl_bee.h"
...
# 49 "../../libraries/sdk/drives/fsl_bee.c"
void BEE_Init(BEE_Type *base)
{
...
# 66 "../../libraries/sdk/drives/fsl_bee.c"
void BEE_Deinit(BEE_Type *base)
{
    base->CTRL &=
        ~((0x1U) | (0x4U) | (0x2U) | (0x10U));


    CLOCK_DisableClock(kCLOCK_Bee);

}
# 95 "../../libraries/sdk/drives/fsl_bee.c"
void BEE_GetDefaultConfig(bee_region_config_t *config)
{
    ((config) ? (void)0 : __aeabi_assert("config", "../../libraries/sdk/drives/fsl_bee.c", 97),
# 97 "../../libraries/sdk/drives/fsl_bee.c"
#pragma clang diagnostic push
# 97 "../../libraries/sdk/drives/fsl_bee.c"
#pragma clang diagnostic ignored "-Wassume"
# 97 "../../libraries/sdk/drives/fsl_bee.c"
...
# 122 "../../libraries/sdk/drives/fsl_bee.c"
void BEE_SetConfig(BEE_Type *base, const bee_region_config_t *config)
{
    uint32_t beeCtrlVal;
    _Bool reenable = 0;
    ...
    beeCtrlVal |= (((uint32_t)(((uint32_t)(config->accessPermission)) << (6U))) & (0x40U)) | (((uint32_t)(((uint32_t)(config->endianSwapEn)) << (7U))) & (0x80U)) |
                  (((uint32_t)(((uint32_t)(config->region0SecLevel)) << (8U))) & (0x300U)) | (((uint32_t)(((uint32_t)(config->region0Mode)) << (10U))) & (0x400U)) |
                  (((uint32_t)(((uint32_t)(config->region1SecLevel)) << (12U))) & (0x3000U)) | (((uint32_t)(((uint32_t)(config->region1Mode)) << (14U))) & (0x4000U));
...
# 175 "../../libraries/sdk/drives/fsl_bee.c"
status_t BEE_SetRegionKey(BEE_Type *base, bee_region_t region, const uint8_t *key, size_t keySize)
{
    _Bool redisable = 0;
...
# 245 "../../libraries/sdk/drives/fsl_bee.c"
status_t BEE_SetRegionNonce(BEE_Type *base, bee_region_t region, const uint8_t *nonce, size_t nonceSize)
{
...
# 287 "../../libraries/sdk/drives/fsl_bee.c"
uint32_t BEE_GetStatusFlags(BEE_Type *base)
{
    return base->STATUS;
}
# 299 "../../libraries/sdk/drives/fsl_bee.c"
void BEE_ClearStatusFlags(BEE_Type *base, uint32_t mask)
{
