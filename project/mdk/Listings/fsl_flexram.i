# 1 "../../libraries/sdk/drives/fsl_flexram.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/sdk/drives/fsl_flexram.c" 2
...
# 1 "../../libraries/sdk/drives/fsl_flexram.h" 1
# 12 "../../libraries/sdk/drives/fsl_flexram.h"
...
# 13 "../../libraries/sdk/drives/fsl_flexram.h" 2
# 1 "../../libraries/sdk/drives/fsl_flexram_allocate.h" 1
# 30 "../../libraries/sdk/drives/fsl_flexram_allocate.h"
enum
{
...
# 69 "../../libraries/sdk/drives/fsl_flexram_allocate.h"
...
{
    ((IOMUXC_GPR_Type *)(0x400AC000u))->GPR16 &= ~(0x4U);
    ((IOMUXC_GPR_Type *)(0x400AC000u))->GPR16 |= (((uint32_t)(((uint32_t)(src)) << (2U))) & (0x4U));
}
# 14 "../../libraries/sdk/drives/fsl_flexram.h" 2
# 37 "../../libraries/sdk/drives/fsl_flexram.h"
enum
{
    kFLEXRAM_Read = 0U,
    kFLEXRAM_Write = 1U,
...
enum
{
    kFLEXRAM_OCRAMAccessError = (0x20U),
    kFLEXRAM_DTCMAccessError = (0x10U),
    kFLEXRAM_ITCMAccessError = (0x8U),
# 81 "../../libraries/sdk/drives/fsl_flexram.h"
    kFLEXRAM_InterruptStatusAll = (0x20U) | (0x10U) |
                                  (0x8U),


};
# 94 "../../libraries/sdk/drives/fsl_flexram.h"
...
# 269 "../../libraries/sdk/drives/fsl_flexram.h"
...
# 288 "../../libraries/sdk/drives/fsl_flexram.h"
...
# 339 "../../libraries/sdk/drives/fsl_flexram.h"
...
# 362 "../../libraries/sdk/drives/fsl_flexram.h"
...
static inline void FLEXRAM_EnableForceRamClockOn(FLEXRAM_Type *base, _Bool enable)
{
    if (enable)
    {
        base->TCM_CTRL |= (0x4U);
...
# 10 "../../libraries/sdk/drives/fsl_flexram.c" 2
# 30 "../../libraries/sdk/drives/fsl_flexram.c"
...
static FLEXRAM_Type *const s_flexramBases[] = { ((FLEXRAM_Type *)(0x400B0000u)) };



static const clock_ip_name_t s_flexramClocks[] = { kCLOCK_FlexRam };
# 59 "../../libraries/sdk/drives/fsl_flexram.c"
static uint32_t FLEXRAM_GetInstance(FLEXRAM_Type *base)
{
    uint32_t instance;


    for (instance = 0; instance < (sizeof(s_flexramBases) / sizeof((s_flexramBases)[0])); instance++)
    {
    ...
    ((instance < (sizeof(s_flexramBases) / sizeof((s_flexramBases)[0]))) ? (void)0 : __aeabi_assert("instance < ARRAY_SIZE(s_flexramBases)", "../../libraries/sdk/drives/fsl_flexram.c", 72),
# 72 "../../libraries/sdk/drives/fsl_flexram.c"
#pragma clang diagnostic push
# 72 "../../libraries/sdk/drives/fsl_flexram.c"
#pragma clang diagnostic ignored "-Wassume"
# 72 "../../libraries/sdk/drives/fsl_flexram.c"
    (__builtin_assume)((instance < (sizeof(s_flexramBases) / sizeof((s_flexramBases)[0])))?1:0)
# 72 "../../libraries/sdk/drives/fsl_flexram.c"
#pragma clang diagnostic pop
# 72 "../../libraries/sdk/drives/fsl_flexram.c"
    );
