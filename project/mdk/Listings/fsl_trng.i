# 1 "../../libraries/sdk/drives/fsl_trng.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/sdk/drives/fsl_trng.c" 2
...
# 1 "../../libraries/sdk/drives/fsl_trng.h" 1
# 11 "../../libraries/sdk/drives/fsl_trng.h"
...
# 12 "../../libraries/sdk/drives/fsl_trng.h" 2
# 66 "../../libraries/sdk/drives/fsl_trng.h"
...
# 193 "../../libraries/sdk/drives/fsl_trng.h"
status_t TRNG_GetDefaultConfig(trng_config_t *userConfig);
# 205 "../../libraries/sdk/drives/fsl_trng.h"
status_t TRNG_Init(TRNG_Type *base, const trng_config_t *userConfig);
# 214 "../../libraries/sdk/drives/fsl_trng.h"
void TRNG_Deinit(TRNG_Type *base);
# 226 "../../libraries/sdk/drives/fsl_trng.h"
status_t TRNG_GetRandomData(TRNG_Type *base, void *data, size_t dataSize);
# 9 "../../libraries/sdk/drives/fsl_trng.c" 2
# 82 "../../libraries/sdk/drives/fsl_trng.c"
typedef enum _trng_work_mode
{
    kTRNG_WorkModeRun = 0U,
    kTRNG_WorkModeProgram = 1U
} trng_work_mode_t;
...
typedef enum _trng_statistical_check
{
    kTRNG_StatisticalCheckMonobit =
        1U,
    kTRNG_StatisticalCheckRunBit1,

    kTRNG_StatisticalCheckRunBit2,

    kTRNG_StatisticalCheckRunBit3,

    kTRNG_StatisticalCheckRunBit4,

    kTRNG_StatisticalCheckRunBit5,

    kTRNG_StatisticalCheckRunBit6Plus,

    kTRNG_StatisticalCheckPoker,
    kTRNG_StatisticalCheckFrequencyCount
} trng_statistical_check_t;
# 1200 "../../libraries/sdk/drives/fsl_trng.c"
static TRNG_Type *const s_trngBases[] = { ((TRNG_Type *)(0x400CC000u)) };



static const clock_ip_name_t s_trngClock[] = { kCLOCK_Trng };
...
static uint32_t trng_GetInstance(TRNG_Type *base)
{
    ...
    for (instance = 0; instance < (sizeof(s_trngBases) / sizeof((s_trngBases)[0])); instance++)
    {
    ...
    ((instance < (sizeof(s_trngBases) / sizeof((s_trngBases)[0]))) ? (void)0 : __aeabi_assert("instance < ARRAY_SIZE(s_trngBases)", "../../libraries/sdk/drives/fsl_trng.c", 1244),
# 1244 "../../libraries/sdk/drives/fsl_trng.c"
#pragma clang diagnostic push
# 1244 "../../libraries/sdk/drives/fsl_trng.c"
#pragma clang diagnostic ignored "-Wassume"
# 1244 "../../libraries/sdk/drives/fsl_trng.c"
    (__builtin_assume)((instance < (sizeof(s_trngBases) / sizeof((s_trngBases)[0])))?1:0)
# 1244 "../../libraries/sdk/drives/fsl_trng.c"
#pragma clang diagnostic pop
# 1244 "../../libraries/sdk/drives/fsl_trng.c"
    );
...
# 1293 "../../libraries/sdk/drives/fsl_trng.c"
status_t TRNG_GetDefaultConfig(trng_config_t *userConfig)
{
    status_t result;
    ...
    if (userConfig != 0)
    {
        ...
        userConfig->lock = (_Bool)0;

        userConfig->clockMode = kTRNG_ClockModeRingOscillator;
        userConfig->ringOscDiv = kTRNG_RingOscDiv0;
        ...
        userConfig->monobitLimit.minimum = (1384 - 268);
        userConfig->runBit1Limit.maximum = 405;
        userConfig->runBit1Limit.minimum = (405 - 178);
        userConfig->runBit2Limit.maximum = 220;
        userConfig->runBit2Limit.minimum = (220 - 122);
        userConfig->runBit3Limit.maximum = 125;
        userConfig->runBit3Limit.minimum = (125 - 88);
        userConfig->runBit4Limit.maximum = 75;
        userConfig->runBit4Limit.minimum = (75 - 64);
        userConfig->runBit5Limit.maximum = 47;
        userConfig->runBit5Limit.minimum = (47 - 46);
        userConfig->runBit6PlusLimit.maximum = 47;
        userConfig->runBit6PlusLimit.minimum = (47 - 46);

        userConfig->pokerLimit.maximum = 26912;
        userConfig->pokerLimit.minimum = (26912 - 2467);
...
# 1354 "../../libraries/sdk/drives/fsl_trng.c"
static status_t trng_SetRetryCount(TRNG_Type *base, uint8_t retry_count)
{
    status_t status;
    ...
    if ((retry_count >= 1u) && (retry_count <= 15u))
    {
        ...
        (((((base)->SCMISC) = (((((base)->SCMISC)) & ~((0xF0000U))) | ((((uint32_t)(((uint32_t)(retry_count)) << (16U))) & (0xF0000U)))))));
...
static status_t trng_SetMonobitLimit(TRNG_Type *base, uint32_t range, uint32_t limit_maximum)
{
...

    {
        ...
        (((((base)->SCML) = (((((base)->SCML)) & ~((0xFFFFU))) | ((((uint32_t)(((uint32_t)(limit_maximum)) << (0U))) & (0xFFFFU)))))));
        (((((base)->SCML) = (((((base)->SCML)) & ~((0xFFFF0000U))) | ((((uint32_t)(((uint32_t)(range)) << (16U))) & (0xFFFF0000U)))))));
        status = kStatus_Success;
    }
    else
    {
...
static status_t trng_SetRunBit1Limit(TRNG_Type *base, uint32_t range, uint32_t limit_maximum)
{
    ...
    if ((range <= 0x7fffu) && (limit_maximum <= 0x7fffu))
    {
        ...
        (((((base)->SCR1L) = (((((base)->SCR1L)) & ~((0x7FFFU))) | ((((uint32_t)(((uint32_t)(limit_maximum)) << (0U))) & (0x7FFFU)))))));
        (((((base)->SCR1L) = (((((base)->SCR1L)) & ~((0x7FFF0000U))) | ((((uint32_t)(((uint32_t)(range)) << (16U))) & (0x7FFF0000U)))))));
        status = kStatus_Success;
    }
    else
    {
...
static status_t trng_SetRunBit2Limit(TRNG_Type *base, uint32_t range, uint32_t limit_maximum)
{
    ...
    if ((range <= 0x3fffu) && (limit_maximum <= 0x3fffu))
    {
        ...
        (((((base)->SCR2L) = (((((base)->SCR2L)) & ~((0x3FFFU))) | ((((uint32_t)(((uint32_t)(limit_maximum)) << (0U))) & (0x3FFFU)))))));
        (((((base)->SCR2L) = (((((base)->SCR2L)) & ~((0x3FFF0000U))) | ((((uint32_t)(((uint32_t)(range)) << (16U))) & (0x3FFF0000U)))))));
        status = kStatus_Success;
    }
    else
    {
...
static status_t trng_SetRunBit3Limit(TRNG_Type *base, uint32_t range, uint32_t limit_maximum)
{
    ...
    if ((range <= 0x1fffu) && (limit_maximum <= 0x1fffu))
    {
        ...
        (((((base)->SCR3L) = (((((base)->SCR3L)) & ~((0x1FFFU))) | ((((uint32_t)(((uint32_t)(limit_maximum)) << (0U))) & (0x1FFFU)))))));
        (((((base)->SCR3L) = (((((base)->SCR3L)) & ~((0x1FFF0000U))) | ((((uint32_t)(((uint32_t)(range)) << (16U))) & (0x1FFF0000U)))))));
        status = kStatus_Success;
    }
    else
    {
...
static status_t trng_SetRunBit4Limit(TRNG_Type *base, uint32_t range, uint32_t limit_maximum)
{
    ...
    if ((range <= 0xfffu) && (limit_maximum <= 0xfffu))
    {
        ...
        (((((base)->SCR4L) = (((((base)->SCR4L)) & ~((0xFFFU))) | ((((uint32_t)(((uint32_t)(limit_maximum)) << (0U))) & (0xFFFU)))))));
        (((((base)->SCR4L) = (((((base)->SCR4L)) & ~((0xFFF0000U))) | ((((uint32_t)(((uint32_t)(range)) << (16U))) & (0xFFF0000U)))))));
        status = kStatus_Success;
    }
    else
    {
...
static status_t trng_SetRunBit5Limit(TRNG_Type *base, uint32_t range, uint32_t limit_maximum)
{
    ...
    if ((range <= 0x7ffu) && (limit_maximum <= 0x7ffu))
    {
        ...
        (((((base)->SCR5L) = (((((base)->SCR5L)) & ~((0x7FFU))) | ((((uint32_t)(((uint32_t)(limit_maximum)) << (0U))) & (0x7FFU)))))));
        (((((base)->SCR5L) = (((((base)->SCR5L)) & ~((0x7FF0000U))) | ((((uint32_t)(((uint32_t)(range)) << (16U))) & (0x7FF0000U)))))));
        status = kStatus_Success;
    }
    else
    {
...
static status_t trng_SetRunBit6Limit(TRNG_Type *base, uint32_t range, uint32_t limit_maximum)
{
    ...
    if ((range <= 0x7ffu) && (limit_maximum <= 0x7ffu))
    {
        ...
        (((((base)->SCR6PL) = (((((base)->SCR6PL)) & ~((0x7FFU))) | ((((uint32_t)(((uint32_t)(limit_maximum)) << (0U))) & (0x7FFU)))))));
        (((((base)->SCR6PL) = (((((base)->SCR6PL)) & ~((0x7FF0000U))) | ((((uint32_t)(((uint32_t)(range)) << (16U))) & (0x7FF0000U)))))));
        status = kStatus_Success;
    }
    else
    {
...
static status_t trng_SetPokerMaxLimit(TRNG_Type *base, uint32_t range, uint32_t limit_maximum)
{
    ...
    if ((range <= 0xffffu) && (limit_maximum <= 0xffffffu))
    {
        ...
        (((((base)->PKRMAX) = (((((base)->PKRMAX)) & ~((0xFFFFFFU))) | ((((uint32_t)(((uint32_t)(limit_maximum)) << (0U))) & (0xFFFFFFU)))))));
        (((((base)->PKRRNG) = (((((base)->PKRRNG)) & ~((0xFFFFU))) | ((((uint32_t)(((uint32_t)(range)) << (0U))) & (0xFFFFU)))))));
        status = kStatus_Success;
    }
    else
    {
...
static status_t trng_SetFrequencyCountMaxLimit(TRNG_Type *base, uint32_t limit_minimum, uint32_t limit_maximum)
{
    ...
    if ((limit_minimum <= 0x3fffffu) && (limit_maximum <= 0x3fffffu))
    {
        ...
        (((((base)->FRQMAX) = (((((base)->FRQMAX)) & ~((0x3FFFFFU))) | ((((uint32_t)(((uint32_t)(limit_maximum)) << (0U))) & (0x3FFFFFU)))))));
        (((((base)->FRQMIN) = (((((base)->FRQMIN)) & ~((0x3FFFFFU))) | ((((uint32_t)(((uint32_t)(limit_minimum)) << (0U))) & (0x3FFFFFU)))))));
        status = kStatus_Success;
    }
    else
    {
                                              ...
                                              const trng_statistical_check_limit_t *limit)
{
    ...
    if ((0 != limit) && (limit->maximum > limit->minimum))
    {
        range = limit->maximum - limit->minimum;

        if (statistical_check == kTRNG_StatisticalCheckMonobit)

        {
            status = trng_SetMonobitLimit(base, range, limit->maximum);
        }
        else if (statistical_check == kTRNG_StatisticalCheckRunBit1)

        {
            status = trng_SetRunBit1Limit(base, range, limit->maximum);
        }
        else if (statistical_check == kTRNG_StatisticalCheckRunBit2)

        {
            status = trng_SetRunBit2Limit(base, range, limit->maximum);
        }
        else if (statistical_check == kTRNG_StatisticalCheckRunBit3)

        {
            status = trng_SetRunBit3Limit(base, range, limit->maximum);
        }
        else if (statistical_check == kTRNG_StatisticalCheckRunBit4)

        {
            status = trng_SetRunBit4Limit(base, range, limit->maximum);
        }
        else if (statistical_check == kTRNG_StatisticalCheckRunBit5)

        {
            status = trng_SetRunBit5Limit(base, range, limit->maximum);
        }
        else if (statistical_check == kTRNG_StatisticalCheckRunBit6Plus)


        {
            status = trng_SetRunBit6Limit(base, range, limit->maximum);
        }
        else if (statistical_check == kTRNG_StatisticalCheckPoker)

        {
            status = trng_SetPokerMaxLimit(base, range, limit->maximum);
        }
        else if (statistical_check == kTRNG_StatisticalCheckFrequencyCount)
...
static status_t trng_ApplyUserConfig(TRNG_Type *base, const trng_config_t *userConfig)
{
    ...
    if (kStatus_Success == status)
    {
        ...
        (((((base)->MCTL) = (((((base)->MCTL)) & ~(((0x80U) | (0x1000U)))) | ((((uint32_t)(((uint32_t)(userConfig->clockMode)) << (7U))) & (0x80U)))))));

        (((((base)->MCTL) = (((((base)->MCTL)) & ~(((0xCU) | (0x1000U)))) | ((((uint32_t)(((uint32_t)(userConfig->ringOscDiv)) << (2U))) & (0xCU)))))));

        (((((base)->MCTL) = (((((base)->MCTL)) & ~(((0x3U) | (0x1000U)))) | ((((uint32_t)(((uint32_t)(userConfig->sampleMode)) << (0U))) & (0x3U)))))));

        (((((base)->SDCTL) = (((((base)->SDCTL)) & ~((0xFFFF0000U))) | ((((uint32_t)(((uint32_t)(userConfig->entropyDelay)) << (16U))) & (0xFFFF0000U)))))));

        (((((base)->SDCTL) = (((((base)->SDCTL)) & ~((0xFFFFU))) | ((((uint32_t)(((uint32_t)(userConfig->sampleSize)) << (0U))) & (0xFFFFU)))))));

        (((((base)->SBLIM) = (((((base)->SBLIM)) & ~((0x3FFU))) | ((((uint32_t)(((uint32_t)(userConfig->sparseBitLimit)) << (0U))) & (0x3FFU)))))));
        (((((base)->SCMISC) = (((((base)->SCMISC)) & ~((0xFFU))) | ((((uint32_t)(((uint32_t)(userConfig->longRunMaxLimit)) << (0U))) & (0xFFU)))))));
    }

    return status;
}
# 1743 "../../libraries/sdk/drives/fsl_trng.c"
static uint32_t trng_ReadEntropy(TRNG_Type *base, uint32_t index)
{
    uint32_t data;
...
# 1773 "../../libraries/sdk/drives/fsl_trng.c"
status_t TRNG_Init(TRNG_Type *base, const trng_config_t *userConfig)
{
    status_t result;
    ...
    if ((base != 0) && (userConfig != 0))
    {
        ...
        ((((base)->MCTL) = (((((base)->MCTL)) & ~(((0x10000U) | (0x1000U) | (0x40U)))) | ((((uint32_t)(((uint32_t)(kTRNG_WorkModeProgram)) << (16U))) & (0x10000U)) | (((uint32_t)(((uint32_t)(1)) << (12U))) & (0x1000U)) | (((uint32_t)(((uint32_t)(1)) << (6U))) & (0x40U))))));
        ...
        if ((result = trng_ApplyUserConfig(base, userConfig)) == kStatus_Success)
        {
            ...
            (((((base)->MCTL) = (((((base)->MCTL)) & ~(((0x10000U) | (0x1000U)))) | ((((uint32_t)(((uint32_t)(kTRNG_WorkModeRun)) << (16U))) & (0x10000U)))))));
            ...
            (void)trng_ReadEntropy(base, ((16U) - 1u));

            if (1 == userConfig->lock)
            {
                (((((base)->SEC_CFG) = (((((base)->SEC_CFG)) & ~((0x2U))) | ((((uint32_t)(((uint32_t)(1)) << (1U))) & (0x2U)))))));
            }
...
# 1827 "../../libraries/sdk/drives/fsl_trng.c"
void TRNG_Deinit(TRNG_Type *base)
{
    ...
    if (0 != base)
    {
        ...
        (((((base)->MCTL) = (((((base)->MCTL)) & ~(((0x10000U) | (0x1000U)))) | ((((uint32_t)(((uint32_t)(kTRNG_WorkModeProgram)) << (16U))) & (0x10000U)))))));
        ...
        while (((((base)->MCTL) & (0x2000U)) >> (13U)) == 0u)
        {
        }
...
# 1862 "../../libraries/sdk/drives/fsl_trng.c"
status_t TRNG_GetRandomData(TRNG_Type *base, void *data, size_t dataSize)
{
    ...
    if ((0 != base) && (0 != data) && (0U != dataSize))
    {


        if (0U != ((((base)->MCTL) & (0x1000U)) >> (12U)))
        {

            (((((base)->MCTL) = (((((base)->MCTL)) & ~((0x1000U))) | ((((uint32_t)(((uint32_t)(1)) << (12U))) & (0x1000U)))))));
        ...
        do
        {
            ...
            tmpValidFlag = ((((base)->MCTL) & (0x400U)) >> (10U));
            tmpErrorFlag = ((((base)->MCTL) & (0x1000U)) >> (12U));
