# 1 "../../libraries/zf_driver/zf_driver_adc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/zf_driver/zf_driver_adc.c" 2
# 36 "../../libraries/zf_driver/zf_driver_adc.c"
...
# 37 "../../libraries/zf_driver/zf_driver_adc.c" 2
...
# 38 "../../libraries/zf_driver/zf_driver_adc.c" 2
...
# 39 "../../libraries/zf_driver/zf_driver_adc.c" 2
...
# 41 "../../libraries/zf_driver/zf_driver_adc.c" 2

static ADC_Type *adc_index[] = { (ADC_Type *)0u, ((ADC_Type *)(0x400C4000u)), ((ADC_Type *)(0x400C8000u)) };
...
void adc_iomuxc(adc_channel_enum ch)
{
    switch(ch)
    {
        ...
        default:((0) ? (void)0 : __aeabi_assert("0", "../../libraries/zf_driver/zf_driver_adc.c", 101),
# 101 "../../libraries/zf_driver/zf_driver_adc.c"
#pragma clang diagnostic push
# 101 "../../libraries/zf_driver/zf_driver_adc.c"
#pragma clang diagnostic ignored "-Wassume"
# 101 "../../libraries/zf_driver/zf_driver_adc.c"
...
# 113 "../../libraries/zf_driver/zf_driver_adc.c"
uint16 adc_convert (adc_channel_enum ch)
{
    adc_channel_config_t adcChannelConfigStruct;

    adcChannelConfigStruct.channelNumber = ch&0xf;
    adcChannelConfigStruct.enableInterruptOnConversionCompleted = 0;
...
# 133 "../../libraries/zf_driver/zf_driver_adc.c"
uint16 adc_mean_filter_convert (adc_channel_enum ch, const uint8 count)
{
    uint8 i = 0;
    uint32 sum = 0;
...
# 154 "../../libraries/zf_driver/zf_driver_adc.c"
void adc_init (adc_channel_enum ch, adc_resolution_enum resolution)
{
    adc_config_t adcConfigStrcut;

    adc_iomuxc(ch);
# 172 "../../libraries/zf_driver/zf_driver_adc.c"
    ...
    else (debug_assert_handler((0), "../../libraries/zf_driver/zf_driver_adc.c", 176));
}
