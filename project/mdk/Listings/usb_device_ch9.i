# 1 "../../libraries/components/usb/usb_cdc_adapter/usb_device_ch9.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/components/usb/usb_cdc_adapter/usb_device_ch9.c" 2
...
# 10 "../../libraries/components/usb/usb_cdc_adapter/usb_device_ch9.c" 2
...
# 11 "../../libraries/components/usb/usb_cdc_adapter/usb_device_ch9.c" 2
...
# 13 "../../libraries/components/usb/usb_cdc_adapter/usb_device_ch9.c" 2
...
# 14 "../../libraries/components/usb/usb_cdc_adapter/usb_device_ch9.c" 2
# 1 "../../libraries/components/usb/usb_cdc_adapter/usb_device_class.h" 1
# 22 "../../libraries/components/usb/usb_cdc_adapter/usb_device_class.h"
...
# 190 "../../libraries/components/usb/usb_cdc_adapter/usb_device_class.h"
...
# 347 "../../libraries/components/usb/usb_cdc_adapter/usb_device_class.h"
usb_status_t USB_DeviceClassInit(uint8_t controllerId,
                                 usb_device_class_config_list_struct_t *configList,
                                 usb_device_handle *handle);
# 360 "../../libraries/components/usb/usb_cdc_adapter/usb_device_class.h"
usb_status_t USB_DeviceClassDeinit(uint8_t controllerId);
# 372 "../../libraries/components/usb/usb_cdc_adapter/usb_device_class.h"
usb_status_t USB_DeviceClassGetSpeed(uint8_t controllerId, uint8_t *speed);
# 388 "../../libraries/components/usb/usb_cdc_adapter/usb_device_class.h"
usb_status_t USB_DeviceClassEvent(usb_device_handle handle, usb_device_class_event_t event, void *param);
# 401 "../../libraries/components/usb/usb_cdc_adapter/usb_device_class.h"
usb_status_t USB_DeviceClassCallback(usb_device_handle handle, uint32_t event, void *param);
# 414 "../../libraries/components/usb/usb_cdc_adapter/usb_device_class.h"
usb_status_t USB_DeviceClassGetDeviceHandle(uint8_t controllerId, usb_device_handle *handle);
# 15 "../../libraries/components/usb/usb_cdc_adapter/usb_device_ch9.c" 2
# 1 "../../libraries/components/usb/usb_cdc_adapter/usb_device_ch9.h" 1
# 45 "../../libraries/components/usb/usb_cdc_adapter/usb_device_ch9.h"
...
# 71 "../../libraries/components/usb/usb_cdc_adapter/usb_device_ch9.h"
extern usb_status_t USB_DeviceControlPipeInit(usb_device_handle handle, void *param);
# 16 "../../libraries/components/usb/usb_cdc_adapter/usb_device_ch9.c" 2
# 33 "../../libraries/components/usb/usb_cdc_adapter/usb_device_ch9.c"
...
static const usb_standard_request_callback_t s_UsbDeviceStandardRequest[] = {
    ...
    (usb_standard_request_callback_t)0,
    USB_DeviceCh9SetClearFeature,
    (usb_standard_request_callback_t)0,
...
# 119 "../../libraries/components/usb/usb_cdc_adapter/usb_device_ch9.c"
static usb_status_t USB_DeviceCh9GetStatus(usb_device_common_class_struct_t *classHandle,
                                           usb_setup_struct_t *setup,
                                           uint8_t **buffer,
                                           uint32_t *length)
{
    ...
    if (((setup->bmRequestType & (0x80U)) != (0x80U)) || (setup->wValue != 0U) ||
        (setup->wLength != 2U))
    {
        return error;
    }
    ...
    if ((setup->bmRequestType & (0x1FU)) == (0x00U))
    {
# 160 "../../libraries/components/usb/usb_cdc_adapter/usb_device_ch9.c"
            error = USB_DeviceGetStatus(classHandle->handle, kUSB_DeviceStatusDevice,
                                        &classHandle->standardTranscationBuffer);
            classHandle->standardTranscationBuffer =
                classHandle->standardTranscationBuffer & (0x03U);
            classHandle->standardTranscationBuffer = (classHandle->standardTranscationBuffer);
    ...
    else if ((setup->bmRequestType & (0x1FU)) == (0x01U))
    {
# 183 "../../libraries/components/usb/usb_cdc_adapter/usb_device_ch9.c"
        error = kStatus_USB_Success;
        classHandle->standardTranscationBuffer = 0U;

        *length = (0x02U);
    }
    else if ((setup->bmRequestType & (0x1FU)) == (0x02U))
    {
# 200 "../../libraries/components/usb/usb_cdc_adapter/usb_device_ch9.c"
        ...
        classHandle->standardTranscationBuffer = endpointStatus.endpointStatus & (0x03U);
        classHandle->standardTranscationBuffer = (classHandle->standardTranscationBuffer);
...
# 232 "../../libraries/components/usb/usb_cdc_adapter/usb_device_ch9.c"
static usb_status_t USB_DeviceCh9SetClearFeature(usb_device_common_class_struct_t *classHandle,
                                                 usb_setup_struct_t *setup,
                                                 uint8_t **buffer,
                                                 uint32_t *length)
{
    ...
    if (((setup->bmRequestType & (0x80U)) != (0x00U)) || (setup->wLength != 0U))
    {
        return error;
    }
...
# 291 "../../libraries/components/usb/usb_cdc_adapter/usb_device_ch9.c"
        else
        {
        }
    }
    else if ((setup->bmRequestType & (0x1FU)) == (0x02U))
    {
        ...
        if ((0U) == setup->wValue)
        {
# 322 "../../libraries/components/usb/usb_cdc_adapter/usb_device_ch9.c"
            if ((0U) == (setup->wIndex & (0x0FU)))
            {
...
# 386 "../../libraries/components/usb/usb_cdc_adapter/usb_device_ch9.c"
static usb_status_t USB_DeviceCh9SetAddress(usb_device_common_class_struct_t *classHandle,
                                            usb_setup_struct_t *setup,
                                            uint8_t **buffer,
                                            uint32_t *length)
{
    ...
    if (((setup->bmRequestType & (0x80U)) != (0x00U)) ||
        ((setup->bmRequestType & (0x1FU)) != (0x00U)) ||
    ...
    else
    {
        ...
        error = USB_DeviceSetStatus(classHandle->handle, kUSB_DeviceStatusAddress, 0);
...
# 465 "../../libraries/components/usb/usb_cdc_adapter/usb_device_ch9.c"
static usb_status_t USB_DeviceCh9GetDescriptor(usb_device_common_class_struct_t *classHandle,
                                               usb_setup_struct_t *setup,
                                               uint8_t **buffer,
                                               uint32_t *length)
{
    ...
    if ((setup->bmRequestType & (0x80U)) != (0x80U))
    {
        return error;
    }
...
# 588 "../../libraries/components/usb/usb_cdc_adapter/usb_device_ch9.c"
    else
    {
    }
...
# 610 "../../libraries/components/usb/usb_cdc_adapter/usb_device_ch9.c"
static usb_status_t USB_DeviceCh9GetConfiguration(usb_device_common_class_struct_t *classHandle,
                                                  usb_setup_struct_t *setup,
                                                  uint8_t **buffer,
                                                  uint32_t *length)
...
# 658 "../../libraries/components/usb/usb_cdc_adapter/usb_device_ch9.c"
static usb_status_t USB_DeviceCh9SetConfiguration(usb_device_common_class_struct_t *classHandle,
                                                  usb_setup_struct_t *setup,
                                                  uint8_t **buffer,
                                                  uint32_t *length)
...
# 721 "../../libraries/components/usb/usb_cdc_adapter/usb_device_ch9.c"
...
# 741 "../../libraries/components/usb/usb_cdc_adapter/usb_device_ch9.c"
static usb_status_t USB_DeviceCh9GetInterface(usb_device_common_class_struct_t *classHandle,
                                              usb_setup_struct_t *setup,
                                              uint8_t **buffer,
                                              uint32_t *length)
{
    ...
    if (((setup->bmRequestType & (0x80U)) != (0x80U)) ||
        ((setup->bmRequestType & (0x1FU)) != (0x01U)) ||
...
# 794 "../../libraries/components/usb/usb_cdc_adapter/usb_device_ch9.c"
static usb_status_t USB_DeviceCh9SetInterface(usb_device_common_class_struct_t *classHandle,
                                              usb_setup_struct_t *setup,
                                              uint8_t **buffer,
                                              uint32_t *length)
...
# 835 "../../libraries/components/usb/usb_cdc_adapter/usb_device_ch9.c"
...
# 858 "../../libraries/components/usb/usb_cdc_adapter/usb_device_ch9.c"
static usb_status_t USB_DeviceCh9SynchFrame(usb_device_common_class_struct_t *classHandle,
                                            usb_setup_struct_t *setup,
                                            uint8_t **buffer,
                                            uint32_t *length)
...
# 928 "../../libraries/components/usb/usb_cdc_adapter/usb_device_ch9.c"
                                                      ...
                                                      uint32_t *length)
{
    ...
    if (kStatus_USB_InvalidRequest == error)
    {
        ...
        status = USB_DeviceStallEndpoint(handle, (uint8_t)(0U));
    }
    else
    {
        ...
        if (kStatus_USB_Success == error)
        {
            status = USB_DeviceSendRequest(handle, ((0U)), *buffer, *length);
        }
        else
        {
            status = USB_DeviceSendRequest(handle, ((0U)), (uint8_t *)0, 0U);
        }

        if ((kStatus_USB_Success == status) &&
            ((0x80U) == (setup->bmRequestType & (0x80U))))
        {
            status = USB_DeviceRecvRequest(handle, ((0U)), (uint8_t *)0, 0U);
        }
    }

    return status;
}
# 982 "../../libraries/components/usb/usb_cdc_adapter/usb_device_ch9.c"
                                              ...
                                              void *callbackParam)
{
    ...
    if (((0xFFFFFFFFU) == message->length) || (0 == callbackParam))
    {
        return status;
    }
    ...
    {
        if (((8U) != message->length) || (0 == message->buffer))
        {
# 1026 "../../libraries/components/usb/usb_cdc_adapter/usb_device_ch9.c"
            return status;
        }
        ...
        deviceSetup->wValue = (setup->wValue);
        deviceSetup->wIndex = (setup->wIndex);
        deviceSetup->wLength = (setup->wLength);
        deviceSetup->bRequest = setup->bRequest;
        deviceSetup->bmRequestType = setup->bmRequestType;


        if ((deviceSetup->bmRequestType & (0x1FU)) > (0x03U))
        {
            ...
            (void)USB_DeviceControlCallbackFeedback(handle, deviceSetup, kStatus_USB_InvalidRequest,
                                                    kUSB_DeviceControlPipeSetupStage, 0, 0);
            return status;

        }

        if ((deviceSetup->bmRequestType & (0x60U)) == (0U))
        {

            if (deviceSetup->bRequest < (sizeof(s_UsbDeviceStandardRequest) / 4U))
            {
                if (s_UsbDeviceStandardRequest[deviceSetup->bRequest] != (usb_standard_request_callback_t)0)
                {
                    status =
        ...
        else
        {
            if ((0U != deviceSetup->wLength) &&
                ((deviceSetup->bmRequestType & (0x80U)) == (0x00U)))
            {

                if ((0U != deviceSetup->wLength) &&
                    ((deviceSetup->bmRequestType & (0x60U)) == (0x20U)))
                {

                    usb_device_control_request_struct_t controlRequest;
                    controlRequest.buffer = (uint8_t *)0;
                    ...
                    buffer = controlRequest.buffer;
                         ...
                         ((deviceSetup->bmRequestType & (0x60U)) == (0x40U)))
                {
                ...
                if (kStatus_USB_Success == status)
                {
                    ...
                    status = USB_DeviceRecvRequest(handle, (0U), buffer, length);
                    return status;
                }
                else
                {
            ...
            else
            {
                ...
                if (((deviceSetup->bmRequestType & (0x60U)) == (0x20U)))
                {
                ...
                else if (((deviceSetup->bmRequestType & (0x60U)) == (0x40U)))
                {
...
# 1226 "../../libraries/components/usb/usb_cdc_adapter/usb_device_ch9.c"
usb_status_t USB_DeviceControlPipeInit(usb_device_handle handle, void *param)
{
    ...
    epInitStruct.zlt = 1U;
    epInitStruct.transferType = (0x00U);
    epInitStruct.interval = 0;
    epInitStruct.endpointAddress = (0U) | ((1U) << (7U));
    epInitStruct.maxPacketSize = (64U);
    ...
    epInitStruct.endpointAddress = (0U) | ((0U) << (7U));

    status = USB_DeviceInitEndpoint(handle, &epInitStruct, &epCallback);

    if (kStatus_USB_Success != status)
    {
# 1261 "../../libraries/components/usb/usb_cdc_adapter/usb_device_ch9.c"
