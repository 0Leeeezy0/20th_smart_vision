# 1 "../../libraries/zf_device/zf_device_oled.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/zf_device/zf_device_oled.c" 2
# 49 "../../libraries/zf_device/zf_device_oled.c"
...
# 50 "../../libraries/zf_device/zf_device_oled.c" 2
...
# 51 "../../libraries/zf_device/zf_device_oled.c" 2
...
# 52 "../../libraries/zf_device/zf_device_oled.c" 2
...
# 53 "../../libraries/zf_device/zf_device_oled.c" 2
...
# 54 "../../libraries/zf_device/zf_device_oled.c" 2
...
# 55 "../../libraries/zf_device/zf_device_oled.c" 2
...
# 56 "../../libraries/zf_device/zf_device_oled.c" 2
...
void oled_init (void);
# 58 "../../libraries/zf_device/zf_device_oled.c" 2
...
static oled_dir_enum oled_display_dir = ( OLED_PORTAIT );
static oled_font_size_enum oled_display_font = ( OLED_6X8_FONT );
# 76 "../../libraries/zf_device/zf_device_oled.c"
...
# 89 "../../libraries/zf_device/zf_device_oled.c"
...
# 103 "../../libraries/zf_device/zf_device_oled.c"
static void oled_set_coordinate (uint8 x, uint8 y)
{



    (debug_assert_handler((128 > x), "../../libraries/zf_device/zf_device_oled.c", 108));
    (debug_assert_handler((8 > y), "../../libraries/zf_device/zf_device_oled.c", 109));

    oled_write_command(0xb0 + y);
    oled_write_command(((x & 0xf0) >> 4) | 0x10);
    oled_write_command((x & 0x0f) | 0x00);
}
# 123 "../../libraries/zf_device/zf_device_oled.c"
static void oled_debug_init (void)
{
    ...
    info.display_x_max = (128);
    info.display_y_max = (64 );
...
# 162 "../../libraries/zf_device/zf_device_oled.c"
void oled_clear (void)
{
    uint8 y = 0, x = 0;
...
# 187 "../../libraries/zf_device/zf_device_oled.c"
void oled_full (const uint8 color)
{
    uint8 y = 0, x = 0;
...
# 212 "../../libraries/zf_device/zf_device_oled.c"
void oled_set_dir (oled_dir_enum dir)
{
    oled_display_dir = dir;
}
# 224 "../../libraries/zf_device/zf_device_oled.c"
void oled_set_font (oled_font_size_enum font)
{
    oled_display_font = font;
}
# 238 "../../libraries/zf_device/zf_device_oled.c"
void oled_draw_point (uint16 x, uint16 y, const uint8 color)
{



    (debug_assert_handler((128 > x), "../../libraries/zf_device/zf_device_oled.c", 243));
    (debug_assert_handler((8 > y), "../../libraries/zf_device/zf_device_oled.c", 244));
...
# 264 "../../libraries/zf_device/zf_device_oled.c"
void oled_show_string (uint16 x, uint16 y, const char ch[])
{



    (debug_assert_handler((128 > x), "../../libraries/zf_device/zf_device_oled.c", 269));
    (debug_assert_handler((8 > y), "../../libraries/zf_device/zf_device_oled.c", 270));
...
# 335 "../../libraries/zf_device/zf_device_oled.c"
void oled_show_int (uint16 x, uint16 y, const int32 dat, uint8 num)
{



    (debug_assert_handler((128 > x), "../../libraries/zf_device/zf_device_oled.c", 340));
    (debug_assert_handler((8 > y), "../../libraries/zf_device/zf_device_oled.c", 341));

    (debug_assert_handler((0 < num), "../../libraries/zf_device/zf_device_oled.c", 343));
    (debug_assert_handler((10 >= num), "../../libraries/zf_device/zf_device_oled.c", 344));
...
# 376 "../../libraries/zf_device/zf_device_oled.c"
void oled_show_uint (uint16 x,uint16 y,const uint32 dat,uint8 num)
{



    (debug_assert_handler((128 > x), "../../libraries/zf_device/zf_device_oled.c", 381));
    (debug_assert_handler((8 > y), "../../libraries/zf_device/zf_device_oled.c", 382));

    (debug_assert_handler((0 < num), "../../libraries/zf_device/zf_device_oled.c", 384));
    (debug_assert_handler((10 >= num), "../../libraries/zf_device/zf_device_oled.c", 385));
...
# 420 "../../libraries/zf_device/zf_device_oled.c"
void oled_show_float (uint16 x,uint16 y,const double dat,uint8 num,uint8 pointnum)
{



    (debug_assert_handler((128 > x), "../../libraries/zf_device/zf_device_oled.c", 425));
    (debug_assert_handler((8 > y), "../../libraries/zf_device/zf_device_oled.c", 426));

    (debug_assert_handler((0 < num), "../../libraries/zf_device/zf_device_oled.c", 428));
    (debug_assert_handler((8 >= num), "../../libraries/zf_device/zf_device_oled.c", 429));
    (debug_assert_handler((0 < pointnum), "../../libraries/zf_device/zf_device_oled.c", 430));
    (debug_assert_handler((6 >= pointnum), "../../libraries/zf_device/zf_device_oled.c", 431));
...
# 465 "../../libraries/zf_device/zf_device_oled.c"
void oled_show_binary_image (uint16 x, uint16 y, const uint8 *image, uint16 width, uint16 height, uint16 dis_width, uint16 dis_height)
{



    (debug_assert_handler((128 > x), "../../libraries/zf_device/zf_device_oled.c", 470));
    (debug_assert_handler((8 > y), "../../libraries/zf_device/zf_device_oled.c", 471));
    (debug_assert_handler((0 != image), "../../libraries/zf_device/zf_device_oled.c", 472));
...
# 547 "../../libraries/zf_device/zf_device_oled.c"
void oled_show_gray_image (uint16 x, uint16 y, const uint8 *image, uint16 width, uint16 height, uint16 dis_width, uint16 dis_height, uint8 threshold)
{



    (debug_assert_handler((128 > x), "../../libraries/zf_device/zf_device_oled.c", 552));
    (debug_assert_handler((8 > y), "../../libraries/zf_device/zf_device_oled.c", 553));
    (debug_assert_handler((0 != image), "../../libraries/zf_device/zf_device_oled.c", 554));
...
# 621 "../../libraries/zf_device/zf_device_oled.c"
void oled_show_wave (uint16 x, uint16 y, const uint16 *wave, uint16 width, uint16 value_max, uint16 dis_width, uint16 dis_value_max)
{
    ...
    (debug_assert_handler((128 > x), "../../libraries/zf_device/zf_device_oled.c", 626));
    (debug_assert_handler((8 > y), "../../libraries/zf_device/zf_device_oled.c", 627));
    (debug_assert_handler((0 != wave), "../../libraries/zf_device/zf_device_oled.c", 628));
...
# 670 "../../libraries/zf_device/zf_device_oled.c"
void oled_show_chinese (uint16 x, uint16 y, uint8 size, const uint8 *chinese_buffer, uint8 number)
{



    (debug_assert_handler((128 > x), "../../libraries/zf_device/zf_device_oled.c", 675));
    (debug_assert_handler((8 > y), "../../libraries/zf_device/zf_device_oled.c", 676));
    (debug_assert_handler((0 != chinese_buffer), "../../libraries/zf_device/zf_device_oled.c", 677));
...
# 704 "../../libraries/zf_device/zf_device_oled.c"
void oled_init (void)
{
    ...
    gpio_init((C19) , GPO, GPIO_HIGH, GPO_PUSH_PULL);
