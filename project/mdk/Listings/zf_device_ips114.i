# 1 "../../libraries/zf_device/zf_device_ips114.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/zf_device/zf_device_ips114.c" 2
# 51 "../../libraries/zf_device/zf_device_ips114.c"
...
# 52 "../../libraries/zf_device/zf_device_ips114.c" 2
...
# 53 "../../libraries/zf_device/zf_device_ips114.c" 2
...
# 54 "../../libraries/zf_device/zf_device_ips114.c" 2
...
# 55 "../../libraries/zf_device/zf_device_ips114.c" 2
...
# 56 "../../libraries/zf_device/zf_device_ips114.c" 2
...
# 57 "../../libraries/zf_device/zf_device_ips114.c" 2
...
# 58 "../../libraries/zf_device/zf_device_ips114.c" 2
...
# 60 "../../libraries/zf_device/zf_device_ips114.c" 2

static uint16 ips114_pencolor = ( RGB565_RED );
static uint16 ips114_bgcolor = ( RGB565_WHITE );

static ips114_dir_enum ips114_display_dir = ( IPS114_PORTAIT );
static ips114_font_size_enum ips114_display_font = ( IPS114_8X16_FONT );
static uint8 ips114_x_max = 240;
static uint8 ips114_y_max = 135;
# 155 "../../libraries/zf_device/zf_device_ips114.c"
...
# 172 "../../libraries/zf_device/zf_device_ips114.c"
static void ips114_set_region (const uint16 x1, const uint16 y1, const uint16 x2, const uint16 y2)
{



    (debug_assert_handler((x1 < ips114_x_max), "../../libraries/zf_device/zf_device_ips114.c", 177));
    (debug_assert_handler((y1 < ips114_y_max), "../../libraries/zf_device/zf_device_ips114.c", 178));
    (debug_assert_handler((x2 < ips114_x_max), "../../libraries/zf_device/zf_device_ips114.c", 179));
    (debug_assert_handler((y2 < ips114_y_max), "../../libraries/zf_device/zf_device_ips114.c", 180));

    switch(ips114_display_dir)
    {
        case IPS114_PORTAIT:
        {
            ips114_write_index(0x2a);
            (spi_write_16bit((SPI_3), (x1 + 40)));
            (spi_write_16bit((SPI_3), (x2 + 40)));
            ips114_write_index(0x2b);
            (spi_write_16bit((SPI_3), (y1 + 52)));
            (spi_write_16bit((SPI_3), (y2 + 52)));
            ips114_write_index(0x2c);
        }break;
        case IPS114_PORTAIT_180:
        {
            ...
            (spi_write_16bit((SPI_3), (x2 + 40)));
            ips114_write_index(0x2b);
            (spi_write_16bit((SPI_3), (y1 + 53)));
            (spi_write_16bit((SPI_3), (y2 + 53)));
            ips114_write_index(0x2c);
        }break;
        case IPS114_CROSSWISE:
        {
            ips114_write_index(0x2a);
            (spi_write_16bit((SPI_3), (x1 + 52)));
            (spi_write_16bit((SPI_3), (x2 + 52)));
            ips114_write_index(0x2b);
            (spi_write_16bit((SPI_3), (y1 + 40)));
            (spi_write_16bit((SPI_3), (y2 + 40)));
            ips114_write_index(0x2c);
        }break;
        case IPS114_CROSSWISE_180:
        {
            ips114_write_index(0x2a);
            (spi_write_16bit((SPI_3), (x1 + 53)));
            (spi_write_16bit((SPI_3), (x2 + 53)));
            ips114_write_index(0x2b);
            (spi_write_16bit((SPI_3), (y1 + 40)));
            (spi_write_16bit((SPI_3), (y2 + 40)));
            ips114_write_index(0x2c);
...
# 234 "../../libraries/zf_device/zf_device_ips114.c"
...
# 273 "../../libraries/zf_device/zf_device_ips114.c"
void ips114_clear (void)
{
    ...
    {
        (spi_write_16bit_array((SPI_3), (color_buffer), (ips114_x_max)));
    }
    ((1) ? (GPIO_SetPinsOutput(PORTPTR[(B3 ) >> 5],1 << ((B3 ) & 0x1f))) : (GPIO_ClearPinsOutput(PORTPTR[(B3 ) >> 5],1 << ((B3 ) & 0x1f))));
}
# 298 "../../libraries/zf_device/zf_device_ips114.c"
void ips114_full (const uint16 color)
{
    uint16 color_buffer[ips114_x_max];
    uint32 i = 0, j = 0;
...
# 323 "../../libraries/zf_device/zf_device_ips114.c"
void ips114_set_dir (ips114_dir_enum dir)
{
...
# 350 "../../libraries/zf_device/zf_device_ips114.c"
void ips114_set_font (ips114_font_size_enum font)
{
    ips114_display_font = font;
}
# 363 "../../libraries/zf_device/zf_device_ips114.c"
void ips114_set_color (const uint16 pen, const uint16 bgcolor)
{
    ips114_pencolor = pen;
    ips114_bgcolor = bgcolor;
}
# 378 "../../libraries/zf_device/zf_device_ips114.c"
void ips114_draw_point (uint16 x, uint16 y, const uint16 color)
{


    (debug_assert_handler((x < ips114_x_max), "../../libraries/zf_device/zf_device_ips114.c", 382));
    (debug_assert_handler((y < ips114_y_max), "../../libraries/zf_device/zf_device_ips114.c", 383));
...
# 402 "../../libraries/zf_device/zf_device_ips114.c"
void ips114_draw_line (uint16 x_start, uint16 y_start, uint16 x_end, uint16 y_end, const uint16 color)
{


    (debug_assert_handler((x_start < ips114_x_max), "../../libraries/zf_device/zf_device_ips114.c", 406));
    (debug_assert_handler((y_start < ips114_y_max), "../../libraries/zf_device/zf_device_ips114.c", 407));
    (debug_assert_handler((x_end < ips114_x_max), "../../libraries/zf_device/zf_device_ips114.c", 408));
    (debug_assert_handler((y_end < ips114_y_max), "../../libraries/zf_device/zf_device_ips114.c", 409));
...
# 465 "../../libraries/zf_device/zf_device_ips114.c"
void ips114_show_char (uint16 x, uint16 y, const char dat)
{


    (debug_assert_handler((x < ips114_x_max), "../../libraries/zf_device/zf_device_ips114.c", 469));
    (debug_assert_handler((y < ips114_y_max), "../../libraries/zf_device/zf_device_ips114.c", 470));
...
# 552 "../../libraries/zf_device/zf_device_ips114.c"
void ips114_show_string (uint16 x, uint16 y, const char dat[])
{


    (debug_assert_handler((x < ips114_x_max), "../../libraries/zf_device/zf_device_ips114.c", 556));
    (debug_assert_handler((y < ips114_y_max), "../../libraries/zf_device/zf_device_ips114.c", 557));
    ...
    while('\0' != dat[j])
    {
        switch(ips114_display_font)
        {
            ...
            case IPS114_16X16_FONT: break;
        }
        j ++;
    }
}
# 582 "../../libraries/zf_device/zf_device_ips114.c"
void ips114_show_int (uint16 x, uint16 y, const int32 dat, uint8 num)
{


    (debug_assert_handler((x < ips114_x_max), "../../libraries/zf_device/zf_device_ips114.c", 586));
    (debug_assert_handler((y < ips114_y_max), "../../libraries/zf_device/zf_device_ips114.c", 587));
    (debug_assert_handler((0 < num), "../../libraries/zf_device/zf_device_ips114.c", 588));
    (debug_assert_handler((10 >= num), "../../libraries/zf_device/zf_device_ips114.c", 589));
...
# 621 "../../libraries/zf_device/zf_device_ips114.c"
void ips114_show_uint (uint16 x, uint16 y, const uint32 dat, uint8 num)
{


    (debug_assert_handler((x < ips114_x_max), "../../libraries/zf_device/zf_device_ips114.c", 625));
    (debug_assert_handler((y < ips114_y_max), "../../libraries/zf_device/zf_device_ips114.c", 626));
    (debug_assert_handler((0 < num), "../../libraries/zf_device/zf_device_ips114.c", 627));
    (debug_assert_handler((10 >= num), "../../libraries/zf_device/zf_device_ips114.c", 628));
...
# 663 "../../libraries/zf_device/zf_device_ips114.c"
void ips114_show_float (uint16 x, uint16 y, const double dat, uint8 num, uint8 pointnum)
{


    (debug_assert_handler((x < ips114_x_max), "../../libraries/zf_device/zf_device_ips114.c", 667));
    (debug_assert_handler((y < ips114_y_max), "../../libraries/zf_device/zf_device_ips114.c", 668));
    (debug_assert_handler((0 < num), "../../libraries/zf_device/zf_device_ips114.c", 669));
    (debug_assert_handler((8 >= num), "../../libraries/zf_device/zf_device_ips114.c", 670));
    (debug_assert_handler((0 < pointnum), "../../libraries/zf_device/zf_device_ips114.c", 671));
    (debug_assert_handler((6 >= pointnum), "../../libraries/zf_device/zf_device_ips114.c", 672));
...
# 706 "../../libraries/zf_device/zf_device_ips114.c"
void ips114_show_binary_image (uint16 x, uint16 y, const uint8 *image, uint16 width, uint16 height, uint16 dis_width, uint16 dis_height)
{


    (debug_assert_handler((x < ips114_x_max), "../../libraries/zf_device/zf_device_ips114.c", 710));
    (debug_assert_handler((y < ips114_y_max), "../../libraries/zf_device/zf_device_ips114.c", 711));
    (debug_assert_handler((0 != image), "../../libraries/zf_device/zf_device_ips114.c", 712));
...
# 761 "../../libraries/zf_device/zf_device_ips114.c"
void ips114_show_gray_image (uint16 x, uint16 y, const uint8 *image, uint16 width, uint16 height, uint16 dis_width, uint16 dis_height, uint8 threshold)
{


    (debug_assert_handler((x < ips114_x_max), "../../libraries/zf_device/zf_device_ips114.c", 765));
    (debug_assert_handler((y < ips114_y_max), "../../libraries/zf_device/zf_device_ips114.c", 766));
    (debug_assert_handler((0 != image), "../../libraries/zf_device/zf_device_ips114.c", 767));
...
# 821 "../../libraries/zf_device/zf_device_ips114.c"
void ips114_show_rgb565_image (uint16 x, uint16 y, const uint16 *image, uint16 width, uint16 height, uint16 dis_width, uint16 dis_height, uint8 color_mode)
{


    (debug_assert_handler((x < ips114_x_max), "../../libraries/zf_device/zf_device_ips114.c", 825));
    (debug_assert_handler((y < ips114_y_max), "../../libraries/zf_device/zf_device_ips114.c", 826));
    (debug_assert_handler((0 != image), "../../libraries/zf_device/zf_device_ips114.c", 827));
...
# 868 "../../libraries/zf_device/zf_device_ips114.c"
void ips114_show_wave (uint16 x, uint16 y, const uint16 *wave, uint16 width, uint16 value_max, uint16 dis_width, uint16 dis_value_max)
{


    (debug_assert_handler((x < ips114_x_max), "../../libraries/zf_device/zf_device_ips114.c", 872));
    (debug_assert_handler((y < ips114_y_max), "../../libraries/zf_device/zf_device_ips114.c", 873));
    (debug_assert_handler((0 != wave), "../../libraries/zf_device/zf_device_ips114.c", 874));
    ...
    ((0) ? (GPIO_SetPinsOutput(PORTPTR[(B3 ) >> 5],1 << ((B3 ) & 0x1f))) : (GPIO_ClearPinsOutput(PORTPTR[(B3 ) >> 5],1 << ((B3 ) & 0x1f))));
    ips114_set_region(x, y, x + dis_width - 1, y + dis_value_max - 1);
...
# 912 "../../libraries/zf_device/zf_device_ips114.c"
void ips114_show_chinese (uint16 x, uint16 y, uint8 size, const uint8 *chinese_buffer, uint8 number, const uint16 color)
{


    (debug_assert_handler((x < ips114_x_max), "../../libraries/zf_device/zf_device_ips114.c", 916));
    (debug_assert_handler((y < ips114_y_max), "../../libraries/zf_device/zf_device_ips114.c", 917));
    (debug_assert_handler((0 != chinese_buffer), "../../libraries/zf_device/zf_device_ips114.c", 918));
        ...
        while(temp1 --)
        {
            for(k = 0; k < temp2; k ++)
            {
                for(j = 8; 0 < j; j --)
                {
                    ...
                    {
                        (spi_write_16bit((SPI_3), (ips114_bgcolor)));
                    }
                }
                p_data ++;
            }
...
# 964 "../../libraries/zf_device/zf_device_ips114.c"
void ips114_init (void)
{



    spi_init((SPI_3), SPI_MODE0, (60 * 1000 * 1000), (SPI3_SCK_B0 ), (SPI3_MOSI_B1), SPI_MISO_NULL, SPI_CS_NULL);
    ...
    switch(ips114_display_dir)
    {
        case IPS114_PORTAIT: (spi_write_8bit((SPI_3), (0xA0))); break;
        case IPS114_PORTAIT_180: (spi_write_8bit((SPI_3), (0x70))); break;
        case IPS114_CROSSWISE: (spi_write_8bit((SPI_3), (0x00))); break;
        case IPS114_CROSSWISE_180: (spi_write_8bit((SPI_3), (0xC0))); break;
    }
    ...
    (spi_write_8bit((SPI_3), (0xA4)));
    (spi_write_8bit((SPI_3), (0xA1)));

    ips114_write_index(0xE0);
    (spi_write_8bit((SPI_3), (0xD0)));
    (spi_write_8bit((SPI_3), (0x04)));
    (spi_write_8bit((SPI_3), (0x0D)));
    (spi_write_8bit((SPI_3), (0x11)));
    (spi_write_8bit((SPI_3), (0x13)));
    (spi_write_8bit((SPI_3), (0x2B)));
    (spi_write_8bit((SPI_3), (0x3F)));
    (spi_write_8bit((SPI_3), (0x54)));
    (spi_write_8bit((SPI_3), (0x4C)));
    (spi_write_8bit((SPI_3), (0x18)));
    (spi_write_8bit((SPI_3), (0x0D)));
    (spi_write_8bit((SPI_3), (0x0B)));
    ...
    (spi_write_8bit((SPI_3), (0x2C)));
    (spi_write_8bit((SPI_3), (0x3F)));
    (spi_write_8bit((SPI_3), (0x44)));
    (spi_write_8bit((SPI_3), (0x51)));
