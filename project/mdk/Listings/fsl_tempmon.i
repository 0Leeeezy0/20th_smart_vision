# 1 "../../libraries/sdk/drives/fsl_tempmon.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/sdk/drives/fsl_tempmon.c" 2
...
# 1 "../../libraries/sdk/drives/fsl_tempmon.h" 1
# 11 "../../libraries/sdk/drives/fsl_tempmon.h"
...
# 12 "../../libraries/sdk/drives/fsl_tempmon.h" 2
# 31 "../../libraries/sdk/drives/fsl_tempmon.h"
...
# 61 "../../libraries/sdk/drives/fsl_tempmon.h"
...
# 82 "../../libraries/sdk/drives/fsl_tempmon.h"
...
# 119 "../../libraries/sdk/drives/fsl_tempmon.h"
void TEMPMON_SetTempAlarm(TEMPMON_Type *base, int8_t tempVal, tempmon_alarm_mode alarmMode);
# 10 "../../libraries/sdk/drives/fsl_tempmon.c" 2
# 39 "../../libraries/sdk/drives/fsl_tempmon.c"
static int32_t s_hotTemp;
static int32_t s_hotCount;
static float s_hotT_ROOM;
static int32_t s_roomC_hotC;
# 53 "../../libraries/sdk/drives/fsl_tempmon.c"
void TEMPMON_Init(TEMPMON_Type *base, const tempmon_config_t *config)
{
    ((0 != config) ? (void)0 : __aeabi_assert("NULL != config", "../../libraries/sdk/drives/fsl_tempmon.c", 55),
# 55 "../../libraries/sdk/drives/fsl_tempmon.c"
#pragma clang diagnostic push
# 55 "../../libraries/sdk/drives/fsl_tempmon.c"
#pragma clang diagnostic ignored "-Wassume"
# 55 "../../libraries/sdk/drives/fsl_tempmon.c"
...
# 55 "../../libraries/sdk/drives/fsl_tempmon.c"
    ...
    base->TEMPSENSE0 &= ~(0x1U);


    base->TEMPSENSE1 = (((uint32_t)(((uint32_t)(config->frequency)) << (0U))) & (0xFFFFU));


    calibrationData = ((OCOTP_Type *)(0x401F4000u))->ANA1;
    tmpU32 = (calibrationData & 0xFFU) >> 0x00U;
    s_hotTemp = (int32_t)tmpU32;

    tmpU32 = (calibrationData & 0xFFF00U) >> 0X08U;
    s_hotCount = (int32_t)tmpU32;

    tmpU32 = (calibrationData & 0xFFF00000U) >> 0x14U;
    roomCount = (int32_t)tmpU32;

    s_hotT_ROOM = (float)s_hotTemp - 25.0f;
...
# 109 "../../libraries/sdk/drives/fsl_tempmon.c"
void TEMPMON_GetDefaultConfig(tempmon_config_t *config)
{
    ((config) ? (void)0 : __aeabi_assert("config", "../../libraries/sdk/drives/fsl_tempmon.c", 111),
# 111 "../../libraries/sdk/drives/fsl_tempmon.c"
#pragma clang diagnostic push
# 111 "../../libraries/sdk/drives/fsl_tempmon.c"
#pragma clang diagnostic ignored "-Wassume"
# 111 "../../libraries/sdk/drives/fsl_tempmon.c"
...
float TEMPMON_GetCurrentTemperature(TEMPMON_Type *base)
{
    ...
    ((0 != base) ? (void)0 : __aeabi_assert("NULL != base", "../../libraries/sdk/drives/fsl_tempmon.c", 135),
# 135 "../../libraries/sdk/drives/fsl_tempmon.c"
#pragma clang diagnostic push
# 135 "../../libraries/sdk/drives/fsl_tempmon.c"
#pragma clang diagnostic ignored "-Wassume"
# 135 "../../libraries/sdk/drives/fsl_tempmon.c"
...
# 135 "../../libraries/sdk/drives/fsl_tempmon.c"
    ...
    while (0U == (base->TEMPSENSE0 & (0x4U)))
    {
    }


    nmeas = (base->TEMPSENSE0 & (0xFFF00U)) >> (8U);
...
# 160 "../../libraries/sdk/drives/fsl_tempmon.c"
void TEMPMON_SetTempAlarm(TEMPMON_Type *base, int8_t tempVal, tempmon_alarm_mode alarmMode)
{

    ((0 != base) ? (void)0 : __aeabi_assert("NULL != base", "../../libraries/sdk/drives/fsl_tempmon.c", 163),
# 163 "../../libraries/sdk/drives/fsl_tempmon.c"
#pragma clang diagnostic push
# 163 "../../libraries/sdk/drives/fsl_tempmon.c"
#pragma clang diagnostic ignored "-Wassume"
# 163 "../../libraries/sdk/drives/fsl_tempmon.c"
...
# 163 "../../libraries/sdk/drives/fsl_tempmon.c"
    ...
    ((s_hotTemp >= tempVal) ? (void)0 : __aeabi_assert("s_hotTemp >= tempVal", "../../libraries/sdk/drives/fsl_tempmon.c", 166),
# 166 "../../libraries/sdk/drives/fsl_tempmon.c"
#pragma clang diagnostic push
# 166 "../../libraries/sdk/drives/fsl_tempmon.c"
#pragma clang diagnostic ignored "-Wassume"
# 166 "../../libraries/sdk/drives/fsl_tempmon.c"
    (__builtin_assume)((s_hotTemp >= tempVal)?1:0)
# 166 "../../libraries/sdk/drives/fsl_tempmon.c"
#pragma clang diagnostic pop
# 166 "../../libraries/sdk/drives/fsl_tempmon.c"
    );
    ...
    switch (alarmMode)
    {
        case kTEMPMON_HighAlarmMode:
            ...
            tempRegVal =
                (tempRegVal & ~(0xFFF00000U)) | (((uint32_t)(((uint32_t)(tempCodeVal)) << (20U))) & (0xFFF00000U));
        ...
        case kTEMPMON_PanicAlarmMode:
            ...
            tempRegVal = (tempRegVal & ~(0xFFF0000U)) |
                         (((uint32_t)(((uint32_t)(tempCodeVal)) << (16U))) & (0xFFF0000U));
        ...
        case kTEMPMON_LowAlarmMode:
            ...
            tempRegVal = base->TEMPSENSE2;
            tempRegVal = (tempRegVal & ~(0xFFFU)) |
                         (((uint32_t)(((uint32_t)(tempCodeVal)) << (0U))) & (0xFFFU));
            base->TEMPSENSE2 = tempRegVal;
            break;

        default:
            ((0) ? (void)0 : __aeabi_assert("false", "../../libraries/sdk/drives/fsl_tempmon.c", 201),
# 201 "../../libraries/sdk/drives/fsl_tempmon.c"
#pragma clang diagnostic push
# 201 "../../libraries/sdk/drives/fsl_tempmon.c"
#pragma clang diagnostic ignored "-Wassume"
# 201 "../../libraries/sdk/drives/fsl_tempmon.c"
