# 1 "../../libraries/sdk/drives/fsl_pxp.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/sdk/drives/fsl_pxp.c" 2
...
# 1 "../../libraries/sdk/drives/fsl_pxp.h" 1
# 12 "../../libraries/sdk/drives/fsl_pxp.h"
...
# 13 "../../libraries/sdk/drives/fsl_pxp.h" 2
# 75 "../../libraries/sdk/drives/fsl_pxp.h"
enum _pxp_interrupt_enable
{
    kPXP_CompleteInterruptEnable = (0x2U),
    kPXP_CommandLoadInterruptEnable = (0x4U),
# 117 "../../libraries/sdk/drives/fsl_pxp.h"
};
...
enum _pxp_flags
{
    kPXP_CompleteFlag = (0x1U),
    kPXP_Axi0WriteErrorFlag = (0x2U),

    kPXP_Axi0ReadErrorFlag = (0x4U),

    kPXP_CommandLoadFlag = (0x8U),
# 173 "../../libraries/sdk/drives/fsl_pxp.h"
};
# 270 "../../libraries/sdk/drives/fsl_pxp.h"
...
# 419 "../../libraries/sdk/drives/fsl_pxp.h"
...
# 460 "../../libraries/sdk/drives/fsl_pxp.h"
...
# 499 "../../libraries/sdk/drives/fsl_pxp.h"
...
# 1090 "../../libraries/sdk/drives/fsl_pxp.h"
void PXP_Init(PXP_Type *base);
# 1099 "../../libraries/sdk/drives/fsl_pxp.h"
void PXP_Deinit(PXP_Type *base);
# 1108 "../../libraries/sdk/drives/fsl_pxp.h"
void PXP_Reset(PXP_Type *base);
# 1123 "../../libraries/sdk/drives/fsl_pxp.h"
...
static inline void PXP_EnableLcdHandShake(PXP_Type *base, _Bool enable)
{
...
# 1155 "../../libraries/sdk/drives/fsl_pxp.h"
}
# 1170 "../../libraries/sdk/drives/fsl_pxp.h"
static inline void PXP_EnableContinousRun(PXP_Type *base, _Bool enable)
{
    if (enable)
    {
        base->CTRL_SET = (0x10000000U);
    }
    else
    {
        base->CTRL_CLR = (0x10000000U);
    }
}
# 1193 "../../libraries/sdk/drives/fsl_pxp.h"
static inline void PXP_SetProcessBlockSize(PXP_Type *base, pxp_block_size_t size)
{
    base->CTRL = (base->CTRL & ~(0x800000U)) | (((uint32_t)(((uint32_t)(size)) << (23U))) & (0x800000U));
}
# 1255 "../../libraries/sdk/drives/fsl_pxp.h"
static inline uint32_t PXP_GetStatusFlags(PXP_Type *base)
{
    ...
    uint32_t status = base->STAT & ((0x8U) | (0x1U) | (0x4U) |
                                    (0x2U));
...
# 1279 "../../libraries/sdk/drives/fsl_pxp.h"
...
# 1297 "../../libraries/sdk/drives/fsl_pxp.h"
static inline uint8_t PXP_GetAxiErrorId(PXP_Type *base, uint8_t axiIndex)
{
# 1309 "../../libraries/sdk/drives/fsl_pxp.h"
    return (uint8_t)((base->STAT & (0xF0U)) >> (4U));

}
# 1334 "../../libraries/sdk/drives/fsl_pxp.h"
...
# 1352 "../../libraries/sdk/drives/fsl_pxp.h"
...
# 1374 "../../libraries/sdk/drives/fsl_pxp.h"
...
# 1452 "../../libraries/sdk/drives/fsl_pxp.h"
...
static inline void PXP_EnableAlphaSurfaceOverlayColorKey(PXP_Type *base, _Bool enable)
{
    if (enable)
    {
        base->AS_CTRL |= (0x8U);
...
# 1482 "../../libraries/sdk/drives/fsl_pxp.h"
...
# 1523 "../../libraries/sdk/drives/fsl_pxp.h"
...
# 1629 "../../libraries/sdk/drives/fsl_pxp.h"
void PXP_SetOutputBufferConfig(PXP_Type *base, const pxp_output_buffer_config_t *config);
# 1640 "../../libraries/sdk/drives/fsl_pxp.h"
static inline void PXP_SetOverwrittenAlphaValue(PXP_Type *base, uint8_t alpha)
{
    base->OUT_CTRL = (base->OUT_CTRL & ~(0xFF000000U)) | (((uint32_t)(((uint32_t)(alpha)) << (24U))) & (0xFF000000U));
}
# 1654 "../../libraries/sdk/drives/fsl_pxp.h"
static inline void PXP_EnableOverWrittenAlpha(PXP_Type *base, _Bool enable)
{
    if (enable)
    {
        base->OUT_CTRL_SET = (0x800000U);
    }
    else
    {
        base->OUT_CTRL_CLR = (0x800000U);
    }
}
# 1690 "../../libraries/sdk/drives/fsl_pxp.h"
                                       ...
                                       pxp_flip_mode_t flipMode)
{
    ...
    base->CTRL =
        (base->CTRL & ~((0x300U) | (0x400000U) | (0x800U) | (0x400U))) |
        (((uint32_t)(((uint32_t)(degree)) << (8U))) & (0x300U)) | (((uint32_t)(((uint32_t)(position)) << (22U))) & (0x400000U)) | ((uint32_t)flipMode << (10U));
# 1715 "../../libraries/sdk/drives/fsl_pxp.h"
}
# 1728 "../../libraries/sdk/drives/fsl_pxp.h"
void PXP_BuildRect(PXP_Type *base,
                   ...
                   uint16_t pitch,
                   uint32_t outAddr);
# 1786 "../../libraries/sdk/drives/fsl_pxp.h"
...
static inline _Bool PXP_IsNextCommandPending(PXP_Type *base)
{
    return (_Bool)(base->NEXT & (0x1U));
}
...
static inline void PXP_CancelNextCommand(PXP_Type *base)
{
    ...
    regAddr += 8U;
    *(uint32_t *)regAddr = (0x1U);
}
# 1861 "../../libraries/sdk/drives/fsl_pxp.h"
...
static inline void PXP_EnableCsc1(PXP_Type *base, _Bool enable)
{
    if (enable)
    {
        base->CSC1_COEF0 &= ~(0x40000000U);
    }
    else
    {
        base->CSC1_COEF0 |= (0x40000000U);
...
# 97 "../../libraries/sdk/drives/fsl_pxp.c"
static uint32_t PXP_GetInstance(PXP_Type *base);
# 129 "../../libraries/sdk/drives/fsl_pxp.c"
...
# 150 "../../libraries/sdk/drives/fsl_pxp.c"
...
static PXP_Type *const s_pxpBases[] = { ((PXP_Type *)(0x402B4000u)) };



static const clock_ip_name_t s_pxpClocks[] = { kCLOCK_Pxp };
...
static uint32_t PXP_GetInstance(PXP_Type *base)
{
    ...
    for (instance = 0; instance < (sizeof(s_pxpBases) / sizeof((s_pxpBases)[0])); instance++)
    {
    ...
    ((instance < (sizeof(s_pxpBases) / sizeof((s_pxpBases)[0]))) ? (void)0 : __aeabi_assert("instance < ARRAY_SIZE(s_pxpBases)", "../../libraries/sdk/drives/fsl_pxp.c", 186),
# 186 "../../libraries/sdk/drives/fsl_pxp.c"
#pragma clang diagnostic push
# 186 "../../libraries/sdk/drives/fsl_pxp.c"
#pragma clang diagnostic ignored "-Wassume"
# 186 "../../libraries/sdk/drives/fsl_pxp.c"
    (__builtin_assume)((instance < (sizeof(s_pxpBases) / sizeof((s_pxpBases)[0])))?1:0)
# 186 "../../libraries/sdk/drives/fsl_pxp.c"
#pragma clang diagnostic pop
# 186 "../../libraries/sdk/drives/fsl_pxp.c"
    );
...
# 232 "../../libraries/sdk/drives/fsl_pxp.c"
static void PXP_GetScalerParam(uint16_t inputDimension, uint16_t outputDimension, uint8_t *dec, uint32_t *scale)
{
...
static void PXP_ResetToInit(PXP_Type *base)
{
    ...
    PXP_Reset(base);
# 293 "../../libraries/sdk/drives/fsl_pxp.c"
    base->CTRL = ctrl;
}
# 304 "../../libraries/sdk/drives/fsl_pxp.c"
void PXP_Init(PXP_Type *base)
{
...
# 324 "../../libraries/sdk/drives/fsl_pxp.c"
void PXP_Deinit(PXP_Type *base)
{
...
# 339 "../../libraries/sdk/drives/fsl_pxp.c"
void PXP_Reset(PXP_Type *base)
{
    base->CTRL_SET = (0x80000000U);
    base->CTRL_CLR = ((0x80000000U) | (0x40000000U));
}
...
void PXP_SetAlphaSurfaceBufferConfig(PXP_Type *base, const pxp_as_buffer_config_t *config)
{
    ((0 != config) ? (void)0 : __aeabi_assert("NULL != config", "../../libraries/sdk/drives/fsl_pxp.c", 353),
# 353 "../../libraries/sdk/drives/fsl_pxp.c"
#pragma clang diagnostic push
# 353 "../../libraries/sdk/drives/fsl_pxp.c"
#pragma clang diagnostic ignored "-Wassume"
# 353 "../../libraries/sdk/drives/fsl_pxp.c"
...
# 353 "../../libraries/sdk/drives/fsl_pxp.c"
    ...
    base->AS_CTRL = (base->AS_CTRL & ~(0xF0U)) | (((uint32_t)(((uint32_t)(config->pixelFormat)) << (4U))) & (0xF0U));
...
void PXP_SetAlphaSurfaceBlendConfig(PXP_Type *base, const pxp_as_blend_config_t *config)
{
    ((0 != config) ? (void)0 : __aeabi_assert("NULL != config", "../../libraries/sdk/drives/fsl_pxp.c", 369),
# 369 "../../libraries/sdk/drives/fsl_pxp.c"
#pragma clang diagnostic push
# 369 "../../libraries/sdk/drives/fsl_pxp.c"
#pragma clang diagnostic ignored "-Wassume"
# 369 "../../libraries/sdk/drives/fsl_pxp.c"
...
# 369 "../../libraries/sdk/drives/fsl_pxp.c"
    ...
    reg = base->AS_CTRL;
    reg &=
        ~((0x100000U) | (0xF0000U) | (0xFF00U) | (0x6U));
    reg |= ((((uint32_t)(((uint32_t)(config->ropMode)) << (16U))) & (0xF0000U)) | (((uint32_t)(((uint32_t)(config->alpha)) << (8U))) & (0xFF00U)) |
            (((uint32_t)(((uint32_t)(config->alphaMode)) << (1U))) & (0x6U)));
...
# 421 "../../libraries/sdk/drives/fsl_pxp.c"
void PXP_SetAlphaSurfacePosition(
    PXP_Type *base, uint16_t upperLeftX, uint16_t upperLeftY, uint16_t lowerRightX, uint16_t lowerRightY)
{
    base->OUT_AS_ULC = (((uint32_t)(((uint32_t)(upperLeftY)) << (0U))) & (0x3FFFU)) | (((uint32_t)(((uint32_t)(upperLeftX)) << (16U))) & (0x3FFF0000U));
    base->OUT_AS_LRC = (((uint32_t)(((uint32_t)(lowerRightY)) << (0U))) & (0x3FFFU)) | (((uint32_t)(((uint32_t)(lowerRightX)) << (16U))) & (0x3FFF0000U));
}
# 479 "../../libraries/sdk/drives/fsl_pxp.c"
void PXP_SetAlphaSurfaceOverlayColorKey(PXP_Type *base, uint32_t colorKeyLow, uint32_t colorKeyHigh)
{
    base->AS_CLRKEYLOW = colorKeyLow;
    base->AS_CLRKEYHIGH = colorKeyHigh;
}
# 492 "../../libraries/sdk/drives/fsl_pxp.c"
void PXP_SetProcessSurfaceBufferConfig(PXP_Type *base, const pxp_ps_buffer_config_t *config)
{
    ((0 != config) ? (void)0 : __aeabi_assert("NULL != config", "../../libraries/sdk/drives/fsl_pxp.c", 494),
# 494 "../../libraries/sdk/drives/fsl_pxp.c"
#pragma clang diagnostic push
# 494 "../../libraries/sdk/drives/fsl_pxp.c"
#pragma clang diagnostic ignored "-Wassume"
# 494 "../../libraries/sdk/drives/fsl_pxp.c"
...
# 494 "../../libraries/sdk/drives/fsl_pxp.c"
    ...
    base->PS_CTRL = ((base->PS_CTRL & ~((0x3FU) | (0x40U))) |
                     (((uint32_t)(((uint32_t)(config->pixelFormat)) << (0U))) & (0x3FU)) | (((uint32_t)(((uint32_t)(config->swapByte)) << (6U))) & (0x40U)));
...
# 516 "../../libraries/sdk/drives/fsl_pxp.c"
void PXP_SetProcessSurfaceScaler(
    PXP_Type *base, uint16_t inputWidth, uint16_t inputHeight, uint16_t outputWidth, uint16_t outputHeight)
{
    uint8_t decX, decY;
    ...
    base->PS_CTRL = (base->PS_CTRL & ~((0xC00U) | (0x300U))) | (((uint32_t)(((uint32_t)(decX)) << (10U))) & (0xC00U)) |
                    (((uint32_t)(((uint32_t)(decY)) << (8U))) & (0x300U));

    base->PS_SCALE = (((uint32_t)(((uint32_t)(scaleX)) << (0U))) & (0x7FFFU)) | (((uint32_t)(((uint32_t)(scaleY)) << (16U))) & (0x7FFF0000U));
}
# 540 "../../libraries/sdk/drives/fsl_pxp.c"
void PXP_SetProcessSurfacePosition(
    PXP_Type *base, uint16_t upperLeftX, uint16_t upperLeftY, uint16_t lowerRightX, uint16_t lowerRightY)
{
    base->OUT_PS_ULC = (((uint32_t)(((uint32_t)(upperLeftY)) << (0U))) & (0x3FFFU)) | (((uint32_t)(((uint32_t)(upperLeftX)) << (16U))) & (0x3FFF0000U));
    base->OUT_PS_LRC = (((uint32_t)(((uint32_t)(lowerRightY)) << (0U))) & (0x3FFFU)) | (((uint32_t)(((uint32_t)(lowerRightX)) << (16U))) & (0x3FFF0000U));
}
# 590 "../../libraries/sdk/drives/fsl_pxp.c"
void PXP_SetProcessSurfaceColorKey(PXP_Type *base, uint32_t colorKeyLow, uint32_t colorKeyHigh)
{
    base->PS_CLRKEYLOW = colorKeyLow;
    base->PS_CLRKEYHIGH = colorKeyHigh;
}
# 603 "../../libraries/sdk/drives/fsl_pxp.c"
void PXP_SetOutputBufferConfig(PXP_Type *base, const pxp_output_buffer_config_t *config)
{
    ((0 != config) ? (void)0 : __aeabi_assert("NULL != config", "../../libraries/sdk/drives/fsl_pxp.c", 605),
# 605 "../../libraries/sdk/drives/fsl_pxp.c"
#pragma clang diagnostic push
# 605 "../../libraries/sdk/drives/fsl_pxp.c"
#pragma clang diagnostic ignored "-Wassume"
# 605 "../../libraries/sdk/drives/fsl_pxp.c"
...
# 605 "../../libraries/sdk/drives/fsl_pxp.c"
    ...
    base->OUT_CTRL = (base->OUT_CTRL & ~((0x1FU) | (0x300U))) |
                     (((uint32_t)(((uint32_t)(config->pixelFormat)) << (0U))) & (0x1FU)) | (((uint32_t)(((uint32_t)(config->interlacedMode)) << (8U))) & (0x300U));

    base->OUT_BUF = (config->buffer0Addr);
    base->OUT_BUF2 = (config->buffer1Addr);

    base->OUT_PITCH = config->pitchBytes;
    base->OUT_LRC = (((uint32_t)(((uint32_t)((uint32_t)config->height - 1U)) << (0U))) & (0x3FFFU)) | (((uint32_t)(((uint32_t)((uint32_t)config->width - 1U)) << (16U))) & (0x3FFF0000U));
# 624 "../../libraries/sdk/drives/fsl_pxp.c"
}
# 637 "../../libraries/sdk/drives/fsl_pxp.c"
void PXP_BuildRect(PXP_Type *base,
                   pxp_output_pixel_format_t outFormat,
                   uint32_t value,
                   uint16_t width,
                   ...
                   uint32_t outAddr)
{
    ...
    (((uint8_t)outFormat <= (uint8_t)kPXP_OutputPixelFormatRGB565) ? (void)0 : __aeabi_assert("(uint8_t)outFormat <= (uint8_t)kPXP_OutputPixelFormatRGB565", "../../libraries/sdk/drives/fsl_pxp.c", 646),
# 646 "../../libraries/sdk/drives/fsl_pxp.c"
#pragma clang diagnostic push
# 646 "../../libraries/sdk/drives/fsl_pxp.c"
#pragma clang diagnostic ignored "-Wassume"
# 646 "../../libraries/sdk/drives/fsl_pxp.c"
    (__builtin_assume)(((uint8_t)outFormat <= (uint8_t)kPXP_OutputPixelFormatRGB565)?1:0)
# 646 "../../libraries/sdk/drives/fsl_pxp.c"
#pragma clang diagnostic pop
# 646 "../../libraries/sdk/drives/fsl_pxp.c"
    );
        ...
        (outFormat == kPXP_OutputPixelFormatARGB4444))
    {
        ...
        pxp_as_blend_config_t asBlendConfig = {
            .alpha = alpha, .invertAlpha = 0, .alphaMode = kPXP_AlphaOverride, .ropMode = kPXP_RopMergeAs};
        ...
        PXP_EnableAlphaSurfaceOverlayColorKey(base, 1);
    ...
    PXP_EnableCsc1(base, 0);
# 709 "../../libraries/sdk/drives/fsl_pxp.c"
...
# 738 "../../libraries/sdk/drives/fsl_pxp.c"
void PXP_SetNextCommand(PXP_Type *base, void *commandAddr)
{
    ...
    base->NEXT = (addr.u32) & (0xFFFFFFFCU);
}
# 806 "../../libraries/sdk/drives/fsl_pxp.c"
void PXP_SetCsc1Mode(PXP_Type *base, pxp_csc1_mode_t mode)
{
# 816 "../../libraries/sdk/drives/fsl_pxp.c"
    if (kPXP_Csc1YUV2RGB == mode)
    {
        base->CSC1_COEF0 = (base->CSC1_COEF0 & ~((0x1FFC0000U) | (0x1FFU) |
                                                 (0x3FE00U) | (0x80000000U))) |
                           (((uint32_t)(((uint32_t)(0x100U)) << (18U))) & (0x1FFC0000U))
                           | (((uint32_t)(((uint32_t)(0x0U)) << (0U))) & (0x1FFU))
                           | (((uint32_t)(((uint32_t)(0x0U)) << (9U))) & (0x3FE00U));
        base->CSC1_COEF1 = (((uint32_t)(((uint32_t)(0x0123U)) << (16U))) & (0x7FF0000U))
                           | (((uint32_t)(((uint32_t)(0x0208U)) << (0U))) & (0x7FFU));
        base->CSC1_COEF2 = (((uint32_t)(((uint32_t)(0x076BU)) << (16U))) & (0x7FF0000U))
                           | (((uint32_t)(((uint32_t)(0x079BU)) << (0U))) & (0x7FFU));
    }
    else
    {
        base->CSC1_COEF0 = (base->CSC1_COEF0 &
                            ~((0x1FFC0000U) | (0x1FFU) | (0x3FE00U))) |
                           (0x80000000U) | (((uint32_t)(((uint32_t)(0x12AU)) << (18U))) & (0x1FFC0000U))
                           | (((uint32_t)(((uint32_t)(0x1F0U)) << (0U))) & (0x1FFU))
                           | (((uint32_t)(((uint32_t)(0x180U)) << (9U))) & (0x3FE00U));
        base->CSC1_COEF1 = (((uint32_t)(((uint32_t)(0x0198U)) << (16U))) & (0x7FF0000U))
                           | (((uint32_t)(((uint32_t)(0x0204U)) << (0U))) & (0x7FFU));
        base->CSC1_COEF2 = (((uint32_t)(((uint32_t)(0x0730U)) << (16U))) & (0x7FF0000U))
                           | (((uint32_t)(((uint32_t)(0x079CU)) << (0U))) & (0x7FFU));
    }
}
# 1048 "../../libraries/sdk/drives/fsl_pxp.c"
void PXP_SetPorterDuffConfig(PXP_Type *base, const pxp_porter_duff_config_t *config)
{
    ((0 != config) ? (void)0 : __aeabi_assert("NULL != config", "../../libraries/sdk/drives/fsl_pxp.c", 1050),
# 1050 "../../libraries/sdk/drives/fsl_pxp.c"
#pragma clang diagnostic push
# 1050 "../../libraries/sdk/drives/fsl_pxp.c"
#pragma clang diagnostic ignored "-Wassume"
# 1050 "../../libraries/sdk/drives/fsl_pxp.c"
...
# 1074 "../../libraries/sdk/drives/fsl_pxp.c"
status_t PXP_GetPorterDuffConfig(pxp_porter_duff_blend_mode_t mode, pxp_porter_duff_config_t *config)
{
    status_t status;
    ...
    static const uint32_t pdCtrl[] = {
        ...
        (0x1U) | (((uint32_t)(((uint32_t)(kPXP_PorterDuffFactorOne)) << (1U))) & (0x6U)) |
            (((uint32_t)(((uint32_t)(kPXP_PorterDuffFactorZero)) << (8U))) & (0x300U)),


        (0x1U) | (((uint32_t)(((uint32_t)(kPXP_PorterDuffFactorStraight)) << (1U))) & (0x6U)) |
            (((uint32_t)(((uint32_t)(kPXP_PorterDuffFactorInversed)) << (8U))) & (0x300U)),
        ...
        (0x1U) | (((uint32_t)(((uint32_t)(kPXP_PorterDuffFactorInversed)) << (1U))) & (0x6U)) |
            (((uint32_t)(((uint32_t)(kPXP_PorterDuffFactorZero)) << (8U))) & (0x300U)),


        (0x1U) | (((uint32_t)(((uint32_t)(kPXP_PorterDuffFactorZero)) << (1U))) & (0x6U)) |
            (((uint32_t)(((uint32_t)(kPXP_PorterDuffFactorOne)) << (8U))) & (0x300U)),


        (0x1U) | (((uint32_t)(((uint32_t)(kPXP_PorterDuffFactorInversed)) << (1U))) & (0x6U)) |
            (((uint32_t)(((uint32_t)(kPXP_PorterDuffFactorStraight)) << (8U))) & (0x300U)),
    ...
    {
        pdConfig.u32 = pdCtrl[(uint32_t)mode] | (((uint32_t)(((uint32_t)(kPXP_PorterDuffLocalAlpha)) << (3U))) & (0x18U)) |
                       (((uint32_t)(((uint32_t)(kPXP_PorterDuffLocalAlpha)) << (10U))) & (0xC00U)) | (((uint32_t)(((uint32_t)(kPXP_PorterDuffColorWithAlpha)) << (6U))) & (0x40U)) |
                       (((uint32_t)(((uint32_t)(kPXP_PorterDuffColorWithAlpha)) << (13U))) & (0x2000U)) | (((uint32_t)(((uint32_t)(kPXP_PorterDuffAlphaStraight)) << (5U))) & (0x20U)) |
                       (((uint32_t)(((uint32_t)(kPXP_PorterDuffAlphaStraight)) << (12U))) & (0x1000U));
                              ...
                              pxp_as_pixel_format_t pixelFormat)
{
    ...
    const pxp_as_blend_config_t asBlendConfig = {
        .alpha = 0U, .invertAlpha = 0, .alphaMode = kPXP_AlphaRop, .ropMode = kPXP_RopMergeAs};
...
# 1221 "../../libraries/sdk/drives/fsl_pxp.c"
status_t PXP_StartPictureCopy(PXP_Type *base, const pxp_pic_copy_config_t *config)
{
...
# 1261 "../../libraries/sdk/drives/fsl_pxp.c"
status_t PXP_StartMemCopy(PXP_Type *base, uint32_t srcAddr, uint32_t destAddr, uint32_t size)
{
    uint16_t pitchBytes;
    uint32_t height;
...
# 1304 "../../libraries/sdk/drives/fsl_pxp.c"
status_t PXP_MemCopy(PXP_Type *base, uint32_t srcAddr, uint32_t destAddr, uint32_t size)
{
    uint16_t pitchBytes;
    uint32_t height;
