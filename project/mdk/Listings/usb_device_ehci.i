# 1 "../../libraries/components/usb/device/usb_device_ehci.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/components/usb/device/usb_device_ehci.c" 2
...
# 1 "../../libraries/components/usb/usb_cdc_adapter\\usb_device_config.h" 1
# 10 "../../libraries/components/usb/device/usb_device_ehci.c" 2
...
# 11 "../../libraries/components/usb/device/usb_device_ehci.c" 2
# 1 "../../libraries/components/usb/include\\usb.h" 1
# 13 "../../libraries/components/usb/include\\usb.h"
...
# 14 "../../libraries/components/usb/include\\usb.h" 2
...
# 15 "../../libraries/components/usb/include\\usb.h" 2
...
# 16 "../../libraries/components/usb/include\\usb.h" 2
# 1 "../../libraries/components/usb/include/usb_misc.h" 1
# 37 "../../libraries/components/usb/include/usb_misc.h"
extern int DbgConsole_Printf(const char *fmt_s, ...);
# 17 "../../libraries/components/usb/include\\usb.h" 2
# 1 "../../libraries/components/usb/include/usb_spec.h" 1
# 23 "../../libraries/components/usb/include/usb_spec.h"
...
# 179 "../../libraries/components/usb/include/usb_spec.h"
...
# 18 "../../libraries/components/usb/include\\usb.h" 2
# 48 "../../libraries/components/usb/include\\usb.h"
...
# 12 "../../libraries/components/usb/device/usb_device_ehci.c" 2
# 1 "../../libraries/components/usb/device/usb_device.h" 1
# 24 "../../libraries/components/usb/device/usb_device.h"
...
# 107 "../../libraries/components/usb/device/usb_device.h"
...
# 162 "../../libraries/components/usb/device/usb_device.h"
typedef usb_status_t (*usb_device_endpoint_callback_t)(usb_device_handle handle,
                                                       usb_device_endpoint_callback_message_struct_t *message,
                                                       void *callbackParam);
# 178 "../../libraries/components/usb/device/usb_device.h"
...
typedef usb_status_t (*usb_device_controller_init_t)(uint8_t controllerId,
                                                     usb_device_handle handle,
                                                     usb_device_handle *controllerHandle);


typedef usb_status_t (*usb_device_controller_deinit_t)(usb_device_handle controllerHandle);


typedef usb_status_t (*usb_device_controller_send_t)(usb_device_handle controllerHandle,
                                                     uint8_t endpointAddress,
                                                     uint8_t *buffer,
                                                     uint32_t length);


typedef usb_status_t (*usb_device_controller_recv_t)(usb_device_handle controllerHandle,
                                                     uint8_t endpointAddress,
                                                     uint8_t *buffer,
                                                     uint32_t length);


typedef usb_status_t (*usb_device_controller_cancel_t)(usb_device_handle controllerHandle,
                                                       uint8_t endpointAddress);


typedef usb_status_t (*usb_device_controller_control_t)(usb_device_handle controllerHandle,
...
# 167 "../../libraries/components/usb/device/usb_device_dci.h"
usb_status_t USB_DeviceNotificationTrigger(void *handle, void *msg);
# 16 "../../libraries/components/usb/device/usb_device_ehci.c" 2

# 1 "../../libraries/components/usb/device/usb_device_ehci.h" 1
# 61 "../../libraries/components/usb/device/usb_device_ehci.h"
...
# 157 "../../libraries/components/usb/device/usb_device_ehci.h"
...
# 196 "../../libraries/components/usb/device/usb_device_ehci.h"
usb_status_t USB_DeviceEhciInit(uint8_t controllerId,
                                usb_device_handle handle,
                                usb_device_handle *ehciHandle);
# 209 "../../libraries/components/usb/device/usb_device_ehci.h"
usb_status_t USB_DeviceEhciDeinit(usb_device_handle ehciHandle);
# 233 "../../libraries/components/usb/device/usb_device_ehci.h"
usb_status_t USB_DeviceEhciSend(usb_device_handle ehciHandle,
                                uint8_t endpointAddress,
                                uint8_t *buffer,
                                uint32_t length);
# 258 "../../libraries/components/usb/device/usb_device_ehci.h"
usb_status_t USB_DeviceEhciRecv(usb_device_handle ehciHandle,
                                uint8_t endpointAddress,
                                uint8_t *buffer,
                                uint32_t length);
# 273 "../../libraries/components/usb/device/usb_device_ehci.h"
usb_status_t USB_DeviceEhciCancel(usb_device_handle ehciHandle, uint8_t ep);
# 286 "../../libraries/components/usb/device/usb_device_ehci.h"
usb_status_t USB_DeviceEhciControl(usb_device_handle ehciHandle,
                                   usb_device_control_type_t type,
                                   void *param);
# 18 "../../libraries/components/usb/device/usb_device_ehci.c" 2
# 43 "../../libraries/components/usb/device/usb_device_ehci.c"
...
__attribute__((aligned(2048)))
                    static uint8_t qh_buffer[((1U) - 1) * 2048 +
                                             2 * (4U) * 2 * sizeof(usb_device_ehci_qh_struct_t)];


__attribute__((aligned(32)))
                    static usb_device_ehci_dtd_struct_t s_UsbDeviceEhciDtd[(1U)]
                                                                          [(16U)];


static usb_device_ehci_state_struct_t g_UsbDeviceEhciState[(1U)];



static uint8_t g_UsbDeviceEhciStateStatus[(1U)] = {0};
# 145 "../../libraries/components/usb/device/usb_device_ehci.c"
static void USB_DeviceEhciSetDefaultState(usb_device_ehci_state_struct_t *ehciState)
{
    ...
    p->nextDtdPointer = 0U;
    ehciState->dtdCount = (16U);


    ehciState->registerBase->USBCMD &= ~(0xFF0000U);
    ehciState->registerBase->USBCMD |= (((uint32_t)(((uint32_t)(0U)) << (16U))) & (0xFF0000U));


    ehciState->registerBase->USBMODE |= (0x8U);





    ehciState->registerBase->USBMODE &= ~(0x4U);


    for (uint32_t i = 0U; i < ((4U) * 2U); i++)
    {
        ehciState->qh[i].nextDtdPointer = (0x00000001U);
        ehciState->qh[i].capabilttiesCharacteristicsUnion.capabilttiesCharacteristicsBitmap.maxPacketSize =
            (64U);
        ehciState->dtdHard[i] = 0;
        ehciState->dtdTail[i] = 0;
        ehciState->qh[i].endpointStatusUnion.endpointStatusBitmap.isOpened = 0U;
    }


    ehciState->registerBase->ENDPTLISTADDR = (uint32_t)ehciState->qh;
...
# 216 "../../libraries/components/usb/device/usb_device_ehci.c"
static usb_status_t USB_DeviceEhciEndpointInit(usb_device_ehci_state_struct_t *ehciState,
                                               usb_device_endpoint_init_struct_t *epInit)
{
    uint32_t primeBit = 1UL << ((epInit->endpointAddress & (0x0FU)) +
                                ((epInit->endpointAddress & (0x80U)) >> 0x03U));
    uint16_t maxPacketSize = epInit->maxPacketSize & (0x07FFu);
    uint8_t endpoint = (epInit->endpointAddress & (0x0FU));
    uint8_t direction = (epInit->endpointAddress & (0x80U)) >>
                        (7U);
    uint8_t index = ((uint8_t)((uint32_t)endpoint << 1U)) | direction;
    uint8_t transferType = epInit->transferType & (0x03U);
# 235 "../../libraries/components/usb/device/usb_device_ehci.c"
    (void)USB_DeviceEhciCancel(ehciState, epInit->endpointAddress);


    if ((0U != (ehciState->registerBase->ENDPTPRIME & primeBit)) || (0U != (ehciState->registerBase->ENDPTSTAT & primeBit)))
    {
        return kStatus_USB_Busy;
    }


    if ((0x01U) == transferType)
    {
        ...
        ehciState->qh[index].capabilttiesCharacteristicsUnion.capabilttiesCharacteristicsBitmap.mult =
            1UL + ((((uint32_t)epInit->maxPacketSize) & (0x1800u)) >>
                   (11U));
    }
    else
    {
    ...
    if (((0U) == endpoint))
    {
        ...
        ehciState->registerBase->ENDPTCTRL0 |=
            ((0U != direction) ?
                 ((0x800000U) | (0x400000U) | ((uint32_t)transferType << (18U))) :
                 ((0x80U) | (0x40U) | ((uint32_t)transferType << (2U))));
    }
    else
    {
        ehciState->qh[index].capabilttiesCharacteristicsUnion.capabilttiesCharacteristicsBitmap.ios = 0U;
        ehciState->registerBase->ENDPTCTRL[endpoint - 1U] |=
            ((0U != direction) ?
                 ((0x800000U) | (0x400000U) | ((uint32_t)transferType << (18U))) :
                 ((0x80U) | (0x40U) | ((uint32_t)transferType << (2U))));
    }
...
# 308 "../../libraries/components/usb/device/usb_device_ehci.c"
static usb_status_t USB_DeviceEhciEndpointDeinit(usb_device_ehci_state_struct_t *ehciState, uint8_t ep)
{
    uint32_t primeBit =
        1UL << ((ep & (0x0FU)) + ((ep & (0x80U)) >> 0x03U));
    uint8_t endpoint = (ep & (0x0FU));
    uint8_t direction =
        (ep & (0x80U)) >> (7U);
    uint8_t index = ((uint8_t)((uint32_t)endpoint << 1U)) | direction;

    ehciState->qh[index].endpointStatusUnion.endpointStatusBitmap.isOpened = 0U;
# 326 "../../libraries/components/usb/device/usb_device_ehci.c"
    ...
    {
        ehciState->registerBase->ENDPTCTRL0 &=
            ~((0U != direction) ? ((0x800000U) | (0xC0000U) | (0x10000U)) :
                                  ((0x80U) | (0xCU) | (0x1U)));
    }
    else
    {
...
# 364 "../../libraries/components/usb/device/usb_device_ehci.c"
static usb_status_t USB_DeviceEhciEndpointStall(usb_device_ehci_state_struct_t *ehciState, uint8_t ep)
{
    uint8_t endpoint = ep & (0x0FU);
    uint8_t direction =
    ...
    if (0U == endpoint)
    {
# 380 "../../libraries/components/usb/device/usb_device_ehci.c"
        (void)USB_DeviceEhciCancel(ehciState, 0x00);
        (void)USB_DeviceEhciCancel(ehciState, 0x80);

        ehciState->registerBase->ENDPTCTRL0 |= ((0x10000U) | (0x1U));
    }
    else
    {
        ...
        ehciState->registerBase->ENDPTCTRL[endpoint - 1U] |= ((0U != direction) ? (0x10000U) : (0x1U));
    }

    return kStatus_USB_Success;
}
# 414 "../../libraries/components/usb/device/usb_device_ehci.c"
static usb_status_t USB_DeviceEhciEndpointUnstall(usb_device_ehci_state_struct_t *ehciState, uint8_t ep)
{
    uint8_t endpoint = ep & (0x0FU);
    uint8_t direction =
    ...
    if (0U == endpoint)
    {
        ehciState->registerBase->ENDPTCTRL0 &= ~((0U != direction) ? (0x10000U) : (0x1U));
    }
    else
    {
        ehciState->registerBase->ENDPTCTRL[endpoint - 1U] &=
            ~((0U != direction) ? (0x10000U) : (0x1U));
        ehciState->registerBase->ENDPTCTRL[endpoint - 1U] |= ((0U != direction) ? (0x400000U) : (0x40U));
    }
...
# 453 "../../libraries/components/usb/device/usb_device_ehci.c"
static void USB_DeviceEhciFillSetupBuffer(usb_device_ehci_state_struct_t *ehciState, uint8_t ep)
{
    uint8_t waitingSafelyAccess = 1U;
    uint8_t index = (ep * 2U) | (0U);


    ehciState->registerBase->ENDPTSETUPSTAT = 1UL << ep;

    while (0U != waitingSafelyAccess)
    {

        ehciState->registerBase->USBCMD |= (0x2000U);
        ...
        if (0U != (ehciState->registerBase->USBCMD & (0x2000U)))
        {
...
# 490 "../../libraries/components/usb/device/usb_device_ehci.c"
static void USB_DeviceEhciCancelControlPipe(usb_device_ehci_state_struct_t *ehciState,
                                            uint8_t endpoint,
                                            uint8_t direction)
{
    ...
    currentDtd =
        (usb_device_ehci_dtd_struct_t *)((uint32_t)ehciState->dtdHard[index] & (0xFFFFFFE0U));
    while (0 != currentDtd)
    {
        ...
        if (0 == message.buffer)
        {
            ...
            message.buffer = (uint8_t *)((bufferAddress & (0xFFFFF000U)) |
                                         (currentDtd->reservedUnion.originalBufferInfo.originalBufferOffest));
        }


        if (0U != (currentDtd->dtdTokenUnion.dtdTokenBitmap.status & (0x00000080U)))
        {
            message.length = (0xFFFFFFFFU);
        }
        else
        {
        ...
        {
            ehciState->dtdHard[index] = 0;
            ehciState->dtdTail[index] = 0;
            ehciState->qh[index].nextDtdPointer = (0x00000001U);
        ...
        if ((0U != currentDtd->dtdTokenUnion.dtdTokenBitmap.ioc) ||
            (0U == ((uint32_t)ehciState->dtdHard[index] & (0xFFFFFFE0U))))
        {
            message.code = endpoint | (uint8_t)((uint32_t)direction << 0x07U);
            message.isSetup = 0U;
# 552 "../../libraries/components/usb/device/usb_device_ehci.c"
...
# 579 "../../libraries/components/usb/device/usb_device_ehci.c"
static void USB_DeviceEhciInterruptTokenDone(usb_device_ehci_state_struct_t *ehciState)
{
    uint32_t status;
    uint32_t primeBit;
    ...
    status = ehciState->registerBase->ENDPTSETUPSTAT;
    ...
    if (0U != status)
    {
        for (endpoint = 0U; endpoint < (4U); endpoint++)
        {
            ...
            if (0U != (status & (1UL << endpoint)))
            {
                ...
                temp = (void *)&ehciState->qh[(uint8_t)((uint32_t)endpoint << 1U) + (0U)].setupBufferBack;
                usb_setup_struct_t *deviceSetup = (usb_setup_struct_t *)temp;


                direction = (deviceSetup->bmRequestType & (0x80U)) >> (7U);
                ...
                message.code = (endpoint) | ((0U) << 0x07U);
                message.buffer = (uint8_t *)deviceSetup;
                message.length = (8U);
                message.isSetup = 1U;

                USB_DeviceEhciFillSetupBuffer(ehciState, endpoint);
# 626 "../../libraries/components/usb/device/usb_device_ehci.c"
                (void)USB_DeviceNotificationTrigger(ehciState->deviceHandle, &message);
    ...
    status = ehciState->registerBase->ENDPTCOMPLETE;

    ehciState->registerBase->ENDPTCOMPLETE = status;
            ...
            if (0U != (status & (1UL << count)))
            {
                ...
                while (0 != currentDtd)
                {
                    ...
                    while (0 != currentDtd)
                    {
                        ...
                        if ((0U !=
                             (currentDtd->dtdTokenUnion.dtdTokenBitmap.status & (0x00000080U))) ||
                    ...
                    if ((0U == isTokenDone) && (0 != currentDtd))
                    {
                        break;
                    }
                    ...
                    while (0 != currentDtd)
                    {
                        ...
                        {
                            message.buffer =
                                (uint8_t *)((currentDtd->bufferPointerPage[0] & (0xFFFFF000U)) |
                                            (currentDtd->reservedUnion.originalBufferInfo.originalBufferOffest));
                        }
                            ...
                            (0U == ((uint32_t)ehciState->dtdHard[index] & (0xFFFFFFE0U))))
                        {
                            message.code = endpoint | (uint8_t)((uint32_t)direction << 0x07U);
                            message.isSetup = 0U;
# 757 "../../libraries/components/usb/device/usb_device_ehci.c"
                            (void)USB_DeviceNotificationTrigger(ehciState->deviceHandle, &message);
                        ...
                        if ((0 != currentDtd) && (0U != (currentDtd->dtdTokenUnion.dtdTokenBitmap.status &
                                                            (0x00000080U))))
                        {
                            primeBit = 1UL << (endpoint + 16U * direction);


                            ehciState->registerBase->ENDPTPRIME = primeBit;



                            if (0U == (ehciState->registerBase->ENDPTSTAT & primeBit))
                            {

                                while (0U != (ehciState->registerBase->ENDPTPRIME & primeBit))
                                {
                                }
...
# 813 "../../libraries/components/usb/device/usb_device_ehci.c"
static void USB_DeviceEhciInterruptPortChange(usb_device_ehci_state_struct_t *ehciState)
{
    usb_device_callback_message_struct_t message;

    message.buffer = (uint8_t *)0;
    message.length = 0U;
    message.isSetup = 0U;


    if (0U == (ehciState->registerBase->PORTSC1 & (0x100U)))
    {

        if (0U != (ehciState->registerBase->PORTSC1 & (0x200U)))
        {
            ehciState->speed = (0x02U);
        }
        else
        {
            ehciState->speed = (0x00U);
        }
...
# 846 "../../libraries/components/usb/device/usb_device_ehci.c"
            (void)USB_DeviceNotificationTrigger(ehciState->deviceHandle, &message);

            ehciState->isResetting = 0U;
        }
    }
# 869 "../../libraries/components/usb/device/usb_device_ehci.c"
}
# 879 "../../libraries/components/usb/device/usb_device_ehci.c"
static void USB_DeviceEhciInterruptReset(usb_device_ehci_state_struct_t *ehciState)
{
    uint32_t status = 0U;
    ...
    status = ehciState->registerBase->ENDPTSETUPSTAT;
    ehciState->registerBase->ENDPTSETUPSTAT = status;
    ...
    do
    {
        ...
        ehciState->registerBase->ENDPTFLUSH = (0xFFU) | (0xFF0000U);
    } while (0U != (ehciState->registerBase->ENDPTPRIME & ((0xFFU) | (0xFF0000U))));
    ...
    else
    {
        ...
        message.length = 0U;
        message.isSetup = 0U;
# 916 "../../libraries/components/usb/device/usb_device_ehci.c"
        (void)USB_DeviceNotificationTrigger(ehciState->deviceHandle, &message);

    }
}
# 929 "../../libraries/components/usb/device/usb_device_ehci.c"
static void USB_DeviceEhciInterruptSof(usb_device_ehci_state_struct_t *ehciState)
{
}
# 984 "../../libraries/components/usb/device/usb_device_ehci.c"
static usb_status_t USB_DeviceEhciTransfer(usb_device_ehci_state_struct_t *ehciState,
                                           uint8_t endpointAddress,
                                           uint8_t *buffer,
                                           uint32_t length)
{
    ...
    uint32_t index = (((uint32_t)endpointAddress & (0x0FU)) << 1U) |
                     (((uint32_t)endpointAddress & (0x80U)) >>
                      (7U));
    uint32_t primeBit = 1UL << ((endpointAddress & (0x0FU)) +
                                ((endpointAddress & (0x80U)) >> 0x03U));
    uint32_t epStatus = primeBit;
    uint32_t sendLength;
    uint32_t currentIndex = 0U;
    uint32_t dtdRequestCount = (length + (0x00004000U) - 1U) / (0x00004000U);
    uint8_t qhIdle = 0U;
    uint8_t waitingSafelyAccess = 1U;
    ...
    OSA_EnterCritical(&osaCurrentSr);
    ...
    do
    {
        ...
        if (length > (0x00004000U))
        {
            sendLength = (0x00004000U);
        }
        else
        {
            sendLength = length;
        ...
        dtd->nextDtdPointer = (0x00000001U);
        dtd->dtdTokenUnion.dtdToken = 0U;
        dtd->bufferPointerPage[0] = (uint32_t)(buffer + currentIndex);
        dtd->bufferPointerPage[1] =
            (dtd->bufferPointerPage[0] + (0x00001000U)) & (0xFFFFF000U);
        dtd->bufferPointerPage[2] = dtd->bufferPointerPage[1] + (0x00001000U);
        dtd->bufferPointerPage[3] = dtd->bufferPointerPage[2] + (0x00001000U);
        dtd->bufferPointerPage[4] = dtd->bufferPointerPage[3] + (0x00001000U);
        ...
        dtd->reservedUnion.originalBufferInfo.originalBufferOffest =
            dtd->bufferPointerPage[0] & (0x00000FFFU);
        ...
        dtd->dtdTokenUnion.dtdTokenBitmap.status = (0x00000080U);


        currentIndex += sendLength;


        if (0 != (ehciState->dtdTail[index]))
        {
    ...
    if (((0U) == (endpointAddress & (0x0FU))) &&
        ((1U) == ((endpointAddress & (0x80U)) >>
                    (7U))))
    {
        uint8_t setupindex = ((endpointAddress & (0x0FU)) * 2U);
    ...
    if (0U == qhIdle)
    {
        ...
        if (0U != (ehciState->registerBase->ENDPTPRIME & primeBit))
        {
            OSA_ExitCritical(osaCurrentSr);
            return kStatus_USB_Success;
        }
        ...
        while (0U != waitingSafelyAccess)
        {
            ...
            ehciState->registerBase->USBCMD |= (0x4000U);

            epStatus = ehciState->registerBase->ENDPTSTAT;

            if (0U != (ehciState->registerBase->USBCMD & (0x4000U)))
            {
                waitingSafelyAccess = 0U;
            }
        }
    ...
    if ((0U != qhIdle) || (0U == (epStatus & primeBit)))
    {
        ...
        __builtin_arm_dsb(0xF);
        ehciState->registerBase->ENDPTPRIME = primeBit;
        while (0U == (ehciState->registerBase->ENDPTSTAT & primeBit))
        {
            primeTimesCount++;
            if (primeTimesCount == (10000000U))
            {
                OSA_ExitCritical(osaCurrentSr);
                return kStatus_USB_Error;
            }
            if (0U != (ehciState->registerBase->ENDPTCOMPLETE & primeBit))
            {
                break;
            }
            else
...
# 1191 "../../libraries/components/usb/device/usb_device_ehci.c"
static void *USB_EhciGetValidEhciState(uint8_t *instanceIndex)
{
    for (uint8_t instance = 0; instance < (1U); instance++)
    {
...
# 1290 "../../libraries/components/usb/device/usb_device_ehci.c"
usb_status_t USB_DeviceEhciInit(uint8_t controllerId,
                                usb_device_handle handle,
                                usb_device_handle *ehciHandle)
{
    usb_device_ehci_state_struct_t *ehciState = 0;
    uint32_t ehci_base[] = { (0x402E0000u), (0x402E0200u) };
    ...
    void *temp;
# 1324 "../../libraries/components/usb/device/usb_device_ehci.c"
    ...
    ehciState->registerBase = (USB_Type *)ehci_base[controllerId - (uint8_t)kUSB_ControllerEhci0];
# 1354 "../../libraries/components/usb/device/usb_device_ehci.c"
    ehciState->registerBase->USBCMD |= (0x2U);
    while (0U != (ehciState->registerBase->USBCMD & (0x2U)))
    {
    }


    ehciState->endpointCount =
        (uint8_t)((ehciState->registerBase->DCCPARAMS & (0x1FU)) >> (0U));

    if (ehciState->endpointCount < (4U))
    {
        return kStatus_USB_Error;
    }
    ...
    ehciState->registerBase->USBMODE &= ~(0x3U);
    ehciState->registerBase->USBMODE |= (((uint32_t)(((uint32_t)(0x02U)) << (0U))) & (0x3U));


    USB_DeviceEhciSetDefaultState(ehciState);
    *ehciHandle = (usb_device_handle)ehciState;
# 1434 "../../libraries/components/usb/device/usb_device_ehci.c"
    return kStatus_USB_Success;
}
# 1446 "../../libraries/components/usb/device/usb_device_ehci.c"
usb_status_t USB_DeviceEhciDeinit(usb_device_handle ehciHandle)
{
    ...
    ehciState->registerBase->USBCMD &= ~(0x1U);

    ehciState->registerBase->USBCMD |= (0x2U);
# 1491 "../../libraries/components/usb/device/usb_device_ehci.c"
    return kStatus_USB_Success;
}
# 1514 "../../libraries/components/usb/device/usb_device_ehci.c"
usb_status_t USB_DeviceEhciSend(usb_device_handle ehciHandle,
                                uint8_t endpointAddress,
                                uint8_t *buffer,
                                uint32_t length)
{
    ...
    return USB_DeviceEhciTransfer(
        ...
        (endpointAddress & (0x0FU)) | ((1U) << (7U)),
        buffer, length);
}
# 1546 "../../libraries/components/usb/device/usb_device_ehci.c"
usb_status_t USB_DeviceEhciRecv(usb_device_handle ehciHandle,
                                uint8_t endpointAddress,
                                uint8_t *buffer,
                                uint32_t length)
{
    ...
    return USB_DeviceEhciTransfer(
        (usb_device_ehci_state_struct_t *)ehciHandle,
        (endpointAddress & (0x0FU)) | ((0U) << (7U)),
        buffer, length);
}
# 1568 "../../libraries/components/usb/device/usb_device_ehci.c"
usb_status_t USB_DeviceEhciCancel(usb_device_handle ehciHandle, uint8_t ep)
{
    usb_device_ehci_state_struct_t *ehciState = (usb_device_ehci_state_struct_t *)ehciHandle;
    usb_device_callback_message_struct_t message;
    ...
    while (0 != currentDtd)
    {
        ...
        currentDtd = (usb_device_ehci_dtd_struct_t *)(currentDtd->nextDtdPointer & (0xFFFFFFE0U));
    }
        ...
        else
        {
            if (0U != (currentDtd->dtdTokenUnion.dtdTokenBitmap.status & (0x00000080U)))
            {
                ...
                do
                {
                    ...
                    ehciState->registerBase->ENDPTFLUSH |= primeBit;


                    while (0U != (ehciState->registerBase->ENDPTFLUSH & primeBit))
                    {
                    }
            ...
            if (0 == message.buffer)
            {
                message.buffer = (uint8_t *)((currentDtd->bufferPointerPage[0] & (0xFFFFF000U)) |
                                             (currentDtd->reservedUnion.originalBufferInfo.originalBufferOffest));
            }
...
# 1710 "../../libraries/components/usb/device/usb_device_ehci.c"
usb_status_t USB_DeviceEhciControl(usb_device_handle ehciHandle, usb_device_control_type_t type, void *param)
{
    usb_device_ehci_state_struct_t *ehciState = (usb_device_ehci_state_struct_t *)ehciHandle;
    ...
    uint16_t *temp16;
    uint8_t *temp8;
# 1729 "../../libraries/components/usb/device/usb_device_ehci.c"
    if (0 == ehciHandle)
    {
        return kStatus_USB_InvalidHandle;
    }
    ...
    switch (type)
    {
        ...
        case kUSB_DeviceControlGetEndpointStatus:
            if (0 != param)
            {
                ...
                uint8_t ep = (endpointStatus->endpointAddress) & (0x0FU);
                uint8_t direction =
                    ((endpointStatus->endpointAddress) & (0x80U)) >>
                    (7U);
                ...
                if (ep < (4U))
                {
                    if (0U != ep)
                    {
                        endpointStatus->endpointStatus =
                            (0U != (ehciState->registerBase->ENDPTCTRL[ep - 1U] &
                                    ((0U != direction) ? (0x10000U) : (0x1U)))) ?
                    ...
                    {
                        endpointStatus->endpointStatus =
                            (0U != (ehciState->registerBase->ENDPTCTRL0 &
                                    ((0U != direction) ? (0x10000U) : (0x1U)))) ?
                                (uint16_t)kUSB_DeviceEndpointStateStalled :
                                (uint16_t)kUSB_DeviceEndpointStateIdle;
                    }
        ...
        case kUSB_DeviceControlGetSynchFrame:
            break;
# 1902 "../../libraries/components/usb/device/usb_device_ehci.c"
        case kUSB_DeviceControlSetDefaultStatus:
            for (uint8_t count = 0U; count < (4U); count++)
            {
                ...
                (void)USB_DeviceEhciEndpointDeinit(ehciState, (count | ((1U) << 0x07U)));
                (void)USB_DeviceEhciEndpointDeinit(ehciState, (count | ((0U) << 0x07U)));
        ...
        case kUSB_DeviceControlSetOtgStatus:
            break;
# 2010 "../../libraries/components/usb/device/usb_device_ehci.c"
        default:
...
# 2026 "../../libraries/components/usb/device/usb_device_ehci.c"
...
# 2179 "../../libraries/components/usb/device/usb_device_ehci.c"
    if (0U != (status & (0x80U)))
    {
