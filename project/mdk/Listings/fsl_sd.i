# 1 "../../libraries/components/sdmmc/sd/fsl_sd.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/components/sdmmc/sd/fsl_sd.c" 2
...
# 12 "../../libraries/components/sdmmc/common\\fsl_sdmmc_common.h"
...
# 13 "../../libraries/components/sdmmc/common\\fsl_sdmmc_common.h" 2
...
# 125 "../../libraries/components/sdmmc/sd/fsl_sd.c"
static status_t SD_SendScr(sd_card_t *card);
# 139 "../../libraries/components/sdmmc/sd/fsl_sd.c"
static status_t SD_SelectFunction(sd_card_t *card, uint32_t group, uint32_t function);
# 151 "../../libraries/components/sdmmc/sd/fsl_sd.c"
...
# 168 "../../libraries/components/sdmmc/sd/fsl_sd.c"
...
{
    ((card != 0) ? (void)0 : __aeabi_assert("card != NULL", "../../libraries/components/sdmmc/sd/fsl_sd.c", 336),
# 336 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 336 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 336 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    (__builtin_assume)((card != 0)?1:0)
# 336 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic pop
# 336 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    );
...
{
    ((card != 0) ? (void)0 : __aeabi_assert("card != NULL", "../../libraries/components/sdmmc/sd/fsl_sd.c", 343),
# 343 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 343 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 343 "../../libraries/components/sdmmc/sd/fsl_sd.c"
...
{
    ((card != 0) ? (void)0 : __aeabi_assert("card != NULL", "../../libraries/components/sdmmc/sd/fsl_sd.c", 350),
# 350 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 350 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 350 "../../libraries/components/sdmmc/sd/fsl_sd.c"
...
{
    ((card != 0) ? (void)0 : __aeabi_assert("card != NULL", "../../libraries/components/sdmmc/sd/fsl_sd.c", 357),
# 357 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 357 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 357 "../../libraries/components/sdmmc/sd/fsl_sd.c"
...
# 357 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    ...
    return SDMMCHOST_ExecuteTuning(card->host, (uint32_t)kSD_SendTuningBlock,
                                   (uint32_t *)(uint32_t)((uint32_t)(card->internalBuffer) + (uint32_t)(32) - ((uint32_t)(card->internalBuffer) & ((uint32_t)(32) - 1U))), 64U);
}

static status_t SD_SwitchIOVoltage(sd_card_t *card, sdmmc_operation_voltage_t voltage)
{
    if ((card->usrParam.ioVoltage != 0) && (card->usrParam.ioVoltage->type == kSD_IOVoltageCtrlByGpio))
    {

        if (card->usrParam.ioVoltage->func != 0)
        {
            card->usrParam.ioVoltage->func(voltage);
        }
    }
    else if ((card->usrParam.ioVoltage != 0) && (card->usrParam.ioVoltage->type == kSD_IOVoltageCtrlByHost))
    {
...
static status_t SD_SwitchVoltage(sd_card_t *card, sdmmc_operation_voltage_t voltage)
{
    ((card != 0) ? (void)0 : __aeabi_assert("card != NULL", "../../libraries/components/sdmmc/sd/fsl_sd.c", 387),
# 387 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 387 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 387 "../../libraries/components/sdmmc/sd/fsl_sd.c"
...
# 387 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    ...
    SDMMCHOST_ForceClockOn(card->host, 1);

    SDMMC_OSADelay(10U);

    SDMMCHOST_ForceClockOn(card->host, 0);
                                                      ...
                                                      (uint32_t)kSDMMC_SignalLineData3) == 0U)
    {
        ...
        SD_SetCardPower(card, 0);
        SD_SetCardPower(card, 1);
...
static status_t SD_StopTransmission(sd_card_t *card)
{
    ((card != 0) ? (void)0 : __aeabi_assert("card != NULL", "../../libraries/components/sdmmc/sd/fsl_sd.c", 459),
# 459 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 459 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 459 "../../libraries/components/sdmmc/sd/fsl_sd.c"
...
# 459 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    ...
    command.responseErrorFlags = ((1UL << (kSDMMC_R1OutOfRangeFlag)) | (1UL << (kSDMMC_R1AddressErrorFlag)) | (1UL << (kSDMMC_R1BlockLengthErrorFlag)) | (1UL << (kSDMMC_R1EraseSequenceErrorFlag)) | (1UL << (kSDMMC_R1EraseParameterErrorFlag)) | (1UL << (kSDMMC_R1WriteProtectViolationFlag)) | (1UL << (kSDMMC_R1CardIsLockedFlag)) | (1UL << (kSDMMC_R1LockUnlockFailedFlag)) | (1UL << (kSDMMC_R1CommandCrcErrorFlag)) | (1UL << (kSDMMC_R1IllegalCommandFlag)) | (1UL << (kSDMMC_R1CardEccFailedFlag)) | (1UL << (kSDMMC_R1CardControllerErrorFlag)) | (1UL << (kSDMMC_R1ErrorFlag)) | (1UL << (kSDMMC_R1CidCsdOverwriteFlag)) | (1UL << (kSDMMC_R1AuthenticationSequenceErrorFlag)));
...
static status_t SD_Transfer(sd_card_t *card, sdmmchost_transfer_t *content, uint32_t retry)
{
    ((content != 0) ? (void)0 : __aeabi_assert("content != NULL", "../../libraries/components/sdmmc/sd/fsl_sd.c", 485),
# 485 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 485 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 485 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    (__builtin_assume)((content != 0)?1:0)
# 485 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic pop
# 485 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    );
    ...
    do
    {
        ...
        if (content->data != 0)
        {
            ...
            error = SD_PollingCardStatusBusy(card, (600U));
...
static status_t SD_SendCardStatus(sd_card_t *card)
{
    ((card != 0) ? (void)0 : __aeabi_assert("card != NULL", "../../libraries/components/sdmmc/sd/fsl_sd.c", 549),
# 549 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 549 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 549 "../../libraries/components/sdmmc/sd/fsl_sd.c"
...
# 549 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    ...
    while (retry != 0U)
    {
        ...
        {
            if (((command.response[0U] & (1UL << (kSDMMC_R1ReadyForDataFlag))) != 0U) &&
                ((((command.response[0U])&0x00001E00U) >> 9U) != (uint32_t)kSDMMC_R1StateProgram))
            {
...
status_t SD_PollingCardStatusBusy(sd_card_t *card, uint32_t timeoutMs)
{
    ((card != 0) ? (void)0 : __aeabi_assert("card != NULL", "../../libraries/components/sdmmc/sd/fsl_sd.c", 591),
# 591 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 591 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 591 "../../libraries/components/sdmmc/sd/fsl_sd.c"
...
static status_t SD_SendWriteSuccessBlocks(sd_card_t *card, uint32_t *blocks)
{
    ((card != 0) ? (void)0 : __aeabi_assert("card != NULL", "../../libraries/components/sdmmc/sd/fsl_sd.c", 622),
# 622 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 622 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 622 "../../libraries/components/sdmmc/sd/fsl_sd.c"
...
# 622 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    ...
    status_t error = kStatus_Success;
    uint32_t *rawBuffer = (uint32_t *)(uint32_t)((uint32_t)(card->internalBuffer) + (uint32_t)(32) - ((uint32_t)(card->internalBuffer) & ((uint32_t)(32) - 1U)));
    ...
    content.data = &data;
    error = SDMMCHOST_TransferFunction(card->host, &content);
    if ((kStatus_Success != error) || (((command.response[0U]) & ((1UL << (kSDMMC_R1OutOfRangeFlag)) | (1UL << (kSDMMC_R1AddressErrorFlag)) | (1UL << (kSDMMC_R1BlockLengthErrorFlag)) | (1UL << (kSDMMC_R1EraseSequenceErrorFlag)) | (1UL << (kSDMMC_R1EraseParameterErrorFlag)) | (1UL << (kSDMMC_R1WriteProtectViolationFlag)) | (1UL << (kSDMMC_R1CardIsLockedFlag)) | (1UL << (kSDMMC_R1LockUnlockFailedFlag)) | (1UL << (kSDMMC_R1CommandCrcErrorFlag)) | (1UL << (kSDMMC_R1IllegalCommandFlag)) | (1UL << (kSDMMC_R1CardEccFailedFlag)) | (1UL << (kSDMMC_R1CardControllerErrorFlag)) | (1UL << (kSDMMC_R1ErrorFlag)) | (1UL << (kSDMMC_R1CidCsdOverwriteFlag)) | (1UL << (kSDMMC_R1AuthenticationSequenceErrorFlag)))) != 0U))
    {
                                                                                                                   ;
    }
    else
    {
        *blocks = (__builtin_bswap32(*rawBuffer));
    }
...
static status_t SD_SendRca(sd_card_t *card)
{
    ((card != 0) ? (void)0 : __aeabi_assert("card != NULL", "../../libraries/components/sdmmc/sd/fsl_sd.c", 668),
# 668 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 668 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 668 "../../libraries/components/sdmmc/sd/fsl_sd.c"
...
static status_t SD_SwitchFunction(sd_card_t *card, uint32_t mode, uint32_t group, uint32_t number, uint32_t *status)
{
    ((card != 0) ? (void)0 : __aeabi_assert("card != NULL", "../../libraries/components/sdmmc/sd/fsl_sd.c", 696),
# 696 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 696 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 696 "../../libraries/components/sdmmc/sd/fsl_sd.c"
...
# 696 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    ...
    ((status != 0) ? (void)0 : __aeabi_assert("status != NULL", "../../libraries/components/sdmmc/sd/fsl_sd.c", 697),
# 697 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 697 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 697 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    (__builtin_assume)((status != 0)?1:0)
# 697 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic pop
# 697 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    );
...
static void SD_DecodeScr(sd_card_t *card, uint32_t *rawScr)
{
    ((card != 0) ? (void)0 : __aeabi_assert("card != NULL", "../../libraries/components/sdmmc/sd/fsl_sd.c", 727),
# 727 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 727 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 727 "../../libraries/components/sdmmc/sd/fsl_sd.c"
...
# 727 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    ...
    ((rawScr != 0) ? (void)0 : __aeabi_assert("rawScr != NULL", "../../libraries/components/sdmmc/sd/fsl_sd.c", 728),
# 728 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 728 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 728 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    (__builtin_assume)((rawScr != 0)?1:0)
# 728 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic pop
# 728 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    );
...
static status_t SD_SendScr(sd_card_t *card)
{
    ((card != 0) ? (void)0 : __aeabi_assert("card != NULL", "../../libraries/components/sdmmc/sd/fsl_sd.c", 788),
# 788 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 788 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 788 "../../libraries/components/sdmmc/sd/fsl_sd.c"
...
# 788 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    ...
    sdmmchost_cmd_t command = {0};
    sdmmchost_data_t data = {0};
    uint32_t *rawScr = (uint32_t *)(uint32_t)((uint32_t)(card->internalBuffer) + (uint32_t)(32) - ((uint32_t)(card->internalBuffer) & ((uint32_t)(32) - 1U)));
    status_t error = kStatus_Success;
...
static status_t SD_SelectFunction(sd_card_t *card, uint32_t group, uint32_t function)
{
    ((card != 0) ? (void)0 : __aeabi_assert("card != NULL", "../../libraries/components/sdmmc/sd/fsl_sd.c", 831),
# 831 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 831 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 831 "../../libraries/components/sdmmc/sd/fsl_sd.c"
...
# 831 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    ...
    uint32_t *functionStatus = (uint32_t *)(uint32_t)((uint32_t)(card->internalBuffer) + (uint32_t)(32) - ((uint32_t)(card->internalBuffer) & ((uint32_t)(32) - 1U)));
...
# 867 "../../libraries/components/sdmmc/sd/fsl_sd.c"
...
static status_t SD_SetDataBusWidth(sd_card_t *card, uint32_t width)
{
    ((card != 0) ? (void)0 : __aeabi_assert("card != NULL", "../../libraries/components/sdmmc/sd/fsl_sd.c", 909),
# 909 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 909 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 909 "../../libraries/components/sdmmc/sd/fsl_sd.c"
...
static void SD_DecodeCsd(sd_card_t *card, uint32_t *rawCsd)
{
    ((card != 0) ? (void)0 : __aeabi_assert("card != NULL", "../../libraries/components/sdmmc/sd/fsl_sd.c", 949),
# 949 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 949 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 949 "../../libraries/components/sdmmc/sd/fsl_sd.c"
...
# 949 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    ...
    ((rawCsd != 0) ? (void)0 : __aeabi_assert("rawCsd != NULL", "../../libraries/components/sdmmc/sd/fsl_sd.c", 950),
# 950 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 950 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 950 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    (__builtin_assume)((rawCsd != 0)?1:0)
# 950 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic pop
# 950 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    );
...
static status_t SD_SendCsd(sd_card_t *card)
{
    ((card != 0) ? (void)0 : __aeabi_assert("card != NULL", "../../libraries/components/sdmmc/sd/fsl_sd.c", 1052),
# 1052 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 1052 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 1052 "../../libraries/components/sdmmc/sd/fsl_sd.c"
...
static void SD_DecodeCid(sd_card_t *card, uint32_t *rawCid)
{
    ((card != 0) ? (void)0 : __aeabi_assert("card != NULL", "../../libraries/components/sdmmc/sd/fsl_sd.c", 1083),
# 1083 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 1083 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 1083 "../../libraries/components/sdmmc/sd/fsl_sd.c"
...
# 1083 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    ...
    ((rawCid != 0) ? (void)0 : __aeabi_assert("rawCid != NULL", "../../libraries/components/sdmmc/sd/fsl_sd.c", 1084),
# 1084 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 1084 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 1084 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    (__builtin_assume)((rawCid != 0)?1:0)
# 1084 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic pop
# 1084 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    );
...
static status_t SD_AllSendCid(sd_card_t *card)
{
    ((card != 0) ? (void)0 : __aeabi_assert("card != NULL", "../../libraries/components/sdmmc/sd/fsl_sd.c", 1108),
# 1108 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 1108 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 1108 "../../libraries/components/sdmmc/sd/fsl_sd.c"
...
static status_t SD_ApplicationSendOperationCondition(sd_card_t *card, uint32_t argument)
{
    ((card != 0) ? (void)0 : __aeabi_assert("card != NULL", "../../libraries/components/sdmmc/sd/fsl_sd.c", 1134),
# 1134 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 1134 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 1134 "../../libraries/components/sdmmc/sd/fsl_sd.c"
...
# 1134 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    ...
    while (0U != i--)
    {
        ...
        if ((command.response[0U] & (1UL << (kSD_OcrPowerUpBusyFlag))) != 0U)
        {

            if ((command.response[0U] & (1UL << (kSD_OcrCardCapacitySupportFlag))) != 0U)
            {
                card->flags |= (uint32_t)kSD_SupportHighCapacityFlag;
            }

            if ((command.response[0U] & (1UL << (kSD_OcrSwitch18AcceptFlag))) != 0U)
            {
...
static status_t SD_SendInterfaceCondition(sd_card_t *card)
{
    ((card != 0) ? (void)0 : __aeabi_assert("card != NULL", "../../libraries/components/sdmmc/sd/fsl_sd.c", 1189),
# 1189 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 1189 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 1189 "../../libraries/components/sdmmc/sd/fsl_sd.c"
...
static status_t SD_SelectBusTiming(sd_card_t *card)
{
    ((card != 0) ? (void)0 : __aeabi_assert("card != NULL", "../../libraries/components/sdmmc/sd/fsl_sd.c", 1228),
# 1228 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 1228 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 1228 "../../libraries/components/sdmmc/sd/fsl_sd.c"
...
# 1228 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    ...
    if (card->operationVoltage != kSDMMC_OperationVoltage180V)
    {
        ...
        if (error == kStatus_Success)
        {
            ...
            card->busClock_Hz =
                SDMMCHOST_SetCardClock(card->host, ((card->usrParam.maxFreq) == 0U ? ((50000000U)) : ((card->usrParam.maxFreq) > ((50000000U)) ? ((50000000U)) : (card->usrParam.maxFreq))));
        }
        else
        {
        ...
        do
        {
                ...
                if ((card->host->capability & (uint32_t)kSDMMCHOST_SupportSDR104) != 0U)
                {
                    ...
                    if (error == kStatus_Success)
                    {
                        ...
                        card->busClock_Hz = SDMMCHOST_SetCardClock(
                            card->host, ((card->usrParam.maxFreq) == 0U ? ((208000000U)) : ((card->usrParam.maxFreq) > ((208000000U)) ? ((208000000U)) : (card->usrParam.maxFreq))));
                        break;
                    }
                }
                                                                       ;
            ...
            if (card->currentTiming == kSD_TimingDDR50Mode)
            {
                ...
                if (error == kStatus_Success)
                {
                    card->currentTiming = kSD_TimingDDR50Mode;
                    card->busClock_Hz = SDMMCHOST_SetCardClock(
                        card->host, ((card->usrParam.maxFreq) == 0U ? ((50000000U)) : ((card->usrParam.maxFreq) > ((50000000U)) ? ((50000000U)) : (card->usrParam.maxFreq))));
                    SDMMCHOST_EnableDDRMode(card->host, 1, 0U);
                    break;
                }
                                                                      ;
            ...
            if (card->currentTiming == kSD_TimingSDR50Mode)
            {
                if ((card->host->capability & (uint32_t)kSDMMCHOST_SupportSDR50) != 0U)
                {
                    ...
                    if (error == kStatus_Success)
                    {
                        card->currentTiming = kSD_TimingSDR50Mode;
                        card->busClock_Hz = SDMMCHOST_SetCardClock(
                            card->host, ((card->usrParam.maxFreq) == 0U ? ((100000000U)) : ((card->usrParam.maxFreq) > ((100000000U)) ? ((100000000U)) : (card->usrParam.maxFreq))));
                        break;
                    }
                }
                                                                      ;
...
static void SD_DecodeStatus(sd_card_t *card, uint32_t *src)
{
    ((card != 0) ? (void)0 : __aeabi_assert("card != NULL", "../../libraries/components/sdmmc/sd/fsl_sd.c", 1355),
# 1355 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 1355 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 1355 "../../libraries/components/sdmmc/sd/fsl_sd.c"
...
# 1355 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    ...
    ((src != 0) ? (void)0 : __aeabi_assert("src != NULL", "../../libraries/components/sdmmc/sd/fsl_sd.c", 1356),
# 1356 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 1356 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 1356 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    (__builtin_assume)((src != 0)?1:0)
# 1356 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic pop
# 1356 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    );

    card->stat.busWidth = (uint8_t)((src[0U] & 0xC0000000U) >> 30U);
    card->stat.secureMode = (uint8_t)((src[0U] & 0x20000000U) >> 29U);
    card->stat.cardType = (uint16_t)((src[0U] & 0x0000FFFFU));
    card->stat.protectedSize = src[1U];
    card->stat.speedClass = (uint8_t)((src[2U] & 0xFF000000U) >> 24U);
    card->stat.performanceMove = (uint8_t)((src[2U] & 0x00FF0000U) >> 16U);
    card->stat.auSize = (uint8_t)((src[2U] & 0x0000F000U) >> 12U);
    card->stat.eraseSize = (uint16_t)(((src[2U] & 0x000000FFU) << 8U) | ((src[3U] & 0xFF000000U) >> 24U));
    card->stat.eraseTimeout = (((uint8_t)((src[3U] & 0x00FF0000U) >> 16U)) & 0xFCU) >> 2U;
    card->stat.eraseOffset = ((uint8_t)((src[3U] & 0x00FF0000U) >> 16U)) & 0x3U;
    card->stat.uhsSpeedGrade = (((uint8_t)((src[3U] & 0x0000FF00U) >> 8U)) & 0xF0U) >> 4U;
    card->stat.uhsAuSize = ((uint8_t)((src[3U] & 0x0000FF00U) >> 8U)) & 0xFU;
}

status_t SD_ReadStatus(sd_card_t *card)
{
    ((card != 0) ? (void)0 : __aeabi_assert("card != NULL", "../../libraries/components/sdmmc/sd/fsl_sd.c", 1374),
# 1374 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 1374 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 1374 "../../libraries/components/sdmmc/sd/fsl_sd.c"
...
# 1374 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    ...
    sdmmchost_data_t data = {0};
    status_t error = kStatus_Success;
    uint32_t *rawPointer = (uint32_t *)(uint32_t)((uint32_t)(card->internalBuffer) + (uint32_t)(32) - ((uint32_t)(card->internalBuffer) & ((uint32_t)(32) - 1U)));
...
status_t SD_SelectCard(sd_card_t *card, _Bool isSelected)
{
    ((card != 0) ? (void)0 : __aeabi_assert("card != NULL", "../../libraries/components/sdmmc/sd/fsl_sd.c", 1421),
# 1421 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 1421 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 1421 "../../libraries/components/sdmmc/sd/fsl_sd.c"
...
status_t SD_SetDriverStrength(sd_card_t *card, sd_driver_strength_t driverStrength)
{
    ((card != 0) ? (void)0 : __aeabi_assert("card != NULL", "../../libraries/components/sdmmc/sd/fsl_sd.c", 1428),
# 1428 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 1428 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 1428 "../../libraries/components/sdmmc/sd/fsl_sd.c"
...
status_t SD_SetMaxCurrent(sd_card_t *card, sd_max_current_t maxCurrent)
{
    ((card != 0) ? (void)0 : __aeabi_assert("card != NULL", "../../libraries/components/sdmmc/sd/fsl_sd.c", 1440),
# 1440 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 1440 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 1440 "../../libraries/components/sdmmc/sd/fsl_sd.c"
...
static status_t SD_Read(sd_card_t *card, uint8_t *buffer, uint32_t startBlock, uint32_t blockSize, uint32_t blockCount)
{
    ((card != 0) ? (void)0 : __aeabi_assert("card != NULL", "../../libraries/components/sdmmc/sd/fsl_sd.c", 1452),
# 1452 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 1452 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 1452 "../../libraries/components/sdmmc/sd/fsl_sd.c"
...
# 1452 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    ...
    ((buffer != 0) ? (void)0 : __aeabi_assert("buffer != NULL", "../../libraries/components/sdmmc/sd/fsl_sd.c", 1453),
# 1453 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 1453 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 1453 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    (__builtin_assume)((buffer != 0)?1:0)
# 1453 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic pop
# 1453 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    );
    ((blockCount != 0U) ? (void)0 : __aeabi_assert("blockCount != 0U", "../../libraries/components/sdmmc/sd/fsl_sd.c", 1454),
# 1454 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 1454 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 1454 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    (__builtin_assume)((blockCount != 0U)?1:0)
# 1454 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic pop
# 1454 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    );
    ((blockSize == (512U)) ? (void)0 : __aeabi_assert("blockSize == FSL_SDMMC_DEFAULT_BLOCK_SIZE", "../../libraries/components/sdmmc/sd/fsl_sd.c", 1455),
# 1455 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 1455 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 1455 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    (__builtin_assume)((blockSize == (512U))?1:0)
# 1455 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic pop
# 1455 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    );
...
static status_t SD_Write(sd_card_t *card,
                         ...
                         uint32_t *writtenBlocks)
{
    ((card != 0) ? (void)0 : __aeabi_assert("card != NULL", "../../libraries/components/sdmmc/sd/fsl_sd.c", 1509),
# 1509 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 1509 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 1509 "../../libraries/components/sdmmc/sd/fsl_sd.c"
...
# 1509 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    ...
    ((buffer != 0) ? (void)0 : __aeabi_assert("buffer != NULL", "../../libraries/components/sdmmc/sd/fsl_sd.c", 1510),
# 1510 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 1510 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 1510 "../../libraries/components/sdmmc/sd/fsl_sd.c"
...
# 1510 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    ...
    ((blockCount != 0U) ? (void)0 : __aeabi_assert("blockCount != 0U", "../../libraries/components/sdmmc/sd/fsl_sd.c", 1511),
# 1511 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 1511 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 1511 "../../libraries/components/sdmmc/sd/fsl_sd.c"
...
# 1511 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    ...
    ((blockSize == (512U)) ? (void)0 : __aeabi_assert("blockSize == FSL_SDMMC_DEFAULT_BLOCK_SIZE", "../../libraries/components/sdmmc/sd/fsl_sd.c", 1512),
# 1512 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 1512 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 1512 "../../libraries/components/sdmmc/sd/fsl_sd.c"
...
static status_t SD_Erase(sd_card_t *card, uint32_t startBlock, uint32_t blockCount, uint32_t timeout)
{
    ((card != 0) ? (void)0 : __aeabi_assert("card != NULL", "../../libraries/components/sdmmc/sd/fsl_sd.c", 1574),
# 1574 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 1574 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 1574 "../../libraries/components/sdmmc/sd/fsl_sd.c"
...
# 1574 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    ...
    ((blockCount != 0U) ? (void)0 : __aeabi_assert("blockCount != 0U", "../../libraries/components/sdmmc/sd/fsl_sd.c", 1575),
# 1575 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 1575 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 1575 "../../libraries/components/sdmmc/sd/fsl_sd.c"
...
# 1575 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    ...
    ((timeout != 0U) ? (void)0 : __aeabi_assert("timeout != 0U", "../../libraries/components/sdmmc/sd/fsl_sd.c", 1576),
# 1576 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 1576 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 1576 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    (__builtin_assume)((timeout != 0U)?1:0)
# 1576 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic pop
# 1576 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    );
    ...
    if (0U == (card->flags & (uint32_t)kSD_SupportHighCapacityFlag))
    {
        eraseBlockStart = eraseBlockStart * (512U);
        eraseBlockEnd = eraseBlockEnd * (512U);
    }
...
_Bool SD_CheckReadOnly(sd_card_t *card)
{
    ((card != 0) ? (void)0 : __aeabi_assert("card != NULL", "../../libraries/components/sdmmc/sd/fsl_sd.c", 1651),
# 1651 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 1651 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 1651 "../../libraries/components/sdmmc/sd/fsl_sd.c"
...
status_t SD_ReadBlocks(sd_card_t *card, uint8_t *buffer, uint32_t startBlock, uint32_t blockCount)
{
    ((card != 0) ? (void)0 : __aeabi_assert("card != NULL", "../../libraries/components/sdmmc/sd/fsl_sd.c", 1659),
# 1659 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 1659 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 1659 "../../libraries/components/sdmmc/sd/fsl_sd.c"
...
# 1659 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    ...
    ((buffer != 0) ? (void)0 : __aeabi_assert("buffer != NULL", "../../libraries/components/sdmmc/sd/fsl_sd.c", 1660),
# 1660 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 1660 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 1660 "../../libraries/components/sdmmc/sd/fsl_sd.c"
...
# 1660 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    ...
    ((blockCount != 0U) ? (void)0 : __aeabi_assert("blockCount != 0U", "../../libraries/components/sdmmc/sd/fsl_sd.c", 1661),
# 1661 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 1661 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 1661 "../../libraries/components/sdmmc/sd/fsl_sd.c"
...
# 1661 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    ...
    (((blockCount + startBlock) <= card->blockCount) ? (void)0 : __aeabi_assert("(blockCount + startBlock) <= card->blockCount", "../../libraries/components/sdmmc/sd/fsl_sd.c", 1662),
# 1662 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 1662 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 1662 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    (__builtin_assume)(((blockCount + startBlock) <= card->blockCount)?1:0)
# 1662 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic pop
# 1662 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    );
    ...
    _Bool dataAddrAlign = 1;
    uint8_t *alignBuffer = (uint8_t *)(uint32_t)((uint32_t)(card->internalBuffer) + (uint32_t)(32) - ((uint32_t)(card->internalBuffer) & ((uint32_t)(32) - 1U)));
    status_t error = kStatus_Success;

    (void)SDMMC_OSAMutexLock(&card->lock, ((uint32_t)(-1)));

    blockLeft = blockCount;

    while (blockLeft != 0U)
    {
        nextBuffer = (uint8_t *)((uint32_t)buffer + blockDone * (512U));
        if ((!card->noInteralAlign) && (!dataAddrAlign || ((((uint32_t)nextBuffer) & (sizeof(uint32_t) - 1U)) != 0U)))
        {
            blockCountOneTime = 1;
            (void)memset(alignBuffer, 0, (512U));
            dataAddrAlign = 0;
        ...
        {
            (void)memcpy(nextBuffer, alignBuffer, (512U));
        }
    }
...
status_t SD_WriteBlocks(sd_card_t *card, const uint8_t *buffer, uint32_t startBlock, uint32_t blockCount)
{
    ((card != 0) ? (void)0 : __aeabi_assert("card != NULL", "../../libraries/components/sdmmc/sd/fsl_sd.c", 1723),
# 1723 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 1723 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 1723 "../../libraries/components/sdmmc/sd/fsl_sd.c"
...
# 1723 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    ...
    ((buffer != 0) ? (void)0 : __aeabi_assert("buffer != NULL", "../../libraries/components/sdmmc/sd/fsl_sd.c", 1724),
# 1724 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 1724 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 1724 "../../libraries/components/sdmmc/sd/fsl_sd.c"
...
# 1724 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    ...
    ((blockCount != 0U) ? (void)0 : __aeabi_assert("blockCount != 0U", "../../libraries/components/sdmmc/sd/fsl_sd.c", 1725),
# 1725 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 1725 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 1725 "../../libraries/components/sdmmc/sd/fsl_sd.c"
...
# 1725 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    ...
    (((blockCount + startBlock) <= card->blockCount) ? (void)0 : __aeabi_assert("(blockCount + startBlock) <= card->blockCount", "../../libraries/components/sdmmc/sd/fsl_sd.c", 1726),
# 1726 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 1726 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 1726 "../../libraries/components/sdmmc/sd/fsl_sd.c"
...
# 1726 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    ...
    while (blockLeft != 0U)
    {
        nextBuffer = (uint8_t *)((uint32_t)buffer + (blockCount - blockLeft) * (512U));
        if (!card->noInteralAlign && (!dataAddrAlign || ((((uint32_t)nextBuffer) & (sizeof(uint32_t) - 1U)) != 0U)))
        {
            blockCountOneTime = 1;
            (void)memcpy(alignBuffer, nextBuffer, (512U));
            dataAddrAlign = 0;
        }
        else
        {
        ...
        error = SD_Write(card, dataAddrAlign ? nextBuffer : alignBuffer, (startBlock + blockCount - blockLeft),
                         (512U), blockCountOneTime, &blockWrittenOneTime);
        if (kStatus_Success != error)
        {
            error = kStatus_SDMMC_TransferFailed;
            break;
...
{
    uint32_t auCount = blockCount / (auSize / (512U));
...
status_t SD_EraseBlocks(sd_card_t *card, uint32_t startBlock, uint32_t blockCount)
{
    ((card != 0) ? (void)0 : __aeabi_assert("card != NULL", "../../libraries/components/sdmmc/sd/fsl_sd.c", 1806),
# 1806 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 1806 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 1806 "../../libraries/components/sdmmc/sd/fsl_sd.c"
...
# 1806 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    ...
    ((blockCount != 0U) ? (void)0 : __aeabi_assert("blockCount != 0U", "../../libraries/components/sdmmc/sd/fsl_sd.c", 1807),
# 1807 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 1807 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 1807 "../../libraries/components/sdmmc/sd/fsl_sd.c"
...
# 1807 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    ...
    (((blockCount + startBlock) <= card->blockCount) ? (void)0 : __aeabi_assert("(blockCount + startBlock) <= card->blockCount", "../../libraries/components/sdmmc/sd/fsl_sd.c", 1808),
# 1808 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 1808 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 1808 "../../libraries/components/sdmmc/sd/fsl_sd.c"
...
{
    ((card != 0) ? (void)0 : __aeabi_assert("card != NULL", "../../libraries/components/sdmmc/sd/fsl_sd.c", 1889),
# 1889 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 1889 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 1889 "../../libraries/components/sdmmc/sd/fsl_sd.c"
...
# 1889 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    ...
    applicationCommand41Argument |=
        (1UL << (kSD_OcrVdd29_30Flag)) | (1UL << (kSD_OcrVdd32_33Flag)) | (1UL << (kSD_OcrVdd33_34Flag));

    if ((card->usrParam.ioVoltage != 0) && (card->usrParam.ioVoltage->type != kSD_IOVoltageCtrlNotSupport) &&
                                    ...
                                    (uint32_t)kSDMMCHOST_SupportDDRMode)) != 0U))
    {
        ...
        applicationCommand41Argument |= (1UL << (kSD_OcrSwitch18RequestFlag));
    ...
    do
    {
        ...
        if (kStatus_Success == error)
        {
            ...
            applicationCommand41Argument |= (1UL << (kSD_OcrHostCapacitySupportFlag));
...
{
    ((card != 0) ? (void)0 : __aeabi_assert("card != NULL", "../../libraries/components/sdmmc/sd/fsl_sd.c", 1987),
# 1987 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 1987 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 1987 "../../libraries/components/sdmmc/sd/fsl_sd.c"
...
# 1987 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    ...
    ((card->isHostReady == 1) ? (void)0 : __aeabi_assert("card->isHostReady == true", "../../libraries/components/sdmmc/sd/fsl_sd.c", 1988),
# 1988 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 1988 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 1988 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    (__builtin_assume)((card->isHostReady == 1)?1:0)
# 1988 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic pop
# 1988 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    );
    ...
    card->busClock_Hz = SDMMCHOST_SetCardClock(card->host, (400000U));
    ...
    card->busClock_Hz = SDMMCHOST_SetCardClock(card->host, (25000000U));
    ...
    error = SD_SetBlockSize(card, (512U));
...
status_t SD_CardInit(sd_card_t *card)
{
    ((card != 0) ? (void)0 : __aeabi_assert("card != NULL", "../../libraries/components/sdmmc/sd/fsl_sd.c", 2076),
# 2076 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 2076 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 2076 "../../libraries/components/sdmmc/sd/fsl_sd.c"
...
void SD_CardDeinit(sd_card_t *card)
{
    ((card != 0) ? (void)0 : __aeabi_assert("card != NULL", "../../libraries/components/sdmmc/sd/fsl_sd.c", 2094),
# 2094 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 2094 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 2094 "../../libraries/components/sdmmc/sd/fsl_sd.c"
...
status_t SD_HostInit(sd_card_t *card)
{
    ((card != 0) ? (void)0 : __aeabi_assert("card != NULL", "../../libraries/components/sdmmc/sd/fsl_sd.c", 2106),
# 2106 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 2106 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 2106 "../../libraries/components/sdmmc/sd/fsl_sd.c"
...
# 2106 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    ...
    ((card->usrParam.cd != 0) ? (void)0 : __aeabi_assert("card->usrParam.cd != NULL", "../../libraries/components/sdmmc/sd/fsl_sd.c", 2107),
# 2107 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 2107 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 2107 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    (__builtin_assume)((card->usrParam.cd != 0)?1:0)
# 2107 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic pop
# 2107 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    );
...
void SD_HostDeinit(sd_card_t *card)
{
    ((card != 0) ? (void)0 : __aeabi_assert("card != NULL", "../../libraries/components/sdmmc/sd/fsl_sd.c", 2133),
# 2133 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 2133 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 2133 "../../libraries/components/sdmmc/sd/fsl_sd.c"
...
void SD_SetCardPower(sd_card_t *card, _Bool enable)
{
    ((card != 0) ? (void)0 : __aeabi_assert("card != NULL", "../../libraries/components/sdmmc/sd/fsl_sd.c", 2142),
# 2142 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 2142 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 2142 "../../libraries/components/sdmmc/sd/fsl_sd.c"
...
# 2142 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    ...
    if (enable)
    {
        powerDelay = card->usrParam.powerOnDelayMS == 0U ? (400U) : card->usrParam.powerOnDelayMS;
    }
    else
    {
        powerDelay = card->usrParam.powerOffDelayMS == 0U ? (100U) : card->usrParam.powerOffDelayMS;
    }
...
_Bool SD_IsCardPresent(sd_card_t *card)
{
    ((card != 0) ? (void)0 : __aeabi_assert("card != NULL", "../../libraries/components/sdmmc/sd/fsl_sd.c", 2169),
# 2169 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 2169 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 2169 "../../libraries/components/sdmmc/sd/fsl_sd.c"
...
# 2169 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    ...
    ((card->usrParam.cd != 0) ? (void)0 : __aeabi_assert("card->usrParam.cd != NULL", "../../libraries/components/sdmmc/sd/fsl_sd.c", 2170),
# 2170 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 2170 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 2170 "../../libraries/components/sdmmc/sd/fsl_sd.c"
...
# 2170 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    ...
    {
        if (card->usrParam.cd->cardDetected == 0)
        {
            return 0;
        }
...
status_t SD_PollingCardInsert(sd_card_t *card, uint32_t status)
{
    ((card != 0) ? (void)0 : __aeabi_assert("card != NULL", "../../libraries/components/sdmmc/sd/fsl_sd.c", 2198),
# 2198 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 2198 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 2198 "../../libraries/components/sdmmc/sd/fsl_sd.c"
...
# 2198 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    ...
    ((card->usrParam.cd != 0) ? (void)0 : __aeabi_assert("card->usrParam.cd != NULL", "../../libraries/components/sdmmc/sd/fsl_sd.c", 2199),
# 2199 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 2199 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 2199 "../../libraries/components/sdmmc/sd/fsl_sd.c"
...
# 2199 "../../libraries/components/sdmmc/sd/fsl_sd.c"
    ...
    if (card->usrParam.cd->type == kSD_DetectCardByGpioCD)
    {
        ...
        do
        {
            if ((card->usrParam.cd->cardDetected() == 1) && (status == (uint32_t)kSD_Inserted))
            {
                SDMMC_OSADelay(card->usrParam.cd->cdDebounce_ms);
                if (card->usrParam.cd->cardDetected() == 1)
                {
                    break;
                }
            }

            if ((card->usrParam.cd->cardDetected() == 0) && (status == (uint32_t)kSD_Removed))
            {
                break;
            }
        } while (1);
...
status_t SD_Init(sd_card_t *card)
{
    ((card != 0) ? (void)0 : __aeabi_assert("card != NULL", "../../libraries/components/sdmmc/sd/fsl_sd.c", 2243),
# 2243 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic push
# 2243 "../../libraries/components/sdmmc/sd/fsl_sd.c"
#pragma clang diagnostic ignored "-Wassume"
# 2243 "../../libraries/components/sdmmc/sd/fsl_sd.c"
