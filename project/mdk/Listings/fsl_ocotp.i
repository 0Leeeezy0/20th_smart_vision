# 1 "../../libraries/sdk/drives/fsl_ocotp.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/sdk/drives/fsl_ocotp.c" 2
...
# 1 "../../libraries/sdk/drives/fsl_ocotp.h" 1
# 10 "../../libraries/sdk/drives/fsl_ocotp.h"
...
# 11 "../../libraries/sdk/drives/fsl_ocotp.h" 2
# 31 "../../libraries/sdk/drives/fsl_ocotp.h"
enum
{
    kStatus_OCOTP_AccessError = ((((kStatusGroup_SDK_OCOTP)*100L) + (0))),
    kStatus_OCOTP_CrcFail = ((((kStatusGroup_SDK_OCOTP)*100L) + (1))),
    kStatus_OCOTP_ReloadError =
        ((((kStatusGroup_SDK_OCOTP)*100L) + (2))),
    kStatus_OCOTP_ProgramFail = ((((kStatusGroup_SDK_OCOTP)*100L) + (3))),
    kStatus_OCOTP_Locked = ((((kStatusGroup_SDK_OCOTP)*100L) + (4))),
};
# 53 "../../libraries/sdk/drives/fsl_ocotp.h"
...
# 78 "../../libraries/sdk/drives/fsl_ocotp.h"
...
# 94 "../../libraries/sdk/drives/fsl_ocotp.h"
static inline _Bool OCOTP_CheckBusyStatus(OCOTP_Type *base)
{
    return (((0x100U) == (base->CTRL & (0x100U))) ? (1) : (0));
}
...
static inline _Bool OCOTP_CheckErrorStatus(OCOTP_Type *base)
{
    return (((0x200U) == (base->CTRL & (0x200U))) ? (1) : (0));
}
...
# 9 "../../libraries/sdk/drives/fsl_ocotp.c" 2
# 46 "../../libraries/sdk/drives/fsl_ocotp.c"
...
status_t OCOTP_ReloadShadowRegister(OCOTP_Type *base)
{
    ((0 != base) ? (void)0 : __aeabi_assert("NULL != base", "../../libraries/sdk/drives/fsl_ocotp.c", 71),
# 71 "../../libraries/sdk/drives/fsl_ocotp.c"
#pragma clang diagnostic push
# 71 "../../libraries/sdk/drives/fsl_ocotp.c"
#pragma clang diagnostic ignored "-Wassume"
# 71 "../../libraries/sdk/drives/fsl_ocotp.c"
    (__builtin_assume)((0 != base)?1:0)
# 71 "../../libraries/sdk/drives/fsl_ocotp.c"
#pragma clang diagnostic pop
# 71 "../../libraries/sdk/drives/fsl_ocotp.c"
    );
...
# 99 "../../libraries/sdk/drives/fsl_ocotp.c"
    base->CTRL_SET = (((uint32_t)(((uint32_t)(1)) << (10U))) & (0x400U));
    ...
    while ((0x400U) == (base->CTRL & (0x400U)))
    {
    }
# 117 "../../libraries/sdk/drives/fsl_ocotp.c"
    return status;
}
...
static void OCOTP_SetReadTiming(OCOTP_Type *base, ocotp_timing_t timingConfig)
{
    ...
    timingValue &= ~((0xF000U) | (0x3F0000U) | (0xFC00000U));
    timingValue |= (((uint32_t)(((uint32_t)(timingConfig.relax)) << (12U))) & (0xF000U)) | (((uint32_t)(((uint32_t)(timingConfig.strobe_read)) << (16U))) & (0x3F0000U)) |
                   (((uint32_t)(((uint32_t)(timingConfig.wait)) << (22U))) & (0xFC00000U));
...
static void OCOTP_SetWriteTiming(OCOTP_Type *base, ocotp_timing_t timingConfig)
{
    ...
    timingValue &= ~((0xF000U) | (0xFFFU) | (0xFC00000U));
    timingValue |= (((uint32_t)(((uint32_t)(timingConfig.relax)) << (12U))) & (0xF000U)) | (((uint32_t)(((uint32_t)(timingConfig.strobe_prog)) << (0U))) & (0xFFFU)) |
                   (((uint32_t)(((uint32_t)(timingConfig.wait)) << (22U))) & (0xFC00000U));
...
void OCOTP_Init(OCOTP_Type *base, uint32_t srcClock_Hz)
{
    ((0 != base) ? (void)0 : __aeabi_assert("NULL != base", "../../libraries/sdk/drives/fsl_ocotp.c", 146),
# 146 "../../libraries/sdk/drives/fsl_ocotp.c"
#pragma clang diagnostic push
# 146 "../../libraries/sdk/drives/fsl_ocotp.c"
#pragma clang diagnostic ignored "-Wassume"
# 146 "../../libraries/sdk/drives/fsl_ocotp.c"
...
# 146 "../../libraries/sdk/drives/fsl_ocotp.c"
    ...
    ((0UL != srcClock_Hz) ? (void)0 : __aeabi_assert("0UL != srcClock_Hz", "../../libraries/sdk/drives/fsl_ocotp.c", 148),
# 148 "../../libraries/sdk/drives/fsl_ocotp.c"
#pragma clang diagnostic push
# 148 "../../libraries/sdk/drives/fsl_ocotp.c"
#pragma clang diagnostic ignored "-Wassume"
# 148 "../../libraries/sdk/drives/fsl_ocotp.c"
    (__builtin_assume)((0UL != srcClock_Hz)?1:0)
# 148 "../../libraries/sdk/drives/fsl_ocotp.c"
#pragma clang diagnostic pop
# 148 "../../libraries/sdk/drives/fsl_ocotp.c"
    );
    ...
    s_timingConfig.wait = (uint32_t)(((uint64_t)150 * srcClock_Hz + 1000000000U) / 1000000000U - 1U);


    s_timingConfig.relax = (uint32_t)(((uint64_t)100 * srcClock_Hz + 1000000000U) / 1000000000U - 1U);


    s_timingConfig.strobe_prog = (uint32_t)(((uint64_t)10000 * srcClock_Hz + 500000000U) / 1000000000U) +
                                 2U * (s_timingConfig.relax + 1U) - 1U;


    s_timingConfig.strobe_read = (uint32_t)(((uint64_t)40 * srcClock_Hz + 1000000000U) / 1000000000U) +
                                 2U * (s_timingConfig.relax + 1U) - 1U;
...
void OCOTP_Deinit(OCOTP_Type *base)
{
    ((0 != base) ? (void)0 : __aeabi_assert("NULL != base", "../../libraries/sdk/drives/fsl_ocotp.c", 176),
# 176 "../../libraries/sdk/drives/fsl_ocotp.c"
#pragma clang diagnostic push
# 176 "../../libraries/sdk/drives/fsl_ocotp.c"
#pragma clang diagnostic ignored "-Wassume"
# 176 "../../libraries/sdk/drives/fsl_ocotp.c"
...
uint32_t OCOTP_ReadFuseShadowRegister(OCOTP_Type *base, uint32_t address)
{
    ((0 != base) ? (void)0 : __aeabi_assert("NULL != base", "../../libraries/sdk/drives/fsl_ocotp.c", 194),
# 194 "../../libraries/sdk/drives/fsl_ocotp.c"
#pragma clang diagnostic push
# 194 "../../libraries/sdk/drives/fsl_ocotp.c"
#pragma clang diagnostic ignored "-Wassume"
# 194 "../../libraries/sdk/drives/fsl_ocotp.c"
...
status_t OCOTP_ReadFuseShadowRegisterExt(OCOTP_Type *base, uint32_t address, uint32_t *data, uint8_t fuseWords)
{
    (((fuseWords > 0U) && (fuseWords <= (1U))) ? (void)0 : __aeabi_assert("(fuseWords > 0U) && (fuseWords <= OCOTP_READ_FUSE_DATA_COUNT)", "../../libraries/sdk/drives/fsl_ocotp.c", 205),
# 205 "../../libraries/sdk/drives/fsl_ocotp.c"
#pragma clang diagnostic push
# 205 "../../libraries/sdk/drives/fsl_ocotp.c"
#pragma clang diagnostic ignored "-Wassume"
# 205 "../../libraries/sdk/drives/fsl_ocotp.c"
    (__builtin_assume)(((fuseWords > 0U) && (fuseWords <= (1U)))?1:0)
# 205 "../../libraries/sdk/drives/fsl_ocotp.c"
#pragma clang diagnostic pop
# 205 "../../libraries/sdk/drives/fsl_ocotp.c"
    );
    ((0 != data) ? (void)0 : __aeabi_assert("NULL != data", "../../libraries/sdk/drives/fsl_ocotp.c", 206),
# 206 "../../libraries/sdk/drives/fsl_ocotp.c"
#pragma clang diagnostic push
# 206 "../../libraries/sdk/drives/fsl_ocotp.c"
#pragma clang diagnostic ignored "-Wassume"
# 206 "../../libraries/sdk/drives/fsl_ocotp.c"
...
# 247 "../../libraries/sdk/drives/fsl_ocotp.c"
    base->CTRL_CLR = (0x3FU);
    base->CTRL_SET = (((uint32_t)(((uint32_t)(address)) << (0U))) & (0x3FU));
...
# 280 "../../libraries/sdk/drives/fsl_ocotp.c"
...
status_t OCOTP_WriteFuseShadowRegister(OCOTP_Type *base, uint32_t address, uint32_t data)
{
    return OCOTP_WriteFuseShadowRegisterWithLock(base, address, data, 0);
}

status_t OCOTP_WriteFuseShadowRegisterWithLock(OCOTP_Type *base, uint32_t address, uint32_t data, _Bool lock)
{
    ((0 != base) ? (void)0 : __aeabi_assert("NULL != base", "../../libraries/sdk/drives/fsl_ocotp.c", 299),
# 299 "../../libraries/sdk/drives/fsl_ocotp.c"
#pragma clang diagnostic push
# 299 "../../libraries/sdk/drives/fsl_ocotp.c"
#pragma clang diagnostic ignored "-Wassume"
# 299 "../../libraries/sdk/drives/fsl_ocotp.c"
...
# 350 "../../libraries/sdk/drives/fsl_ocotp.c"
    base->CTRL_CLR = (0x3FU) | (0xFFFF0000U);
# 361 "../../libraries/sdk/drives/fsl_ocotp.c"
    {
        base->CTRL_SET = (((uint32_t)(((uint32_t)(address)) << (0U))) & (0x3FU)) | (((uint32_t)(((uint32_t)((0x3E77))) << (16U))) & (0xFFFF0000U));
    }
...
# 399 "../../libraries/sdk/drives/fsl_ocotp.c"
