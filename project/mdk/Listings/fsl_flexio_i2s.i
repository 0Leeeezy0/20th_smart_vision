# 1 "../../libraries/sdk/drives/fsl_flexio_i2s.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/sdk/drives/fsl_flexio_i2s.c" 2
...
# 1 "../../libraries/sdk/drives/fsl_flexio_i2s.h" 1
# 11 "../../libraries/sdk/drives/fsl_flexio_i2s.h"
...
# 12 "../../libraries/sdk/drives/fsl_flexio_i2s.h" 2
...
# 13 "../../libraries/sdk/drives/fsl_flexio_i2s.h" 2
# 35 "../../libraries/sdk/drives/fsl_flexio_i2s.h"
enum
{
    kStatus_FLEXIO_I2S_Idle = ((((kStatusGroup_FLEXIO_I2S)*100L) + (0))),
    kStatus_FLEXIO_I2S_TxBusy = ((((kStatusGroup_FLEXIO_I2S)*100L) + (1))),
    kStatus_FLEXIO_I2S_RxBusy = ((((kStatusGroup_FLEXIO_I2S)*100L) + (2))),
    kStatus_FLEXIO_I2S_Error = ((((kStatusGroup_FLEXIO_I2S)*100L) + (3))),
    kStatus_FLEXIO_I2S_QueueFull = ((((kStatusGroup_FLEXIO_I2S)*100L) + (4))),
    kStatus_FLEXIO_I2S_Timeout =
        ((((kStatusGroup_FLEXIO_I2S)*100L) + (5))),
};
...
# 183 "../../libraries/sdk/drives/fsl_flexio_i2s.h"
void FLEXIO_I2S_Init(FLEXIO_I2S_Type *base, const flexio_i2s_config_t *config);
# 194 "../../libraries/sdk/drives/fsl_flexio_i2s.h"
void FLEXIO_I2S_GetDefaultConfig(flexio_i2s_config_t *config);
# 204 "../../libraries/sdk/drives/fsl_flexio_i2s.h"
...
static inline void FLEXIO_I2S_Enable(FLEXIO_I2S_Type *base, _Bool enable)
{
    if (enable)
    {
...
# 233 "../../libraries/sdk/drives/fsl_flexio_i2s.h"
uint32_t FLEXIO_I2S_GetStatusFlags(FLEXIO_I2S_Type *base);
# 250 "../../libraries/sdk/drives/fsl_flexio_i2s.h"
void FLEXIO_I2S_EnableInterrupts(FLEXIO_I2S_Type *base, uint32_t mask);
# 260 "../../libraries/sdk/drives/fsl_flexio_i2s.h"
void FLEXIO_I2S_DisableInterrupts(FLEXIO_I2S_Type *base, uint32_t mask);
# 275 "../../libraries/sdk/drives/fsl_flexio_i2s.h"
static inline void FLEXIO_I2S_TxEnableDMA(FLEXIO_I2S_Type *base, _Bool enable)
{
...
static inline void FLEXIO_I2S_RxEnableDMA(FLEXIO_I2S_Type *base, _Bool enable)
{
    FLEXIO_EnableShifterStatusDMA(base->flexioBase, 1UL << base->rxShifterIndex, enable);
}
# 299 "../../libraries/sdk/drives/fsl_flexio_i2s.h"
...
# 312 "../../libraries/sdk/drives/fsl_flexio_i2s.h"
...
# 385 "../../libraries/sdk/drives/fsl_flexio_i2s.h"
...
# 115 "../../libraries/sdk/drives/fsl_flexio_i2s.c"
void FLEXIO_I2S_Init(FLEXIO_I2S_Type *base, const flexio_i2s_config_t *config)
{
    (((base != 0) && (config != 0)) ? (void)0 : __aeabi_assert("(base != NULL) && (config != NULL)", "../../libraries/sdk/drives/fsl_flexio_i2s.c", 117),
# 117 "../../libraries/sdk/drives/fsl_flexio_i2s.c"
#pragma clang diagnostic push
# 117 "../../libraries/sdk/drives/fsl_flexio_i2s.c"
#pragma clang diagnostic ignored "-Wassume"
# 117 "../../libraries/sdk/drives/fsl_flexio_i2s.c"
    (__builtin_assume)(((base != 0) && (config != 0))?1:0)
# 117 "../../libraries/sdk/drives/fsl_flexio_i2s.c"
#pragma clang diagnostic pop
# 117 "../../libraries/sdk/drives/fsl_flexio_i2s.c"
    );
    ...
    if (config->masterSlave == kFLEXIO_I2S_Master)
    {
        timerConfig.triggerSelect = ((uint32_t)(base->txPinIndex) << 1U);
    ...
    {
        timerConfig.triggerSelect = ((uint32_t)(base->bclkPinIndex) << 1U);
        timerConfig.triggerPolarity = kFLEXIO_TimerTriggerPolarityActiveHigh;
    ...
    if (config->masterSlave == kFLEXIO_I2S_Master)
    {
        timerConfig.triggerSelect = (((uint32_t)(base->txShifterIndex) << 2U) | 0x1U);
    ...
    {
        timerConfig.triggerSelect = (((uint32_t)(base->fsTimerIndex) << 2U) | 0x3U);
        timerConfig.triggerPolarity = kFLEXIO_TimerTriggerPolarityActiveHigh;
        timerConfig.triggerSource = kFLEXIO_TimerTriggerSourceInternal;
        timerConfig.pinSelect = base->bclkPinIndex;
        timerConfig.pinConfig = kFLEXIO_PinConfigOutputDisabled;
...
# 257 "../../libraries/sdk/drives/fsl_flexio_i2s.c"
void FLEXIO_I2S_GetDefaultConfig(flexio_i2s_config_t *config)
{
...
# 280 "../../libraries/sdk/drives/fsl_flexio_i2s.c"
void FLEXIO_I2S_Deinit(FLEXIO_I2S_Type *base)
{
...
# 302 "../../libraries/sdk/drives/fsl_flexio_i2s.c"
void FLEXIO_I2S_EnableInterrupts(FLEXIO_I2S_Type *base, uint32_t mask)
{
...
# 338 "../../libraries/sdk/drives/fsl_flexio_i2s.c"
void FLEXIO_I2S_DisableInterrupts(FLEXIO_I2S_Type *base, uint32_t mask)
{
    if ((mask & (uint32_t)kFLEXIO_I2S_TxDataRegEmptyInterruptEnable) != 0UL)
    {
...
# 360 "../../libraries/sdk/drives/fsl_flexio_i2s.c"
void FLEXIO_I2S_MasterSetFormat(FLEXIO_I2S_Type *base, flexio_i2s_format_t *format, uint32_t srcClock_Hz)
{
    ...
    base->flexioBase->TIMCMP[base->fsTimerIndex] = (((uint32_t)(((uint32_t)(format->bitWidth * timDiv - 1U)) << (0U))) & (0xFFFFU));


    bclkDiv = ((timDiv / 2U - 1U) | ((format->bitWidth * 2UL - 1UL) << 8U));
    base->flexioBase->TIMCMP[base->bclkTimerIndex] = (((uint32_t)(((uint32_t)(bclkDiv)) << (0U))) & (0xFFFFU));
}
# 387 "../../libraries/sdk/drives/fsl_flexio_i2s.c"
void FLEXIO_I2S_SlaveSetFormat(FLEXIO_I2S_Type *base, flexio_i2s_format_t *format)
{

    base->flexioBase->TIMCMP[base->fsTimerIndex] = (((uint32_t)(((uint32_t)(format->bitWidth * 4UL - 3UL)) << (0U))) & (0xFFFFU));


    base->flexioBase->TIMCMP[base->bclkTimerIndex] = (((uint32_t)(((uint32_t)(format->bitWidth * 2UL - 1UL)) << (0U))) & (0xFFFFU));
}
# 408 "../../libraries/sdk/drives/fsl_flexio_i2s.c"
status_t FLEXIO_I2S_WriteBlocking(FLEXIO_I2S_Type *base, uint8_t bitWidth, uint8_t *txData, size_t size)
{
    uint32_t i = 0;
    uint8_t bytesPerWord = bitWidth / 8U;
    ...
    for (i = 0; i < size / bytesPerWord; i++)
    {
# 430 "../../libraries/sdk/drives/fsl_flexio_i2s.c"
...
# 450 "../../libraries/sdk/drives/fsl_flexio_i2s.c"
    while ((FLEXIO_I2S_GetStatusFlags(base) & (uint32_t)kFLEXIO_I2S_TxDataRegEmptyFlag) == 0UL)
    {
    }
...
# 470 "../../libraries/sdk/drives/fsl_flexio_i2s.c"
status_t FLEXIO_I2S_ReadBlocking(FLEXIO_I2S_Type *base, uint8_t bitWidth, uint8_t *rxData, size_t size)
{
    uint32_t i = 0;
    uint8_t bytesPerWord = bitWidth / 8U;
    ...
    for (i = 0; i < size / bytesPerWord; i++)
    {
# 492 "../../libraries/sdk/drives/fsl_flexio_i2s.c"
...
# 515 "../../libraries/sdk/drives/fsl_flexio_i2s.c"
void FLEXIO_I2S_TransferTxCreateHandle(FLEXIO_I2S_Type *base,
                                       flexio_i2s_handle_t *handle,
                                       flexio_i2s_callback_t callback,
                                       void *userData)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_flexio_i2s.c", 520),
# 520 "../../libraries/sdk/drives/fsl_flexio_i2s.c"
#pragma clang diagnostic push
# 520 "../../libraries/sdk/drives/fsl_flexio_i2s.c"
#pragma clang diagnostic ignored "-Wassume"
# 520 "../../libraries/sdk/drives/fsl_flexio_i2s.c"
...
# 553 "../../libraries/sdk/drives/fsl_flexio_i2s.c"
void FLEXIO_I2S_TransferRxCreateHandle(FLEXIO_I2S_Type *base,
                                       flexio_i2s_handle_t *handle,
                                       flexio_i2s_callback_t callback,
                                       void *userData)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_flexio_i2s.c", 558),
# 558 "../../libraries/sdk/drives/fsl_flexio_i2s.c"
#pragma clang diagnostic push
# 558 "../../libraries/sdk/drives/fsl_flexio_i2s.c"
#pragma clang diagnostic ignored "-Wassume"
# 558 "../../libraries/sdk/drives/fsl_flexio_i2s.c"
...
# 590 "../../libraries/sdk/drives/fsl_flexio_i2s.c"
void FLEXIO_I2S_TransferSetFormat(FLEXIO_I2S_Type *base,
                                  flexio_i2s_handle_t *handle,
                                  flexio_i2s_format_t *format,
                                  uint32_t srcClock_Hz)
{
    (((handle != 0) && (format != 0)) ? (void)0 : __aeabi_assert("(handle != NULL) && (format != NULL)", "../../libraries/sdk/drives/fsl_flexio_i2s.c", 595),
# 595 "../../libraries/sdk/drives/fsl_flexio_i2s.c"
#pragma clang diagnostic push
# 595 "../../libraries/sdk/drives/fsl_flexio_i2s.c"
#pragma clang diagnostic ignored "-Wassume"
# 595 "../../libraries/sdk/drives/fsl_flexio_i2s.c"
...
# 626 "../../libraries/sdk/drives/fsl_flexio_i2s.c"
status_t FLEXIO_I2S_TransferSendNonBlocking(FLEXIO_I2S_Type *base,
                                            flexio_i2s_handle_t *handle,
                                            flexio_i2s_transfer_t *xfer)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_flexio_i2s.c", 630),
# 630 "../../libraries/sdk/drives/fsl_flexio_i2s.c"
#pragma clang diagnostic push
# 630 "../../libraries/sdk/drives/fsl_flexio_i2s.c"
#pragma clang diagnostic ignored "-Wassume"
# 630 "../../libraries/sdk/drives/fsl_flexio_i2s.c"
...
# 630 "../../libraries/sdk/drives/fsl_flexio_i2s.c"
    ...
    if (handle->queue[handle->queueUser].data != 0)
    {
        return kStatus_FLEXIO_I2S_QueueFull;
    }
    if ((xfer->dataSize == 0U) || (xfer->data == 0))
    {
    ...
    handle->queueUser = (handle->queueUser + 1U) % (4U);
    ...
    FLEXIO_I2S_Enable(base, 1);

    return kStatus_Success;
}
# 673 "../../libraries/sdk/drives/fsl_flexio_i2s.c"
status_t FLEXIO_I2S_TransferReceiveNonBlocking(FLEXIO_I2S_Type *base,
                                               flexio_i2s_handle_t *handle,
                                               flexio_i2s_transfer_t *xfer)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_flexio_i2s.c", 677),
# 677 "../../libraries/sdk/drives/fsl_flexio_i2s.c"
#pragma clang diagnostic push
# 677 "../../libraries/sdk/drives/fsl_flexio_i2s.c"
#pragma clang diagnostic ignored "-Wassume"
# 677 "../../libraries/sdk/drives/fsl_flexio_i2s.c"
...
# 717 "../../libraries/sdk/drives/fsl_flexio_i2s.c"
void FLEXIO_I2S_TransferAbortSend(FLEXIO_I2S_Type *base, flexio_i2s_handle_t *handle)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_flexio_i2s.c", 719),
# 719 "../../libraries/sdk/drives/fsl_flexio_i2s.c"
#pragma clang diagnostic push
# 719 "../../libraries/sdk/drives/fsl_flexio_i2s.c"
#pragma clang diagnostic ignored "-Wassume"
# 719 "../../libraries/sdk/drives/fsl_flexio_i2s.c"
...
# 719 "../../libraries/sdk/drives/fsl_flexio_i2s.c"
    ...
    (void)memset(handle->queue, 0, sizeof(flexio_i2s_transfer_t) * (4U));
    handle->queueDriver = 0;
    handle->queueUser = 0;
}
# 740 "../../libraries/sdk/drives/fsl_flexio_i2s.c"
void FLEXIO_I2S_TransferAbortReceive(FLEXIO_I2S_Type *base, flexio_i2s_handle_t *handle)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_flexio_i2s.c", 742),
# 742 "../../libraries/sdk/drives/fsl_flexio_i2s.c"
#pragma clang diagnostic push
# 742 "../../libraries/sdk/drives/fsl_flexio_i2s.c"
#pragma clang diagnostic ignored "-Wassume"
# 742 "../../libraries/sdk/drives/fsl_flexio_i2s.c"
...
# 763 "../../libraries/sdk/drives/fsl_flexio_i2s.c"
status_t FLEXIO_I2S_TransferGetSendCount(FLEXIO_I2S_Type *base, flexio_i2s_handle_t *handle, size_t *count)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_flexio_i2s.c", 765),
# 765 "../../libraries/sdk/drives/fsl_flexio_i2s.c"
#pragma clang diagnostic push
# 765 "../../libraries/sdk/drives/fsl_flexio_i2s.c"
#pragma clang diagnostic ignored "-Wassume"
# 765 "../../libraries/sdk/drives/fsl_flexio_i2s.c"
...
# 791 "../../libraries/sdk/drives/fsl_flexio_i2s.c"
status_t FLEXIO_I2S_TransferGetReceiveCount(FLEXIO_I2S_Type *base, flexio_i2s_handle_t *handle, size_t *count)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_flexio_i2s.c", 793),
# 793 "../../libraries/sdk/drives/fsl_flexio_i2s.c"
#pragma clang diagnostic push
# 793 "../../libraries/sdk/drives/fsl_flexio_i2s.c"
#pragma clang diagnostic ignored "-Wassume"
# 793 "../../libraries/sdk/drives/fsl_flexio_i2s.c"
...
void FLEXIO_I2S_TransferTxHandleIRQ(void *i2sBase, void *i2sHandle)
{
    ((i2sHandle != 0) ? (void)0 : __aeabi_assert("i2sHandle != NULL", "../../libraries/sdk/drives/fsl_flexio_i2s.c", 818),
# 818 "../../libraries/sdk/drives/fsl_flexio_i2s.c"
#pragma clang diagnostic push
# 818 "../../libraries/sdk/drives/fsl_flexio_i2s.c"
#pragma clang diagnostic ignored "-Wassume"
# 818 "../../libraries/sdk/drives/fsl_flexio_i2s.c"
    (__builtin_assume)((i2sHandle != 0)?1:0)
# 818 "../../libraries/sdk/drives/fsl_flexio_i2s.c"
#pragma clang diagnostic pop
# 818 "../../libraries/sdk/drives/fsl_flexio_i2s.c"
    );
    ...
    if (((FLEXIO_I2S_GetStatusFlags(base) & (uint32_t)kFLEXIO_I2S_TxDataRegEmptyFlag) != 0UL) &&
        (handle->queue[handle->queueDriver].data != 0))
    {
    ...
    if ((handle->queue[handle->queueDriver].dataSize == 0U) && (handle->queue[handle->queueDriver].data != 0))
    {
        (void)memset(&handle->queue[handle->queueDriver], 0, sizeof(flexio_i2s_transfer_t));
        handle->queueDriver = (handle->queueDriver + 1U) % (4U);
    ...
    if (handle->queue[handle->queueDriver].data == 0)
    {
...
void FLEXIO_I2S_TransferRxHandleIRQ(void *i2sBase, void *i2sHandle)
{
    ((i2sHandle != 0) ? (void)0 : __aeabi_assert("i2sHandle != NULL", "../../libraries/sdk/drives/fsl_flexio_i2s.c", 868),
# 868 "../../libraries/sdk/drives/fsl_flexio_i2s.c"
#pragma clang diagnostic push
# 868 "../../libraries/sdk/drives/fsl_flexio_i2s.c"
#pragma clang diagnostic ignored "-Wassume"
# 868 "../../libraries/sdk/drives/fsl_flexio_i2s.c"
