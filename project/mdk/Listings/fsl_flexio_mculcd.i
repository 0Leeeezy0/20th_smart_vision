# 1 "../../libraries/sdk/drives/fsl_flexio_mculcd.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/sdk/drives/fsl_flexio_mculcd.c" 2
...
# 1 "../../libraries/sdk/drives/fsl_flexio_mculcd.h" 1
# 12 "../../libraries/sdk/drives/fsl_flexio_mculcd.h"
...
# 13 "../../libraries/sdk/drives/fsl_flexio_mculcd.h" 2
...
# 14 "../../libraries/sdk/drives/fsl_flexio_mculcd.h" 2
# 56 "../../libraries/sdk/drives/fsl_flexio_mculcd.h"
enum
{
    kStatus_FLEXIO_MCULCD_Idle = ((((kStatusGroup_FLEXIO_MCULCD)*100L) + (0))),
    kStatus_FLEXIO_MCULCD_Busy = ((((kStatusGroup_FLEXIO_MCULCD)*100L) + (1))),
    kStatus_FLEXIO_MCULCD_Error = ((((kStatusGroup_FLEXIO_MCULCD)*100L) + (2))),
};
...
typedef void (*flexio_mculcd_pin_func_t)(_Bool set);
...
# 208 "../../libraries/sdk/drives/fsl_flexio_mculcd.h"
...
static inline void FLEXIO_MCULCD_EnableRxDMA(FLEXIO_MCULCD_Type *base, _Bool enable)
{
    FLEXIO_EnableShifterStatusDMA(base->flexioBase, (1UL << base->rxShifterEndIndex), enable);
}
# 327 "../../libraries/sdk/drives/fsl_flexio_mculcd.h"
...
# 341 "../../libraries/sdk/drives/fsl_flexio_mculcd.h"
...
static inline void FLEXIO_MCULCD_Enable(FLEXIO_MCULCD_Type *base, _Bool enable)
{
    if (enable)
    {
...
# 500 "../../libraries/sdk/drives/fsl_flexio_mculcd.h"
uint32_t FLEXIO_MCULCD_ReadData(FLEXIO_MCULCD_Type *base);
# 513 "../../libraries/sdk/drives/fsl_flexio_mculcd.h"
...
# 101 "../../libraries/sdk/drives/fsl_flexio_mculcd.c"
void FLEXIO_MCULCD_GetDefaultConfig(flexio_mculcd_config_t *config)
{
    ((0 != config) ? (void)0 : __aeabi_assert("NULL != config", "../../libraries/sdk/drives/fsl_flexio_mculcd.c", 103),
# 103 "../../libraries/sdk/drives/fsl_flexio_mculcd.c"
#pragma clang diagnostic push
# 103 "../../libraries/sdk/drives/fsl_flexio_mculcd.c"
#pragma clang diagnostic ignored "-Wassume"
# 103 "../../libraries/sdk/drives/fsl_flexio_mculcd.c"
...
# 103 "../../libraries/sdk/drives/fsl_flexio_mculcd.c"
    ...
    config->enable = 1;
    config->enableInDoze = 0;
    config->enableInDebug = 1;
    config->enableFastAccess = 1;
    config->baudRate_Bps = 96000000U;
}
# 124 "../../libraries/sdk/drives/fsl_flexio_mculcd.c"
status_t FLEXIO_MCULCD_SetBaudRate(FLEXIO_MCULCD_Type *base, uint32_t baudRate_Bps, uint32_t srcClock_Hz)
{
    ...
    baudRatePerDataLine = baudRate_Bps / (uint32_t)16UL;

    baudRateDiv = (srcClock_Hz + baudRatePerDataLine) / (baudRatePerDataLine * 2U);

    if ((0U == baudRateDiv) || (baudRateDiv > (0xFFU + 1U)))
    {
    ...
    else
    {
        ...
        timerCompare = (timerCompare & ~0xFFU) | baudRateDiv;
...
# 163 "../../libraries/sdk/drives/fsl_flexio_mculcd.c"
uint32_t FLEXIO_MCULCD_GetStatusFlags(FLEXIO_MCULCD_Type *base)
{
    uint32_t ret = 0U;
    uint32_t flags;
...
# 193 "../../libraries/sdk/drives/fsl_flexio_mculcd.c"
void FLEXIO_MCULCD_ClearStatusFlags(FLEXIO_MCULCD_Type *base, uint32_t mask)
{
    uint32_t flags = 0U;
...
# 220 "../../libraries/sdk/drives/fsl_flexio_mculcd.c"
void FLEXIO_MCULCD_EnableInterrupts(FLEXIO_MCULCD_Type *base, uint32_t mask)
{
...
# 247 "../../libraries/sdk/drives/fsl_flexio_mculcd.c"
void FLEXIO_MCULCD_DisableInterrupts(FLEXIO_MCULCD_Type *base, uint32_t mask)
{
    uint32_t interrupts = 0U;
...
# 291 "../../libraries/sdk/drives/fsl_flexio_mculcd.c"
uint32_t FLEXIO_MCULCD_ReadData(FLEXIO_MCULCD_Type *base)
{
...
# 311 "../../libraries/sdk/drives/fsl_flexio_mculcd.c"
void FLEXIO_MCULCD_SetSingleBeatWriteConfig(FLEXIO_MCULCD_Type *base)
{
    ...
    base->flexioBase->SHIFTCFG[base->txShifterStartIndex] =
        (((uint32_t)(((uint32_t)((uint32_t)16UL - 1U)) << (16U))) & (0x1F0000U)) |
        (((uint32_t)(((uint32_t)(kFLEXIO_ShifterInputFromNextShifterOutput)) << (8U))) & (0x100U));

    base->flexioBase->SHIFTCTL[base->txShifterStartIndex] =
        (((uint32_t)(((uint32_t)(base->timerIndex)) << (24U))) & (0x7000000U)) | (((uint32_t)(((uint32_t)(kFLEXIO_ShifterTimerPolarityOnPositive)) << (23U))) & (0x800000U)) |
        (((uint32_t)(((uint32_t)(kFLEXIO_PinConfigOutput)) << (16U))) & (0x30000U)) | (((uint32_t)(((uint32_t)(base->dataPinStartIndex)) << (8U))) & (0x1F00U)) |
        (((uint32_t)(((uint32_t)(kFLEXIO_PinActiveHigh)) << (7U))) & (0x80U)) | (((uint32_t)(((uint32_t)(kFLEXIO_ShifterModeTransmit)) << (0U))) & (0x7U));
    ...
    base->flexioBase->TIMCFG[base->timerIndex] =
        (((uint32_t)(((uint32_t)(kFLEXIO_TimerOutputOneNotAffectedByReset)) << (24U))) & (0x3000000U)) |
        (((uint32_t)(((uint32_t)(kFLEXIO_TimerDecSrcOnFlexIOClockShiftTimerOutput)) << (20U))) & (0x300000U)) |
        (((uint32_t)(((uint32_t)(kFLEXIO_TimerResetNever)) << (16U))) & (0x70000U)) | (((uint32_t)(((uint32_t)(kFLEXIO_TimerDisableOnTimerCompare)) << (12U))) & (0x7000U)) |
        (((uint32_t)(((uint32_t)(kFLEXIO_TimerEnableOnTriggerHigh)) << (8U))) & (0x700U)) | (((uint32_t)(((uint32_t)(kFLEXIO_TimerStopBitDisabled)) << (4U))) & (0x30U)) |
        (((uint32_t)(((uint32_t)(kFLEXIO_TimerStartBitDisabled)) << (1U))) & (0x2U));

    base->flexioBase->TIMCTL[base->timerIndex] =
        (((uint32_t)(((uint32_t)((((uint32_t)(base->txShifterStartIndex) << 2U) | 0x1U))) << (24U))) & (0x3F000000U)) |
        (((uint32_t)(((uint32_t)(kFLEXIO_TimerTriggerPolarityActiveLow)) << (23U))) & (0x800000U)) |
        (((uint32_t)(((uint32_t)(kFLEXIO_TimerTriggerSourceInternal)) << (22U))) & (0x400000U)) | (((uint32_t)(((uint32_t)(kFLEXIO_PinConfigOutput)) << (16U))) & (0x30000U)) |
        (((uint32_t)(((uint32_t)(base->ENWRPinIndex)) << (8U))) & (0x1F00U)) | (((uint32_t)(((uint32_t)(kFLEXIO_PinActiveLow)) << (7U))) & (0x80U)) |
        (((uint32_t)(((uint32_t)(kFLEXIO_TimerModeDual8BitBaudBit)) << (0U))) & (0x3U));
}
# 364 "../../libraries/sdk/drives/fsl_flexio_mculcd.c"
void FLEXIO_MCULCD_ClearSingleBeatWriteConfig(FLEXIO_MCULCD_Type *base)
{
...
# 389 "../../libraries/sdk/drives/fsl_flexio_mculcd.c"
void FLEXIO_MCULCD_SetSingleBeatReadConfig(FLEXIO_MCULCD_Type *base)
{
    ...
    base->flexioBase->SHIFTCTL[base->rxShifterEndIndex] =
        (((uint32_t)(((uint32_t)(base->timerIndex)) << (24U))) & (0x7000000U)) | (((uint32_t)(((uint32_t)(kFLEXIO_ShifterTimerPolarityOnNegitive)) << (23U))) & (0x800000U)) |
        (((uint32_t)(((uint32_t)(kFLEXIO_PinConfigOutputDisabled)) << (16U))) & (0x30000U)) | (((uint32_t)(((uint32_t)(base->dataPinStartIndex)) << (8U))) & (0x1F00U)) |
        (((uint32_t)(((uint32_t)(kFLEXIO_PinActiveHigh)) << (7U))) & (0x80U)) | (((uint32_t)(((uint32_t)(kFLEXIO_ShifterModeReceive)) << (0U))) & (0x7U));
    ...
    base->flexioBase->TIMCFG[base->timerIndex] =
        ...
        (((uint32_t)(((uint32_t)(kFLEXIO_TimerDecSrcOnFlexIOClockShiftTimerOutput)) << (20U))) & (0x300000U)) |
        (((uint32_t)(((uint32_t)(kFLEXIO_TimerResetNever)) << (16U))) & (0x70000U)) | (((uint32_t)(((uint32_t)(kFLEXIO_TimerDisableOnTimerCompare)) << (12U))) & (0x7000U)) |
        (((uint32_t)(((uint32_t)(kFLEXIO_TimerEnableOnTriggerHigh)) << (8U))) & (0x700U)) |
    ...
    base->flexioBase->TIMCTL[base->timerIndex] |=
        (((uint32_t)(((uint32_t)((((uint32_t)(base->rxShifterEndIndex) << 2U) | 0x1U))) << (24U))) & (0x3F000000U)) |
        (((uint32_t)(((uint32_t)(kFLEXIO_TimerTriggerPolarityActiveLow)) << (23U))) & (0x800000U)) |
        (((uint32_t)(((uint32_t)(kFLEXIO_TimerTriggerSourceInternal)) << (22U))) & (0x400000U)) | (((uint32_t)(((uint32_t)(kFLEXIO_PinConfigOutput)) << (16U))) & (0x30000U)) |
        (((uint32_t)(((uint32_t)(timerPin)) << (8U))) & (0x1F00U)) | (((uint32_t)(((uint32_t)(timerPinPolarity)) << (7U))) & (0x80U)) |
        (((uint32_t)(((uint32_t)(kFLEXIO_TimerModeDual8BitBaudBit)) << (0U))) & (0x3U));
}
# 456 "../../libraries/sdk/drives/fsl_flexio_mculcd.c"
void FLEXIO_MCULCD_ClearSingleBeatReadConfig(FLEXIO_MCULCD_Type *base)
{
...
# 481 "../../libraries/sdk/drives/fsl_flexio_mculcd.c"
void FLEXIO_MCULCD_SetMultiBeatsWriteConfig(FLEXIO_MCULCD_Type *base)
{
    ...
    {
        base->flexioBase->SHIFTCFG[i] = (((uint32_t)(((uint32_t)((uint32_t)16UL - 1U)) << (16U))) & (0x1F0000U)) |
                                        (((uint32_t)(((uint32_t)(kFLEXIO_ShifterInputFromNextShifterOutput)) << (8U))) & (0x100U));

        base->flexioBase->SHIFTCTL[i] =
            (((uint32_t)(((uint32_t)(base->timerIndex)) << (24U))) & (0x7000000U)) | (((uint32_t)(((uint32_t)(kFLEXIO_ShifterTimerPolarityOnPositive)) << (23U))) & (0x800000U)) |
            (((uint32_t)(((uint32_t)(kFLEXIO_PinConfigOutputDisabled)) << (16U))) & (0x30000U)) | (((uint32_t)(((uint32_t)(0)) << (8U))) & (0x1F00U)) |
            (((uint32_t)(((uint32_t)(kFLEXIO_PinActiveHigh)) << (7U))) & (0x80U)) | (((uint32_t)(((uint32_t)(kFLEXIO_ShifterModeTransmit)) << (0U))) & (0x7U));
    }
    ...
    base->flexioBase->TIMCTL[base->timerIndex] =
        (((uint32_t)(((uint32_t)((((uint32_t)(base->txShifterEndIndex) << 2U) | 0x1U))) << (24U))) & (0x3F000000U)) |
        (((uint32_t)(((uint32_t)(kFLEXIO_TimerTriggerPolarityActiveLow)) << (23U))) & (0x800000U)) |
        (((uint32_t)(((uint32_t)(kFLEXIO_TimerTriggerSourceInternal)) << (22U))) & (0x400000U)) | (((uint32_t)(((uint32_t)(kFLEXIO_PinConfigOutput)) << (16U))) & (0x30000U)) |
        (((uint32_t)(((uint32_t)(base->ENWRPinIndex)) << (8U))) & (0x1F00U)) | (((uint32_t)(((uint32_t)(kFLEXIO_PinActiveLow)) << (7U))) & (0x80U)) |
        (((uint32_t)(((uint32_t)(kFLEXIO_TimerModeDual8BitBaudBit)) << (0U))) & (0x3U));
}
# 552 "../../libraries/sdk/drives/fsl_flexio_mculcd.c"
void FLEXIO_MCULCD_ClearMultiBeatsWriteConfig(FLEXIO_MCULCD_Type *base)
{
    uint8_t i;
...
# 585 "../../libraries/sdk/drives/fsl_flexio_mculcd.c"
void FLEXIO_MCULCD_SetMultiBeatsReadConfig(FLEXIO_MCULCD_Type *base)
{
...
# 669 "../../libraries/sdk/drives/fsl_flexio_mculcd.c"
void FLEXIO_MCULCD_ClearMultiBeatsReadConfig(FLEXIO_MCULCD_Type *base)
{
    uint8_t i;
    uint32_t statusFlags = 0U;
...
# 698 "../../libraries/sdk/drives/fsl_flexio_mculcd.c"
void FLEXIO_MCULCD_WaitTransmitComplete(void)
{
    uint32_t i = 512;
...
# 717 "../../libraries/sdk/drives/fsl_flexio_mculcd.c"
void FLEXIO_MCULCD_WriteCommandBlocking(FLEXIO_MCULCD_Type *base, uint32_t command)
{
...
# 762 "../../libraries/sdk/drives/fsl_flexio_mculcd.c"
void FLEXIO_MCULCD_WriteDataArrayBlocking(FLEXIO_MCULCD_Type *base, const void *data, size_t size)
{
    ((size > 0U) ? (void)0 : __aeabi_assert("size > 0U", "../../libraries/sdk/drives/fsl_flexio_mculcd.c", 764),
# 764 "../../libraries/sdk/drives/fsl_flexio_mculcd.c"
#pragma clang diagnostic push
# 764 "../../libraries/sdk/drives/fsl_flexio_mculcd.c"
#pragma clang diagnostic ignored "-Wassume"
# 764 "../../libraries/sdk/drives/fsl_flexio_mculcd.c"
...
# 764 "../../libraries/sdk/drives/fsl_flexio_mculcd.c"
    ...
    FLEXIO_MCULCD_SetSingleBeatWriteConfig(base);
# 802 "../../libraries/sdk/drives/fsl_flexio_mculcd.c"
...
# 833 "../../libraries/sdk/drives/fsl_flexio_mculcd.c"
void FLEXIO_MCULCD_ReadDataArrayBlocking(FLEXIO_MCULCD_Type *base, void *data, size_t size)
{
    ((size > 0U) ? (void)0 : __aeabi_assert("size > 0U", "../../libraries/sdk/drives/fsl_flexio_mculcd.c", 835),
# 835 "../../libraries/sdk/drives/fsl_flexio_mculcd.c"
#pragma clang diagnostic push
# 835 "../../libraries/sdk/drives/fsl_flexio_mculcd.c"
#pragma clang diagnostic ignored "-Wassume"
# 835 "../../libraries/sdk/drives/fsl_flexio_mculcd.c"
...
# 870 "../../libraries/sdk/drives/fsl_flexio_mculcd.c"
    size /= 2U;
...
# 911 "../../libraries/sdk/drives/fsl_flexio_mculcd.c"
void FLEXIO_MCULCD_WriteSameValueBlocking(FLEXIO_MCULCD_Type *base, uint32_t sameValue, size_t size)
{
    ((size > 0U) ? (void)0 : __aeabi_assert("size > 0U", "../../libraries/sdk/drives/fsl_flexio_mculcd.c", 913),
# 913 "../../libraries/sdk/drives/fsl_flexio_mculcd.c"
#pragma clang diagnostic push
# 913 "../../libraries/sdk/drives/fsl_flexio_mculcd.c"
#pragma clang diagnostic ignored "-Wassume"
# 913 "../../libraries/sdk/drives/fsl_flexio_mculcd.c"
...
# 958 "../../libraries/sdk/drives/fsl_flexio_mculcd.c"
void FLEXIO_MCULCD_TransferBlocking(FLEXIO_MCULCD_Type *base, flexio_mculcd_transfer_t *xfer)
{
...
# 995 "../../libraries/sdk/drives/fsl_flexio_mculcd.c"
status_t FLEXIO_MCULCD_TransferCreateHandle(FLEXIO_MCULCD_Type *base,
                                            flexio_mculcd_handle_t *handle,
                                            flexio_mculcd_transfer_callback_t callback,
                                            void *userData)
{
    ((0 != handle) ? (void)0 : __aeabi_assert("NULL != handle", "../../libraries/sdk/drives/fsl_flexio_mculcd.c", 1000),
# 1000 "../../libraries/sdk/drives/fsl_flexio_mculcd.c"
#pragma clang diagnostic push
# 1000 "../../libraries/sdk/drives/fsl_flexio_mculcd.c"
#pragma clang diagnostic ignored "-Wassume"
# 1000 "../../libraries/sdk/drives/fsl_flexio_mculcd.c"
...
# 1036 "../../libraries/sdk/drives/fsl_flexio_mculcd.c"
status_t FLEXIO_MCULCD_TransferNonBlocking(FLEXIO_MCULCD_Type *base,
                                           flexio_mculcd_handle_t *handle,
                                           flexio_mculcd_transfer_t *xfer)
{
...
# 1124 "../../libraries/sdk/drives/fsl_flexio_mculcd.c"
void FLEXIO_MCULCD_TransferAbort(FLEXIO_MCULCD_Type *base, flexio_mculcd_handle_t *handle)
{
...
# 1168 "../../libraries/sdk/drives/fsl_flexio_mculcd.c"
status_t FLEXIO_MCULCD_TransferGetCount(FLEXIO_MCULCD_Type *base, flexio_mculcd_handle_t *handle, size_t *count)
{
    ((0 != count) ? (void)0 : __aeabi_assert("NULL != count", "../../libraries/sdk/drives/fsl_flexio_mculcd.c", 1170),
# 1170 "../../libraries/sdk/drives/fsl_flexio_mculcd.c"
#pragma clang diagnostic push
# 1170 "../../libraries/sdk/drives/fsl_flexio_mculcd.c"
#pragma clang diagnostic ignored "-Wassume"
# 1170 "../../libraries/sdk/drives/fsl_flexio_mculcd.c"
...
# 1193 "../../libraries/sdk/drives/fsl_flexio_mculcd.c"
void FLEXIO_MCULCD_TransferHandleIRQ(void *base, void *handle)
{
        ...
        while ((0U != ((uint32_t)kFLEXIO_MCULCD_RxFullFlag & statusFlags)) && (flexioLcdMcuHandle->remainingCount > 0U))
        {
            ...
            *(uint16_t *)(flexioLcdMcuHandle->dataAddrOrSameValue) = (uint16_t)data;
            ...
            if (0U == flexioLcdMcuHandle->remainingCount)
            {
                ...
                if (0 != flexioLcdMcuHandle->completionCallback)
                {
