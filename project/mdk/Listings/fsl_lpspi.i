# 1 "../../libraries/sdk/drives/fsl_lpspi.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/sdk/drives/fsl_lpspi.c" 2
...
# 1 "../../libraries/sdk/drives/fsl_lpspi.h" 1
# 11 "../../libraries/sdk/drives/fsl_lpspi.h"
...
# 12 "../../libraries/sdk/drives/fsl_lpspi.h" 2
# 39 "../../libraries/sdk/drives/fsl_lpspi.h"
extern volatile uint8_t g_lpspiDummyData[];


enum
{
    kStatus_LPSPI_Busy = ((((kStatusGroup_LPSPI)*100L) + (0))),
    kStatus_LPSPI_Error = ((((kStatusGroup_LPSPI)*100L) + (1))),
    kStatus_LPSPI_Idle = ((((kStatusGroup_LPSPI)*100L) + (2))),
    kStatus_LPSPI_OutOfRange = ((((kStatusGroup_LPSPI)*100L) + (3))),
    kStatus_LPSPI_Timeout = ((((kStatusGroup_LPSPI)*100L) + (4)))
};


enum _lpspi_flags
{
    kLPSPI_TxDataRequestFlag = (0x1U),
    kLPSPI_RxDataReadyFlag = (0x2U),
    kLPSPI_WordCompleteFlag = (0x100U),
    kLPSPI_FrameCompleteFlag = (0x200U),
    kLPSPI_TransferCompleteFlag = (0x400U),
    kLPSPI_TransmitErrorFlag = (0x800U),
    kLPSPI_ReceiveErrorFlag = (0x1000U),
    kLPSPI_DataMatchFlag = (0x2000U),
    kLPSPI_ModuleBusyFlag = (0x1000000U),
    kLPSPI_AllStatusFlag = ((0x1U) | (0x2U) | (0x100U) | (0x200U) |
...
{
    kLPSPI_TxInterruptEnable = (0x1U),
    kLPSPI_RxInterruptEnable = (0x2U),
    kLPSPI_WordCompleteInterruptEnable = (0x100U),
    kLPSPI_FrameCompleteInterruptEnable = (0x200U),
    kLPSPI_TransferCompleteInterruptEnable = (0x400U),
    kLPSPI_TransmitErrorInterruptEnable = (0x800U),
    kLPSPI_ReceiveErrorInterruptEnable = (0x1000U),
    kLPSPI_DataMatchInterruptEnable = (0x2000U),
    kLPSPI_AllInterruptEnable =
        ((0x1U) | (0x2U) | (0x100U) | (0x200U) | (0x400U) |
...
{
    kLPSPI_TxDmaEnable = (0x1U),
    kLPSPI_RxDmaEnable = (0x2U)
};
...
{
    kLPSPI_MasterPcs0 = 0U << (4U),
    kLPSPI_MasterPcs1 = 1U << (4U),
    kLPSPI_MasterPcs2 = 2U << (4U),
    kLPSPI_MasterPcs3 = 3U << (4U),

    kLPSPI_MasterPcsContinuous = 1U << 20,

    kLPSPI_MasterByteSwap =
        1U << 22
# 224 "../../libraries/sdk/drives/fsl_lpspi.h"
};
...
{
    kLPSPI_SlavePcs0 = 0U << (4U),
    kLPSPI_SlavePcs1 = 1U << (4U),
    kLPSPI_SlavePcs2 = 2U << (4U),
    kLPSPI_SlavePcs3 = 3U << (4U),

    kLPSPI_SlaveByteSwap =
        1U << 22
# 250 "../../libraries/sdk/drives/fsl_lpspi.h"
};
...
# 322 "../../libraries/sdk/drives/fsl_lpspi.h"
typedef void (*lpspi_master_transfer_callback_t)(LPSPI_Type *base,
                                                 lpspi_master_handle_t *handle,
                                                 status_t status,
                                                 void *userData);
# 335 "../../libraries/sdk/drives/fsl_lpspi.h"
...
{
    volatile _Bool isPcsContinuous;
    volatile _Bool writeTcrInIsr;

    volatile _Bool isByteSwap;
    volatile _Bool isTxMask;
...
# 437 "../../libraries/sdk/drives/fsl_lpspi.h"
void LPSPI_MasterInit(LPSPI_Type *base, const lpspi_master_config_t *masterConfig, uint32_t srcClock_Hz);
# 452 "../../libraries/sdk/drives/fsl_lpspi.h"
...
# 475 "../../libraries/sdk/drives/fsl_lpspi.h"
...
static inline void LPSPI_Enable(LPSPI_Type *base, _Bool enable)
{
    if (enable)
    {
        base->CR |= (0x1U);
...
# 531 "../../libraries/sdk/drives/fsl_lpspi.h"
...
{
    return (1U << ((base->PARAM & (0xFF00U)) >> (8U)));
}
...
{
    base->TCR = (base->TCR & (~(0x3000000U))) | (((uint32_t)(((uint32_t)((uint8_t)select)) << (24U))) & (0x3000000U));
}
# 761 "../../libraries/sdk/drives/fsl_lpspi.h"
static inline void LPSPI_SetPCSContinous(LPSPI_Type *base, _Bool IsContinous)
{
    if (IsContinous)
    {
        base->TCR |= (0x200000U);
...
static inline _Bool LPSPI_IsMaster(LPSPI_Type *base)
{
    return (_Bool)((base->CFGR1) & (0x1U));
}
# 791 "../../libraries/sdk/drives/fsl_lpspi.h"
static inline void LPSPI_FlushFifo(LPSPI_Type *base, _Bool flushTxFifo, _Bool flushRxFifo)
{
    base->CR |= ((uint32_t)flushTxFifo << (8U)) | ((uint32_t)flushRxFifo << (9U));
}
# 807 "../../libraries/sdk/drives/fsl_lpspi.h"
static inline void LPSPI_SetFifoWatermarks(LPSPI_Type *base, uint32_t txWater, uint32_t rxWater)
{
    base->FCR = (((uint32_t)(((uint32_t)(txWater)) << (0U))) & (0xFU)) | (((uint32_t)(((uint32_t)(rxWater)) << (16U))) & (0xF0000U));
}
# 826 "../../libraries/sdk/drives/fsl_lpspi.h"
static inline void LPSPI_SetAllPcsPolarity(LPSPI_Type *base, uint32_t mask)
{
    base->CFGR1 = (base->CFGR1 & ~(0xF00U)) | (((uint32_t)(((uint32_t)(~mask)) << (8U))) & (0xF00U));
}
# 850 "../../libraries/sdk/drives/fsl_lpspi.h"
static inline void LPSPI_SetFrameSize(LPSPI_Type *base, uint32_t frameSize)
{
    base->TCR = (base->TCR & ~(0xFFFU)) | (((uint32_t)(((uint32_t)(frameSize - 1U)) << (0U))) & (0xFFFU));
}
# 878 "../../libraries/sdk/drives/fsl_lpspi.h"
uint32_t LPSPI_MasterSetBaudRate(LPSPI_Type *base,
                                 uint32_t baudRate_Bps,
                                 uint32_t srcClock_Hz,
                                 uint32_t *tcrPrescaleValue);
# 905 "../../libraries/sdk/drives/fsl_lpspi.h"
void LPSPI_MasterSetDelayScaler(LPSPI_Type *base, uint32_t scaler, lpspi_delay_type_t whichDelay);
# 935 "../../libraries/sdk/drives/fsl_lpspi.h"
uint32_t LPSPI_MasterSetDelayTimes(LPSPI_Type *base,
                                   uint32_t delayTimeInNanoSec,
                                   lpspi_delay_type_t whichDelay,
                                   uint32_t srcClock_Hz);
# 952 "../../libraries/sdk/drives/fsl_lpspi.h"
static inline void LPSPI_WriteData(LPSPI_Type *base, uint32_t data)
{
    base->TDR = data;
}
# 966 "../../libraries/sdk/drives/fsl_lpspi.h"
static inline uint32_t LPSPI_ReadData(LPSPI_Type *base)
{
    return (base->RDR);
}
# 981 "../../libraries/sdk/drives/fsl_lpspi.h"
void LPSPI_SetDummyData(LPSPI_Type *base, uint8_t dummyData);
# 1004 "../../libraries/sdk/drives/fsl_lpspi.h"
void LPSPI_MasterTransferCreateHandle(LPSPI_Type *base,
                                      lpspi_master_handle_t *handle,
                                      lpspi_master_transfer_callback_t callback,
                                      void *userData);
# 1026 "../../libraries/sdk/drives/fsl_lpspi.h"
status_t LPSPI_MasterTransferBlocking(LPSPI_Type *base, lpspi_transfer_t *transfer);
# 1045 "../../libraries/sdk/drives/fsl_lpspi.h"
status_t LPSPI_MasterTransferNonBlocking(LPSPI_Type *base, lpspi_master_handle_t *handle, lpspi_transfer_t *transfer);
# 1057 "../../libraries/sdk/drives/fsl_lpspi.h"
status_t LPSPI_MasterTransferGetCount(LPSPI_Type *base, lpspi_master_handle_t *handle, size_t *count);
# 1067 "../../libraries/sdk/drives/fsl_lpspi.h"
void LPSPI_MasterTransferAbort(LPSPI_Type *base, lpspi_master_handle_t *handle);
# 1077 "../../libraries/sdk/drives/fsl_lpspi.h"
void LPSPI_MasterTransferHandleIRQ(LPSPI_Type *base, lpspi_master_handle_t *handle);
# 1090 "../../libraries/sdk/drives/fsl_lpspi.h"
void LPSPI_SlaveTransferCreateHandle(LPSPI_Type *base,
                                     lpspi_slave_handle_t *handle,
                                     lpspi_slave_transfer_callback_t callback,
                                     void *userData);
# 1112 "../../libraries/sdk/drives/fsl_lpspi.h"
status_t LPSPI_SlaveTransferNonBlocking(LPSPI_Type *base, lpspi_slave_handle_t *handle, lpspi_transfer_t *transfer);
# 1124 "../../libraries/sdk/drives/fsl_lpspi.h"
status_t LPSPI_SlaveTransferGetCount(LPSPI_Type *base, lpspi_slave_handle_t *handle, size_t *count);
# 1134 "../../libraries/sdk/drives/fsl_lpspi.h"
void LPSPI_SlaveTransferAbort(LPSPI_Type *base, lpspi_slave_handle_t *handle);
# 1144 "../../libraries/sdk/drives/fsl_lpspi.h"
void LPSPI_SlaveTransferHandleIRQ(LPSPI_Type *base, lpspi_slave_handle_t *handle);
# 10 "../../libraries/sdk/drives/fsl_lpspi.c" 2
# 25 "../../libraries/sdk/drives/fsl_lpspi.c"
...
# 53 "../../libraries/sdk/drives/fsl_lpspi.c"
...
static uint32_t LPSPI_CombineWriteData(uint8_t *txData, uint8_t bytesEachWrite, _Bool isByteSwap);





static void LPSPI_SeparateReadData(uint8_t *rxData, uint32_t readData, uint8_t bytesEachRead, _Bool isByteSwap);
...
static _Bool LPSPI_TxFifoReady(LPSPI_Type *base);
...
static LPSPI_Type *const s_lpspiBases[] = { (LPSPI_Type *)0u, ((LPSPI_Type *)(0x40394000u)), ((LPSPI_Type *)(0x40398000u)), ((LPSPI_Type *)(0x4039C000u)), ((LPSPI_Type *)(0x403A0000u)) };


static const IRQn_Type s_lpspiIRQ[] = { NotAvail_IRQn, LPSPI1_IRQn, LPSPI2_IRQn, LPSPI3_IRQn, LPSPI4_IRQn };



static const clock_ip_name_t s_lpspiClocks[] = { kCLOCK_IpInvalid, kCLOCK_Lpspi1, kCLOCK_Lpspi2, kCLOCK_Lpspi3, kCLOCK_Lpspi4 };
# 134 "../../libraries/sdk/drives/fsl_lpspi.c"
static void *s_lpspiHandle[(sizeof(s_lpspiBases) / sizeof((s_lpspiBases)[0]))];
...
volatile uint8_t g_lpspiDummyData[(sizeof(s_lpspiBases) / sizeof((s_lpspiBases)[0]))] = {0};
# 153 "../../libraries/sdk/drives/fsl_lpspi.c"
uint32_t LPSPI_GetInstance(LPSPI_Type *base)
{
    uint8_t instance = 0;


    for (instance = 0; instance < (sizeof(s_lpspiBases) / sizeof((s_lpspiBases)[0])); instance++)
    {
    ...
    ((instance < (sizeof(s_lpspiBases) / sizeof((s_lpspiBases)[0]))) ? (void)0 : __aeabi_assert("instance < ARRAY_SIZE(s_lpspiBases)", "../../libraries/sdk/drives/fsl_lpspi.c", 166),
# 166 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic push
# 166 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic ignored "-Wassume"
# 166 "../../libraries/sdk/drives/fsl_lpspi.c"
    (__builtin_assume)((instance < (sizeof(s_lpspiBases) / sizeof((s_lpspiBases)[0])))?1:0)
# 166 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic pop
# 166 "../../libraries/sdk/drives/fsl_lpspi.c"
    );
...
# 181 "../../libraries/sdk/drives/fsl_lpspi.c"
void LPSPI_SetDummyData(LPSPI_Type *base, uint8_t dummyData)
{
    uint32_t instance = LPSPI_GetInstance(base);
    g_lpspiDummyData[instance] = dummyData;
}
# 194 "../../libraries/sdk/drives/fsl_lpspi.c"
void LPSPI_MasterInit(LPSPI_Type *base, const lpspi_master_config_t *masterConfig, uint32_t srcClock_Hz)
{
    ((masterConfig != 0) ? (void)0 : __aeabi_assert("masterConfig != NULL", "../../libraries/sdk/drives/fsl_lpspi.c", 196),
# 196 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic push
# 196 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic ignored "-Wassume"
# 196 "../../libraries/sdk/drives/fsl_lpspi.c"
    (__builtin_assume)((masterConfig != 0)?1:0)
# 196 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic pop
# 196 "../../libraries/sdk/drives/fsl_lpspi.c"
    );
...
# 213 "../../libraries/sdk/drives/fsl_lpspi.c"
    ...
    base->CFGR1 = (base->CFGR1 & ~((0x4000000U) | (0x3000000U) | (0x8U))) |
                  (((uint32_t)(((uint32_t)(masterConfig->dataOutConfig)) << (26U))) & (0x4000000U)) | (((uint32_t)(((uint32_t)(masterConfig->pinCfg)) << (24U))) & (0x3000000U)) |
    ...
    base->TCR = (((uint32_t)(((uint32_t)(masterConfig->cpol)) << (31U))) & (0x80000000U)) | (((uint32_t)(((uint32_t)(masterConfig->cpha)) << (30U))) & (0x40000000U)) |
                (((uint32_t)(((uint32_t)(masterConfig->direction)) << (23U))) & (0x800000U)) | (((uint32_t)(((uint32_t)(masterConfig->bitsPerFrame - 1U)) << (0U))) & (0xFFFU)) |
                (((uint32_t)(((uint32_t)(tcrPrescaleValue)) << (27U))) & (0x38000000U)) | (((uint32_t)(((uint32_t)(masterConfig->whichPcs)) << (24U))) & (0x3000000U));
    ...
    LPSPI_SetDummyData(base, (0x00U));
}
# 257 "../../libraries/sdk/drives/fsl_lpspi.c"
void LPSPI_MasterGetDefaultConfig(lpspi_master_config_t *masterConfig)
{
    ((masterConfig != 0) ? (void)0 : __aeabi_assert("masterConfig != NULL", "../../libraries/sdk/drives/fsl_lpspi.c", 259),
# 259 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic push
# 259 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic ignored "-Wassume"
# 259 "../../libraries/sdk/drives/fsl_lpspi.c"
...
void LPSPI_SlaveInit(LPSPI_Type *base, const lpspi_slave_config_t *slaveConfig)
{
    ((slaveConfig != 0) ? (void)0 : __aeabi_assert("slaveConfig != NULL", "../../libraries/sdk/drives/fsl_lpspi.c", 289),
# 289 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic push
# 289 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic ignored "-Wassume"
# 289 "../../libraries/sdk/drives/fsl_lpspi.c"
    (__builtin_assume)((slaveConfig != 0)?1:0)
# 289 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic pop
# 289 "../../libraries/sdk/drives/fsl_lpspi.c"
    );
    ...
    base->CFGR1 = (base->CFGR1 & ~((0x4000000U) | (0x3000000U))) |
                  (((uint32_t)(((uint32_t)(slaveConfig->dataOutConfig)) << (26U))) & (0x4000000U)) | (((uint32_t)(((uint32_t)(slaveConfig->pinCfg)) << (24U))) & (0x3000000U));

    LPSPI_SetFifoWatermarks(base, (uint32_t)kLpspiDefaultTxWatermark, (uint32_t)kLpspiDefaultRxWatermark);

    base->TCR = (((uint32_t)(((uint32_t)(slaveConfig->cpol)) << (31U))) & (0x80000000U)) | (((uint32_t)(((uint32_t)(slaveConfig->cpha)) << (30U))) & (0x40000000U)) |
                (((uint32_t)(((uint32_t)(slaveConfig->direction)) << (23U))) & (0x800000U)) | (((uint32_t)(((uint32_t)(slaveConfig->bitsPerFrame - 1U)) << (0U))) & (0xFFFU));
...
# 334 "../../libraries/sdk/drives/fsl_lpspi.c"
void LPSPI_SlaveGetDefaultConfig(lpspi_slave_config_t *slaveConfig)
{
    ((slaveConfig != 0) ? (void)0 : __aeabi_assert("slaveConfig != NULL", "../../libraries/sdk/drives/fsl_lpspi.c", 336),
# 336 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic push
# 336 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic ignored "-Wassume"
# 336 "../../libraries/sdk/drives/fsl_lpspi.c"
                                    ...
                                    lpspi_pcs_polarity_config_t activeLowOrHigh)
{
    ...
    cfgr1Value = base->CFGR1 & ~(1UL << ((8U) + (uint32_t)pcs));


    base->CFGR1 = cfgr1Value | ((uint32_t)activeLowOrHigh << ((8U) + (uint32_t)pcs));
}
# 428 "../../libraries/sdk/drives/fsl_lpspi.c"
uint32_t LPSPI_MasterSetBaudRate(LPSPI_Type *base,
                                 uint32_t baudRate_Bps,
                                 uint32_t srcClock_Hz,
                                 uint32_t *tcrPrescaleValue)
{
    ((tcrPrescaleValue != 0) ? (void)0 : __aeabi_assert("tcrPrescaleValue != NULL", "../../libraries/sdk/drives/fsl_lpspi.c", 433),
# 433 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic push
# 433 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic ignored "-Wassume"
# 433 "../../libraries/sdk/drives/fsl_lpspi.c"
    (__builtin_assume)((tcrPrescaleValue != 0)?1:0)
# 433 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic pop
# 433 "../../libraries/sdk/drives/fsl_lpspi.c"
    );
    ...
    if ((!LPSPI_IsMaster(base)) || ((base->CR & (0x1U)) != 0U))
    {
        return 0U;
    }
...
# 508 "../../libraries/sdk/drives/fsl_lpspi.c"
    base->CCR = (base->CCR & ~(0xFFU)) | (((uint32_t)(((uint32_t)(bestScaler)) << (0U))) & (0xFFU));
...
# 540 "../../libraries/sdk/drives/fsl_lpspi.c"
void LPSPI_MasterSetDelayScaler(LPSPI_Type *base, uint32_t scaler, lpspi_delay_type_t whichDelay)
{
# 565 "../../libraries/sdk/drives/fsl_lpspi.c"
    switch (whichDelay)
    {
        case kLPSPI_PcsToSck:
            base->CCR = (base->CCR & (~(0xFF0000U))) | (((uint32_t)(((uint32_t)(scaler)) << (16U))) & (0xFF0000U));

            break;
        case kLPSPI_LastSckToPcs:
            base->CCR = (base->CCR & (~(0xFF000000U))) | (((uint32_t)(((uint32_t)(scaler)) << (24U))) & (0xFF000000U));

            break;
        case kLPSPI_BetweenTransfer:
            base->CCR = (base->CCR & (~(0xFF00U))) | (((uint32_t)(((uint32_t)(scaler)) << (8U))) & (0xFF00U));

            break;
        default:
            ((0) ? (void)0 : __aeabi_assert("false", "../../libraries/sdk/drives/fsl_lpspi.c", 580),
# 580 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic push
# 580 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic ignored "-Wassume"
# 580 "../../libraries/sdk/drives/fsl_lpspi.c"
...
# 613 "../../libraries/sdk/drives/fsl_lpspi.c"
uint32_t LPSPI_MasterSetDelayTimes(LPSPI_Type *base,
                                   uint32_t delayTimeInNanoSec,
                                   lpspi_delay_type_t whichDelay,
                                   uint32_t srcClock_Hz)
{
    ...
    clockDividedPrescaler =
        srcClock_Hz / s_baudratePrescaler[(base->TCR & (0x38000000U)) >> (27U)];
...
# 736 "../../libraries/sdk/drives/fsl_lpspi.c"
void LPSPI_MasterTransferCreateHandle(LPSPI_Type *base,
                                      lpspi_master_handle_t *handle,
                                      lpspi_master_transfer_callback_t callback,
                                      void *userData)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_lpspi.c", 741),
# 741 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic push
# 741 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic ignored "-Wassume"
# 741 "../../libraries/sdk/drives/fsl_lpspi.c"
...
# 763 "../../libraries/sdk/drives/fsl_lpspi.c"
_Bool LPSPI_CheckTransferArgument(LPSPI_Type *base, lpspi_transfer_t *transfer, _Bool isEdma)
{
    ((transfer != 0) ? (void)0 : __aeabi_assert("transfer != NULL", "../../libraries/sdk/drives/fsl_lpspi.c", 765),
# 765 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic push
# 765 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic ignored "-Wassume"
# 765 "../../libraries/sdk/drives/fsl_lpspi.c"
...
# 765 "../../libraries/sdk/drives/fsl_lpspi.c"
    ...
    uint32_t bitsPerFrame = ((base->TCR & (0xFFFU)) >> (0U)) + 1U;
    uint32_t bytesPerFrame = (bitsPerFrame + 7U) / 8U;
    uint32_t temp = (base->CFGR1 & (0x3000000U));
    ...
    if ((0 == (transfer->txData)) && (0 == (transfer->rxData)))
    {
        return 0;
    }
    ...
    if ((temp == (((uint32_t)(((uint32_t)(kLPSPI_SdiInSdiOut)) << (24U))) & (0x3000000U))) || (temp == (((uint32_t)(((uint32_t)(kLPSPI_SdoInSdoOut)) << (24U))) & (0x3000000U))))
    {

        if ((transfer->txData != 0) && (transfer->rxData != 0))
        {
            return 0;
        }
        if (0 == transfer->txData)
        {
            base->CFGR1 |= (0x4000000U);
        }
    }
...
# 849 "../../libraries/sdk/drives/fsl_lpspi.c"
status_t LPSPI_MasterTransferBlocking(LPSPI_Type *base, lpspi_transfer_t *transfer)
{
    ((transfer != 0) ? (void)0 : __aeabi_assert("transfer != NULL", "../../libraries/sdk/drives/fsl_lpspi.c", 851),
# 851 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic push
# 851 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic ignored "-Wassume"
# 851 "../../libraries/sdk/drives/fsl_lpspi.c"
...
# 851 "../../libraries/sdk/drives/fsl_lpspi.c"
    ...
    if (!LPSPI_CheckTransferArgument(base, transfer, 0))
    {
        return kStatus_InvalidArgument;
    }

    LPSPI_FlushFifo(base, 1, 1);
    LPSPI_ClearStatusFlags(base, (uint32_t)kLPSPI_AllStatusFlag);


    _Bool isTxMask = 0;
    _Bool isByteSwap = ((transfer->configFlags & (uint32_t)kLPSPI_MasterByteSwap) != 0U);
    ...
    uint32_t bytesPerFrame = ((base->TCR & (0xFFFU)) >> (0U)) / 8U + 1U;

    _Bool isPcsContinuous = (((transfer->configFlags & (uint32_t)kLPSPI_MasterPcsContinuous) != 0U) &&
                            (bytesPerFrame < transfer->dataSize));
    uint32_t rxFifoMaxBytes = (((bytesPerFrame) < (4U)) ? (bytesPerFrame) : (4U)) * fifoSize;
    uint32_t whichPcs = (transfer->configFlags & (0xF0U)) >> (4U);
    uint32_t temp = (base->CFGR1 & (0x3000000U));
    ...
    base->TCR = (base->TCR & ~((0x200000U) | (0x100000U) | (0x80000U) |
                               (0x40000U) | (0x3000000U))) |
                (((uint32_t)(((uint32_t)(whichPcs)) << (24U))) & (0x3000000U));
    ...
    base->TCR |= (((uint32_t)(((uint32_t)(isPcsContinuous)) << (21U))) & (0x200000U)) | (((uint32_t)(((uint32_t)(isPcsContinuous)) << (20U))) & (0x100000U)) | (((uint32_t)(((uint32_t)(0 == rxData)) << (19U))) & (0x80000U));
...
# 961 "../../libraries/sdk/drives/fsl_lpspi.c"
        if (((0 == rxData) || (rxRemainingByteCount - txRemainingByteCount) < rxFifoMaxBytes))
        {
            if (isTxMask)
            {
                ...
                if (isPcsContinuous && (txRemainingByteCount == bytesPerFrame))
                {
                    ...
                    base->TCR &= ~((0x100000U) | (0x200000U) | (0x40000U));
                }
        ...
        if ((rxData != 0) && (rxRemainingByteCount != 0U))
        {
    ...
    if (isPcsContinuous && !isTxMask)
    {
        ...
        base->TCR = (base->TCR & ~((0x100000U) | (0x200000U)));
    }
...
# 1119 "../../libraries/sdk/drives/fsl_lpspi.c"
status_t LPSPI_MasterTransferNonBlocking(LPSPI_Type *base, lpspi_master_handle_t *handle, lpspi_transfer_t *transfer)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_lpspi.c", 1121),
# 1121 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic push
# 1121 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic ignored "-Wassume"
# 1121 "../../libraries/sdk/drives/fsl_lpspi.c"
...
# 1121 "../../libraries/sdk/drives/fsl_lpspi.c"
    ...
    ((transfer != 0) ? (void)0 : __aeabi_assert("transfer != NULL", "../../libraries/sdk/drives/fsl_lpspi.c", 1122),
# 1122 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic push
# 1122 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic ignored "-Wassume"
# 1122 "../../libraries/sdk/drives/fsl_lpspi.c"
...
# 1122 "../../libraries/sdk/drives/fsl_lpspi.c"
    ...
    handle->writeTcrInIsr = 0;
    handle->bytesPerFrame = (uint16_t)((base->TCR & (0xFFFU)) >> (0U)) / 8U + 1U;
    ...
    base->TCR |= (((uint32_t)(((uint32_t)(isPcsContinuous)) << (21U))) & (0x200000U)) | (((uint32_t)(((uint32_t)(isPcsContinuous)) << (20U))) & (0x100000U)) | (((uint32_t)(((uint32_t)(isRxMask)) << (19U))) & (0x80000U));
    ...
    if (handle->rxData != 0)
    {
        if (handle->isTxMask)
        {
            ...
            if ((handle->bytesPerFrame / 4U) < (uint16_t)handle->rxWatermark)
            {
                ...
                base->FCR = (base->FCR & (~(0xF0000U))) | (((uint32_t)(((uint32_t)(handle->rxWatermark)) << (16U))) & (0xF0000U));
            }
        }
        else
        {
            ...
            {
                base->FCR = (base->FCR & (~(0xF0000U))) | (((uint32_t)(((uint32_t)(tmpTimes - 1U)) << (16U))) & (0xF0000U));
            }
        }
...
static void LPSPI_MasterTransferFillUpTxFifo(LPSPI_Type *base, lpspi_master_handle_t *handle)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_lpspi.c", 1298),
# 1298 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic push
# 1298 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic ignored "-Wassume"
# 1298 "../../libraries/sdk/drives/fsl_lpspi.c"
...
# 1298 "../../libraries/sdk/drives/fsl_lpspi.c"
    ...
    _Bool isByteSwap = handle->isByteSwap;
    ...
    while ((LPSPI_GetTxFifoCount(base) < fifoSize) &&
           (((readRegRemainingTimes - writeRegRemainingTimes) < (uint32_t)fifoSize) || (handle->rxData == 0)))
    {
...
static void LPSPI_MasterTransferComplete(LPSPI_Type *base, lpspi_master_handle_t *handle)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_lpspi.c", 1366),
# 1366 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic push
# 1366 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic ignored "-Wassume"
# 1366 "../../libraries/sdk/drives/fsl_lpspi.c"
...
# 1389 "../../libraries/sdk/drives/fsl_lpspi.c"
status_t LPSPI_MasterTransferGetCount(LPSPI_Type *base, lpspi_master_handle_t *handle, size_t *count)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_lpspi.c", 1391),
# 1391 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic push
# 1391 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic ignored "-Wassume"
# 1391 "../../libraries/sdk/drives/fsl_lpspi.c"
...
# 1429 "../../libraries/sdk/drives/fsl_lpspi.c"
void LPSPI_MasterTransferAbort(LPSPI_Type *base, lpspi_master_handle_t *handle)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_lpspi.c", 1431),
# 1431 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic push
# 1431 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic ignored "-Wassume"
# 1431 "../../libraries/sdk/drives/fsl_lpspi.c"
...
# 1451 "../../libraries/sdk/drives/fsl_lpspi.c"
void LPSPI_MasterTransferHandleIRQ(LPSPI_Type *base, lpspi_master_handle_t *handle)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_lpspi.c", 1453),
# 1453 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic push
# 1453 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic ignored "-Wassume"
# 1453 "../../libraries/sdk/drives/fsl_lpspi.c"
...
# 1453 "../../libraries/sdk/drives/fsl_lpspi.c"
    ...
    if (handle->rxData != 0)
    {
        ...
        {
            base->FCR = (base->FCR & (~(0xF0000U))) |
                        (((uint32_t)(((uint32_t)((readRegRemainingTimes > 1U) ? (readRegRemainingTimes - 1U) : (0U))) << (16U))) & (0xF0000U));
        }
    }
...
# 1583 "../../libraries/sdk/drives/fsl_lpspi.c"
void LPSPI_SlaveTransferCreateHandle(LPSPI_Type *base,
                                     lpspi_slave_handle_t *handle,
                                     lpspi_slave_transfer_callback_t callback,
                                     void *userData)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_lpspi.c", 1588),
# 1588 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic push
# 1588 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic ignored "-Wassume"
# 1588 "../../libraries/sdk/drives/fsl_lpspi.c"
...
# 1619 "../../libraries/sdk/drives/fsl_lpspi.c"
status_t LPSPI_SlaveTransferNonBlocking(LPSPI_Type *base, lpspi_slave_handle_t *handle, lpspi_transfer_t *transfer)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_lpspi.c", 1621),
# 1621 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic push
# 1621 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic ignored "-Wassume"
# 1621 "../../libraries/sdk/drives/fsl_lpspi.c"
...
# 1621 "../../libraries/sdk/drives/fsl_lpspi.c"
    ...
    ((transfer != 0) ? (void)0 : __aeabi_assert("transfer != NULL", "../../libraries/sdk/drives/fsl_lpspi.c", 1622),
# 1622 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic push
# 1622 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic ignored "-Wassume"
# 1622 "../../libraries/sdk/drives/fsl_lpspi.c"
...
# 1622 "../../libraries/sdk/drives/fsl_lpspi.c"
    ...
    base->TCR = (base->TCR & ~((0x200000U) | (0x100000U) | (0x80000U) |
                               (0x40000U) | (0x3000000U))) |
                (((uint32_t)(((uint32_t)(isRxMask)) << (19U))) & (0x80000U)) | (((uint32_t)(((uint32_t)(isTxMask)) << (18U))) & (0x40000U)) | (((uint32_t)(((uint32_t)(whichPcs)) << (24U))) & (0x3000000U));
    ...
    if (handle->rxData != 0)
    {
        ...
        if (readRegRemainingTimes <= (uint32_t)handle->rxWatermark)
        {
            base->FCR = (base->FCR & (~(0xF0000U))) | (((uint32_t)(((uint32_t)(readRegRemainingTimes - 1U)) << (16U))) & (0xF0000U));
        }
...
static void LPSPI_SlaveTransferFillUpTxFifo(LPSPI_Type *base, lpspi_slave_handle_t *handle)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_lpspi.c", 1756),
# 1756 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic push
# 1756 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic ignored "-Wassume"
# 1756 "../../libraries/sdk/drives/fsl_lpspi.c"
...
static void LPSPI_SlaveTransferComplete(LPSPI_Type *base, lpspi_slave_handle_t *handle)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_lpspi.c", 1788),
# 1788 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic push
# 1788 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic ignored "-Wassume"
# 1788 "../../libraries/sdk/drives/fsl_lpspi.c"
...
# 1822 "../../libraries/sdk/drives/fsl_lpspi.c"
status_t LPSPI_SlaveTransferGetCount(LPSPI_Type *base, lpspi_slave_handle_t *handle, size_t *count)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_lpspi.c", 1824),
# 1824 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic push
# 1824 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic ignored "-Wassume"
# 1824 "../../libraries/sdk/drives/fsl_lpspi.c"
...
# 1862 "../../libraries/sdk/drives/fsl_lpspi.c"
void LPSPI_SlaveTransferAbort(LPSPI_Type *base, lpspi_slave_handle_t *handle)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_lpspi.c", 1864),
# 1864 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic push
# 1864 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic ignored "-Wassume"
# 1864 "../../libraries/sdk/drives/fsl_lpspi.c"
...
# 1884 "../../libraries/sdk/drives/fsl_lpspi.c"
void LPSPI_SlaveTransferHandleIRQ(LPSPI_Type *base, lpspi_slave_handle_t *handle)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_lpspi.c", 1886),
# 1886 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic push
# 1886 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic ignored "-Wassume"
# 1886 "../../libraries/sdk/drives/fsl_lpspi.c"
...
# 1886 "../../libraries/sdk/drives/fsl_lpspi.c"
    ...
    if (handle->rxData != 0)
    {
        if (handle->rxRemainingByteCount > 0U)
        {
            while (LPSPI_GetRxFifoCount(base) != 0U)
            {
                ...
                if ((handle->txRemainingByteCount > 0U) && (handle->txData != 0))
                {
                    LPSPI_SlaveTransferFillUpTxFifo(base, handle);
                }
    ...
    if ((handle->rxData == 0) && (handle->txRemainingByteCount != 0U) && (handle->txData != 0))
    {
        LPSPI_SlaveTransferFillUpTxFifo(base, handle);
    }
...
static uint32_t LPSPI_CombineWriteData(uint8_t *txData, uint8_t bytesEachWrite, _Bool isByteSwap)
{
    ((txData != 0) ? (void)0 : __aeabi_assert("txData != NULL", "../../libraries/sdk/drives/fsl_lpspi.c", 1998),
# 1998 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic push
# 1998 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic ignored "-Wassume"
# 1998 "../../libraries/sdk/drives/fsl_lpspi.c"
    (__builtin_assume)((txData != 0)?1:0)
# 1998 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic pop
# 1998 "../../libraries/sdk/drives/fsl_lpspi.c"
    );
    ...
    switch (bytesEachWrite)
    {
        ...
        default:
            ((0) ? (void)0 : __aeabi_assert("false", "../../libraries/sdk/drives/fsl_lpspi.c", 2074),
# 2074 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic push
# 2074 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic ignored "-Wassume"
# 2074 "../../libraries/sdk/drives/fsl_lpspi.c"
...
static void LPSPI_SeparateReadData(uint8_t *rxData, uint32_t readData, uint8_t bytesEachRead, _Bool isByteSwap)
{
    ((rxData != 0) ? (void)0 : __aeabi_assert("rxData != NULL", "../../libraries/sdk/drives/fsl_lpspi.c", 2082),
# 2082 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic push
# 2082 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic ignored "-Wassume"
# 2082 "../../libraries/sdk/drives/fsl_lpspi.c"
    (__builtin_assume)((rxData != 0)?1:0)
# 2082 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic pop
# 2082 "../../libraries/sdk/drives/fsl_lpspi.c"
    );
    ...
    switch (bytesEachRead)
    {
        ...
        default:
            ((0) ? (void)0 : __aeabi_assert("false", "../../libraries/sdk/drives/fsl_lpspi.c", 2155),
# 2155 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic push
# 2155 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic ignored "-Wassume"
# 2155 "../../libraries/sdk/drives/fsl_lpspi.c"
...
# 2202 "../../libraries/sdk/drives/fsl_lpspi.c"
void LPSPI1_DriverIRQHandler(void);
void LPSPI1_DriverIRQHandler(void)
{
    ((s_lpspiHandle[1] != 0) ? (void)0 : __aeabi_assert("s_lpspiHandle[1] != NULL", "../../libraries/sdk/drives/fsl_lpspi.c", 2205),
# 2205 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic push
# 2205 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic ignored "-Wassume"
# 2205 "../../libraries/sdk/drives/fsl_lpspi.c"
    (__builtin_assume)((s_lpspiHandle[1] != 0)?1:0)
# 2205 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic pop
# 2205 "../../libraries/sdk/drives/fsl_lpspi.c"
    );
    LPSPI_CommonIRQHandler(((LPSPI_Type *)(0x40394000u)), s_lpspiHandle[1]);
}
...
void LPSPI2_DriverIRQHandler(void)
{
    ((s_lpspiHandle[2] != 0) ? (void)0 : __aeabi_assert("s_lpspiHandle[2] != NULL", "../../libraries/sdk/drives/fsl_lpspi.c", 2214),
# 2214 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic push
# 2214 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic ignored "-Wassume"
# 2214 "../../libraries/sdk/drives/fsl_lpspi.c"
    (__builtin_assume)((s_lpspiHandle[2] != 0)?1:0)
# 2214 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic pop
# 2214 "../../libraries/sdk/drives/fsl_lpspi.c"
    );
    LPSPI_CommonIRQHandler(((LPSPI_Type *)(0x40398000u)), s_lpspiHandle[2]);
}
...
void LPSPI3_DriverIRQHandler(void)
{
    ((s_lpspiHandle[3] != 0) ? (void)0 : __aeabi_assert("s_lpspiHandle[3] != NULL", "../../libraries/sdk/drives/fsl_lpspi.c", 2223),
# 2223 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic push
# 2223 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic ignored "-Wassume"
# 2223 "../../libraries/sdk/drives/fsl_lpspi.c"
    (__builtin_assume)((s_lpspiHandle[3] != 0)?1:0)
# 2223 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic pop
# 2223 "../../libraries/sdk/drives/fsl_lpspi.c"
    );
    LPSPI_CommonIRQHandler(((LPSPI_Type *)(0x4039C000u)), s_lpspiHandle[3]);
}
...
void LPSPI4_DriverIRQHandler(void)
{
    ((s_lpspiHandle[4] != 0) ? (void)0 : __aeabi_assert("s_lpspiHandle[4] != NULL", "../../libraries/sdk/drives/fsl_lpspi.c", 2232),
# 2232 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic push
# 2232 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic ignored "-Wassume"
# 2232 "../../libraries/sdk/drives/fsl_lpspi.c"
    (__builtin_assume)((s_lpspiHandle[4] != 0)?1:0)
# 2232 "../../libraries/sdk/drives/fsl_lpspi.c"
#pragma clang diagnostic pop
# 2232 "../../libraries/sdk/drives/fsl_lpspi.c"
    );
    LPSPI_CommonIRQHandler(((LPSPI_Type *)(0x403A0000u)), s_lpspiHandle[4]);
}
