# 1 "../../libraries/sdk/drives/fsl_dmamux.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/sdk/drives/fsl_dmamux.c" 2
...
# 12 "../../libraries/sdk/drives/fsl_dmamux.h"
...
# 13 "../../libraries/sdk/drives/fsl_dmamux.h" 2
...
# 10 "../../libraries/sdk/drives/fsl_dmamux.c" 2
# 29 "../../libraries/sdk/drives/fsl_dmamux.c"
...
static DMAMUX_Type *const s_dmamuxBases[] = { ((DMAMUX_Type *)(0x400EC000u)) };



static const clock_ip_name_t s_dmamuxClockName[] = { kCLOCK_Dma };
...
static uint32_t DMAMUX_GetInstance(DMAMUX_Type *base)
{
    ...
    for (instance = 0; instance < (sizeof(s_dmamuxBases) / sizeof((s_dmamuxBases)[0])); instance++)
    {
    ...
    ((instance < (sizeof(s_dmamuxBases) / sizeof((s_dmamuxBases)[0]))) ? (void)0 : __aeabi_assert("instance < ARRAY_SIZE(s_dmamuxBases)", "../../libraries/sdk/drives/fsl_dmamux.c", 59),
# 59 "../../libraries/sdk/drives/fsl_dmamux.c"
#pragma clang diagnostic push
# 59 "../../libraries/sdk/drives/fsl_dmamux.c"
#pragma clang diagnostic ignored "-Wassume"
# 59 "../../libraries/sdk/drives/fsl_dmamux.c"
    (__builtin_assume)((instance < (sizeof(s_dmamuxBases) / sizeof((s_dmamuxBases)[0])))?1:0)
# 59 "../../libraries/sdk/drives/fsl_dmamux.c"
#pragma clang diagnostic pop
# 59 "../../libraries/sdk/drives/fsl_dmamux.c"
    );
...
# 72 "../../libraries/sdk/drives/fsl_dmamux.c"
void DMAMUX_Init(DMAMUX_Type *base)
{
...
# 86 "../../libraries/sdk/drives/fsl_dmamux.c"
void DMAMUX_Deinit(DMAMUX_Type *base)
{
