# 1 "../../libraries/sdk/drives/fsl_lpi2c_edma.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/sdk/drives/fsl_lpi2c_edma.c" 2
...
# 1 "../../libraries/sdk/drives/fsl_lpi2c_edma.h" 1
# 11 "../../libraries/sdk/drives/fsl_lpi2c_edma.h"
...
# 12 "../../libraries/sdk/drives/fsl_lpi2c_edma.h" 2
...
# 13 "../../libraries/sdk/drives/fsl_lpi2c_edma.h" 2
# 30 "../../libraries/sdk/drives/fsl_lpi2c_edma.h"
typedef struct _lpi2c_master_edma_handle lpi2c_master_edma_handle_t;
# 43 "../../libraries/sdk/drives/fsl_lpi2c_edma.h"
...
# 102 "../../libraries/sdk/drives/fsl_lpi2c_edma.h"
void LPI2C_MasterCreateEDMAHandle(LPI2C_Type *base,
                                  ...
                                  void *userData);
# 122 "../../libraries/sdk/drives/fsl_lpi2c_edma.h"
status_t LPI2C_MasterTransferEDMA(LPI2C_Type *base,
                                  lpi2c_master_edma_handle_t *handle,
                                  lpi2c_master_transfer_t *transfer);
# 135 "../../libraries/sdk/drives/fsl_lpi2c_edma.h"
status_t LPI2C_MasterTransferGetCountEDMA(LPI2C_Type *base, lpi2c_master_edma_handle_t *handle, size_t *count);
# 148 "../../libraries/sdk/drives/fsl_lpi2c_edma.h"
status_t LPI2C_MasterTransferAbortEDMA(LPI2C_Type *base, lpi2c_master_edma_handle_t *handle);
# 10 "../../libraries/sdk/drives/fsl_lpi2c_edma.c" 2
# 26 "../../libraries/sdk/drives/fsl_lpi2c_edma.c"
...
# 57 "../../libraries/sdk/drives/fsl_lpi2c_edma.c"
static uint32_t LPI2C_GenerateCommands(lpi2c_master_edma_handle_t *handle);
# 67 "../../libraries/sdk/drives/fsl_lpi2c_edma.c"
static void LPI2C_MasterEDMACallback(edma_handle_t *dmaHandle, void *userData, _Bool isTransferDone, uint32_t tcds);
# 77 "../../libraries/sdk/drives/fsl_lpi2c_edma.c"
...
# 105 "../../libraries/sdk/drives/fsl_lpi2c_edma.c"
void LPI2C_MasterCreateEDMAHandle(LPI2C_Type *base,
                                  lpi2c_master_edma_handle_t *handle,
                                  edma_handle_t *rxDmaHandle,
                                  edma_handle_t *txDmaHandle,
                                  ...
                                  void *userData)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_lpi2c_edma.c", 112),
# 112 "../../libraries/sdk/drives/fsl_lpi2c_edma.c"
#pragma clang diagnostic push
# 112 "../../libraries/sdk/drives/fsl_lpi2c_edma.c"
#pragma clang diagnostic ignored "-Wassume"
# 112 "../../libraries/sdk/drives/fsl_lpi2c_edma.c"
...
# 112 "../../libraries/sdk/drives/fsl_lpi2c_edma.c"
    ...
    ((rxDmaHandle != 0) ? (void)0 : __aeabi_assert("rxDmaHandle != NULL", "../../libraries/sdk/drives/fsl_lpi2c_edma.c", 113),
# 113 "../../libraries/sdk/drives/fsl_lpi2c_edma.c"
#pragma clang diagnostic push
# 113 "../../libraries/sdk/drives/fsl_lpi2c_edma.c"
#pragma clang diagnostic ignored "-Wassume"
# 113 "../../libraries/sdk/drives/fsl_lpi2c_edma.c"
    (__builtin_assume)((rxDmaHandle != 0)?1:0)
# 113 "../../libraries/sdk/drives/fsl_lpi2c_edma.c"
#pragma clang diagnostic pop
# 113 "../../libraries/sdk/drives/fsl_lpi2c_edma.c"
    );
    ((txDmaHandle != 0) ? (void)0 : __aeabi_assert("txDmaHandle != NULL", "../../libraries/sdk/drives/fsl_lpi2c_edma.c", 114),
# 114 "../../libraries/sdk/drives/fsl_lpi2c_edma.c"
#pragma clang diagnostic push
# 114 "../../libraries/sdk/drives/fsl_lpi2c_edma.c"
#pragma clang diagnostic ignored "-Wassume"
# 114 "../../libraries/sdk/drives/fsl_lpi2c_edma.c"
    (__builtin_assume)((txDmaHandle != 0)?1:0)
# 114 "../../libraries/sdk/drives/fsl_lpi2c_edma.c"
#pragma clang diagnostic pop
# 114 "../../libraries/sdk/drives/fsl_lpi2c_edma.c"
    );
    ...
    handle->tx = ((0) > 0) ? txDmaHandle : rxDmaHandle;
...
static uint32_t LPI2C_GenerateCommands(lpi2c_master_edma_handle_t *handle)
{
    ...
    if ((xfer->flags & (uint32_t)kLPI2C_TransferNoStartFlag) != 0U)
    {
        if (xfer->direction == kLPI2C_Read)
        {
            ...
            cmd[cmdCount++] = (uint16_t)kRxDataCmd | (uint16_t)(((uint32_t)(((uint32_t)(xfer->dataSize - 1U)) << (0U))) & (0xFFU));
        }
    }
    else
    {
        ...
        if ((xfer->dataSize != 0U) && (xfer->direction == kLPI2C_Read))
        {
            ...
            while (tmpRxSize != 0U)
            {
                if (tmpRxSize > 256U)
                {
                    cmd[cmdCount++] = (uint16_t)kRxDataCmd | (uint16_t)(((uint32_t)(((uint32_t)(0xFFU)) << (0U))) & (0xFFU));
                    tmpRxSize -= 256U;
                }
                else
                {
                    cmd[cmdCount++] = (uint16_t)kRxDataCmd | (uint16_t)(((uint32_t)(((uint32_t)(tmpRxSize - 1U)) << (0U))) & (0xFFU));
                    tmpRxSize = 0U;
                }
            }
        }
...
# 230 "../../libraries/sdk/drives/fsl_lpi2c_edma.c"
status_t LPI2C_MasterTransferEDMA(LPI2C_Type *base,
                                  lpi2c_master_edma_handle_t *handle,
                                  lpi2c_master_transfer_t *transfer)
{
    ...
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_lpi2c_edma.c", 236),
# 236 "../../libraries/sdk/drives/fsl_lpi2c_edma.c"
#pragma clang diagnostic push
# 236 "../../libraries/sdk/drives/fsl_lpi2c_edma.c"
#pragma clang diagnostic ignored "-Wassume"
# 236 "../../libraries/sdk/drives/fsl_lpi2c_edma.c"
...
# 236 "../../libraries/sdk/drives/fsl_lpi2c_edma.c"
    ...
    ((transfer != 0) ? (void)0 : __aeabi_assert("transfer != NULL", "../../libraries/sdk/drives/fsl_lpi2c_edma.c", 237),
# 237 "../../libraries/sdk/drives/fsl_lpi2c_edma.c"
#pragma clang diagnostic push
# 237 "../../libraries/sdk/drives/fsl_lpi2c_edma.c"
#pragma clang diagnostic ignored "-Wassume"
# 237 "../../libraries/sdk/drives/fsl_lpi2c_edma.c"
...
# 237 "../../libraries/sdk/drives/fsl_lpi2c_edma.c"
    ...
    ((transfer->subaddressSize <= sizeof(transfer->subaddress)) ? (void)0 : __aeabi_assert("transfer->subaddressSize <= sizeof(transfer->subaddress)", "../../libraries/sdk/drives/fsl_lpi2c_edma.c", 238),
# 238 "../../libraries/sdk/drives/fsl_lpi2c_edma.c"
#pragma clang diagnostic push
# 238 "../../libraries/sdk/drives/fsl_lpi2c_edma.c"
#pragma clang diagnostic ignored "-Wassume"
# 238 "../../libraries/sdk/drives/fsl_lpi2c_edma.c"
...
# 238 "../../libraries/sdk/drives/fsl_lpi2c_edma.c"
    ...
    LPI2C_MasterEnableDMA(base, 0, 0);
    ...
    {
        if (handle->completionCallback != 0)
        {
    ...
    edma_tcd_t *tcd = (edma_tcd_t *)((uint32_t)(&handle->tcds[1]) & (~(0x1fU)));

    _Bool hasSendData = (transfer->direction == kLPI2C_Write) && (transfer->dataSize != 0U);
    _Bool hasReceiveData = (transfer->direction == kLPI2C_Read) && (transfer->dataSize != 0U);

    edma_transfer_config_t transferConfig;
    edma_tcd_t *linkTcd = 0;
    ...
    if (hasSendData)
    {
        ...
        if (commandCount != 0U)
        {
            ...
            EDMA_TcdReset(tcd);
            EDMA_TcdSetTransferConfig(tcd, &transferConfig, 0);
        ...
        else
        {
            ...
            EDMA_SetTransferConfig(handle->tx->base, handle->tx->channel, &transferConfig, 0);
    ...
    else if (hasReceiveData)
    {
        ...
        if (((0) != 0) || (0U == commandCount))
        {

            EDMA_SetTransferConfig(handle->rx->base, handle->rx->channel, &transferConfig, 0);
        ...
        else
        {
            ...
            edma_tcd_t *tcdSetRxClearTxDMA = (edma_tcd_t *)((uint32_t)(&handle->tcds[2]) & (~(0x1fU)));
    ...
    if (hasReceiveData || (0 == (0)))
    {
        EDMA_StartTransfer(handle->rx);
    }

    if ((hasSendData || (commandCount != 0U)) && ((0) != 0))
    {
        EDMA_StartTransfer(handle->tx);
    }


    LPI2C_MasterEnableDMA(base, 1, 1);
...
# 435 "../../libraries/sdk/drives/fsl_lpi2c_edma.c"
status_t LPI2C_MasterTransferGetCountEDMA(LPI2C_Type *base, lpi2c_master_edma_handle_t *handle, size_t *count)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_lpi2c_edma.c", 437),
# 437 "../../libraries/sdk/drives/fsl_lpi2c_edma.c"
#pragma clang diagnostic push
# 437 "../../libraries/sdk/drives/fsl_lpi2c_edma.c"
#pragma clang diagnostic ignored "-Wassume"
# 437 "../../libraries/sdk/drives/fsl_lpi2c_edma.c"
...
# 485 "../../libraries/sdk/drives/fsl_lpi2c_edma.c"
status_t LPI2C_MasterTransferAbortEDMA(LPI2C_Type *base, lpi2c_master_edma_handle_t *handle)
{
...
static void LPI2C_MasterTransferEdmaHandleIRQ(LPI2C_Type *base, void *lpi2cMasterEdmaHandle)
{
    ((lpi2cMasterEdmaHandle != 0) ? (void)0 : __aeabi_assert("lpi2cMasterEdmaHandle != NULL", "../../libraries/sdk/drives/fsl_lpi2c_edma.c", 550),
# 550 "../../libraries/sdk/drives/fsl_lpi2c_edma.c"
#pragma clang diagnostic push
# 550 "../../libraries/sdk/drives/fsl_lpi2c_edma.c"
#pragma clang diagnostic ignored "-Wassume"
# 550 "../../libraries/sdk/drives/fsl_lpi2c_edma.c"
    (__builtin_assume)((lpi2cMasterEdmaHandle != 0)?1:0)
# 550 "../../libraries/sdk/drives/fsl_lpi2c_edma.c"
#pragma clang diagnostic pop
# 550 "../../libraries/sdk/drives/fsl_lpi2c_edma.c"
    );
