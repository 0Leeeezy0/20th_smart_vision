# 1 "../../libraries/sdk/drives/fsl_pit.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/sdk/drives/fsl_pit.c" 2
...
# 11 "../../libraries/sdk/drives/fsl_pit.h"
...
# 12 "../../libraries/sdk/drives/fsl_pit.h" 2
...
# 10 "../../libraries/sdk/drives/fsl_pit.c" 2
# 26 "../../libraries/sdk/drives/fsl_pit.c"
...
static PIT_Type *const s_pitBases[] = { ((PIT_Type *)(0x40084000u)) };



static const clock_ip_name_t s_pitClocks[] = { kCLOCK_Pit };
...
static uint32_t PIT_GetInstance(PIT_Type *base)
{
    ...
    for (instance = 0; instance < (sizeof(s_pitBases) / sizeof((s_pitBases)[0])); instance++)
    {
    ...
    ((instance < (sizeof(s_pitBases) / sizeof((s_pitBases)[0]))) ? (void)0 : __aeabi_assert("instance < ARRAY_SIZE(s_pitBases)", "../../libraries/sdk/drives/fsl_pit.c", 55),
# 55 "../../libraries/sdk/drives/fsl_pit.c"
#pragma clang diagnostic push
# 55 "../../libraries/sdk/drives/fsl_pit.c"
#pragma clang diagnostic ignored "-Wassume"
# 55 "../../libraries/sdk/drives/fsl_pit.c"
    (__builtin_assume)((instance < (sizeof(s_pitBases) / sizeof((s_pitBases)[0])))?1:0)
# 55 "../../libraries/sdk/drives/fsl_pit.c"
#pragma clang diagnostic pop
# 55 "../../libraries/sdk/drives/fsl_pit.c"
    );
...
# 68 "../../libraries/sdk/drives/fsl_pit.c"
void PIT_Init(PIT_Type *base, const pit_config_t *config)
{
    ((0 != config) ? (void)0 : __aeabi_assert("NULL != config", "../../libraries/sdk/drives/fsl_pit.c", 70),
# 70 "../../libraries/sdk/drives/fsl_pit.c"
#pragma clang diagnostic push
# 70 "../../libraries/sdk/drives/fsl_pit.c"
#pragma clang diagnostic ignored "-Wassume"
# 70 "../../libraries/sdk/drives/fsl_pit.c"
...
# 70 "../../libraries/sdk/drives/fsl_pit.c"
    ...
    for (uint8_t i = 0U; i < (uint32_t)(4); i++)
    {
        base->CHANNEL[i].TCTRL &= ~((0x1U) | (0x2U) | (0x4U));
    }



    if (1 == config->enableRunInDebug)
    {
        base->MCR &= ~(0x1U);
    }
    else
...
# 134 "../../libraries/sdk/drives/fsl_pit.c"
uint64_t PIT_GetLifetimeTimerCount(PIT_Type *base)
{
    uint32_t valueH = 0U;
    uint32_t valueL = 0U;
