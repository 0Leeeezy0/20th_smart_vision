# 1 "../../libraries/sdk/drives/fsl_adc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/sdk/drives/fsl_adc.c" 2
...
# 1 "../../libraries/sdk/drives/fsl_adc.h" 1
# 12 "../../libraries/sdk/drives/fsl_adc.h"
...
# 13 "../../libraries/sdk/drives/fsl_adc.h" 2
# 28 "../../libraries/sdk/drives/fsl_adc.h"
typedef enum _adc_status_flags
{
    kADC_ConversionActiveFlag = (0x1U),
    kADC_CalibrationFailedFlag = (0x2U),
...
{
    _Bool enableOverWrite;
    _Bool enableContinuousConversion;
    _Bool enableHighSpeed;
    _Bool enableLowPower;
    _Bool enableLongSample;
    _Bool enableAsynchronousClockOutput;
...
# 172 "../../libraries/sdk/drives/fsl_adc.h"
...
typedef struct _adc_channel_config
{
    ...
    _Bool enableInterruptOnConversionCompleted;
} adc_channel_config_t;
# 208 "../../libraries/sdk/drives/fsl_adc.h"
...
# 236 "../../libraries/sdk/drives/fsl_adc.h"
void ADC_GetDefaultConfig(adc_config_t *config);
# 265 "../../libraries/sdk/drives/fsl_adc.h"
void ADC_SetChannelConfig(ADC_Type *base, uint32_t channelGroup, const adc_channel_config_t *config);
# 275 "../../libraries/sdk/drives/fsl_adc.h"
static inline uint32_t ADC_GetChannelConversionValue(ADC_Type *base, uint32_t channelGroup)
{
    ((channelGroup < (uint32_t)(8)) ? (void)0 : __aeabi_assert("channelGroup < (uint32_t)FSL_FEATURE_ADC_CONVERSION_CONTROL_COUNT", "../../libraries/sdk/drives/fsl_adc.h", 277),
# 277 "../../libraries/sdk/drives/fsl_adc.h"
#pragma clang diagnostic push
# 277 "../../libraries/sdk/drives/fsl_adc.h"
#pragma clang diagnostic ignored "-Wassume"
# 277 "../../libraries/sdk/drives/fsl_adc.h"
    (__builtin_assume)((channelGroup < (uint32_t)(8))?1:0)
# 277 "../../libraries/sdk/drives/fsl_adc.h"
#pragma clang diagnostic pop
# 277 "../../libraries/sdk/drives/fsl_adc.h"
    );
...
# 299 "../../libraries/sdk/drives/fsl_adc.h"
static inline uint32_t ADC_GetChannelStatusFlags(ADC_Type *base, uint32_t channelGroup)
{
    ((channelGroup < (uint32_t)(8)) ? (void)0 : __aeabi_assert("channelGroup < (uint32_t)FSL_FEATURE_ADC_CONVERSION_CONTROL_COUNT", "../../libraries/sdk/drives/fsl_adc.h", 301),
# 301 "../../libraries/sdk/drives/fsl_adc.h"
#pragma clang diagnostic push
# 301 "../../libraries/sdk/drives/fsl_adc.h"
#pragma clang diagnostic ignored "-Wassume"
# 301 "../../libraries/sdk/drives/fsl_adc.h"
...
# 320 "../../libraries/sdk/drives/fsl_adc.h"
...
static inline void ADC_EnableDMA(ADC_Type *base, _Bool enable)
{
    if (enable)
    {
        base->GC |= (0x2U);
...
# 355 "../../libraries/sdk/drives/fsl_adc.h"
static inline void ADC_EnableHardwareTrigger(ADC_Type *base, _Bool enable)
{
    if (enable)
    {
        base->CFG |= (0x2000U);
...
# 10 "../../libraries/sdk/drives/fsl_adc.c" 2
# 24 "../../libraries/sdk/drives/fsl_adc.c"
...
static ADC_Type *const s_adcBases[] = { (ADC_Type *)0u, ((ADC_Type *)(0x400C4000u)), ((ADC_Type *)(0x400C8000u)) };



static const clock_ip_name_t s_adcClocks[] = { kCLOCK_IpInvalid, kCLOCK_Adc1, kCLOCK_Adc2 };
...
static uint32_t ADC_GetInstance(ADC_Type *base)
{
    ...
    for (instance = 0; instance < (sizeof(s_adcBases) / sizeof((s_adcBases)[0])); instance++)
    {
    ...
    ((instance < (sizeof(s_adcBases) / sizeof((s_adcBases)[0]))) ? (void)0 : __aeabi_assert("instance < ARRAY_SIZE(s_adcBases)", "../../libraries/sdk/drives/fsl_adc.c", 53),
# 53 "../../libraries/sdk/drives/fsl_adc.c"
#pragma clang diagnostic push
# 53 "../../libraries/sdk/drives/fsl_adc.c"
#pragma clang diagnostic ignored "-Wassume"
# 53 "../../libraries/sdk/drives/fsl_adc.c"
    (__builtin_assume)((instance < (sizeof(s_adcBases) / sizeof((s_adcBases)[0])))?1:0)
# 53 "../../libraries/sdk/drives/fsl_adc.c"
#pragma clang diagnostic pop
# 53 "../../libraries/sdk/drives/fsl_adc.c"
    );
...
void ADC_Init(ADC_Type *base, const adc_config_t *config)
{
    ((0 != config) ? (void)0 : __aeabi_assert("NULL != config", "../../libraries/sdk/drives/fsl_adc.c", 66),
# 66 "../../libraries/sdk/drives/fsl_adc.c"
#pragma clang diagnostic push
# 66 "../../libraries/sdk/drives/fsl_adc.c"
#pragma clang diagnostic ignored "-Wassume"
# 66 "../../libraries/sdk/drives/fsl_adc.c"
...
# 66 "../../libraries/sdk/drives/fsl_adc.c"
    ...
    tmp32 = base->CFG & ((0xC000U) | (0x2000U));
    tmp32 |= (((uint32_t)(((uint32_t)(config->referenceVoltageSource)) << (11U))) & (0x1800U)) | (((uint32_t)(((uint32_t)(config->samplePeriodMode)) << (8U))) & (0x300U)) |
             (((uint32_t)(((uint32_t)(config->clockSource)) << (0U))) & (0x3U)) | (((uint32_t)(((uint32_t)(config->clockDriver)) << (5U))) & (0x60U)) | (((uint32_t)(((uint32_t)(config->resolution)) << (2U))) & (0xCU));
...
# 142 "../../libraries/sdk/drives/fsl_adc.c"
void ADC_GetDefaultConfig(adc_config_t *config)
{
    ((0 != config) ? (void)0 : __aeabi_assert("NULL != config", "../../libraries/sdk/drives/fsl_adc.c", 144),
# 144 "../../libraries/sdk/drives/fsl_adc.c"
#pragma clang diagnostic push
# 144 "../../libraries/sdk/drives/fsl_adc.c"
#pragma clang diagnostic ignored "-Wassume"
# 144 "../../libraries/sdk/drives/fsl_adc.c"
...
# 144 "../../libraries/sdk/drives/fsl_adc.c"
    ...
    config->enableAsynchronousClockOutput = 1;
    config->enableOverWrite = 0;
    config->enableContinuousConversion = 0;
    config->enableHighSpeed = 0;
    config->enableLowPower = 0;
    config->enableLongSample = 0;
...
# 189 "../../libraries/sdk/drives/fsl_adc.c"
void ADC_SetChannelConfig(ADC_Type *base, uint32_t channelGroup, const adc_channel_config_t *config)
{
    ((0 != config) ? (void)0 : __aeabi_assert("NULL != config", "../../libraries/sdk/drives/fsl_adc.c", 191),
# 191 "../../libraries/sdk/drives/fsl_adc.c"
#pragma clang diagnostic push
# 191 "../../libraries/sdk/drives/fsl_adc.c"
#pragma clang diagnostic ignored "-Wassume"
# 191 "../../libraries/sdk/drives/fsl_adc.c"
...
# 191 "../../libraries/sdk/drives/fsl_adc.c"
    ...
    ((channelGroup < (uint32_t)(8)) ? (void)0 : __aeabi_assert("channelGroup < (uint32_t)FSL_FEATURE_ADC_CONVERSION_CONTROL_COUNT", "../../libraries/sdk/drives/fsl_adc.c", 192),
# 192 "../../libraries/sdk/drives/fsl_adc.c"
#pragma clang diagnostic push
# 192 "../../libraries/sdk/drives/fsl_adc.c"
#pragma clang diagnostic ignored "-Wassume"
# 192 "../../libraries/sdk/drives/fsl_adc.c"
...
# 192 "../../libraries/sdk/drives/fsl_adc.c"
    ...
    tmp32 = (((uint32_t)(((uint32_t)(config->channelNumber)) << (0U))) & (0x1FU));
...
# 224 "../../libraries/sdk/drives/fsl_adc.c"
status_t ADC_DoAutoCalibration(ADC_Type *base)
{
    status_t status = kStatus_Success;
    ...
    if (0U != ((0x2000U) & base->CFG))
    {
        bHWTrigger = 1;
        ADC_EnableHardwareTrigger(base, 0);
    }
...
void ADC_SetOffsetConfig(ADC_Type *base, const adc_offest_config_t *config)
{
    ((0 != config) ? (void)0 : __aeabi_assert("NULL != config", "../../libraries/sdk/drives/fsl_adc.c", 286),
# 286 "../../libraries/sdk/drives/fsl_adc.c"
#pragma clang diagnostic push
# 286 "../../libraries/sdk/drives/fsl_adc.c"
#pragma clang diagnostic ignored "-Wassume"
# 286 "../../libraries/sdk/drives/fsl_adc.c"
...
# 286 "../../libraries/sdk/drives/fsl_adc.c"
    ...
    tmp32 = (((uint32_t)(((uint32_t)(config->offsetValue)) << (0U))) & (0xFFFU));
...
# 311 "../../libraries/sdk/drives/fsl_adc.c"
void ADC_SetHardwareCompareConfig(ADC_Type *base, const adc_hardware_compare_config_t *config)
{
    uint32_t tmp32;

    tmp32 = base->GC & ~((0x10U) | (0x8U) | (0x4U));
    if (0 == config)
    {
        base->GC = tmp32;
        return;
    ...
    switch (config->hardwareCompareMode)
    {
        ...
        case kADC_HardwareCompareMode3:
            ...
            break;
        default:
            ((0) ? (void)0 : __aeabi_assert("false", "../../libraries/sdk/drives/fsl_adc.c", 339),
# 339 "../../libraries/sdk/drives/fsl_adc.c"
#pragma clang diagnostic push
# 339 "../../libraries/sdk/drives/fsl_adc.c"
#pragma clang diagnostic ignored "-Wassume"
# 339 "../../libraries/sdk/drives/fsl_adc.c"
...
# 339 "../../libraries/sdk/drives/fsl_adc.c"
    ...
    tmp32 = (((uint32_t)(((uint32_t)(config->value1)) << (0U))) & (0xFFFU)) | (((uint32_t)(((uint32_t)(config->value2)) << (16U))) & (0xFFF0000U));
    base->CV = tmp32;
}
# 359 "../../libraries/sdk/drives/fsl_adc.c"
void ADC_SetHardwareAverageConfig(ADC_Type *base, adc_hardware_average_mode_t mode)
{
    uint32_t tmp32;
    ...
    {
        tmp32 = base->CFG & ~(0xC000U);
        tmp32 |= (((uint32_t)(((uint32_t)(mode)) << (14U))) & (0xC000U));
        base->CFG = tmp32;
        base->GC |= (0x20U);
    }
}
