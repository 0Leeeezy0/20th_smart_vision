# 1 "../../libraries/sdk/drives/fsl_sai.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/sdk/drives/fsl_sai.c" 2
...
# 1 "../../libraries/sdk/drives/fsl_sai.h" 1
# 12 "../../libraries/sdk/drives/fsl_sai.h"
...
# 13 "../../libraries/sdk/drives/fsl_sai.h" 2
# 29 "../../libraries/sdk/drives/fsl_sai.h"
enum
{
    kStatus_SAI_TxBusy = ((((kStatusGroup_SAI)*100L) + (0))),
    kStatus_SAI_RxBusy = ((((kStatusGroup_SAI)*100L) + (1))),
    kStatus_SAI_TxError = ((((kStatusGroup_SAI)*100L) + (2))),
    kStatus_SAI_RxError = ((((kStatusGroup_SAI)*100L) + (3))),
    kStatus_SAI_QueueFull = ((((kStatusGroup_SAI)*100L) + (4))),
    kStatus_SAI_TxIdle = ((((kStatusGroup_SAI)*100L) + (5))),
    kStatus_SAI_RxIdle = ((((kStatusGroup_SAI)*100L) + (6)))
};
...
# 119 "../../libraries/sdk/drives/fsl_sai.h"
...
enum
{
    kSAI_WordStartInterruptEnable =
        (0x1000U),
    kSAI_SyncErrorInterruptEnable = (0x800U),
    kSAI_FIFOWarningInterruptEnable = (0x200U),
    kSAI_FIFOErrorInterruptEnable = (0x400U),

    kSAI_FIFORequestInterruptEnable = (0x100U),
...
enum
{
    kSAI_FIFOWarningDMAEnable = (0x2U),

    kSAI_FIFORequestDMAEnable = (0x1U),
...
enum
{
    kSAI_WordStartFlag = (0x100000U),
    kSAI_SyncErrorFlag = (0x80000U),
    kSAI_FIFOErrorFlag = (0x40000U),

    kSAI_FIFORequestFlag = (0x10000U),

    kSAI_FIFOWarningFlag = (0x20000U),
};


typedef enum _sai_reset_type
{
    kSAI_ResetTypeSoftware = (0x1000000U),
    kSAI_ResetTypeFIFO = (0x2000000U),
    kSAI_ResetAll = (0x1000000U) | (0x2000000U)
} sai_reset_type_t;
...
typedef struct _sai_transfer_format
{
    ...
    uint8_t watermark;
# 289 "../../libraries/sdk/drives/fsl_sai.h"
    uint8_t channel;
    uint8_t channelMask;
    uint8_t endChannel;
    uint8_t channelNums;
    ...
    sai_protocol_t protocol;
    _Bool isFrameSyncCompact;

} sai_transfer_format_t;
# 331 "../../libraries/sdk/drives/fsl_sai.h"
typedef struct _sai_fifo
{

    _Bool fifoContinueOneError;
...
typedef struct _sai_frame_sync
{
    ...
    _Bool frameSyncEarly;



    _Bool frameSyncGenerateOnDemand;
...
struct _sai_handle
{
    ...
    void *userData;
    uint8_t bitWidth;
# 442 "../../libraries/sdk/drives/fsl_sai.h"
    uint8_t channel;
    uint8_t channelMask;
    uint8_t endChannel;
    uint8_t channelNums;
...
# 484 "../../libraries/sdk/drives/fsl_sai.h"
void SAI_TxInit(I2S_Type *base, const sai_config_t *config);
# 501 "../../libraries/sdk/drives/fsl_sai.h"
void SAI_RxInit(I2S_Type *base, const sai_config_t *config);
# 520 "../../libraries/sdk/drives/fsl_sai.h"
void SAI_TxGetDefaultConfig(sai_config_t *config);
# 539 "../../libraries/sdk/drives/fsl_sai.h"
void SAI_RxGetDefaultConfig(sai_config_t *config);
# 548 "../../libraries/sdk/drives/fsl_sai.h"
void SAI_Init(I2S_Type *base);
# 558 "../../libraries/sdk/drives/fsl_sai.h"
void SAI_Deinit(I2S_Type *base);
# 567 "../../libraries/sdk/drives/fsl_sai.h"
void SAI_TxReset(I2S_Type *base);
# 576 "../../libraries/sdk/drives/fsl_sai.h"
...
void SAI_TxEnable(I2S_Type *base, _Bool enable);
...
# 642 "../../libraries/sdk/drives/fsl_sai.h"
...
# 662 "../../libraries/sdk/drives/fsl_sai.h"
...
# 683 "../../libraries/sdk/drives/fsl_sai.h"
...
# 695 "../../libraries/sdk/drives/fsl_sai.h"
void SAI_RxSetBitClockRate(
    I2S_Type *base, uint32_t sourceClockHz, uint32_t sampleRate, uint32_t bitWidth, uint32_t channelNumbers);
# 705 "../../libraries/sdk/drives/fsl_sai.h"
void SAI_TxSetBitclockConfig(I2S_Type *base, sai_master_slave_t masterSlave, sai_bit_clock_t *config);
# 714 "../../libraries/sdk/drives/fsl_sai.h"
void SAI_RxSetBitclockConfig(I2S_Type *base, sai_master_slave_t masterSlave, sai_bit_clock_t *config);
# 734 "../../libraries/sdk/drives/fsl_sai.h"
...
# 752 "../../libraries/sdk/drives/fsl_sai.h"
void SAI_TxSetFrameSyncConfig(I2S_Type *base, sai_master_slave_t masterSlave, sai_frame_sync_t *config);
# 761 "../../libraries/sdk/drives/fsl_sai.h"
...
# 803 "../../libraries/sdk/drives/fsl_sai.h"
...
# 1033 "../../libraries/sdk/drives/fsl_sai.h"
...
# 1054 "../../libraries/sdk/drives/fsl_sai.h"
static inline void SAI_TxSetFIFOErrorContinue(I2S_Type *base, _Bool isEnabled)
{
    if (isEnabled)
    {
        base->TCR4 |= (0x10000000U);
    }
    else
    {
        base->TCR4 &= ~(0x10000000U);
...
# 1075 "../../libraries/sdk/drives/fsl_sai.h"
static inline void SAI_RxSetFIFOErrorContinue(I2S_Type *base, _Bool isEnabled)
{
    if (isEnabled)
    {
        base->RCR4 |= (0x10000000U);
    }
    else
    {
        base->RCR4 &= ~(0x10000000U);
...
# 1107 "../../libraries/sdk/drives/fsl_sai.h"
static inline void SAI_TxEnableInterrupts(I2S_Type *base, uint32_t mask)
{
    base->TCSR = ((base->TCSR & 0xFFE3FFFFU) | mask);
}
# 1124 "../../libraries/sdk/drives/fsl_sai.h"
static inline void SAI_RxEnableInterrupts(I2S_Type *base, uint32_t mask)
{
    base->RCSR = ((base->RCSR & 0xFFE3FFFFU) | mask);
}
# 1141 "../../libraries/sdk/drives/fsl_sai.h"
static inline void SAI_TxDisableInterrupts(I2S_Type *base, uint32_t mask)
{
    base->TCSR = ((base->TCSR & 0xFFE3FFFFU) & (~mask));
}
# 1158 "../../libraries/sdk/drives/fsl_sai.h"
static inline void SAI_RxDisableInterrupts(I2S_Type *base, uint32_t mask)
{
    base->RCSR = ((base->RCSR & 0xFFE3FFFFU) & (~mask));
}
# 1179 "../../libraries/sdk/drives/fsl_sai.h"
static inline void SAI_TxEnableDMA(I2S_Type *base, uint32_t mask, _Bool enable)
{
    if (enable)
    {
        base->TCSR = ((base->TCSR & 0xFFE3FFFFU) | mask);
...
# 1200 "../../libraries/sdk/drives/fsl_sai.h"
static inline void SAI_RxEnableDMA(I2S_Type *base, uint32_t mask, _Bool enable)
{
    if (enable)
    {
        base->RCSR = ((base->RCSR & 0xFFE3FFFFU) | mask);
...
# 1318 "../../libraries/sdk/drives/fsl_sai.h"
static inline void SAI_WriteData(I2S_Type *base, uint32_t channel, uint32_t data)
{
    base->TDR[channel] = data;
}
# 1334 "../../libraries/sdk/drives/fsl_sai.h"
void SAI_ReadBlocking(I2S_Type *base, uint32_t channel, uint32_t bitWidth, uint8_t *buffer, uint32_t size);
# 1348 "../../libraries/sdk/drives/fsl_sai.h"
void SAI_ReadMultiChannelBlocking(
    I2S_Type *base, uint32_t channel, uint32_t channelMask, uint32_t bitWidth, uint8_t *buffer, uint32_t size);
# 1358 "../../libraries/sdk/drives/fsl_sai.h"
static inline uint32_t SAI_ReadData(I2S_Type *base, uint32_t channel)
{
    return base->RDR[channel];
}
# 1381 "../../libraries/sdk/drives/fsl_sai.h"
void SAI_TransferTxCreateHandle(I2S_Type *base, sai_handle_t *handle, sai_transfer_callback_t callback, void *userData);
# 1394 "../../libraries/sdk/drives/fsl_sai.h"
void SAI_TransferRxCreateHandle(I2S_Type *base, sai_handle_t *handle, sai_transfer_callback_t callback, void *userData);
# 1406 "../../libraries/sdk/drives/fsl_sai.h"
void SAI_TransferTxSetConfig(I2S_Type *base, sai_handle_t *handle, sai_transceiver_t *config);
# 1418 "../../libraries/sdk/drives/fsl_sai.h"
void SAI_TransferRxSetConfig(I2S_Type *base, sai_handle_t *handle, sai_transceiver_t *config);
# 1435 "../../libraries/sdk/drives/fsl_sai.h"
status_t SAI_TransferTxSetFormat(I2S_Type *base,
                                 sai_handle_t *handle,
                                 sai_transfer_format_t *format,
                                 uint32_t mclkSourceClockHz,
                                 uint32_t bclkSourceClockHz);
# 1456 "../../libraries/sdk/drives/fsl_sai.h"
status_t SAI_TransferRxSetFormat(I2S_Type *base,
                                 sai_handle_t *handle,
                                 sai_transfer_format_t *format,
                                 uint32_t mclkSourceClockHz,
                                 uint32_t bclkSourceClockHz);
# 1477 "../../libraries/sdk/drives/fsl_sai.h"
status_t SAI_TransferSendNonBlocking(I2S_Type *base, sai_handle_t *handle, sai_transfer_t *xfer);
# 1494 "../../libraries/sdk/drives/fsl_sai.h"
status_t SAI_TransferReceiveNonBlocking(I2S_Type *base, sai_handle_t *handle, sai_transfer_t *xfer);
# 1505 "../../libraries/sdk/drives/fsl_sai.h"
status_t SAI_TransferGetSendCount(I2S_Type *base, sai_handle_t *handle, size_t *count);
# 1516 "../../libraries/sdk/drives/fsl_sai.h"
status_t SAI_TransferGetReceiveCount(I2S_Type *base, sai_handle_t *handle, size_t *count);
# 1527 "../../libraries/sdk/drives/fsl_sai.h"
void SAI_TransferAbortSend(I2S_Type *base, sai_handle_t *handle);
# 1538 "../../libraries/sdk/drives/fsl_sai.h"
void SAI_TransferAbortReceive(I2S_Type *base, sai_handle_t *handle);
# 1549 "../../libraries/sdk/drives/fsl_sai.h"
void SAI_TransferTerminateSend(I2S_Type *base, sai_handle_t *handle);
# 1560 "../../libraries/sdk/drives/fsl_sai.h"
...
# 10 "../../libraries/sdk/drives/fsl_sai.c" 2
# 20 "../../libraries/sdk/drives/fsl_sai.c"
enum
{
    kSAI_Busy = 0x0U,
    kSAI_Idle,
...
# 46 "../../libraries/sdk/drives/fsl_sai.c"
static _Bool SAI_RxGetEnabledInterruptStatus(I2S_Type *base, uint32_t enableFlag, uint32_t statusFlag);
# 56 "../../libraries/sdk/drives/fsl_sai.c"
static _Bool SAI_TxGetEnabledInterruptStatus(I2S_Type *base, uint32_t enableFlag, uint32_t statusFlag);
# 68 "../../libraries/sdk/drives/fsl_sai.c"
static _Bool SAI_TxGetEnabledInterruptStatus(I2S_Type *base, uint32_t enableFlag, uint32_t statusFlag);
# 91 "../../libraries/sdk/drives/fsl_sai.c"
static uint32_t SAI_GetInstance(I2S_Type *base);
# 104 "../../libraries/sdk/drives/fsl_sai.c"
static void SAI_WriteNonBlocking(I2S_Type *base,
                                 ...
                                 uint8_t *buffer,
                                 uint32_t size);
# 123 "../../libraries/sdk/drives/fsl_sai.c"
static void SAI_ReadNonBlocking(I2S_Type *base,
                                ...
                                uint8_t *buffer,
                                uint32_t size);
# 139 "../../libraries/sdk/drives/fsl_sai.c"
...
static I2S_Type *const s_saiBases[] = { (I2S_Type *)0u, ((I2S_Type *)(0x40384000u)), ((I2S_Type *)(0x40388000u)), ((I2S_Type *)(0x4038C000u)) };

static sai_handle_t *s_saiHandle[(sizeof(s_saiBases) / sizeof((s_saiBases)[0]))][2];

static const IRQn_Type s_saiTxIRQ[] = { NotAvail_IRQn, SAI1_IRQn, SAI2_IRQn, SAI3_TX_IRQn };
static const IRQn_Type s_saiRxIRQ[] = { NotAvail_IRQn, SAI1_IRQn, SAI2_IRQn, SAI3_RX_IRQn };


static const clock_ip_name_t s_saiClock[] = { kCLOCK_IpInvalid, kCLOCK_Sai1, kCLOCK_Sai2, kCLOCK_Sai3 };
...
static _Bool SAI_RxGetEnabledInterruptStatus(I2S_Type *base, uint32_t enableFlag, uint32_t statusFlag)
{
    ...
    return (((rcsr) & ((uint32_t)enableFlag)) != 0UL) && (((rcsr) & ((uint32_t)statusFlag)) != 0UL);
}
...
static _Bool SAI_TxGetEnabledInterruptStatus(I2S_Type *base, uint32_t enableFlag, uint32_t statusFlag)
{
    ...
    return (((tcsr) & ((uint32_t)enableFlag)) != 0UL) && (((tcsr) & ((uint32_t)statusFlag)) != 0UL);
}
# 259 "../../libraries/sdk/drives/fsl_sai.c"
static uint32_t SAI_GetInstance(I2S_Type *base)
{
    uint32_t instance;


    for (instance = 0; instance < (sizeof(s_saiBases) / sizeof((s_saiBases)[0])); instance++)
    {
    ...
    ((instance < (sizeof(s_saiBases) / sizeof((s_saiBases)[0]))) ? (void)0 : __aeabi_assert("instance < ARRAY_SIZE(s_saiBases)", "../../libraries/sdk/drives/fsl_sai.c", 272),
# 272 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic push
# 272 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic ignored "-Wassume"
# 272 "../../libraries/sdk/drives/fsl_sai.c"
    (__builtin_assume)((instance < (sizeof(s_saiBases) / sizeof((s_saiBases)[0])))?1:0)
# 272 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic pop
# 272 "../../libraries/sdk/drives/fsl_sai.c"
    );
                                 ...
                                 uint32_t size)
{
    ...
    for (i = 0; i < size / bytesPerWord; i++)
    {
        ...
        {
            if (((((1UL << j)) & ((uint32_t)channelMask)) != 0UL))
            {
...
static void SAI_GetCommonConfig(sai_transceiver_t *config,
                                ...
                                uint32_t saiChannelMask)
{
    ((0 != config) ? (void)0 : __aeabi_assert("NULL != config", "../../libraries/sdk/drives/fsl_sai.c", 345),
# 345 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic push
# 345 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic ignored "-Wassume"
# 345 "../../libraries/sdk/drives/fsl_sai.c"
...
# 345 "../../libraries/sdk/drives/fsl_sai.c"
    ...
    ((saiChannelMask != 0U) ? (void)0 : __aeabi_assert("saiChannelMask != 0U", "../../libraries/sdk/drives/fsl_sai.c", 346),
# 346 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic push
# 346 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic ignored "-Wassume"
# 346 "../../libraries/sdk/drives/fsl_sai.c"
    (__builtin_assume)((saiChannelMask != 0U)?1:0)
# 346 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic pop
# 346 "../../libraries/sdk/drives/fsl_sai.c"
    );
    ...
    config->bitClock.bclkSrcSwap = 0;
    config->bitClock.bclkInputDelay = 0;
    ...
    config->frameSync.frameSyncEarly = 1;

    config->frameSync.frameSyncGenerateOnDemand = 0;
    ...
    config->fifo.fifoWatermark = (uint8_t)((uint32_t)(32) / 2U);



    config->fifo.fifoContinueOneError = 1;

}
# 409 "../../libraries/sdk/drives/fsl_sai.c"
void SAI_TxInit(I2S_Type *base, const sai_config_t *config)
{
    uint32_t val = 0;
...
# 430 "../../libraries/sdk/drives/fsl_sai.c"
    SAI_TxReset(base);


    if (config->protocol == kSAI_BusLeftJustified)
    {
        base->TCR2 |= (0x2000000U);
        base->TCR3 &= ~(0x1FU);
        base->TCR4 = (((uint32_t)(((uint32_t)(1U)) << (4U))) & (0x10U)) | (((uint32_t)(((uint32_t)(31U)) << (8U))) & (0x1F00U)) | (((uint32_t)(((uint32_t)(0U)) << (3U))) & (0x8U)) | (((uint32_t)(((uint32_t)(0U)) << (1U))) & (0x2U)) | (((uint32_t)(((uint32_t)(1U)) << (16U))) & (0x1F0000U));
    }
    ...
    else if (config->protocol == kSAI_BusI2S)
    {
        base->TCR2 |= (0x2000000U);
        base->TCR3 &= ~(0x1FU);
        base->TCR4 = (((uint32_t)(((uint32_t)(1U)) << (4U))) & (0x10U)) | (((uint32_t)(((uint32_t)(31U)) << (8U))) & (0x1F00U)) | (((uint32_t)(((uint32_t)(1U)) << (3U))) & (0x8U)) | (((uint32_t)(((uint32_t)(1U)) << (1U))) & (0x2U)) | (((uint32_t)(((uint32_t)(1U)) << (16U))) & (0x1F0000U));
    }
    else if (config->protocol == kSAI_BusPCMA)
    {
        base->TCR2 &= ~(0x2000000U);
        base->TCR3 &= ~(0x1FU);
        base->TCR4 = (((uint32_t)(((uint32_t)(1U)) << (4U))) & (0x10U)) | (((uint32_t)(((uint32_t)(0U)) << (8U))) & (0x1F00U)) | (((uint32_t)(((uint32_t)(1U)) << (3U))) & (0x8U)) | (((uint32_t)(((uint32_t)(0U)) << (1U))) & (0x2U)) | (((uint32_t)(((uint32_t)(1U)) << (16U))) & (0x1F0000U));
    }
    else
    {
        base->TCR2 &= ~(0x2000000U);
        base->TCR3 &= ~(0x1FU);
        base->TCR4 = (((uint32_t)(((uint32_t)(1U)) << (4U))) & (0x10U)) | (((uint32_t)(((uint32_t)(0U)) << (8U))) & (0x1F00U)) | (((uint32_t)(((uint32_t)(0U)) << (3U))) & (0x8U)) | (((uint32_t)(((uint32_t)(0U)) << (1U))) & (0x2U)) | (((uint32_t)(((uint32_t)(1U)) << (16U))) & (0x1F0000U));
    }
    ...
    if (config->masterSlave == kSAI_Master)
    {
        ...
        val = base->TCR2 & (~(0xC000000U));
        base->TCR2 = (val | (((uint32_t)(((uint32_t)(config->bclkSource)) << (26U))) & (0xC000000U)));
    }
    else
    {
        base->TCR2 &= ~(0x1000000U);
    ...
    if (config->syncMode == kSAI_ModeAsync)
    {
        val = base->TCR2;
        val &= ~(0x40000000U);
        base->TCR2 = (val | (((uint32_t)(((uint32_t)(0U)) << (30U))) & (0x40000000U)));
    }
    if (config->syncMode == kSAI_ModeSync)
    {
        val = base->TCR2;
        val &= ~(0x40000000U);
        base->TCR2 = (val | (((uint32_t)(((uint32_t)(1U)) << (30U))) & (0x40000000U)));

        val = base->RCR2;
        val &= ~(0x40000000U);
        base->RCR2 = (val | (((uint32_t)(((uint32_t)(0U)) << (30U))) & (0x40000000U)));
    }
# 513 "../../libraries/sdk/drives/fsl_sai.c"
    SAI_TxSetFIFOErrorContinue(base, 1);

}
# 533 "../../libraries/sdk/drives/fsl_sai.c"
void SAI_RxInit(I2S_Type *base, const sai_config_t *config)
{
    uint32_t val = 0;
    ...
    (void)CLOCK_EnableClock(s_saiClock[SAI_GetInstance(base)]);
# 554 "../../libraries/sdk/drives/fsl_sai.c"
    SAI_RxReset(base);


    if (config->protocol == kSAI_BusLeftJustified)
    {
        base->RCR2 |= (0x2000000U);
        base->RCR3 &= ~(0x1FU);
        base->RCR4 = (((uint32_t)(((uint32_t)(1U)) << (4U))) & (0x10U)) | (((uint32_t)(((uint32_t)(31U)) << (8U))) & (0x1F00U)) | (((uint32_t)(((uint32_t)(0U)) << (3U))) & (0x8U)) | (((uint32_t)(((uint32_t)(0U)) << (1U))) & (0x2U)) | (((uint32_t)(((uint32_t)(1U)) << (16U))) & (0x1F0000U));
    }
    else if (config->protocol == kSAI_BusRightJustified)
    {
        base->RCR2 |= (0x2000000U);
    ...
    else if (config->protocol == kSAI_BusI2S)
    {
        base->RCR2 |= (0x2000000U);
        base->RCR3 &= ~(0x1FU);
        base->RCR4 = (((uint32_t)(((uint32_t)(1U)) << (4U))) & (0x10U)) | (((uint32_t)(((uint32_t)(31U)) << (8U))) & (0x1F00U)) | (((uint32_t)(((uint32_t)(1U)) << (3U))) & (0x8U)) | (((uint32_t)(((uint32_t)(1U)) << (1U))) & (0x2U)) | (((uint32_t)(((uint32_t)(1U)) << (16U))) & (0x1F0000U));
    }
    else if (config->protocol == kSAI_BusPCMA)
    {
        base->RCR2 &= ~(0x2000000U);
        base->RCR3 &= ~(0x1FU);
        base->RCR4 = (((uint32_t)(((uint32_t)(1U)) << (4U))) & (0x10U)) | (((uint32_t)(((uint32_t)(0U)) << (8U))) & (0x1F00U)) | (((uint32_t)(((uint32_t)(1U)) << (3U))) & (0x8U)) | (((uint32_t)(((uint32_t)(0U)) << (1U))) & (0x2U)) | (((uint32_t)(((uint32_t)(1U)) << (16U))) & (0x1F0000U));
    }
    else
    {
        base->RCR2 &= ~(0x2000000U);
        base->RCR3 &= ~(0x1FU);
        base->RCR4 = (((uint32_t)(((uint32_t)(1U)) << (4U))) & (0x10U)) | (((uint32_t)(((uint32_t)(0U)) << (8U))) & (0x1F00U)) | (((uint32_t)(((uint32_t)(0U)) << (3U))) & (0x8U)) | (((uint32_t)(((uint32_t)(0U)) << (1U))) & (0x2U)) | (((uint32_t)(((uint32_t)(1U)) << (16U))) & (0x1F0000U));
    }
    ...
    if (config->masterSlave == kSAI_Master)
    {
        ...
        val = base->RCR2 & (~(0xC000000U));
        base->RCR2 = (val | (((uint32_t)(((uint32_t)(config->bclkSource)) << (26U))) & (0xC000000U)));
    }
    else
    {
        base->RCR2 &= ~(0x1000000U);
    ...
    if (config->syncMode == kSAI_ModeSync)
    {
        val = base->RCR2;
        val &= ~(0x40000000U);
        base->RCR2 = (val | (((uint32_t)(((uint32_t)(1U)) << (30U))) & (0x40000000U)));

        val = base->TCR2;
        val &= ~(0x40000000U);
        base->TCR2 = (val | (((uint32_t)(((uint32_t)(0U)) << (30U))) & (0x40000000U)));
    }
# 637 "../../libraries/sdk/drives/fsl_sai.c"
    SAI_RxSetFIFOErrorContinue(base, 1);

}
# 648 "../../libraries/sdk/drives/fsl_sai.c"
void SAI_Init(I2S_Type *base)
{
    ...
    base->TCSR &=
        ~((0x100U) | (0x200U) | (0x400U) | (0x1U) | (0x2U));
    base->RCSR &=
        ~((0x100U) | (0x200U) | (0x400U) | (0x1U) | (0x2U));
...
# 676 "../../libraries/sdk/drives/fsl_sai.c"
void SAI_Deinit(I2S_Type *base)
{
    SAI_TxEnable(base, 0);
    SAI_RxEnable(base, 0);
...
# 702 "../../libraries/sdk/drives/fsl_sai.c"
void SAI_TxGetDefaultConfig(sai_config_t *config)
{
...
# 736 "../../libraries/sdk/drives/fsl_sai.c"
void SAI_RxGetDefaultConfig(sai_config_t *config)
{
...
# 760 "../../libraries/sdk/drives/fsl_sai.c"
void SAI_TxReset(I2S_Type *base)
{

    base->TCSR = (0x1000000U) | (0x2000000U);


    base->TCSR &= ~(0x1000000U);
...
# 783 "../../libraries/sdk/drives/fsl_sai.c"
void SAI_RxReset(I2S_Type *base)
{

    base->RCSR = (0x1000000U) | (0x2000000U);


    base->RCSR &= ~(0x1000000U);
...
void SAI_TxEnable(I2S_Type *base, _Bool enable)
{
    if (enable)
    {
        ...
        if (((base->TCR2 & (0x40000000U)) >> (30U)) == 0x1U)
        {
            base->RCSR = ((base->RCSR & 0xFFE3FFFFU) | (0x80000000U));
        }
        base->TCSR = ((base->TCSR & 0xFFE3FFFFU) | (0x80000000U));
    ...
    else
    {
        ...
        if (((base->RCR2 & (0x40000000U)) >> (30U)) != 0x1U)
        {
...
# 870 "../../libraries/sdk/drives/fsl_sai.c"
void SAI_TxSoftwareReset(I2S_Type *base, sai_reset_type_t resetType)
{
...
# 889 "../../libraries/sdk/drives/fsl_sai.c"
void SAI_RxSoftwareReset(I2S_Type *base, sai_reset_type_t resetType)
{
...
# 904 "../../libraries/sdk/drives/fsl_sai.c"
void SAI_TxSetChannelFIFOMask(I2S_Type *base, uint8_t mask)
{
    base->TCR3 &= ~(0xF0000U);
    base->TCR3 |= (((uint32_t)(((uint32_t)(mask)) << (16U))) & (0xF0000U));
}
# 917 "../../libraries/sdk/drives/fsl_sai.c"
void SAI_RxSetChannelFIFOMask(I2S_Type *base, uint8_t mask)
{
    base->RCR3 &= ~(0xF0000U);
    base->RCR3 |= (((uint32_t)(((uint32_t)(mask)) << (16U))) & (0xF0000U));
}
...
void SAI_TxSetDataOrder(I2S_Type *base, sai_data_order_t order)
{
    uint32_t val = (base->TCR4) & (~(0x10U));

    val |= (((uint32_t)(((uint32_t)(order)) << (4U))) & (0x10U));
    base->TCR4 = val;
}
...
void SAI_TxSetBitClockPolarity(I2S_Type *base, sai_clock_polarity_t polarity)
{
    uint32_t val = (base->TCR2) & (~(0x2000000U));

    val |= (((uint32_t)(((uint32_t)(polarity)) << (25U))) & (0x2000000U));
    base->TCR2 = val;
}
...
void SAI_RxSetBitClockPolarity(I2S_Type *base, sai_clock_polarity_t polarity)
{
    uint32_t val = (base->RCR2) & (~(0x2000000U));
...
void SAI_TxSetFrameSyncPolarity(I2S_Type *base, sai_clock_polarity_t polarity)
{
    uint32_t val = (base->TCR4) & (~(0x2U));

    val |= (((uint32_t)(((uint32_t)(polarity)) << (1U))) & (0x2U));
    base->TCR4 = val;
}
...
void SAI_RxSetFrameSyncPolarity(I2S_Type *base, sai_clock_polarity_t polarity)
{
    uint32_t val = (base->RCR4) & (~(0x2U));

    val |= (((uint32_t)(((uint32_t)(polarity)) << (1U))) & (0x2U));
    base->RCR4 = val;
}
# 1014 "../../libraries/sdk/drives/fsl_sai.c"
void SAI_TxSetFIFOPacking(I2S_Type *base, sai_fifo_packing_t pack)
{
    uint32_t val = base->TCR4;

    val &= ~(0x3000000U);
    val |= (((uint32_t)(((uint32_t)(pack)) << (24U))) & (0x3000000U));
    base->TCR4 = val;
}
...
# 1048 "../../libraries/sdk/drives/fsl_sai.c"
void SAI_TxSetBitClockRate(
    I2S_Type *base, uint32_t sourceClockHz, uint32_t sampleRate, uint32_t bitWidth, uint32_t channelNumbers)
{
    ...
    ((sourceClockHz >= bitClockFreq) ? (void)0 : __aeabi_assert("sourceClockHz >= bitClockFreq", "../../libraries/sdk/drives/fsl_sai.c", 1055),
# 1055 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic push
# 1055 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic ignored "-Wassume"
# 1055 "../../libraries/sdk/drives/fsl_sai.c"
    (__builtin_assume)((sourceClockHz >= bitClockFreq)?1:0)
# 1055 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic pop
# 1055 "../../libraries/sdk/drives/fsl_sai.c"
    );
...
# 1079 "../../libraries/sdk/drives/fsl_sai.c"
    {
        tcr2 |= (((uint32_t)(((uint32_t)(bitClockDiv / 2U - 1UL)) << (0U))) & (0xFFU));
    }

    base->TCR2 = tcr2;
}
# 1095 "../../libraries/sdk/drives/fsl_sai.c"
void SAI_RxSetBitClockRate(
    I2S_Type *base, uint32_t sourceClockHz, uint32_t sampleRate, uint32_t bitWidth, uint32_t channelNumbers)
{
    ...
    ((sourceClockHz >= bitClockFreq) ? (void)0 : __aeabi_assert("sourceClockHz >= bitClockFreq", "../../libraries/sdk/drives/fsl_sai.c", 1102),
# 1102 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic push
# 1102 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic ignored "-Wassume"
# 1102 "../../libraries/sdk/drives/fsl_sai.c"
...
# 1126 "../../libraries/sdk/drives/fsl_sai.c"
    {
        rcr2 |= (((uint32_t)(((uint32_t)(bitClockDiv / 2U - 1UL)) << (0U))) & (0xFFU));
    }

    base->RCR2 = rcr2;
}
# 1140 "../../libraries/sdk/drives/fsl_sai.c"
void SAI_TxSetBitclockConfig(I2S_Type *base, sai_master_slave_t masterSlave, sai_bit_clock_t *config)
{
    uint32_t tcr2 = base->TCR2;
    ...
    {
        ((config != 0) ? (void)0 : __aeabi_assert("config != NULL", "../../libraries/sdk/drives/fsl_sai.c", 1146),
# 1146 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic push
# 1146 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic ignored "-Wassume"
# 1146 "../../libraries/sdk/drives/fsl_sai.c"
        (__builtin_assume)((config != 0)?1:0)
# 1146 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic pop
# 1146 "../../libraries/sdk/drives/fsl_sai.c"
        );

        tcr2 &= ~((0x1000000U) | (0x2000000U) | (0x10000000U) | (0x20000000U) | (0xC000000U));
        tcr2 |= (((uint32_t)(((uint32_t)(1U)) << (24U))) & (0x1000000U)) | (((uint32_t)(((uint32_t)(config->bclkPolarity)) << (25U))) & (0x2000000U)) | (((uint32_t)(((uint32_t)(config->bclkInputDelay)) << (28U))) & (0x10000000U)) |
                (((uint32_t)(((uint32_t)(config->bclkSrcSwap)) << (29U))) & (0x20000000U)) | (((uint32_t)(((uint32_t)(config->bclkSource)) << (26U))) & (0xC000000U));
    }
    else
    {
        tcr2 &= ~((0x1000000U));
        tcr2 |= (((uint32_t)(((uint32_t)(config->bclkPolarity)) << (25U))) & (0x2000000U));
    }

    base->TCR2 = tcr2;
}
# 1168 "../../libraries/sdk/drives/fsl_sai.c"
void SAI_RxSetBitclockConfig(I2S_Type *base, sai_master_slave_t masterSlave, sai_bit_clock_t *config)
{
    uint32_t rcr2 = base->RCR2;
    ...
    if ((masterSlave == kSAI_Master) || (masterSlave == kSAI_Bclk_Master_FrameSync_Slave))
    {
        ((config != 0) ? (void)0 : __aeabi_assert("config != NULL", "../../libraries/sdk/drives/fsl_sai.c", 1174),
# 1174 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic push
# 1174 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic ignored "-Wassume"
# 1174 "../../libraries/sdk/drives/fsl_sai.c"
...
# 1174 "../../libraries/sdk/drives/fsl_sai.c"
        ...
        rcr2 &= ~((0x1000000U) | (0x2000000U) | (0x10000000U) | (0x20000000U) | (0xC000000U));
        rcr2 |= (((uint32_t)(((uint32_t)(1U)) << (24U))) & (0x1000000U)) | (((uint32_t)(((uint32_t)(config->bclkPolarity)) << (25U))) & (0x2000000U)) | (((uint32_t)(((uint32_t)(config->bclkInputDelay)) << (28U))) & (0x10000000U)) |
                (((uint32_t)(((uint32_t)(config->bclkSrcSwap)) << (29U))) & (0x20000000U)) | (((uint32_t)(((uint32_t)(config->bclkSource)) << (26U))) & (0xC000000U));
    }
    else
    {
        rcr2 &= ~((0x1000000U));
        rcr2 |= (((uint32_t)(((uint32_t)(config->bclkPolarity)) << (25U))) & (0x2000000U));
    }

    base->RCR2 = rcr2;
}
# 1232 "../../libraries/sdk/drives/fsl_sai.c"
void SAI_TxSetFifoConfig(I2S_Type *base, sai_fifo_t *config)
{
    ((config != 0) ? (void)0 : __aeabi_assert("config != NULL", "../../libraries/sdk/drives/fsl_sai.c", 1234),
# 1234 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic push
# 1234 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic ignored "-Wassume"
# 1234 "../../libraries/sdk/drives/fsl_sai.c"
...
# 1234 "../../libraries/sdk/drives/fsl_sai.c"
    ...
    ((config->fifoWatermark <= ((0x1FU) >> (0U))) ? (void)0 : __aeabi_assert("config->fifoWatermark <= (I2S_TCR1_TFW_MASK >> I2S_TCR1_TFW_SHIFT)", "../../libraries/sdk/drives/fsl_sai.c", 1236),
# 1236 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic push
# 1236 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic ignored "-Wassume"
# 1236 "../../libraries/sdk/drives/fsl_sai.c"
    (__builtin_assume)((config->fifoWatermark <= ((0x1FU) >> (0U)))?1:0)
# 1236 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic pop
# 1236 "../../libraries/sdk/drives/fsl_sai.c"
    );
    ...
    tcr4 &= ~(0xC000000U);
    tcr4 |= (((uint32_t)(((uint32_t)(config->fifoCombine)) << (26U))) & (0xC000000U));
    ...
    if (base->TMR == 0U)
    {
        tcr4 |= (((uint32_t)(((uint32_t)(config->fifoContinueOneError)) << (28U))) & (0x10000000U));
    }



    tcr4 &= ~(0x3000000U);
    tcr4 |= (((uint32_t)(((uint32_t)(config->fifoPacking)) << (24U))) & (0x3000000U));


    base->TCR4 = tcr4;


    base->TCR1 = (base->TCR1 & (~(0x1FU))) | (((uint32_t)(((uint32_t)(config->fifoWatermark)) << (0U))) & (0x1FU));
...
void SAI_RxSetFifoConfig(I2S_Type *base, sai_fifo_t *config)
{
    ((config != 0) ? (void)0 : __aeabi_assert("config != NULL", "../../libraries/sdk/drives/fsl_sai.c", 1276),
# 1276 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic push
# 1276 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic ignored "-Wassume"
# 1276 "../../libraries/sdk/drives/fsl_sai.c"
...
# 1276 "../../libraries/sdk/drives/fsl_sai.c"
    ...
    ((config->fifoWatermark <= ((0x1FU) >> (0U))) ? (void)0 : __aeabi_assert("config->fifoWatermark <= (I2S_TCR1_TFW_MASK >> I2S_TCR1_TFW_SHIFT)", "../../libraries/sdk/drives/fsl_sai.c", 1278),
# 1278 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic push
# 1278 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic ignored "-Wassume"
# 1278 "../../libraries/sdk/drives/fsl_sai.c"
...
# 1278 "../../libraries/sdk/drives/fsl_sai.c"
    ...
    rcr4 &= ~(0xC000000U);
    rcr4 |= (((uint32_t)(((uint32_t)(config->fifoCombine)) << (26U))) & (0xC000000U));



    rcr4 &= ~(0x10000000U);
    rcr4 |= (((uint32_t)(((uint32_t)(config->fifoContinueOneError)) << (28U))) & (0x10000000U));



    rcr4 &= ~(0x3000000U);
    rcr4 |= (((uint32_t)(((uint32_t)(config->fifoPacking)) << (24U))) & (0x3000000U));


    base->RCR4 = rcr4;


    base->RCR1 = (base->RCR1 & (~(0x1FU))) | (((uint32_t)(((uint32_t)(config->fifoWatermark)) << (0U))) & (0x1FU));

}
# 1312 "../../libraries/sdk/drives/fsl_sai.c"
void SAI_TxSetFrameSyncConfig(I2S_Type *base, sai_master_slave_t masterSlave, sai_frame_sync_t *config)
{
    ((config != 0) ? (void)0 : __aeabi_assert("config != NULL", "../../libraries/sdk/drives/fsl_sai.c", 1314),
# 1314 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic push
# 1314 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic ignored "-Wassume"
# 1314 "../../libraries/sdk/drives/fsl_sai.c"
...
# 1314 "../../libraries/sdk/drives/fsl_sai.c"
    ...
    (((config->frameSyncWidth - 1UL) <= ((0x1F00U) >> (8U))) ? (void)0 : __aeabi_assert("(config->frameSyncWidth - 1UL) <= (I2S_TCR4_SYWD_MASK >> I2S_TCR4_SYWD_SHIFT)", "../../libraries/sdk/drives/fsl_sai.c", 1315),
# 1315 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic push
# 1315 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic ignored "-Wassume"
# 1315 "../../libraries/sdk/drives/fsl_sai.c"
    (__builtin_assume)(((config->frameSyncWidth - 1UL) <= ((0x1F00U) >> (8U)))?1:0)
# 1315 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic pop
# 1315 "../../libraries/sdk/drives/fsl_sai.c"
    );
    ...
    tcr4 &= ~((0x8U) | (0x2U) | (0x1U) | (0x1F00U));


    tcr4 &= ~(0x4U);
    tcr4 |= (((uint32_t)(((uint32_t)(config->frameSyncGenerateOnDemand)) << (2U))) & (0x4U));


    tcr4 |=
        (((uint32_t)(((uint32_t)(config->frameSyncEarly)) << (3U))) & (0x8U)) | (((uint32_t)(((uint32_t)(config->frameSyncPolarity)) << (1U))) & (0x2U)) |
        (((uint32_t)(((uint32_t)(((masterSlave == kSAI_Master) || (masterSlave == kSAI_Bclk_Slave_FrameSync_Master)) ? 1UL : 0U)) << (0U))) & (0x1U)) |
        (((uint32_t)(((uint32_t)(config->frameSyncWidth - 1UL)) << (8U))) & (0x1F00U));

    base->TCR4 = tcr4;
}
# 1341 "../../libraries/sdk/drives/fsl_sai.c"
void SAI_RxSetFrameSyncConfig(I2S_Type *base, sai_master_slave_t masterSlave, sai_frame_sync_t *config)
{
    ((config != 0) ? (void)0 : __aeabi_assert("config != NULL", "../../libraries/sdk/drives/fsl_sai.c", 1343),
# 1343 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic push
# 1343 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic ignored "-Wassume"
# 1343 "../../libraries/sdk/drives/fsl_sai.c"
...
# 1343 "../../libraries/sdk/drives/fsl_sai.c"
    ...
    (((config->frameSyncWidth - 1UL) <= ((0x1F00U) >> (8U))) ? (void)0 : __aeabi_assert("(config->frameSyncWidth - 1UL) <= (I2S_RCR4_SYWD_MASK >> I2S_RCR4_SYWD_SHIFT)", "../../libraries/sdk/drives/fsl_sai.c", 1344),
# 1344 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic push
# 1344 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic ignored "-Wassume"
# 1344 "../../libraries/sdk/drives/fsl_sai.c"
...
# 1344 "../../libraries/sdk/drives/fsl_sai.c"
    ...
    rcr4 &= ~((0x8U) | (0x2U) | (0x1U) | (0x1F00U));


    rcr4 &= ~(0x4U);
    rcr4 |= (((uint32_t)(((uint32_t)(config->frameSyncGenerateOnDemand)) << (2U))) & (0x4U));
...
void SAI_TxSetSerialDataConfig(I2S_Type *base, sai_serial_data_t *config)
{
    ((config != 0) ? (void)0 : __aeabi_assert("config != NULL", "../../libraries/sdk/drives/fsl_sai.c", 1371),
# 1371 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic push
# 1371 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic ignored "-Wassume"
# 1371 "../../libraries/sdk/drives/fsl_sai.c"
...
# 1371 "../../libraries/sdk/drives/fsl_sai.c"
    ...
    base->TCR5 = (((uint32_t)(((uint32_t)(config->dataWordNLength - 1UL)) << (24U))) & (0x1F000000U)) | (((uint32_t)(((uint32_t)(config->dataWord0Length - 1UL)) << (16U))) & (0x1F0000U)) |
                 (((uint32_t)(((uint32_t)(config->dataFirstBitShifted - 1UL)) << (8U))) & (0x1F00U));
    ...
    tcr4 &= ~((0x1F0000U) | (0x10U));
    tcr4 |= (((uint32_t)(((uint32_t)(config->dataWordNum - 1UL)) << (16U))) & (0x1F0000U)) | (((uint32_t)(((uint32_t)(config->dataOrder)) << (4U))) & (0x10U));


    tcr4 &= ~(0x20U);
    tcr4 |= (((uint32_t)(((uint32_t)(config->dataMode)) << (5U))) & (0x20U));
...
void SAI_RxSetSerialDataConfig(I2S_Type *base, sai_serial_data_t *config)
{
    ((config != 0) ? (void)0 : __aeabi_assert("config != NULL", "../../libraries/sdk/drives/fsl_sai.c", 1405),
# 1405 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic push
# 1405 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic ignored "-Wassume"
# 1405 "../../libraries/sdk/drives/fsl_sai.c"
...
# 1405 "../../libraries/sdk/drives/fsl_sai.c"
    ...
    base->RCR5 = (((uint32_t)(((uint32_t)(config->dataWordNLength - 1UL)) << (24U))) & (0x1F000000U)) | (((uint32_t)(((uint32_t)(config->dataWord0Length - 1UL)) << (16U))) & (0x1F0000U)) |
                 (((uint32_t)(((uint32_t)(config->dataFirstBitShifted - 1UL)) << (8U))) & (0x1F00U));
    base->RMR = config->dataMaskedWord;

    rcr4 &= ~((0x1F0000U) | (0x10U));
    rcr4 |= (((uint32_t)(((uint32_t)(config->dataWordNum - 1uL)) << (16U))) & (0x1F0000U)) | (((uint32_t)(((uint32_t)(config->dataOrder)) << (4U))) & (0x10U));
...
void SAI_TxSetConfig(I2S_Type *base, sai_transceiver_t *config)
{
    ((config != 0) ? (void)0 : __aeabi_assert("config != NULL", "../../libraries/sdk/drives/fsl_sai.c", 1427),
# 1427 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic push
# 1427 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic ignored "-Wassume"
# 1427 "../../libraries/sdk/drives/fsl_sai.c"
...
# 1427 "../../libraries/sdk/drives/fsl_sai.c"
    ...
    (((((base) == ((I2S_Type *)(0x40384000u))) ? (4) : (((base) == ((I2S_Type *)(0x40388000u))) ? (1) : (((base) == ((I2S_Type *)(0x4038C000u))) ? (1) : (-1)))) != -1) ? (void)0 : __aeabi_assert("FSL_FEATURE_SAI_CHANNEL_COUNTn(base) != -1", "../../libraries/sdk/drives/fsl_sai.c", 1428),
# 1428 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic push
# 1428 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic ignored "-Wassume"
# 1428 "../../libraries/sdk/drives/fsl_sai.c"
    (__builtin_assume)(((((base) == ((I2S_Type *)(0x40384000u))) ? (4) : (((base) == ((I2S_Type *)(0x40388000u))) ? (1) : (((base) == ((I2S_Type *)(0x4038C000u))) ? (1) : (-1)))) != -1)?1:0)
# 1428 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic pop
# 1428 "../../libraries/sdk/drives/fsl_sai.c"
    );
    ...
    for (i = 0U; i < (uint32_t)(((base) == ((I2S_Type *)(0x40384000u))) ? (4) : (((base) == ((I2S_Type *)(0x40388000u))) ? (1) : (((base) == ((I2S_Type *)(0x4038C000u))) ? (1) : (-1)))); i++)
    {
        if ((((1UL << i) & ((uint32_t)config->channelMask)) != 0UL))
        {
            channelNums++;
            config->endChannel = i;
        }
    ...
    {
        base->TCR4 &= ~(0xC000000U);
    }



    base->TCR3 &= ~(0xF0000U);
    base->TCR3 |= (((uint32_t)(((uint32_t)(config->channelMask)) << (16U))) & (0xF0000U));
...
# 1507 "../../libraries/sdk/drives/fsl_sai.c"
...
# 1527 "../../libraries/sdk/drives/fsl_sai.c"
void SAI_TransferTxSetConfig(I2S_Type *base, sai_handle_t *handle, sai_transceiver_t *config)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_sai.c", 1529),
# 1529 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic push
# 1529 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic ignored "-Wassume"
# 1529 "../../libraries/sdk/drives/fsl_sai.c"
...
# 1529 "../../libraries/sdk/drives/fsl_sai.c"
    ...
    ((config != 0) ? (void)0 : __aeabi_assert("config != NULL", "../../libraries/sdk/drives/fsl_sai.c", 1530),
# 1530 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic push
# 1530 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic ignored "-Wassume"
# 1530 "../../libraries/sdk/drives/fsl_sai.c"
...
# 1530 "../../libraries/sdk/drives/fsl_sai.c"
    ...
    ((config->channelNums <= (uint32_t)(((base) == ((I2S_Type *)(0x40384000u))) ? (4) : (((base) == ((I2S_Type *)(0x40388000u))) ? (1) : (((base) == ((I2S_Type *)(0x4038C000u))) ? (1) : (-1))))) ? (void)0 : __aeabi_assert("config->channelNums <= (uint32_t)FSL_FEATURE_SAI_CHANNEL_COUNTn(base)", "../../libraries/sdk/drives/fsl_sai.c", 1531),
# 1531 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic push
# 1531 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic ignored "-Wassume"
# 1531 "../../libraries/sdk/drives/fsl_sai.c"
    (__builtin_assume)((config->channelNums <= (uint32_t)(((base) == ((I2S_Type *)(0x40384000u))) ? (4) : (((base) == ((I2S_Type *)(0x40388000u))) ? (1) : (((base) == ((I2S_Type *)(0x4038C000u))) ? (1) : (-1)))))?1:0)
# 1531 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic pop
# 1531 "../../libraries/sdk/drives/fsl_sai.c"
    );
...
void SAI_RxSetConfig(I2S_Type *base, sai_transceiver_t *config)
{
    ((config != 0) ? (void)0 : __aeabi_assert("config != NULL", "../../libraries/sdk/drives/fsl_sai.c", 1556),
# 1556 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic push
# 1556 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic ignored "-Wassume"
# 1556 "../../libraries/sdk/drives/fsl_sai.c"
...
# 1556 "../../libraries/sdk/drives/fsl_sai.c"
    ...
    (((((base) == ((I2S_Type *)(0x40384000u))) ? (4) : (((base) == ((I2S_Type *)(0x40388000u))) ? (1) : (((base) == ((I2S_Type *)(0x4038C000u))) ? (1) : (-1)))) != -1) ? (void)0 : __aeabi_assert("FSL_FEATURE_SAI_CHANNEL_COUNTn(base) != -1", "../../libraries/sdk/drives/fsl_sai.c", 1557),
# 1557 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic push
# 1557 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic ignored "-Wassume"
# 1557 "../../libraries/sdk/drives/fsl_sai.c"
...
# 1557 "../../libraries/sdk/drives/fsl_sai.c"
    ...
    if (config->channelNums > 1U)
    {
        base->RCR4 &= ~(0xC000000U);
    }



    base->RCR3 &= ~(0xF0000U);
    base->RCR3 |= (((uint32_t)(((uint32_t)(config->channelMask)) << (16U))) & (0xF0000U));
...
# 1637 "../../libraries/sdk/drives/fsl_sai.c"
...
# 1657 "../../libraries/sdk/drives/fsl_sai.c"
void SAI_TransferRxSetConfig(I2S_Type *base, sai_handle_t *handle, sai_transceiver_t *config)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_sai.c", 1659),
# 1659 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic push
# 1659 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic ignored "-Wassume"
# 1659 "../../libraries/sdk/drives/fsl_sai.c"
...
# 1659 "../../libraries/sdk/drives/fsl_sai.c"
    ...
    ((config != 0) ? (void)0 : __aeabi_assert("config != NULL", "../../libraries/sdk/drives/fsl_sai.c", 1660),
# 1660 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic push
# 1660 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic ignored "-Wassume"
# 1660 "../../libraries/sdk/drives/fsl_sai.c"
...
# 1685 "../../libraries/sdk/drives/fsl_sai.c"
void SAI_GetClassicI2SConfig(sai_transceiver_t *config,
                             sai_word_width_t bitWidth,
                             sai_mono_stereo_t mode,
                             uint32_t saiChannelMask)
...
# 1701 "../../libraries/sdk/drives/fsl_sai.c"
void SAI_GetLeftJustifiedConfig(sai_transceiver_t *config,
                                sai_word_width_t bitWidth,
                                sai_mono_stereo_t mode,
                                uint32_t saiChannelMask)
{
    ((0 != config) ? (void)0 : __aeabi_assert("NULL != config", "../../libraries/sdk/drives/fsl_sai.c", 1706),
# 1706 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic push
# 1706 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic ignored "-Wassume"
# 1706 "../../libraries/sdk/drives/fsl_sai.c"
...
# 1706 "../../libraries/sdk/drives/fsl_sai.c"
    ...
    ((saiChannelMask != 0U) ? (void)0 : __aeabi_assert("saiChannelMask != 0U", "../../libraries/sdk/drives/fsl_sai.c", 1707),
# 1707 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic push
# 1707 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic ignored "-Wassume"
# 1707 "../../libraries/sdk/drives/fsl_sai.c"
...
# 1707 "../../libraries/sdk/drives/fsl_sai.c"
    ...
    config->frameSync.frameSyncEarly = 0;
    config->frameSync.frameSyncPolarity = kSAI_PolarityActiveHigh;
}
# 1723 "../../libraries/sdk/drives/fsl_sai.c"
void SAI_GetRightJustifiedConfig(sai_transceiver_t *config,
                                 sai_word_width_t bitWidth,
                                 sai_mono_stereo_t mode,
                                 uint32_t saiChannelMask)
{
    ((0 != config) ? (void)0 : __aeabi_assert("NULL != config", "../../libraries/sdk/drives/fsl_sai.c", 1728),
# 1728 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic push
# 1728 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic ignored "-Wassume"
# 1728 "../../libraries/sdk/drives/fsl_sai.c"
...
# 1728 "../../libraries/sdk/drives/fsl_sai.c"
    ...
    ((saiChannelMask != 0U) ? (void)0 : __aeabi_assert("saiChannelMask != 0U", "../../libraries/sdk/drives/fsl_sai.c", 1729),
# 1729 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic push
# 1729 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic ignored "-Wassume"
# 1729 "../../libraries/sdk/drives/fsl_sai.c"
...
# 1760 "../../libraries/sdk/drives/fsl_sai.c"
void SAI_GetDSPConfig(sai_transceiver_t *config,
                      sai_frame_sync_len_t frameSyncWidth,
                      sai_word_width_t bitWidth,
                      sai_mono_stereo_t mode,
                      uint32_t saiChannelMask)
{
    ((0 != config) ? (void)0 : __aeabi_assert("NULL != config", "../../libraries/sdk/drives/fsl_sai.c", 1766),
# 1766 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic push
# 1766 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic ignored "-Wassume"
# 1766 "../../libraries/sdk/drives/fsl_sai.c"
...
# 1766 "../../libraries/sdk/drives/fsl_sai.c"
    ...
    ((saiChannelMask != 0U) ? (void)0 : __aeabi_assert("saiChannelMask != 0U", "../../libraries/sdk/drives/fsl_sai.c", 1767),
# 1767 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic push
# 1767 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic ignored "-Wassume"
# 1767 "../../libraries/sdk/drives/fsl_sai.c"
...
# 1767 "../../libraries/sdk/drives/fsl_sai.c"
    ...
    switch (frameSyncWidth)
    {
        case kSAI_FrameSyncLenOneBitClk:
            ...
            break;
        default:
            ((0) ? (void)0 : __aeabi_assert("false", "../../libraries/sdk/drives/fsl_sai.c", 1778),
# 1778 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic push
# 1778 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic ignored "-Wassume"
# 1778 "../../libraries/sdk/drives/fsl_sai.c"
...
# 1793 "../../libraries/sdk/drives/fsl_sai.c"
void SAI_GetTDMConfig(sai_transceiver_t *config,
                      sai_frame_sync_len_t frameSyncWidth,
                      sai_word_width_t bitWidth,
                      uint32_t dataWordNum,
                      uint32_t saiChannelMask)
{
    ((0 != config) ? (void)0 : __aeabi_assert("NULL != config", "../../libraries/sdk/drives/fsl_sai.c", 1799),
# 1799 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic push
# 1799 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic ignored "-Wassume"
# 1799 "../../libraries/sdk/drives/fsl_sai.c"
...
# 1799 "../../libraries/sdk/drives/fsl_sai.c"
    ...
    ((saiChannelMask != 0U) ? (void)0 : __aeabi_assert("saiChannelMask != 0U", "../../libraries/sdk/drives/fsl_sai.c", 1800),
# 1800 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic push
# 1800 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic ignored "-Wassume"
# 1800 "../../libraries/sdk/drives/fsl_sai.c"
...
# 1800 "../../libraries/sdk/drives/fsl_sai.c"
    ...
    ((dataWordNum <= 32U) ? (void)0 : __aeabi_assert("dataWordNum <= 32U", "../../libraries/sdk/drives/fsl_sai.c", 1801),
# 1801 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic push
# 1801 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic ignored "-Wassume"
# 1801 "../../libraries/sdk/drives/fsl_sai.c"
    (__builtin_assume)((dataWordNum <= 32U)?1:0)
# 1801 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic pop
# 1801 "../../libraries/sdk/drives/fsl_sai.c"
    );
    ...
    switch (frameSyncWidth)
    {
        ...
        case kSAI_FrameSyncLenPerWordWidth:
            break;
        default:
            ((0) ? (void)0 : __aeabi_assert("false", "../../libraries/sdk/drives/fsl_sai.c", 1814),
# 1814 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic push
# 1814 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic ignored "-Wassume"
# 1814 "../../libraries/sdk/drives/fsl_sai.c"
...
# 1836 "../../libraries/sdk/drives/fsl_sai.c"
void SAI_TxSetFormat(I2S_Type *base,
                     sai_transfer_format_t *format,
                     uint32_t mclkSourceClockHz,
                     uint32_t bclkSourceClockHz)
{
    (((((base) == ((I2S_Type *)(0x40384000u))) ? (4) : (((base) == ((I2S_Type *)(0x40388000u))) ? (1) : (((base) == ((I2S_Type *)(0x4038C000u))) ? (1) : (-1)))) != -1) ? (void)0 : __aeabi_assert("FSL_FEATURE_SAI_CHANNEL_COUNTn(base) != -1", "../../libraries/sdk/drives/fsl_sai.c", 1841),
# 1841 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic push
# 1841 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic ignored "-Wassume"
# 1841 "../../libraries/sdk/drives/fsl_sai.c"
...
# 1841 "../../libraries/sdk/drives/fsl_sai.c"
    ...
    if (format->isFrameSyncCompact)
    {
        ...
        val = (base->TCR4 & (~(0x1F00U)));
        val |= (((uint32_t)(((uint32_t)(format->bitWidth - 1U)) << (8U))) & (0x1F00U));
        base->TCR4 = val;
    }
    else
    {
...
# 1870 "../../libraries/sdk/drives/fsl_sai.c"
    if ((((base->TCR2) & ((uint32_t)(0x1000000U))) != 0UL))
    {
        base->TCR2 &= ~(0xFFU);
...
# 1894 "../../libraries/sdk/drives/fsl_sai.c"
        {
            base->TCR2 |= (((uint32_t)(((uint32_t)(divider / 2U - 1U)) << (0U))) & (0xFFU));
        }
    }
    ...
    {
        base->TCR5 = (((uint32_t)(((uint32_t)(val)) << (24U))) & (0x1F000000U)) | (((uint32_t)(((uint32_t)(val)) << (16U))) & (0x1F0000U)) | (((uint32_t)(((uint32_t)(val)) << (8U))) & (0x1F00U));
    }
    else
    {
        if ((((base->TCR4) & ((uint32_t)(0x10U))) != 0UL))
        {
            base->TCR5 = (((uint32_t)(((uint32_t)(val)) << (24U))) & (0x1F000000U)) | (((uint32_t)(((uint32_t)(val)) << (16U))) & (0x1F0000U)) | (((uint32_t)(((uint32_t)(format->bitWidth - 1UL)) << (8U))) & (0x1F00U));
        }
        else
        {
            base->TCR5 = (((uint32_t)(((uint32_t)(val)) << (24U))) & (0x1F000000U)) | (((uint32_t)(((uint32_t)(val)) << (16U))) & (0x1F0000U)) | (((uint32_t)(((uint32_t)(0)) << (8U))) & (0x1F00U));
        }
    }
    ...
    for (i = 0U; i < (uint32_t)(((base) == ((I2S_Type *)(0x40384000u))) ? (4) : (((base) == ((I2S_Type *)(0x40388000u))) ? (1) : (((base) == ((I2S_Type *)(0x4038C000u))) ? (1) : (-1)))); i++)
    {
        if (((((1UL << i)) & ((uint32_t)format->channelMask)) != 0UL))
        {
            channelNums++;
            format->endChannel = i;
        }
    ...
    base->TCR3 &= ~(0xF0000U);
    base->TCR3 |= (((uint32_t)(((uint32_t)(format->channelMask)) << (16U))) & (0xF0000U));
...
# 1979 "../../libraries/sdk/drives/fsl_sai.c"
void SAI_RxSetFormat(I2S_Type *base,
                     sai_transfer_format_t *format,
                     uint32_t mclkSourceClockHz,
                     uint32_t bclkSourceClockHz)
{
    (((((base) == ((I2S_Type *)(0x40384000u))) ? (4) : (((base) == ((I2S_Type *)(0x40388000u))) ? (1) : (((base) == ((I2S_Type *)(0x4038C000u))) ? (1) : (-1)))) != -1) ? (void)0 : __aeabi_assert("FSL_FEATURE_SAI_CHANNEL_COUNTn(base) != -1", "../../libraries/sdk/drives/fsl_sai.c", 1984),
# 1984 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic push
# 1984 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic ignored "-Wassume"
# 1984 "../../libraries/sdk/drives/fsl_sai.c"
...
# 2013 "../../libraries/sdk/drives/fsl_sai.c"
    if ((((base->RCR2) & ((uint32_t)(0x1000000U))) != 0UL))
    {
        base->RCR2 &= ~(0xFFU);
...
# 2036 "../../libraries/sdk/drives/fsl_sai.c"
        {
            base->RCR2 |= (((uint32_t)(((uint32_t)(divider / 2U - 1U)) << (0U))) & (0xFFU));
        }
    }
    ...
    if (format->protocol == kSAI_BusRightJustified)
    {
        base->RCR5 = (((uint32_t)(((uint32_t)(val)) << (24U))) & (0x1F000000U)) | (((uint32_t)(((uint32_t)(val)) << (16U))) & (0x1F0000U)) | (((uint32_t)(((uint32_t)(val)) << (8U))) & (0x1F00U));
    }
    else
    {
        if ((((base->RCR4) & ((uint32_t)(0x10U))) != 0UL))
        {
            base->RCR5 = (((uint32_t)(((uint32_t)(val)) << (24U))) & (0x1F000000U)) | (((uint32_t)(((uint32_t)(val)) << (16U))) & (0x1F0000U)) | (((uint32_t)(((uint32_t)(format->bitWidth - 1UL)) << (8U))) & (0x1F00U));
        }
        else
        {
            base->RCR5 = (((uint32_t)(((uint32_t)(val)) << (24U))) & (0x1F000000U)) | (((uint32_t)(((uint32_t)(val)) << (16U))) & (0x1F0000U)) | (((uint32_t)(((uint32_t)(0UL)) << (8U))) & (0x1F00U));
        }
    }
    ...
    base->RCR3 |= (((uint32_t)(((uint32_t)(format->channelMask)) << (16U))) & (0xF0000U));
...
# 2120 "../../libraries/sdk/drives/fsl_sai.c"
void SAI_WriteBlocking(I2S_Type *base, uint32_t channel, uint32_t bitWidth, uint8_t *buffer, uint32_t size)
{
    uint32_t i = 0;
    uint32_t bytesPerWord = bitWidth / 8U;

    bytesPerWord = (((uint32_t)(32) - base->TCR1) * bytesPerWord);


    while (i < size)
    {

        while (!((((base->TCSR) & ((uint32_t)(0x20000U))) != 0UL)))
        {
        }
...
# 2158 "../../libraries/sdk/drives/fsl_sai.c"
void SAI_WriteMultiChannelBlocking(
    I2S_Type *base, uint32_t channel, uint32_t channelMask, uint32_t bitWidth, uint8_t *buffer, uint32_t size)
{
    (((((base) == ((I2S_Type *)(0x40384000u))) ? (4) : (((base) == ((I2S_Type *)(0x40388000u))) ? (1) : (((base) == ((I2S_Type *)(0x4038C000u))) ? (1) : (-1)))) != -1) ? (void)0 : __aeabi_assert("FSL_FEATURE_SAI_CHANNEL_COUNTn(base) != -1", "../../libraries/sdk/drives/fsl_sai.c", 2161),
# 2161 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic push
# 2161 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic ignored "-Wassume"
# 2161 "../../libraries/sdk/drives/fsl_sai.c"
...
# 2161 "../../libraries/sdk/drives/fsl_sai.c"
    ...
    for (i = 0U; (i < (uint32_t)(((base) == ((I2S_Type *)(0x40384000u))) ? (4) : (((base) == ((I2S_Type *)(0x40388000u))) ? (1) : (((base) == ((I2S_Type *)(0x4038C000u))) ? (1) : (-1))))); i++)
    {
        if (((((1UL << i)) & ((uint32_t)channelMask)) != 0UL))
        {
            channelNums++;
            endChannel = i;
        }
...
# 2213 "../../libraries/sdk/drives/fsl_sai.c"
void SAI_ReadMultiChannelBlocking(
    I2S_Type *base, uint32_t channel, uint32_t channelMask, uint32_t bitWidth, uint8_t *buffer, uint32_t size)
{
    (((((base) == ((I2S_Type *)(0x40384000u))) ? (4) : (((base) == ((I2S_Type *)(0x40388000u))) ? (1) : (((base) == ((I2S_Type *)(0x4038C000u))) ? (1) : (-1)))) != -1) ? (void)0 : __aeabi_assert("FSL_FEATURE_SAI_CHANNEL_COUNTn(base) != -1", "../../libraries/sdk/drives/fsl_sai.c", 2216),
# 2216 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic push
# 2216 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic ignored "-Wassume"
# 2216 "../../libraries/sdk/drives/fsl_sai.c"
...
# 2216 "../../libraries/sdk/drives/fsl_sai.c"
    ...
    while (j < size)
    {
        ...
        while (!((((base->RCSR) & ((uint32_t)(0x20000U))) != 0UL)))
        {
        }
...
# 2260 "../../libraries/sdk/drives/fsl_sai.c"
void SAI_ReadBlocking(I2S_Type *base, uint32_t channel, uint32_t bitWidth, uint8_t *buffer, uint32_t size)
{
    uint32_t i = 0;
    uint32_t bytesPerWord = bitWidth / 8U;
...
# 2292 "../../libraries/sdk/drives/fsl_sai.c"
void SAI_TransferTxCreateHandle(I2S_Type *base, sai_handle_t *handle, sai_transfer_callback_t callback, void *userData)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_sai.c", 2294),
# 2294 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic push
# 2294 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic ignored "-Wassume"
# 2294 "../../libraries/sdk/drives/fsl_sai.c"
...
# 2323 "../../libraries/sdk/drives/fsl_sai.c"
void SAI_TransferRxCreateHandle(I2S_Type *base, sai_handle_t *handle, sai_transfer_callback_t callback, void *userData)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_sai.c", 2325),
# 2325 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic push
# 2325 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic ignored "-Wassume"
# 2325 "../../libraries/sdk/drives/fsl_sai.c"
...
# 2359 "../../libraries/sdk/drives/fsl_sai.c"
status_t SAI_TransferTxSetFormat(I2S_Type *base,
                                 sai_handle_t *handle,
                                 sai_transfer_format_t *format,
                                 uint32_t mclkSourceClockHz,
                                 uint32_t bclkSourceClockHz)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_sai.c", 2365),
# 2365 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic push
# 2365 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic ignored "-Wassume"
# 2365 "../../libraries/sdk/drives/fsl_sai.c"
...
# 2409 "../../libraries/sdk/drives/fsl_sai.c"
status_t SAI_TransferRxSetFormat(I2S_Type *base,
                                 sai_handle_t *handle,
                                 sai_transfer_format_t *format,
                                 uint32_t mclkSourceClockHz,
                                 uint32_t bclkSourceClockHz)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_sai.c", 2415),
# 2415 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic push
# 2415 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic ignored "-Wassume"
# 2415 "../../libraries/sdk/drives/fsl_sai.c"
...
# 2458 "../../libraries/sdk/drives/fsl_sai.c"
status_t SAI_TransferSendNonBlocking(I2S_Type *base, sai_handle_t *handle, sai_transfer_t *xfer)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_sai.c", 2460),
# 2460 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic push
# 2460 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic ignored "-Wassume"
# 2460 "../../libraries/sdk/drives/fsl_sai.c"
...
# 2460 "../../libraries/sdk/drives/fsl_sai.c"
    ...
    ((handle->channelNums <= (uint32_t)(((base) == ((I2S_Type *)(0x40384000u))) ? (4) : (((base) == ((I2S_Type *)(0x40388000u))) ? (1) : (((base) == ((I2S_Type *)(0x4038C000u))) ? (1) : (-1))))) ? (void)0 : __aeabi_assert("handle->channelNums <= (uint32_t)FSL_FEATURE_SAI_CHANNEL_COUNTn(base)", "../../libraries/sdk/drives/fsl_sai.c", 2461),
# 2461 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic push
# 2461 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic ignored "-Wassume"
# 2461 "../../libraries/sdk/drives/fsl_sai.c"
    (__builtin_assume)((handle->channelNums <= (uint32_t)(((base) == ((I2S_Type *)(0x40384000u))) ? (4) : (((base) == ((I2S_Type *)(0x40388000u))) ? (1) : (((base) == ((I2S_Type *)(0x4038C000u))) ? (1) : (-1)))))?1:0)
# 2461 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic pop
# 2461 "../../libraries/sdk/drives/fsl_sai.c"
    );
    ...
    if (handle->saiQueue[handle->queueUser].data != 0)
    {
    ...
    handle->queueUser = (handle->queueUser + 1U) % (uint8_t)(4U);
    ...
    SAI_TxEnableInterrupts(base, (0x400U) | (0x100U));
...
# 2507 "../../libraries/sdk/drives/fsl_sai.c"
status_t SAI_TransferReceiveNonBlocking(I2S_Type *base, sai_handle_t *handle, sai_transfer_t *xfer)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_sai.c", 2509),
# 2509 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic push
# 2509 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic ignored "-Wassume"
# 2509 "../../libraries/sdk/drives/fsl_sai.c"
...
# 2509 "../../libraries/sdk/drives/fsl_sai.c"
    ...
    ((handle->channelNums <= (uint32_t)(((base) == ((I2S_Type *)(0x40384000u))) ? (4) : (((base) == ((I2S_Type *)(0x40388000u))) ? (1) : (((base) == ((I2S_Type *)(0x4038C000u))) ? (1) : (-1))))) ? (void)0 : __aeabi_assert("handle->channelNums <= (uint32_t)FSL_FEATURE_SAI_CHANNEL_COUNTn(base)", "../../libraries/sdk/drives/fsl_sai.c", 2510),
# 2510 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic push
# 2510 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic ignored "-Wassume"
# 2510 "../../libraries/sdk/drives/fsl_sai.c"
...
# 2510 "../../libraries/sdk/drives/fsl_sai.c"
    ...
    SAI_RxEnableInterrupts(base, (0x400U) | (0x100U));
...
# 2550 "../../libraries/sdk/drives/fsl_sai.c"
status_t SAI_TransferGetSendCount(I2S_Type *base, sai_handle_t *handle, size_t *count)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_sai.c", 2552),
# 2552 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic push
# 2552 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic ignored "-Wassume"
# 2552 "../../libraries/sdk/drives/fsl_sai.c"
...
# 2578 "../../libraries/sdk/drives/fsl_sai.c"
status_t SAI_TransferGetReceiveCount(I2S_Type *base, sai_handle_t *handle, size_t *count)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_sai.c", 2580),
# 2580 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic push
# 2580 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic ignored "-Wassume"
# 2580 "../../libraries/sdk/drives/fsl_sai.c"
...
# 2606 "../../libraries/sdk/drives/fsl_sai.c"
void SAI_TransferAbortSend(I2S_Type *base, sai_handle_t *handle)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_sai.c", 2608),
# 2608 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic push
# 2608 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic ignored "-Wassume"
# 2608 "../../libraries/sdk/drives/fsl_sai.c"
...
# 2608 "../../libraries/sdk/drives/fsl_sai.c"
    ...
    SAI_TxDisableInterrupts(base, (0x400U) | (0x100U));
    ...
    (void)memset(handle->saiQueue, 0, sizeof(sai_transfer_t) * (uint8_t)(4U));
    handle->queueDriver = 0;
    handle->queueUser = 0;
}
# 2636 "../../libraries/sdk/drives/fsl_sai.c"
void SAI_TransferAbortReceive(I2S_Type *base, sai_handle_t *handle)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_sai.c", 2638),
# 2638 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic push
# 2638 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic ignored "-Wassume"
# 2638 "../../libraries/sdk/drives/fsl_sai.c"
...
# 2638 "../../libraries/sdk/drives/fsl_sai.c"
    ...
    SAI_RxDisableInterrupts(base, (0x400U) | (0x100U));
...
# 2666 "../../libraries/sdk/drives/fsl_sai.c"
void SAI_TransferTerminateSend(I2S_Type *base, sai_handle_t *handle)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_sai.c", 2668),
# 2668 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic push
# 2668 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic ignored "-Wassume"
# 2668 "../../libraries/sdk/drives/fsl_sai.c"
...
# 2690 "../../libraries/sdk/drives/fsl_sai.c"
void SAI_TransferTerminateReceive(I2S_Type *base, sai_handle_t *handle)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_sai.c", 2692),
# 2692 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic push
# 2692 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic ignored "-Wassume"
# 2692 "../../libraries/sdk/drives/fsl_sai.c"
...
void SAI_TransferTxHandleIRQ(I2S_Type *base, sai_handle_t *handle)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_sai.c", 2713),
# 2713 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic push
# 2713 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic ignored "-Wassume"
# 2713 "../../libraries/sdk/drives/fsl_sai.c"
...
# 2713 "../../libraries/sdk/drives/fsl_sai.c"
    ...
    if ((((base->TCSR) & ((uint32_t)(0x40000U))) != 0UL))
    {

        SAI_TxClearStatusFlags(base, (0x40000U));
    ...
    if ((((base->TCSR) & ((uint32_t)(0x10000U))) != 0UL))
    {

        size_t size = ((((handle->saiQueue[handle->queueDriver].dataSize)) < ((size_t)(((uint32_t)(32) - handle->watermark) * dataSize))) ? ((handle->saiQueue[handle->queueDriver].dataSize)) : ((size_t)(((uint32_t)(32) - handle->watermark) * dataSize)));
...
# 2765 "../../libraries/sdk/drives/fsl_sai.c"
    ...
    if (handle->saiQueue[handle->queueDriver].data == 0)
    {
        SAI_TransferAbortSend(base, handle);
    }
}
...
void SAI_TransferRxHandleIRQ(I2S_Type *base, sai_handle_t *handle)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_sai.c", 2790),
# 2790 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic push
# 2790 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic ignored "-Wassume"
# 2790 "../../libraries/sdk/drives/fsl_sai.c"
...
# 2790 "../../libraries/sdk/drives/fsl_sai.c"
    ...
    if ((((base->RCSR) & ((uint32_t)(0x40000U))) != 0UL))
    {

        SAI_RxClearStatusFlags(base, (0x40000U));
    ...
    if ((((base->RCSR) & ((uint32_t)(0x10000U))) != 0UL))
    {

        size_t size = ((((handle->saiQueue[handle->queueDriver].dataSize)) < (handle->watermark * dataSize)) ? ((handle->saiQueue[handle->queueDriver].dataSize)) : (handle->watermark * dataSize));
...
# 2841 "../../libraries/sdk/drives/fsl_sai.c"
    if (handle->saiQueue[handle->queueDriver].dataSize == 0U)
    {
        (void)memset(&handle->saiQueue[handle->queueDriver], 0, sizeof(sai_transfer_t));
        handle->queueDriver = (handle->queueDriver + 1U) % (uint8_t)(4U);
...
# 3637 "../../libraries/sdk/drives/fsl_sai.c"
void SAI1_DriverIRQHandler(void);
void SAI1_DriverIRQHandler(void)
{

    if ((s_saiHandle[1][1] != 0) && SAI_RxGetEnabledInterruptStatus(((I2S_Type *)(0x40384000u)), ((0x100U) | (0x400U)),
                                                                       ((0x10000U) | (0x40000U))))
    ...
    {
        s_saiRxIsr(((I2S_Type *)(0x40384000u)), s_saiHandle[1][1]);
    }

    if ((s_saiHandle[1][0] != 0) && SAI_TxGetEnabledInterruptStatus(((I2S_Type *)(0x40384000u)), ((0x100U) | (0x400U)),
                                                                       ((0x10000U) | (0x40000U))))
    ...
    {
        s_saiTxIsr(((I2S_Type *)(0x40384000u)), s_saiHandle[1][0]);
    }
    __builtin_arm_dsb(0xF);
}
...
void SAI2_DriverIRQHandler(void)
{
    ...
    if ((s_saiHandle[2][1] != 0) && SAI_RxGetEnabledInterruptStatus(((I2S_Type *)(0x40388000u)), ((0x100U) | (0x400U)),
                                                                       ((0x10000U) | (0x40000U))))
    ...
    {
        s_saiRxIsr(((I2S_Type *)(0x40388000u)), s_saiHandle[2][1]);
    }

    if ((s_saiHandle[2][0] != 0) && SAI_TxGetEnabledInterruptStatus(((I2S_Type *)(0x40388000u)), ((0x100U) | (0x400U)),
                                                                       ((0x10000U) | (0x40000U))))
    ...
    {
        s_saiTxIsr(((I2S_Type *)(0x40388000u)), s_saiHandle[2][0]);
    }
    __builtin_arm_dsb(0xF);
}
...
void SAI3_DriverIRQHandler(void)
{
    ...
    if ((s_saiHandle[3][1] != 0) && SAI_RxGetEnabledInterruptStatus(((I2S_Type *)(0x4038C000u)), ((0x100U) | (0x400U)),
                                                                       ((0x10000U) | (0x40000U))))
    ...
    {
        s_saiRxIsr(((I2S_Type *)(0x4038C000u)), s_saiHandle[3][1]);
    }

    if ((s_saiHandle[3][0] != 0) && SAI_TxGetEnabledInterruptStatus(((I2S_Type *)(0x4038C000u)), ((0x100U) | (0x400U)),
                                                                       ((0x10000U) | (0x40000U))))
    ...
    {
        s_saiTxIsr(((I2S_Type *)(0x4038C000u)), s_saiHandle[3][0]);
    }
    __builtin_arm_dsb(0xF);
}
...
void SAI3_TX_DriverIRQHandler(void)
{
    ((s_saiHandle[3][0] != 0) ? (void)0 : __aeabi_assert("s_saiHandle[3][0] != NULL", "../../libraries/sdk/drives/fsl_sai.c", 3722),
# 3722 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic push
# 3722 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic ignored "-Wassume"
# 3722 "../../libraries/sdk/drives/fsl_sai.c"
    (__builtin_assume)((s_saiHandle[3][0] != 0)?1:0)
# 3722 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic pop
# 3722 "../../libraries/sdk/drives/fsl_sai.c"
    );
...
void SAI3_RX_DriverIRQHandler(void)
{
    ((s_saiHandle[3][1] != 0) ? (void)0 : __aeabi_assert("s_saiHandle[3][1] != NULL", "../../libraries/sdk/drives/fsl_sai.c", 3730),
# 3730 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic push
# 3730 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic ignored "-Wassume"
# 3730 "../../libraries/sdk/drives/fsl_sai.c"
    (__builtin_assume)((s_saiHandle[3][1] != 0)?1:0)
# 3730 "../../libraries/sdk/drives/fsl_sai.c"
#pragma clang diagnostic pop
# 3730 "../../libraries/sdk/drives/fsl_sai.c"
    );
