# 1 "../../libraries/sdk/drives/fsl_flexcan_edma.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/sdk/drives/fsl_flexcan_edma.c" 2
...
# 1 "../../libraries/sdk/drives/fsl_flexcan_edma.h" 1
# 11 "../../libraries/sdk/drives/fsl_flexcan_edma.h"
...
# 12 "../../libraries/sdk/drives/fsl_flexcan_edma.h" 2
...
# 13 "../../libraries/sdk/drives/fsl_flexcan_edma.h" 2
# 30 "../../libraries/sdk/drives/fsl_flexcan_edma.h"
...
{
    KFLEXCAN_RxFifoIdle = 0U,
    KFLEXCAN_RxFifoBusy = 1U,
};
...
static flexcan_edma_private_handle_t s_flexcanEdmaPrivateHandle[(sizeof(s_flexcanBases) / sizeof((s_flexcanBases)[0]))];
# 57 "../../libraries/sdk/drives/fsl_flexcan_edma.c"
static void FLEXCAN_ReceiveFifoEDMACallback(edma_handle_t *handle, void *param, _Bool transferDone, uint32_t tcds);
...
# 109 "../../libraries/sdk/drives/fsl_flexcan_edma.c"
void FLEXCAN_TransferCreateHandleEDMA(CAN_Type *base,
                                      flexcan_edma_handle_t *handle,
                                      flexcan_edma_transfer_callback_t callback,
                                      void *userData,
                                      edma_handle_t *rxFifoEdmaHandle)
{
    ((0 != handle) ? (void)0 : __aeabi_assert("NULL != handle", "../../libraries/sdk/drives/fsl_flexcan_edma.c", 115),
# 115 "../../libraries/sdk/drives/fsl_flexcan_edma.c"
#pragma clang diagnostic push
# 115 "../../libraries/sdk/drives/fsl_flexcan_edma.c"
#pragma clang diagnostic ignored "-Wassume"
# 115 "../../libraries/sdk/drives/fsl_flexcan_edma.c"
...
# 144 "../../libraries/sdk/drives/fsl_flexcan_edma.c"
void FLEXCAN_PrepareTransfConfiguration(CAN_Type *base,
                                        flexcan_fifo_transfer_t *pFifoXfer,
                                        edma_transfer_config_t *pEdmaConfig)
{
    ((0 != pFifoXfer) ? (void)0 : __aeabi_assert("NULL != pFifoXfer", "../../libraries/sdk/drives/fsl_flexcan_edma.c", 148),
# 148 "../../libraries/sdk/drives/fsl_flexcan_edma.c"
#pragma clang diagnostic push
# 148 "../../libraries/sdk/drives/fsl_flexcan_edma.c"
#pragma clang diagnostic ignored "-Wassume"
# 148 "../../libraries/sdk/drives/fsl_flexcan_edma.c"
...
# 148 "../../libraries/sdk/drives/fsl_flexcan_edma.c"
    ...
    ((0 != pFifoXfer->frame) ? (void)0 : __aeabi_assert("NULL != pFifoXfer->frame", "../../libraries/sdk/drives/fsl_flexcan_edma.c", 149),
# 149 "../../libraries/sdk/drives/fsl_flexcan_edma.c"
#pragma clang diagnostic push
# 149 "../../libraries/sdk/drives/fsl_flexcan_edma.c"
#pragma clang diagnostic ignored "-Wassume"
# 149 "../../libraries/sdk/drives/fsl_flexcan_edma.c"
    (__builtin_assume)((0 != pFifoXfer->frame)?1:0)
# 149 "../../libraries/sdk/drives/fsl_flexcan_edma.c"
#pragma clang diagnostic pop
# 149 "../../libraries/sdk/drives/fsl_flexcan_edma.c"
    );
    ((0 != pEdmaConfig) ? (void)0 : __aeabi_assert("NULL != pEdmaConfig", "../../libraries/sdk/drives/fsl_flexcan_edma.c", 150),
# 150 "../../libraries/sdk/drives/fsl_flexcan_edma.c"
#pragma clang diagnostic push
# 150 "../../libraries/sdk/drives/fsl_flexcan_edma.c"
#pragma clang diagnostic ignored "-Wassume"
# 150 "../../libraries/sdk/drives/fsl_flexcan_edma.c"
    (__builtin_assume)((0 != pEdmaConfig)?1:0)
# 150 "../../libraries/sdk/drives/fsl_flexcan_edma.c"
#pragma clang diagnostic pop
# 150 "../../libraries/sdk/drives/fsl_flexcan_edma.c"
    );
...
# 162 "../../libraries/sdk/drives/fsl_flexcan_edma.c"
...
# 178 "../../libraries/sdk/drives/fsl_flexcan_edma.c"
status_t FLEXCAN_StartTransferDatafromRxFIFO(CAN_Type *base,
                                             flexcan_edma_handle_t *handle,
                                             edma_transfer_config_t *pEdmaConfig)
{
    ((0 != handle->rxFifoEdmaHandle) ? (void)0 : __aeabi_assert("NULL != handle->rxFifoEdmaHandle", "../../libraries/sdk/drives/fsl_flexcan_edma.c", 182),
# 182 "../../libraries/sdk/drives/fsl_flexcan_edma.c"
#pragma clang diagnostic push
# 182 "../../libraries/sdk/drives/fsl_flexcan_edma.c"
#pragma clang diagnostic ignored "-Wassume"
# 182 "../../libraries/sdk/drives/fsl_flexcan_edma.c"
    (__builtin_assume)((0 != handle->rxFifoEdmaHandle)?1:0)
# 182 "../../libraries/sdk/drives/fsl_flexcan_edma.c"
#pragma clang diagnostic pop
# 182 "../../libraries/sdk/drives/fsl_flexcan_edma.c"
    );
    ((0 != pEdmaConfig) ? (void)0 : __aeabi_assert("NULL != pEdmaConfig", "../../libraries/sdk/drives/fsl_flexcan_edma.c", 183),
# 183 "../../libraries/sdk/drives/fsl_flexcan_edma.c"
#pragma clang diagnostic push
# 183 "../../libraries/sdk/drives/fsl_flexcan_edma.c"
#pragma clang diagnostic ignored "-Wassume"
# 183 "../../libraries/sdk/drives/fsl_flexcan_edma.c"
...
# 183 "../../libraries/sdk/drives/fsl_flexcan_edma.c"
    ...
    else
    {
        ...
        FLEXCAN_EnableRxFifoDMA(base, 1);
...
# 221 "../../libraries/sdk/drives/fsl_flexcan_edma.c"
status_t FLEXCAN_TransferReceiveFifoEDMA(CAN_Type *base,
                                         flexcan_edma_handle_t *handle,
                                         flexcan_fifo_transfer_t *pFifoXfer)
{
    ((0 != handle->rxFifoEdmaHandle) ? (void)0 : __aeabi_assert("NULL != handle->rxFifoEdmaHandle", "../../libraries/sdk/drives/fsl_flexcan_edma.c", 225),
# 225 "../../libraries/sdk/drives/fsl_flexcan_edma.c"
#pragma clang diagnostic push
# 225 "../../libraries/sdk/drives/fsl_flexcan_edma.c"
#pragma clang diagnostic ignored "-Wassume"
# 225 "../../libraries/sdk/drives/fsl_flexcan_edma.c"
...
# 247 "../../libraries/sdk/drives/fsl_flexcan_edma.c"
void FLEXCAN_TransferAbortReceiveFifoEDMA(CAN_Type *base, flexcan_edma_handle_t *handle)
{
    ((0 != handle->rxFifoEdmaHandle) ? (void)0 : __aeabi_assert("NULL != handle->rxFifoEdmaHandle", "../../libraries/sdk/drives/fsl_flexcan_edma.c", 249),
# 249 "../../libraries/sdk/drives/fsl_flexcan_edma.c"
#pragma clang diagnostic push
# 249 "../../libraries/sdk/drives/fsl_flexcan_edma.c"
#pragma clang diagnostic ignored "-Wassume"
# 249 "../../libraries/sdk/drives/fsl_flexcan_edma.c"
...
# 249 "../../libraries/sdk/drives/fsl_flexcan_edma.c"
    ...
    FLEXCAN_EnableRxFifoDMA(base, 0);
}
