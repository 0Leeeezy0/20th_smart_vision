# 1 "../../libraries/sdk/drives/fsl_snvs_hp.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/sdk/drives/fsl_snvs_hp.c" 2
...
# 1 "../../libraries/sdk/drives/fsl_snvs_hp.h" 1
# 12 "../../libraries/sdk/drives/fsl_snvs_hp.h"
...
# 13 "../../libraries/sdk/drives/fsl_snvs_hp.h" 2
# 29 "../../libraries/sdk/drives/fsl_snvs_hp.h"
typedef enum _snvs_hp_interrupts
{
    kSNVS_RTC_AlarmInterrupt = (0x2U),
    kSNVS_RTC_PeriodicInterrupt = (0x8U),
} snvs_hp_interrupts_t;


typedef enum _snvs_hp_status_flags
{
    kSNVS_RTC_AlarmInterruptFlag = (0x1U),
    kSNVS_RTC_PeriodicInterruptFlag = (0x2U),
    kSNVS_ZMK_ZeroFlag = (int)(0x80000000U),
    kSNVS_OTPMK_ZeroFlag = (0x8000000U),
} snvs_hp_status_flags_t;
# 66 "../../libraries/sdk/drives/fsl_snvs_hp.h"
typedef enum _snvs_hp_sv_status_flags
{
    kSNVS_LP_ViolationFlag = (0x8000U),
    kSNVS_ZMK_EccFailFlag = (0x8000000U),

    kSNVS_LP_SoftwareViolationFlag = (0x8000U),
    kSNVS_FatalSoftwareViolationFlag = (0x4000U),
    kSNVS_SoftwareViolationFlag = (0x2000U),
    kSNVS_Violation0Flag = (0x1U),
    kSNVS_Violation1Flag = (0x2U),
    kSNVS_Violation2Flag = (0x4U),

    kSNVS_Violation3Flag = (0x8U),

    kSNVS_Violation4Flag = (0x10U),
    kSNVS_Violation5Flag = (0x20U),
} snvs_hp_sv_status_flags_t;
# 93 "../../libraries/sdk/drives/fsl_snvs_hp.h"
...
# 112 "../../libraries/sdk/drives/fsl_snvs_hp.h"
...
# 155 "../../libraries/sdk/drives/fsl_snvs_hp.h"
...
# 172 "../../libraries/sdk/drives/fsl_snvs_hp.h"
...
# 192 "../../libraries/sdk/drives/fsl_snvs_hp.h"
void SNVS_HP_RTC_GetDefaultConfig(snvs_hp_rtc_config_t *config);
# 210 "../../libraries/sdk/drives/fsl_snvs_hp.h"
...
# 234 "../../libraries/sdk/drives/fsl_snvs_hp.h"
...
{
    base->HPCR &= ~(0x1U);
    while ((base->HPCR & (0x1U)) != 0U)
    {
    }
}
# 364 "../../libraries/sdk/drives/fsl_snvs_hp.h"
static inline void SNVS_HP_EnableMasterKeySelection(SNVS_Type *base, _Bool enable)
{
    if (enable)
    {
        base->HPCOMR |= (0x2000U);
...
{
    return (snvs_hp_ssm_state_t)((uint32_t)((base->HPSR & (0xF00U)) >> (8U)));
}
# 453 "../../libraries/sdk/drives/fsl_snvs_hp.h"
static inline void SNVS_HP_ResetLP(SNVS_Type *base)
{
    base->HPCOMR |= (0x10U);
}
# 469 "../../libraries/sdk/drives/fsl_snvs_hp.h"
static inline void SNVS_HP_EnableHighAssuranceCounter(SNVS_Type *base, _Bool enable)
{
    if (enable)
    {
        base->HPCOMR |= (0x10000U);
    }
    else
    {
        base->HPCOMR &= (~(0x10000U));
...
static inline void SNVS_HP_StartHighAssuranceCounter(SNVS_Type *base, _Bool start)
{
    if (start)
    {
        base->HPCOMR &= (~(0x80000U));
    }
    else
    {
        base->HPCOMR |= (0x80000U);
...
# 545 "../../libraries/sdk/drives/fsl_snvs_hp.h"
static inline void SNVS_HP_ClearHighAssuranceCounter(SNVS_Type *base)
{
    base->HPCOMR |= (0x40000U);
}
# 558 "../../libraries/sdk/drives/fsl_snvs_hp.h"
static inline void SNVS_HP_LockHighAssuranceCounter(SNVS_Type *base)
{
    base->HPLR |= (0x40000U);
}
# 574 "../../libraries/sdk/drives/fsl_snvs_hp.h"
static inline uint32_t SNVS_HP_GetStatusFlags(SNVS_Type *base)
{
    return base->HPSR;
}
# 591 "../../libraries/sdk/drives/fsl_snvs_hp.h"
static inline void SNVS_HP_ClearStatusFlags(SNVS_Type *base, uint32_t mask)
{
    base->HPSR = mask;
}
# 605 "../../libraries/sdk/drives/fsl_snvs_hp.h"
static inline uint32_t SNVS_HP_GetSecurityViolationStatusFlags(SNVS_Type *base)
{
    return base->HPSVSR;
}
# 628 "../../libraries/sdk/drives/fsl_snvs_hp.h"
static inline void SNVS_HP_ClearSecurityViolationStatusFlags(SNVS_Type *base, uint32_t mask)
{
    base->HPSVSR = mask;
}
# 10 "../../libraries/sdk/drives/fsl_snvs_hp.c" 2
# 44 "../../libraries/sdk/drives/fsl_snvs_hp.c"
static _Bool SNVS_HP_CheckDatetimeFormat(const snvs_hp_rtc_datetime_t *datetime);
# 53 "../../libraries/sdk/drives/fsl_snvs_hp.c"
...
# 72 "../../libraries/sdk/drives/fsl_snvs_hp.c"
static uint32_t SNVS_HP_RTC_GetSeconds(SNVS_Type *base);
# 98 "../../libraries/sdk/drives/fsl_snvs_hp.c"
static _Bool SNVS_HP_CheckDatetimeFormat(const snvs_hp_rtc_datetime_t *datetime)
{
    ((datetime != 0) ? (void)0 : __aeabi_assert("datetime != NULL", "../../libraries/sdk/drives/fsl_snvs_hp.c", 100),
# 100 "../../libraries/sdk/drives/fsl_snvs_hp.c"
#pragma clang diagnostic push
# 100 "../../libraries/sdk/drives/fsl_snvs_hp.c"
#pragma clang diagnostic ignored "-Wassume"
# 100 "../../libraries/sdk/drives/fsl_snvs_hp.c"
    (__builtin_assume)((datetime != 0)?1:0)
# 100 "../../libraries/sdk/drives/fsl_snvs_hp.c"
#pragma clang diagnostic pop
# 100 "../../libraries/sdk/drives/fsl_snvs_hp.c"
    );
...
static uint32_t SNVS_HP_ConvertDatetimeToSeconds(const snvs_hp_rtc_datetime_t *datetime)
{
    ((datetime != 0) ? (void)0 : __aeabi_assert("datetime != NULL", "../../libraries/sdk/drives/fsl_snvs_hp.c", 132),
# 132 "../../libraries/sdk/drives/fsl_snvs_hp.c"
#pragma clang diagnostic push
# 132 "../../libraries/sdk/drives/fsl_snvs_hp.c"
#pragma clang diagnostic ignored "-Wassume"
# 132 "../../libraries/sdk/drives/fsl_snvs_hp.c"
...
# 132 "../../libraries/sdk/drives/fsl_snvs_hp.c"
    ...
    seconds = (((uint32_t)datetime->year - 1970U) * (365U));
...
static void SNVS_HP_ConvertSecondsToDatetime(uint32_t seconds, snvs_hp_rtc_datetime_t *datetime)
{
    ((datetime != 0) ? (void)0 : __aeabi_assert("datetime != NULL", "../../libraries/sdk/drives/fsl_snvs_hp.c", 162),
# 162 "../../libraries/sdk/drives/fsl_snvs_hp.c"
#pragma clang diagnostic push
# 162 "../../libraries/sdk/drives/fsl_snvs_hp.c"
#pragma clang diagnostic ignored "-Wassume"
# 162 "../../libraries/sdk/drives/fsl_snvs_hp.c"
...
# 162 "../../libraries/sdk/drives/fsl_snvs_hp.c"
    ...
    days = secondsRemaining / (86400U) + 1U;


    secondsRemaining = secondsRemaining % (86400U);


    datetime->hour = (uint8_t)(secondsRemaining / (3600U));
    secondsRemaining = secondsRemaining % (3600U);
    datetime->minute = (uint8_t)(secondsRemaining / 60U);
    datetime->second = (uint8_t)(secondsRemaining % (60U));
...
# 246 "../../libraries/sdk/drives/fsl_snvs_hp.c"
void SNVS_HP_Init(SNVS_Type *base)
{
...
# 277 "../../libraries/sdk/drives/fsl_snvs_hp.c"
void SNVS_HP_RTC_Init(SNVS_Type *base, const snvs_hp_rtc_config_t *config)
{
    ((config != 0) ? (void)0 : __aeabi_assert("config != NULL", "../../libraries/sdk/drives/fsl_snvs_hp.c", 279),
# 279 "../../libraries/sdk/drives/fsl_snvs_hp.c"
#pragma clang diagnostic push
# 279 "../../libraries/sdk/drives/fsl_snvs_hp.c"
#pragma clang diagnostic ignored "-Wassume"
# 279 "../../libraries/sdk/drives/fsl_snvs_hp.c"
...
# 279 "../../libraries/sdk/drives/fsl_snvs_hp.c"
    ...
    base->HPCOMR |= (0x80000000U);

    base->HPCR = (base->HPCR & ~(0xF0U)) | (((uint32_t)(((uint32_t)(config->periodicInterruptFreq)) << (4U))) & (0xF0U));

    if (config->rtcCalEnable)
    {
        base->HPCR = (base->HPCR & ~(0x7C00U)) | (((uint32_t)(((uint32_t)(config->rtcCalValue)) << (10U))) & (0x7C00U));
        base->HPCR |= (0x100U);
    }
}
...
# 317 "../../libraries/sdk/drives/fsl_snvs_hp.c"
void SNVS_HP_RTC_GetDefaultConfig(snvs_hp_rtc_config_t *config)
{
    ((config != 0) ? (void)0 : __aeabi_assert("config != NULL", "../../libraries/sdk/drives/fsl_snvs_hp.c", 319),
# 319 "../../libraries/sdk/drives/fsl_snvs_hp.c"
#pragma clang diagnostic push
# 319 "../../libraries/sdk/drives/fsl_snvs_hp.c"
#pragma clang diagnostic ignored "-Wassume"
# 319 "../../libraries/sdk/drives/fsl_snvs_hp.c"
...
# 354 "../../libraries/sdk/drives/fsl_snvs_hp.c"
status_t SNVS_HP_RTC_SetDatetime(SNVS_Type *base, const snvs_hp_rtc_datetime_t *datetime)
{
    ((datetime != 0) ? (void)0 : __aeabi_assert("datetime != NULL", "../../libraries/sdk/drives/fsl_snvs_hp.c", 356),
# 356 "../../libraries/sdk/drives/fsl_snvs_hp.c"
#pragma clang diagnostic push
# 356 "../../libraries/sdk/drives/fsl_snvs_hp.c"
#pragma clang diagnostic ignored "-Wassume"
# 356 "../../libraries/sdk/drives/fsl_snvs_hp.c"
...
void SNVS_HP_RTC_GetDatetime(SNVS_Type *base, snvs_hp_rtc_datetime_t *datetime)
{
    ((datetime != 0) ? (void)0 : __aeabi_assert("datetime != NULL", "../../libraries/sdk/drives/fsl_snvs_hp.c", 393),
# 393 "../../libraries/sdk/drives/fsl_snvs_hp.c"
#pragma clang diagnostic push
# 393 "../../libraries/sdk/drives/fsl_snvs_hp.c"
#pragma clang diagnostic ignored "-Wassume"
# 393 "../../libraries/sdk/drives/fsl_snvs_hp.c"
...
# 412 "../../libraries/sdk/drives/fsl_snvs_hp.c"
status_t SNVS_HP_RTC_SetAlarm(SNVS_Type *base, const snvs_hp_rtc_datetime_t *alarmTime)
{
    ((alarmTime != 0) ? (void)0 : __aeabi_assert("alarmTime != NULL", "../../libraries/sdk/drives/fsl_snvs_hp.c", 414),
# 414 "../../libraries/sdk/drives/fsl_snvs_hp.c"
#pragma clang diagnostic push
# 414 "../../libraries/sdk/drives/fsl_snvs_hp.c"
#pragma clang diagnostic ignored "-Wassume"
# 414 "../../libraries/sdk/drives/fsl_snvs_hp.c"
    (__builtin_assume)((alarmTime != 0)?1:0)
# 414 "../../libraries/sdk/drives/fsl_snvs_hp.c"
#pragma clang diagnostic pop
# 414 "../../libraries/sdk/drives/fsl_snvs_hp.c"
    );
...
void SNVS_HP_RTC_GetAlarm(SNVS_Type *base, snvs_hp_rtc_datetime_t *datetime)
{
    ((datetime != 0) ? (void)0 : __aeabi_assert("datetime != NULL", "../../libraries/sdk/drives/fsl_snvs_hp.c", 459),
# 459 "../../libraries/sdk/drives/fsl_snvs_hp.c"
#pragma clang diagnostic push
# 459 "../../libraries/sdk/drives/fsl_snvs_hp.c"
#pragma clang diagnostic ignored "-Wassume"
# 459 "../../libraries/sdk/drives/fsl_snvs_hp.c"
...
# 501 "../../libraries/sdk/drives/fsl_snvs_hp.c"
uint32_t SNVS_HP_RTC_GetStatusFlags(SNVS_Type *base)
{
    uint32_t flags = 0U;

    if ((base->HPSR & (0x2U)) != 0U)
    {
        flags |= (uint32_t)kSNVS_RTC_PeriodicInterruptFlag;
    }

    if ((base->HPSR & (0x1U)) != 0U)
    {
...
# 526 "../../libraries/sdk/drives/fsl_snvs_hp.c"
uint32_t SNVS_HP_RTC_GetEnabledInterrupts(SNVS_Type *base)
{
    uint32_t val = 0U;

    if ((base->HPCR & (0x8U)) != 0U)
    {
        val |= (uint32_t)kSNVS_RTC_PeriodicInterrupt;
    }

    if ((base->HPCR & (0x2U)) != 0U)
    {
