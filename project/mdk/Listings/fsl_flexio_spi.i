# 1 "../../libraries/sdk/drives/fsl_flexio_spi.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/sdk/drives/fsl_flexio_spi.c" 2
...
# 1 "../../libraries/sdk/drives/fsl_flexio_spi.h" 1
# 12 "../../libraries/sdk/drives/fsl_flexio_spi.h"
...
# 13 "../../libraries/sdk/drives/fsl_flexio_spi.h" 2
...
# 14 "../../libraries/sdk/drives/fsl_flexio_spi.h" 2
# 44 "../../libraries/sdk/drives/fsl_flexio_spi.h"
enum
{
    kStatus_FLEXIO_SPI_Busy = ((((kStatusGroup_FLEXIO_SPI)*100L) + (1))),
    kStatus_FLEXIO_SPI_Idle = ((((kStatusGroup_FLEXIO_SPI)*100L) + (2))),
    kStatus_FLEXIO_SPI_Error = ((((kStatusGroup_FLEXIO_SPI)*100L) + (3))),
    kStatus_FLEXIO_SPI_Timeout =
        ((((kStatusGroup_FLEXIO_SPI)*100L) + (4))),
};
...
# 247 "../../libraries/sdk/drives/fsl_flexio_spi.h"
...
# 266 "../../libraries/sdk/drives/fsl_flexio_spi.h"
void FLEXIO_SPI_MasterGetDefaultConfig(flexio_spi_master_config_t *masterConfig);
# 305 "../../libraries/sdk/drives/fsl_flexio_spi.h"
...
# 324 "../../libraries/sdk/drives/fsl_flexio_spi.h"
void FLEXIO_SPI_SlaveGetDefaultConfig(flexio_spi_slave_config_t *slaveConfig);
# 342 "../../libraries/sdk/drives/fsl_flexio_spi.h"
uint32_t FLEXIO_SPI_GetStatusFlags(FLEXIO_SPI_Type *base);
# 354 "../../libraries/sdk/drives/fsl_flexio_spi.h"
void FLEXIO_SPI_ClearStatusFlags(FLEXIO_SPI_Type *base, uint32_t mask);
# 373 "../../libraries/sdk/drives/fsl_flexio_spi.h"
void FLEXIO_SPI_EnableInterrupts(FLEXIO_SPI_Type *base, uint32_t mask);
# 385 "../../libraries/sdk/drives/fsl_flexio_spi.h"
void FLEXIO_SPI_DisableInterrupts(FLEXIO_SPI_Type *base, uint32_t mask);
# 402 "../../libraries/sdk/drives/fsl_flexio_spi.h"
void FLEXIO_SPI_EnableDMA(FLEXIO_SPI_Type *base, uint32_t mask, _Bool enable);
# 413 "../../libraries/sdk/drives/fsl_flexio_spi.h"
...
# 437 "../../libraries/sdk/drives/fsl_flexio_spi.h"
...
# 463 "../../libraries/sdk/drives/fsl_flexio_spi.h"
static inline void FLEXIO_SPI_Enable(FLEXIO_SPI_Type *base, _Bool enable)
{
    if (enable)
    {
...
# 478 "../../libraries/sdk/drives/fsl_flexio_spi.h"
void FLEXIO_SPI_MasterSetBaudRate(FLEXIO_SPI_Type *base, uint32_t baudRate_Bps, uint32_t srcClockHz);
# 491 "../../libraries/sdk/drives/fsl_flexio_spi.h"
...
# 513 "../../libraries/sdk/drives/fsl_flexio_spi.h"
...
# 537 "../../libraries/sdk/drives/fsl_flexio_spi.h"
status_t FLEXIO_SPI_WriteBlocking(FLEXIO_SPI_Type *base,
                                  flexio_spi_shift_direction_t direction,
                                  const uint8_t *buffer,
                                  size_t size);
# 555 "../../libraries/sdk/drives/fsl_flexio_spi.h"
status_t FLEXIO_SPI_ReadBlocking(FLEXIO_SPI_Type *base,
                                 flexio_spi_shift_direction_t direction,
                                 uint8_t *buffer,
                                 size_t size);
# 570 "../../libraries/sdk/drives/fsl_flexio_spi.h"
...
# 597 "../../libraries/sdk/drives/fsl_flexio_spi.h"
status_t FLEXIO_SPI_MasterTransferCreateHandle(FLEXIO_SPI_Type *base,
                                               flexio_spi_master_handle_t *handle,
                                               flexio_spi_master_transfer_callback_t callback,
                                               void *userData);
# 615 "../../libraries/sdk/drives/fsl_flexio_spi.h"
...
# 636 "../../libraries/sdk/drives/fsl_flexio_spi.h"
...
# 697 "../../libraries/sdk/drives/fsl_flexio_spi.h"
...
# 223 "../../libraries/sdk/drives/fsl_flexio_spi.c"
void FLEXIO_SPI_MasterInit(FLEXIO_SPI_Type *base, flexio_spi_master_config_t *masterConfig, uint32_t srcClock_Hz)
{
    ((base != 0) ? (void)0 : __aeabi_assert("base != NULL", "../../libraries/sdk/drives/fsl_flexio_spi.c", 225),
# 225 "../../libraries/sdk/drives/fsl_flexio_spi.c"
#pragma clang diagnostic push
# 225 "../../libraries/sdk/drives/fsl_flexio_spi.c"
#pragma clang diagnostic ignored "-Wassume"
# 225 "../../libraries/sdk/drives/fsl_flexio_spi.c"
...
# 225 "../../libraries/sdk/drives/fsl_flexio_spi.c"
    ...
    ((masterConfig != 0) ? (void)0 : __aeabi_assert("masterConfig != NULL", "../../libraries/sdk/drives/fsl_flexio_spi.c", 226),
# 226 "../../libraries/sdk/drives/fsl_flexio_spi.c"
#pragma clang diagnostic push
# 226 "../../libraries/sdk/drives/fsl_flexio_spi.c"
#pragma clang diagnostic ignored "-Wassume"
# 226 "../../libraries/sdk/drives/fsl_flexio_spi.c"
...
# 226 "../../libraries/sdk/drives/fsl_flexio_spi.c"
    ...
    ctrlReg &= ~((0x80000000U) | (0x40000000U) | (0x4U) | (0x1U));
    ctrlReg |= ((((uint32_t)(((uint32_t)(masterConfig->enableInDebug)) << (30U))) & (0x40000000U)) | (((uint32_t)(((uint32_t)(masterConfig->enableFastAccess)) << (2U))) & (0x4U)) |
                (((uint32_t)(((uint32_t)(masterConfig->enableMaster)) << (0U))) & (0x1U)));
    ...
    timerConfig.triggerSelect = (((uint32_t)(base->shifterIndex[0]) << 2U) | 0x1U);
    ...
    timerConfig.triggerSelect = (((uint32_t)(base->timerIndex[0]) << 2U) | 0x3U);
...
# 374 "../../libraries/sdk/drives/fsl_flexio_spi.c"
void FLEXIO_SPI_MasterGetDefaultConfig(flexio_spi_master_config_t *masterConfig)
{
    ((masterConfig != 0) ? (void)0 : __aeabi_assert("masterConfig != NULL", "../../libraries/sdk/drives/fsl_flexio_spi.c", 376),
# 376 "../../libraries/sdk/drives/fsl_flexio_spi.c"
#pragma clang diagnostic push
# 376 "../../libraries/sdk/drives/fsl_flexio_spi.c"
#pragma clang diagnostic ignored "-Wassume"
# 376 "../../libraries/sdk/drives/fsl_flexio_spi.c"
...
# 376 "../../libraries/sdk/drives/fsl_flexio_spi.c"
    ...
    masterConfig->enableInDoze = 0;
    masterConfig->enableInDebug = 1;
    masterConfig->enableFastAccess = 0;
...
# 430 "../../libraries/sdk/drives/fsl_flexio_spi.c"
void FLEXIO_SPI_SlaveInit(FLEXIO_SPI_Type *base, flexio_spi_slave_config_t *slaveConfig)
{
    (((base != 0) && (slaveConfig != 0)) ? (void)0 : __aeabi_assert("(base != NULL) && (slaveConfig != NULL)", "../../libraries/sdk/drives/fsl_flexio_spi.c", 432),
# 432 "../../libraries/sdk/drives/fsl_flexio_spi.c"
#pragma clang diagnostic push
# 432 "../../libraries/sdk/drives/fsl_flexio_spi.c"
#pragma clang diagnostic ignored "-Wassume"
# 432 "../../libraries/sdk/drives/fsl_flexio_spi.c"
    (__builtin_assume)(((base != 0) && (slaveConfig != 0))?1:0)
# 432 "../../libraries/sdk/drives/fsl_flexio_spi.c"
#pragma clang diagnostic pop
# 432 "../../libraries/sdk/drives/fsl_flexio_spi.c"
    );
    ...
    ctrlReg = base->flexioBase->CTRL;
    ctrlReg &= ~((0x80000000U) | (0x40000000U) | (0x4U) | (0x1U));
    ctrlReg |= ((((uint32_t)(((uint32_t)(slaveConfig->enableInDebug)) << (30U))) & (0x40000000U)) | (((uint32_t)(((uint32_t)(slaveConfig->enableFastAccess)) << (2U))) & (0x4U)) |
    ...
    timerConfig.triggerSelect = ((uint32_t)(base->CSnPinIndex) << 1U);
    timerConfig.triggerPolarity = kFLEXIO_TimerTriggerPolarityActiveLow;
    timerConfig.triggerSource = kFLEXIO_TimerTriggerSourceInternal;
...
# 550 "../../libraries/sdk/drives/fsl_flexio_spi.c"
void FLEXIO_SPI_SlaveGetDefaultConfig(flexio_spi_slave_config_t *slaveConfig)
{
    ((slaveConfig != 0) ? (void)0 : __aeabi_assert("slaveConfig != NULL", "../../libraries/sdk/drives/fsl_flexio_spi.c", 552),
# 552 "../../libraries/sdk/drives/fsl_flexio_spi.c"
#pragma clang diagnostic push
# 552 "../../libraries/sdk/drives/fsl_flexio_spi.c"
#pragma clang diagnostic ignored "-Wassume"
# 552 "../../libraries/sdk/drives/fsl_flexio_spi.c"
...
# 552 "../../libraries/sdk/drives/fsl_flexio_spi.c"
    ...
    slaveConfig->enableInDoze = 0;
    slaveConfig->enableInDebug = 1;
    slaveConfig->enableFastAccess = 0;

    slaveConfig->phase = kFLEXIO_SPI_ClockPhaseFirstEdge;

    slaveConfig->dataMode = kFLEXIO_SPI_8BitMode;
}
# 577 "../../libraries/sdk/drives/fsl_flexio_spi.c"
void FLEXIO_SPI_EnableInterrupts(FLEXIO_SPI_Type *base, uint32_t mask)
{
...
# 599 "../../libraries/sdk/drives/fsl_flexio_spi.c"
void FLEXIO_SPI_DisableInterrupts(FLEXIO_SPI_Type *base, uint32_t mask)
{
    if ((mask & (uint32_t)kFLEXIO_SPI_TxEmptyInterruptEnable) != 0U)
    {
...
# 619 "../../libraries/sdk/drives/fsl_flexio_spi.c"
void FLEXIO_SPI_EnableDMA(FLEXIO_SPI_Type *base, uint32_t mask, _Bool enable)
{
...
# 641 "../../libraries/sdk/drives/fsl_flexio_spi.c"
uint32_t FLEXIO_SPI_GetStatusFlags(FLEXIO_SPI_Type *base)
{
...
# 662 "../../libraries/sdk/drives/fsl_flexio_spi.c"
void FLEXIO_SPI_ClearStatusFlags(FLEXIO_SPI_Type *base, uint32_t mask)
{
...
# 681 "../../libraries/sdk/drives/fsl_flexio_spi.c"
void FLEXIO_SPI_MasterSetBaudRate(FLEXIO_SPI_Type *base, uint32_t baudRate_Bps, uint32_t srcClockHz)
{
    uint16_t timerDiv = 0;
    uint16_t timerCmp = 0;
...
# 710 "../../libraries/sdk/drives/fsl_flexio_spi.c"
status_t FLEXIO_SPI_WriteBlocking(FLEXIO_SPI_Type *base,
                                  flexio_spi_shift_direction_t direction,
                                  const uint8_t *buffer,
                                  size_t size)
{
    ((buffer != 0) ? (void)0 : __aeabi_assert("buffer != NULL", "../../libraries/sdk/drives/fsl_flexio_spi.c", 715),
# 715 "../../libraries/sdk/drives/fsl_flexio_spi.c"
#pragma clang diagnostic push
# 715 "../../libraries/sdk/drives/fsl_flexio_spi.c"
#pragma clang diagnostic ignored "-Wassume"
# 715 "../../libraries/sdk/drives/fsl_flexio_spi.c"
...
# 715 "../../libraries/sdk/drives/fsl_flexio_spi.c"
    ...
    ((size != 0U) ? (void)0 : __aeabi_assert("size != 0U", "../../libraries/sdk/drives/fsl_flexio_spi.c", 716),
# 716 "../../libraries/sdk/drives/fsl_flexio_spi.c"
#pragma clang diagnostic push
# 716 "../../libraries/sdk/drives/fsl_flexio_spi.c"
#pragma clang diagnostic ignored "-Wassume"
# 716 "../../libraries/sdk/drives/fsl_flexio_spi.c"
    (__builtin_assume)((size != 0U)?1:0)
# 716 "../../libraries/sdk/drives/fsl_flexio_spi.c"
#pragma clang diagnostic pop
# 716 "../../libraries/sdk/drives/fsl_flexio_spi.c"
    );
...
# 759 "../../libraries/sdk/drives/fsl_flexio_spi.c"
status_t FLEXIO_SPI_ReadBlocking(FLEXIO_SPI_Type *base,
                                 flexio_spi_shift_direction_t direction,
                                 uint8_t *buffer,
                                 size_t size)
{
    ((buffer != 0) ? (void)0 : __aeabi_assert("buffer != NULL", "../../libraries/sdk/drives/fsl_flexio_spi.c", 764),
# 764 "../../libraries/sdk/drives/fsl_flexio_spi.c"
#pragma clang diagnostic push
# 764 "../../libraries/sdk/drives/fsl_flexio_spi.c"
#pragma clang diagnostic ignored "-Wassume"
# 764 "../../libraries/sdk/drives/fsl_flexio_spi.c"
...
# 764 "../../libraries/sdk/drives/fsl_flexio_spi.c"
    ...
    ((size != 0U) ? (void)0 : __aeabi_assert("size != 0U", "../../libraries/sdk/drives/fsl_flexio_spi.c", 765),
# 765 "../../libraries/sdk/drives/fsl_flexio_spi.c"
#pragma clang diagnostic push
# 765 "../../libraries/sdk/drives/fsl_flexio_spi.c"
#pragma clang diagnostic ignored "-Wassume"
# 765 "../../libraries/sdk/drives/fsl_flexio_spi.c"
...
# 805 "../../libraries/sdk/drives/fsl_flexio_spi.c"
status_t FLEXIO_SPI_MasterTransferBlocking(FLEXIO_SPI_Type *base, flexio_spi_transfer_t *xfer)
{
    flexio_spi_shift_direction_t direction;
    ...
    uint32_t tmpData = (0xFFFFFFFFU);
    uint8_t dataFormat = ((xfer->flags) & (0x7U));
    ...
    if ((xfer->flags & (uint8_t)kFLEXIO_SPI_csContinuous) != 0U)
    {
        base->flexioBase->TIMCFG[base->timerIndex[0]] =
            (base->flexioBase->TIMCFG[base->timerIndex[0]] & ~(0x30U)) |
            (((uint32_t)(((uint32_t)(kFLEXIO_TimerStopBitDisabled)) << (4U))) & (0x30U));
    }
    else
    {
        base->flexioBase->TIMCFG[base->timerIndex[0]] =
            (base->flexioBase->TIMCFG[base->timerIndex[0]] & ~(0x30U)) |
            (((uint32_t)(((uint32_t)(kFLEXIO_TimerStopBitEnableOnTimerDisable)) << (4U))) & (0x30U));
    }
    ...
    switch (dataFormat)
    {
        ...
        default:
            ...
            bytesPerFrame = 1U;
            direction = kFLEXIO_SPI_MsbFirst;
            ((1) ? (void)0 : __aeabi_assert("true", "../../libraries/sdk/drives/fsl_flexio_spi.c", 875),
# 875 "../../libraries/sdk/drives/fsl_flexio_spi.c"
#pragma clang diagnostic push
# 875 "../../libraries/sdk/drives/fsl_flexio_spi.c"
#pragma clang diagnostic ignored "-Wassume"
# 875 "../../libraries/sdk/drives/fsl_flexio_spi.c"
            (__builtin_assume)((1)?1:0)
# 875 "../../libraries/sdk/drives/fsl_flexio_spi.c"
#pragma clang diagnostic pop
# 875 "../../libraries/sdk/drives/fsl_flexio_spi.c"
            );
...
# 1036 "../../libraries/sdk/drives/fsl_flexio_spi.c"
status_t FLEXIO_SPI_MasterTransferCreateHandle(FLEXIO_SPI_Type *base,
                                               flexio_spi_master_handle_t *handle,
                                               flexio_spi_master_transfer_callback_t callback,
                                               void *userData)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_flexio_spi.c", 1041),
# 1041 "../../libraries/sdk/drives/fsl_flexio_spi.c"
#pragma clang diagnostic push
# 1041 "../../libraries/sdk/drives/fsl_flexio_spi.c"
#pragma clang diagnostic ignored "-Wassume"
# 1041 "../../libraries/sdk/drives/fsl_flexio_spi.c"
...
# 1041 "../../libraries/sdk/drives/fsl_flexio_spi.c"
    ...
    IRQn_Type flexio_irqs[] = { NotAvail_IRQn, FLEXIO1_IRQn, FLEXIO2_IRQn, FLEXIO3_IRQn };
    ...
    __NVIC_ClearPendingIRQ(flexio_irqs[FLEXIO_SPI_GetInstance(base)]);
...
# 1074 "../../libraries/sdk/drives/fsl_flexio_spi.c"
status_t FLEXIO_SPI_MasterTransferNonBlocking(FLEXIO_SPI_Type *base,
                                              flexio_spi_master_handle_t *handle,
                                              flexio_spi_transfer_t *xfer)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_flexio_spi.c", 1078),
# 1078 "../../libraries/sdk/drives/fsl_flexio_spi.c"
#pragma clang diagnostic push
# 1078 "../../libraries/sdk/drives/fsl_flexio_spi.c"
#pragma clang diagnostic ignored "-Wassume"
# 1078 "../../libraries/sdk/drives/fsl_flexio_spi.c"
...
# 1078 "../../libraries/sdk/drives/fsl_flexio_spi.c"
    ...
    ((xfer != 0) ? (void)0 : __aeabi_assert("xfer != NULL", "../../libraries/sdk/drives/fsl_flexio_spi.c", 1079),
# 1079 "../../libraries/sdk/drives/fsl_flexio_spi.c"
#pragma clang diagnostic push
# 1079 "../../libraries/sdk/drives/fsl_flexio_spi.c"
#pragma clang diagnostic ignored "-Wassume"
# 1079 "../../libraries/sdk/drives/fsl_flexio_spi.c"
    (__builtin_assume)((xfer != 0)?1:0)
# 1079 "../../libraries/sdk/drives/fsl_flexio_spi.c"
#pragma clang diagnostic pop
# 1079 "../../libraries/sdk/drives/fsl_flexio_spi.c"
    );
    ...
    if ((xfer->txData == 0) && (xfer->rxData == 0))
    {
        return kStatus_InvalidArgument;
    }
    ...
    switch (dataFormat)
    {
        ...
        default:
            ...
            handle->bytePerFrame = 1U;
            handle->direction = kFLEXIO_SPI_MsbFirst;
            ((1) ? (void)0 : __aeabi_assert("true", "../../libraries/sdk/drives/fsl_flexio_spi.c", 1156),
# 1156 "../../libraries/sdk/drives/fsl_flexio_spi.c"
#pragma clang diagnostic push
# 1156 "../../libraries/sdk/drives/fsl_flexio_spi.c"
#pragma clang diagnostic ignored "-Wassume"
# 1156 "../../libraries/sdk/drives/fsl_flexio_spi.c"
...
# 1245 "../../libraries/sdk/drives/fsl_flexio_spi.c"
status_t FLEXIO_SPI_MasterTransferGetCount(FLEXIO_SPI_Type *base, flexio_spi_master_handle_t *handle, size_t *count)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_flexio_spi.c", 1247),
# 1247 "../../libraries/sdk/drives/fsl_flexio_spi.c"
#pragma clang diagnostic push
# 1247 "../../libraries/sdk/drives/fsl_flexio_spi.c"
#pragma clang diagnostic ignored "-Wassume"
# 1247 "../../libraries/sdk/drives/fsl_flexio_spi.c"
...
void FLEXIO_SPI_MasterTransferAbort(FLEXIO_SPI_Type *base, flexio_spi_master_handle_t *handle)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_flexio_spi.c", 1275),
# 1275 "../../libraries/sdk/drives/fsl_flexio_spi.c"
#pragma clang diagnostic push
# 1275 "../../libraries/sdk/drives/fsl_flexio_spi.c"
#pragma clang diagnostic ignored "-Wassume"
# 1275 "../../libraries/sdk/drives/fsl_flexio_spi.c"
...
void FLEXIO_SPI_MasterTransferHandleIRQ(void *spiType, void *spiHandle)
{
    ((spiHandle != 0) ? (void)0 : __aeabi_assert("spiHandle != NULL", "../../libraries/sdk/drives/fsl_flexio_spi.c", 1296),
# 1296 "../../libraries/sdk/drives/fsl_flexio_spi.c"
#pragma clang diagnostic push
# 1296 "../../libraries/sdk/drives/fsl_flexio_spi.c"
#pragma clang diagnostic ignored "-Wassume"
# 1296 "../../libraries/sdk/drives/fsl_flexio_spi.c"
    (__builtin_assume)((spiHandle != 0)?1:0)
# 1296 "../../libraries/sdk/drives/fsl_flexio_spi.c"
#pragma clang diagnostic pop
# 1296 "../../libraries/sdk/drives/fsl_flexio_spi.c"
    );
...
# 1343 "../../libraries/sdk/drives/fsl_flexio_spi.c"
status_t FLEXIO_SPI_SlaveTransferCreateHandle(FLEXIO_SPI_Type *base,
                                              flexio_spi_slave_handle_t *handle,
                                              flexio_spi_slave_transfer_callback_t callback,
                                              void *userData)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_flexio_spi.c", 1348),
# 1348 "../../libraries/sdk/drives/fsl_flexio_spi.c"
#pragma clang diagnostic push
# 1348 "../../libraries/sdk/drives/fsl_flexio_spi.c"
#pragma clang diagnostic ignored "-Wassume"
# 1348 "../../libraries/sdk/drives/fsl_flexio_spi.c"
...
# 1381 "../../libraries/sdk/drives/fsl_flexio_spi.c"
status_t FLEXIO_SPI_SlaveTransferNonBlocking(FLEXIO_SPI_Type *base,
                                             flexio_spi_slave_handle_t *handle,
                                             flexio_spi_transfer_t *xfer)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_flexio_spi.c", 1385),
# 1385 "../../libraries/sdk/drives/fsl_flexio_spi.c"
#pragma clang diagnostic push
# 1385 "../../libraries/sdk/drives/fsl_flexio_spi.c"
#pragma clang diagnostic ignored "-Wassume"
# 1385 "../../libraries/sdk/drives/fsl_flexio_spi.c"
...
# 1385 "../../libraries/sdk/drives/fsl_flexio_spi.c"
    ...
    ((xfer != 0) ? (void)0 : __aeabi_assert("xfer != NULL", "../../libraries/sdk/drives/fsl_flexio_spi.c", 1386),
# 1386 "../../libraries/sdk/drives/fsl_flexio_spi.c"
#pragma clang diagnostic push
# 1386 "../../libraries/sdk/drives/fsl_flexio_spi.c"
#pragma clang diagnostic ignored "-Wassume"
# 1386 "../../libraries/sdk/drives/fsl_flexio_spi.c"
...
# 1386 "../../libraries/sdk/drives/fsl_flexio_spi.c"
    ...
    if ((xfer->flags & (uint8_t)kFLEXIO_SPI_csContinuous) != 0U)
    {
        base->flexioBase->TIMCFG[base->timerIndex[0]] |= (((uint32_t)(((uint32_t)(kFLEXIO_TimerDisableOnTriggerFallingEdge)) << (12U))) & (0x7000U));
    }
    else
    {
        if ((base->flexioBase->SHIFTCTL[base->shifterIndex[0]] & (0x800000U)) ==
            (((uint32_t)(((uint32_t)(kFLEXIO_ShifterTimerPolarityOnNegitive)) << (23U))) & (0x800000U)))
        {
            base->flexioBase->TIMCFG[base->timerIndex[0]] =
                (base->flexioBase->TIMCFG[base->timerIndex[0]] & ~(0x7000U)) |
                (((uint32_t)(((uint32_t)(kFLEXIO_TimerDisableOnTimerCompare)) << (12U))) & (0x7000U));
        }
        else
        {
            base->flexioBase->TIMCFG[base->timerIndex[0]] =
                (base->flexioBase->TIMCFG[base->timerIndex[0]] & ~(0x7000U)) |
                (((uint32_t)(((uint32_t)(kFLEXIO_TimerDisableOnTriggerFallingEdge)) << (12U))) & (0x7000U));
        }
    }
    ...
    switch (dataFormat)
    {
        ...
        default:
            ...
            handle->bytePerFrame = 1U;
            handle->direction = kFLEXIO_SPI_MsbFirst;
            ((1) ? (void)0 : __aeabi_assert("true", "../../libraries/sdk/drives/fsl_flexio_spi.c", 1467),
# 1467 "../../libraries/sdk/drives/fsl_flexio_spi.c"
#pragma clang diagnostic push
# 1467 "../../libraries/sdk/drives/fsl_flexio_spi.c"
#pragma clang diagnostic ignored "-Wassume"
# 1467 "../../libraries/sdk/drives/fsl_flexio_spi.c"
...
void FLEXIO_SPI_SlaveTransferHandleIRQ(void *spiType, void *spiHandle)
{
    ((spiHandle != 0) ? (void)0 : __aeabi_assert("spiHandle != NULL", "../../libraries/sdk/drives/fsl_flexio_spi.c", 1504),
# 1504 "../../libraries/sdk/drives/fsl_flexio_spi.c"
#pragma clang diagnostic push
# 1504 "../../libraries/sdk/drives/fsl_flexio_spi.c"
#pragma clang diagnostic ignored "-Wassume"
# 1504 "../../libraries/sdk/drives/fsl_flexio_spi.c"
...
void FLEXIO_SPI_FlushShifters(FLEXIO_SPI_Type *base)
{
    ...
    base->flexioBase->SHIFTCTL[base->shifterIndex[0]] &= ~(0x7U);
    base->flexioBase->SHIFTCTL[base->shifterIndex[0]] |= (((uint32_t)(((uint32_t)(kFLEXIO_ShifterModeTransmit)) << (0U))) & (0x7U));
