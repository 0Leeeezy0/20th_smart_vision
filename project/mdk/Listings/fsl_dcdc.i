# 1 "../../libraries/sdk/drives/fsl_dcdc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/sdk/drives/fsl_dcdc.c" 2
...
# 1 "../../libraries/sdk/drives/fsl_dcdc.h" 1
# 12 "../../libraries/sdk/drives/fsl_dcdc.h"
...
# 13 "../../libraries/sdk/drives/fsl_dcdc.h" 2
# 28 "../../libraries/sdk/drives/fsl_dcdc.h"
enum _dcdc_status_flags_t
{
    kDCDC_LockedOKStatus = (1U << 0U),
};
...
# 178 "../../libraries/sdk/drives/fsl_dcdc.h"
typedef struct _dcdc_detection_config
{
    _Bool enableXtalokDetection;




    _Bool powerDownOverVoltageDetection;

    _Bool powerDownLowVlotageDetection;
    _Bool powerDownOverCurrentDetection;
    _Bool powerDownPeakCurrentDetection;
    _Bool powerDownZeroCrossDetection;
...
{
    _Bool enableCommonHysteresis;

    _Bool enableCommonThresholdDetection;
# 212 "../../libraries/sdk/drives/fsl_dcdc.h"
    _Bool enableInvertHysteresisSign;
    _Bool enableRCThresholdDetection;
...
typedef struct _dcdc_low_power_config
{
    ...
    _Bool enableOverloadDetection;



    _Bool enableAdjustHystereticValue;
    dcdc_count_charging_time_period_t
...
{
    _Bool enableUseHalfFreqForContinuous;
} dcdc_min_power_config_t;
# 314 "../../libraries/sdk/drives/fsl_dcdc.h"
...
# 354 "../../libraries/sdk/drives/fsl_dcdc.h"
uint32_t DCDC_GetstatusFlags(DCDC_Type *base);
# 381 "../../libraries/sdk/drives/fsl_dcdc.h"
static inline void DCDC_EnableOutputRangeComparator(DCDC_Type *base, _Bool enable)
{
    if (enable)
    {
        base->REG0 &= ~(0x4000000U);
    }
    else
    {
        base->REG0 |= (0x4000000U);
...
# 419 "../../libraries/sdk/drives/fsl_dcdc.h"
...
# 443 "../../libraries/sdk/drives/fsl_dcdc.h"
...
void DCDC_ResetCurrentAlertSignal(DCDC_Type *base, _Bool enable);
...
{
    base->REG1 &= ~(0x1F000000U);
    base->REG1 |= (((uint32_t)(((uint32_t)(trimValue)) << (24U))) & (0x1F000000U));
}
# 489 "../../libraries/sdk/drives/fsl_dcdc.h"
...
{
    base->REG1 &= ~(0x3000U);
    base->REG1 |= (((uint32_t)(((uint32_t)(biasVaule)) << (12U))) & (0x3000U));
}
# 591 "../../libraries/sdk/drives/fsl_dcdc.h"
static inline void DCDC_LockTargetVoltage(DCDC_Type *base)
{
    base->REG3 |= (0x40000000U);
}
# 610 "../../libraries/sdk/drives/fsl_dcdc.h"
void DCDC_AdjustTargetVoltage(DCDC_Type *base, uint32_t VDDRun, uint32_t VDDStandby);
# 623 "../../libraries/sdk/drives/fsl_dcdc.h"
void DCDC_AdjustRunTargetVoltage(DCDC_Type *base, uint32_t VDDRun);
# 636 "../../libraries/sdk/drives/fsl_dcdc.h"
void DCDC_AdjustLowPowerTargetVoltage(DCDC_Type *base, uint32_t VDDStandby);
# 645 "../../libraries/sdk/drives/fsl_dcdc.h"
void DCDC_SetInternalRegulatorConfig(DCDC_Type *base, const dcdc_internal_regulator_config_t *config);
# 654 "../../libraries/sdk/drives/fsl_dcdc.h"
static inline void DCDC_EnableImproveTransition(DCDC_Type *base, _Bool enable)
{
    if (enable)
    {
        base->REG2 |= (0x10000000U);
    }
    else
    {
        base->REG2 &= ~(0x10000000U);
...
# 714 "../../libraries/sdk/drives/fsl_dcdc.h"
void DCDC_BootIntoDCM(DCDC_Type *base);
# 725 "../../libraries/sdk/drives/fsl_dcdc.h"
void DCDC_BootIntoCCM(DCDC_Type *base);
# 10 "../../libraries/sdk/drives/fsl_dcdc.c" 2
# 24 "../../libraries/sdk/drives/fsl_dcdc.c"
static uint32_t DCDC_GetInstance(DCDC_Type *base);
# 40 "../../libraries/sdk/drives/fsl_dcdc.c"
static DCDC_Type *const s_dcdcBases[] = { ((DCDC_Type *)(0x40080000u)) };



static const clock_ip_name_t s_dcdcClocks[] = { kCLOCK_Dcdc };
...
static uint32_t DCDC_GetInstance(DCDC_Type *base)
{
    ...
    for (instance = 0; instance < (sizeof(s_dcdcBases) / sizeof((s_dcdcBases)[0])); instance++)
    {
    ...
    ((instance < (sizeof(s_dcdcBases) / sizeof((s_dcdcBases)[0]))) ? (void)0 : __aeabi_assert("instance < ARRAY_SIZE(s_dcdcBases)", "../../libraries/sdk/drives/fsl_dcdc.c", 63),
# 63 "../../libraries/sdk/drives/fsl_dcdc.c"
#pragma clang diagnostic push
# 63 "../../libraries/sdk/drives/fsl_dcdc.c"
#pragma clang diagnostic ignored "-Wassume"
# 63 "../../libraries/sdk/drives/fsl_dcdc.c"
    (__builtin_assume)((instance < (sizeof(s_dcdcBases) / sizeof((s_dcdcBases)[0])))?1:0)
# 63 "../../libraries/sdk/drives/fsl_dcdc.c"
#pragma clang diagnostic pop
# 63 "../../libraries/sdk/drives/fsl_dcdc.c"
    );
...
# 119 "../../libraries/sdk/drives/fsl_dcdc.c"
void DCDC_Init(DCDC_Type *base)
{
...
# 200 "../../libraries/sdk/drives/fsl_dcdc.c"
void DCDC_SetClockSource(DCDC_Type *base, dcdc_clock_source_t clockSource)
{
    uint32_t tmp32;


    tmp32 = base->REG0 & ~((0x20000000U) | (0x2U) |
                           (0x4U) | (0x8U));
    switch (clockSource)
    {
        ...
        case kDCDC_ClockAutoSwitch:
            ...
            break;
        default:
            ((0) ? (void)0 : __aeabi_assert("false", "../../libraries/sdk/drives/fsl_dcdc.c", 221),
# 221 "../../libraries/sdk/drives/fsl_dcdc.c"
#pragma clang diagnostic push
# 221 "../../libraries/sdk/drives/fsl_dcdc.c"
#pragma clang diagnostic ignored "-Wassume"
# 221 "../../libraries/sdk/drives/fsl_dcdc.c"
...
# 245 "../../libraries/sdk/drives/fsl_dcdc.c"
void DCDC_GetDefaultDetectionConfig(dcdc_detection_config_t *config)
{
    ((0 != config) ? (void)0 : __aeabi_assert("NULL != config", "../../libraries/sdk/drives/fsl_dcdc.c", 247),
# 247 "../../libraries/sdk/drives/fsl_dcdc.c"
#pragma clang diagnostic push
# 247 "../../libraries/sdk/drives/fsl_dcdc.c"
#pragma clang diagnostic ignored "-Wassume"
# 247 "../../libraries/sdk/drives/fsl_dcdc.c"
...
# 247 "../../libraries/sdk/drives/fsl_dcdc.c"
    ...
    config->enableXtalokDetection = 0;




    config->powerDownOverVoltageDetection = 1;

    config->powerDownLowVlotageDetection = 0;
    config->powerDownOverCurrentDetection = 1;
    config->powerDownPeakCurrentDetection = 1;
    config->powerDownZeroCrossDetection = 1;
...
void DCDC_SetDetectionConfig(DCDC_Type *base, const dcdc_detection_config_t *config)
{
    ((0 != config) ? (void)0 : __aeabi_assert("NULL != config", "../../libraries/sdk/drives/fsl_dcdc.c", 275),
# 275 "../../libraries/sdk/drives/fsl_dcdc.c"
#pragma clang diagnostic push
# 275 "../../libraries/sdk/drives/fsl_dcdc.c"
#pragma clang diagnostic ignored "-Wassume"
# 275 "../../libraries/sdk/drives/fsl_dcdc.c"
...
# 275 "../../libraries/sdk/drives/fsl_dcdc.c"
    ...
    tmp32 |= (((uint32_t)(((uint32_t)(config->PeakCurrentThreshold)) << (5U))) & (0xE0U)) |
             (((uint32_t)(((uint32_t)(config->OverCurrentThreshold)) << (9U))) & (0x600U));
    if (0 == config->enableXtalokDetection)
    {
        tmp32 |= (0x8000000U);
    }
# 309 "../../libraries/sdk/drives/fsl_dcdc.c"
...
# 351 "../../libraries/sdk/drives/fsl_dcdc.c"
void DCDC_GetDefaultLowPowerConfig(dcdc_low_power_config_t *config)
{
    ((0 != config) ? (void)0 : __aeabi_assert("NULL != config", "../../libraries/sdk/drives/fsl_dcdc.c", 353),
# 353 "../../libraries/sdk/drives/fsl_dcdc.c"
#pragma clang diagnostic push
# 353 "../../libraries/sdk/drives/fsl_dcdc.c"
#pragma clang diagnostic ignored "-Wassume"
# 353 "../../libraries/sdk/drives/fsl_dcdc.c"
...
# 353 "../../libraries/sdk/drives/fsl_dcdc.c"
    ...
    config->enableOverloadDetection = 1;

    config->enableAdjustHystereticValue = 0;
...
void DCDC_SetLowPowerConfig(DCDC_Type *base, const dcdc_low_power_config_t *config)
{
    ((0 != config) ? (void)0 : __aeabi_assert("NULL != config", "../../libraries/sdk/drives/fsl_dcdc.c", 373),
# 373 "../../libraries/sdk/drives/fsl_dcdc.c"
#pragma clang diagnostic push
# 373 "../../libraries/sdk/drives/fsl_dcdc.c"
#pragma clang diagnostic ignored "-Wassume"
# 373 "../../libraries/sdk/drives/fsl_dcdc.c"
...
# 373 "../../libraries/sdk/drives/fsl_dcdc.c"
    ...
    tmp32 = base->REG0 &
            ~((0x200000U) | (0x100000U) | (0xC0000U)

              | (0x10000U)

            );
    tmp32 |= (((uint32_t)(((uint32_t)(config->countChargingTimePeriod)) << (20U))) & (0x100000U)) |
             (((uint32_t)(((uint32_t)(config->countChargingTimeThreshold)) << (18U))) & (0xC0000U));
...
uint32_t DCDC_GetstatusFlags(DCDC_Type *base)
{
    ...
    if ((0x80000000U) == ((0x80000000U) & base->REG0))
    {
...
# 423 "../../libraries/sdk/drives/fsl_dcdc.c"
void DCDC_ResetCurrentAlertSignal(DCDC_Type *base, _Bool enable)
{
    if (enable)
    {
        base->REG0 |= (0x10000000U);
    }
    else
    {
        base->REG0 &= ~(0x10000000U);
...
# 452 "../../libraries/sdk/drives/fsl_dcdc.c"
void DCDC_GetDefaultLoopControlConfig(dcdc_loop_control_config_t *config)
{
    ((0 != config) ? (void)0 : __aeabi_assert("NULL != config", "../../libraries/sdk/drives/fsl_dcdc.c", 454),
# 454 "../../libraries/sdk/drives/fsl_dcdc.c"
#pragma clang diagnostic push
# 454 "../../libraries/sdk/drives/fsl_dcdc.c"
#pragma clang diagnostic ignored "-Wassume"
# 454 "../../libraries/sdk/drives/fsl_dcdc.c"
...
# 454 "../../libraries/sdk/drives/fsl_dcdc.c"
    ...
    config->enableCommonHysteresis = 0;
    config->enableCommonThresholdDetection = 0;
    config->enableInvertHysteresisSign = 0;
    config->enableRCThresholdDetection = 0;
...
void DCDC_SetLoopControlConfig(DCDC_Type *base, const dcdc_loop_control_config_t *config)
{
    ((0 != config) ? (void)0 : __aeabi_assert("NULL != config", "../../libraries/sdk/drives/fsl_dcdc.c", 475),
# 475 "../../libraries/sdk/drives/fsl_dcdc.c"
#pragma clang diagnostic push
# 475 "../../libraries/sdk/drives/fsl_dcdc.c"
#pragma clang diagnostic ignored "-Wassume"
# 475 "../../libraries/sdk/drives/fsl_dcdc.c"
...
# 475 "../../libraries/sdk/drives/fsl_dcdc.c"
    ...
    uint32_t tmp32;
# 501 "../../libraries/sdk/drives/fsl_dcdc.c"
    tmp32 = base->REG1 & ~((0x800000U) | (0x200000U));
    ...
    tmp32 = base->REG2 & ~((0x2000U) | (0x1000U) |
                           (0xE00U) | (0x1C0U));
    tmp32 |= (((uint32_t)(((uint32_t)(config->complementFeedForwardStep)) << (6U))) & (0x1C0U)) |
             (((uint32_t)(((uint32_t)(config->enableRCScaleCircuit)) << (9U))) & (0xE00U));
...
void DCDC_SetMinPowerConfig(DCDC_Type *base, const dcdc_min_power_config_t *config)
{
    ((0 != config) ? (void)0 : __aeabi_assert("NULL != config", "../../libraries/sdk/drives/fsl_dcdc.c", 537),
# 537 "../../libraries/sdk/drives/fsl_dcdc.c"
#pragma clang diagnostic push
# 537 "../../libraries/sdk/drives/fsl_dcdc.c"
#pragma clang diagnostic ignored "-Wassume"
# 537 "../../libraries/sdk/drives/fsl_dcdc.c"
...
# 718 "../../libraries/sdk/drives/fsl_dcdc.c"
void DCDC_AdjustTargetVoltage(DCDC_Type *base, uint32_t VDDRun, uint32_t VDDStandby)
{
    uint32_t tmp32;
    ...
    tmp32 = base->REG3 & ~((0x700U) | (0x1FU));

    tmp32 |= (((uint32_t)(((uint32_t)(VDDStandby)) << (8U))) & (0x700U)) | (((uint32_t)(((uint32_t)(VDDRun)) << (0U))) & (0x1FU));
    base->REG3 = tmp32;



    while ((0x80000000U) != ((0x80000000U) & base->REG0))
    {
    }
}
# 749 "../../libraries/sdk/drives/fsl_dcdc.c"
void DCDC_AdjustRunTargetVoltage(DCDC_Type *base, uint32_t VDDRun)
{
    uint32_t tmp32;
    ...
    tmp32 = base->REG3 & ~(0x1FU);

    tmp32 |= (((uint32_t)(((uint32_t)(VDDRun)) << (0U))) & (0x1FU));
    base->REG3 = tmp32;
...
# 780 "../../libraries/sdk/drives/fsl_dcdc.c"
void DCDC_AdjustLowPowerTargetVoltage(DCDC_Type *base, uint32_t VDDStandby)
{
    uint32_t tmp32;
    ...
    tmp32 = base->REG3 & ~(0x700U);

    tmp32 |= (((uint32_t)(((uint32_t)(VDDStandby)) << (8U))) & (0x700U));
    base->REG3 = tmp32;
...
# 807 "../../libraries/sdk/drives/fsl_dcdc.c"
void DCDC_SetInternalRegulatorConfig(DCDC_Type *base, const dcdc_internal_regulator_config_t *config)
{
    ((0 != config) ? (void)0 : __aeabi_assert("NULL != config", "../../libraries/sdk/drives/fsl_dcdc.c", 809),
# 809 "../../libraries/sdk/drives/fsl_dcdc.c"
#pragma clang diagnostic push
# 809 "../../libraries/sdk/drives/fsl_dcdc.c"
#pragma clang diagnostic ignored "-Wassume"
# 809 "../../libraries/sdk/drives/fsl_dcdc.c"
...
# 809 "../../libraries/sdk/drives/fsl_dcdc.c"
    ...
    uint32_t tmp32;
# 821 "../../libraries/sdk/drives/fsl_dcdc.c"
    tmp32 = base->REG1 & ~((0x180U) | (0x200U));
    tmp32 |= (((uint32_t)(((uint32_t)(config->feedbackPoint)) << (7U))) & (0x180U));
...
# 893 "../../libraries/sdk/drives/fsl_dcdc.c"
void DCDC_BootIntoDCM(DCDC_Type *base)
{
    base->REG0 &= ~((0x1U) | (0x4000000U));
    base->REG2 = (~(0xE00U) & base->REG2) | (((uint32_t)(((uint32_t)(0x5U)) << (9U))) & (0xE00U)) |
                 (0x10000000U);
}
# 909 "../../libraries/sdk/drives/fsl_dcdc.c"
void DCDC_BootIntoCCM(DCDC_Type *base)
{
    base->REG0 = (~(0x4000000U) & base->REG0) | (0x1U);
    base->REG2 = (~(0xE00U) & base->REG2) | (((uint32_t)(((uint32_t)(0x3U)) << (9U))) & (0xE00U));
}
