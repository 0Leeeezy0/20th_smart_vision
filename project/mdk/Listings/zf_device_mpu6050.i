# 1 "../../libraries/zf_device/zf_device_mpu6050.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/zf_device/zf_device_mpu6050.c" 2
# 55 "../../libraries/zf_device/zf_device_mpu6050.c"
...
# 56 "../../libraries/zf_device/zf_device_mpu6050.c" 2
...
# 57 "../../libraries/zf_device/zf_device_mpu6050.c" 2
...
# 58 "../../libraries/zf_device/zf_device_mpu6050.c" 2
...
# 59 "../../libraries/zf_device/zf_device_mpu6050.c" 2
...
# 60 "../../libraries/zf_device/zf_device_mpu6050.c" 2
...
# 62 "../../libraries/zf_device/zf_device_mpu6050.c" 2
...
# 85 "../../libraries/zf_device/zf_device_mpu6050.c"
static uint8 mpu6050_self1_check (void)
{
    uint8 dat = 0, return_state = 0;
    uint16 timeout_count = 0;

    (soft_iic_write_8bit_register(&mpu6050_iic_struct, ((0x6B)), (0x00)));
    (soft_iic_write_8bit_register(&mpu6050_iic_struct, ((0x19)), (0x07)));
    while(0x07 != dat)
    {
        ...
        dat = (soft_iic_read_8bit_register(&mpu6050_iic_struct, ((0x19))));
        system_delay_ms(10);
    }
    return return_state;
}
# 112 "../../libraries/zf_device/zf_device_mpu6050.c"
void mpu6050_get_acc (void)
{
    uint8 dat[6];

    (soft_iic_read_8bit_registers(&mpu6050_iic_struct, ((0x3B)), (dat), (6)));
    mpu6050_acc_x = (int16)(((uint16)dat[0] << 8 | dat[1]));
    mpu6050_acc_y = (int16)(((uint16)dat[2] << 8 | dat[3]));
    mpu6050_acc_z = (int16)(((uint16)dat[4] << 8 | dat[5]));
}
# 129 "../../libraries/zf_device/zf_device_mpu6050.c"
void mpu6050_get_gyro (void)
{
    uint8 dat[6];

    (soft_iic_read_8bit_registers(&mpu6050_iic_struct, ((0x43)), (dat), (6)));
...
# 146 "../../libraries/zf_device/zf_device_mpu6050.c"
float mpu6050_acc_transition (int16 acc_value)
{
    float acc_data = 0;
    switch((0x10))
...
# 167 "../../libraries/zf_device/zf_device_mpu6050.c"
float mpu6050_gyro_transition (int16 gyro_value)
{
    float gyro_data = 0;
    switch((0x18))
...
# 188 "../../libraries/zf_device/zf_device_mpu6050.c"
uint8 mpu6050_init (void)
{
    uint8 return_state = 0;

    soft_iic_init(&mpu6050_iic_struct, (0xD0>>1), (100), (C23), (C22));
    ...
    do
    {
        if(mpu6050_self1_check())
        {
            ...
            (debug_log_handler((0), ("MPU6050 self check error."), "../../libraries/zf_device/zf_device_mpu6050.c", 205));
            return_state = 1;
            break;
        }
        (soft_iic_write_8bit_register(&mpu6050_iic_struct, ((0x6B)), (0x00)));
        (soft_iic_write_8bit_register(&mpu6050_iic_struct, ((0x19)), (0x07)));
        (soft_iic_write_8bit_register(&mpu6050_iic_struct, ((0x1A)), (0x04)));

        (soft_iic_write_8bit_register(&mpu6050_iic_struct, ((0x1B)), ((0x18))));
        ...
        (soft_iic_write_8bit_register(&mpu6050_iic_struct, ((0x1C)), ((0x10))));
        ...
        (soft_iic_write_8bit_register(&mpu6050_iic_struct, ((0x6A)), (0x00)));
        (soft_iic_write_8bit_register(&mpu6050_iic_struct, ((0x37)), (0x02)));
    }while(0);
    return return_state;
}
