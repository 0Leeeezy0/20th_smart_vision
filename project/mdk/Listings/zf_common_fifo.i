# 1 "../../libraries/zf_common/zf_common_fifo.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/zf_common/zf_common_fifo.c" 2
# 36 "../../libraries/zf_common/zf_common_fifo.c"
...
# 37 "../../libraries/zf_common/zf_common_fifo.c" 2
...
# 38 "../../libraries/zf_common/zf_common_fifo.c" 2
# 47 "../../libraries/zf_common/zf_common_fifo.c"
...
# 65 "../../libraries/zf_common/zf_common_fifo.c"
...
# 82 "../../libraries/zf_common/zf_common_fifo.c"
fifo_state_enum fifo_clear (fifo_struct *fifo)
{
    (debug_assert_handler((0 != fifo), "../../libraries/zf_common/zf_common_fifo.c", 84));
...
# 115 "../../libraries/zf_common/zf_common_fifo.c"
uint32 fifo_used (fifo_struct *fifo)
{
    (debug_assert_handler((fifo != 0), "../../libraries/zf_common/zf_common_fifo.c", 117));
    return (fifo->max - fifo->size);
}
# 129 "../../libraries/zf_common/zf_common_fifo.c"
fifo_state_enum fifo_write_element (fifo_struct *fifo, uint32 dat)
{
    (debug_assert_handler((0 != fifo), "../../libraries/zf_common/zf_common_fifo.c", 131));
    fifo_state_enum return_state = FIFO_SUCCESS;
...
# 173 "../../libraries/zf_common/zf_common_fifo.c"
fifo_state_enum fifo_write_buffer (fifo_struct *fifo, void *dat, uint32 length)
{
    (debug_assert_handler((0 != fifo), "../../libraries/zf_common/zf_common_fifo.c", 175));
    fifo_state_enum return_state = FIFO_SUCCESS;
...
# 288 "../../libraries/zf_common/zf_common_fifo.c"
fifo_state_enum fifo_read_element (fifo_struct *fifo, void *dat, fifo_operation_enum flag)
{
    (debug_assert_handler((0 != fifo), "../../libraries/zf_common/zf_common_fifo.c", 290));
    fifo_state_enum return_state = FIFO_SUCCESS;
...
# 350 "../../libraries/zf_common/zf_common_fifo.c"
fifo_state_enum fifo_read_buffer (fifo_struct *fifo, void *dat, uint32 *length, fifo_operation_enum flag)
{
    (debug_assert_handler((0 != fifo), "../../libraries/zf_common/zf_common_fifo.c", 352));
    (debug_assert_handler((0 != length), "../../libraries/zf_common/zf_common_fifo.c", 353));
    fifo_state_enum return_state = FIFO_SUCCESS;
    uint32 temp_length = 0;
...
# 449 "../../libraries/zf_common/zf_common_fifo.c"
fifo_state_enum fifo_read_tail_buffer (fifo_struct *fifo, void *dat, uint32 *length, fifo_operation_enum flag)
{
    (debug_assert_handler((0 != fifo), "../../libraries/zf_common/zf_common_fifo.c", 451));
    (debug_assert_handler((0 != length), "../../libraries/zf_common/zf_common_fifo.c", 452));
    fifo_state_enum return_state = FIFO_SUCCESS;
    uint32 temp_length = 0;
    uint32 fifo_data_length = 0;
...
# 543 "../../libraries/zf_common/zf_common_fifo.c"
fifo_state_enum fifo_init (fifo_struct *fifo, fifo_data_type_enum type, void *buffer_addr, uint32 size)
{
    (debug_assert_handler((0 != fifo), "../../libraries/zf_common/zf_common_fifo.c", 545));
    fifo_state_enum return_state = FIFO_SUCCESS;
    do
    {
