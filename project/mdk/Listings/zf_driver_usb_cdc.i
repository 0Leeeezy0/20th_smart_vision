# 1 "../../libraries/zf_driver/zf_driver_usb_cdc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/zf_driver/zf_driver_usb_cdc.c" 2
# 36 "../../libraries/zf_driver/zf_driver_usb_cdc.c"
# 1 "../../libraries/sdk/board\\board.h" 1
# 12 "../../libraries/sdk/board\\board.h"
# 1 "../../libraries/sdk/board/clock_config.h" 1
# 11 "../../libraries/sdk/board/clock_config.h"
...
# 12 "../../libraries/sdk/board/clock_config.h" 2
...
# 13 "../../libraries/sdk/board\\board.h" 2
...
# 15 "../../libraries/sdk/board\\board.h" 2
# 254 "../../libraries/sdk/board\\board.h"
uint32_t BOARD_DebugConsoleSrcFreq(void);

void BOARD_InitDebugConsole(void);

void BOARD_ConfigMPU(void);
# 306 "../../libraries/sdk/board\\board.h"
void BOARD_MMC_Pin_Config(uint32_t speed, uint32_t strength);
# 37 "../../libraries/zf_driver/zf_driver_usb_cdc.c" 2
# 1 "../../libraries/components/usb/usb_cdc_adapter\\usb_device_config.h" 1
# 38 "../../libraries/zf_driver/zf_driver_usb_cdc.c" 2
...
# 39 "../../libraries/zf_driver/zf_driver_usb_cdc.c" 2
...
# 40 "../../libraries/zf_driver/zf_driver_usb_cdc.c" 2
...
# 41 "../../libraries/zf_driver/zf_driver_usb_cdc.c" 2
# 1 "../../libraries/components/usb/usb_cdc_adapter\\usb_device_cdc_acm.h" 1
# 97 "../../libraries/components/usb/usb_cdc_adapter\\usb_device_cdc_acm.h"
...
# 43 "../../libraries/zf_driver/zf_driver_usb_cdc.c" 2
...
# 44 "../../libraries/zf_driver/zf_driver_usb_cdc.c" 2
# 1 "../../libraries/components/usb/usb_cdc_adapter\\usb_device_descriptor.h" 1
# 180 "../../libraries/components/usb/usb_cdc_adapter\\usb_device_descriptor.h"
extern usb_status_t USB_DeviceSetSpeed(usb_device_handle handle, uint8_t speed);
# 191 "../../libraries/components/usb/usb_cdc_adapter\\usb_device_descriptor.h"
extern usb_status_t USB_DeviceGetDeviceDescriptor(usb_device_handle handle,
                                                  usb_device_get_device_descriptor_struct_t *deviceDescriptor);
# 203 "../../libraries/components/usb/usb_cdc_adapter\\usb_device_descriptor.h"
usb_status_t USB_DeviceGetStringDescriptor(usb_device_handle handle,
                                           usb_device_get_string_descriptor_struct_t *stringDescriptor);
# 215 "../../libraries/components/usb/usb_cdc_adapter\\usb_device_descriptor.h"
extern usb_status_t USB_DeviceGetConfigurationDescriptor(
    usb_device_handle handle, usb_device_get_configuration_descriptor_struct_t *configurationDescriptor);
# 45 "../../libraries/zf_driver/zf_driver_usb_cdc.c" 2
# 1 "../../libraries/components/usb/phy\\usb_phy.h" 1
# 14 "../../libraries/components/usb/phy\\usb_phy.h"
...
# 40 "../../libraries/zf_driver/zf_driver_delay.h" 2


void system_delay_ms (uint32 time);
void system_delay_us (uint32 time);
# 47 "../../libraries/zf_driver/zf_driver_usb_cdc.c" 2
...
# 48 "../../libraries/zf_driver/zf_driver_usb_cdc.c" 2
# 98 "../../libraries/zf_driver/zf_driver_usb_cdc.c"
typedef struct _usb_cdc_vcom_struct
{
    ...
    uint8_t currentInterfaceAlternateSetting[(2U)];
...
{
    uint8_t serialStateBuf[(0x08) + (0x02)];
...
static uint8_t s_lineCoding[(0x07)] = {

    ((115200) >> 0U) & 0x000000FFU,
    ((115200) >> 8U) & 0x000000FFU,
    ((115200) >> 16U) & 0x000000FFU,
    ((115200) >> 24U) & 0x000000FFU,
    (0x00),
    (0x00),
    (0x08)};
...
__attribute__((aligned(4U)))
static uint8_t s_abstractState[(0x02)] = {((0x0000) >> 0U) & 0x00FFU,
                                                          ((0x0000) >> 8U) & 0x00FFU};


__attribute__((aligned(4U)))
static uint8_t s_countryCode[(0x02)] = {((0x0000) >> 0U) & 0x00FFU,
                                                        ((0x0000) >> 8U) & 0x00FFU};


__attribute__((aligned(4U))) static usb_cdc_acm_info_t s_usbCdcAcmInfo;

__attribute__((aligned(4U))) uint8_t usb_cdc_receive_buff[(512U)];
...
# 191 "../../libraries/zf_driver/zf_driver_usb_cdc.c"
...
void USB_DeviceClockInit(void)
{
    ...
    if (kUSB_ControllerEhci0 == kUSB_ControllerEhci0)
    {
    ...
    USB_EhciPhyInit(kUSB_ControllerEhci0, 24000000U, &phyConfig);
}
void USB_DeviceIsrEnable(void)
{
    uint8_t irqNumber;

    uint8_t usbDeviceEhciIrq[] = { USB_OTG1_IRQn, USB_OTG2_IRQn };
    irqNumber = usbDeviceEhciIrq[kUSB_ControllerEhci0 - kUSB_ControllerEhci0];


    __NVIC_SetPriority((IRQn_Type)irqNumber, (3U));
    ...
    switch (event)
    {
        case kUSB_DeviceCdcEventSendResponse:
        {
                ...
                (0U == (epCbParam->length % g_UsbDeviceCdcVcomDicEndpoints[0].maxPacketSize)))
            {
                ...
                error = USB_DeviceCdcAcmSend(handle, (2U), 0, 0);
            }
            else if ((1U == s_cdcVcom.attach) && (1U == s_cdcVcom.startTransactions))
            {
                if ((epCbParam->buffer != 0) || ((epCbParam->buffer == 0) && (epCbParam->length == 0)))
                {
# 271 "../../libraries/zf_driver/zf_driver_usb_cdc.c"
                }
            }
            else
            {
        ...
        case kUSB_DeviceCdcEventRecvResponse:
        {
            if ((1U == s_cdcVcom.attach) && (1U == s_cdcVcom.startTransactions))
            {
...

                {
                    ...
                    error = USB_DeviceCdcAcmRecv(handle, (3U), usb_cdc_receive_buff,
        ...
        case kUSB_DeviceCdcEventSetCommFeature:
            if ((0x01U) == acmReqParam->setupValue)
            {
            ...
            else if ((0x02U) == acmReqParam->setupValue)
            {
                if (1U == acmReqParam->isSetup)
                {
        ...
        case kUSB_DeviceCdcEventSetControlLineState:
        {
            ...
            if (acmInfo->dteStatus & (0x02U))
            {
                acmInfo->uartState |= (0x02U);
            }
            else
            {
                acmInfo->uartState &= (uint16_t)~(0x02U);
            }


            if (acmInfo->dteStatus & (0x01U))
            {
                acmInfo->uartState |= (0x01U);
            }

            else
            {
                acmInfo->uartState &= (uint16_t)~(0x01U);
            }


            acmInfo->dtePresent = (acmInfo->dteStatus & (0x01U)) ? 1 : 0;


            acmInfo->serialStateBuf[0] = (0xA1);
            acmInfo->serialStateBuf[1] = (0x20U);
            acmInfo->serialStateBuf[2] = 0x00;
            acmInfo->serialStateBuf[3] = 0x00;
            acmInfo->serialStateBuf[4] = 0x00;
            acmInfo->serialStateBuf[5] = 0x00;
            acmInfo->serialStateBuf[6] = (0x02);
            acmInfo->serialStateBuf[7] = 0x00;

            acmInfo->serialStateBuf[4] = acmReqParam->interfaceIndex;

            uartBitmap = (uint8_t *)&acmInfo->serialStateBuf[(0x08) + (0x02) - 2];
            uartBitmap[0] = acmInfo->uartState & 0xFFu;
            uartBitmap[1] = (acmInfo->uartState >> 8) & 0xFFu;


            len = (uint32_t)((0x08) + (0x02));
            if (0U == ((usb_device_cdc_acm_struct_t *)handle)->hasSentState)
            {
                error = USB_DeviceCdcAcmSend(handle, (1U), acmInfo->serialStateBuf, len);
                if (kStatus_USB_Success != error)
                {
                    DbgConsole_Printf("kUSB_DeviceCdcEventSetControlLineState error!");
                }
...
# 470 "../../libraries/zf_driver/zf_driver_usb_cdc.c"
            }
            error = kStatus_USB_Success;
        }
        break;
    ...
    switch (event)
    {
        ...
        case kUSB_DeviceEventSetConfiguration:
            ...
            else if ((1U) == (*temp8))
            {
                ...
                USB_DeviceCdcAcmRecv(s_cdcVcom.cdcAcmHandle, (3U), usb_cdc_receive_buff,
                                     g_UsbDeviceCdcVcomDicEndpoints[1].maxPacketSize);
            }
            else
            {
...
uint8 usb_cdc_check_busy(void)
{
    ...
    usb_device_cdc_acm_pipe_t *cdcAcmPipe = 0;
...
void usb_cdc_write_byte(uint8 dat)
{
 ...
 {
  while(usb_cdc_check_busy())
  {
   system_delay_us(10);
   if(5000 <= delay_num++)usb_cdc_com_open_flag = 0;
   if(!usb_cdc_com_open_flag) return;
  }
  USB_DeviceCdcAcmSend(s_cdcVcom.cdcAcmHandle, (2U), &dat, 1);
 }
}
...
void usb_cdc_write_string(const char *str)
{
 ...
 if(usb_cdc_com_open_flag)
 {
  ...
  USB_DeviceCdcAcmSend(s_cdcVcom.cdcAcmHandle, (2U), (uint8 *)str, strlen((const char *)str));
 }
}
# 670 "../../libraries/zf_driver/zf_driver_usb_cdc.c"
void usb_cdc_write_buffer(uint8 *p, uint32 length)
{
 uint16 delay_num=0;
 ...
 while(length)
 {
  ...
  if(length>512)
  {
   USB_DeviceCdcAcmSend(s_cdcVcom.cdcAcmHandle, (2U), p, 512);
   p += 512;
   length -= 512;
  }
  else
  {
   USB_DeviceCdcAcmSend(s_cdcVcom.cdcAcmHandle, (2U), p, length);
   length = 0;
  }
 }
}
# 707 "../../libraries/zf_driver/zf_driver_usb_cdc.c"
void usb_cdc_receive_buffer_callback(void)
{
...
void usb_cdc_init(void)
{
    ...
    s_cdcVcom.speed = (0x00U);
    s_cdcVcom.attach = 0;
    s_cdcVcom.cdcAcmHandle = (class_handle_t)0;
    s_cdcVcom.deviceHandle = 0;

    if (kStatus_USB_Success != USB_DeviceClassInit(kUSB_ControllerEhci0, &s_cdcAcmConfigList, &s_cdcVcom.deviceHandle))
    {
