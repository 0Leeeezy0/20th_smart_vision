# 1 "../../libraries/zf_device/zf_device_type.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/zf_device/zf_device_type.c" 2
# 36 "../../libraries/zf_device/zf_device_type.c"
# 1 "../../libraries/zf_device/zf_device_bluetooth_ch9141.h" 1
# 50 "../../libraries/zf_device/zf_device_bluetooth_ch9141.h"
...
# 51 "../../libraries/zf_device/zf_device_bluetooth_ch9141.h" 2
...
# 37 "../../libraries/zf_device/zf_device_type.c" 2
...
# 39 "../../libraries/zf_device/zf_device_type.c" 2


camera_type_enum camera_type = NO_CAMERE;
callback_function camera_uart_handler = type_default_callback;

camera_type_enum flexio_camera_type = NO_CAMERE;
callback_function flexio_camera_vsync_handler = type_default_callback;
callback_function flexio_camera_uart_handler = type_default_callback;
...
# 75 "../../libraries/zf_device/zf_device_type.c"
void set_camera_type (camera_type_enum type_set, callback_function vsync_callback, callback_function dma_callback, callback_function uart_callback)
{
    camera_type = type_set;
    camera_uart_handler = ((uart_callback == 0) ? (type_default_callback) : (uart_callback));
}
# 88 "../../libraries/zf_device/zf_device_type.c"
void set_flexio_camera_type (camera_type_enum type_set, callback_function vsync_callback, callback_function dma_callback, callback_function uart_callback)
{
    flexio_camera_type = type_set;
    flexio_camera_uart_handler = ((uart_callback == 0) ? (type_default_callback) : (uart_callback));
    flexio_camera_vsync_handler = ((vsync_callback == 0) ? (type_default_callback) : (vsync_callback));
}
# 103 "../../libraries/zf_device/zf_device_type.c"
void set_wireless_type (wireless_type_enum type_set, callback_function wireless_callback)
{
    wireless_type = type_set;
    if(WIFI_SPI == wireless_type)
    {
        wireless_module_spi_handler = ((wireless_callback == 0) ? (type_default_callback) : (wireless_callback));
    }
    else
    {
        wireless_module_uart_handler = ((wireless_callback == 0) ? (type_default_callback) : (wireless_callback));
    }
}
# 124 "../../libraries/zf_device/zf_device_type.c"
void set_tof_type (tof_type_enum type_set, callback_function exti_callback)
{
    tof_type = type_set;
    tof_module_exti_handler = ((exti_callback == 0) ? (type_default_callback) : (exti_callback));
}
