# 1 "../../libraries/sdk/drives/fsl_snvs_lp.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/sdk/drives/fsl_snvs_lp.c" 2
...
# 1 "../../libraries/sdk/drives/fsl_snvs_lp.h" 1
# 12 "../../libraries/sdk/drives/fsl_snvs_lp.h"
...
# 13 "../../libraries/sdk/drives/fsl_snvs_lp.h" 2
# 32 "../../libraries/sdk/drives/fsl_snvs_lp.h"
typedef enum _snvs_lp_srtc_interrupts
{
    kSNVS_SRTC_AlarmInterrupt = (0x2U),
} snvs_lp_srtc_interrupts_t;


typedef enum _snvs_lp_srtc_status_flags
{
    kSNVS_SRTC_AlarmInterruptFlag = (0x1U),
} snvs_lp_srtc_status_flags_t;
# 103 "../../libraries/sdk/drives/fsl_snvs_lp.h"
typedef struct
{
    uint8_t polarity;
...
# 121 "../../libraries/sdk/drives/fsl_snvs_lp.h"
...
# 154 "../../libraries/sdk/drives/fsl_snvs_lp.h"
...
# 201 "../../libraries/sdk/drives/fsl_snvs_lp.h"
...
# 220 "../../libraries/sdk/drives/fsl_snvs_lp.h"
...
# 239 "../../libraries/sdk/drives/fsl_snvs_lp.h"
void SNVS_LP_SRTC_GetDefaultConfig(snvs_lp_srtc_config_t *config);
# 255 "../../libraries/sdk/drives/fsl_snvs_lp.h"
...
# 283 "../../libraries/sdk/drives/fsl_snvs_lp.h"
...
{
    base->LPCR &= ~(0x1U);
    while ((base->LPCR & (0x1U)) != 0U)
    {
    }
}
# 520 "../../libraries/sdk/drives/fsl_snvs_lp.h"
void SNVS_LP_PassiveTamperPin_GetDefaultConfig(snvs_lp_passive_tamper_t *config);
# 579 "../../libraries/sdk/drives/fsl_snvs_lp.h"
static inline void SNVS_LP_EnableMonotonicCounter(SNVS_Type *base, _Bool enable)
{
    if (enable)
    {
        base->LPCR |= (0x4U);
...
# 606 "../../libraries/sdk/drives/fsl_snvs_lp.h"
static inline void SNVS_LP_IncreaseMonotonicCounter(SNVS_Type *base)
{

    *((volatile uint32_t *)(uint32_t)(&(base->LPSMCLR))) = 0xFFFFFFFFU;
}
# 625 "../../libraries/sdk/drives/fsl_snvs_lp.h"
void SNVS_LP_WriteZeroizableMasterKey(SNVS_Type *base, uint32_t ZMKey[8U]);
# 637 "../../libraries/sdk/drives/fsl_snvs_lp.h"
static inline void SNVS_LP_SetZeroizableMasterKeyValid(SNVS_Type *base, _Bool valid)
{
    if (valid)
    {
        base->LPMKCR |= (0x8U);
...
# 657 "../../libraries/sdk/drives/fsl_snvs_lp.h"
static inline _Bool SNVS_LP_GetZeroizableMasterKeyValid(SNVS_Type *base)
{
    return ((0x8U) == (base->LPMKCR & (0x8U)));
}
...
static inline void SNVS_LP_EnableZeroizableMasterKeyECC(SNVS_Type *base, _Bool enable)
{
    if (enable)
    {
        base->LPMKCR |= (0x10U);
...
# 706 "../../libraries/sdk/drives/fsl_snvs_lp.h"
static inline void SNVS_LP_SetMasterKeyMode(SNVS_Type *base, snvs_lp_master_key_mode_t mode)
{
    uint32_t lpmkcr = base->LPMKCR;
    lpmkcr = (lpmkcr & (~(0x3U))) | (((uint32_t)(((uint32_t)(mode)) << (0U))) & (0x3U));
    base->LPMKCR = lpmkcr;
}
# 10 "../../libraries/sdk/drives/fsl_snvs_lp.c" 2
# 39 "../../libraries/sdk/drives/fsl_snvs_lp.c"
static _Bool SNVS_LP_CheckDatetimeFormat(const snvs_lp_srtc_datetime_t *datetime);
# 48 "../../libraries/sdk/drives/fsl_snvs_lp.c"
...
# 67 "../../libraries/sdk/drives/fsl_snvs_lp.c"
static uint32_t SNVS_LP_SRTC_GetSeconds(SNVS_Type *base);
# 93 "../../libraries/sdk/drives/fsl_snvs_lp.c"
static _Bool SNVS_LP_CheckDatetimeFormat(const snvs_lp_srtc_datetime_t *datetime)
{
    ((datetime != 0) ? (void)0 : __aeabi_assert("datetime != NULL", "../../libraries/sdk/drives/fsl_snvs_lp.c", 95),
# 95 "../../libraries/sdk/drives/fsl_snvs_lp.c"
#pragma clang diagnostic push
# 95 "../../libraries/sdk/drives/fsl_snvs_lp.c"
#pragma clang diagnostic ignored "-Wassume"
# 95 "../../libraries/sdk/drives/fsl_snvs_lp.c"
...
static uint32_t SNVS_LP_ConvertDatetimeToSeconds(const snvs_lp_srtc_datetime_t *datetime)
{
    ((datetime != 0) ? (void)0 : __aeabi_assert("datetime != NULL", "../../libraries/sdk/drives/fsl_snvs_lp.c", 127),
# 127 "../../libraries/sdk/drives/fsl_snvs_lp.c"
#pragma clang diagnostic push
# 127 "../../libraries/sdk/drives/fsl_snvs_lp.c"
#pragma clang diagnostic ignored "-Wassume"
# 127 "../../libraries/sdk/drives/fsl_snvs_lp.c"
...
static void SNVS_LP_ConvertSecondsToDatetime(uint32_t seconds, snvs_lp_srtc_datetime_t *datetime)
{
    ((datetime != 0) ? (void)0 : __aeabi_assert("datetime != NULL", "../../libraries/sdk/drives/fsl_snvs_lp.c", 157),
# 157 "../../libraries/sdk/drives/fsl_snvs_lp.c"
#pragma clang diagnostic push
# 157 "../../libraries/sdk/drives/fsl_snvs_lp.c"
#pragma clang diagnostic ignored "-Wassume"
# 157 "../../libraries/sdk/drives/fsl_snvs_lp.c"
...
# 242 "../../libraries/sdk/drives/fsl_snvs_lp.c"
void SNVS_LP_Init(SNVS_Type *base)
{
# 255 "../../libraries/sdk/drives/fsl_snvs_lp.c"
    base->LPLVDR = (0x41736166U);
    base->LPSR = (0x8U);
...
# 284 "../../libraries/sdk/drives/fsl_snvs_lp.c"
void SNVS_LP_SRTC_Init(SNVS_Type *base, const snvs_lp_srtc_config_t *config)
{
    ((config != 0) ? (void)0 : __aeabi_assert("config != NULL", "../../libraries/sdk/drives/fsl_snvs_lp.c", 286),
# 286 "../../libraries/sdk/drives/fsl_snvs_lp.c"
#pragma clang diagnostic push
# 286 "../../libraries/sdk/drives/fsl_snvs_lp.c"
#pragma clang diagnostic ignored "-Wassume"
# 286 "../../libraries/sdk/drives/fsl_snvs_lp.c"
...
# 286 "../../libraries/sdk/drives/fsl_snvs_lp.c"
    ...
    {
        base->LPCR = (base->LPCR & ~(0x7C00U)) | (((uint32_t)(((uint32_t)(config->srtcCalValue)) << (10U))) & (0x7C00U));
        base->LPCR |= (0x100U);
    }
# 306 "../../libraries/sdk/drives/fsl_snvs_lp.c"
}
...
# 330 "../../libraries/sdk/drives/fsl_snvs_lp.c"
void SNVS_LP_SRTC_GetDefaultConfig(snvs_lp_srtc_config_t *config)
{
    ((config != 0) ? (void)0 : __aeabi_assert("config != NULL", "../../libraries/sdk/drives/fsl_snvs_lp.c", 332),
# 332 "../../libraries/sdk/drives/fsl_snvs_lp.c"
#pragma clang diagnostic push
# 332 "../../libraries/sdk/drives/fsl_snvs_lp.c"
#pragma clang diagnostic ignored "-Wassume"
# 332 "../../libraries/sdk/drives/fsl_snvs_lp.c"
...
# 366 "../../libraries/sdk/drives/fsl_snvs_lp.c"
status_t SNVS_LP_SRTC_SetDatetime(SNVS_Type *base, const snvs_lp_srtc_datetime_t *datetime)
{
    ((datetime != 0) ? (void)0 : __aeabi_assert("datetime != NULL", "../../libraries/sdk/drives/fsl_snvs_lp.c", 368),
# 368 "../../libraries/sdk/drives/fsl_snvs_lp.c"
#pragma clang diagnostic push
# 368 "../../libraries/sdk/drives/fsl_snvs_lp.c"
#pragma clang diagnostic ignored "-Wassume"
# 368 "../../libraries/sdk/drives/fsl_snvs_lp.c"
...
void SNVS_LP_SRTC_GetDatetime(SNVS_Type *base, snvs_lp_srtc_datetime_t *datetime)
{
    ((datetime != 0) ? (void)0 : __aeabi_assert("datetime != NULL", "../../libraries/sdk/drives/fsl_snvs_lp.c", 405),
# 405 "../../libraries/sdk/drives/fsl_snvs_lp.c"
#pragma clang diagnostic push
# 405 "../../libraries/sdk/drives/fsl_snvs_lp.c"
#pragma clang diagnostic ignored "-Wassume"
# 405 "../../libraries/sdk/drives/fsl_snvs_lp.c"
...
# 428 "../../libraries/sdk/drives/fsl_snvs_lp.c"
status_t SNVS_LP_SRTC_SetAlarm(SNVS_Type *base, const snvs_lp_srtc_datetime_t *alarmTime)
{
    ((alarmTime != 0) ? (void)0 : __aeabi_assert("alarmTime != NULL", "../../libraries/sdk/drives/fsl_snvs_lp.c", 430),
# 430 "../../libraries/sdk/drives/fsl_snvs_lp.c"
#pragma clang diagnostic push
# 430 "../../libraries/sdk/drives/fsl_snvs_lp.c"
#pragma clang diagnostic ignored "-Wassume"
# 430 "../../libraries/sdk/drives/fsl_snvs_lp.c"
...
void SNVS_LP_SRTC_GetAlarm(SNVS_Type *base, snvs_lp_srtc_datetime_t *datetime)
{
    ((datetime != 0) ? (void)0 : __aeabi_assert("datetime != NULL", "../../libraries/sdk/drives/fsl_snvs_lp.c", 474),
# 474 "../../libraries/sdk/drives/fsl_snvs_lp.c"
#pragma clang diagnostic push
# 474 "../../libraries/sdk/drives/fsl_snvs_lp.c"
#pragma clang diagnostic ignored "-Wassume"
# 474 "../../libraries/sdk/drives/fsl_snvs_lp.c"
...
# 492 "../../libraries/sdk/drives/fsl_snvs_lp.c"
uint32_t SNVS_LP_SRTC_GetStatusFlags(SNVS_Type *base)
{
    uint32_t flags = 0U;

    if ((base->LPSR & (0x1U)) != 0U)
    {
...
# 512 "../../libraries/sdk/drives/fsl_snvs_lp.c"
uint32_t SNVS_LP_SRTC_GetEnabledInterrupts(SNVS_Type *base)
{
    uint32_t val = 0U;

    if ((base->LPCR & (0x2U)) != 0U)
    {
...
# 535 "../../libraries/sdk/drives/fsl_snvs_lp.c"
void SNVS_LP_PassiveTamperPin_GetDefaultConfig(snvs_lp_passive_tamper_t *config)
{
    ((config != 0) ? (void)0 : __aeabi_assert("config != NULL", "../../libraries/sdk/drives/fsl_snvs_lp.c", 537),
# 537 "../../libraries/sdk/drives/fsl_snvs_lp.c"
#pragma clang diagnostic push
# 537 "../../libraries/sdk/drives/fsl_snvs_lp.c"
#pragma clang diagnostic ignored "-Wassume"
# 537 "../../libraries/sdk/drives/fsl_snvs_lp.c"
...
# 1291 "../../libraries/sdk/drives/fsl_snvs_lp.c"
uint64_t SNVS_LP_GetMonotonicCounter(SNVS_Type *base)
{
