# 1 "../../libraries/sdk/drives/fsl_flexspi.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/sdk/drives/fsl_flexspi.c" 2
...
# 1 "../../libraries/sdk/drives/fsl_flexspi.h" 1
# 12 "../../libraries/sdk/drives/fsl_flexspi.h"
...
# 13 "../../libraries/sdk/drives/fsl_flexspi.h" 2
...
# 14 "../../libraries/sdk/drives/fsl_flexspi.h" 2
...
# 15 "../../libraries/sdk/drives/fsl_flexspi.h" 2
# 39 "../../libraries/sdk/drives/fsl_flexspi.h"
enum
{
    kStatus_FLEXSPI_Busy = ((((kStatusGroup_FLEXSPI)*100L) + (0))),
    kStatus_FLEXSPI_SequenceExecutionTimeout = ((((kStatusGroup_FLEXSPI)*100L) + (1))),

    kStatus_FLEXSPI_IpCommandSequenceError = ((((kStatusGroup_FLEXSPI)*100L) + (2))),

    kStatus_FLEXSPI_IpCommandGrantTimeout = ((((kStatusGroup_FLEXSPI)*100L) + (3))),
...
{
    kFLEXSPI_SequenceExecutionTimeoutFlag = (0x800U),



    kFLEXSPI_AhbBusTimeoutFlag = (0x400U),
    ...
    kFLEXSPI_IpTxFifoWatermarkEmptyFlag = (0x40U),
    kFLEXSPI_IpRxFifoWatermarkAvailableFlag = (0x20U),
    kFLEXSPI_AhbCommandSequenceErrorFlag =
        (0x10U),
    kFLEXSPI_IpCommandSequenceErrorFlag = (0x8U),
...
typedef struct _flexspi_config
{
    ...
    _Bool enableSckFreeRunning;

    _Bool enableCombination;


    _Bool enableDoze;
    _Bool enableHalfSpeedAccess;


    _Bool enableSckBDiffOpt;


    _Bool enableSameConfigForAll;
    ...
    struct
    {
        ...
        _Bool enableAHBWriteIpTxFifo;


        _Bool enableAHBWriteIpRxFifo;
        ...
        _Bool enableClearAHBBufferOpt;

        _Bool enableReadAddressOpt;

        _Bool enableAHBPrefetch;

        _Bool enableAHBBufferable;

        _Bool enableAHBCachable;
    } ahbConfig;
} flexspi_config_t;
...
# 353 "../../libraries/sdk/drives/fsl_flexspi.h"
...
# 372 "../../libraries/sdk/drives/fsl_flexspi.h"
...
static inline void FLEXSPI_Enable(FLEXSPI_Type *base, _Bool enable)
{
    if (enable)
    {
        base->MCR0 &= ~(0x2U);
...
# 457 "../../libraries/sdk/drives/fsl_flexspi.h"
...
# 484 "../../libraries/sdk/drives/fsl_flexspi.h"
static inline void FLEXSPI_EnableTxDMA(FLEXSPI_Type *base, _Bool enable)
{
    if (enable)
    {
        base->IPTXFCR |= (0x2U);
...
static inline void FLEXSPI_EnableRxDMA(FLEXSPI_Type *base, _Bool enable)
{
    if (enable)
    {
        base->IPRXFCR |= (0x2U);
...
# 547 "../../libraries/sdk/drives/fsl_flexspi.h"
static inline void FLEXSPI_ResetFifos(FLEXSPI_Type *base, _Bool txFifo, _Bool rxFifo)
{
    if (txFifo)
    {
        base->IPTXFCR |= (0x1U);
...
# 568 "../../libraries/sdk/drives/fsl_flexspi.h"
static inline void FLEXSPI_GetFifoCounts(FLEXSPI_Type *base, size_t *txCount, size_t *rxCount)
{
    if (0 != txCount)
    {
        *txCount = (((base->IPTXFSTS) & (0xFFU)) >> (0U)) * 8U;
    }
    if (0 != rxCount)
    {
        *rxCount = (((base->IPRXFSTS) & (0xFFU)) >> (0U)) * 8U;
    }
}
# 592 "../../libraries/sdk/drives/fsl_flexspi.h"
...
# 636 "../../libraries/sdk/drives/fsl_flexspi.h"
...
{
    *index = (uint8_t)((base->STS1 & (0xF0000U)) >> (16U));
    return (flexspi_ip_error_code_t)(
        (uint32_t)((base->STS1 & (0xF000000U)) >> (24U)));
}
...
{
    *index = (uint8_t)(base->STS1 & (0xFU)) >> (0U);
    return (flexspi_ahb_error_code_t)(
        (uint32_t)((base->STS1 & (0xF00U)) >> (8U)));
}
...
static inline _Bool FLEXSPI_GetBusIdleStatus(FLEXSPI_Type *base)
{
    return (0U != (base->STS0 & (0x2U))) && (0U != (base->STS0 & (0x1U)));
}
# 690 "../../libraries/sdk/drives/fsl_flexspi.h"
...
static inline void FLEXSPI_EnableIPParallelMode(FLEXSPI_Type *base, _Bool enable)
{
    if (enable)
    {
        base->IPCR1 |= (0x80000000U);
    }
    else
    {
        base->IPCR1 &= ~(0x80000000U);
...
# 717 "../../libraries/sdk/drives/fsl_flexspi.h"
static inline void FLEXSPI_EnableAHBParallelMode(FLEXSPI_Type *base, _Bool enable)
{
    if (enable)
    {
        base->AHBCR |= (0x1U);
...
# 10 "../../libraries/sdk/drives/fsl_flexspi.c" 2
# 24 "../../libraries/sdk/drives/fsl_flexspi.c"
enum
{
    kFLEXSPI_DelayCellUnitMin = 75,
    kFLEXSPI_DelayCellUnitMax = 225,
};
...
{
    kFLEXSPI_Idle = 0x0U,
    kFLEXSPI_BusyWrite = 0x1U,
    kFLEXSPI_BusyRead = 0x2U,
};
...
static FLEXSPI_Type *const s_flexspiBases[] = { ((FLEXSPI_Type *)(0x402A8000u)), (FLEXSPI_Type *)0u, ((FLEXSPI_Type *)(0x402A4000u)) };


static const IRQn_Type s_flexspiIrqs[] = { FLEXSPI_IRQn, NotAvail_IRQn, FLEXSPI2_IRQn };



static const clock_ip_name_t s_flexspiClock[] = { kCLOCK_FlexSpi, kCLOCK_IpInvalid, kCLOCK_FlexSpi2 };
# 118 "../../libraries/sdk/drives/fsl_flexspi.c"
static void FLEXSPI_Memset(void *src, uint8_t value, size_t length)
{
    ((src != 0) ? (void)0 : __aeabi_assert("src != NULL", "../../libraries/sdk/drives/fsl_flexspi.c", 120),
# 120 "../../libraries/sdk/drives/fsl_flexspi.c"
#pragma clang diagnostic push
# 120 "../../libraries/sdk/drives/fsl_flexspi.c"
#pragma clang diagnostic ignored "-Wassume"
# 120 "../../libraries/sdk/drives/fsl_flexspi.c"
...
uint32_t FLEXSPI_GetInstance(FLEXSPI_Type *base)
{
    ...
    for (instance = 0; instance < (sizeof(s_flexspiBases) / sizeof((s_flexspiBases)[0])); instance++)
    {
    ...
    ((instance < (sizeof(s_flexspiBases) / sizeof((s_flexspiBases)[0]))) ? (void)0 : __aeabi_assert("instance < ARRAY_SIZE(s_flexspiBases)", "../../libraries/sdk/drives/fsl_flexspi.c", 143),
# 143 "../../libraries/sdk/drives/fsl_flexspi.c"
#pragma clang diagnostic push
# 143 "../../libraries/sdk/drives/fsl_flexspi.c"
#pragma clang diagnostic ignored "-Wassume"
# 143 "../../libraries/sdk/drives/fsl_flexspi.c"
    (__builtin_assume)((instance < (sizeof(s_flexspiBases) / sizeof((s_flexspiBases)[0])))?1:0)
# 143 "../../libraries/sdk/drives/fsl_flexspi.c"
#pragma clang diagnostic pop
# 143 "../../libraries/sdk/drives/fsl_flexspi.c"
    );
...
static uint32_t FLEXSPI_CalculateDll(FLEXSPI_Type *base, flexspi_device_config_t *config)
{
    ...
    uint32_t rxSampleClock = (base->MCR0 & (0x30U)) >> (4U);
    switch (rxSampleClock)
    {
        ...
        case (uint32_t)kFLEXSPI_ReadSampleClkExternalInputFromDqsPad:
            ...
            break;
        default:
            ((0) ? (void)0 : __aeabi_assert("false", "../../libraries/sdk/drives/fsl_flexspi.c", 176),
# 176 "../../libraries/sdk/drives/fsl_flexspi.c"
#pragma clang diagnostic push
# 176 "../../libraries/sdk/drives/fsl_flexspi.c"
#pragma clang diagnostic ignored "-Wassume"
# 176 "../../libraries/sdk/drives/fsl_flexspi.c"
...
# 176 "../../libraries/sdk/drives/fsl_flexspi.c"
    ...
    {
        if (config->flexspiRootClk >= 100U * (1000000UL))
        {
            ...
            flexspiDllValue = (((uint32_t)(((uint32_t)(1)) << (0U))) & (0x1U)) | (((uint32_t)(((uint32_t)(0x0F)) << (3U))) & (0x78U));

        }
        else
        {
            temp = (uint32_t)config->dataValidTime * 1000U;
            dllValue = temp / (uint32_t)kFLEXSPI_DelayCellUnitMin;
            if (dllValue * (uint32_t)kFLEXSPI_DelayCellUnitMin < temp)
            {
                dllValue++;
            }
            flexspiDllValue = (((uint32_t)(((uint32_t)(1)) << (8U))) & (0x100U)) | (((uint32_t)(((uint32_t)(dllValue)) << (9U))) & (0x7E00U));
        }
    }
...
status_t FLEXSPI_CheckAndClearError(FLEXSPI_Type *base, uint32_t status)
{
    ...
    if (0U != status)
    {
        ...
        {
            ((0) ? (void)0 : __aeabi_assert("false", "../../libraries/sdk/drives/fsl_flexspi.c", 233),
# 233 "../../libraries/sdk/drives/fsl_flexspi.c"
#pragma clang diagnostic push
# 233 "../../libraries/sdk/drives/fsl_flexspi.c"
#pragma clang diagnostic ignored "-Wassume"
# 233 "../../libraries/sdk/drives/fsl_flexspi.c"
...
# 256 "../../libraries/sdk/drives/fsl_flexspi.c"
void FLEXSPI_Init(FLEXSPI_Type *base, const flexspi_config_t *config)
{
...
# 272 "../../libraries/sdk/drives/fsl_flexspi.c"
    base->MCR0 &= ~(0x2U);
    FLEXSPI_SoftwareReset(base);


    configValue = (((uint32_t)(((uint32_t)(config->rxSampleClock)) << (4U))) & (0x30U)) | (((uint32_t)(((uint32_t)(config->enableDoze)) << (12U))) & (0x1000U)) |
                  (((uint32_t)(((uint32_t)(config->ipGrantTimeoutCycle)) << (16U))) & (0xFF0000U)) |
                  (((uint32_t)(((uint32_t)(config->ahbConfig.ahbGrantTimeoutCycle)) << (24U))) & (0xFF000000U)) |
                  (((uint32_t)(((uint32_t)(config->enableSckFreeRunning)) << (14U))) & (0x4000U)) |
                  (((uint32_t)(((uint32_t)(config->enableHalfSpeedAccess)) << (11U))) & (0x800U)) |

                  (((uint32_t)(((uint32_t)(config->enableCombination)) << (13U))) & (0x2000U)) |


                  (((uint32_t)(((uint32_t)(config->ahbConfig.enableAHBWriteIpTxFifo)) << (7U))) & (0x80U)) |


                  (((uint32_t)(((uint32_t)(config->ahbConfig.enableAHBWriteIpRxFifo)) << (6U))) & (0x40U)) |
    ...
    configValue =
        (((uint32_t)(((uint32_t)(config->seqTimeoutCycle)) << (16U))) & (0xFFFF0000U)) | (((uint32_t)(((uint32_t)(config->ahbConfig.ahbBusTimeoutCycle)) << (0U))) & (0xFFFFU));
    base->MCR1 = configValue;


    configValue = base->MCR2;
    configValue &= ~((0xFF000000U) |

                     (0x80000U) |

                     (0x8000U) | (0x800U));
    configValue |= (((uint32_t)(((uint32_t)(config->ahbConfig.resumeWaitCycle)) << (24U))) & (0xFF000000U)) |

                   (((uint32_t)(((uint32_t)(config->enableSckBDiffOpt)) << (19U))) & (0x80000U)) |

                   (((uint32_t)(((uint32_t)(config->enableSameConfigForAll)) << (15U))) & (0x8000U)) |
                   (((uint32_t)(((uint32_t)(config->ahbConfig.enableClearAHBBufferOpt)) << (11U))) & (0x800U));

    base->MCR2 = configValue;


    configValue = base->AHBCR;
    configValue &= ~((0x40U) | (0x20U) | (0x10U) |
                     (0x8U));
    configValue |= (((uint32_t)(((uint32_t)(config->ahbConfig.enableReadAddressOpt)) << (6U))) & (0x40U)) |
                   (((uint32_t)(((uint32_t)(config->ahbConfig.enableAHBPrefetch)) << (5U))) & (0x20U)) |
                   (((uint32_t)(((uint32_t)(config->ahbConfig.enableAHBBufferable)) << (4U))) & (0x10U)) |
                   (((uint32_t)(((uint32_t)(config->ahbConfig.enableAHBCachable)) << (3U))) & (0x8U));
    base->AHBCR = configValue;


    for (i = 0; i < (uint32_t)(4); i++)
    {
        configValue = base->AHBRXBUFCR0[i];

        configValue &= ~((0x80000000U) | (0x3000000U) |
                         (0xF0000U) | (0xFFU));
        configValue |= (((uint32_t)(((uint32_t)(config->ahbConfig.buffer[i].enablePrefetch)) << (31U))) & (0x80000000U)) |
                       (((uint32_t)(((uint32_t)(config->ahbConfig.buffer[i].priority)) << (24U))) & (0x3000000U)) |
                       (((uint32_t)(((uint32_t)(config->ahbConfig.buffer[i].masterIndex)) << (16U))) & (0xF0000U)) |
                       (((uint32_t)(((uint32_t)((uint32_t)config->ahbConfig.buffer[i].bufferSize / 8U)) << (0U))) & (0xFFU));
        base->AHBRXBUFCR0[i] = configValue;
    }


    base->IPRXFCR &= ~(0x3CU);
    base->IPRXFCR |= (((uint32_t)(((uint32_t)((uint32_t)config->rxWatermark / 8U - 1U)) << (2U))) & (0x3CU));
    base->IPTXFCR &= ~(0x3CU);
    base->IPTXFCR |= (((uint32_t)(((uint32_t)((uint32_t)config->txWatermark / 8U - 1U)) << (2U))) & (0x3CU));
...
void FLEXSPI_GetDefaultConfig(flexspi_config_t *config)
{
    ...
    config->enableSckFreeRunning = 0;

    config->enableCombination = 0;

    config->enableDoze = 1;
    config->enableHalfSpeedAccess = 0;

    config->enableSckBDiffOpt = 0;

    config->enableSameConfigForAll = 0;
    config->seqTimeoutCycle = 0xFFFFU;
    config->ipGrantTimeoutCycle = 0xFFU;
    config->txWatermark = 8;
    config->rxWatermark = 8;

    config->ahbConfig.enableAHBWriteIpTxFifo = 0;


    config->ahbConfig.enableAHBWriteIpRxFifo = 0;
    ...
    for (uint8_t i = 0; i < ((uint8_t)(4) - 2U); i++)
    {
        config->ahbConfig.buffer[i].enablePrefetch = 1;
        config->ahbConfig.buffer[i].masterIndex = 0xFU;
        config->ahbConfig.buffer[i].bufferSize =
            0;
    }

    for (uint8_t i = ((uint8_t)(4) - 2U);
         i < (uint8_t)(4); i++)
    {
        config->ahbConfig.buffer[i].enablePrefetch = 1;
        config->ahbConfig.buffer[i].bufferSize = 256U;
    }
    config->ahbConfig.enableClearAHBBufferOpt = 0;
    config->ahbConfig.enableReadAddressOpt = 0;
    config->ahbConfig.enableAHBPrefetch = 0;
    config->ahbConfig.enableAHBBufferable = 0;
    config->ahbConfig.enableAHBCachable = 0;
}
...
# 427 "../../libraries/sdk/drives/fsl_flexspi.c"
void FLEXSPI_UpdateDllValue(FLEXSPI_Type *base, flexspi_device_config_t *config, flexspi_port_t port)
{
    uint32_t configValue = 0;
...
# 484 "../../libraries/sdk/drives/fsl_flexspi.c"
void FLEXSPI_SetFlashConfig(FLEXSPI_Type *base, flexspi_device_config_t *config, flexspi_port_t port)
{
    uint32_t configValue = 0;
    uint8_t index = (uint8_t)port >> 1U;
    ...
    base->FLSHCR1[port] = (((uint32_t)(((uint32_t)(config->CSInterval)) << (16U))) & (0xFFFF0000U)) |
                          (((uint32_t)(((uint32_t)(config->CSIntervalUnit)) << (15U))) & (0x8000U)) |
                          (((uint32_t)(((uint32_t)(config->CSHoldTime)) << (5U))) & (0x3E0U)) | (((uint32_t)(((uint32_t)(config->CSSetupTime)) << (0U))) & (0x1FU)) |
                          (((uint32_t)(((uint32_t)(config->columnspace)) << (11U))) & (0x7800U)) | (((uint32_t)(((uint32_t)(config->enableWordAddress)) << (10U))) & (0x400U));


    configValue = base->FLSHCR2[port];

    configValue &= ~((0x70000000U) | (0xFFF0000U) | (0xE000U) |
                     (0xF00U) | (0xE0U) | (0xFU));

    configValue |=
        (((uint32_t)(((uint32_t)(config->AHBWriteWaitUnit)) << (28U))) & (0x70000000U)) | (((uint32_t)(((uint32_t)(config->AHBWriteWaitInterval)) << (16U))) & (0xFFF0000U));

    if (config->AWRSeqNumber > 0U)
    {
        configValue |= (((uint32_t)(((uint32_t)((uint32_t)config->AWRSeqIndex)) << (8U))) & (0xF00U)) |
                       (((uint32_t)(((uint32_t)((uint32_t)config->AWRSeqNumber - 1U)) << (13U))) & (0xE000U));
    }

    if (config->ARDSeqNumber > 0U)
    {
        configValue |= (((uint32_t)(((uint32_t)((uint32_t)config->ARDSeqIndex)) << (0U))) & (0xFU)) |
                       (((uint32_t)(((uint32_t)((uint32_t)config->ARDSeqNumber - 1U)) << (5U))) & (0xE0U));
    }
    ...
    {
        base->FLSHCR4 &= ~(0x4U);
        base->FLSHCR4 |= (((uint32_t)(((uint32_t)(config->enableWriteMask)) << (2U))) & (0x4U));
    }

    else
    {
        base->FLSHCR4 &= ~(0x8U);
        base->FLSHCR4 |= (((uint32_t)(((uint32_t)(config->enableWriteMask)) << (3U))) & (0x8U));
    }
...
# 573 "../../libraries/sdk/drives/fsl_flexspi.c"
void FLEXSPI_UpdateLUT(FLEXSPI_Type *base, uint32_t index, const uint32_t *cmd, uint32_t count)
{
    ((index < 64U) ? (void)0 : __aeabi_assert("index < 64U", "../../libraries/sdk/drives/fsl_flexspi.c", 575),
# 575 "../../libraries/sdk/drives/fsl_flexspi.c"
#pragma clang diagnostic push
# 575 "../../libraries/sdk/drives/fsl_flexspi.c"
#pragma clang diagnostic ignored "-Wassume"
# 575 "../../libraries/sdk/drives/fsl_flexspi.c"
    (__builtin_assume)((index < 64U)?1:0)
# 575 "../../libraries/sdk/drives/fsl_flexspi.c"
#pragma clang diagnostic pop
# 575 "../../libraries/sdk/drives/fsl_flexspi.c"
    );
...
void FLEXSPI_UpdateRxSampleClock(FLEXSPI_Type *base, flexspi_read_sample_clock_t clockSource)
{
    ...
    mcr0Val = base->MCR0;
    mcr0Val &= ~(0x30U);
    mcr0Val |= (((uint32_t)(((uint32_t)(clockSource)) << (4U))) & (0x30U));
    base->MCR0 = mcr0Val;


    FLEXSPI_SoftwareReset(base);
}
# 638 "../../libraries/sdk/drives/fsl_flexspi.c"
status_t FLEXSPI_WriteBlocking(FLEXSPI_Type *base, uint32_t *buffer, size_t size)
{
    uint32_t txWatermark = ((base->IPTXFCR & (0x3CU)) >> (2U)) + 1U;
    uint32_t status;
    status_t result = kStatus_Success;
    uint32_t i = 0;
...
# 697 "../../libraries/sdk/drives/fsl_flexspi.c"
status_t FLEXSPI_ReadBlocking(FLEXSPI_Type *base, uint32_t *buffer, size_t size)
{
    uint32_t rxWatermark = ((base->IPRXFCR & (0x3CU)) >> (2U)) + 1U;
    uint32_t status;
    status_t result = kStatus_Success;
    uint32_t i = 0;
    _Bool isReturn = 0;
    ...
    while (0U != size)
    {
        ...
        else
        {
            ...
            while (size > ((((base->IPRXFSTS) & (0xFFU)) >> (0U)) * 8U))
            {
...
# 784 "../../libraries/sdk/drives/fsl_flexspi.c"
status_t FLEXSPI_TransferBlocking(FLEXSPI_Type *base, flexspi_transfer_t *xfer)
{
    uint32_t configValue = 0;
    status_t result = kStatus_Success;
    ...
    base->FLSHCR2[xfer->port] |= (0x80000000U);


    base->INTR |= (0x10U) | (0x8U) | (0x4U) |
                  (0x2U);
    ...
    {
        configValue = (((uint32_t)(((uint32_t)(xfer->dataSize)) << (0U))) & (0xFFFFU));
    }


    configValue |=
        (((uint32_t)(((uint32_t)((uint32_t)xfer->seqIndex)) << (16U))) & (0xF0000U)) | (((uint32_t)(((uint32_t)((uint32_t)xfer->SeqNumber - 1U)) << (24U))) & (0x7000000U));
...
# 851 "../../libraries/sdk/drives/fsl_flexspi.c"
void FLEXSPI_TransferCreateHandle(FLEXSPI_Type *base,
                                  flexspi_handle_t *handle,
                                  flexspi_transfer_callback_t callback,
                                  void *userData)
{
    ((0 != handle) ? (void)0 : __aeabi_assert("NULL != handle", "../../libraries/sdk/drives/fsl_flexspi.c", 856),
# 856 "../../libraries/sdk/drives/fsl_flexspi.c"
#pragma clang diagnostic push
# 856 "../../libraries/sdk/drives/fsl_flexspi.c"
#pragma clang diagnostic ignored "-Wassume"
# 856 "../../libraries/sdk/drives/fsl_flexspi.c"
...
# 874 "../../libraries/sdk/drives/fsl_flexspi.c"
    (void)EnableIRQ(s_flexspiIrqs[instance]);
}
# 892 "../../libraries/sdk/drives/fsl_flexspi.c"
status_t FLEXSPI_TransferNonBlocking(FLEXSPI_Type *base, flexspi_handle_t *handle, flexspi_transfer_t *xfer)
{
    uint32_t configValue = 0;
    status_t result = kStatus_Success;

    ((0 != handle) ? (void)0 : __aeabi_assert("NULL != handle", "../../libraries/sdk/drives/fsl_flexspi.c", 897),
# 897 "../../libraries/sdk/drives/fsl_flexspi.c"
#pragma clang diagnostic push
# 897 "../../libraries/sdk/drives/fsl_flexspi.c"
#pragma clang diagnostic ignored "-Wassume"
# 897 "../../libraries/sdk/drives/fsl_flexspi.c"
...
# 897 "../../libraries/sdk/drives/fsl_flexspi.c"
    ...
    ((0 != xfer) ? (void)0 : __aeabi_assert("NULL != xfer", "../../libraries/sdk/drives/fsl_flexspi.c", 898),
# 898 "../../libraries/sdk/drives/fsl_flexspi.c"
#pragma clang diagnostic push
# 898 "../../libraries/sdk/drives/fsl_flexspi.c"
#pragma clang diagnostic ignored "-Wassume"
# 898 "../../libraries/sdk/drives/fsl_flexspi.c"
...
# 969 "../../libraries/sdk/drives/fsl_flexspi.c"
status_t FLEXSPI_TransferGetCount(FLEXSPI_Type *base, flexspi_handle_t *handle, size_t *count)
{
    ((0 != handle) ? (void)0 : __aeabi_assert("NULL != handle", "../../libraries/sdk/drives/fsl_flexspi.c", 971),
# 971 "../../libraries/sdk/drives/fsl_flexspi.c"
#pragma clang diagnostic push
# 971 "../../libraries/sdk/drives/fsl_flexspi.c"
#pragma clang diagnostic ignored "-Wassume"
# 971 "../../libraries/sdk/drives/fsl_flexspi.c"
...
# 996 "../../libraries/sdk/drives/fsl_flexspi.c"
void FLEXSPI_TransferAbort(FLEXSPI_Type *base, flexspi_handle_t *handle)
{
    ((0 != handle) ? (void)0 : __aeabi_assert("NULL != handle", "../../libraries/sdk/drives/fsl_flexspi.c", 998),
# 998 "../../libraries/sdk/drives/fsl_flexspi.c"
#pragma clang diagnostic push
# 998 "../../libraries/sdk/drives/fsl_flexspi.c"
#pragma clang diagnostic ignored "-Wassume"
# 998 "../../libraries/sdk/drives/fsl_flexspi.c"
...
void FLEXSPI_TransferHandleIRQ(FLEXSPI_Type *base, flexspi_handle_t *handle)
{
    ...
    if ((status & intEnableStatus) != 0U)
    {
        ...
        if ((result != kStatus_Success) && (handle->completionCallback != 0))
        {
        ...
        else
        {
            ...
            {
                rxWatermark = ((base->IPRXFCR & (0x3CU)) >> (2U)) + 1U;
                ...
                (handle->state == (uint32_t)kFLEXSPI_BusyWrite))
            {
                ...
                {
                    txWatermark = ((base->IPTXFCR & (0x3CU)) >> (2U)) + 1U;
