# 1 "../../libraries/sdk/drives/fsl_flexio.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/sdk/drives/fsl_flexio.c" 2
...
# 11 "../../libraries/sdk/drives/fsl_flexio.h"
...
# 12 "../../libraries/sdk/drives/fsl_flexio.h" 2
...
# 10 "../../libraries/sdk/drives/fsl_flexio.c" 2
# 27 "../../libraries/sdk/drives/fsl_flexio.c"
FLEXIO_Type *const s_flexioBases[] = { (FLEXIO_Type *)0u, ((FLEXIO_Type *)(0x401AC000u)), ((FLEXIO_Type *)(0x401B0000u)), ((FLEXIO_Type *)(0x42020000u)) };



const clock_ip_name_t s_flexioClocks[] = { kCLOCK_IpInvalid, kCLOCK_Flexio1, kCLOCK_Flexio2, kCLOCK_Flexio3 };



static void *s_flexioHandle[2];


static void *s_flexioType[2];


static flexio_isr_t s_flexioIsr[2];


static void FLEXIO_CommonIRQHandler(void);
# 55 "../../libraries/sdk/drives/fsl_flexio.c"
uint32_t FLEXIO_GetInstance(FLEXIO_Type *base)
{
    uint32_t instance;


    for (instance = 0; instance < (sizeof(s_flexioBases) / sizeof((s_flexioBases)[0])); instance++)
    {
    ...
    ((instance < (sizeof(s_flexioBases) / sizeof((s_flexioBases)[0]))) ? (void)0 : __aeabi_assert("instance < ARRAY_SIZE(s_flexioBases)", "../../libraries/sdk/drives/fsl_flexio.c", 68),
# 68 "../../libraries/sdk/drives/fsl_flexio.c"
#pragma clang diagnostic push
# 68 "../../libraries/sdk/drives/fsl_flexio.c"
#pragma clang diagnostic ignored "-Wassume"
# 68 "../../libraries/sdk/drives/fsl_flexio.c"
    (__builtin_assume)((instance < (sizeof(s_flexioBases) / sizeof((s_flexioBases)[0])))?1:0)
# 68 "../../libraries/sdk/drives/fsl_flexio.c"
#pragma clang diagnostic pop
# 68 "../../libraries/sdk/drives/fsl_flexio.c"
    );
...
# 91 "../../libraries/sdk/drives/fsl_flexio.c"
void FLEXIO_Init(FLEXIO_Type *base, const flexio_config_t *userConfig)
{
    uint32_t ctrlReg = 0;
    ...
    ctrlReg |= ((((uint32_t)(((uint32_t)(userConfig->enableInDebug)) << (30U))) & (0x40000000U)) | (((uint32_t)(((uint32_t)(userConfig->enableFastAccess)) << (2U))) & (0x4U)) |
                (((uint32_t)(((uint32_t)(userConfig->enableFlexio)) << (0U))) & (0x1U)));
...
# 120 "../../libraries/sdk/drives/fsl_flexio.c"
void FLEXIO_Deinit(FLEXIO_Type *base)
{
    FLEXIO_Enable(base, 0);

    CLOCK_DisableClock(s_flexioClocks[FLEXIO_GetInstance(base)]);

}
# 140 "../../libraries/sdk/drives/fsl_flexio.c"
void FLEXIO_GetDefaultConfig(flexio_config_t *userConfig)
{
    ((userConfig != 0) ? (void)0 : __aeabi_assert("userConfig != NULL", "../../libraries/sdk/drives/fsl_flexio.c", 142),
# 142 "../../libraries/sdk/drives/fsl_flexio.c"
#pragma clang diagnostic push
# 142 "../../libraries/sdk/drives/fsl_flexio.c"
#pragma clang diagnostic ignored "-Wassume"
# 142 "../../libraries/sdk/drives/fsl_flexio.c"
    (__builtin_assume)((userConfig != 0)?1:0)
# 142 "../../libraries/sdk/drives/fsl_flexio.c"
#pragma clang diagnostic pop
# 142 "../../libraries/sdk/drives/fsl_flexio.c"
    );
    ...
    userConfig->enableFlexio = 1;
    userConfig->enableInDoze = 0;
    userConfig->enableInDebug = 1;
    userConfig->enableFastAccess = 0;
}
...
# 173 "../../libraries/sdk/drives/fsl_flexio.c"
uint32_t FLEXIO_GetShifterBufferAddress(FLEXIO_Type *base, flexio_shifter_buffer_type_t type, uint8_t index)
{
    ((index < (8U)) ? (void)0 : __aeabi_assert("index < FLEXIO_SHIFTBUF_COUNT", "../../libraries/sdk/drives/fsl_flexio.c", 175),
# 175 "../../libraries/sdk/drives/fsl_flexio.c"
#pragma clang diagnostic push
# 175 "../../libraries/sdk/drives/fsl_flexio.c"
#pragma clang diagnostic ignored "-Wassume"
# 175 "../../libraries/sdk/drives/fsl_flexio.c"
    (__builtin_assume)((index < (8U))?1:0)
# 175 "../../libraries/sdk/drives/fsl_flexio.c"
#pragma clang diagnostic pop
# 175 "../../libraries/sdk/drives/fsl_flexio.c"
    );
...
# 247 "../../libraries/sdk/drives/fsl_flexio.c"
void FLEXIO_SetShifterConfig(FLEXIO_Type *base, uint8_t index, const flexio_shifter_config_t *shifterConfig)
{
    base->SHIFTCFG[index] = (((uint32_t)(((uint32_t)(shifterConfig->inputSource)) << (8U))) & (0x100U))

                            | (((uint32_t)(((uint32_t)(shifterConfig->parallelWidth)) << (16U))) & (0x1F0000U))

                            | (((uint32_t)(((uint32_t)(shifterConfig->shifterStop)) << (4U))) & (0x30U)) |
                            (((uint32_t)(((uint32_t)(shifterConfig->shifterStart)) << (0U))) & (0x3U));

    base->SHIFTCTL[index] =
        (((uint32_t)(((uint32_t)(shifterConfig->timerSelect)) << (24U))) & (0x7000000U)) | (((uint32_t)(((uint32_t)(shifterConfig->timerPolarity)) << (23U))) & (0x800000U)) |
        (((uint32_t)(((uint32_t)(shifterConfig->pinConfig)) << (16U))) & (0x30000U)) | (((uint32_t)(((uint32_t)(shifterConfig->pinSelect)) << (8U))) & (0x1F00U)) |
        (((uint32_t)(((uint32_t)(shifterConfig->pinPolarity)) << (7U))) & (0x80U)) | (((uint32_t)(((uint32_t)(shifterConfig->shifterMode)) << (0U))) & (0x7U));
}
# 292 "../../libraries/sdk/drives/fsl_flexio.c"
void FLEXIO_SetTimerConfig(FLEXIO_Type *base, uint8_t index, const flexio_timer_config_t *timerConfig)
{
    base->TIMCFG[index] =
        (((uint32_t)(((uint32_t)(timerConfig->timerOutput)) << (24U))) & (0x3000000U)) | (((uint32_t)(((uint32_t)(timerConfig->timerDecrement)) << (20U))) & (0x300000U)) |
        (((uint32_t)(((uint32_t)(timerConfig->timerReset)) << (16U))) & (0x70000U)) | (((uint32_t)(((uint32_t)(timerConfig->timerDisable)) << (12U))) & (0x7000U)) |
        (((uint32_t)(((uint32_t)(timerConfig->timerEnable)) << (8U))) & (0x700U)) | (((uint32_t)(((uint32_t)(timerConfig->timerStop)) << (4U))) & (0x30U)) |
        (((uint32_t)(((uint32_t)(timerConfig->timerStart)) << (1U))) & (0x2U));

    base->TIMCMP[index] = (((uint32_t)(((uint32_t)(timerConfig->timerCompare)) << (0U))) & (0xFFFFU));

    base->TIMCTL[index] = (((uint32_t)(((uint32_t)(timerConfig->triggerSelect)) << (24U))) & (0x3F000000U)) |
                          (((uint32_t)(((uint32_t)(timerConfig->triggerPolarity)) << (23U))) & (0x800000U)) |
                          (((uint32_t)(((uint32_t)(timerConfig->triggerSource)) << (22U))) & (0x400000U)) |
                          (((uint32_t)(((uint32_t)(timerConfig->pinConfig)) << (16U))) & (0x30000U)) | (((uint32_t)(((uint32_t)(timerConfig->pinSelect)) << (8U))) & (0x1F00U)) |
                          (((uint32_t)(((uint32_t)(timerConfig->pinPolarity)) << (7U))) & (0x80U)) | (((uint32_t)(((uint32_t)(timerConfig->timerMode)) << (0U))) & (0x3U));
}
# 318 "../../libraries/sdk/drives/fsl_flexio.c"
status_t FLEXIO_RegisterHandleIRQ(void *base, void *handle, flexio_isr_t isr)
{
    ((base != 0) ? (void)0 : __aeabi_assert("base != NULL", "../../libraries/sdk/drives/fsl_flexio.c", 320),
# 320 "../../libraries/sdk/drives/fsl_flexio.c"
#pragma clang diagnostic push
# 320 "../../libraries/sdk/drives/fsl_flexio.c"
#pragma clang diagnostic ignored "-Wassume"
# 320 "../../libraries/sdk/drives/fsl_flexio.c"
...
# 320 "../../libraries/sdk/drives/fsl_flexio.c"
    ...
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_flexio.c", 321),
# 321 "../../libraries/sdk/drives/fsl_flexio.c"
#pragma clang diagnostic push
# 321 "../../libraries/sdk/drives/fsl_flexio.c"
#pragma clang diagnostic ignored "-Wassume"
# 321 "../../libraries/sdk/drives/fsl_flexio.c"
...
# 321 "../../libraries/sdk/drives/fsl_flexio.c"
    ...
    ((isr != 0) ? (void)0 : __aeabi_assert("isr != NULL", "../../libraries/sdk/drives/fsl_flexio.c", 322),
# 322 "../../libraries/sdk/drives/fsl_flexio.c"
#pragma clang diagnostic push
# 322 "../../libraries/sdk/drives/fsl_flexio.c"
#pragma clang diagnostic ignored "-Wassume"
# 322 "../../libraries/sdk/drives/fsl_flexio.c"
    (__builtin_assume)((isr != 0)?1:0)
# 322 "../../libraries/sdk/drives/fsl_flexio.c"
#pragma clang diagnostic pop
# 322 "../../libraries/sdk/drives/fsl_flexio.c"
    );
...
# 356 "../../libraries/sdk/drives/fsl_flexio.c"
status_t FLEXIO_UnregisterHandleIRQ(void *base)
{
    ((base != 0) ? (void)0 : __aeabi_assert("base != NULL", "../../libraries/sdk/drives/fsl_flexio.c", 358),
# 358 "../../libraries/sdk/drives/fsl_flexio.c"
#pragma clang diagnostic push
# 358 "../../libraries/sdk/drives/fsl_flexio.c"
#pragma clang diagnostic ignored "-Wassume"
# 358 "../../libraries/sdk/drives/fsl_flexio.c"
...
# 358 "../../libraries/sdk/drives/fsl_flexio.c"
    ...
    for (index = 0U; index < (uint8_t)2; index++)
    {
        if (s_flexioType[index] == base)
        {
            ...
            s_flexioType[index] = 0;
            s_flexioHandle[index] = 0;
            s_flexioIsr[index] = 0;
            break;
        }
    }
