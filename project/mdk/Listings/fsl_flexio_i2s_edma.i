# 1 "../../libraries/sdk/drives/fsl_flexio_i2s_edma.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/sdk/drives/fsl_flexio_i2s_edma.c" 2
...
# 1 "../../libraries/sdk/drives/fsl_flexio_i2s_edma.h" 1
# 11 "../../libraries/sdk/drives/fsl_flexio_i2s_edma.h"
...
# 12 "../../libraries/sdk/drives/fsl_flexio_i2s_edma.h" 2
...
# 13 "../../libraries/sdk/drives/fsl_flexio_i2s_edma.h" 2
# 29 "../../libraries/sdk/drives/fsl_flexio_i2s_edma.h"
...
# 50 "../../libraries/sdk/drives/fsl_flexio_i2s_edma.c"
static void FLEXIO_I2S_TxEDMACallback(edma_handle_t *handle, void *userData, _Bool done, uint32_t tcds);
# 60 "../../libraries/sdk/drives/fsl_flexio_i2s_edma.c"
static void FLEXIO_I2S_RxEDMACallback(edma_handle_t *handle, void *userData, _Bool done, uint32_t tcds);
...
static void FLEXIO_I2S_TxEDMACallback(edma_handle_t *handle, void *userData, _Bool done, uint32_t tcds)
{
    ...
    flexio_i2sHandle->queueDriver = (flexio_i2sHandle->queueDriver + 1U) % (4U);
    if (flexio_i2sHandle->callback != 0)
    {
        (flexio_i2sHandle->callback)(privHandle->base, flexio_i2sHandle, kStatus_Success, flexio_i2sHandle->userData);
    }


    if (flexio_i2sHandle->queue[flexio_i2sHandle->queueDriver].data == 0)
    {
...
# 118 "../../libraries/sdk/drives/fsl_flexio_i2s_edma.c"
void FLEXIO_I2S_TransferTxCreateHandleEDMA(FLEXIO_I2S_Type *base,
                                           flexio_i2s_edma_handle_t *handle,
                                           flexio_i2s_edma_callback_t callback,
                                           void *userData,
                                           edma_handle_t *dmaHandle)
{
    (((handle != 0) && (dmaHandle != 0)) ? (void)0 : __aeabi_assert("(handle != NULL) && (dmaHandle != NULL)", "../../libraries/sdk/drives/fsl_flexio_i2s_edma.c", 124),
# 124 "../../libraries/sdk/drives/fsl_flexio_i2s_edma.c"
#pragma clang diagnostic push
# 124 "../../libraries/sdk/drives/fsl_flexio_i2s_edma.c"
#pragma clang diagnostic ignored "-Wassume"
# 124 "../../libraries/sdk/drives/fsl_flexio_i2s_edma.c"
    (__builtin_assume)(((handle != 0) && (dmaHandle != 0))?1:0)
# 124 "../../libraries/sdk/drives/fsl_flexio_i2s_edma.c"
#pragma clang diagnostic pop
# 124 "../../libraries/sdk/drives/fsl_flexio_i2s_edma.c"
    );
    ...
    EDMA_InstallTCDMemory(dmaHandle, (edma_tcd_t *)(((uint32_t)(handle->tcd) + 32U) & ~0x1FU), (4U));


    EDMA_SetCallback(dmaHandle, FLEXIO_I2S_TxEDMACallback, &s_edmaPrivateHandle[0]);
}
# 160 "../../libraries/sdk/drives/fsl_flexio_i2s_edma.c"
void FLEXIO_I2S_TransferRxCreateHandleEDMA(FLEXIO_I2S_Type *base,
                                           flexio_i2s_edma_handle_t *handle,
                                           flexio_i2s_edma_callback_t callback,
                                           void *userData,
                                           edma_handle_t *dmaHandle)
{
    (((handle != 0) && (dmaHandle != 0)) ? (void)0 : __aeabi_assert("(handle != NULL) && (dmaHandle != NULL)", "../../libraries/sdk/drives/fsl_flexio_i2s_edma.c", 166),
# 166 "../../libraries/sdk/drives/fsl_flexio_i2s_edma.c"
#pragma clang diagnostic push
# 166 "../../libraries/sdk/drives/fsl_flexio_i2s_edma.c"
#pragma clang diagnostic ignored "-Wassume"
# 166 "../../libraries/sdk/drives/fsl_flexio_i2s_edma.c"
...
# 200 "../../libraries/sdk/drives/fsl_flexio_i2s_edma.c"
void FLEXIO_I2S_TransferSetFormatEDMA(FLEXIO_I2S_Type *base,
                                      flexio_i2s_edma_handle_t *handle,
                                      flexio_i2s_format_t *format,
                                      uint32_t srcClock_Hz)
{
    (((handle != 0) && (format != 0)) ? (void)0 : __aeabi_assert("(handle != NULL) && (format != NULL)", "../../libraries/sdk/drives/fsl_flexio_i2s_edma.c", 205),
# 205 "../../libraries/sdk/drives/fsl_flexio_i2s_edma.c"
#pragma clang diagnostic push
# 205 "../../libraries/sdk/drives/fsl_flexio_i2s_edma.c"
#pragma clang diagnostic ignored "-Wassume"
# 205 "../../libraries/sdk/drives/fsl_flexio_i2s_edma.c"
...
# 235 "../../libraries/sdk/drives/fsl_flexio_i2s_edma.c"
status_t FLEXIO_I2S_TransferSendEDMA(FLEXIO_I2S_Type *base,
                                     flexio_i2s_edma_handle_t *handle,
                                     flexio_i2s_transfer_t *xfer)
{
    (((handle != 0) && (xfer != 0)) ? (void)0 : __aeabi_assert("(handle != NULL) && (xfer != NULL)", "../../libraries/sdk/drives/fsl_flexio_i2s_edma.c", 239),
# 239 "../../libraries/sdk/drives/fsl_flexio_i2s_edma.c"
#pragma clang diagnostic push
# 239 "../../libraries/sdk/drives/fsl_flexio_i2s_edma.c"
#pragma clang diagnostic ignored "-Wassume"
# 239 "../../libraries/sdk/drives/fsl_flexio_i2s_edma.c"
...
# 299 "../../libraries/sdk/drives/fsl_flexio_i2s_edma.c"
status_t FLEXIO_I2S_TransferReceiveEDMA(FLEXIO_I2S_Type *base,
                                        flexio_i2s_edma_handle_t *handle,
                                        flexio_i2s_transfer_t *xfer)
{
    (((handle != 0) && (xfer != 0)) ? (void)0 : __aeabi_assert("(handle != NULL) && (xfer != NULL)", "../../libraries/sdk/drives/fsl_flexio_i2s_edma.c", 303),
# 303 "../../libraries/sdk/drives/fsl_flexio_i2s_edma.c"
#pragma clang diagnostic push
# 303 "../../libraries/sdk/drives/fsl_flexio_i2s_edma.c"
#pragma clang diagnostic ignored "-Wassume"
# 303 "../../libraries/sdk/drives/fsl_flexio_i2s_edma.c"
...
void FLEXIO_I2S_TransferAbortSendEDMA(FLEXIO_I2S_Type *base, flexio_i2s_edma_handle_t *handle)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_flexio_i2s_edma.c", 357),
# 357 "../../libraries/sdk/drives/fsl_flexio_i2s_edma.c"
#pragma clang diagnostic push
# 357 "../../libraries/sdk/drives/fsl_flexio_i2s_edma.c"
#pragma clang diagnostic ignored "-Wassume"
# 357 "../../libraries/sdk/drives/fsl_flexio_i2s_edma.c"
...
void FLEXIO_I2S_TransferAbortReceiveEDMA(FLEXIO_I2S_Type *base, flexio_i2s_edma_handle_t *handle)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_flexio_i2s_edma.c", 377),
# 377 "../../libraries/sdk/drives/fsl_flexio_i2s_edma.c"
#pragma clang diagnostic push
# 377 "../../libraries/sdk/drives/fsl_flexio_i2s_edma.c"
#pragma clang diagnostic ignored "-Wassume"
# 377 "../../libraries/sdk/drives/fsl_flexio_i2s_edma.c"
...
# 377 "../../libraries/sdk/drives/fsl_flexio_i2s_edma.c"
    ...
    FLEXIO_I2S_RxEnableDMA(base, 0);


    handle->state = (uint32_t)kFLEXIO_I2S_Idle;
}
# 398 "../../libraries/sdk/drives/fsl_flexio_i2s_edma.c"
status_t FLEXIO_I2S_TransferGetSendCountEDMA(FLEXIO_I2S_Type *base, flexio_i2s_edma_handle_t *handle, size_t *count)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_flexio_i2s_edma.c", 400),
# 400 "../../libraries/sdk/drives/fsl_flexio_i2s_edma.c"
#pragma clang diagnostic push
# 400 "../../libraries/sdk/drives/fsl_flexio_i2s_edma.c"
#pragma clang diagnostic ignored "-Wassume"
# 400 "../../libraries/sdk/drives/fsl_flexio_i2s_edma.c"
...
# 427 "../../libraries/sdk/drives/fsl_flexio_i2s_edma.c"
status_t FLEXIO_I2S_TransferGetReceiveCountEDMA(FLEXIO_I2S_Type *base, flexio_i2s_edma_handle_t *handle, size_t *count)
{
    ((handle != 0) ? (void)0 : __aeabi_assert("handle != NULL", "../../libraries/sdk/drives/fsl_flexio_i2s_edma.c", 429),
# 429 "../../libraries/sdk/drives/fsl_flexio_i2s_edma.c"
#pragma clang diagnostic push
# 429 "../../libraries/sdk/drives/fsl_flexio_i2s_edma.c"
#pragma clang diagnostic ignored "-Wassume"
# 429 "../../libraries/sdk/drives/fsl_flexio_i2s_edma.c"
