# 1 "../../libraries/zf_driver/zf_driver_encoder.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/zf_driver/zf_driver_encoder.c" 2
# 36 "../../libraries/zf_driver/zf_driver_encoder.c"
...
# 37 "../../libraries/zf_driver/zf_driver_encoder.c" 2
...
# 38 "../../libraries/zf_driver/zf_driver_encoder.c" 2
# 1 "../../libraries/sdk/drives\\fsl_qtmr.h" 1
# 27 "../../libraries/sdk/drives\\fsl_qtmr.h"
...
# 410 "../../libraries/sdk/drives\\fsl_qtmr.h"
static inline void QTMR_StartTimer(TMR_Type *base, qtmr_channel_selection_t channel, qtmr_counting_mode_t clockSource)
{
    ...
    reg &= (uint16_t)(~((0xE000U)));
    reg |= (((uint16_t)(((uint16_t)(clockSource)) << (13U))) & (0xE000U));
...
# 40 "../../libraries/zf_driver/zf_driver_encoder.c" 2
...
# 41 "../../libraries/zf_driver/zf_driver_encoder.c" 2
...
# 43 "../../libraries/zf_driver/zf_driver_encoder.c" 2




TMR_Type * qtimer_index[] = { (TMR_Type *)0u, ((TMR_Type *)(0x401DC000u)), ((TMR_Type *)(0x401E0000u)), ((TMR_Type *)(0x401E4000u)), ((TMR_Type *)(0x401E8000u)) };
...
void qtimer_iomuxc(encoder_index_enum qtimern, encoder_channel1_enum ch1_pin, encoder_channel2_enum ch2_pin)
{
    switch(qtimern)
    {
        ...
        {
            if (QTIMER1_ENCODER1_CH1_C0 == ch1_pin) afio_init(0x401F813CU, 0x1U, 0, 0, 0x401F832CU, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);
            if (QTIMER1_ENCODER1_CH2_C1 == ch2_pin) afio_init(0x401F8140U, 0x1U, 0, 0, 0x401F8330U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);
        }break;

        case QTIMER1_ENCODER2:
        {
            if (QTIMER1_ENCODER2_CH1_C2 == ch1_pin) afio_init(0x401F8144U, 0x1U, 0, 0, 0x401F8334U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);
            if (QTIMER1_ENCODER2_CH2_C24 == ch2_pin) afio_init(0x401F819CU, 0x1U, 0, 0, 0x401F838CU, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);
        }break;

        case QTIMER2_ENCODER1:
        {
            if (QTIMER2_ENCODER1_CH1_C3 == ch1_pin) afio_init(0x401F8148U, 0x1U, 0x401F856CU, 0x1U, 0x401F8338U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);
            if (QTIMER2_ENCODER1_CH2_C4 == ch2_pin) afio_init(0x401F814CU, 0x1U, 0x401F8570U, 0x1U, 0x401F833CU, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);
            else if (QTIMER2_ENCODER1_CH2_C25 == ch2_pin) afio_init(0x401F81A0U, 0x1U, 0x401F8578U, 0x1U, 0x401F8390U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);
        }break;

        case QTIMER2_ENCODER2:
        {
            if (QTIMER2_ENCODER2_CH1_C5 == ch1_pin) afio_init(0x401F8150U, 0x1U, 0x401F8574U, 0x1U, 0x401F8340U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);
            if (QTIMER2_ENCODER2_CH2_C25 == ch2_pin) afio_init(0x401F81A0U, 0x1U, 0x401F8578U, 0x1U, 0x401F8390U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);
        }break;

        case QTIMER3_ENCODER1:
        {
            if (QTIMER3_ENCODER1_CH1_B16 == ch1_pin) afio_init(0x401F80FCU, 0x1U, 0x401F857CU, 0x1U, 0x401F82ECU, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);
            else if (QTIMER3_ENCODER1_CH1_C6 == ch1_pin) afio_init(0x401F8154U, 0x1U, 0x401F857CU, 0x2U, 0x401F8344U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);

            if (QTIMER3_ENCODER1_CH2_B17 == ch2_pin) afio_init(0x401F8100U, 0x1U, 0x401F8580U, 0x0U, 0x401F82F0U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);
            else if (QTIMER3_ENCODER1_CH2_C7 == ch2_pin) afio_init(0x401F8158U, 0x1U, 0x401F8580U, 0x2U, 0x401F8348U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);
        }break;

        case QTIMER3_ENCODER2:
        {
            if (QTIMER3_ENCODER2_CH1_B18 == ch1_pin) afio_init(0x401F8104U, 0x1U, 0x401F8584U, 0x1U, 0x401F82F4U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);
            else if (QTIMER3_ENCODER2_CH1_C8 == ch1_pin) afio_init(0x401F815CU, 0x1U, 0x401F8584U, 0x2U, 0x401F834CU, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);

            if (QTIMER3_ENCODER2_CH2_B19 == ch2_pin) afio_init(0x401F8108U, 0x1U, 0x401F8588U, 0x1U, 0x401F82F8U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);
            else if (QTIMER3_ENCODER2_CH2_C26 == ch2_pin) afio_init(0x401F81A4U, 0x1U, 0x401F8588U, 0x2U, 0x401F8394U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);
        }break;

        case QTIMER4_ENCODER1:
        {
            if (QTIMER4_ENCODER1_CH1_C9 == ch1_pin) afio_init(0x401F8160U, 0x1U, 0, 0, 0x401F8350U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);
            if (QTIMER4_ENCODER1_CH2_C10 == ch2_pin) afio_init(0x401F8164U, 0x1U, 0, 0, 0x401F8354U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);
        }break;

        case QTIMER4_ENCODER2:
        {
            if (QTIMER4_ENCODER2_CH1_C11 == ch1_pin) afio_init(0x401F8168U, 0x1U, 0, 0, 0x401F8358U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);
            if (QTIMER4_ENCODER2_CH2_C27 == ch2_pin) afio_init(0x401F81A8U, 0x1U, 0, 0, 0x401F8398U, 0, SPEED_100MHZ | KEEPER_EN | DSE_R0_6);
        }break;

        default: (debug_assert_handler((0), "../../libraries/zf_driver/zf_driver_encoder.c", 108));break;
    }
}
# 119 "../../libraries/zf_driver/zf_driver_encoder.c"
int16 encoder_get_count (encoder_index_enum encoder_n)
{
    uint8 qtimer_cha;
    qtimer_cha = (encoder_n % 2) * 2;
    return QTMR_GetCurrentTimerCount(qtimer_index[encoder_n / 2], (qtmr_channel_selection_t)(qtimer_cha));
}
# 133 "../../libraries/zf_driver/zf_driver_encoder.c"
void encoder_clear_count (encoder_index_enum encoder_n)
{
    uint8 qtimer_cha;
    qtimer_cha = (encoder_n % 2) * 2;
...
# 151 "../../libraries/zf_driver/zf_driver_encoder.c"
void encoder_quad_init (encoder_index_enum encoder_n, encoder_channel1_enum ch1_pin, encoder_channel2_enum ch2_pin)
{
    uint8 qtimer_cha;
    uint8 qtimer_chb;
    ...
    (debug_assert_handler((encoder_n == (ch1_pin / 2)), "../../libraries/zf_driver/zf_driver_encoder.c", 157));
    (debug_assert_handler((encoder_n == (ch2_pin / 2)), "../../libraries/zf_driver/zf_driver_encoder.c", 158));
    ...
    QTMR_Init(qtimer_index[encoder_n / 2], (qtmr_channel_selection_t)(qtimer_cha), &qtmrConfig);
    QTMR_Deinit(qtimer_index[encoder_n / 2], (qtmr_channel_selection_t)(qtimer_cha));
    QTMR_Init(qtimer_index[encoder_n / 2], (qtmr_channel_selection_t)(qtimer_cha), &qtmrConfig);

    QTMR_StartTimer(qtimer_index[encoder_n / 2], (qtmr_channel_selection_t)(qtimer_cha), kQTMR_PriSrcRiseEdgeSecDir);
}
# 195 "../../libraries/zf_driver/zf_driver_encoder.c"
void encoder_dir_init (encoder_index_enum encoder_n, encoder_channel1_enum ch1_pin, encoder_channel2_enum ch2_pin)
{
