# 1 "../../libraries/zf_driver/zf_driver_timer.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/zf_driver/zf_driver_timer.c" 2
# 36 "../../libraries/zf_driver/zf_driver_timer.c"
...
# 37 "../../libraries/zf_driver/zf_driver_timer.c" 2
...
# 38 "../../libraries/zf_driver/zf_driver_timer.c" 2
...
# 39 "../../libraries/zf_driver/zf_driver_timer.c" 2
...
# 40 "../../libraries/zf_driver/zf_driver_timer.c" 2
...
# 42 "../../libraries/zf_driver/zf_driver_timer.c" 2

GPT_Type *timer_index[] = { (GPT_Type *)0u, ((GPT_Type *)(0x401EC000u)), ((GPT_Type *)(0x401F0000u)) };
# 52 "../../libraries/zf_driver/zf_driver_timer.c"
void timer_start (timer_index_enum index)
{
    GPT_StartTimer(timer_index[index]);
}
# 64 "../../libraries/zf_driver/zf_driver_timer.c"
void timer_stop (timer_index_enum index)
{
    GPT_StopTimer(timer_index[index]);
}
# 76 "../../libraries/zf_driver/zf_driver_timer.c"
uint32 timer_get (timer_index_enum index)
{
    return GPT_GetCurrentTimerCount(timer_index[index]);
}
# 88 "../../libraries/zf_driver/zf_driver_timer.c"
void timer_clear (timer_index_enum index)
{

    if(timer_index[index]->CR & (0x1U))
    {
        timer_stop(index);
        timer_start(index);
    }
}
# 106 "../../libraries/zf_driver/zf_driver_timer.c"
void timer_init (timer_index_enum index, timer_mode_enum mode)
{
    ...
    switch(mode)
    {
        ...
        case TIMER_MS:
        {
            ...
            gptConfig.divider = (24000000) / 12 / 1000;

        }break;
    }

    GPT_Init(timer_index[index], &gptConfig);
    GPT_Deinit(timer_index[index]);
    GPT_Init(timer_index[index], &gptConfig);
