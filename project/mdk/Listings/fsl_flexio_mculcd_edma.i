# 1 "../../libraries/sdk/drives/fsl_flexio_mculcd_edma.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/sdk/drives/fsl_flexio_mculcd_edma.c" 2
...
# 1 "../../libraries/sdk/drives/fsl_flexio_mculcd_edma.h" 1
# 12 "../../libraries/sdk/drives/fsl_flexio_mculcd_edma.h"
...
# 13 "../../libraries/sdk/drives/fsl_flexio_mculcd_edma.h" 2
# 1 "../../libraries/sdk/drives/fsl_flexio_mculcd.h" 1
# 13 "../../libraries/sdk/drives/fsl_flexio_mculcd.h"
...
# 14 "../../libraries/sdk/drives/fsl_flexio_mculcd_edma.h" 2
# 30 "../../libraries/sdk/drives/fsl_flexio_mculcd_edma.h"
...
# 95 "../../libraries/sdk/drives/fsl_flexio_mculcd_edma.h"
status_t FLEXIO_MCULCD_TransferCreateHandleEDMA(FLEXIO_MCULCD_Type *base,
                                                ...
                                                edma_handle_t *txDmaHandle,
                                                edma_handle_t *rxDmaHandle);
# 119 "../../libraries/sdk/drives/fsl_flexio_mculcd_edma.h"
...
# 140 "../../libraries/sdk/drives/fsl_flexio_mculcd_edma.h"
status_t FLEXIO_MCULCD_TransferGetCountEDMA(FLEXIO_MCULCD_Type *base,
                                            flexio_mculcd_edma_handle_t *handle,
                                            size_t *count);
# 10 "../../libraries/sdk/drives/fsl_flexio_mculcd_edma.c" 2
# 22 "../../libraries/sdk/drives/fsl_flexio_mculcd_edma.c"
enum
{
...
# 40 "../../libraries/sdk/drives/fsl_flexio_mculcd_edma.c"
static void FLEXIO_MCULCD_TxEDMACallback(edma_handle_t *DmaHandle, void *param, _Bool transferDone, uint32_t tcds);
...
static void FLEXIO_MCULCD_RxEDMACallback(edma_handle_t *DmaHandle, void *param, _Bool transferDone, uint32_t tcds);
# 56 "../../libraries/sdk/drives/fsl_flexio_mculcd_edma.c"
static void FLEXIO_MCULCD_EDMAConfig(FLEXIO_MCULCD_Type *base, flexio_mculcd_edma_handle_t *handle);
# 66 "../../libraries/sdk/drives/fsl_flexio_mculcd_edma.c"
static _Bool FLEXIO_MCULCD_GetEDMAModulo(uint8_t shifterNum, edma_modulo_t *modulo);
# 76 "../../libraries/sdk/drives/fsl_flexio_mculcd_edma.c"
static void FLEXIO_MCULCD_TxEDMACallback(edma_handle_t *DmaHandle, void *param, _Bool transferDone, uint32_t tcds)
{
    tcds = tcds;
    ...
    if (transferDone)
    {
        ...
        {
            FLEXIO_MCULCD_EnableTxDMA(flexioLcdMcuBase, 0);
...
static void FLEXIO_MCULCD_RxEDMACallback(edma_handle_t *DmaHandle, void *param, _Bool transferDone, uint32_t tcds)
{
    ...
    if (transferDone)
    {
        ...
        {
            FLEXIO_MCULCD_EnableRxDMA(flexioLcdMcuBase, 0);
...
# 171 "../../libraries/sdk/drives/fsl_flexio_mculcd_edma.c"
...
static void FLEXIO_MCULCD_EDMAConfig(FLEXIO_MCULCD_Type *base, flexio_mculcd_edma_handle_t *handle)
{
    ...
    if (majorLoopCounts > ((0x7FFFU) >> (0U)))
    {
        majorLoopCounts = ((0x7FFFU) >> (0U));
    }
...
# 321 "../../libraries/sdk/drives/fsl_flexio_mculcd_edma.c"
status_t FLEXIO_MCULCD_TransferCreateHandleEDMA(FLEXIO_MCULCD_Type *base,
                                                flexio_mculcd_edma_handle_t *handle,
                                                flexio_mculcd_edma_transfer_callback_t callback,
                                                void *userData,
                                                ...
                                                edma_handle_t *rxDmaHandle)
{
    ((0 != handle) ? (void)0 : __aeabi_assert("NULL != handle", "../../libraries/sdk/drives/fsl_flexio_mculcd_edma.c", 328),
# 328 "../../libraries/sdk/drives/fsl_flexio_mculcd_edma.c"
#pragma clang diagnostic push
# 328 "../../libraries/sdk/drives/fsl_flexio_mculcd_edma.c"
#pragma clang diagnostic ignored "-Wassume"
# 328 "../../libraries/sdk/drives/fsl_flexio_mculcd_edma.c"
...
# 386 "../../libraries/sdk/drives/fsl_flexio_mculcd_edma.c"
status_t FLEXIO_MCULCD_TransferEDMA(FLEXIO_MCULCD_Type *base,
                                    flexio_mculcd_edma_handle_t *handle,
                                    flexio_mculcd_transfer_t *xfer)
{
    ((0 != handle) ? (void)0 : __aeabi_assert("NULL != handle", "../../libraries/sdk/drives/fsl_flexio_mculcd_edma.c", 390),
# 390 "../../libraries/sdk/drives/fsl_flexio_mculcd_edma.c"
#pragma clang diagnostic push
# 390 "../../libraries/sdk/drives/fsl_flexio_mculcd_edma.c"
#pragma clang diagnostic ignored "-Wassume"
# 390 "../../libraries/sdk/drives/fsl_flexio_mculcd_edma.c"
...
# 390 "../../libraries/sdk/drives/fsl_flexio_mculcd_edma.c"
    ...
    ((0 != xfer) ? (void)0 : __aeabi_assert("NULL != xfer", "../../libraries/sdk/drives/fsl_flexio_mculcd_edma.c", 391),
# 391 "../../libraries/sdk/drives/fsl_flexio_mculcd_edma.c"
#pragma clang diagnostic push
# 391 "../../libraries/sdk/drives/fsl_flexio_mculcd_edma.c"
#pragma clang diagnostic ignored "-Wassume"
# 391 "../../libraries/sdk/drives/fsl_flexio_mculcd_edma.c"
...
# 412 "../../libraries/sdk/drives/fsl_flexio_mculcd_edma.c"
    ...
    else
    {
        ...
        if (kFLEXIO_MCULCD_ReadArray == xfer->mode)
        {
            ...
            FLEXIO_MCULCD_EnableRxDMA(base, 1);
        ...
        else
        {
            ...
            FLEXIO_MCULCD_EnableTxDMA(base, 1);
...
void FLEXIO_MCULCD_TransferAbortEDMA(FLEXIO_MCULCD_Type *base, flexio_mculcd_edma_handle_t *handle)
{
    ((0 != handle) ? (void)0 : __aeabi_assert("NULL != handle", "../../libraries/sdk/drives/fsl_flexio_mculcd_edma.c", 505),
# 505 "../../libraries/sdk/drives/fsl_flexio_mculcd_edma.c"
#pragma clang diagnostic push
# 505 "../../libraries/sdk/drives/fsl_flexio_mculcd_edma.c"
#pragma clang diagnostic ignored "-Wassume"
# 505 "../../libraries/sdk/drives/fsl_flexio_mculcd_edma.c"
...
# 505 "../../libraries/sdk/drives/fsl_flexio_mculcd_edma.c"
    ...
    if (0 != handle->txDmaHandle)
    {
        EDMA_AbortTransfer(handle->txDmaHandle);
    }
    if (0 != handle->rxDmaHandle)
    {
        EDMA_AbortTransfer(handle->rxDmaHandle);
    }


    FLEXIO_MCULCD_EnableTxDMA(handle->base, 0);
    FLEXIO_MCULCD_EnableRxDMA(handle->base, 0);


    handle->state = (uint32_t)kFLEXIO_MCULCD_StateIdle;
    handle->dataCount = 0;
}
# 535 "../../libraries/sdk/drives/fsl_flexio_mculcd_edma.c"
status_t FLEXIO_MCULCD_TransferGetCountEDMA(FLEXIO_MCULCD_Type *base,
                                            flexio_mculcd_edma_handle_t *handle,
                                            size_t *count)
{
    ((0 != handle) ? (void)0 : __aeabi_assert("NULL != handle", "../../libraries/sdk/drives/fsl_flexio_mculcd_edma.c", 539),
# 539 "../../libraries/sdk/drives/fsl_flexio_mculcd_edma.c"
#pragma clang diagnostic push
# 539 "../../libraries/sdk/drives/fsl_flexio_mculcd_edma.c"
#pragma clang diagnostic ignored "-Wassume"
# 539 "../../libraries/sdk/drives/fsl_flexio_mculcd_edma.c"
...
# 539 "../../libraries/sdk/drives/fsl_flexio_mculcd_edma.c"
    ...
    ((0 != count) ? (void)0 : __aeabi_assert("NULL != count", "../../libraries/sdk/drives/fsl_flexio_mculcd_edma.c", 540),
# 540 "../../libraries/sdk/drives/fsl_flexio_mculcd_edma.c"
#pragma clang diagnostic push
# 540 "../../libraries/sdk/drives/fsl_flexio_mculcd_edma.c"
#pragma clang diagnostic ignored "-Wassume"
# 540 "../../libraries/sdk/drives/fsl_flexio_mculcd_edma.c"
