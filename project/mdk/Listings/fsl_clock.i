# 1 "../../libraries/sdk/drives/fsl_clock.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/sdk/drives/fsl_clock.c" 2
...
# 9 "../../libraries/sdk/drives/fsl_clock.c" 2
# 34 "../../libraries/sdk/drives/fsl_clock.c"
typedef double clock_64b_t;
# 60 "../../libraries/sdk/drives/fsl_clock.c"
volatile uint32_t g_xtalFreq;

volatile uint32_t g_rtcXtalFreq;
# 73 "../../libraries/sdk/drives/fsl_clock.c"
...
static uint32_t CLOCK_GetPeriphClkFreq(void)
{
    ...
    if ((((CCM_Type *)(0x400FC000u))->CBCDR & (0x2000000U)) != 0U)
    {
        switch (((CCM_Type *)(0x400FC000u))->CBCMR & (0x3000U))
        {

            case (((uint32_t)(((uint32_t)(0U)) << (12U))) & (0x3000U)):
                freq = CLOCK_GetPllFreq(kCLOCK_PllUsb1);
                break;


            case (((uint32_t)(((uint32_t)(1U)) << (12U))) & (0x3000U)):
                freq = CLOCK_GetOscFreq();
                break;

            case (((uint32_t)(((uint32_t)(2U)) << (12U))) & (0x3000U)):
                freq = CLOCK_GetPllFreq(kCLOCK_PllSys);
                break;

            case (((uint32_t)(((uint32_t)(3U)) << (12U))) & (0x3000U)):
            default:
                freq = 0U;
                break;
        }

        freq /= (((((CCM_Type *)(0x400FC000u))->CBCDR & (0x38000000U)) >> (27U)) + 1U);
    }

    else
    {
        switch (((CCM_Type *)(0x400FC000u))->CBCMR & (0xC0000U))
        {

            case (((uint32_t)(((uint32_t)(0U)) << (18U))) & (0xC0000U)):
                freq = CLOCK_GetPllFreq(kCLOCK_PllSys);
                break;


            case (((uint32_t)(((uint32_t)(1U)) << (18U))) & (0xC0000U)):
                freq = CLOCK_GetSysPfdFreq(kCLOCK_Pfd2);
                break;


            case (((uint32_t)(((uint32_t)(2U)) << (18U))) & (0xC0000U)):
                freq = CLOCK_GetSysPfdFreq(kCLOCK_Pfd0);
                break;


            case (((uint32_t)(((uint32_t)(3U)) << (18U))) & (0xC0000U)):
                freq = CLOCK_GetPllFreq(kCLOCK_PllArm) /
                       (((((CCM_Type *)(0x400FC000u))->CACRR & (0x7U)) >> (0U)) + 1U);
                break;
...
static uint32_t CLOCK_GetPllUsb1SWFreq(void)
{
    ...
    switch ((((CCM_Type *)(0x400FC000u))->CCSR & (0x1U)) >> (0U))
    {
        case 0:
        {
            freq = CLOCK_GetPllFreq(kCLOCK_PllUsb1);
...
# 190 "../../libraries/sdk/drives/fsl_clock.c"
void CLOCK_InitExternalClk(_Bool bypassXtalOsc)
{

    ((!bypassXtalOsc) ? (void)0 : __aeabi_assert("!bypassXtalOsc", "../../libraries/sdk/drives/fsl_clock.c", 193),
# 193 "../../libraries/sdk/drives/fsl_clock.c"
#pragma clang diagnostic push
# 193 "../../libraries/sdk/drives/fsl_clock.c"
#pragma clang diagnostic ignored "-Wassume"
# 193 "../../libraries/sdk/drives/fsl_clock.c"
    (__builtin_assume)((!bypassXtalOsc)?1:0)
# 193 "../../libraries/sdk/drives/fsl_clock.c"
#pragma clang diagnostic pop
# 193 "../../libraries/sdk/drives/fsl_clock.c"
    );

    ((CCM_ANALOG_Type *)(0x400D8000u))->MISC0_CLR = (0x40000000U);
    while ((((XTALOSC24M_Type *)(0x400D8000u))->LOWPWR_CTRL & (0x10000U)) == 0U)
    {
    }
    ((CCM_ANALOG_Type *)(0x400D8000u))->MISC0_SET = (0x10000U);
    while ((((CCM_ANALOG_Type *)(0x400D8000u))->MISC0 & (0x8000U)) == 0UL)
    {
    }
    ((CCM_ANALOG_Type *)(0x400D8000u))->MISC0_CLR = (0x10000U);
}
# 214 "../../libraries/sdk/drives/fsl_clock.c"
void CLOCK_DeinitExternalClk(void)
{
    ((CCM_ANALOG_Type *)(0x400D8000u))->MISC0_SET = (0x40000000U);
}
# 226 "../../libraries/sdk/drives/fsl_clock.c"
void CLOCK_SwitchOsc(clock_osc_t osc)
{
    if (osc == kCLOCK_RcOsc)
    {
        ((XTALOSC24M_Type *)(0x400D8000u))->LOWPWR_CTRL_SET = (0x10U);
    }
    else
    {
        ((XTALOSC24M_Type *)(0x400D8000u))->LOWPWR_CTRL_CLR = (0x10U);
    }
}
...
void CLOCK_InitRcOsc24M(void)
{
    ((XTALOSC24M_Type *)(0x400D8000u))->LOWPWR_CTRL |= (0x1U);
}
...
uint32_t CLOCK_GetAhbFreq(void)
{
    return CLOCK_GetPeriphClkFreq() / (((((CCM_Type *)(0x400FC000u))->CBCDR & (0x1C00U)) >> (10U)) + 1U);
}
...
uint32_t CLOCK_GetSemcFreq(void)
{
    ...
    if ((((CCM_Type *)(0x400FC000u))->CBCDR & (0x40U)) != 0U)
    {

        if ((((CCM_Type *)(0x400FC000u))->CBCDR & (0x80U)) != 0U)
        {
    ...
    freq /= (((((CCM_Type *)(0x400FC000u))->CBCDR & (0x70000U)) >> (16U)) + 1U);
...
uint32_t CLOCK_GetIpgFreq(void)
{
    return CLOCK_GetAhbFreq() / (((((CCM_Type *)(0x400FC000u))->CBCDR & (0x300U)) >> (8U)) + 1U);
}
...
uint32_t CLOCK_GetPerClkFreq(void)
{
    ...
    if ((((CCM_Type *)(0x400FC000u))->CSCMR1 & (0x40U)) != 0U)
    {
        freq = CLOCK_GetOscFreq();
    }
    ...
    freq /= (((((CCM_Type *)(0x400FC000u))->CSCMR1 & (0x3FU)) >> (0U)) + 1U);

    return freq;
}
# 342 "../../libraries/sdk/drives/fsl_clock.c"
uint32_t CLOCK_GetFreq(clock_name_t name)
{
    uint32_t freq;
...
uint32_t CLOCK_GetClockRootFreq(clock_root_t clockRoot)
{
    static const clock_name_t clockRootSourceArray[][6] = { {kCLOCK_SysPllPfd2Clk, kCLOCK_SysPllPfd0Clk, kCLOCK_NoneName, kCLOCK_NoneName, kCLOCK_NoneName, kCLOCK_NoneName}, {kCLOCK_SysPllPfd2Clk, kCLOCK_SysPllPfd0Clk, kCLOCK_NoneName, kCLOCK_NoneName, kCLOCK_NoneName, kCLOCK_NoneName}, {kCLOCK_SemcClk, kCLOCK_Usb1SwClk, kCLOCK_SysPllPfd2Clk, kCLOCK_Usb1PllPfd0Clk, kCLOCK_NoneName, kCLOCK_NoneName}, {kCLOCK_SysPllPfd2Clk, kCLOCK_Usb1PllPfd0Clk, kCLOCK_Usb1PllPfd1Clk, kCLOCK_SysPllClk, kCLOCK_NoneName, kCLOCK_NoneName}, {kCLOCK_OscClk, kCLOCK_SysPllPfd2Clk, kCLOCK_Usb1Sw120MClk, kCLOCK_Usb1PllPfd1Clk, kCLOCK_NoneName, kCLOCK_NoneName}, {kCLOCK_Usb1PllPfd1Clk, kCLOCK_Usb1PllPfd0Clk, kCLOCK_SysPllClk, kCLOCK_SysPllPfd2Clk, kCLOCK_NoneName, kCLOCK_NoneName}, {kCLOCK_SysPllClk, kCLOCK_SysPllPfd2Clk, kCLOCK_SysPllPfd0Clk, kCLOCK_SysPllPfd1Clk, kCLOCK_NoneName, kCLOCK_NoneName}, {kCLOCK_Usb1PllPfd2Clk, kCLOCK_VideoPllClk, kCLOCK_AudioPllClk, kCLOCK_NoneName, kCLOCK_NoneName, kCLOCK_NoneName}, {kCLOCK_Usb1PllPfd2Clk, kCLOCK_VideoPllClk, kCLOCK_AudioPllClk, kCLOCK_NoneName, kCLOCK_NoneName, kCLOCK_NoneName}, {kCLOCK_Usb1PllPfd2Clk, kCLOCK_VideoPllClk, kCLOCK_AudioPllClk, kCLOCK_NoneName, kCLOCK_NoneName, kCLOCK_NoneName}, {kCLOCK_Usb1Sw60MClk, kCLOCK_OscClk, kCLOCK_NoneName, kCLOCK_NoneName, kCLOCK_NoneName, kCLOCK_NoneName}, {kCLOCK_Usb1Sw60MClk, kCLOCK_OscClk, kCLOCK_Usb1Sw80MClk, kCLOCK_NoneName, kCLOCK_NoneName, kCLOCK_NoneName}, {kCLOCK_Usb1Sw80MClk, kCLOCK_OscClk, kCLOCK_NoneName, kCLOCK_NoneName, kCLOCK_NoneName, kCLOCK_NoneName}, {kCLOCK_SysPllClk, kCLOCK_Usb1PllPfd3Clk, kCLOCK_VideoPllClk, kCLOCK_SysPllPfd0Clk, kCLOCK_SysPllPfd1Clk, kCLOCK_Usb1PllPfd1Clk}, {kCLOCK_AudioPllClk, kCLOCK_Usb1PllPfd2Clk, kCLOCK_VideoPllClk, kCLOCK_Usb1SwClk, kCLOCK_NoneName, kCLOCK_NoneName}, {kCLOCK_AudioPllClk, kCLOCK_Usb1PllPfd2Clk, kCLOCK_VideoPllClk, kCLOCK_Usb1SwClk, kCLOCK_NoneName, kCLOCK_NoneName}, {kCLOCK_AudioPllClk, kCLOCK_Usb1PllPfd2Clk, kCLOCK_VideoPllClk, kCLOCK_Usb1PllClk, kCLOCK_NoneName, kCLOCK_NoneName}, };
    static const clock_mux_t clockRootMuxTupleArray[] = { kCLOCK_Usdhc1Mux, kCLOCK_Usdhc2Mux, kCLOCK_FlexspiMux, kCLOCK_Flexspi2Mux, kCLOCK_CsiMux, kCLOCK_LpspiMux, kCLOCK_TraceMux, kCLOCK_Sai1Mux, kCLOCK_Sai2Mux, kCLOCK_Sai3Mux, kCLOCK_Lpi2cMux, kCLOCK_CanMux, kCLOCK_UartMux, kCLOCK_LcdifPreMux, kCLOCK_SpdifMux, kCLOCK_Flexio1Mux, kCLOCK_Flexio2Mux, };
    static const clock_div_t clockRootDivTupleArray[][2] = { {kCLOCK_NonePreDiv, kCLOCK_Usdhc1Div}, {kCLOCK_NonePreDiv, kCLOCK_Usdhc2Div}, {kCLOCK_NonePreDiv, kCLOCK_FlexspiDiv}, {kCLOCK_NonePreDiv, kCLOCK_Flexspi2Div}, {kCLOCK_NonePreDiv, kCLOCK_CsiDiv}, {kCLOCK_NonePreDiv, kCLOCK_LpspiDiv}, {kCLOCK_NonePreDiv, kCLOCK_TraceDiv}, {kCLOCK_Sai1PreDiv, kCLOCK_Sai1Div}, {kCLOCK_Sai2PreDiv, kCLOCK_Sai2Div}, {kCLOCK_Sai3PreDiv, kCLOCK_Sai3Div}, {kCLOCK_NonePreDiv, kCLOCK_Lpi2cDiv}, {kCLOCK_NonePreDiv, kCLOCK_CanDiv}, {kCLOCK_NonePreDiv, kCLOCK_UartDiv}, {kCLOCK_LcdifPreDiv, kCLOCK_LcdifDiv}, {kCLOCK_Spdif0PreDiv, kCLOCK_Spdif0Div}, {kCLOCK_Flexio1PreDiv, kCLOCK_Flexio1Div}, {kCLOCK_Flexio2PreDiv, kCLOCK_Flexio2Div}, };
    uint32_t freq = 0UL;
    ...
    uint32_t clockRootMuxValue = ((*((volatile uint32_t *)(((uint32_t)(((CCM_Type *)(0x400FC000u)))) + ((uint32_t)(clockRootMuxTuple)&0xFFU)))) & ((uint32_t)((((uint32_t)(clockRootMuxTuple) >> 13U) & 0x1FFFU) << (((((uint32_t)clockRootMuxTuple) >> 8U) & 0x1FU))))) >>
                                 ((((uint32_t)clockRootMuxTuple) >> 8U) & 0x1FU);
    clock_name_t clockSourceName;

    clockSourceName = clockRootSourceArray[(uint8_t)clockRoot][clockRootMuxValue];

    ((clockSourceName != kCLOCK_NoneName) ? (void)0 : __aeabi_assert("clockSourceName != kCLOCK_NoneName", "../../libraries/sdk/drives/fsl_clock.c", 463),
# 463 "../../libraries/sdk/drives/fsl_clock.c"
#pragma clang diagnostic push
# 463 "../../libraries/sdk/drives/fsl_clock.c"
#pragma clang diagnostic ignored "-Wassume"
# 463 "../../libraries/sdk/drives/fsl_clock.c"
    (__builtin_assume)((clockSourceName != kCLOCK_NoneName)?1:0)
# 463 "../../libraries/sdk/drives/fsl_clock.c"
#pragma clang diagnostic pop
# 463 "../../libraries/sdk/drives/fsl_clock.c"
    );
    ...
    {
        freq /= (((*((volatile uint32_t *)(((uint32_t)(((CCM_Type *)(0x400FC000u)))) + ((uint32_t)(clockRootPreDivTuple)&0xFFU)))) & ((uint32_t)((((uint32_t)(clockRootPreDivTuple) >> 13U) & 0x1FFFU) << (((((uint32_t)clockRootPreDivTuple) >> 8U) & 0x1FU))))) >>
                 ((((uint32_t)clockRootPreDivTuple) >> 8U) & 0x1FU)) +
                1UL;
    }

    freq /= (((*((volatile uint32_t *)(((uint32_t)(((CCM_Type *)(0x400FC000u)))) + ((uint32_t)(clockRootPostDivTuple)&0xFFU)))) & ((uint32_t)((((uint32_t)(clockRootPostDivTuple) >> 13U) & 0x1FFFU) << (((((uint32_t)clockRootPostDivTuple) >> 8U) & 0x1FU))))) >>
             ((((uint32_t)clockRootPostDivTuple) >> 8U) & 0x1FU)) +
            1UL;

    return freq;
}
# 492 "../../libraries/sdk/drives/fsl_clock.c"
_Bool CLOCK_EnableUsbhs0Clock(clock_usb_src_t src, uint32_t freq)
{
    uint32_t i;
    ((CCM_Type *)(0x400FC000u))->CCGR6 |= (0x3U);
    ((USB_Type *)(0x402E0000u))->USBCMD |= (0x2U);
    ...
    ((PMU_Type *)(0x400D8000u))->REG_3P0 = (((PMU_Type *)(0x400D8000u))->REG_3P0 & (~(0x1F00U))) |
                   ((((uint32_t)(((uint32_t)(0x17)) << (8U))) & (0x1F00U)) | (0x1U));
    return 1;
}
# 519 "../../libraries/sdk/drives/fsl_clock.c"
_Bool CLOCK_EnableUsbhs1Clock(clock_usb_src_t src, uint32_t freq)
{
    uint32_t i = 0;
    ((CCM_Type *)(0x400FC000u))->CCGR6 |= (0x3U);
    ((USB_Type *)(0x402E0200u))->USBCMD |= (0x2U);
...
# 544 "../../libraries/sdk/drives/fsl_clock.c"
_Bool CLOCK_EnableUsbhs0PhyPllClock(clock_usb_phy_src_t src, uint32_t freq)
{
    static const clock_usb_pll_config_t g_ccmConfigUsbPll = {.loopDivider = 0U};
    if ((((CCM_ANALOG_Type *)(0x400D8000u))->PLL_USB1 & (0x2000U)) != 0U)
    {
        ((CCM_ANALOG_Type *)(0x400D8000u))->PLL_USB1 |= (0x40U);
    }
    else
    {
        CLOCK_InitUsb1Pll(&g_ccmConfigUsbPll);
    }
    ((USBPHY_Type *)(0x400D9000u))->CTRL &= ~(0x80000000U);
    ((USBPHY_Type *)(0x400D9000u))->CTRL &= ~(0x40000000U);

    ((USBPHY_Type *)(0x400D9000u))->PWD = 0;
    ((USBPHY_Type *)(0x400D9000u))->CTRL |= (0x100000U) | (0x80000U) |
                     (0x4000U) | (0x8000U);
    return 1;
}
...
# 581 "../../libraries/sdk/drives/fsl_clock.c"
void CLOCK_InitArmPll(const clock_arm_pll_config_t *config)
{

    ((CCM_ANALOG_Type *)(0x400D8000u))->PLL_ARM = (((CCM_ANALOG_Type *)(0x400D8000u))->PLL_ARM & (~(0xC000U))) |
                          (0x10000U) | (((uint32_t)(((uint32_t)(config->src)) << (14U))) & (0xC000U));

    ((CCM_ANALOG_Type *)(0x400D8000u))->PLL_ARM =
        (((CCM_ANALOG_Type *)(0x400D8000u))->PLL_ARM & (~((0x7FU) | (0x1000U)))) |
        (0x2000U) | (((uint32_t)(((uint32_t)(config->loopDivider)) << (0U))) & (0x7FU));

    while ((((CCM_ANALOG_Type *)(0x400D8000u))->PLL_ARM & (0x80000000U)) == 0UL)
    {
    }


    ((CCM_ANALOG_Type *)(0x400D8000u))->PLL_ARM &= ~(0x10000U);
}
...
void CLOCK_DeinitArmPll(void)
{
    ((CCM_ANALOG_Type *)(0x400D8000u))->PLL_ARM = (0x1000U);
}
# 614 "../../libraries/sdk/drives/fsl_clock.c"
void CLOCK_InitSysPll(const clock_sys_pll_config_t *config)
{

    ((CCM_ANALOG_Type *)(0x400D8000u))->PLL_SYS = (((CCM_ANALOG_Type *)(0x400D8000u))->PLL_SYS & (~(0xC000U))) |
                          (0x10000U) | (((uint32_t)(((uint32_t)(config->src)) << (14U))) & (0xC000U));

    ((CCM_ANALOG_Type *)(0x400D8000u))->PLL_SYS =
        (((CCM_ANALOG_Type *)(0x400D8000u))->PLL_SYS & (~((0x1U) | (0x1000U)))) |
        (0x2000U) | (((uint32_t)(((uint32_t)(config->loopDivider)) << (0U))) & (0x1U));


    ((CCM_ANALOG_Type *)(0x400D8000u))->PLL_SYS_NUM = (((uint32_t)(((uint32_t)(config->numerator)) << (0U))) & (0x3FFFFFFFU));
    ((CCM_ANALOG_Type *)(0x400D8000u))->PLL_SYS_DENOM = (((uint32_t)(((uint32_t)(config->denominator)) << (0U))) & (0x3FFFFFFFU));


    ((CCM_ANALOG_Type *)(0x400D8000u))->PLL_SYS_SS = (((uint32_t)(((uint32_t)(config->ss_step)) << (0U))) & (0x7FFFU)) |
                             (((uint32_t)(((uint32_t)(config->ss_enable)) << (15U))) & (0x8000U)) |
                             (((uint32_t)(((uint32_t)(config->ss_stop)) << (16U))) & (0xFFFF0000U));

    while ((((CCM_ANALOG_Type *)(0x400D8000u))->PLL_SYS & (0x80000000U)) == 0UL)
    {
    }


    ((CCM_ANALOG_Type *)(0x400D8000u))->PLL_SYS &= ~(0x10000U);
}
...
void CLOCK_DeinitSysPll(void)
{
    ((CCM_ANALOG_Type *)(0x400D8000u))->PLL_SYS = (0x1000U);
}
# 656 "../../libraries/sdk/drives/fsl_clock.c"
void CLOCK_InitUsb1Pll(const clock_usb_pll_config_t *config)
{

    ((CCM_ANALOG_Type *)(0x400D8000u))->PLL_USB1 = (((CCM_ANALOG_Type *)(0x400D8000u))->PLL_USB1 & (~(0xC000U))) |
                           (0x10000U) | (((uint32_t)(((uint32_t)(config->src)) << (14U))) & (0xC000U));

    ((CCM_ANALOG_Type *)(0x400D8000u))->PLL_USB1 = (((CCM_ANALOG_Type *)(0x400D8000u))->PLL_USB1 & (~(0x2U))) |
                           (0x2000U) | (0x1000U) |
                           (0x40U) | (((uint32_t)(((uint32_t)(config->loopDivider)) << (1U))) & (0x2U));

    while ((((CCM_ANALOG_Type *)(0x400D8000u))->PLL_USB1 & (0x80000000U)) == 0UL)
    {
    }


    ((CCM_ANALOG_Type *)(0x400D8000u))->PLL_USB1 &= ~(0x10000U);
}
...
void CLOCK_DeinitUsb1Pll(void)
{
    ((CCM_ANALOG_Type *)(0x400D8000u))->PLL_USB1 = 0U;
}
# 689 "../../libraries/sdk/drives/fsl_clock.c"
void CLOCK_InitUsb2Pll(const clock_usb_pll_config_t *config)
{

    ((CCM_ANALOG_Type *)(0x400D8000u))->PLL_USB2 = (((CCM_ANALOG_Type *)(0x400D8000u))->PLL_USB2 & (~(0xC000U))) |
                           (0x10000U) | (((uint32_t)(((uint32_t)(config->src)) << (14U))) & (0xC000U));

    ((CCM_ANALOG_Type *)(0x400D8000u))->PLL_USB2 = (((CCM_ANALOG_Type *)(0x400D8000u))->PLL_USB2 & (~(0x2U))) |
                           (0x2000U) | (0x1000U) |
                           (0x40U) | (((uint32_t)(((uint32_t)(config->loopDivider)) << (1U))) & (0x2U));

    while ((((CCM_ANALOG_Type *)(0x400D8000u))->PLL_USB2 & (0x80000000U)) == 0UL)
    {
    }


    ((CCM_ANALOG_Type *)(0x400D8000u))->PLL_USB2 &= ~(0x10000U);
}
...
void CLOCK_DeinitUsb2Pll(void)
{
    ((CCM_ANALOG_Type *)(0x400D8000u))->PLL_USB2 = 0U;
}
# 722 "../../libraries/sdk/drives/fsl_clock.c"
void CLOCK_InitAudioPll(const clock_audio_pll_config_t *config)
{
    uint32_t pllAudio;
    uint32_t misc2 = 0;
    ...
    ((CCM_ANALOG_Type *)(0x400D8000u))->PLL_AUDIO = (((CCM_ANALOG_Type *)(0x400D8000u))->PLL_AUDIO & (~(0xC000U))) |
                            (0x10000U) | (((uint32_t)(((uint32_t)(config->src)) << (14U))) & (0xC000U));

    ((CCM_ANALOG_Type *)(0x400D8000u))->PLL_AUDIO_NUM = (((uint32_t)(((uint32_t)(config->numerator)) << (0U))) & (0x3FFFFFFFU));
    ((CCM_ANALOG_Type *)(0x400D8000u))->PLL_AUDIO_DENOM = (((uint32_t)(((uint32_t)(config->denominator)) << (0U))) & (0x3FFFFFFFU));
# 751 "../../libraries/sdk/drives/fsl_clock.c"
    pllAudio =
        (((CCM_ANALOG_Type *)(0x400D8000u))->PLL_AUDIO & (~((0x7FU) | (0x1000U)))) |
        (0x2000U) | (((uint32_t)(((uint32_t)(config->loopDivider)) << (0U))) & (0x7FU));

    switch (config->postDivider)
    {
        case 16:
            pllAudio |= (((uint32_t)(((uint32_t)(0)) << (19U))) & (0x180000U));
            misc2 = (0x800000U) | (0x8000U);
            break;

        case 8:
            pllAudio |= (((uint32_t)(((uint32_t)(1)) << (19U))) & (0x180000U));
            misc2 = (0x800000U) | (0x8000U);
            break;

        case 4:
            pllAudio |= (((uint32_t)(((uint32_t)(2)) << (19U))) & (0x180000U));
            misc2 = (0x800000U) | (0x8000U);
            break;
    ...
    ((CCM_ANALOG_Type *)(0x400D8000u))->MISC2 =
        (((CCM_ANALOG_Type *)(0x400D8000u))->MISC2 & ~((0x8000U) | (0x800000U))) | misc2;

    ((CCM_ANALOG_Type *)(0x400D8000u))->PLL_AUDIO = pllAudio;

    while ((((CCM_ANALOG_Type *)(0x400D8000u))->PLL_AUDIO & (0x80000000U)) == 0UL)
    {
    }


    ((CCM_ANALOG_Type *)(0x400D8000u))->PLL_AUDIO &= ~(0x10000U);
}
...
void CLOCK_DeinitAudioPll(void)
{
    ((CCM_ANALOG_Type *)(0x400D8000u))->PLL_AUDIO = (uint32_t)(0x1000U);
}
# 809 "../../libraries/sdk/drives/fsl_clock.c"
void CLOCK_InitVideoPll(const clock_video_pll_config_t *config)
{
    uint32_t pllVideo;
    uint32_t misc2 = 0;
    ...
    ((CCM_ANALOG_Type *)(0x400D8000u))->PLL_VIDEO = (((CCM_ANALOG_Type *)(0x400D8000u))->PLL_VIDEO & (~(0xC000U))) |
                            (0x10000U) | (((uint32_t)(((uint32_t)(config->src)) << (14U))) & (0xC000U));

    ((CCM_ANALOG_Type *)(0x400D8000u))->PLL_VIDEO_NUM = (((uint32_t)(((uint32_t)(config->numerator)) << (0U))) & (0x3FFFFFFFU));
    ((CCM_ANALOG_Type *)(0x400D8000u))->PLL_VIDEO_DENOM = (((uint32_t)(((uint32_t)(config->denominator)) << (0U))) & (0x3FFFFFFFU));
# 838 "../../libraries/sdk/drives/fsl_clock.c"
    pllVideo =
        (((CCM_ANALOG_Type *)(0x400D8000u))->PLL_VIDEO & (~((0x7FU) | (0x1000U)))) |
        (0x2000U) | (((uint32_t)(((uint32_t)(config->loopDivider)) << (0U))) & (0x7FU));

    switch (config->postDivider)
    {
        case 16:
            pllVideo |= (((uint32_t)(((uint32_t)(0)) << (19U))) & (0x180000U));
            misc2 = (((uint32_t)(((uint32_t)(3)) << (30U))) & (0xC0000000U));
            break;

        case 8:
            pllVideo |= (((uint32_t)(((uint32_t)(1)) << (19U))) & (0x180000U));
            misc2 = (((uint32_t)(((uint32_t)(3)) << (30U))) & (0xC0000000U));
            break;

        case 4:
            pllVideo |= (((uint32_t)(((uint32_t)(2)) << (19U))) & (0x180000U));
            misc2 = (((uint32_t)(((uint32_t)(3)) << (30U))) & (0xC0000000U));
            break;
    ...
    ((CCM_ANALOG_Type *)(0x400D8000u))->MISC2 = (((CCM_ANALOG_Type *)(0x400D8000u))->MISC2 & ~(0xC0000000U)) | misc2;

    ((CCM_ANALOG_Type *)(0x400D8000u))->PLL_VIDEO = pllVideo;

    while ((((CCM_ANALOG_Type *)(0x400D8000u))->PLL_VIDEO & (0x80000000U)) == 0UL)
    {
    }


    ((CCM_ANALOG_Type *)(0x400D8000u))->PLL_VIDEO &= ~(0x10000U);
}
...
void CLOCK_DeinitVideoPll(void)
{
    ((CCM_ANALOG_Type *)(0x400D8000u))->PLL_VIDEO = (0x1000U);
}
# 895 "../../libraries/sdk/drives/fsl_clock.c"
void CLOCK_InitEnetPll(const clock_enet_pll_config_t *config)
{
    uint32_t enet_pll = (((uint32_t)(((uint32_t)(config->loopDivider)) << (0U))) & (0x3U)) |
                        (((uint32_t)(((uint32_t)(config->loopDivider1)) << (2U))) & (0xCU));

    ((CCM_ANALOG_Type *)(0x400D8000u))->PLL_ENET = (((CCM_ANALOG_Type *)(0x400D8000u))->PLL_ENET & (~(0xC000U))) |
                           (0x10000U) | (((uint32_t)(((uint32_t)(config->src)) << (14U))) & (0xC000U));
    ...
    ((CCM_ANALOG_Type *)(0x400D8000u))->PLL_ENET =
        (((CCM_ANALOG_Type *)(0x400D8000u))->PLL_ENET & (~((0x3U) | (0xCU) |
                                   (0x1000U)))) |
        enet_pll;


    while ((((CCM_ANALOG_Type *)(0x400D8000u))->PLL_ENET & (0x80000000U)) == 0UL)
    {
    }


    ((CCM_ANALOG_Type *)(0x400D8000u))->PLL_ENET &= ~(0x10000U);
}
...
void CLOCK_DeinitEnetPll(void)
{
    ((CCM_ANALOG_Type *)(0x400D8000u))->PLL_ENET = (0x1000U);
}
# 950 "../../libraries/sdk/drives/fsl_clock.c"
uint32_t CLOCK_GetPllFreq(clock_pll_t pll)
{
    uint32_t freq;
    uint32_t divSelect;
    ...
    if (!CLOCK_IsPllEnabled(((CCM_ANALOG_Type *)(0x400D8000u)), pll))
    {
        return 0U;
    }


    freq = CLOCK_GetPllBypassRefClk(((CCM_ANALOG_Type *)(0x400D8000u)), pll);


    if (CLOCK_IsPllBypassed(((CCM_ANALOG_Type *)(0x400D8000u)), pll))
    {
        return freq;
    }
    ...
    {
        case kCLOCK_PllArm:
            freq = ((freq * ((((CCM_ANALOG_Type *)(0x400D8000u))->PLL_ARM & (0x7FU)) >>
                             (0U))) >>
                    1U);
            break;
        case kCLOCK_PllSys:

            freqTmp = ((clock_64b_t)freq * ((clock_64b_t)(((CCM_ANALOG_Type *)(0x400D8000u))->PLL_SYS_NUM)));
            freqTmp /= ((clock_64b_t)(((CCM_ANALOG_Type *)(0x400D8000u))->PLL_SYS_DENOM));

            if ((((CCM_ANALOG_Type *)(0x400D8000u))->PLL_SYS & (0x1U)) != 0U)
            {
                freq *= 22U;
            }
            else
        ...
        case kCLOCK_PllUsb1:
            freq = (freq * (((((CCM_ANALOG_Type *)(0x400D8000u))->PLL_USB1 & (0x2U)) != 0UL) ? 22U : 20U));
            break;

        case kCLOCK_PllAudio:

            divSelect =
                (((CCM_ANALOG_Type *)(0x400D8000u))->PLL_AUDIO & (0x7FU)) >> (0U);

            freqTmp = ((clock_64b_t)freq * ((clock_64b_t)(((CCM_ANALOG_Type *)(0x400D8000u))->PLL_AUDIO_NUM)));
            freqTmp /= ((clock_64b_t)(((CCM_ANALOG_Type *)(0x400D8000u))->PLL_AUDIO_DENOM));

            freq = freq * divSelect + (uint32_t)freqTmp;
# 1032 "../../libraries/sdk/drives/fsl_clock.c"
            switch (((CCM_ANALOG_Type *)(0x400D8000u))->PLL_AUDIO & (0x180000U))
            {
                case (((uint32_t)(((uint32_t)(0U)) << (19U))) & (0x180000U)):
                    freq = freq >> 2U;
                    break;

                case (((uint32_t)(((uint32_t)(1U)) << (19U))) & (0x180000U)):
                    freq = freq >> 1U;
                    break;

                case (((uint32_t)(((uint32_t)(2U)) << (19U))) & (0x180000U)):
                    freq = freq >> 0U;
                    break;

                default:
                    ((0) ? (void)0 : __aeabi_assert("false", "../../libraries/sdk/drives/fsl_clock.c", 1047),
# 1047 "../../libraries/sdk/drives/fsl_clock.c"
#pragma clang diagnostic push
# 1047 "../../libraries/sdk/drives/fsl_clock.c"
#pragma clang diagnostic ignored "-Wassume"
# 1047 "../../libraries/sdk/drives/fsl_clock.c"
...
# 1047 "../../libraries/sdk/drives/fsl_clock.c"
            ...
            switch (((CCM_ANALOG_Type *)(0x400D8000u))->MISC2 & ((0x800000U) | (0x8000U)))
            {
                case (((uint32_t)(((uint32_t)(1)) << (23U))) & (0x800000U)) | (((uint32_t)(((uint32_t)(1)) << (15U))) & (0x8000U)):
                    freq >>= 2U;
                    break;

                case (((uint32_t)(((uint32_t)(0)) << (23U))) & (0x800000U)) | (((uint32_t)(((uint32_t)(1)) << (15U))) & (0x8000U)):
                    freq >>= 1U;
                    break;

                case (((uint32_t)(((uint32_t)(0)) << (23U))) & (0x800000U)) | (((uint32_t)(((uint32_t)(0)) << (15U))) & (0x8000U)):
                case (((uint32_t)(((uint32_t)(1)) << (23U))) & (0x800000U)) | (((uint32_t)(((uint32_t)(0)) << (15U))) & (0x8000U)):
                    freq >>= 0U;
                    break;

                default:
                    ((0) ? (void)0 : __aeabi_assert("false", "../../libraries/sdk/drives/fsl_clock.c", 1067),
# 1067 "../../libraries/sdk/drives/fsl_clock.c"
#pragma clang diagnostic push
# 1067 "../../libraries/sdk/drives/fsl_clock.c"
#pragma clang diagnostic ignored "-Wassume"
# 1067 "../../libraries/sdk/drives/fsl_clock.c"
...
# 1067 "../../libraries/sdk/drives/fsl_clock.c"
        ...
        case kCLOCK_PllVideo:
            ...
            divSelect =
                (((CCM_ANALOG_Type *)(0x400D8000u))->PLL_VIDEO & (0x7FU)) >> (0U);

            freqTmp = ((clock_64b_t)freq * ((clock_64b_t)(((CCM_ANALOG_Type *)(0x400D8000u))->PLL_VIDEO_NUM)));
            freqTmp /= ((clock_64b_t)(((CCM_ANALOG_Type *)(0x400D8000u))->PLL_VIDEO_DENOM));
            freq = freq * divSelect + (uint32_t)freqTmp;
# 1097 "../../libraries/sdk/drives/fsl_clock.c"
            switch (((CCM_ANALOG_Type *)(0x400D8000u))->PLL_VIDEO & (0x180000U))
            {
                case (((uint32_t)(((uint32_t)(0U)) << (19U))) & (0x180000U)):
                    freq = freq >> 2U;
                    break;
                ...
                default:
                    ((0) ? (void)0 : __aeabi_assert("false", "../../libraries/sdk/drives/fsl_clock.c", 1112),
# 1112 "../../libraries/sdk/drives/fsl_clock.c"
#pragma clang diagnostic push
# 1112 "../../libraries/sdk/drives/fsl_clock.c"
#pragma clang diagnostic ignored "-Wassume"
# 1112 "../../libraries/sdk/drives/fsl_clock.c"
...
# 1112 "../../libraries/sdk/drives/fsl_clock.c"
            ...
            switch (((CCM_ANALOG_Type *)(0x400D8000u))->MISC2 & (0xC0000000U))
            {
                case (((uint32_t)(((uint32_t)(3U)) << (30U))) & (0xC0000000U)):
                    freq >>= 2U;
                    break;

                case (((uint32_t)(((uint32_t)(1U)) << (30U))) & (0xC0000000U)):
                    freq >>= 1U;
                    break;

                case (((uint32_t)(((uint32_t)(0U)) << (30U))) & (0xC0000000U)):
                case (((uint32_t)(((uint32_t)(2U)) << (30U))) & (0xC0000000U)):
                    freq >>= 0U;
                    break;

                default:
                    ((0) ? (void)0 : __aeabi_assert("false", "../../libraries/sdk/drives/fsl_clock.c", 1132),
# 1132 "../../libraries/sdk/drives/fsl_clock.c"
#pragma clang diagnostic push
# 1132 "../../libraries/sdk/drives/fsl_clock.c"
#pragma clang diagnostic ignored "-Wassume"
# 1132 "../../libraries/sdk/drives/fsl_clock.c"
...
# 1132 "../../libraries/sdk/drives/fsl_clock.c"
        ...
        case kCLOCK_PllEnet:
            divSelect =
                (((CCM_ANALOG_Type *)(0x400D8000u))->PLL_ENET & (0x3U)) >> (0U);
            freq = enetRefClkFreq[divSelect];
            break;

        case kCLOCK_PllEnet2:
            divSelect = (((CCM_ANALOG_Type *)(0x400D8000u))->PLL_ENET & (0xCU)) >>
                        (2U);
            freq = enetRefClkFreq[divSelect];
            break;
        ...
        case kCLOCK_PllUsb2:
            freq = (freq * (((((CCM_ANALOG_Type *)(0x400D8000u))->PLL_USB2 & (0x2U)) != 0U) ? 22U : 20U));
            break;
        default:
            freq = 0U;
            break;
...
# 1174 "../../libraries/sdk/drives/fsl_clock.c"
void CLOCK_InitSysPfd(clock_pfd_t pfd, uint8_t pfdFrac)
{
    uint32_t pfdIndex = (uint32_t)pfd;
    uint32_t pfd528;

    pfd528 = ((CCM_ANALOG_Type *)(0x400D8000u))->PFD_528 &
             ~(((uint32_t)((uint32_t)(0x80U) | (0x3FU))
                << (8UL * pfdIndex)));


    ((CCM_ANALOG_Type *)(0x400D8000u))->PFD_528 = pfd528 | ((uint32_t)(0x80U) << (8UL * pfdIndex));


    ((CCM_ANALOG_Type *)(0x400D8000u))->PFD_528 = pfd528 | ((((uint32_t)(((uint32_t)(pfdFrac)) << (0U))) & (0x3FU)) << (8UL * pfdIndex));
}
# 1197 "../../libraries/sdk/drives/fsl_clock.c"
void CLOCK_DeinitSysPfd(clock_pfd_t pfd)
{
    ((CCM_ANALOG_Type *)(0x400D8000u))->PFD_528 |= (uint32_t)(0x80U) << (8U * (uint8_t)pfd);
}
# 1210 "../../libraries/sdk/drives/fsl_clock.c"
_Bool CLOCK_IsSysPfdEnabled(clock_pfd_t pfd)
{
    return ((((CCM_ANALOG_Type *)(0x400D8000u))->PFD_528 & (uint32_t)(0x80U) << (8UL * (uint8_t)pfd)) == 0U);
}
# 1225 "../../libraries/sdk/drives/fsl_clock.c"
void CLOCK_InitUsb1Pfd(clock_pfd_t pfd, uint8_t pfdFrac)
{
    uint32_t pfdIndex = (uint32_t)pfd;
    uint32_t pfd480;

    pfd480 = ((CCM_ANALOG_Type *)(0x400D8000u))->PFD_480 &
             ~(((uint32_t)((uint32_t)(0x80U) | (0x3FU))
                << (8UL * pfdIndex)));


    ((CCM_ANALOG_Type *)(0x400D8000u))->PFD_480 = pfd480 | ((uint32_t)(0x80U) << (8UL * pfdIndex));


    ((CCM_ANALOG_Type *)(0x400D8000u))->PFD_480 = pfd480 | ((((uint32_t)(((uint32_t)(pfdFrac)) << (0U))) & (0x3FU)) << (8UL * pfdIndex));
}
# 1248 "../../libraries/sdk/drives/fsl_clock.c"
void CLOCK_DeinitUsb1Pfd(clock_pfd_t pfd)
{
    ((CCM_ANALOG_Type *)(0x400D8000u))->PFD_480 |= (uint32_t)(0x80U) << (8UL * (uint8_t)pfd);
}
# 1261 "../../libraries/sdk/drives/fsl_clock.c"
_Bool CLOCK_IsUsb1PfdEnabled(clock_pfd_t pfd)
{
    return ((((CCM_ANALOG_Type *)(0x400D8000u))->PFD_480 & (uint32_t)(0x80U) << (8UL * (uint8_t)pfd)) == 0U);
}
# 1274 "../../libraries/sdk/drives/fsl_clock.c"
uint32_t CLOCK_GetSysPfdFreq(clock_pfd_t pfd)
{
    ...
    {
        case kCLOCK_Pfd0:
            freq /= ((((CCM_ANALOG_Type *)(0x400D8000u))->PFD_528 & (0x3FU)) >> (0U));
            break;

        case kCLOCK_Pfd1:
            freq /= ((((CCM_ANALOG_Type *)(0x400D8000u))->PFD_528 & (0x3F00U)) >> (8U));
            break;

        case kCLOCK_Pfd2:
            freq /= ((((CCM_ANALOG_Type *)(0x400D8000u))->PFD_528 & (0x3F0000U)) >> (16U));
            break;

        case kCLOCK_Pfd3:
            freq /= ((((CCM_ANALOG_Type *)(0x400D8000u))->PFD_528 & (0x3F000000U)) >> (24U));
            break;
...
# 1313 "../../libraries/sdk/drives/fsl_clock.c"
uint32_t CLOCK_GetUsb1PfdFreq(clock_pfd_t pfd)
{
    ...
    {
        case kCLOCK_Pfd0:
            freq /= ((((CCM_ANALOG_Type *)(0x400D8000u))->PFD_480 & (0x3FU)) >> (0U));
            break;

        case kCLOCK_Pfd1:
            freq /= ((((CCM_ANALOG_Type *)(0x400D8000u))->PFD_480 & (0x3F00U)) >> (8U));
            break;

        case kCLOCK_Pfd2:
            freq /= ((((CCM_ANALOG_Type *)(0x400D8000u))->PFD_480 & (0x3F0000U)) >> (16U));
            break;

        case kCLOCK_Pfd3:
            freq /= ((((CCM_ANALOG_Type *)(0x400D8000u))->PFD_480 & (0x3F000000U)) >> (24U));
            break;
...
# 1353 "../../libraries/sdk/drives/fsl_clock.c"
_Bool CLOCK_EnableUsbhs1PhyPllClock(clock_usb_phy_src_t src, uint32_t freq)
{
    static const clock_usb_pll_config_t g_ccmConfigUsbPll = {.loopDivider = 0U};
    CLOCK_InitUsb2Pll(&g_ccmConfigUsbPll);
    ((USBPHY_Type *)(0x400DA000u))->CTRL &= ~(0x80000000U);
    ((USBPHY_Type *)(0x400DA000u))->CTRL &= ~(0x40000000U);

    ((USBPHY_Type *)(0x400DA000u))->PWD = 0;
    ((USBPHY_Type *)(0x400DA000u))->CTRL |= (0x100000U) | (0x80000U) |
                     (0x4000U) | (0x8000U);
...
void CLOCK_DisableUsbhs1PhyPllClock(void)
{
    ((CCM_ANALOG_Type *)(0x400D8000u))->PLL_USB2 &= ~(0x40U);
    ((USBPHY_Type *)(0x400DA000u))->CTRL |= (0x40000000U);
}
...
void CLOCK_SetClockOutput1(clock_output1_selection_t selection, clock_output_divider_t divider)
{
    ...
    tmp32 = ((CCM_Type *)(0x400FC000u))->CCOSR;
    ...
    else
    {
        tmp32 |= (0x80U);
        tmp32 &= ~((0xFU) | (0x70U));
        tmp32 |= (((uint32_t)(((uint32_t)(selection)) << (0U))) & (0xFU)) | (((uint32_t)(((uint32_t)(divider)) << (4U))) & (0x70U));
    }
    ((CCM_Type *)(0x400FC000u))->CCOSR = tmp32;
}
...
void CLOCK_SetClockOutput2(clock_output2_selection_t selection, clock_output_divider_t divider)
{
    ...
    {
        tmp32 |= (0x1000000U);
        tmp32 &= ~((0x1F0000U) | (0xE00000U));
        tmp32 |= (((uint32_t)(((uint32_t)(selection)) << (16U))) & (0x1F0000U)) | (((uint32_t)(((uint32_t)(divider)) << (21U))) & (0xE00000U));
    }
...
uint32_t CLOCK_GetClockOutClkO2Freq(void)
{
    ...
    if ((tmp32 & (0x1000000U)) != 0UL)
    {
        switch ((tmp32 & (0x1F0000U)) >> (16U))
        {
