# 1 "../../libraries/sdk/drives/fsl_cmp.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/sdk/drives/fsl_cmp.c" 2
...
# 1 "../../libraries/sdk/drives/fsl_cmp.h" 1
# 12 "../../libraries/sdk/drives/fsl_cmp.h"
...
# 13 "../../libraries/sdk/drives/fsl_cmp.h" 2
# 32 "../../libraries/sdk/drives/fsl_cmp.h"
enum _cmp_interrupt_enable
{
    kCMP_OutputRisingInterruptEnable = (0x10U),
    kCMP_OutputFallingInterruptEnable = (0x8U),
};
...
{
    kCMP_OutputRisingEventFlag = (0x4U),
    kCMP_OutputFallingEventFlag = (0x2U),
    kCMP_OutputAssertEventFlag = (0x1U),
};
...
typedef struct _cmp_config
{
    ...
    _Bool enableInvertOutput;
    _Bool useUnfilteredOutput;
    _Bool enablePinOut;
...
# 131 "../../libraries/sdk/drives/fsl_cmp.h"
void CMP_Init(CMP_Type *base, const cmp_config_t *config);
# 146 "../../libraries/sdk/drives/fsl_cmp.h"
...
static inline void CMP_Enable(CMP_Type *base, _Bool enable)
{
    if (enable)
    {
        base->CR1 |= (0x1U);
    ...
    {
        base->CR1 &= ~(uint8_t)(0x1U);
    }
}
# 181 "../../libraries/sdk/drives/fsl_cmp.h"
void CMP_GetDefaultConfig(cmp_config_t *config);
# 194 "../../libraries/sdk/drives/fsl_cmp.h"
void CMP_SetInputChannels(CMP_Type *base, uint8_t positiveChannel, uint8_t negativeChannel);
# 215 "../../libraries/sdk/drives/fsl_cmp.h"
void CMP_EnableDMA(CMP_Type *base, _Bool enable);
# 225 "../../libraries/sdk/drives/fsl_cmp.h"
static inline void CMP_EnableWindowMode(CMP_Type *base, _Bool enable)
{
    if (enable)
    {
        base->CR1 |= (0x40U);
    ...
    {
        base->CR1 &= (uint8_t)(~(0x40U));
    }
}
# 264 "../../libraries/sdk/drives/fsl_cmp.h"
...
# 304 "../../libraries/sdk/drives/fsl_cmp.h"
...
# 10 "../../libraries/sdk/drives/fsl_cmp.c" 2
# 24 "../../libraries/sdk/drives/fsl_cmp.c"
...
static CMP_Type *const s_cmpBases[] = { (CMP_Type *)0u, ((CMP_Type *)(0x40094000u)), ((CMP_Type *)(0x40094008u)), ((CMP_Type *)(0x40094010u)), ((CMP_Type *)(0x40094018u)) };


static const clock_ip_name_t s_cmpClocks[] = { kCLOCK_IpInvalid, kCLOCK_Acmp1, kCLOCK_Acmp2, kCLOCK_Acmp3, kCLOCK_Acmp4 };
...
static uint32_t CMP_GetInstance(CMP_Type *base)
{
    ...
    for (instance = 0; instance < (sizeof(s_cmpBases) / sizeof((s_cmpBases)[0])); instance++)
    {
    ...
    ((instance < (sizeof(s_cmpBases) / sizeof((s_cmpBases)[0]))) ? (void)0 : __aeabi_assert("instance < ARRAY_SIZE(s_cmpBases)", "../../libraries/sdk/drives/fsl_cmp.c", 52),
# 52 "../../libraries/sdk/drives/fsl_cmp.c"
#pragma clang diagnostic push
# 52 "../../libraries/sdk/drives/fsl_cmp.c"
#pragma clang diagnostic ignored "-Wassume"
# 52 "../../libraries/sdk/drives/fsl_cmp.c"
    (__builtin_assume)((instance < (sizeof(s_cmpBases) / sizeof((s_cmpBases)[0])))?1:0)
# 52 "../../libraries/sdk/drives/fsl_cmp.c"
#pragma clang diagnostic pop
# 52 "../../libraries/sdk/drives/fsl_cmp.c"
    );
...
# 70 "../../libraries/sdk/drives/fsl_cmp.c"
void CMP_Init(CMP_Type *base, const cmp_config_t *config)
{
    ((0 != config) ? (void)0 : __aeabi_assert("NULL != config", "../../libraries/sdk/drives/fsl_cmp.c", 72),
# 72 "../../libraries/sdk/drives/fsl_cmp.c"
#pragma clang diagnostic push
# 72 "../../libraries/sdk/drives/fsl_cmp.c"
#pragma clang diagnostic ignored "-Wassume"
# 72 "../../libraries/sdk/drives/fsl_cmp.c"
...
# 72 "../../libraries/sdk/drives/fsl_cmp.c"
    ...
    tmp8 = (uint8_t)(base->CR1 & ~((0x10U) | (0x8U) | (0x4U) | (0x2U)));
    if (1 == config->enableHighSpeed)
    {
        tmp8 |= (0x10U);
    }
    if (1 == config->enableInvertOutput)
    {
        tmp8 |= (0x8U);
    }
    if (1 == config->useUnfilteredOutput)
    {
        tmp8 |= (0x4U);
    }
    if (1 == config->enablePinOut)
    {
        tmp8 |= (0x2U);
    }
# 111 "../../libraries/sdk/drives/fsl_cmp.c"
    base->CR1 = tmp8;


    tmp8 = base->CR0 & ~(uint8_t)(0x3U);
    tmp8 |= (((uint8_t)(((uint8_t)(config->hysteresisMode)) << (0U))) & (0x3U));
    base->CR0 = tmp8;

    CMP_Enable(base, config->enableCmp);
}
# 134 "../../libraries/sdk/drives/fsl_cmp.c"
void CMP_Deinit(CMP_Type *base)
{
...
# 160 "../../libraries/sdk/drives/fsl_cmp.c"
void CMP_GetDefaultConfig(cmp_config_t *config)
{
    ((0 != config) ? (void)0 : __aeabi_assert("NULL != config", "../../libraries/sdk/drives/fsl_cmp.c", 162),
# 162 "../../libraries/sdk/drives/fsl_cmp.c"
#pragma clang diagnostic push
# 162 "../../libraries/sdk/drives/fsl_cmp.c"
#pragma clang diagnostic ignored "-Wassume"
# 162 "../../libraries/sdk/drives/fsl_cmp.c"
...
# 162 "../../libraries/sdk/drives/fsl_cmp.c"
    ...
    config->enableInvertOutput = 0;
    config->useUnfilteredOutput = 0;
    config->enablePinOut = 0;



}
# 189 "../../libraries/sdk/drives/fsl_cmp.c"
void CMP_SetInputChannels(CMP_Type *base, uint8_t positiveChannel, uint8_t negativeChannel)
{
    uint8_t tmp8 = base->MUXCR;

    tmp8 &= ~(uint8_t)((0x38U) | (0x7U));
    tmp8 |= (((uint8_t)(((uint8_t)(positiveChannel)) << (3U))) & (0x38U)) | (((uint8_t)(((uint8_t)(negativeChannel)) << (0U))) & (0x7U));
    base->MUXCR = tmp8;
}
# 210 "../../libraries/sdk/drives/fsl_cmp.c"
void CMP_EnableDMA(CMP_Type *base, _Bool enable)
{
    uint8_t tmp8 = (uint8_t)(base->SCR & ~((0x4U) | (0x2U)));
...
# 232 "../../libraries/sdk/drives/fsl_cmp.c"
void CMP_SetFilterConfig(CMP_Type *base, const cmp_filter_config_t *config)
{
    ((0 != config) ? (void)0 : __aeabi_assert("NULL != config", "../../libraries/sdk/drives/fsl_cmp.c", 234),
# 234 "../../libraries/sdk/drives/fsl_cmp.c"
#pragma clang diagnostic push
# 234 "../../libraries/sdk/drives/fsl_cmp.c"
#pragma clang diagnostic ignored "-Wassume"
# 234 "../../libraries/sdk/drives/fsl_cmp.c"
...
# 234 "../../libraries/sdk/drives/fsl_cmp.c"
    ...
    {
        base->CR1 &= (uint8_t)(~(0x80U));
    }


    tmp8 = (uint8_t)(base->CR0 & ~(0x70U));
    tmp8 |= (((uint8_t)(((uint8_t)(config->filterCount)) << (4U))) & (0x70U));
    base->CR0 = tmp8;

    base->FPR = (((uint8_t)(((uint8_t)(config->filterPeriod)) << (0U))) & (0xFFU));
}
...
void CMP_SetDACConfig(CMP_Type *base, const cmp_dac_config_t *config)
{
    ...
    tmp8 |= (((uint8_t)(((uint8_t)(config->DACValue)) << (0U))) & (0x3FU));
...
# 333 "../../libraries/sdk/drives/fsl_cmp.c"
uint32_t CMP_GetStatusFlags(CMP_Type *base)
{
    uint32_t ret32 = 0U;
