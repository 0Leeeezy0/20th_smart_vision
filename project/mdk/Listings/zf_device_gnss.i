# 1 "../../libraries/zf_device/zf_device_gnss.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/zf_device/zf_device_gnss.c" 2
# 46 "../../libraries/zf_device/zf_device_gnss.c"
...
# 47 "../../libraries/zf_device/zf_device_gnss.c" 2
# 1 "../../libraries/zf_common\\zf_common_function.h" 1
# 39 "../../libraries/zf_common\\zf_common_function.h"
...
# 40 "../../libraries/zf_common\\zf_common_function.h" 2
...
# 48 "../../libraries/zf_device/zf_device_gnss.c" 2
...
# 49 "../../libraries/zf_device/zf_device_gnss.c" 2
...
# 50 "../../libraries/zf_device/zf_device_gnss.c" 2
...
# 51 "../../libraries/zf_device/zf_device_gnss.c" 2
...
# 53 "../../libraries/zf_device/zf_device_gnss.c" 2
...
static uint8 gnss_state = 0;
static fifo_struct gnss_receiver_fifo;
static uint8 gnss_receiver_buffer[( 128 )];

static gps_state_enum gnss_gga_state = GPS_STATE_RECEIVING;
static gps_state_enum gnss_rmc_state = GPS_STATE_RECEIVING;
static gps_state_enum gnss_ths_state = GPS_STATE_RECEIVING;

static uint8 gps_gga_buffer[( 128 )];
static uint8 gps_rmc_buffer[( 128 )];
static uint8 gps_ths_buffer[( 128 )];
# 79 "../../libraries/zf_device/zf_device_gnss.c"
...
# 113 "../../libraries/zf_device/zf_device_gnss.c"
...
# 133 "../../libraries/zf_device/zf_device_gnss.c"
...
# 154 "../../libraries/zf_device/zf_device_gnss.c"
...
# 175 "../../libraries/zf_device/zf_device_gnss.c"
...
# 223 "../../libraries/zf_device/zf_device_gnss.c"
static uint8 gps_gnrmc_parse (char *line, gnss_info_struct *gnss)
{
    ...
    if('A' == state || 'D' == state)
    {
        ...
        speed_tmp = get_float_number(&buf[get_parameter_index(7, buf)]);
        gnss->speed = speed_tmp * 1.85f;
        gnss->direction = get_float_number(&buf[get_parameter_index(8, buf)]);
    }
    else
    {
        gnss->state = 0;
    ...
    gnss->time.hour = (buf[7] - '0') * 10 + (buf[8] - '0');
...
# 294 "../../libraries/zf_device/zf_device_gnss.c"
...
# 320 "../../libraries/zf_device/zf_device_gnss.c"
...
# 352 "../../libraries/zf_device/zf_device_gnss.c"
double get_two_points_distance (double latitude1, double longitude1, double latitude2, double longitude2)
{
    ...
    rad_latitude1 = ( (latitude1) * ( 3.1415926535898 ) / 180.0 );
    rad_latitude2 = ( (latitude2) * ( 3.1415926535898 ) / 180.0 );
    rad_longitude1 = ( (longitude1) * ( 3.1415926535898 ) / 180.0 );
    rad_longitude2 = ( (longitude2) * ( 3.1415926535898 ) / 180.0 );
...
# 387 "../../libraries/zf_device/zf_device_gnss.c"
double get_two_points_azimuth (double latitude1, double longitude1, double latitude2, double longitude2)
{
    latitude1 = ( (latitude1) * ( 3.1415926535898 ) / 180.0 );
    latitude2 = ( (latitude2) * ( 3.1415926535898 ) / 180.0 );
    longitude1 = ( (longitude1) * ( 3.1415926535898 ) / 180.0 );
    longitude2 = ( (longitude2) * ( 3.1415926535898 ) / 180.0 );
    ...
    double angle = ( (atan2(x, y)) * 180.0 / ( 3.1415926535898 ) );
    return ((0 < angle) ? angle : (angle + 360));
}
# 407 "../../libraries/zf_device/zf_device_gnss.c"
uint8 gnss_data_parse (void)
{
    uint8 return_state = 0;
...
# 491 "../../libraries/zf_device/zf_device_gnss.c"
void gnss_uart_callback (void)
{
    uint8 temp_gps[6];
    ...
    {
        uint8 dat;
        while(uart_query_byte((UART_4), &dat))
        {
...
# 560 "../../libraries/zf_device/zf_device_gnss.c"
void gnss_init (gps_device_enum gps_device)
{
    ...
    if((GN42A == gps_device))
    {
        fifo_init(&gnss_receiver_fifo, FIFO_DATA_8BIT, gnss_receiver_buffer, ( 128 ));
        system_delay_ms(500);
        uart_init((UART_4), 115200, (UART4_TX_C16), (UART4_RX_C17));

        uart_write_buffer((UART_4), (uint8 *)set_rate, sizeof(set_rate));
        system_delay_ms(200);

        uart_write_buffer((UART_4), (uint8 *)open_rmc, sizeof(open_rmc));
        system_delay_ms(50);
        uart_write_buffer((UART_4), (uint8 *)open_gga, sizeof(open_gga));
        system_delay_ms(50);
        uart_write_buffer((UART_4), (uint8 *)close_gll, sizeof(close_gll));
        system_delay_ms(50);
        uart_write_buffer((UART_4), (uint8 *)close_gsa, sizeof(close_gsa));
        system_delay_ms(50);
        uart_write_buffer((UART_4), (uint8 *)close_grs, sizeof(close_grs));
        system_delay_ms(50);
        uart_write_buffer((UART_4), (uint8 *)close_gsv, sizeof(close_gsv));
        system_delay_ms(50);
        uart_write_buffer((UART_4), (uint8 *)close_vtg, sizeof(close_vtg));
        system_delay_ms(50);
        uart_write_buffer((UART_4), (uint8 *)close_zda, sizeof(close_zda));
        system_delay_ms(50);
        uart_write_buffer((UART_4), (uint8 *)close_gst, sizeof(close_gst));
        system_delay_ms(50);
        uart_write_buffer((UART_4), (uint8 *)close_txt, sizeof(close_txt));
        system_delay_ms(50);
        uart_write_buffer((UART_4), (uint8 *)close_txt_ant, sizeof(close_txt_ant));
        system_delay_ms(50);
