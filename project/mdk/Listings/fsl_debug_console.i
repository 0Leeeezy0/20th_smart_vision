# 1 "../../libraries/sdk/utilities/debug_console/fsl_debug_console.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 387 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../libraries/sdk/utilities/debug_console/fsl_debug_console.c" 2
# 10 "../../libraries/sdk/utilities/debug_console/fsl_debug_console.c"
...
# 11 "../../libraries/sdk/utilities/debug_console/fsl_debug_console.c" 2
# 1 "D:\\KEIL\\ARM\\ARMCLANG\\Bin\\..\\include\\stdlib.h" 1 3
# 71 "D:\\KEIL\\ARM\\ARMCLANG\\Bin\\..\\include\\stdlib.h" 3
...
# 12 "../../libraries/sdk/utilities/debug_console/fsl_debug_console.c" 2
...
# 14 "../../libraries/sdk/utilities/debug_console/fsl_debug_console.c" 2
...
# 16 "../../libraries/sdk/utilities/debug_console/fsl_debug_console.c" 2
# 1 "../../libraries/sdk/utilities/debug_console/fsl_debug_console.h" 1
# 25 "../../libraries/sdk/utilities/debug_console/fsl_debug_console.h"
...
# 26 "../../libraries/sdk/utilities/debug_console/fsl_debug_console.h" 2
...
# 17 "../../libraries/sdk/utilities/debug_console/fsl_debug_console.c" 2
...
# 18 "../../libraries/sdk/utilities/debug_console/fsl_debug_console.c" 2
# 37 "../../libraries/sdk/utilities/debug_console/fsl_debug_console.c"
typedef struct DebugConsoleState
{
    uint8_t uartHandleBuffer[(8U + (0U) * 16U + (0U) * 4U)];
    ...
    hal_uart_status_t (*getChar)(hal_uart_handle_t handle,
                                 uint8_t *data,
                                 size_t length);
    serial_port_type_t serial_port_type;
...
# 114 "../../libraries/sdk/utilities/debug_console/fsl_debug_console.c"
status_t DbgConsole_Init(uint8_t instance, uint32_t baudRate, serial_port_type_t device, uint32_t clkSrcFreq)
{
...
# 291 "../../libraries/sdk/utilities/debug_console/fsl_debug_console.c"
...
# 315 "../../libraries/sdk/utilities/debug_console/fsl_debug_console.c"
...
# 338 "../../libraries/sdk/utilities/debug_console/fsl_debug_console.c"
static int32_t DbgConsole_ConvertRadixNumToString(char *numstr, void *nump, int32_t neg, int32_t radix, _Bool use_caps)
{
...
# 360 "../../libraries/sdk/utilities/debug_console/fsl_debug_console.c"
    int32_t nlen;
    char *nstrp;
    ...
    *nstrp++ = '\0';
    ...
    uc = 0ULL;
    uc_param = 0ULL;
# 389 "../../libraries/sdk/utilities/debug_console/fsl_debug_console.c"
    (void)a;
    (void)b;
    (void)c;
    (void)ua;
...
# 436 "../../libraries/sdk/utilities/debug_console/fsl_debug_console.c"
            else
            {
                c = c + (int)'0';
            }
...
# 496 "../../libraries/sdk/utilities/debug_console/fsl_debug_console.c"
...
# 606 "../../libraries/sdk/utilities/debug_console/fsl_debug_console.c"
static int DbgConsole_PrintfFormattedData(PUTCHAR_FUNC func_ptr, const char *fmt, va_list ap)
{
    ...
    while (1)
    {
        ...
        while (!done)
        {
            ...
            {
                field_width = (uint32_t)__builtin_va_arg(ap, unsigned int);
            }
        ...
        if (*++p == '.')
        {
            ...
            while (!done)
            {
                ...
                if ((c >= '0') && (c <= '9'))
                {
                    ...
                    valid_precision_width = 1;

                }

                else if (c == '*')
                {
                    precision_width = (uint32_t)__builtin_va_arg(ap, unsigned int);
                    valid_precision_width = 1;
                }
        ...
        c = *++p;
        {
                ...
                (c == 'b') || (c == 'p') || (c == 'u'))
            {
                if ((c == 'd') || (c == 'i'))
                {
                    ...
                    {
                        ival = (long long int)__builtin_va_arg(ap, long long int);
                    }
                    else if (0U != (flags_used & (uint32_t)kPRINTF_LengthLongInt))
                    {
                        ival = (long int)__builtin_va_arg(ap, long int);
                    }
                    else

                    {
                        ival = (int)__builtin_va_arg(ap, int);
                    }
                ...
                if ((c == 'f') || (c == 'F'))
                {
                    fval = (double)__builtin_va_arg(ap, double);
                ...
                if ((c == 'X') || (c == 'x'))
                {
                    ...
                    if (0U != (flags_used & (uint32_t)kPRINTF_LengthLongLongInt))
                    {
                        uval = (unsigned long long int)__builtin_va_arg(ap, unsigned long long int);
                    }
                    else if (0U != (flags_used & (uint32_t)kPRINTF_LengthLongInt))
                    {
                        uval = (unsigned long int)__builtin_va_arg(ap, unsigned long int);
                    }
                    else

                    {
                        uval = (unsigned int)__builtin_va_arg(ap, unsigned int);
                    }
                ...
                if ((c == 'o') || (c == 'b') || (c == 'p') || (c == 'u'))
                {
                    if ('p' == c)
                    {
# 1030 "../../libraries/sdk/utilities/debug_console/fsl_debug_console.c"
                        void *pval;
                        pval = (void *)__builtin_va_arg(ap, void *);
            ...
            {
                cval = (int32_t)__builtin_va_arg(ap, unsigned int);
                (void)func_ptr(cval);
                count++;
            }
            else if (c == 's')
            {
                sval = (char *)__builtin_va_arg(ap, char *);
                if (0 != sval)
                {
...
# 1188 "../../libraries/sdk/utilities/debug_console/fsl_debug_console.c"
static int DbgConsole_ScanfFormattedData(const char *line_ptr, char *format, va_list args_ptr)
{
    uint8_t base;
    int8_t neg;
        ...
        else
        {
            ...
            switch (flag & (uint32_t)kSCANF_DestMask)
            {
                case (uint32_t)kSCANF_DestChar:
                    s = (const char *)p;
                    buf = __builtin_va_arg(args_ptr, char *);
                    ...
                    if (0U == (flag & (uint32_t)kSCANF_Suppress))
                    {
                        ...
                        switch (flag & (uint32_t)kSCANF_LengthMask)
                        {
                            case (uint32_t)kSCANF_LengthChar:
                                ...
                                {
                                    *__builtin_va_arg(args_ptr, signed char *) = (signed char)val;
                                }
                                else
                                {
                                    *__builtin_va_arg(args_ptr, unsigned char *) = (unsigned char)val;
                                }
                                break;
                            case (uint32_t)kSCANF_LengthShortInt:
                                if (0U != (flag & (uint32_t)kSCANF_TypeSinged))
                                {
                                    *__builtin_va_arg(args_ptr, signed short *) = (signed short)val;
                                }
                                else
                                {
                                    *__builtin_va_arg(args_ptr, unsigned short *) = (unsigned short)val;
                                }
                                break;
                            case (uint32_t)kSCANF_LengthLongInt:
                                if (0U != (flag & (uint32_t)kSCANF_TypeSinged))
                                {
                                    *__builtin_va_arg(args_ptr, signed long int *) = (signed long int)val;
                                }
                                else
                                {
                                    *__builtin_va_arg(args_ptr, unsigned long int *) = (unsigned long int)val;
                                }
                                break;
                            case (uint32_t)kSCANF_LengthLongLongInt:
                                if (0U != (flag & (uint32_t)kSCANF_TypeSinged))
                                {
                                    *__builtin_va_arg(args_ptr, signed long long int *) = (signed long long int)val;
                                }
                                else
                                {
                                    *__builtin_va_arg(args_ptr, unsigned long long int *) = (unsigned long long int)val;
                                }
                                break;
                            default:
                                ...
                                if (0U != (flag & (uint32_t)kSCANF_TypeSinged))
                                {
                                    *__builtin_va_arg(args_ptr, signed int *) = (signed int)val;
                                }
                                else
                                {
                                    *__builtin_va_arg(args_ptr, unsigned int *) = (unsigned int)val;
                                }
                                break;
                        }
# 1620 "../../libraries/sdk/utilities/debug_console/fsl_debug_console.c"
                        nassigned++;
                    }
                    break;
                ...
                case (uint32_t)kSCANF_DestFloat:
                    ...
                    if ((fnum >= __builtin_inf()) || (fnum <= -__builtin_inf()))
                    {
                        break;
                    }
                    ...
                    if (0U == (flag & (uint32_t)kSCANF_Suppress))
                    {
                        ...
                        {
                            *__builtin_va_arg(args_ptr, double *) = fnum;
                        }
                        else
                        {
                            *__builtin_va_arg(args_ptr, float *) = (float)fnum;
                        }
                        nassigned++;
                    }
                    break;
