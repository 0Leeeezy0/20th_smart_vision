...
float PID_MOTOR_1[5] = {9.4 ,0.70 ,0 ,9000 ,500};	// 后
float PID_MOTOR_2[5] = {7.4 ,0.94 ,0 ,9000 ,500}; // 左
float PID_MOTOR_3[5] = {7.4 ,0.94 ,0 ,9000 ,500}; // 右
...
float PATH_PID[3][6] = {{0.30 ,0 ,0.035 ,0.025 ,22 ,2},{0.35 ,0 ,0.08 ,0.050 ,25 ,2},{0.40 ,0 ,0.09 ,0.045 ,30 ,2}}; // linear_speed = 6	积分限幅和陀螺仪微分项调整需注意
