...
float PATH_PID[4][6] = 
{
{0.350 ,0 ,1.8 ,0.35 ,55 ,2},
{0.420 ,0 ,2.3 ,0.25 ,55 ,2},
{0.530 ,0 ,2.5 ,0.10 ,55 ,2},
{0.580 ,0 ,0.0 ,0.10 ,55 ,2}}; // linear_speed = 80-120	积分限幅和陀螺仪微分项调整需注意															// 模糊

#endif
float x_speed_rate = 2.2;							// x速度比例
float path_linear_speed_target[3] = {190,190,190};	// 循迹线速度（缓启动速度 启动最小速度 启动最大速度）（cm/s）	best：{70,130,130}
int16 control_point[2] = {70 ,50};					// 控制点高度（速度：100：65，100：50 速度：130：70，130：50）
