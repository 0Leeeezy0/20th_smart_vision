...
float PATH_PID[4][6] = 
{
{0.520 ,0 ,2.5 ,0.10 ,55 ,2},
{0.560 ,0 ,2.2 ,0.28 ,55 ,2},
{0.600 ,0 ,1.6 ,0.14 ,55 ,2},
{0.660 ,0 ,1.0 ,0.08 ,55 ,2}}; // linear_speed = 80-120	积分限幅和陀螺仪微分项调整需注意															// 模糊

#endif
float x_speed_rate = 2.3;							// x速度比例
float path_linear_speed_target[3] = {150,150,150};	// 循迹线速度（缓启动速度 启动最小速度 启动最大速度）（cm/s）	best：{70,130,130}
int16 control_point[2] = {75 ,50};					// 控制点高度（速度：100：65，100：50 速度：130：70，130：50）
