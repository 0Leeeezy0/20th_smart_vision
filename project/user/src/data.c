...
float PATH_PID[4][6] = 
{
{0.450 ,0 ,1.6 ,0.40 ,50 ,2},
{0.480 ,0 ,2.0 ,0.22 ,50 ,2},
{0.550 ,0 ,1.9 ,0.15 ,50 ,2},
{0.600 ,0 ,1.8 ,0.10 ,50 ,2}}; // linear_speed = 80-120	积分限幅和陀螺仪微分项调整需注意															// 模糊

#endif
float x_speed_rate = 2.2;							// x速度比例
float path_linear_speed_target[3] = {160,160,160};	// 循迹线速度（缓启动速度 启动最小速度 启动最大速度）（cm/s）	best：{70,130,130}
int16 control_point[2] = {75 ,75};					// 控制点高度（速度：100：65，100：50 速度：130：70，130：50）
