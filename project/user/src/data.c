...
float PATH_PID[6][6] = {{0.76 ,0 ,0.1 ,0.05 ,18 ,2},{0.78 ,0 ,0.1 ,0.05 ,20 ,2},{0.80 ,0 ,0.1 ,0.035 ,25 ,2},{0.82 ,0 ,0.1 ,0.035 ,32 ,2},{0.85 ,0 ,0.1 ,0.035 ,40 ,2},{0.88 ,0 ,0.1 ,0.035 ,45 ,2}}; // linear_speed = 100	积分限幅和陀螺仪微分项调整需注意
#endif
