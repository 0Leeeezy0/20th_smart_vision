...
float PID_SPEED_MOTOR_2[5] = {0.0149,0.008,0 ,3 ,500};
float PID_SPEED_MOTOR_3[5] = {0.0149,0.008,0 ,3 ,500};
...
float PID_I_MOTOR_2[5] = {300,600,0 ,9000 ,500};
float PID_I_MOTOR_3[5] = {300,600,0 ,9000 ,500};
//float PID_SPEED_MOTOR_1[5] = {18.8*2 ,1.4*2 ,0 ,9000 ,500};	// 后
//float PID_SPEED_MOTOR_2[5] = {14.8*2 ,1.88*2 ,0 ,9000 ,500}; // 左
//float PID_SPEED_MOTOR_3[5] = {14.8*2 ,1.88*2 ,0 ,9000 ,500}; // 右
...
{0.600 ,0 ,1.8 ,0.18  ,45 ,2}}; // linear_speed = 80-120	积分限幅和陀螺仪微分项调整需注意															// 模糊
