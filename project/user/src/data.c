...
int16 control_point = 55;		// 控制点高度（速度：3：30 速度：6：55 速度：8：55）
...
// 位置式
float PATH_PID[4][6] = {{1 ,0.01 ,0 ,0.064 ,10 ,1},{0.034 ,0.01 ,0 ,0.008 ,1 ,0.1},{0.038 ,0.01 ,0 ,0.008 ,1 ,0.1},{0.042 ,0.01 ,0 ,0.008 ,1 ,0.1}}; // linear_speed = 6	积分限幅和陀螺仪微分项调整需注意
#endif
