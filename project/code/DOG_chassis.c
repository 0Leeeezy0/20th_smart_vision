...
//    else if (chassis_control.motor_3.dir==0){I_Original_ADC_data_3 = -1.0*(float)adc_mean_filter_convert(MOTOR_3_I_PIN, 5);}
    ...
    motor_1_I = (I_Karman_ADC_data_1-2035) / 4095 *3.3/ 20/0.01;
    motor_2_I = (I_Karman_ADC_data_2-2035) / 4095 *3.3/ 20/0.01;
    motor_3_I = (I_Karman_ADC_data_3-2035) / 4095 *3.3/ 20/0.01;    
